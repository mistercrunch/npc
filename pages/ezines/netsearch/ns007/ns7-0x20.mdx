...
cambiando los codigos de España por los de  alli y  la cosa funciono a medias,
por lo que con  unos pequeños  retoques podria estar lista :) ...  asi que por
lo visto  el programa esta bien hecho pero pienso que falla la alimentacion de
la tarjeta. Creo que añadiendo algun condensador debe solucionarse el problema,
...
ibamos diseñando  la tarjeta y el programa.  Tambien he  adjuntado un programa
...
- Tarjeta, acido, etc ... eso depende de lo cutre que seas diseñando circuitos
...
----------------------------------
   ...
   (57..64) │         │    │
            ├─────────┼────┤
   (65..80) │0001 0100│ 14 │ Tarjeta de 1000 pas (España)
      **    │0010 0101│ 25 │ Tarjeta de 2000 ptas (España)
      **    │0010 0101│ 25 │ Tarjeta de 2100 ptas (España)
...
* Podemos usar un PIC12CE67x que tiene 8 patillas  y  funciona a 10 Mhz con un
  ...
  Esquema del PIC12CE67x
                 ...
                 Vdd   ----> ┌┤1    8├┐ <----  Vss
                             └┤      ├┘
       GP5/OSC1/CLKIN <----> ┌┤2    7├┐ <----> GP0/AN0
                             └┤      ├┘
  GP4/OSC2/AN3/CLKOUT <----> ┌┤3    6├┐ <----> GP1/AN1/Vref
             ____            └┤      ├┘
         GP3/MCLR/Vpp <----> ┌┤4    5├┐ <----> GP2/T0CKI/AN2/INT
                             └┤      ├┘
                              └──────┘
  ...
  Descripcion de los pines:
        ...
        ╔══════════════════════════════════════════════════════════╗
        ║     NOMBRE    │         DURANTE LA PROGRAMACION          ║
        ║      DEL      ├────────┬────┬────────────────────────────║
        ║      PIN      │NOM. PIN│TIPO│        DESCRIPCION         ║
        ╠══════════════════════════════════════════════════════════╣
        ║      GP1      │ CLOCK  │ I  │Entrada de Clock            ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║      GP0      │ DATA   │I/O │Entrada/salida de datos     ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║     ____      │        │    │Power de programacion (tiene║
        ║ GP3/MCLR/Vpp  │  Vpp   │ P  │que ser de 12v a 14v)       ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║      Vdd      │  Vdd   │ P  │Power de suministro (2v-6v) ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║      Vss      │  Vss   │ P  │Masa                        ║
        ╠══════════════════════════════════════════════════════════╣
        ║GP5/OSC1/CLKIN │        │ I  │Entrada oscilador a cristal ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║ P4/OCS2/CLKOUT│        │ O  │Salida oscilador a cristal  ║
        ║───────────────┼────────┼────┼────────────────────────────║
        ║GP2/T0CKI/INT  │        │I/O │(algo del TMR0 - reloj)     ║
        ╚══════════════════════════════════════════════════════════╝
...
fin
        BCF     INTCON, INTF	; borramos se±alizador de la interrupcion
