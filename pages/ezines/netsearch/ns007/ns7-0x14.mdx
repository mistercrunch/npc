...
____________________
 	...
 	Bueno, pues despues de unos 6 meses en la era de nuestro se±or sin 
...
En el a±o 93, 50 empresas se juntaron en lo que se llamo la Infrared Data 
...
(signal meter, medidor de se±al) la potencia de la se±al IR recibida.
...
Es un protocolo dise±ado para que un objeto pueda ser movido de un dispositivo a 
...
IrCOMM fue dise±ado para dar soporte a aquellas aplicaciones que ya funcionaban 
...
En el modules.conf o conf.modules segun distribuciones hay que a±adir, lo pongo 
...
a±adir un fichero 'irda' que contenga estas lineas. 
...
ííííNO ES POSIBLE TENER EL SERIE Y EL BUILT-IN NSC IR UTILIZANDO LO MISMO!!!!
...
documentado para a±adirlo al documento. Mi intencion es siempre aportar el 
...
a todo lo anterior hay que a±adir:
...
Es recomendable a±adir la variable al sistema PILOTRATE que nos permite aumentar 
...
Se suponen son los tama±os de almacenamiento para cada una de las keys. Lo del 
...
Password = contrase±a_de_la_conexion
New PPPD = yes
...
Los dos primeros tienen una tama±o de 8 bits mientras el ultimo debe ser 
multiplo de 8.
...
(19) = Tama±o del campo de informacion creo.
