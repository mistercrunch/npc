...
```
Bienvenidos a la edición nº 1 de Minotauro Magazine (c) Minotauro Group.
 ...
 *** (bueno, en el momento que escribí esto no conocía las HBO) ***

pilar todo lo que podamos, y armarlo en un paquete, para no tener que estar
pensando "en donde deje el formato de los .exe", ó "como mierda se hacia para
...
compilar. Lo que sí, esperamos todo el apoyo posible (hmmm:) para que esto sal_
ga adelante...Cualquier información será bienvenida.

Cualquier tipo de dudas, nos pueden encontrar en estos BBS de Bs.As.:
	Dionysios I	253-4389
	Dionysios II	253-2098
	Mindbenders	806-7202
...
Indice :
 ...
 2) Programación de virus #1, by Drako
