...
1. C O R R E O   E L E C T R O N I C O 
 ...
 Asi surgio el E-Mail ( Electronic Mail, o en español, Correo Electronico ).
 ...
 STAT --> Nos dice el numero de mensajes que hay en el buzon y el tamaño
          en bytes que ocupan.
 LIST --> Similar al anterior pero nos muestra el tamaño de cada mensaje
          (no en conjunto).
 ...
 .mx quiere decir que proviene de Mexico, .es de España, etc.
 ...
 el año, la fecha, etc) la @ y el dominio.
