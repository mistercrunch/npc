...
```
This is ILLEGAL #26, rewritten from paper by King Fisher / Triad. The German
...
WHO'S HOT, WHO'S NOT, WHO'S NASTY and WHO'S NICE???
...
THE NEXT COPYPARTIES

?too many conferences at the moment error in March / April 1988.

March, the 19th: VENLO, HOLLAND. HOTLINE, TWG, ORION, RWE...

March, the 19th: GROSS-GERAU, GERMANY. 'KONRADS PARTY', A.C.E.???
...
HTL, RWE, TWG, ORION, IAN&MIC / TRIAD... THIS GONNA BE IT!

April, the 23rd: BELGIAN ART! CFR, BS1, WOW, C64CG, SHIELD... for information
write to: B-ART, PATRONAGIESTR.25, 9950 WAARSCHOOT, BELGIUM.
...
TRIAD (IXION, JEFF SMART, HITEC, 3D)
BFD-CREW (THE BRIGHT LION)
HEPTAGON (GALACTICUS)
TRIUMPH (ICON)
...
THE  T R I A D  RANKINGS ONTHA 5-3 / '88
...
BADSQUAD, JEWELS, DCU (cumming over), UPFRONT, TRIUMPH, SCOOP, FAC and
...
THE UNDERGROUND IS CELEBRATING... OR WHAT?
...
'Big groups like FOOTBALL HOOLIGANS or UNEMPLOYMENT CRACKING SERVICE were
...
TRISTAR, C64CG, SRG, MADSQUAD, SHARKS, SAP, RADWAR (of course), PLEASURE, CFR
...
members: STRIDER, GOLLUM, GANDALF, THE BLACK SHADOW, THE HOBBIT and WILFO.
...
STRIDER OF FAIRLIGHT, IAN & MIC FROM TRIAD, and many more.
...
FS: Sleep. But mainly I'm looking for my son, who's very ill, he's got a
    ...
    CAN HELP. READ "COLLECT YOUR USED STAMPS")
...
A BIG 'THANX YOU' FOR VOTING:

IAN / FUSION, JUST ICE / IKARI, BAD BOY / THE SURVIVORS, CF / BB, RUB / TWG, MA
