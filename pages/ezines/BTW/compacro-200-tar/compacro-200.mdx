...
ASSP    Application Specific Standard Prot
...
ATP     Appletalk Transaction Protocol
        Application Transmission Processing
...
BCS     Binary Compatility Standard
...
BITS    Base Information Transfer System
        BSI Information Technology Services
...
CCA     Common Cryptographic Architecture
        Communications Control Architecture
...
CDA     Compound Document Architecture 
        ...
        Capability Data Acknowledgement
CDC     Control Data Corporation
CD_CHRDYCarD CHannel ReaDY
...
CDROMXA CDROM eXtended Architecture
...
CEPI    Conference of European Postal and Telecommunications
...
CMA     Concert Multi-thread Architecture
        Communications Managers Assocation
...
CSDM    Circuit-Switched Data Network
...
CSMA/CP Carrier Sense Multiple Access with Collision Prevention
...
CSS     Continuous System Simulation
        Conceptual Signaling and Status
...
DIF     Data Interchange Format
        ...
        Dual Inline Flatpack
        Documentation Interchange Format
DIFFSENSDifferential Sense
...
DISP    Displacement 
        Directory Information Shadow Protocol
...
DMOS    Double-diffused Metal-Oxide Semiconductor
        Diffustion Metal Occide Semiconductor
...
DNHR    Dynamic NonHierachal Routing
...
DSB     Double SideBand
DSBSC   Double SideBand Supressed Cattier
...
ECN     Exchange Carriers Standards Association
...
EEHLLAPIEntry Emulator High Level Language API
...
EETDN   End-to-End Transit Delat Negotiation
...
ERF     Event Report Function
        Emergency Restoration Facility                                     
...
ESF     Exteneded Superframe Format
...
ETRI-PECElectronics and Telecommunications Research Institute - Protocol Engineering Center
...
FMT     Format
FMVFT   Frequency-Modulated Voice Frequenct Telegraph
FN      FiNish
...
FOCUS   Forum of Control Data Users
        Federation On Computing in the U.S.
FOD     Finger Of Death
...
FRAM    Ferroelectric Random-Access Memory
        Ferromagnetic RAM
FRED    FRame EDitor
        FRont End to the Directory
        Flipping Rediculous Electronic Device
FREQ    File REQuest
...
IIA     Industry Information Association
...
INTERCALCompiler Language With No Pronouncable Acronym
...
ITI     Industrial Technology Institute
        Interactive Technology Equipment
...
ITSP    Information Technology and System Plan
        Information Technology and System Planning
...
LZW     Lempel-Ziv-Walsh
        abraham Lempel, jacob Ziv, Welch
...
MAP     Maintenance Analysis Procedures
        ...
        Manufacturing Automation Profile
        MAjor sync Point
...
MICS    Macro Interpretive Commands
        Management Information Conference Statement
...
MUMPS   Massachusetts Utility Multi-Programming System 
...
NACS    National Advisory Committee on Semiconductors
        Novell Asynchronous Communications Server
...
NET     Network Entity Title
        Norme Europeene de Telecommunications
...
NPL     National Physical Laboratiry
...
ODA/ODIFOpen Document Architecture/Open Document Interchange Format
...
PAR     Parallel
PARA    Paragraph
PARADISEPiloting A Researchers DIrectory Service in Europe
...
PLOTKA  Press Lots Of Keys To Abort
...
PSC     Product Service Center
        ...
        Protocols Standards and Communications
...
PSI     Performance Summary Interval
        Process to Support Interoperability
...
RIFF    Resource Interschange File Format 
RIME    RelayNet International Message Exchange
RIP     Raster Image Processor 
        Routing Information Protocol 
        Remote Imaging Protocol
RIPE    Reseaux IP Europeene
...
RTSE    Reliable Transfer Serivce Element
...
SAA     Systems Application Architecture 
        Standards Association of Austrailia
...
SAM     Serial Access Memory 
        ...
        Symantic Antivirus for Macintosh
...
SDI     Switched Digital International
        Supplier Declaration of Interoperation
SDIF    SGML Document Interchange Format
SDK     Software Developer's Kit 
        Software Development Kit
SDL     Specification and Desciption Language
...
SPAG    Standard Promotion and Applications Group
...
SPDU    Session PDU
SPEC    Standards Performance Evaluation Corp.
...
THOR    Tandy High-Performance Optical Recording
        Tandy High-Intensity Optical Recorder
...
USRT    Universal Synchronous Receiver/Transmitter
        Universal Synchronous Receiver Transceiver
...
VAX     Virtual Address Extension
        Virtual Architecture eXtensions
...
VER     Verify
        Version
VERONICAVery Easy Rodent-Oriented Netwide Guide to Computerized Archives
...
WELAC   Western Europe Laboratory Accreditation Corporation
...
XNS/ITP Xerox Network System/Internet TransPort
XO      eXactly Once
XOR     Exclusive OR 
