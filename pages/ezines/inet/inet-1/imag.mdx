...
http://intrusos.cjb.net (Web oficial de Intrusos)

http://travel.to/silence (Web de Mr.Silence, anillo de hack and phreak en
español).
...
* Intrusos no se responsabiliza de daños o incursiones premeditadas al     *                          *
* al pentágono, al FBI, al "computador de X universidad", etc..            *  
...
****************************************************************************
                        ...
                        ║       CONTENIDO       ║
        ╔═══════════════╩═══════════════════════╬═══════════════╗
        ║ 1)- Editorial                         ║  Intrusos     ║
        ╠═══════════════════════════════════════╣               ║
        ║ 2)- Politicas del Windows NT          ║  EndlessRoad  ║
        ╠═══════════════════════════════════════╣               ║
        ║ 3)- ¿Peligro en la seguridad?         ║  EndlessRoad  ║
        ╠═══════════════════════════════════════╣               ║
        ║ 4)- Ingenieria Social en el Netmeeting║  EndlessRoad  ║
        ╠═══════════════════════════════════════╣               ║
        ║ 5)- Introduccion al LINUX             ║  EndlessRoad  ║
        ╠═══════════════════════════════════════╣               ║
        ║ 6)- Passwords por defecto             ║  Recopilacion ║
        ╠═══════════════════════════════════════╣               ║
        ║ 7)- Manifiesto Cyberpunk              ║  A.S Kirtchev ║
        ╠═══════════════════════════════════════╣               ║
        ║ 8)- NeuroAlfa2 (Ficcion)              ║  EndlessRoad  ║
        ╠═══════════════════════════════════════╣               ║
        ║ 9)- Despedida                         ║  Intrusos     ║
        ╚═══════════════════════════════════════╩═══════════════╝
...
para referirse a esos desocupados que solamente activaban virus o dañaban
sistemas.
...
Noticias asi son las que maltratan la palabra Hacker, es mas, en español
traducen "hacker" como "pirata", sin tener conocimientos de que un pirata
es Warez. Hasta Yahoo, una de las principales compañias del mundo que ofrece
...
DAÑO AL SISTEMA EN QUE ENTRAN Y TRATANDO DE SOLUCIONAR EL PROBLEMA QUE DESCUBREN
...
creen que van a dañar su etica...pues estan muuuuy equivocados.
...
Lo abrimos con un el notepad y verificamos en [Options] que este añadida la
...
como añadidura especial en el CD del windows 95 (I.E admin/appstools).
...
------------------------------------------------------------------------------
  Ingenieria Social: Engañar a alguien, hacerse pasar por otra persona para
...
>> Si se hace Ingenieria Social en el IRC tienes que gastar mucho tiempo de
   ...
   de que podria estar hablando con un engañador o algo asi, ademas es muy
...
las utilidades ftp y telnet (del que UNIX es dueño), los examinadores web
...
por Christian As.Kirtchev traducido por AuRiL (http://www.cyberpunks.com)
...
nadando en el oceano de la informacion. 2/ Estamos cohibidos, pequeños chicos
de colegio, sentados en el ultimo pupitre, en la esquina de la clase.
3/ Somos el adolescente que todos consideran extraño. 4/ Estamos estudiando
...
eso es lo nuestro. Lo nuestro es una habitación con ordenadores,
...
interior. Eso es lo que somos- realistas con gafas de soñadores. 8/ Somosaquellas personas casi desconocidas para el vecindario. Personas, entregadas
...
gobiernos utilizan para enorgullecerse, no son mas que un pequeño paso
...
el mañana. Todo lo que ellos tienen que hacer es cerrar sus puños y sentir lo
...
juventud, la "educacion-modelo" para todos los niños : y, cuando alguno se
...
en las bases del pasado. Leyes, para hoy, leyes, que se ajusten al mañana.
...
a ocurrir el dia de mañana. 6/ Observamos la Red, y la Red esta creciendo y
...
pequeño individuo y nosotros controlaremos la Red. 16/ Pero, si tu no
...
odio es un arma y la paz un sueño. 3/ El mundo crece lentamente. Es dificil
...
Machacan a los ni±os con sus puntos de vista y castigan y niegan todo intento
...
tiempos deben estarlo...si, me imagino que nadie a leído hasta aqui :))
Esto es algo de Ciencia Ficción (¿o Cyberpunk?) que escribi cuando acababa
...
BioRobot dedicado a varias tareas, pero los sueños a menudo eran reales y lo
crearon.
El sistema experto se Ilamo el NeuroAlfa2, antes habian intentado construir el
NeuroAlfa1 pero el intento fue tan falible que se demoraron muchos años para
...
tamaño, teletransportando su contenido.
...
Pasados los años todos los habitantes fueron BioRobots pero en forma
