...
"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*"*:._.*
       ...
       ..Taker..         u_taker@bigfoot.com  (Otra vez yo...!!!)
       ...
       &lt;Pacman> uds son una verguenza
       &lt;Pacman> solo por chuparsela al editor
       &lt;Pacman> de esa revista lama
       <}^PunkY^{> yo no soy hacker hacker es muy amplio me falta aun por
                   ke no le e dedikado todo mi time
       &lt;Pacman> que es proyecto R
       &lt;MoonSpell> &lt;Pacman> solo por chuparsela al editor
       &lt;MoonSpell> &lt;Pacman> de esa revista lama
       &lt;Pacman> Proyecto R es una verguenza
       &lt;MoonSpell> jajajaja
       <}^PunkY^{> revista lama la del plaxius???
       &lt;MoonSpell> jajaja
       &lt;MoonSpell> plaxius lamah jajajaja
       <}^PunkY^{> shuaaaaaaaaaaaa
       <}^PunkY^{> ahora tiraste abajo el pokito de respeto ke te tenia
       &lt;Pacman> puta es cosa de ver la pagina
       &lt;Pacman> y los ahueonaos qu escriben
       <}^PunkY^{> no hablo mas kon weones
       &lt;Pacman> que hacker tiene que leer
       &lt;Pacman> o aprender
       &lt;Pacman> esa huea que esta en geocities
       &lt;MoonSpell> jajajaja
       &lt;MoonSpell> actualizate weon
       &lt;MoonSpell> www.cdlr.org
       &lt;kernel_F> jajajajaja
       &lt;MoonSpell> igual ke tenemos dominio y servidor y vo no :9
       &lt;Pacman> cacha el fuego po
       &lt;Pacman> penosa la pagina
       &lt;MoonSpell> teni dominio????
       &lt;Pacman> yo me consigo los dominios gratis
       &lt;Pacman> que tenis que andar haciendo paginas
       &lt;MoonSpell> jajajajaja
       &lt;Pacman> y ezines
...
dudas  a  mi e-mail  (u_taker@bigfoot.com)  con  el  subject  phreak,  yo  me 
...
By:     TeeSPy
Mail:   tspspark@geocities.com  <<-- Aki comentarios o dudas..(YAA!!, ta 
...
chmod +x &lt;nombrearchivo> lo dejamos listo para la ejecucion.
...
se detenga y espere  la  siguiente  entrada  de teclado. Si oprime &lt;intro> el
script continua y si presiona &lt;Ctrl-D> mientras  read  estaba  esperando,  se
termina el script.
...
comando  se  llaman  $0,  $1,  $2.. y  asi hasta llegar al numero 9. Estas 10
variables corresponden a las posiciones de los argumentos de la linea, siendo
el $0 el nombre del comando, el $1  el  primer  argumento, el $2 el segundo y
asi sucesivamente. Como ejemplo de esto, vea el siguiente script ejemplo:

	# Nombre: movedel
	# Fecha: **/**/**
		cp $1 /trash   # Copia el archivo al directorio /trash
		rm $1          # Elimina el archivo

Ahora se escribe movedel archivo1 y presiona &lt;Intro> (despues de haberle dado
...
indico que solo actuara con el argumento $1. Para solucionar  esto, se  puede
sustituir  en  el  script de ejemplo el $1 por $*, que representa a todos los
...
normal,  en  cambio,  se  introduce  el  valor  de  la  variable $5 cuando se
despliega la cadena.


	echo "Son $5 la pizza, se~or"


Aqui,  en  lugar  de  la cadena $5, se despliega el valor que tiene conferido 
...
varios años (hasta el dia de hoy) ya que  el resultado de un finger nos puede
...
plaxius@bertacueva.cdlr.org$finger @server.com
...
plaxius@boticueva.cdlr.org$telnet www.server.com > finger.txt
...
plaxius@barticueva.cdlr.org$finger root@server.com
...
APORTE PERUANO               Por Jiuster Vela             XJiuster3@Usa.net
...
Tienes mi correo XJiuster3@Usa.Net
...
@="4u8hâäàåçêëèD=G?BKLLôöòûPISKNWXXƒáíóUñÑªº[][`^^aikl▓│┤╡llnm«ú╝╜╛┐└┴┬├"
...
Return-Path: &lt;jperez@datanet.com.mx>
Received: from jperez.217.12.111.248 by marte.datanet.com.mx (SMI-8.6/SMI-SVR4)
	id TAB29951; Tue, 17 Aug 1999 19:03:20 -0800
Message-ID: <000c02bee90e$622606c0$51de0ac8@217.12.111.248>
From: "Juan Perez" &lt;jperez@datanet.com.mx>
To: jperez@datanet.com.mx
Subject: prueba
...
Direccion de Correo: elpanteraazul@iname.com
...
Return-Path: &lt;elpanteraazul@iname.com>
Received: from jperez.217.12.111.248 by marte.datanet.com.mx (SMI-8.6/SMI-SVR4)
	id UAB29958; Tue, 17 Aug 1999 20:33:28 -0800
Message-ID: <000c02bee90e$622606c0$51de0ac8@217.12.111.248>
From: "El Pantera Azul" &lt;elpanteraazul@iname.com>
To: jperez@datanet.com.mx
Subject: prueba2
...
250 Fin Juan Niceforo Perez del Hoyo &lt;jperez@datanet.com.mx>                        
...
Message-ID: <000d01aaa90e$622606c0$51de0ac8@217.12.111.248>
From: "El Pantera Azul" &lt;elpanteraazul@iname.com>
To: jperez@datanet.com.mx
Subject: prueba3
...
yo@server.com  el  finger buscara a ese  usuario  entre  la  lista  total  de 
...
si hacemos finger al login o sea underchile asi.. finger a carlos@server.com,  
...
esto   je,  asi   de   simple   finger  RHS@server.com,  Linux@server.com,  o 
user@server.com  esto nos deberia dar la lista completa de todos los usuarios 
...
if [ $1 ]; then
	if [ $2 ]; then
		finger RHS@$1 | grep "Login" | awk -F ' ' {print $2} | sort - | uniq >> $2
	fi
	else
		printf "se necesita otro argumento mas\n"
	fi
else
	printf "uso: $0 host file\n"
fi
...
mas  o  menos  200  kb de basura, PC Anywhere responde "Please press &lt;Enter>"
...
Cualquier duda, aclaracion, comentario, etc, a: u_taker@bigfoot.com
...
Comuniquence  conmigo  a  magistelus@hotmail.com, o  en irc.reuna.cl  que  me 
...
Hace bastante tiempo tenía la  inquietud  de  como poder hacer programas para
linux en los ke pudiese  conectarme a servidores o cosas por el estilo. Bueno
a  través  de  esta  inquietud fué que decidí comenzar a buscar información y
aquí  les presento alguna de las cosas ke se pueden hacer y bueno más ke nada
darles el  empujón inicial para ke puedan continuar este maravilloso mundo de
la programación..... El  lenguaje a utilizar no va a ser otro más ke el archi
conocido C. Es necesario que  ojala  tengas  conocimientos  básicos  de  este
lenguaje.... (hay muchos  manuales  por  ahí que hablan del tema). No soy por
ningún motivo un experto en C pero creo ke  no  es necesario serlo para hacer
esto, demás esta decir que cualquier error que cometa pueden hacermelo saber.

Esta vez mostraré algunos ejemplos sobre programación  de  sockets (crear  un
...
(esto lo explico más tarde). 


Un  típico  ejemplo  de un cliente es el siguiente programa que se conecta al
puerto 80 de un servidor para obtener información sobre el WEBSERVER.

/*      WEBQUERY V1.0
	Programa creado por AnDyK
	Te da información acerca del servidor web de un host determinado
...
Estoy  seguro  que muchos de ustedes más de alguna vez han usado un portscan.
...
/* Program Created By AnDyK. CDLR Pro Hackers DOMAIN
	...
	Cualkier consulta a andykhack@hotmail.com
*/
...
un cliente (recueden leer el artículo anterior, si es ke no lo han hecho).

Estos son los  primeros  programas  que  se me ocurrieron crear, como ven son
bastante simples, creo ke seguiré mostrando mis primeras creaciones.

Una vez que cree estos programas recuerdo  ke me dije AHORA A CREAR UN SERVER
(teniendo la esperanza de algún día  crear  un buen backdoor.... uuppss bueno
ke esto kede en secreto!!!!!!!!).

Ke tal un programa ke al conectarse  a  través  de  una  aplicación de telnet
me muestre /etc/passwd ... (esto es  solo  un  ejemplo... podría  haber  sido
...
En  realidad  este  programa  no  es  muy  útil...  como  podrán  observar al
ejecutarlo verán ke la sesión keda inutilizada esperando  por  conexiones....
Aquí viene la  parte  interesante  de  este  artículo... La pregunta ke yo me
hice  fue  el  como  poder  hechar  a  andar  el programa y ke kede residente
pudiendo yo hacer cualkier otra  cosa  desde la misma  sesión.... y  más  aun
ke el programa siga corriendo una vez ke yo he cerrado la sesión....
...
En el encontre la teoría de los demonios y como poder crearlos....

En  la  práctica  lograremos  ke  el  mismo  programa  anterior funcione algo
así como los programas residentes  en  memoria  (TSR)  de  DOS  esperando por
una conexión.

En teoría se hace uso de la función? fork() de C ke crea un proceso hijo.

En  realidad  teoricamente  no entiendo bien como funciona pero prácticamente
evidente. Trataré de explicarlo al menos como yo lo entiendo:
...
problemas familiares asi ke mejor dejemoslo así.

El siguiente  código  ke  mostraré  es  algo así como el eskeleto de cualkier
programa ke kiera usar esta tecnica, lo único  ke  debes  hacer  es  llamar a
este procedimiento desde la función main(). Bueno esto kedará  claro  con  el
...
Ahora lo unico ke debemos hacer es en  nuestro  programa  original, hacer una
llamada a daemon_start(); esto al final kedaría como sigue:

*****************************************************************************
			AKI EMPIEZA EL OBJETIVO FINAL
*****************************************************************************
/* Program Created By AnDyK. CDLR Pro Hackers DOMAIN
	Compilar usando: gcc -o bd bd.c
	Este es solo un ejemplo de programacion de Sockets
...
sus programas. Es claro mencionar ke este programa está diseñado para Linux..
para Unix solo hay ke realizar unas pequeñas modificaciones.
...
así no tendrás ke esperar a ke un desconocido cree  esos  programas  ke tanto
te imaginas.... no sean flojillos. Además podrán cooperar en nuestra  seccion
de Código Fuente en nuestra recién inaugurado servidor.
...
estadisticas de desempe±o de cualquier mßquina en esa red.
...
mandame un e-mail a u_taker@bigfoot.com.
...
Un saludo...   TnK   G_Tonik@bigfoot.com 
...
en la memoria de la computadora durante toda la sesión de Windows.  

URL: http://www.news.com


CRITICAN EN ESPAÑA AL DICCIONARIO DE MICROSOFT
...
incluir alguna para el proximo ezine, escribid a TnK  G_Tonik@bigfoot.com  
...
Para cualkier tipo de comentarios, mail a tspspark@yahoo.com

*****************************************************************************
TeeSPy &lt;tspspark@yahoo.com>
-----------------------------------------------------------------------------
Powered by Linux!!!
*****************************************************************************
...
Dirección MAC = 00-10-5A-CD-98-8E
...
GENERAL
=======
Bueno  en esta sección nos muestrala direccion IP del server, fecha del scan, 
...
Para  versiones  en  español  o cuando el grupo de administradores tiene otro
...
16/12/98  18.45         &lt;DIR>          .
16/12/98  18.45         &lt;DIR>          ..
23/12/98  16.55         &lt;DIR>          samples
31/03/99  13.57                  2.697 default.htm
26/02/99  11.25         &lt;DIR>          _private
26/02/99  11.25         &lt;DIR>          cgi-bin
26/02/99  11.25         &lt;DIR>          images
...
Undocumented Windows NT..By O∩Reilly & Associates
IISHACK
...
From: "Juan Pablo" &lt;juanparaya@xxxxx.xxx>
...
caleta el tema.
Sabnia lo minimo.. que pa todos mis compa±eros era la caga... como
...
que sali el a±o pasado y no me dio pa ing civil en la U, terngo + tiempo
...
From: "Eduardo Herrera" &lt;destinoculto@xxxxx.xxx>
To: proyecto_r@bigfoot.com

Hola gente de proyecto r, antes que todo debo felicitarlos por su pßgina, 
...
aprender a ocuparlo por falta de $$$...Ojalß me ayuden y me respondan, les 
estarφa muy agradecido...
                                                             Gracias....
...
Subject: hola chikos de la R.... !!!!
	 ...
	 From: "Mauricio S." &lt;maurimau@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com


hola chikos de la R ... parto este mail felicitandolos por el fantßstiko 
proyecto ke llevan a cabo ... kreo ke el e-zine es excelente ... hacφa falta 
...
servido de mucho , he ido conociendo kosas ke no pensΘ ke existφan dentro de 
internet ,pues como ustedes saben y no sΘ si comparten mi opini≤n ... en 
Chile , a la Internet se le considera solo como elemento de diversi≤n y 
entretenci≤n ... (ciertamente en un porcentaje lo es por supuesto) y no se 
le toma el peso komo una herramienta de trabajo y un elemento ke en los 
pr≤ximos a±os ..va a ser cotidiano.... bueno ...mi consulta es acerca del 
...
hola@tc34-5-entelchile.net y blabla bla..)
y aparecen por ejemplo los dominios..    hola@hola.como.estai.cl  ....como 
pueden hacer eso? ... existe un programa en especial para realizar eso?...  
la otra consulta ke tenφa... es sobre las cuentas shell.... para ke 
sirven?.... existe alguna direcci≤n en internet donde obtener una gratis?... 
...
Subject: Phreacking
	 ...
	 From: "Gohan" &lt;top_guns@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>
		CC:  &lt;proyecto_r@bigfoot.com>
...
Subject: saludos y algunas dudas!
	 ...
	 From: Daniel Mannheim &lt;dmannheim@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com
...
intendado.-
    ...
    podrias correr un getadmin o sechole, o beadmin si es WINNT en español
...
Subject: 
	 ...
	 From: Apolo Titanit &lt;apoloks@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com


Hola feliz aniversario,
los felicito por su E_ZinE, creo que es un gran esfuerzo de parte de 
ustedes, por tu tiempo de investigaci≤n, horas por el ciber espacio.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Subject: Adelanteíí, Proyecto R
	 Date: Sun, 13 Jun 1999 19:19:00 -0500
	 From: INET &lt;inet@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com


Entonces que muchachos Bien ≤ Que ??
...
comenzar lo estan haciendo muy bien ííí  :-) :-) :-)

Me pueden llamar Pipa, pues asi me conocen mis allegados vacanes ííí
...
sus contrase±as, pero estan cifradas, ademas aparecen otras descripciones de
los usuarios.
...
Me pueden escribir a mi mail personal que es pipasoft@xxxxx.xxx
...
Subject:
	 ...
	 From: arkham@xxxxx.xxx
		 To: proyecto_r@bigfoot.com


Saludos a todos los integrantes del Proyecto. Soy un español adicto a vuestro
...
resistir.
    ...
    en este momento estamos trabajando en el diseño de la pagina para 
    el nuevo servidor, y nos hemos matado la cabeza diseñando logos y toda
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
		 Subject: 
				...
				From: "HaCk Trivial" &lt;trivial_hk@xxxxx.xxx>
...
despide Gengis_KAN, Trivial_HK
    ...
    hackear .. creo que hay una pequeña diferencia (la C y R x H) . 
    Saludos Trivial_HK]

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Subject: Unas felicitaciones por su sitio y una recomendacion(o petici≤n??)
	 Date: Wed, 23 Jun 1999 03:08:38 -0400
	 From: "Ankor" &lt;ankor2@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>


Bueno dear friends los felicito, sus documentos son super buenos para las
personas que como yo intentamos aprender algo mßs del mundo "E", me fue muy
grato encontrar su pßgina y echar mano de algunos(muchos) secretillos que
desconocφa, su "magazine" tiene un buen contenido pero se cae en un lado, el
formato, ya que si bie es cierto los primeros 2 numeros estaban en formato de
ayuda, lo que hacφa muy entretenido y muchoo mßs sencillo entender la
organizaci≤n de la revista, el resto de los numeros no tenφan esa opci≤n,
acepto que es verdad que la mayor(por no decir toda) parte de la gente posee
un editor de texto y no asφ win95( o un lector para archivos de ayuda en
formato chm), podrφan editar su revista en dos formatos, o por ultimo en
formato html y que incluyese frames, asφ yo la dise±arφa con 3 frames
...
otro con alt y anch *(el cuerpo), cosa que la harφa mßs sencilla (en el
...
ankor2@xxxxx.xxx
    ...
    diseño de paginas, solo hago lo que puedo XDD) ahora si te interesa 
...
pT2@bigfoot.com...(se que la IP va pero no he hecho nada malo)
...
Subject: :)
	 ...
	 From: ozono UnderGroup &lt;ozono_under@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com

"Hacky cumplea±os a  uds , hacky birthday a ustedes !!!! ..... que los
cumplan FeliZ"
...
feliz cumplea±os porque ustedes fueron y son nuestros mentores , y los de
muchos otros grupos chilenos , son una muestra de que en chile no somos unos
inutiles de mierda , por eso y mas ...feliz cumplea±os . a todos , aunque
...
pd =====> el nuevo mail es       ozono_under@xxxxx.xxx
y mi nuevo nick es Dude OverDrive , y mi mai lres dude_overdrive@xxxxx.xxx 

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Subject: Hackers San Miguel
	 Date: Mon, 5 Jul 1999 19:12:39 -0400
	 From: "Nicolßs Flores" &lt;nfloresj@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>
...
ya que los otros s≤lo copian textos de otras pßginas y se las dan de
Hack-Webmaster.

Quisiera pedirles que me contacten con hackers de San Miguel ya que quiero
aprender cada dφa mßs y conocer gente de aquφ.

Gracias y ííí sigan adelante !!!
...
Subject: SOLICITO LINUX
	 ...
	 From: "Sergio" &lt;compured@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>

Hola
Me encanta sus pßginas y e aprendido mucho sobre internet e informatica en 
general.
...
Me gustria comprarles el CD de Linux la ultima versi≤n en espa±ol y si tienen 
...
Les pido que me contesten a APOLOKS@xxxxx.xxx  o COMPURED@xxxxx.xxx y 
...
Ha yo me Llamo Sergio y soy estudiande de 4 a±o de Ingenieria de Ejec. en 
Informatica.
...
Creo que le Linux por lo poco que se de el es el S.O. dell ma±ana y hoy 
tenemos que darlo a conoser para terminar con el monopolio de la MS.
 
POR FAVOR ESCRIBAN LO MAS PRONTO POSIBLE YA QUE ESTOY ANSIOSO POR ┌SAR LINUX
...
Subject: 
	 ...
	 From: Tomas Saieg Paez &lt;tspspark@xxxxx.xxx>
		 To: proyecto_r@bigfoot.com
...
Bueno, como te gusto,  entonces creo ke me tendre ke poner en campa±a
...
Bueno, y ultima cosa,  Cuantos a±os tienen ???,  es decir,  cuando veo
la palabra hackers en Internet me imagino jovenes de 15 o 16 a±os, como
yo, pero luego veo los grupos y estan formados de gente de 25 e incluso
mas a±os... Yo ke con el colegio kedo chato,  como lo hacen uds para
hacerse de tiempo ???
...
diganme ke no me meto mßs). Son de Stgo??, y si estudian Informatica en
...
dispuesto a colaborar (con lo ke sea, graficos, web, etc). Me gustarφa
poder hacer eso por ke es la mejor forma de aprender.

    [Tkr: Ya lo has dicho, te encargamos el diseño de la web. ;)]
...
PD2: Se me olvido poner en la introducci≤n ke el libro esta basado en
...
introducci≤n tambien, tu veras como lo acomodas. (No  pongas la parte de
ke el libro es malo, no valla a ser ke me llegue una demanda... :-))
    ...
    piratas en la RED" de una editorial española... Buaaa la verdad es un 
...
Subject: Saludos
	 ...
	 From: Des Integrator &lt;desintegrator0@xxxxx.xxx>
		 To: Proyecto_r@bigfoot.com
...
Subject: 
	 ...
	 From: "darius" &lt;dariusfranciscus@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>
...
COMO FUNCIONA:
1) CONSEGUIR TELEFONO CELULAR (OJALA NOKIA 2160) ES M┴S FACIL
2) CONTRATAR SERVICIO DE LLAMADOS  CON TARJETA VALE 5 LUCAS Y TE REGALAN 
	 ALGUNOS MINUTILLOS
3) SALIR DEL RADIO DE FUNCIONAMIENTO DE LAS TARJETAS OSEA SALIR  DE LA REGI╙N 
...
9) SI SELECCIONAN NAM 1 Y APRIETAN (-)=SELECT  APARECERA 31810 NO HACER NADA, 
	 ...
	 OPCION  QUE M┴S ARRIVA "SERIAL NO." AQUI ESTA TODA LA CIENCIA YA QUE LOS 
	 CELULARES TRABAJAN CON ESTOS 2 CODIGOS QUE TIENEN UNA RELACION ALGO ASI 
	 COMO NOMBRE DE USUARIO Y CONTRASE╤A. EL PUNTO A JODER ES QUE AUN NO PILLO 
	 COMO CAMBIAR EL SW VRSION 
10) ESO DE NAM 2 3 ETC ES PARA A╤ADIR NUMEROS DE TELEFONOS AL MISMO PASWER 
...
Subject: hola yo soy de mexico
	 ...
	 From: "miguel fernandez" &lt;mfergu@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>
...
mi e-mail  es mfergu@xxxxx.xxx

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Subject: MKLINUX TEAM
	 Date: Tue, 10 Aug 1999 06:27:37 +0200 (GMT+02:00)
	 From: jose roberto flores rosales &lt;jrflores@xxxxx.xxx>
		 To: &lt;proyecto_r@bigfoot.com>
 ...
 Luego de tener alguna version solo con que me traigan el cd o por $1000 
 podria grabarle el S.O. a quie lo pidiera por estos lugares o mandarlo si 
 lo piden. 

 Envienme una respuesta a cd1999@xxxxx.xxx
...
GRANDES DUDAS sobre nuestros personajes preferidos de la infancia... 
  ...
  un dφa asignado de la semana para curtirse a Blancanieves? 
...
Colaboracion de Luis Andres Delgado Lisi±ska
Desde Cali - Colombia
...
Guayaquil-Ecuador
      ...
      Un hombre paga $2 por un producto de 1$ que necesita
      Una mujer paga $1 por un producto de 2$ que no necesita
...

...

JOPOxtJNgDatgX0AoM079AmxEqf3AsnFxGCzujx/p1/0
=KceG
...

...

=AUmh
-----END PGP PUBLIC KEY BLOCK-----
