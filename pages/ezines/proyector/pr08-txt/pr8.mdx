...
-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-
    ...
    &lt;XXXXXXX> Cucumber, viste que se hackearon la pagina del DIM?
    &lt;cucumber> no, xq? dame la URL
    &lt;XXXXXXX> http://www.dim.uchile.cl/
...
seguridad-nt-subscribe@onelist.com,  y no es por nada,  pero las noticias nos
...
proyecto_r-subscribe@onelist.com, os aseguro que no recibiras spam..!!! ;)
...
!                                                                           !
!::                                                                         !
!Resquest-Remailing-To: "direccion@destino.com"	                            !
!                                                                           !
...
servidor numero 1, en mi caso utilizare "anonim@hyperreal.art.pl".
...
!                                                                           !
!::                                                                         !
!Request-Remailing-To: anonim@hyperreal.art.pl                              ! 
!                                                                           !
!::                                                                         !
!Encryption: PGP                                                            !
!                                                                           !
...
!                                                                           !
!::                                                                         !
!Request-Remailing-To: mixer@nowhere.to                                     ! 
!                                                                           !
!::                                                                         !
!Encryption: PGP                                                            !
!                                                                           !
...
$remailer{"bruble"} = "&lt;bruble@amis.net> cpunk mix hybrid middle pgp pgponly latent ek ekx cut hash post repgp remix reord ext max test inflt75 rhop5 klen500";
...
$remailer{"canuck"} = "&lt;canmail@home.com> cpunk mix hybrid middle pgp latent ek cut hash post repgp remix reord ext max test inflt75 rhop6 klen1000";
$remailer{"cracker"} = "&lt;remailer@gacracker.org> cpunk mix middle pgp pgponly remix latent hash cut test ek ekx esub inflt50 rhop20 reord klen1024";
...
$remailer{"fitugmix"} = "&lt;mixmaster@fitug.de> cpunk mix pgp remix latent hash cut test ek esub inflt50 rhops20 reord post";
$remailer{"flash"} = "&lt;remailer@flashmail.com> cpunk pgp hash ksub esub latent cut ek reord klen64";
$remailer{"foebud"} = "&lt;remailer@foebud.org> cpunk mix pgp remix latent hash cut test ek esub inflt50 rhops20 reord";
$remailer{"gretchen"} = "&lt;gretchen@neuropa.net> cpunk pgp pgponly latent ek cut hash repgp ext max test inflt75 rhop6 klen1000";
$remailer{"hr13"} = "&lt;remailer@hr13.zedz.net> cpunk mix remix pgp hash middle latent cut ek pgponly test";
$remailer{"hyper2"} = "&lt;mix@hyperreal.art.pl> cpunk mix pgp remix latent hash cut test ek esub inflt50 rhops20 post"; 
$remailer{"jsbach"} = "&lt;jsbach@idirect.ca> cpunk pgp pgponly latent ek cut hash post repgp reord ext max test inflt75 rhop4 klen488";
...
$remailer{"magnet"} = "&lt;deldotb@juno.com> cpunk pgp pgponly cut ek hash klen64 post";
$remailer{"mccain"} = "&lt;mccain@notatla.demon.co.uk> mix middle klen200";
$remailer{"mid"} = "&lt;mid@lo14.wroc.pl> pgp mix middle";
$remailer{"mix"} = "&lt;mixmaster@remail.obscura.com> cpunk mix pgp hash latent cut ek ksub reord klen1000";
$remailer{"neo"} = "&lt;neo@karmadrome.prohosting.com> cpunk mix hybrid pgp pgponly latent ek ekx esub cut hash post remix reord ext max test klen500";
...
$remailer{"passthru"} = "&lt;mixer@immd1.informatik.uni-erlangen.de> mix middle";
$remailer{"quegati"} = "&lt;quegati.remailer@virgin.net> cpunk mix hybrid middle pgp latent ek ekx esub cut hash post repgp remix reord ext max test inflt10 rhop4 klen244";
$remailer{"redneck"} = "&lt;config@redneck.gacracker.org> newnym pgp klen1024";
$remailer{"replay"} = "&lt;remailer@replay.com> cpunk mix remix remix2 pgp hash latent cut post ek klen1000";
$remailer{"squat"} = "&lt;mixmaster@squat.net> cpunk mix pgp pgponly remix latent hash cut test ek esub inflt50 rhops20 post klen4";
$remailer{"squirrel"} = "&lt;mix@squirrel.owl.de> cpunk mix pgp pgponly remix latent hash cut test ek esub inflt50 rhops20 reord post";
...
$remailer{"swiss"} = "&lt;mix@remailer.ch> mix";
$remailer{"teatwo"} = "&lt;teatwo@notatla.demon.co.uk> cpunk middle pgp pgponly remix latent hash cut ek post klen200";
$remailer{"tempest"} = "&lt;tempest@gamebox.net> cpunk mix hybrid middle pgp pgponly latent ek esub cut hash repgp remix reord ext max test inflt75 rhop3 klen500";
$remailer{"tuttle"} = "&lt;harry_tuttle@remailer.freeserve.co.uk> cpunk pgp pgponly latent ek cut hash post reord ext max test inflt75 klen109";
$remailer{"widow"} = "&lt;Widow@wol.be> cpunk mix hybrid pgp latent ek cut hash repgp remix reord ext max test inflt5 rhop3 klen128"; 
...
pequeña  que  la  de  que las escuchas se traicionen a si mismas por un error
...
3a   .- IP Spoofing
3b   .- DNS Spoofing
3bi  .- Ataque DNS Spoofing nº 1
3bii .- Ataque DNS Spoofing nº 2
3c   .- E-Mail Spoofing
3d   .- IP Hijacking
3e   .- WEB Spoofing
...
El  spoofing en una  tecnica que  hace algunos años era muy utilizada por los 
...
despues de  20 años de  su puesta en funcionamiento. Esta es la parte que mas 
...
peticion DNS, tiene que ser el propio  DNS el que se encarga de añadir a cada 
...
recibiran como respuesta nuestra IP.
    ...
    Tan solo nos queda un  pequeño  detalle,  el  QueryID, esa identificacion 
...
Bien, lo  que vamos  a añadir a  este fichero  son solo  dos lineas, una para 
añadir  otro NS  al dominio  cdlr.org y otra en la que asignamos una IP a ese 
nuevo NS, que sera la del atacante. O sea que añadiremos estas dos lineas:
...
hemos añadido  y hacer correr un programa en nexus.cdlr.org que permita meter 
...
- Si  configuramos  nuestro cliente de correo de manera que al mandar un mail 
  en  el  FROM  ponga  que  es   de  root@server.com  y  en  el  REPLY  ponga 
  mi_correo@de_verdad.com  ( una cuenta anonima claro ) y se lo mandamos a un 
  usuario  contandole  cualquier  historia  para que nos mande su contraseña, 
...
- Otra manera,  hacemos lo mismo que en la anterior pero cambiando tambien el 
  REPLY y haciendo  que el usuario  cambie la contraseña por una que le damos 
...
No me apetece seguir escribiendo mas de esto, ademas, tengo sueño,... ZzzZZzz
...
de contraseña incorrecta y se conecte al hotmail veridico. Despues dejamos la 
maquina con la pagina spoofeada en  el navegador y como toda la peña que va a 
...
La compañia de  Bill se  quedo tranquila  hasta que  hace un par de meses una 
compañia llamada NTA-Monitor, descubrio  que el nuevo algoritmo de generacion 
...
La  compañia que  descubrio este bug, NTA Monitor, difundio una tabla con los 
...
La prediccion de los numeros de secuencia se arreglo alla por el año 95 ( mas 
...
-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-:-
     ...
     ..--::  09.  Programacion en el shell bash, segunda entrega  ::--..
                       By: TeeSPy / Mail: teespy@cdlr.org
...
6.- Otras cosas importantes
    ...
    script "echo don $5 su pedido". Alli,  el  shell  creeria  ke  $5  es una
...
Como siempre, dudas y comentarios a teespy@cdlr.org
...
impresoras) Mensajería Etc ..  Estos servicios muchas veces no los utilizamos
...
una fuerte auditoría en este directorio ya que es un medio bastante simple de
...
existe  un pequeño risgo de seguridad.  No instalar Otros sistemas operativos
...
que estos sean capaces de instalar aplicaciones dañinas o correr aplicaciones
...
Bueno estas son algunas de las cosas que yo  considero  mas  críticas  y  que
...
plaxius@cdlr.org  Estoy pensando hacer un articulo de como auditar WINNT para
...
íEureka!  Ya pude entrar a Internet cuando menos podre entrar en los momentos
...
* Keyboard  layout:  Info  sobre  el  teclado,  DLL  como  se  disponen,  son
  ...
  Ej;  HKEY_CURRENT_USER\RemoteAccess\Profile\Miconexi≤n.
...
direccion,  en  mi  caso "C:\WINDOWS\Escritorio\Regedit_Prac\2.ico".  Existen
...
(configure &lt;aki deveria aparecer el nombre de tu modem> (ld 0
(io 0 (base &lt;la  ubikacion de tu modem algo asi komo "0x02f8" (si no la sabes 
ubikala en tu wirdows)>))
(int 0 (irq &lt;el irq de tu modem>(mode +e)))
(act y)
))
(waitforkey)
...
debajo de la linea /sbin/isapnp /etc/isapnp.conf
                   /bin/seterial -v /dev/modem port &lt;ubikacion de tu modem> 
		   &lt;irq de tu modem>
...
PuNkYx:	punky@antisocial.com (viene con su personalidad)
MoonSpell:  moonspell@cdlr.org 
...
adicional  y  ademas  puede  mejorar  el desempe±o en la respuesta de la red. 
...
El servidor proxy puede utilizarse para mejorar el  desempe±o  de  la red por 
...
basandose en una formula que utiliza el tiempo, popularidad y tamaño  de  los
...
actualizados  la  mayor  parte  del tiempo. Y mejorando el desempeño  en  los
...
Articulo de MercΦ Molist (saludos de tonik...)
...
&lt;STYLE>.  La vulnerabilidad esta  presente  si  el  usuario  emplea  Internet
Explorer 5.0 o Netscape Communicator 4.x (aunque la forma de llevar a cabo el
ataque es diferente dependiendo del navegador). El ejecutar codigo JavaScript
cuando  el  usuario  abre  un  mensaje puede permitir mostrar una pantalla de
acceso falsa de tal forma que cuando el usuario introduzca su contrase~a esta
sea robada.

Georgi  Guninski  tambien  esta  convencido  de  la  posibilidad  de leer los
mensajes del usuario atacado,  enviar mensajes empleando su  cuenta  y  otras
muchas acciones semejantes.  Hace aproximadamente un a~o,  cuando se demostro
la posibilidad de  robar  contrase~as  empleando  codigo  JavaScript  Hotmail
implemento  diversos  filtros  para buscar etiquetas JavaScript dentro de los
mensajes y dejarlas inoperativas.

Tras esta  limitacion,  se  encontro  que  el  codigo  JavaScript  podia  ser
implementado  con  el  mismo  resultado  en las etiquetas de cabeceras de los
mensajes e-mail.  Rapidamente Microsoft volvio  a implementar un nuevo filtro
que  eliminaba  todo  tipo  de scripts y elementos peligrosos de los mensajes
entrantes.   Pero  Guninski  ha  encontrado  otra  forma  de  saltarse   esta
proteccion, al incorporar el codigo en las etiquetas de estilo.

Como  se  comprueba  en la demostracion del autor,  el ataque se lleva a cabo
mucho mas facilmente si el usuario utiliza Internet Explorer  5,  que  si  su
navegador es Netscape Communicator.
...
Subject:
   ...
   From: "anonymus under" &lt;lista_correo@xxxxx.xxx>
...
nuestra libertad, asi como yo hay muchos y como dice &lt;the mentor>...
...
íííííííííííí LA INFORMACION ES CULTURA.............
...
Subject:  Nu y la (in) seguridad de windows
   ...
   From:  Desintegrator &lt;desintegrator0@xxxxx.xxx>
     To:  Proyecto_r@bigfoot.com
...
Subject: Salutez!
   ...
   From: "Alejandro Lopez" &lt;KlAmATh@dxxxxx.xxx>
     To: &lt;proyecto_r@bigfoot.com>
...
nuestro peque±o  grano  de  arena , sobre  Bl00dmagazine  podrias enviarlas a 
...
Subject:  Manga.... hola y etc...
   ...
   From:  "sargatanas yopez" &lt;tintito@xxxxxxxx>
     To:  proyecto_r@bigfoot.com
...
Pido  perdon  por  mantenerme  al   margen muchos a±os antes... pero nunca es
tarde.
...
wea y  llego al final y veo QUEíííííííííí un numero 800 que COOL me ponego en 
campa±a de conectrame a vcer si la wea me funciona y esto me paso

conecctando

comprobando  numero  de  usuario y contrase±a (bamos bien) y depronto sale un 
...
otro numero (N-8) gracias desde yaíííí
...
Subject: So±e con Linux ...
   Date: Mon, 18 Oct 1999 14:56:15 CLST
   From: "toshino rex" &lt;toshinorex@xxxxx.xxx>
     To: proyecto_r@bigfoot.com

(anoche so±e con que tenia linux en mi pc y que mi pc era feliz.)
...
6.0  y  Red Hat Mandrake 6.0. Entonces le pregunte a la se±ora que me atendio
...
office  y  que  red  hat  no  traia nada. Entonces le dije a la se±ora que me
...
3.- Como configura linux mis tarjetas.
    ...
    *Bueno,  linux no configura el hardware eso lo tiene que hacer uno por si 
    ...
    ahorro un poco de trabajo, pues viene en espa±ol y con menu.*
...
6.- Yo grabo cds. Puedo grabar cds desde linux.?
    ...
    *Si  se  puede  grabar  desde  linux  pero  te  aconsejaria que visitaras
    http://linux-es.uio.no/ donde  esta  mucha  documentacion en espa±ol para 
...
9.- Linux solo esta disponible en Ingles ?
    ...
    *No  tambien  esta  en aleman y otros idiomas mas dificiles pero creo que 
    Suse 6.2 ya tambien esta en espa±ol.*
...
18.- Donde consigo un buen manual, libro o documentacion  en  espa±ol  que me 
...
por eso te pido que publique mi dire. rygor@chilemix.com y si no te gusta
...
Subject: Holaps!!
   ...
   From: "Francisco Bustos" &lt;waynet98@xxxxx.xxx>
     To: Proyecto_R@bigfoot.com
...
Subject: Saludos Terricolas...
   ...
   From: "Rolando Barraza" &lt;rola2h@xxxxx.xxx>
     To: &lt;proyecto_r@bigfoot.com>
...
el numero 8.
    ...
    Tambien quiero que conozcan a quien me ha ense±ado algunas cocillas el es
...
From: "Francisco M." &lt;f_melmena@xxxxx.xxx>
To: &lt;proyecto_r@bigfoot.com>
...
claro  en  la pagina.  Mi  e-mail  es  f_melmena@hotmail.com  espero  que  me
...
Subject: Crackers Chilenos ..
   ...
   From: "Kr@cKerZ United Team 99" &lt;kayut99@xxxxx.xxx>
     To: "Freix" &lt;proyecto_r@bigfoot.com>
...
http://go.fast.to/esteban
    ...
    nopidancosas@quenolesvamosadar.com  una  semana  antes  y  te  reservamos
    el sitio ok..???]
...
Subject: lastima!!
   ...
   From: "John Stwart" &lt;apostoles@xxxxx.xxx>
     To: proyecto_r@bigfoot.com
...
Subject: hola Proyecto R
   ...
   From: "Tony Baldessari" &lt;mr_nukem@xxxxx.xxx>
     To: proyecto_r@bigfoot.com
...
yo  tengo una version del Linux Red Hat 5.1 en español (El Eurielec no se que
version, de  una revista  de España),  el Red Hat 5.0 en Ingles y el Unix SCO
...
pedidos, lo que sea
mandalo a mr_nukem@xxxxx.xxx  

:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::

From: "Mastroianni" &lt;chocko@xxxxxxxx>
To: proyecto_r@bigfoot.com
...
la pregunta de tal suerte que no pueda salir con una de sus vulgaridades:
 ...
 -  Ya me acorde: "íQue buen culo que tenes, perra!"
 ...
 inspector y le dice:
 -  íííConcha de tu madre, si no sabes para que mierda soplas!!!
