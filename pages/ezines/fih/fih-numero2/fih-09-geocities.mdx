...
te pone tambiΘn es fßcil de quitar, lo veremos despuΘs. 
...
consciente, pues se le ha avisado en mßs de una ocasi≤n pasando olimpicamente del tema. Pero para 
aquellos que pudieran tener alojada una web en geocities, tal vez, pueda resultar interesante.

Si nosotros abrimos una cuenta en www.geocities.com, con el user pepita (por ejemplo) tendrφamos la 
pßgina www.geocities.com/pepita, pero los servidores de geocities, estan enlazados entre si a travΘs 
del mundo. Aquφ esta el fallo. MΘxico, Espa±a, y Usa, estan unidas, separadas de Italia y Francia. 
┐QuΘ ocurre con esto? que si otra persona en Mexico, se ingresara con el nick pepita en 
www.mx.geocities.com, y fuera a su pßgina de administraci≤n de la web que ofrece el servidor, y 
entrara con su pass, en el navegador le quedaria una direcci≤n tal que asφ 

http://mx.geocities.com

Si esta persona, quitara el mx de su navegador y le diera al enter quedarφa:
...
instantaneamente, accederφa a la cuenta de pepita en Espa±a, sin necesidad de pass, y pudiendo cambiar 
...
pßgina de administraci≤n web :S, se pasa a la pßgina de administraci≤n web del otro servidor, 
directamente, asφ hasta tres, con las opciones de modificar contrase±a, pass, correo, etc.

Esto es posible gracias a la mala administraci≤n de los servidores de yahoo, que no se enteran. C≤mo 
he mencionado tal fallo les fue comunicado por evilgirls hace mßs de un a±o, sin que hayan hecho nada 
...
serφa este que se pone al final del html:
