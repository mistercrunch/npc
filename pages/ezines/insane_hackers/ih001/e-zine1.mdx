...
+--------------------------------------------------------------------+
 ...
 ====================================================================
    ...
    y a enseñar a todos akellos interesados en el lado obscuro de
...
novela llamada "Neuromancer" o "Neuromante(en espa±ol)" escrita por el
...
chateando en el canal #linux de irc.ciudad.com.ar (donde me pueden
...
Ya sabemos que una IP no puede pasar este limite 255.255.255.255, por lo
...
#mandrake       elgarca      ~elgarca@200.5.120.129 

/who 200?5?120?229

#linux       pete      ~pete@200.5.120.229

Y aqui finalmente podemos ver que la IP de "pete" es 200.5.120.229 .
...
pete ~pete@XXXXXXXXXX.arnet.net.ar
#linux   #gay-argentina
...
~pete@XXXXXXXXXX.arnet.net.ar

en realidad es algo como esto pero oculto:

~pete@host024428.arnet.net.ar
...
/dns ~pete@XXXXXXXXX1.arnet.net.ar

#mandrake       elgarca      ~elgarca@XXXXXXXXX1.arnet.net.ar 
#solos          nkt          ~nkt@XXXXXXXXX1.arnet.net.ar
#river          el10         ~el10@XXXXXXXXX1.arnet.net.ar

no tenemos exito asi que seguimos probando hasta llegar al 8 donde
si tenemos suerte y nos aparece:

/dns ~pete@XXXXXXXXX8.arnet.net.ar

#linux       pete      ~pete@XXXXXXXXX8.arnet.net.ar
...
/dns ~pete@XXXXXXXX18.arnet.net.ar

#linux       pete      ~pete@XXXXXXXX18.arnet.net.ar

/dns ~pete@XXXXXXX218.arnet.net.ar

#linux       pete      ~pete@XXXXXXX218.arnet.net.ar

/dns ~pete@XXXXXX4218.arnet.net.ar

#linux       pete      ~pete@XXXXXX4218.arnet.net.ar

/dns ~pete@XXXXX84218.arnet.net.ar

#linux       pete      ~pete@XXXXX84218.arnet.net.ar

/dns ~pete@XXXX084218.arnet.net.ar

#linux       pete      ~pete@XXXX084218.arnet.net.ar
...
"host084218.arnet.net.ar", y ahora ustedes me diran para que quiero el
...
[root@CAOS /]# ping host084218.arnet.net.ar

y cuando empezemos a recibir una respuesta del siguiente tipo sabremos
cual es la IP:

PING host084218.arnet.net.ar (200.5.120.229) from 127.0.0.1 :
56(84) bytes of data.

64 bytes from 200.5.120.229: icmp_seq=0 ttl=255 time=0.1 ms
64 bytes from 200.5.120.229: icmp_seq=1 ttl=255 time=0.1 ms
64 bytes from 200.5.120.229: icmp_seq=2 ttl=255 time=0.1 ms
64 bytes from 200.5.120.229: icmp_seq=3 ttl=255 time=0.1 ms
...
de irc.ciudad.com.ar donde paso muchas noches riendome con amigos.
