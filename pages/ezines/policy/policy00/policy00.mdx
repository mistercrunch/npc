...
quivos com a mesma rotina usada para criptografar as senhas.
        A criptografia de arquivos e o correio eletrônico podem ser combinados
...
garantir sua privacidade, para encapsulálo em um atributu archive, para compa-
...
previa aquiescencia da pessoa a que se referem. 
     ...
     º 1o  toda pessoa cadastrada dar-se-a conhecimento
das informacoes pessoais armazenadas e das respectivas fontes. 

     º 2o  assegurado ao individuo o direito de retificar
qualquer informacao pessoal que julgar incorreta. 

     º 3o Salvo por disposicao legal ou determinacao judicial
...
a sua validade. 
     ...
     º 4o Qualquer pessoa, identificando-se, tem o direito de
...
multa. 
     ...
     º 1o Se o acesso se faz por uso indevido de senha ou de
processo de identificacao magnetica de terceiro: 

Pena - detencao, de 1 (um) a 2 (dois) anos, e multa. 

     º 2o Se, alem disso, resulta prejuizo economico para o
titular: 

Pena - detencao, de 1 (um) a 3 (tres) anos, e multa. 

     º 3o Se o acesso tem por escopo causar dano a outrem ou
obter vantagem indevida: 

     Pena - detencao, de 2 (dois) a 4 (quatro) anos, e multa. 

     º 4o Se o sistema ou rede integrada de computadores
...
do º 4o, do art. 18 e art. 29, em que a acao e publica
incondicionada. 
...
reveste, hoje, de enorme importΓncia para a sociedade brasileira.
Acreditamos, tambem, que a sua relevΓncia devera aumentar, na
