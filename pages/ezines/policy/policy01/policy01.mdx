...
grandes, exigindo muita tecnica e pericia das pessoas que iriam opera-las.
        Com o surgimento dos famosos ∩micros∩, o mercado de mainframes entrou
...
#
        ...
        Bem voce deve ter entendido que, caso erro ∩exit 1∩, e caso sucesso
∩exit 0∩ contribui para essa saida do $?. Leia os parametros a cima para maior
informacao.
...
e apresenta o estado dos agentes nos varios nos(nós) gerenciados.
