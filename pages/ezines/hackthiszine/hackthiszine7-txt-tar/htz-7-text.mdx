...
```
"You want a seriously righteous hack you score one of those Gibsons man. You 
...
average of two days off a month.  A worker daring to take a Sunday offΓÇöwhich is 
supposedly their weekly holidayΓÇöwill be docked 2 % days' wages.  Including 
...
FridaysΓÇöa small chicken leg and foot.  For breakfast, they are given watery rice 
...
EQUIPMENT 
ΓÇó2.4 GHz 24 dBi High Performance Die Cast Reflector Grid Wireless LAN Antenna 
(Directional Antenna)
ΓÇóHyperAmp┬« AP 1 Watt 2.4 GHz 802.11g (b/g) Compatible Outdoor Bi- Directional 
WiFi Amplifier with Active Power Control 
ΓÇóN-Male to N-Male: 400-Series Cable 30 feet 
ΓÇóN-Female to N-Female Bulkhead 0-6 GHz Lightning Surge Protector 
ΓÇóN-Male to N-Male: 400-Series Cable 25 feet 
ΓÇóN-Male to Reverse Polarity TNC Plug: 400-Series Cable 2 feet 
ΓÇó2 Linksys WRT54GL v 1.1 routers ΓÇô one acting as a bridge and the other acting 
as an AP.
...
Troubleshooting 
ΓÇó	On a WinXP OS use IE explorer instead of Firefox or clear the cache on 
Firefox if it seems that changes aren't saving. 
ΓÇó	Use http not https when browsing to the IP addresses. 
...
4.	Go to the Setup Tab > Basic Setup 
	...
	h.	Click "Apply" ΓÇö triggers reboot.
...
3.	Go to the Setup Tab > Basic Setup 
	a.	Internet setup: Automatic Configuration ΓÇô DHCP 
	b.	Network setup 
