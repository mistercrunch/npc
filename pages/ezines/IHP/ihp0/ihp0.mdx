...
|+******************************************************************************+|
|                                                                                |
|Ciao! Sono Mister Baison. La mia voce è il mio passaporto. Verificatemi.        |
|                                                                                |
|eeeehmm...                                                                      |
|mi sono lasciato prendere la mano! Non mi dite che non avete scoperto da dove   |
|proviene la frase che scritto sopra perkè dovreste essere linciati!!! Ma        |
|dai è la frase registrata sul tesserino dei sistemi di sicurezza "Bada a come   |
|parli" del famosissimo film "I signori della truffa"...                         |
|vabbè vi consiglio vivamente di vederlo!                                        |
...
|aveva un'avventura da raccontare... alla fine ci siamo detti: "Perkè non        |
...
|Essì, perkè io, dopo aver militato ufficialmente in un bel po' di riviste       |
|(ufficialmente, perkè ho visto fare di tutto con i miei arts nella rete         |
...
|solo file di testo i migliori art apparsi su LIP più ovviamente quelli scritti  |
...
|Ahahahah il nome è nato in chat quando tutti e 3 abbiamo detto una parola       |
|diversa per creare il nome della zina... ed è venuto fuori IHP. [Io ho detto    |
|hard perkè sono tosto... hihihihihihi (ma stai zitto che sei una mezzasega      |
|ndLettore)].                                                                    |
|                                                                                |
|Benone penso di aver detto tutto, poi vojo vedere ki si leggerà tutta sta roba  |
|perkè io delle intro delle riviste che conosco penso di aver letto al massimo   |
...
|    In ogni caso, Φ tempo che vi faccia capire a cosa potrebbe servirvi         |
|    il suddetto articolo: Φ un articolo teorico-pratico sulle amate             |
|    numerazioni verdi, sviscerate nel migliore dei modi (...).                  |
|    Vi ricordo che qui non ci sono veritα assolute, ma risultati                |
|    sperimentali che sono usciti fuori da scanning e dall'analisi               |
|    (peraltro incompleta) dei green sull'elenco telecom. Noterete               |
|    senz'altro che le altre sezioni (com'Φ ovvio) non sono curate come          |
|    la sezione green tradizionale (800xxxxxx). Per finire, far≥ un uso          |
...
|    illegale. Il lettore in nessun modo dovrα utilizzarle per scopi             |
|    illegali. L'autore declina ogni responsabilitα derivante dall'uso           |
...
|    vero? Bene, se Φ cos∞ possiamo cominciare (se non dovesse essere            |
|    cos∞, ripassate sull'elenco Telecom, sezione Numeri Intelligenti).          |
|    Per prima cosa spieghiamo cos'Φ una numerazione: una numerazione            |
|    pu≥ essere considerata come una regola che noi applichiamo nella            |
...
|    server). Il metodo pi∙ semplice per trovare un green attivo, per            |
|    chi non ha conoscenza delle numerazioni Φ sfogliare l'elenco                |
|    Telecom, che presenta i green in ordine alfabetico, vistosamente            |
|    poco funzionale per i nostri scopi. Ma al di lα di questi numeri            |
...
|    sarα, senza nulla togliere ai green in elenco (anche se buona               |
...
|     meglio riprender≥ un passo dall'avantielenco: (elenco Telecom              |
...
|    non sono affatto queste. Chissα, col tempo potrei cadere di nuovo           |
|    in errore, com'Φ naturale parlando di argomenti di questo genere.           |
|    Queste prime due numerazioni (800xxyyzz e 800xyzxyz) sono solo              |
|    l'inizio del nostro viaggio, indubbiamente importanti, ma non               |
|    le pi∙ importanti. Con la citazione che seguirα, converrete                 |
...
|                    numerazione 80087xxxx, tant'Φ che in un primo               |
|                    tempo ero quasi portato a pensare che fossero la            |
|                    stessa cosa, ma mi sbagliavo. La prossima                   |
|                    numerazione vi dimostrerα in maniera lampante le            |
|                    mie affermazioni.                                           |
|                                                                                |
|      [80087x167]   ...>                                                        |
|                                                                                |
...
|    avevo fatto. Al di lα della numerazione 80078xxxx, che Φ                    |
|    importantissima, c'Φ anche una incredibile cazzata che questa               |
...
|    perdonarmi...                                                               |
|                                                                                |
|    Quindi, riassumendo: ora sapete cos'Φ una numerazione, avete una            |
...
|              ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                      |
|                                                                                |
|    Ovviamente, come giα accennato ne 'La guida inutile' ci sono                |
|    variazioni su variazioni delle prime due numerazioni, che siete             |
|    benissimo in grado di intuire (ad esempio 800-123-124). Vi                  |
|    ricordo che questa parte teorica Φ in continua evoluzione,                  |
|    e per questo aspettatevi sempre qualche novitα. Per quanto                  |
...
|    -----------------------------------------------------------------           |
|                                                                                |
|    Eccoci arrivati alla parte pratica (non vi aspettate granchΦ, ci            |
...
|    1000 numeri, ed Φ il venticinquesimo (si riconduce ad un numero             |
|    di 3 cifre) e compare in elenco (per forza, l'ho preso da l∞ :D).           |
...
|    ma come si pu≥ notare, questa Φ una variazione (affermazione                |
...
|    numerazioni: hanno pi∙ numeri attivi (se invece prendeste dei               |
|    numeri fatti a caso che contengano il 25, Φ molto difficile                 |
...
|    precedenti, ma presenta anche una particolaritα: dal tono di                |
|    chiamata intuiamo che si tratta di un numero che non chiama in              |
|    Italia, ma in un punto della rete mondiale non definito. Il                 |
|    segno distintivo di questi green Φ la parte 87xxxx, che li                  |
|    accomuna. Com'Φ ovvio green di questo tipo possono appartenere              |
...
|    -----------------------------------------------------------------           |
|                                                                                |
|    Questa sezione tratterα di numerazioni gratuite ma meno note di             |
...
|                         L'utilizzo standard di queste numerazioni Φ            |
...
|                         blue-box o, pi∙ semplicemente venendo in               |
...
|    che il numero Φ cambiato e che fino al 31 dicembre verrete                  |
...
|                      nulla. Chissα se un domani la situazione                  |
|                      migliorerα (o pi∙ probabilmente questi numeri             |
|                      verranno soppressi). Se avete problemi con la             |
|                      vostra famiglia tuttavia non ignorerete                   |
|                      l'19696, il Telefono Azzurro...>                          |
|                                                                                |
|    Anche qui nessuna novitα, forse anche perchΦ non spero nemmeno              |
...
|                     non li nomina neppure. Tempo fα, data la                   |
|                     semplicitα della numerazione (1000 numeri)                 |
...
|                     forse la rianalizzer≥...>                                  |
|                                                                                |
|    Beh, su questa numerazione invece ora ci sono novitα. Non                   |
...
|                                                                                |
|    <...x ringraziarti se non li sai giα ti risparmio un p≥ di                  |
...
|                                                                                |
|     poi c'Φ il 998 Prova Rete Intelligente Telecom...>                         |
|                                                                                |
|     Questo Φ veramente tutto sulle numerazioni alternative.                    |
...
|     possibile ed immaginabile, non resta che fermarci a riflettere (giα        |
|     immagino un coro di 'Noooo' che si rivolge al sottoscritto...).            |
|     L'argomento Φ interessante e qualche mese fa mi capit≥ di parlarne         |
|     via e-mail (un altro??? Ebbene s∞!) con kArGHeTTo che mi ha fornito        |
|     un ottimo spunto di riflessione (mi spiace se non ti ho scritto pi∙        |
...
|      Φ quasi finita, infatti, prelevando alcunoi green ci siamo resi           |
...
|      io almeno credo che sia cos∞, tu che ne pensi???>                         |
|                                                                                |
|      Non voglio assolutamente fare un copia-incolla con la mia risposta        |
|      (anche perchΦ sarebbe esagerato ed inutile), visto che potete             |
...
|      aziende abbiano facoltα di scegliere la numerazione disponibile           |
|      che pi∙ le aggrada, escluse quelle riservate e le mnemoniche.             |
|      E' un problema complesso che Φ molto lontano dalla sua soluzione          |
...
|      questo art in tempi brevissimi (se l'art fa schifo Φ colpa tua :PP)       |
|      ed al mitico Zapotecz (la foto ricordo dello smau sarα un ricordo         |
|      da mostrare alle generazioni future :DDD).                                |
|                                                                                |
|      That's all...from lsdmaster (the dark side of the moon)                   |
|                                                                                |
|                                                                                |
|      coming soon (non troppo per≥ :PPP) 'La guida inutile al phreaking3'       |
|                                                                                |
|                                                                                |
|                                                                                |
|                                                                                |
...
|improvvisa del mio pene (le creme delle TV funzionano davvero!) bensì di un     |
|green alquanto strano: provando a chiamare a caso mi è capitato di comporre     |
|800-ITALIA <--- ITALIA = 482542 sequendo le lettere sui cellulari. Il numero    |
|è abbastanza strano 800-482542, se seguite le riflessioni riguardo le           |
...
|rilevante, ma se provate a chiamare vi risponderà un tipo od una tipa!!!        |
...
|UNA FAMIGLIA? Da numero verde? Com'è possibile? Tutto era strano anche per      |
|la famiglia stessa... ma la cosa più bella è che io e i miei amici ce ne        |
...
|che avrei dovuto indagare! Ora siccome a me non va' più di abbozzare strane     |
|teorie (tipo kuella per la numerazione 800-87XXXX) e quindi mi sono chiesto     |
|se è possibile che a volte le numerazione prendono indirizzamenti sbajati se    |
...
|Bene per ora ho concluso, se non mi credete è per la serie TRY AT HOME, cioè    |
...
|       gruppo punk, poi per≥ ha la majetta degli Slipknot, e esegue             |
...
|                                                                                |
|In questo articolo vi spiegher≥ come realizzarvi una beige box coi              |
|controcazzi, in modo talmente semplice che anche qualche essere non             |
|pensante (ad esempio il mio compagno di classe che Φ riuscito a                 |
|studiare la letteratura dal piano dell'opera del testo...) possa                |
|riuscire a capire...                                                            |
|Non vi spiegher≥ nulla riguardo le centraline, quella Φ un'altra                |
|storia...                                                                       |
|Bene si pu≥ iniziare... aspettate un attimo ke, tra un morso e un               |
|altro, vado a fare pip∞...                                                      |
|                                                                                |
|Eccomi! Stavamo parlando delle cosce di Alessia Mancini?                        |
|NO!                                                                             |
|                                                                                |
|Innanzitutto cos'Φ una beige box? Nulla di + semplice: Φ un telefono!           |
|Si proprio cos∞, non so' proprio perkΦ dovessero chiamare un telefono           |
...
|PerchΦ Paperino va' in giro col culo di fuori, e poi quando esce dalla          |
|doccia, porta l'asciugamano alla vita?                                          |
|Ah forse perkΦ gli armadi-centralina dei tempi andati erano beige???            |
...
|  |£££|   | £££ | <--|                                  quelli veri!!!)         |
|  |£££|   | £££ | <--|___Tastierino numerico       (Ma dai!Addirittura!         |
|  |£££|   | £££ | <--|                                       ndLETTORE)         |
|  |£££|   | £££ | <--|                                                          |
|  /   \   |     |                                                               |
| | ::: |  | ::: | <--|___Microfono                                              |
| | ::: |  | ::: | <--|                                                          |
| '--)--'  '--)--'                                                               |
|    (        ( ^---Solitamente Φ presente un tasto per agganciare               |
|    )        )                                                                  |
|    (        ( <---Doppino telefonico                                           |
|    )        )                                                                  |
...
|Molto spesso alcuni telefoni sono facili da riparare, magari si Φ               |
|strozzato il doppino telefonico, oppure il tasto per l'aggancio si Φ            |
...
|o sostituibili.                                                                 |
|                                                                                |
|Attenzione! Sia per altoparlante che microfono perchΦ non portarsi via          |
...
|                                                                                |
|Tastierino: Chiaramente sostituirne uno, per chi Φ alle prime armi,             |
|potrebbe essere un po' impegnativo, ma tutti c'avete il classico amico          |
|elettronico che vi pu≥ dare una mano!!!                                         |
|                                                                                |
|Vi consiglio di operare direttamente sulla scheda principale del                |
|telefono: quindi dissaldate i fili elettrici e sostituiteli, dopodicchΦ         |
...
|                                                                                |
|Per ora Φ tutto, pi∙ avanti parleremo di implementare altre cose fiche          |
|tipo led lampeggianti, monitor di rete, antenne satellitari, caffΦ,             |
|doccia, e fa anche pizze e pizzette per tutta famiglia e io non mi              |
|stanko pi∙ a fare da mangiare! E si pulisce anche da solo.                      |
|                                                                                |
|BELLA BAISOOOOOOOOOOOOOOOOOON                                                   |
|                                                                                |
|Si grazie le mie battute sono una figata!                                       |
|                                                                                |
|VabbΦ ho reso l'idea quindi a presto!!!                                         |
|                                                                                |
|                                                                                |
|                                                                                |
|                                                                                |
...
|[ di carta (e pi∙ precisamente sono quelli che iniziano per 6xxx e il      ]    |
...
|[ l' ATR Φ 9000. Osserviamo ora un paio di esempi:                         ]    |
...
|[ riferisce al baud rate seriale di 9600 BPS). Se non c'Φ il clock interno ]    |
...
|[ Sempre per il fatto che T=0 si spiega perche' non c'Φ il byte TCK.       ]    |
|[                                                                          ]    |
|[ ### TA1, TB1, TC1, TD1 ###                                               ]    |
...
|[                                                                          ]    |
|[ Ragionando in esadecimale, ogni byte pu≥ avere un valore da 00 a FF.     ]    |
...
|[ Cmq Φ raro che un comando tipo 'xx 00 00 00 00' provochi qualcosa di     ]    |
...
|[                                                                          ]    |
|[ Cosa c'Φ rimasta da fare? Beh fino ad ora abbiamo fatto poco e nulla :)  ]    |
...
|[ C'Φ da dire che il logger e' un interfaccia semplicissima... in pratica  ]    |
...
|[   00 <- questo credo che non centri nulla... sarα un errore.             ]    |
|[                                                                          ]    |
...
|[ comando di INPUT; se invece dopo l'ack c'Φ una risposta allora e' di     ]    |
|[ OUTPUT.                                                                  ]    |
|[ Un esempio                                                               ]    |
|[ -> D0 A4 00 00 02                                                        ]    |
|[ <- A4                                                                    ]    |
...
|[ sembra familiare... mi ricordano un p≥ le sim GSM.                       ]    |
...
|[ File? si file... La memoria delle simcard (e non solo) Φ organizzata in  ]    |
|[ file: Questi si dividono in MasterFile (MF), DedicatedFile (DF), e       ]    |
|[ ElementaryFile (EF). Lo card GSM sono cos∞ organizzate:                  ]    |
|[                                                                          ]    |
|[                  [MF]----------------,                                   ]    |
|[               ____||____             |                                   ]    |
|[              |          |          [EF1]                                 ]    |
...
|[ ad uno... ma per questo primo episodio basta cos∞. Mi fermo sul pi∙      ]    |
|[ bello... lo so... ma ho anche io bisogno di ripassarmi un p≥ di cosucce. ]    |
...
| svariate cause: 1) conoscete lsdmaster (quest'Φ grave!!!); 2) siete            |
| stati costretti da lsdmaster (quest'Φ peggio); 3) non avete un cazzo di        |
...
| hanno riscontrato disturbi psico-somatici (:PPP) ; 2) sapete giα che           |
...
| racconto, il mio indirizzo e-mail Φ 'lsdmaster_telecoma@hotmail.com'           |
| (tranne che per osservazioni come: "Questo racconto fα schifo" "Hai            |
...
|                                                                                |
| Anno 200x, nella sconfinata campagna abruzzese. Un contadino stα cantando      |
| con la zappa nelle mani, la felicitα nello spirito ed i Pink Floyd nelle       |
...
| ritornare. La sua giornata Φ finita e lui torna a casa, con in testa           |
...
| intatto: "Boh, chissα di chi Φ? Mah, comunque sia lo riporto a casa, cos∞      |
| per lo meno mia figlia la smetterα di rompere con questa sua voglia di         |
| cellulare. Ai miei tempi si viveva di pane, amore e lavoro. Com'Φ              |
| cambiato il mondo...". Tornato a casa lo ripone sul tavolo della cucina,       |
| saluta moglie e figlia e vα a lavarsi. La figlia vede il vecchio motorola      |
| e pensa: "E vabbΦ, sempre meglio di niente.". Lo accende, ne prova il          |
...
| toccherα comprare il carica-batterie, per≥ sembra apposto. Chissα dove         |
| lo ha preso papα...". Il giorno seguente si dirige verso un centro             |
...
| realtα era molto pi∙ conosciuto come lsdmaster, ed il suo attuale lavoro       |
| gli serviva solo per acquisire informazioni riservate da sfruttare nella       |
| sua attivitα di phreaker. Quel giorno, mentre rischiava il posto a causa       |
| della sua passione per i Pink Floyd (aveva attaccato all'impianto del          |
| negozio il lettore cd solo per sentire 'One of this days') arriv≥ una          |
| ragazzina con un cellulare motorola nella mano. Scosso dall'inconsueta         |
| presenza femminile diviene di colpo il commesso pi∙ professionale di           |
...
| torna il phreakkettone di sempre: "Ma lei non aveva giα un'altra               |
| scheda?" "Veramente s∞, eccola qua" "Beh, noi stiamo rottamando le sim         |
| che non servono pi∙ e se lei me la consegna potrei farle uno sconto"           |
| "Va bene, tenga". Lsdmaster prende la sim e ne verifica immediatamente         |
| la funzionalitα: "Scusi signorina, potrebbe dirmi il pin?" "Ah, scusi.         |
| E' 7465" "Grazie ed arrivederci" "Arrivederci". Il pin Φ quello giusto,        |
...
| cos∞ mi allontani i clienti?") pronto ad affrontare una serata                 |
| tranquilla su irc, col suo nuovo gingillo, la sim 'rottamata', p
```
