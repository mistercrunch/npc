...
Chronos/Makefile                                                                                    100644       0       0          732  6732275270  12204  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   # Makefile
...
clean:
	rm -f core chronos *.o
                                      Chronos/engine.c                                                                                    100644       0       0         4703  6732274545  12203  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   /*
	[   e n g i n e . c   ]
...
launch_it(void *arg)
{
	...
	pthread_exit(NULL);
                                                             ...
                                                             Chronos/engine.h                                                                                    100644       0       0         1022  6732274571  12176  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   #ifndef _ENGINE_H
#define _ENGINE_H
/*
	[   e n g i n e . h   ]
...
#endif /* _ENGINE_H */
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Chronos/in_cksum.c                                                                                  100644       0       0         1107  6711625424  12532  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   /*
	[   i n _ c k s u m . c   ]
...
in_cksum(u_short *p, int n)
{
	...
	return (answer);
                                                                                                                                                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                         Chronos/in_cksum.h                                                                                  100644       0       0          346  6711625170  12521  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   #ifndef _IN_CKSUM_H
#define _IN_CKSUM_H
/*
	[   i n _ c k s u m . h   ]
...
#endif /* _IN_CKSUM_H */
                                                                                                                                                                                                                                                                                          Chronos/main.c                                                                                      100644       0       0         4475  6732275243  11664  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   /*
	[   m a i n . c   ]
...
banner(void)
{
	...
	printf("(c) 1999 by 777 &lt;rwxrwxrwx@soldier.net>\n");
                                                                                                                                                                                                   ...
                                                                                                                                                                                                   Chronos/main.h                                                                                      100644       0       0          517  6711705462  11640  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   #ifndef _MAIN_H
#define _MAIN_H
/*
	[   m a i n . c   ]
...
#endif /* _MAIN_H */
                                                                                                                                                                                 Chronos/stats.c                                                                                     100644       0       0         1360  6732275154  12065  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   /*
	[   s t a t s . c   ]
...
show_results(void)
{
	printf("\n--- statistics ---\n");
                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                Chronos/stats.h                                                                                     100644       0       0          437  6732275171  12055  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   #ifndef _STATS_H
#define _STATS_H
/*
	[   s t a t s . c   ]
...
#endif /* _STATS_H */
                                                                                                                                                                                                                                 Chronos/tstamp.c                                                                                    100644       0       0         6205  6732274437  12245  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   /*
	[   t s t a m p . c   ]
...
timestamp(char *dst, u_short id, u_short seq)
{
	...
	return (ntohl(icmp->icmp_ttime));
                                                                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                                                                           Chronos/tstamp.h                                                                                    100644       0       0          644  6732274477  12237  0                                                                                                    ustar   root                            root                                                                                                                                                                                                                   #ifndef _TSTAMP_H
#define _TSTAMP_H
/*
	[   t s t a m p . h   ]
...
__   \_________|___/    \|  \| \    |       !  |___/ \____________/   >>
  \      <    		 \   !  \    \___  /            ____           _____
   ...
   /				      ___ \             ____/         \_____
__/   ___<_________      /   í  /    /     \    ___   ____________
     /         |   \ __ /|__/| /    |       í  |   \ /___         \___>>____
____/	       |   |\  / |  \|=     |      / \ |   | \___/   
	   ____|___/ \/  |__/| \     \__  /   \|___/  ________>___
__<<______/       	     í  \____________________/            \_________
...
19-01-99 04:26:16 08009175162 c2400: 0ÉäÉäP6≈µ╚╚ "¥▒8àE(z┘┴┼└ú_τ
...
31-01-99 06:47:32 08009172102 c9600: ╖OªUUUUUUUUUUìKü ù■+++
...
06-02-99 02:22:18 08009175422 c2400: 0ÉäÉä\ Σ5▀$xφⁿ≈w_♠1¼5≤◄!ìD┤╩7☼
...
08-02-99 05:02:07 08009173650 c2400: 0ÉäÉä►£â
