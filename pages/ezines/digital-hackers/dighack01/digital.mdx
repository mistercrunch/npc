...
```
      ...
      ║                                                               ║
      ║         Frase:"Lo que una mente crea otra lo supera"          ║
      ╚═══════════════════════════════════════════════════════════════╝
      ...
      ║ no nos hacemos responsables por lo que hagas con el o lo que  ║
      ║ el te haga a ti. Si no estas de acuerdo con lo anterior apaga ║
      ║ el ordenador y vete a lamear por ahi.                         ║ 
      ╚═══════════════════════════════════════════════════════════════╝
 ...
 13. OBTENIENDO CONTRASEÑAS (I) By Morfeo
...
- Tenemos habilitada la seccion del lector donde responderemos todas sus
  ...
  El E-mail para enviarnos sus dudas es: lectores@dighack.com
...
mail from:webmaster@ministeriopublico.gov.gt <- ponemos de donde viene.

El servidor nos contesta:

250 < webmaster@ministeriopublico.gov.gt > ... Sender Okay 
...
⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡
⌡⌡⌡                 5.INGENIERIA SOCIAL: (Para principiantes)              ⌡⌡⌡
⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡

Esta es una tecnica muy usada para apoderarnos de contraseñas, pasaremos
a la explicacion:
La ingenieria social (IS) es la forma de convencer hablando a una persona
para que nos revele algo,por ejemplo la contraseña de acceso a un sistema.
...
1_EL NUEVO:
  ...
  EJ:
   ...
   HACKER:    (llama al encargado o al centro de seguridad de la empresa que
               tiene como objetivo averiguar la contraseña)
   RING.RING.RING. (Atiende el encargado):

   ENCARGADO: - Centro de seguridad, habla Frank, ¿en que lo puedo ayudar?
   HACKER:    - Hola, habla el señor (un nombre falso a no ser que quieras
...
CONCLUSION: Con este ejemplo mostramos como con un poco de manipulacion de la
            palabra y la seguridad al hablar, podemos averiguar la contraseña.
            ...
            contraseñas importantes, quien sabe tal vez el proximo seas tu.
...
7) Volvemos a buscar a la persona que engañaremos.
...
3_EL IMPORTANTE:
  ...
  EJ:
   ...
   SECRETARIA: Bueno sigue siendo aun el mismo login: HIMBREYIM y la
               contraseña: 927826 , ya esta dada de alta nuevamente.
...
4_ IS ESCRITA:
   ...
   usuario y contraseña y que nos conteste a la brevedad a X direccion de
   ...
   factura por los daños ocasionado.
   ...
   Contraseña anterior:_______________
   Nueva contraseña:__________________
...
5) DIVERSAS FORMAS:
   ...
   a) Cuando te enteras que hay una falla en algun empresa, te puedes hacer
      ...
      HACKER:     ¿Que era lo que hacias normalmente cuando se inicializaba el
                  sistema?
      SECRETARIA: Me pedia una contraseña y entraba a windows nt.
      ...
      SECRETARIO: Ha por cierto ¿que tipeabas de contraseña usualmente?
      SECRETARIA: cam567
   ...
   b) Otra forma es haciendonos pasar como que hacemos propaganda de un server y
      ...
      las preguntas es la contraseña de su server y si desea que utilize la
     ...
     CONTRASEÑA DE SU SERVER:(SI ES QUE TIENE UNO):
     QUIERE USAR LA MISMA CONTRASEÑA: SI - NO
     SI ES NO ESCRIBA SU NUEVA CONTRASEÑA:________________
...
Autor: ^HacKZombi^
E-mail: Hackzombi@ciudad.com.ar

                
⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡
⌡⌡⌡          6.INGENIERIA SOCIAL INVERSA: (Para principiantes)             ⌡⌡⌡
⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡⌡
...
▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
▄      DIFERENCIAS ENTRE INGENIERIA SOCIAL E INGENIERIA SOCIAL INVERSA       ▄
▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
▄       INGENIERIA SOCIAL           ▄▄        INGENIERIA SOCIAL INVERSA      ▄
▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
▄ -Vos los buscas.                  ▄▄ -Ellos te llaman.                     ▄
▄ -Vos los necesitas a ellos.       ▄▄ -Ellos te necesitan a ti.             ▄
▄ -Puede funcionar en todos lados.  ▄▄ -Solo funciona en algunos lados.      ▄
▄ -La victima puede sospechar.      ▄▄ -La victima no sospecha.              ▄
▄ -No exige muchos conocimiento de  ▄▄ -Debes averiguar varios datos de la   ▄
▄  la victima.                      ▄▄  victima.                             ▄
▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
...
dejando una nota en la oficina donde se encuentra "x pc" que diga:
 ...
 ║        LAS 24 HS           ║
 ║ Reparacion de pc consultas ║
 ║         sin cargo.         ║
 ║                            ║
 ║  TEL: 8795552547 Preguntar ║
 ║      por Gord. Pancho      ║
 ╚════════════════════════════╝
...
y arreglar el sistema nos tendran que decir la contraseña, (al menos que no
...
passes            Muestra las contraseñas del usuario actual y la 
...
Por supuesto puede tener otro nombre y estar acompañada de comentarios
...
Esto fue todo, cualquier duda o sugerencia a troyanos@troyanos.com
...
***
 ...
 vuelvo a lectura, seguiré estando en el bit 13
...
no se le deé mal uso. Espero que lo sepan interpretar.
 ...
 3x3 cm. Con un poco de ma±a lo podes realizar en la propia tarjeta.
...
** Funcionamiento **
 ...
 se activa una interrupcion en el micro. Ahí se fija el estado
...
del Pentagono!) si todos esos productos tienen algun tipo de pequeño programa
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
 ...
 sea el correcto, incluyendo las contraseñas de inicio en win 95.
 ...
 y no se deje engañar por el diablo (bill gates)

 Autor:MoRfEO
 E-mail:Morfeo@dighack.com
...
Un Hacker se caracteriza por penetrar en sistemas sin hacer daño o modificar
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§  
§§§                       13.OBETENIENDO CONTRASEÑA                        §§§
§§§                           Tipo de contraseñas                          §§§
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

Vamos a pasar a explicar como podremos obtener contraseñas y explicaremos
un poco sobre estas:

Existen disitintos tipos de contraseñas:
...
Podemos utilizar distintos metodos para la obtencion de contraseñas:
...
*Investigando mas alla de la logica consiste en investigar a una persona 
 ...
 poner un Login y una contraseña con su fecha de cumpleños o la de algun
 familiar cercano, ya que no se da cuenta del riesgo que esto provoca.


INGRESE CONTRASEÑA: Aqui al usuario se le ocurriria poner su fecha de
...
en nuestro sistema debe enviarnos su Log-In y Contraseña dentro de un rango
...
internet.
Estados Unidos, Australia, Canada, Nueva Zelanda y Gran Bretaña son los dueños
de ECHELON.
...
alrededor del planeta y no desdañan nada de lo que encuentran a su paso.
...
dueños seamos "nosotros" con nuestra cultura de siempre...
...
Esta técnica no es propia de un Hacker sino de un Lamer
(no quiero decir Cracker para no ofender a nadie :) ya que únicamente sirve
...
que aunque aquí les explicare no es cuestión que lo uses por Internet
atacando servidores.
La utilidad Ping sirve principalmente para saber si un servidor esta
activo y además podemos calcular el trafico en la red según el tiempo de su
respuesta. Básicamente se le envía un paquete a un servidor y este nos
contesta, solo que si se le envía un paquete muy grande puede llegar
...
datagrama del ping muy grande y producirá su caída. Para ejecutar este ataque
solo tenemos que escribir :
c:\>ping -l 65510 victima.com 
Pues esta simple línea es muy destructiva, por lo que tened cuidado y antes de
hacer tonterías lee la parte sobre seguridad y como borrar sus huellas.
...
siempre deja indicios de su accion como puedan ser un aumento en el tamaño
...
que el fichero infectado tenia antes de ser atacado (fecha o tamaño
...
sistema para impedir los daños que los virus puedan causar. Por ejemplo,
...
Sus dudas o sugerencias a etimegt ---> etimegt@intelnet.net.gt

Autor: E-guru
E-mail: etimegt@intelnet.net.gt
Web: www.technohackers.cjb.net
...
14/5/2000 NOOOOOOOOOOOOOOOOOO!!!!  creo que tengo un virus, hoy me saque nota
          baja en el colegio y despues le robe la goma a mi compañero. Porque
...
CRACKER: PERSONA QUE PENETRA EN UN SISTEMA CON EL FIN DE HACER DAÑO, SE LO
...
LAMER: PERSONA ESTUPIDA INSERVIBLE POR SI MISMA. NO TIENE NINGUN TIPO DE
       ...
       Y UNA CONTRASEÑA PARA IR AL IRC (que por cierto no sabe lo que es)
...
programa  para  niños  activado en una escena de la
novela.
...
reactivarlo   hoy  por la  ma±ana.  Lo  juro. En mi
...
- ¿Lara Croft? ¿Alguna vez pensaste en algo asi?
  ...
  " Tuve  mucha  suerte ;  cuando  empece  a escribir 
    ...
    lo habrφa imaginado,  pero ahora veo a Lara Croft
...
- Se te ha identificado una y otra vez con el llamado
  ...
  "Si. Se me asocio con un grupo de escritores en los
   ...
   si  tenga validez polφtica o sociopolitica ahora o
...
- Ya   has   mencionado  que  para ti la tecnologia es
  ...
  " Si. Pero lo que es mßs importante es que el cambio
...
acepta  posar  para    mßs   fotos  para  Planeta  X  y 
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
 ...
 enviandonos un E-mail a virus@dighack.com
 ...
 2.Crea las siguientes claves en el registro para que se ejecute
   ...
   van hacia la pagina &lt;http://www.skyinet.net> con la intencion de bajar un
   ...
   sistema.Si el gusano ha conseguido realizar el paso anterior también
   ...
   .SCT y .HTA, y crea otros con el mismo nombre y extensión .VBS en el que
   introduce su código.
   Nuevamente busca los archivos con extensión .JPG, .JPEG, .MP3 y .MP2,
   los elimina, y crea un nuevo nombre que va estar formado por el nombre y
   la extensión anterior más VBS como extencion real.
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
§§§                  25.ZONA X - PASSWORD DE ACCESO                        §§§
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

Hemos recibido muchos e-mail preguntandonos cual era el nombre de usuario y 
contraseña para accder a la zona x.
Pues aqui va la respuesta:
...
Esto es todo amigo espero que difruten entrando en la zona solo miembros.
...
Virus: Es un programa que tiene la funcion de reproducirse y su unico objetivo
       es provocar daños en el ordenador infectado.
...
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
§§§                   27. HISTORIA A TECHNOHACKERS                         §§§
§§§                             SU HISTORIA                                §§§
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

De: technohacker &lt;technohacker@crosswinds.net>
Para: area54 &lt;entrevista@dighack.com>
Asunto: Nuestra historia
Fecha: Martes, 09 de Mayo de 2000 12:31 a.m.

En esta seccion contaremos la historia de algunas organizaciones amigas, la
primera es Technohacker:

Primeramente WebmasterGT (que fue el primer nombre) nace desde ya casi 3
años atras haya por el mes de marzo por la inquietud de tener una asociacion
chapina y asi poder reunir a todos los compañeros de la universidad de San
Carlos de Guatemala que tenian un poco de conocimientos sobre internet y
sobre computacion, los primeros integrantes fueron un tal german, edgar y yo
(e-guru), despues de mucho conseguimos introducirnos en el servidor de una
conocida empresa aqui en Guatemala llamada ICAITI y colocamos nuestra
primera pagina al aire, despues de perder el intereses por ella fue
descubierta y borrada, pero para esto ya teniamos casi mas de 4 meses de
tenerla ahi, bueno despues de eso WebmastersGT se disuelve por falta de
compatibilidad entre los amigos, despues de unos meses de receso contacto con
un amigo que estaba en mi clase de matematicas que se hacia llamar
UnderTaker, que tambien tenia el mismo interes y apacionamiento por la PC's
como yo, despues de esto yo cambie de nickname (antes era megapa....) bueno
eso es secreto y luego paso a ser tekno, y el UnderTaker dejar de ser
tambien para ser el Cyberpsico, es en donde empezamos a tener mas contacto
con inquietudes un poco mas oscuras como el pirateo de programas "VIRUS"
de microsoft para ese tiempo nuestro primer logro fue hacer un programa que
formateara los diskettes de 1.44 a 1.57 para poder copiar los diskettes de
windows 95 que se suponian "venian protegidos" ese programilla recuerdo que
lo hicimos en pascal de D.O.S, despues empezamos a trabajar en los
generadores de keys de microsoft, pero claro no sabiamos que despues de
rompernos la cabeza creyendo que microsoft era algo inteligente y ponia
codigos dificiles descubrimos la llave maestra y mas conocida que era
411-0123456 y ya !! que desepcion, :-) pero bueo....
Luego de unos ensayos y pruebas logramos entrar a los servidores de la
biblioteca central de nuestra universidad pero de nada sirvio porque tenia
una red de tipo AS-400 y solo puro texto y  caracteres pudimos extraer pero
bueno algo nos divertimos porque cambiamos los titulos y borramos la mitad
de la base de datos. }:-)
luego nos iniciamos en el campo del htm y conseguimos unos cuantos manuales
en la red y logramos aprender muy bien el lenguaje, y montamos nuetra
segunda web en geocities (el clasico) luego de eso Cyberpsico cambia de
nombre por un trauma con viaje a las estrella esos de star treak y se hace
llamar DATA como el cybor que aparece ahi, bueno yo tambien cambio y me
transformo en e-guru (casi que parecemos pokemons evolucionando...jajaja)
bueno luego de eso tomamos un cursillo de programacion avanzada en visual
basic y empezamos a realizar nuestro programas generadores de llaves para
programas nacionales y algunos del extranjero, un dia el data recibe una
dura leccion por parte de un hijo de puta que nosotros le llamamos
hidrosefalico que creo que su verdadero nombre es ALEX, un tipico fanfaron
que le infecto con un juego la maquina y desde ahi juramos VENGAZA. bueno
despues de varios dias de ardua lectura y prueba y ensayo logramos hacer un
programa que realizaba el overclocking de un pentium I y que borraba
parcialmente el bios, de una 586 viejita verdad? bueno despues de eso no se
atrevio a voltear a vernos mas.
Despues siguio la historia haya por el año de 1998 plantamos la pagina de
los technohacker's y del DATAGT con material nocivo y corrosivo, de ahi para
la fecha hemos trabajando desde pirateria en gran escala de CD's de software
y musica asi como intrision de sistemas sobre NT, Windows 9X, As400,
programacion para D.O.S y windows 3.11 y 9X , comprar CD's con tarjetas de
credito falsas , etc, etc, etc. una anecdota muy graciosa es la de una vez
que llegamos al laboratorio de computacion de nuestra facultad y queriamos
alquilar unas maquinas para navegar un rato, pero el impertinente y
prepotente del encargado no nos quiso dejar entrar porque segun el habia
mucha gente en el laboratorio y no debiamos estar ahi, entonces otro dia que
llegamos solo tomamos los ip's de algunas maquinas incluyendo el servidor y
estan son creo que todavia son los mismo si quieren prueben a darle un ping
200.12.38.39
200.12.49.199
200.12.49.198
200.12.49.196
200.12.49.195
aeiusac.metrocable.net
y utlilizando telnet logramos entrar para conseguir passwords y otras
cosillas tambien pudimos incrustar un pequeño troyan de nuestra fabricacion
basado en el famoso backorifice, solo que este solo hacia los cambios en el
registro de win pero no era detectado como virus, o troyan tool, despues de
mucho borrar y componer logramos borrar el disco duro del servidor y
sacrificar muchos de los discos duros de la red al dios de la venganza,
luego de eso despidieron al encargado...jajajajajajaja

Bueno la historia de la revista etimegt nace de la composicion de nuestros
dos nombres E-Guru de DAt@ GT
nace de la necesidad de mantenernos en el mundo electronico despues de que
nos quedaramos sin muchos de los numeros de conexion a internet de cobro
revertido que aqui les llamamos 1801 que nos habiamos robado de varias
empresas como Cybernet, Infovia, Quetzalnet, Starnet, Pronet. que como se
imaginaran pasabamos conectados casi las 24 horas del dia sin que nos
cobraran ni un centavo a nosotros, y utilizando mas de 160 usuarios
diferentes,(pero desgraciadamente ese servicio fue cancelado por todas la
compañias por el alza al precio del telefono)  despues de eso ya no pudimos
actualizar ni la pagina ni volver a conectarnos mucho, entonces pensamos en
no dejar a nuestro publico que siempre visitaba nuestra pagina sin noticias
nuevas y sin presencia nuestra en la red, es por eso que pensamos en un
boletin electronico quincenal y ahi es donde "parimos" a etimegt, primero
teniamos que anunciar nuestra nueva pagina y nuevo servicio para eso tuvimos
que hacer muchos sacrificios para conseguir el dinero de el fono, utilizando
para esto la pirateria de CD's y muchas cosillas mas pero asi conseguimos
subir una nueva pagina con su respectiva seccion de suscripcion que era lo
que nos interesaba, luego de eso la primera semana tuvimos una respuesta muy
agradable de nuestro publico llegando a tener mas de 30 suscripciones
diarias y subiendo, despues del  primer numero subio a casi 35 diarias
despues decayo vertiginosamente debido a que nos borraron la pagina el
servidor de xoom en donde la teniamos por el contenido nocivo dicen ellos.
luego de eso conseguimos un lugar por ahi y la colocamos de nuevo y de ahi
para adelante todo es historia.....
...
ORALES esta es nuestra historia !!!!!!!!!!!!!!

  	  PARA MAS INFORMACION VISITEN WWW.TECHNOHACKERS.CJB.NET
 
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
§§§                     28.CORREO DE LOS LECTORES                          §§§
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

Como esta es la primer edicion aun ningun lector a enviado sus preguntas y
sugerencias.
Invitamos a todos los interesados en salir en esta seccion a que manden sus 
dudas y preguntas a:
...
- CIRCUITOS ELECTRONICOS: Publicaremos interesantes circuitos para armar. 

- BRICOLAGE: En esta seccion armaremos herramientas, circuitos y un poco de 
             todo. Si tenes algun invento para aportar envianoslo a:
	     bricolage@dighack.com
		
- RADIOAFICIONADOS: No metemos en el mundo de las comunicaciones para aprender
		    desde como funciona un equipo de radio a armar uno.

§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§
§§§                             DESPEDIDA                                  §§§
§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§§

 Espero que les haya agradado este numero y recuerden que todas sus dudas las
 pueden enviar a lectores@dighack.com y las responderemos.
 Tambien pueden mandar sus articulos para que salgan en la revista.
 Esto fue todo y esperemos que la revista siga dia a dia creciendo tanto como
 en numeros de lectores como en tamaño.
 ...
 La editorial de Digital Hackers
               ...
               y otros que no nombraremos por razones de seguridad.


Fecha de elaboracion: 13/5/2000
Proxima entrega: 15/6/2000
  
                TODOS LOS DERECHOS RESERVADOR POR DIGITAL HACKERS
