...
```
      ...
      ╚════════════════════════════════════════════════════════════════╝
                     ...
                     EDICION Nº3 - AÑO 2000 - ARGENTINA
                            WWW.AREA54TEAM.COM
       ...
       SALUDOS: A la revista C.I.A Magazine, a Lawebdelprogramador que
                cumplio 3 años, y a Technohackers que estan desaparecidos.
 ...
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   2   ║ MEMOFACIL POR DEFAULT                 ║    HacKZombI   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   3   ║ COMPARATIVA ENTRE W98, W98, WNT       ║      Alvaro    ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   4   ║ CURSO DE VISUAL BASIC                 ║SiStCoM,BoNScoTT║  Basico ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   5   ║ INTERCAMBIO DE MP3 x ICQ              ║    DamiSoft    ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   6   ║ FREEPRO                               ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   7   ║ DESINFECTANDONOS DEL METALTROJAN      ║      Ante      ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   8   ║ CONVERTITE EN REPORTERO.              ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   9   ║ LAS 10 MEJORES WEB.                   ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   10  ║ CURSO SOBRE CGI (II)                  ║    Sebastian   ║ Med. -->║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ...
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   13  ║ ZONA X - SOLO PARA MIEMBROS           ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   14  ║ LLAVE PGP                             ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   15  ║ LISTA DE CORREO                       ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   16  ║ ENCUESTA A LOS LECTORES Y RESULTADOS  ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   17  ║ PROYECTO LISTADO BBS ACTUAL           ║    HacKZombI   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   18  ║ MANUAL DE LINUX RED HAT               ║    Mr. Nuk3m   ║ Mediano ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   19  ║ CARTAS DE LOS LECTORES                ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   20  ║ PROXIMO NUMERO...                     ║    EDITORIAL   ║   ---   ║
 ╠═══════╬═══════════════════════════════════════╬════════════════╬═════════╣
 ║   21  ║ DESPEDIDA                             ║    EDITORIAL   ║   ---   ║
 ╚═══════╩═══════════════════════════════════════╩════════════════╩═════════╝
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
 ...
 nuestra clave de seguridad. Aca actuamos nosotros, si el dueño del telefono
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
                  ...
                  ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
                  █03.WINDOWS 95, WINDOWS 98 Y WINDOWS NT█
                  ▀▀▀▀▀▀▀▀▀▀▀██▀▀▀▀▀▀▀▀▀▀▀▀▀▀██▀▀▀▀▀▀▀▀▀▀▀
                             ██     Alvaro   ██
                             ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
    ...
    pack 4 esta disponible en internet,  pero el hecho de que su tamaño sea 
    ...
    no  tiene  nada  que  ver  con  Windows  95/98.  Microsoft  encargó  el 
    ...
    NTFS.  FAT16 fue diseñado para discos duros de mucha menor capacidad de 
    ...
    el tamaño de la unidad de asignacion.  Segun sea el  tamaño  del  disco 
    duro  (o de la particion) el tamaño de asignacion ser  mas grande o mas 
    pequeño.  
      
        A continuacion escribo una tabla con el  tamaño  de  la  unidad  de 
    asignacion segun el tamaño de un disco duro.  
    ...
    prefijado por el tamaño de la unidad de asignacion.  Aunque esto no  es 
    ...
    estarian gastando 32MB.  
        ...
        Para paliar este problema Microsoft parcheó  la  FAT16  y  creó  la 
    FAT32,  que  no  deja  de  ser un mal arreglo de la FAT16.  Sobre FAT32 
    independientemente del tamaño del disco duro siempre existir  un tamaño 
    de asignacion de 4KB, con lo cual las cosas quedan bastante arregladas.  
    El tamaño maximo que soporta FAT32 creo que venia a ser de 8GB,  aunque 
    ...
    no ocasiona gran trauma.  
        ...
        La  conversión de FAT16 a FAT32 (de una partición de 2GB) sobre una 
    instalación de software de 350MB mas o menos  me  liberó  un  total  de 
    60MB, como se puede ver, FAT16 es un verdadero problema. La utilización 
    ...
    FAT32 se ve claramente como sobre Windows 98 la gestión es  mas  r pida 
    que  sobre  FAT32  de Windows 95. Teniendo en cuenta que la FAT32 es la 
    misma en ambos sistemas se puede llegar  a  la  conclusión  de  que  la 
    ...
    disco se fragmenta mas rapidamente,  no se el porqúe pero claramente es 
    ...
    estaba  leyendo o escribiendo de disco duro muchos ficheros pequeños se 
    ...
    y  sobretodo  en  subdirectorios  de muchos ficheros pequeños,  a cuyos 
    ...
    mejor elección.  WIndows 98 con 32MB de RAM se ve como queda  atras  en 
    ...
    recursos que Windows 98, por lo que va sensiblemente mas r pido.  
        ...
        Arrancando cualquier tipo de aplicacion, sea grande o pequeña se ve 
    ...
    NT en una particion d: y dejar una partición c: para instalar el ms-dos 
    o pc-dos.  
    ...
    una multitarea marcar  sin lugar a dudas su calificación final.  
    ...
    cargados  se  movieran unicamente (salvo pequeñas excepciones) entre el 
    micro y la memoria RAM,  pues cualquiera de las  dos  multitareas  daba 
    buenos resultados.  Lo que se me ocurrió hacer fue evaluar la multitrea 
    ...
    tañamo  de  unidad  minima  de asignacion duplica el tamaño que existia 
    ...
    que el tamaño de unidad de asignacion siga siendo el de una unidad NTFS 
    ...
    indicar si esta comprimido o nó.  
    ...
    arreglar  cualquier instalacion dañada de Windows NT,  a diferencia del 
    disco de inicio de Windows 95/98 que es simplemente eso,  un  disco  de 
    inicio con algunas utilidades basicas.

        En  el caso de Windows NT se ofrecen posibilidades de corrección de 
    ...
    sido  dañado  o borrado.  Algo muy util frente a Windows 95/98 que a la 
    ...
    error  correspondiente y se finaliza la ejecución de la aplicacion.  En 
    ...
    instalación mínima de Windows 95 solo para juegos y luego Windows NT en 
    ...
    da la ventaja de que es  la  plataforma  de  ejecución  win32  que  mas 
    ...
    recuperación de recursos es total.  
    ...
    NT es la mejor opción,  aunque hay cosas para  las  que  no  sirve  (de 
    ...
    RAM) o se realiza una doble instalación,  por un lado Windows NT y  por 
    otro  lado  una instalación minima de Windows 95 para usarla unicamente 
    en juegos.  
    ...
    mas  rapido  que  en Windows 98,  por esta razón Windows 98 no interesa 
    ...
    declaró  publicamente que la filosofia del Windows 98 (basada en el ms-
    ...
    vivimos.  
        ...
        No podía faltar  en  esta  comparativa  un  comentario  acerca  del 
    Windows  2000.  Si  un  día  tengo  tiempo  estoy  dispuesto a hacer un 
    an lisis  mas  detallado,   pero  de  momento  voy  a  intentar   hacer 
    simplemente  un  capítulo  al  respecto de esta ultima versión que va a 
    ...
    2000), así que todos mis comentarios van a ser acerca de esa versión.  

        Así para empezar hay dos cosas que me llamaron la atención, primero 
    ...
    libres,  debido a esto llego a la conclusión de que para trabajar  bien 
    con  el Windows 2000 se necesita un mínimo de 96 MB de RAM.  La segunda 
    cosa que me llamo la atención es la gran carga de opciones destinadas a 
    ser utilizadas en un entorno de red, algo que para el usuario domestico 
    ni le va ni le viene.  Según Microsoft,  mínimo se necesita Pentium 166 
    para  ejecutar Windows 2000,  así que se puede hacer el lector una idea 
    de la cantidad de recursos que come esta versión del sistema operativo. 
    En lo que se refiere a espacio de disco duro,  la instalación son  algo 
    mas de 300MB.  
    ...
    con  otra  versión  anterior  del  Windows  sobre  FAT32.  A la hora de 
    ...
    esta muy bien si se va a utilizar en conjunto con otra versión anterior 
    del Windows.  

        El escritorio es igual al Windows 98, con lo que en este aspecto no 
    habr  problemas de adaptación.  
    ...
    NT 4.  
        ...
        Viene integrado el Internet Explorer 5, en sustitución del 4, dicen 
    ...
    cuestión de cada uno.  
        ...
        La beta 2 venia con Direct X versión 3,  y la beta 3 con  Direct  X 
    versión 5, parece que la versión final incorporar  la última versión de 
    las Direct X disponible en ese momento.  

        El  tema  de  añadir  hardware  lo  he  visto mas complicado que en 
    versiones anteriores,  aunque puede haber sido solamente una impresión, 
    así que tampoco me voy a meter demasiado en eso.  

        Y  para  finalizar,  voy  a dar mi opinión al respecto.  Para mi el 
    ...
    integración en una red local. El Windows 2000 no va a ejecutar nada que 
    no pueda ejecutar el Windows NT 4 o el Windows 98, y lo único que le va 
    ...
    domestico  debería  olvidarse  del Windows 2000 y seguir optando por la 
    instalación del Windows 98 o el Windows NT 4 (junto al  ultimo  service 
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
 ...
 totalmente distinto:
 1.- Primero se diseñan los formularios (ventanas).
 ...
 Tiempo de diseño, periodo en el que se definen los formularios, se escribe
 el codigo, etc.
 ...
 Controles: Son todos aquellos que se colocan en un formulario, a traves de
            ...
            - TextBox:    Un control TextBox, tambien denominado control de
                          ...
                          informacion introducida en tiempo de diseño,
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
 ...
 Para empezar necesitamos tener un poco de conocimiento de algún lenguaje de
 programación (el que sea).
 La idea de esta guía es utilizar como base Perl, aunque serán dados ejemplos
 en C y también en Pascal (vamos Turbo todavía).
 Creo que con eso bastará para dar una idea general , (que por otra parte es lo
 que pretendo), y las adaptaciones necesarias para cualquier otro lenguaje
 con un poco de ingenio se podrán hacer sin problemas.
 ...
 afirmativo envía el archivo como respuesta. Nuestra computadora entonces,
 muestra el archivo en el formato apropiado.
 
 Además de todo esto, los servers de Web estan configurados de tal manera que
 ...
 programa y la salida de este programa es enviada a nuestra máquina para que
 ésta la muestre. Esta función es conocida como "Common Gateway Interface" y
 ...
 es el cgi-bin, de manera que los scripts que armemos deberán ser situados en
 el mismo.
 Si no tenemos control de la administración del server, debemos solicitar
 que se les dé permiso de ejecución a todos los archivos que pongamos en este
 directorio (cgi-bin).                                                       
    
 En esta segunda parte veremos scripts que funcionan en base a los datos y
 variables que les son enviados a través de un FORM en una página HTML, y
 dejaremos para la tercera de aquellos que no necesitan de esta input, por
 ejemplo los counters, las animaciones y otras cosas un poco más complicadas.
  

 Nuestro Primer Script.

 Para empezar por lo más simple y poder apreciar la funcionalidad de este
 sistema veremos un script muy fácil de entender, el cual no necesita que les
 sean suministrados datos de ningún tipo para funcionar.
 Pero sigamos con lo nuestro;
 
┌────────────────────────────────────────────────────────────────────────────┐
│ PERL                                                                       │
├────────────────────────────────────────────────────────────────────────────┤
│!#/usr/bin/perl                            <─── Esta línea llama al intérpre│
│                                                 te de Perl.                │
│                                                                            │
...
└────────────────────────────────────────────────────────────────────────────┘
 ...
 la información que enviamos, en este caso se trata de una página HTML, por
 lo tanto el header apropiado es:
                                 Content-type: text/html
 
 Tomemos en cuenta también que los primeros dos saltos de línea que introduci
 mos son significativos. Los código de retorno MIME, a los cuales pertenece
 "Content-type..", necesitan dos "newlines" siguiéndolos para delimitar su fin.
 No enviar este segundo newline nos traerá bastantes problemas.
 Los demás "newline" incluídos en la página que generamos no son realmente
 necesarios, pero facilitarán la lectura de alguien que haga un "View Source".
 
 Como vemos en los ejemplos tuvimos que generar todos los tags de la página,
 pero eso resultó muy simple, no es así?
 Ahora vamos a hacer algo un poco más interesante, vamos a solicitar algunos
 datos con un FORM apropiado, y vamos a retornar una página que contenga los
 ...
 En este punto comenzaremos a hacer uso de librerías especializadas (los sites
 donde conseguir cada una de las librerías figuran al final de este texto).
 Quisiera recalcar que estas librerías no son únicas, existen muchas variaciones
 sobre el mismo tema, y cada una de ellas tiene su propia forma de manejarse,
 por lo tanto es conveniente revisar cuidadosamente la documentación que las
 acompaña en caso de que se utilize alguna otra que no figure aquí.
 
 Estas librerías nos ahorrarán el trabajo de separar los distintos componentes
 ...
 El script que utilizaremos será muy simple y nos va a servir de base para
 futuros desarrollos. Veamos paso a paso su estructura;
         1. Primero llama al intérprete en caso de ser necesario (Perl).
         2. Luego de incluír/cargar la librería, de alguna manera corre la
            función que separa QUERY_STRING en sus componentes individuales.
...
│require("cgi-lib.pl");                     <─── Incluímos la librería.      │
│                                                                            │
...
│ PASCAL                                                                     │
├────────────────────────────────────────────────────────────────────────────┤
│Uses TPWCGI;                               <─── Incluímos la librería.      │
│                                                                            │
...
│#include &lt;stdio.h>                                                          │
│#include &lt;errno.h>                                                          │
│#include &lt;uncgi.h>                         <─── Incluímos la librería.      │
│char *getenv();                                                             │
│                                                                            │
│main()                                                                      │
│{                                                                           │
...
└────────────────────────────────────────────────────────────────────────────┘
 ...
 Como sugerencia, la estructura que propongo para un script más o menos decente
 es la siguiente ( de todas maneras igual que en matemáticas de primer grado,
 "el orden de los factores no altera el producto", aunque sí lo hace más díficil
 de mantener :)!
 ...
 │ que generará la salida que   │
 │ deseamos a partir de los     │         
 │ datos de entrada.            │
 ├──────────────────────────────┤
 │ Envío de la página con los   │
 ...
 retorne una página con distintos mensajes según sea quien ha completado el
 form.
 Los scripts pueden hacer cosas más complicadas, como verificar que los campos
 sean llenados correctamente, modificar archivos y hasta retornar una página
 que no haya sido elaborada por ellos. En el siguiente y último punto veremos
 como implementar estos métodos en la forma de un 'mini-guestbook'.
 
 
 Un Mini-GuestBook
 
 Vamos a armar una especie de Mini-Libro de Firmas, una aplicación bastante
 difundida, que nos servirá de ejemplo para mostrar los puntos que mencioné
 más arriba.
 ...
 * Comentarios
 ...
 A partir de allí, lo que el usuario ingrese será grabado en otra página, la
 página del guestbook más precisamente, y luego finalmente se presentará una
 pantalla agradeciendo el comentario e invitando a mirar el Libro.
 
 Para poder conseguir lo que queremos, utilizaremos un método muy común,
 estableceremos una marca invisible (un comentario) en la página en cuestión
 ...
 Los pasos a seguir en este caso son los siguientes:
         ...
         1. Verificar la entrada del usuario, para que no existan campos vacíos,
            retornando un mensaje de error si existe algun problema.
         2. Abrir y leer la página del mini-guestbook línea por línea (grabando
            cada una de ellas en un archivo temporario) hasta encontrar la
            marca que indica el comienzo de los comentarios (o sea el último
            ingresado), grabar después de la misma el input del usuario y
            terminar de copiar el resto del archivo.
         3. Cerrar los archivos, borrar el original y renombrar el temporario.
         4. Devolver un código de retorno "Location.." que llevará al usuario
            a una página de agradecimiento que tendrá un link al guestbook.
 
 Muchos se preguntarán, Y que pasa si dos usuarios acceden al mismo tiempo al
 archivo? Cómo hacen para leerlo/grabarlo? Quién tiene prioridad?
 Creo que sería intentar avanzar demasiado en este momento, a manera de comen-
 tario (de todas maneras les contaré como hacerlo en la tercera parte) lo que
 se necesita es una manera de trabar el acceso al archivo mientras se esté
 trabajando con él.
...
│                                                                            │
│                                                                            │
│if (($nombre eq "") || ($email eq "")      <─── Si alguno de los campos está│
│   || ($comentario eq ""))                      vacío, retornaremos la      │
│ {                                              siguiente página con este   │
...
│           Comentarios:&lt;BR>\n$comentario&lt;HR>\n/o;                           │
│                                   │                                        │
│      print GB $line;              └─>Aquí grabamos cada línea,reemplazando │
...
│                                                                            │
│                                                                            │
│if (( nombre = '') or (email = '')         <─── Si alguno de los campos está│
│   or (comentario = '') )                       vacío, retornaremos la      │
│then begin                                      siguiente página con este   │
...
│       begin                                                                │
│       Writeln (Arch-Out, linea);    ┌>Aquí grabamos cada línea,reemplazando│
...
│Send ('');                 │                                                │
│EndCgi                     └─>Vamos a la página de agradecimiento.          │
│end.                                                                        │
│                                                                            │
└────────────────────────────────────────────────────────────────────────────┘


 Me pareció redundante incluir la versión en C ya que esta puede ser fácilmente
 inducida a partir del fuente en Pascal.
 Como el TEXTAREA que utilizamos para cargar el comentario entrega sus datos
 sólo separados por newlines, tuvimos que hacer un pequeño proceso en cada
 uno de los programas para generar un &lt;BR> por cada uno de ellos en la página
 definitiva.
 Notarán que existe diferencias en la forma de hacer el "update" del archivo en
 cada una de las versiones. En el fuente Perl aproveché una función de sustitu
 ción bastante potente que simplifica las cosas, en cambio en la versión en
 Pascal hubo que hacer dicha sustitución "a mano".
 ...
 * Estar ubicado en el directorio cgi-bin. La ubicación de este server va a
 ...
 * Sea capaz de acceder a los archivos que necesita.
   ...
   cuando tengamos que retornar una página HTML completa, usemos su URL
   completa (http://....) .
 * Tener seteados los permisos correctamente.
   Perdonen que siga jodiendo con lo mismo, pero más de una vez las cosa no me
   anduvieron por esta sencilla razón. (Nadie podía ejecutar el programa
   excepto yo...)
 
 
 Bueno, los dejo, espero no haberlos aburrido demasiado, que les sea de utilidad
 y encontrarlos leyendo la tercera y última parte ( espero que en el tiempo que
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
                   ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
                   █ 11.LA VIRUTECA DE DIGITAL HACKERS █
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
 ...
 las faltas de ortografia pero no voy a poner acentos, salvo las eñes
  ...
  * PROPENSO A FALLOS: No es raro observar que Windows se "CAE" sin razon
    ...
    han estado operando por mas de 1 año sin caida alguna :)
  ...
  * INTERFACE DE USUARIO INCONSISTENTE: GNU/Linux refelja el trafico de varios
    programadores, cada uno con metas de diseño diferentes, interfaces
  ...
  * PAQUETES REPETIDOS: Dentro de una distribucion se pueden encontrar una
    ...
    fueron diseñadas por distintas personas, con objetivos de diseño. Por
...
a un sistema tan potente, versatil y nos daran una amplia vision de algunas
 ...
 recomienda no utilizarlo ya que podria dañar la escritura de archivos de una
 particion NTFS.
 ...
 es un resultado de años de desarrollo, testeo y correccion basados en el
 ...
 A nivel aplicaciones, Linux esta acompañado de innumerables aplicaciones
 como lo son:
 ...
 conceptos se trataran mas adelante), su tamaño en bloques, y su ultima
 ...
 corresponde al usuario indicado se asocio una contraseña (PASSWORD) con
 cada nombre de usuario. La contraseña solamente la debe conocer el usuario
 propietario de la cuenta.

 Como parte del proceso de inicio de sesion se debe ingresar la contraseña
 apropiada, la cual sera encriptada por el sistema inmediatamente y chequeada
 contra la base de datos de contraseñas y gurdada en el sistema. Este proceso
 se conoce como autenticacion del usuario. Si la contraseña es cheaqueada
 ...
 contraseñas, y ademas no se debe permitir a cualquier usuario que pueda
 ...
 asignarles contraseñas y eliminarlas si es necesario. Estos no son los unicos
 ...
 establecen quien es el usuario dueño del archivo y a que grupo de usuarios
  ...
  * DUEÑO: El usuario que creo el archivo es el dueño del mismo. El dueño es
  ...
  * OTROS (Universo): El universo se constituye de todos los demas usuarios
                      que no son ni dueños del archivo ni pertenecen al
                      grupo del archivo.
 ...
 lectura y escritura para el dueño y de lectura y ejecucion para el universo.
 Para los directorios son: de lectura, escritura y ejecucion para el dueño y
 de lectura y ejecucion para el grupo y para el universo (otros usuarios).

 En cualquier momento, el usuario que es dueño del archivo o directorio puede
 ...
 de tamaño fijo, cada uno con su direccion. Los tamaños de bloques mas comunes
 ...
 Una interrupcion es una señal electronica que se emite desde un dispositivo
 ...
 mediante el uso de "cañerias". Estas tecnicas son poderosas y extremadamente
 ...
 es generada por el comando df y muestra las capacidades, tamaños utilizados
 ...
 Las cañerias (pipes) conectan la salida estandar de un programa con la entrada
 estandar de otro programa. Una cañeria es diferente a la redireccion de la
 ...
 programa a un archivo. Una cañeria coencta la salida de un programa
 ...
 permisos, su dueño, el grupo al que pertenece, la cantidad de links que
 posee, su tamaño (en bloques), y su fecha de modificacion. Un ejemplo de un
  ...
  * Cada archivo o directorio es mostrado en una linea separada acompañado
  ...
  * Las siguientes columnas especifican el usuario que es dueño del archivo o
    directorio, y el grupo al que pertenece.

  * La columna que sigue nos muestra el tamaño del archivo, pero este tamaño
 ...
 7.13 vemos que los archivos tiene distintos tamaños, distintas fechas de
 modificacion, etc.
 ...
 archivo sera borrado, solo si somos dueño del mismo, sino obtendremos un
 ...
 Otro uso comun del comando find es la busqueda de archivos por tamaño. Para
 buscar archivos por tamaño, en vez de utilizar la opcion -name utilizamos la
 opcion -size. A continuacion de esta opcion debemos especificar el tamaño de
 los archivos a buscar y ademas si queremos buscar archivos mas grandes o mas
 chicos que el tamaño especificado. Veamos un ejemplo en la figura 7.18.
 ...
 En este ejemplo, queremos encontrar todos los archivos que tengan un tamaño
 mayor a 7000 Kbytes, a partir del directorio /mp3. Debemos realizar dos
 observaciones:

  * El signo "+" que prefijamos al argumento que especifica el tamaño obliga
    al comando find a realizar un test. En este caso testeara que el tamaño
    del archivo sea mayor a 7000 Kbytes. En caso de querer buscar archivos
    de un tamaño menor al argumento debemos prefijar el simbolo "-". Si no
    usamos ningun simbolo, find buscara archivos cuyo tamaño sea exactamente
 ...
 archivo debemos ser dueño del mismo. Existe una excepcion a esta regla que
 es el "superusuario" :).
 ...
 Para averiguar que permisos tiene un archivo, que usuario es dueño y a que
 ...
 muestra el usuario dueño del archivo y la columna siguiente especifica el
 grupo al cual pertenece el archivo. En este caso el dueño de los archivos
  ...
  * Los tres primeros simbolos especifican los permisos de lectura, escritura
    y ejecucion para el usuario dueño del archivo.
 ...
 permiso de lectura para todos los niveles de privilegio, pero solo el dueño
 ...
 que el dueño del archivo y que los demas usuarios tengan los mismos o menos
 ...
 hacer que un archivo no pueda ser leido por su dueño pero que los demas
 ...
 para todos los usuarios, pero su dueño es el unico que tiene permiso de
 ...
 Los comandos chown (change owner) y chgrp (change group) cambian el dueño y
 ...
 archivos de otros usuarios. El siguiente comando cambiara el dueño de todos
 los archivos del directorio actual al usuario juan:

  ==> chown juan *

 El nombre del nuevo dueño debe ser un nombre de usuario valido o un numero
 ...
 el sistema. Cada proceso tendra especificado el usuario dueño del mismo.
 ...
 recupera su tamaño y nombre original.
 ...
 comprimir con gzip obtuvimos un archivo con un tamaño de 5138529 bytes, lo
 ...
 no pueden hacer mucho sobre archivos pequeños. Primero, los archivos pequeños
 son pequeños, valga la redundancia, y comprimirlos no nos trae mucho
 ...
 problemas, pero tener 5.000 o 10.000 archivos de ese tamaño pueden hacernos
 ...
 un gran archivo secuencial y tar fue diseñado para empaquetar conjuntos de
 ...
 la limitacion de un tamaño de cluster fijo. Los archivos se colocan uno
 despues del otro separados por un encabezado. Un grupo de archivos pequeños
 ...
 cañeria creada permite que el comando gzip obtenga la salida de tar y
 ...
 comprimido el tamaño del archivo es de solo 13 Megabytes, lo que implica un
 grado de compresion del 74.5%.

 En la figura 8.9b mostramos como se puede descomprimir el archivo
 linux-2.2.5.tar.gz.

 El comando es otra vez una cañeria, pero esta vez en sentido inverso. Se
 ...
 linux-2.2.5 y que su tamaño es nuevamente 51 Megabytes.
 ...
 una serie de mensajes y luego se dara por finalizada la instalacion.
   ...
   NOTA: Es necesario estar en una sesion con permisos de superusuario para
         ...
         cual nos pedira la contraseña del superusuario y si es correcta,
 ...
 archivos, permisos, tipos, dueños y grupos de cada archivo. Cualquier
 ...
 Con el objetivo de hacer que los programas sean mas pequeños, los mismos se
 ...
 funcionalidad relativamente pequeña (aunque aumentando dia a dia). De todas
 ...
 El kernel de Linux se ocupa, principalmente, de las siguientes tareas:
  ...
  Mecanismo de intercomunicacion entre procesos: Los procesos se comunican
      ...
      (Inter-Process Communications - IPC), las señales y las cañerias son
 ...
 caracteristica evidencia una falta de modularidad en el diseño del kernel.
 ...
 obteniendo asi un kernel mas pequeño que ocupara menos memoria. Ya que,
 como dijimos antes, el kernel es la parte del S.O. que se encuentra
 residente en memoria, es importante reducir el tamaño del mismo para
 ...
 compatibles Sound Blaster, pero nos engañan, ya que la compatibilidad la
 ...
 Historicamente, se trataba de mantener los PATH's con una longuitud pequeña,
 ...
 Similarmente es recomendable mantener un tamaño aceptable en los directorios
 ...
 contiene otro pequeño cargador que lee la primera parte del S.O. y lo inicia.
 ...
 se encuentra comprimida, por lo que contiene un pequeño sector de codigo al
 ...
 Los comandos con privilegios de superusuarios pueden causar gran daño si
 ...
 Algunas de las opciones que se le agregan a la linea de comandos son:
  ...
  defecto es usar el ID mas pequeño mayor a 99 y mayor a cualquier UID de
 ...
 si lo ejecutara el dueño (owner) del archivo ejecutable, sin importar quien
 lo ejecute. Esto es, cualquier usuario que ejecute dicho programa adquiere
 los privilegios del dueño, mientras el programa esta en ejecucion.

 El modo setgid es similar al anterior, solo que se adquieren los privilegios
 del grupo del dueño del archivo, y no del usuario.

 El dueño de un archivo puede setear los setuid y setgid mediante el comando
 chmod. La forma de utilizar este comando es tratada en la seccion 7.6.

 El modo setuid se indica con una s en la posicion ejecutable (x) del dueño.
 ...
 con los privilegios y el ambiente del usuario dueño de ese archivo.
 ...
 Bueno señores, aca termina este manual del sistema operativo Linux Red Hat
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
 ...
 Asunto: dudas sobre la 3º revista
 ...
 mesmo?
 Desculpe por nπo ter respondido sua ultima mensagem 
 ontem pelo ICQ, e que eu realmente ta perdidaτa em 
 materia de ICQ, e de informatica em geral.(risos)Sei la
 o que eu fiz, que consegui me desconectar, como ja era 
 muito tarde ou melhor cedo fui dormir. Eu nπo sei que 
 bobagem eu fiz que voce entrou no meu ICQ, mas nπo do 
 jeito que eu queria; vou explicar: Voce nπo ficou "la em 
 cima" junto com os outros, vc ta escondidinha  no ICQ 
 List ou seja nπo consigo enxergar quando vc esta online, 
 da pra entender ou ta muito confuso? Hoje meu filhπo 
 chega de viagem e ele deve saber qual a caca que eu 
 fiz,resta saber se ele vai ter, diria, "vontade 
 polφtica" de me ajudar, pois ele faz de tudo pra que eu 
 fique afastada da civilizaτπo...diz que Internet nπo e 
 coisa pra mπes (pra velhos ele quer dizer) "vc e a unica 
  mπe que eu conheτo que gosta da Internet, de andar de 
 bicicleta na praia, ir no pagode e coisas do genero! 
 (isso pq s≤ tenho 35 anos, imagina qdo eu tiver 60!)Mas 
 nπo vou desistir dos meus prazeres jamais, vou sim e 
 tratar da cabecinha dele, ele deve sofrer muito nπo acha?
 Gostei muito de saber que vc e o ADDK sπo casados, 
 adorei a hist≤ria de amor de voces.
 Quem sabe a gente combina um dia e se encontra , aqui em 
 Sampa ou aφ no Rio, seria divertido conhecer os outros 
 tambem nπo e?
 Hoje nπo entrarei na batalha, vou deixar ele matar a 
 saudades da Net, mas depois negociarei com ele, pois 
 vivemos numa democracia e depois da meia-noite e hora de 
 crianτa estar na cama, mesmo pq estou super cansada 
 ...
 mail ta?
 Um beijπo pra voces, e ate!

 Ah! NΓo deixe a moτada esquecer de mim, adoro a 
 companhia de voces, me faz muito bem!E se outra Sereia 
 invadir aquele marzπo e plagio!
 ...
 y me di cuenta que lo que me enseñaron, esta todo ahi!!! pero actualizado! y
 ...
 ----------------------------------------------------------------------------
 De: Fabian A. Muñoz &lt;fmunoz@XXXXXXX.XXX.XX>
 Asunto: Revista
 Fecha: Martes, 13 de Junio de 2000 05:32 a.m.

 Que tal, me interesa la propuesta, mi nombre es Fabian Muñoz y soy Analista
 ...
 aclarado nuestras dudas, porque son o españolas o americanas.
 ...
 Pero ojo, que si era verdad yo no iba a da±ar ninguna pc. Bueno, en este 
 tiempo me he dedicado a recolectar informacion(muchisimas revistas 
 espa±olas) pero aqui va una triste verdad: SIN UNIX/LINUX no podes hackear 
...
ææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææææ
  ...
  Esperamos sus e-mails. Hasta la edicion 4. 
     ...
     ██████████████████████████████████████████████████████████████
     ██████         Fecha de elaboracion: 28/7/2000          ██████
     ██████            Proxima entrega:   15/8/2000          ██████
     ██████████████████████████████████████████████████████████████
