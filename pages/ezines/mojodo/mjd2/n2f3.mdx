...
+---(Attenzione)--------------------------------------------------------------------+
|                                                                                   |
| Questa guida Φ da considerarsi come un'appendice delle lezioni sul Perl,  quindi  |
| se  non studiate  il perl  potete anche  non leggere  questo txt  poi fate  come  |
| volete. Ho scritto questo articolo visto che entro breve scriver≥ la lezione sui  |
| socket  col  perl e  forse  uscirα il  mio  prog-lezione per  le  e-mail in  cui  |
| sentirete molto  parlare di  'sti benedetti  moduli. Let's  Go (o  come cazzo si  |
| dice!!)                                                                           |
|                                                                                   |
+---(Start)-------------------------------------------------------------------------+
|                                                                                   |
| Forse, se avete letto  le ultime mie lezioni  avr≥ nominato un paio  di volte il  |
| Cpan e i moduli. Riguardo ai moduli vi d≥ una spiegazione semplice ma  efficace:  |
| i moduli stanno al Perl  come le librerie stanno al  C, pi∙ o meno. Questi  sono  |
...
| diciamo pi∙ semplici ed elementari (come ad esempio le operazioni  matematiche).  |
...
| pacchetto IO. E' detto standard poichΦ Φ presente in tutte le distribuzioni perl  |
| senza  bisogno di  scaricarlo da  internet. Uno  dei moduli  per i  socket "non   |
| -standard" Φ ad esempio quello utilizzato per lo script che AdVanced ha inserito  |
...
| Slackware 8.0  non ho  ancora controllato,  io preferisco  IO::Socket ma chissα,  |
| magari ce n'Φ un altro che non conosco che Φ migliore). Voi direte...come faccio  |
...
| faccio a utilizzarlo? Per la prima domanda  ho due risposte per voi: La prima  Φ  |
| forse la pi∙ logica, andare nella directory in cui sono presenti tutti  sorgenti  |
| e    cazzi     vari    per     l'interprete    Perl     che    generalmente    Φ  |
...
| nome  cmq  quelle  di  cui  sopra   son  le  pi∙  usate.  Prendo  come   esempio  |
| /usr/lib/perl5 che Φ  quella che possiedo  sia per la  Slack che per  la RH. Per  |
...
| di volete) :D C'Φ anche un altro modo molto pi∙ semplice e comodo (NdVoi: E  ORA  |
| CE LO DICIII??) ossia quello di utilizzare una delle opzioni che il nostro  caro  |
| interprete ci mette a disposizione:  l'opzione -M (cioΦ Module). Funziona  cos∞:  |
| scriviamo nel prompt  o in un  terminate: perl -Mnomedelmodulochevogliamo  se il  |
| modulo  Φ presente  ci apparirα  lo STDIN  per inserire  il codice  (per uscire   |
| premere  CTRL +  C), mentre  se non  Φ installato  ci apparirα  un messaggio  di  |
| errore. Esempio:                                                                  |
|                                                                                   |
| # perl -MNet::FTP                                                                 |
...
| ...e qua entra in ballo  CPAN. Un p≥ di storia:  CPAN nacque dalla mente di  due  |
...
| espanderli. Nacque  cos∞ la  comunitα del  CPAN che  sta per  Comprehensive Perl  |
| Archive Network, ossia Archivio di Rete  Perl Completo che, negli ultimi anni  Φ  |
...
| CPAN Φ portato avanti dai migliori programmatori Perl di ogni angolo della Terra  |
| che mettono a disposizione tutto ci≥ che creano per gli altri...insomma...  CPAN  |
| Φ un  piccolo paradiso  dell'open source.  Per usufruire  dei servizi  di questo  |
| immenso archivio  basta collegarsi  al sito  http://www.cpan.org e  vedere un p≥  |
| quello che ci serve. Ovviamente se ci interessa un modulo andiamo nella  sezione  |
| Modules che contiene pi∙ di 3000 moduli suddivisi per categorie a seconda  della  |
...
| incontrando  un nuovo  artista, il  cui tocco  stimoli nuove  tecniche, che  pu≥  |
| ritrovare vigore e crescere!" secondo me ci  stava bene e l'ho messo :■ Poi  c'Φ  |
...
| per benino  del sito  perchΦ quando  avrete problemi  con la  programmazione, vi  |
| serve qualcosa, modulo o script  che sia, insieme al man  il CPAN Φ il vostro  +  |
...
| make test                                                                         |
|                                                                                   |
| (se volete fare un test di integritα e funzionalitα del modulo in modo da vedere  |
| se Φ tutto ok)                                                                    |
|                                                                                   |
| make install                                                                      |
|                                                                                   |
...
| installazione... Per verificare  se tutto Φ  apposto basta fare  quel che vi  ho  |
...
| perl -MMail::Sendmail                                                             |
|                                                                                   |
| e se  ci appare  lo STDIN  in attesa  Φ tutto  apposto, il  modulo Φ  installato  |
...
|                                                                                   |
| leggete sempre la manpage del modulo appena installato perchΦ viene spiegato  il  |
| modo in cui lo si utilizza generalmente  sotto la riga SYNOPSIS ma non Φ  detto.  |
| Quindi divertitevi  e codate,  codate, codate!!!  Forse ve  l'ho giα detto altre  |
| volte ma non mi stancher≥ mai  di ripetervelo! Ci vediamo sempre con  le lezioni  |
