...
+---(INTRODUZIONE)-----------------------------------------------------------------+
|                                                                                  |
|  Il  protocollo  TCP/IP,  Trasmission  Controlo  Protocol/Internet  Protocol, Φ  |
...
|  For Comments, cioΦ  quelle pubblicazioni che  descrivono i vari  aspetti delle  |
...
|          pacchetti. [RFC 792]                                                    |
|                                                                                  |
|        - IGMP, Φ utilizzato per segnalare ai router l'eventuale appartenenza     |
|          ad una determinata rete.                                                |
|                                                                                  |
+---(TCP [RFC 793])----------------------------------------------------------------+
|                                                                                  |
| TCP Φ  un protocollo  di trasmissione  di pacchetti  affidabile come gia visto   |
...
| pacchetto che TCP trasmette. Infatti l'host ricevente dovrα rispondere con  un   |
...
| tramite un numero di porta  che Φ  compreso tra 0  e 65.536. Le porte  dal  lato |
...
|                                                                                  |
| Ricordiamo che ogni segmento TCP/IP Φ numerato, e precisamente ogni  segmento    |
| contiene:                                                                        |
|                                                                                  |
...
| Ogni IP Φ costituito da due ID,                                                  |
...
| L'indirizzo IP Φ comunemente visualizzato in forma decimale puntata,             |
| ad esempio: 207.46.197.101. In questa forma l'IP viene presentato da             |
| quattro campi di 3 cifre che arrivano al massimo a 255.                          |
| La sua forma Φ: a.b.c.d dove 'a' rappresenta l'ID di Rete e 'b' l'ID Host.       |
| Il formato utilizzato dalle macchine per trattare gli IP Φ in realtα             |
| quello binario. In questo formato abbiamo che ogni IP Φ dato da quattro          |
| otteti, cioΦ campi di 8 bit, per un totale  di 32 bit (Nota: per aumentare       |
| la disponibilitα di indirizzi con IPv6 si hanno IP di 128 bit).                  |
|                                                                                  |
