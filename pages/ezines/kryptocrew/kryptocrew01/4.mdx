...
und eventuell bei der ▄bertragung aufgetretene Fehlern beseitigt werden k÷nnen. Bei dem im Internet verwendeten 
Protokoll werden alle Daten in Bl÷cke (Packets) aufgeteilt und verschickt; bei Leitungsst÷rungen werden 
...
in dem die Adresse des EmpfΣngers vermerkt ist. Fⁿr die korrekte Zustellung dieser Pakete ist ein weiteres Protokoll 
verantwortlich, das Transmission Control Protocol (TCP). Da beide gewisserma▀en eine Einheit bilden, spricht man in der 
