...
┌────────────────────────────────────────────────────────────────────────────┐
│                                                                            │
│   ┘ │  │     /  │ Phone Losers of America Special Report   ┘ │  │     /  │ │
...
┌────────────────────────────────────────────────────────────────────────────┐
│ THÉ ΣXi£Σ welcomes you to TWi$TΣD RΣA£iTY  (The Elite Phreekers of 618...) │
└────────────────────────────────────────────────────────────────────────────┘
 ·WARNING· ·WARNING· ·WARNING· THE SYSOP OF THiS BBS iS NOT RESPONSiBLE FOR 
...
RULES: 
  ...
  [Feel the cheese, feel the lameness of this total wanna-be phreaker bbs. I
   ...
   The sysop's name is Phillip Wool, alias Mr. Hack aka LÅXVÅXÉN and totally
...
LÅXVÅXÉN (EXiLE) #1             Belleville, Illinois          08/02/95 Locally 
...
Mr.Xerox  #22                   Bethalto,ill                  07/30/95 14.4/V32
...
ThΣ Pφìñt #2                    Alton, Illinois               07/27/95 Locally 
...
VMX                Phreeker          Inet            Diskdrive    Lordchaos
 ...
 [Eight Ball had the pleasure of chatting with LÅXVÅXÉN one night and was
...
8B: Oh you'll probably see when the PLA do what they did to them to you.
  ...
  [Nobody is sure if LÅXVÅXÉN is trying to be elite or he just doesn't know
...
/s
   ...
   What's even worse is their hack line at 618-397-7729...
    ...
    Thank you for calling TWi$TΣD RΣA£iTY, another fine Synchronet BBS...
