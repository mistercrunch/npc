...
PC'Æs ICMP reply packet will divulge:

	o The hostname of the PC
	o The hostname of the PC'Æs authentication server
	o The username of the person logged in
	o The password for the user
 (Thank you very much!)

All of this information is in clear text unless PC-NFSÆ's NETLOGIN is 
...
don'Æt have a sniffer, try the -v(erbose) option of ping and convert the 
