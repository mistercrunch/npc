...
```
                       ...
                       ñ-=Abuso de los proxy's para windows=-ñ
...
Asi que por fin, me he decidido a escribir un peque±o texto, que sin entrar
...
de ellos si, otros no son vulnerables por defecto pero un peque±o descuido
...
son bastantes buenos en redes peque±as y si son configurados con cuidado no
...
hay que despreciar el da±o que pueden hacer el resto de posibles agresores.
...
Estas peque±as pautas de configuracion que voy a dar a continuacion son muy
...
1) Cerrar todas las pasarelas que no se usen: Normalmente en peque±as redes
...
Por ejemplo, si tenemos una peque±a red con 3 maquinas conectadas en red. 2 de
...
Y un peque±o truco para comprobar que realmente es un WinProxy, hacemos una
...
habitualemente por administradores de peque±as redes en espa±a.
...
El proxy telnet del s-proxy, tiene un peque±o inconveniente con respecto a
