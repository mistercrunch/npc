...
&lt;Gbyte> Θ soh escuta no test mode dele, soh q Θ dificil de achar... 
         se alguem achar...
&lt;Gbyte> tipo, entrar no test mode todo mundo entra agora fazer a 
         escuta ja Θ meio foda, ve ai com o pessoal se ja sabem disso, 
...
&lt;Gbyte> Meio Bobo, mas na falta de coisa sobre Cells pode colocar 
         isso... olha isso muita pouca gente sabe... e esse Cell Θ 
...
YXXXXXXXXXXP^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^YXXXXXXXXXXP
  ~YXXXXXX(                                )XXXXXXP~
   ...
   Certo dia na irc.viars.com.br no knal #rosßrio eu tive uma experiencia
...
&lt;InBloom> que silΩncio
&lt;InBloom> quem eh rosariense de coraτπo digita: //say $port
&lt;InBloom> heheheh
...
&lt;InBloom> cara... se vc se esforτar vc vai ser um hacker completo como 
...
https://cadastro.mandic.com.br/index.cgi-bin?loc=poa&page=/etc/shadow
   ...
   Apareceram 2 caracteres (►î) que nao tinham nada a ver com o shadow.
