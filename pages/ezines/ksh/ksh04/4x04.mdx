...
----------
 ...
 9.2.4     íHay un Intruso en mi Sistemaí ┐Que hago?
...
Ahora si, demosle continuacion al documento í
...
Con  este  peque±o  fragmento del  archivo /etc/inetd.conf NO os  digo que asi 
...
desempe±ar como un servidor, podrias  deshabilitar  todos los servicios, ahora
...
Si NO lo tenes, pues entonces a actualizar tu kernel í
...
---
 ...
 MASQ: los paquetes serßn enmascarados como si se tratara del equipo maestro.

 REDIRECT: los  paquetes  puedes ser  redireccionados al  socket local  de  la 
           maquina maestro.
           
 RETURN: El  procesamiento  de paquetes  continuara en la  pr≤xima regla de la 
         siguiente cadena.
...
sistema. Verifica contrase±as, archivos SUID, SGID, etc...
...
Reviza el  sistema en  busca de  archivos alterados  o da±ados. Muy importante
...
- Directorios o ficheros sospechosos. Los usuarios mas  potenciales a realizar 
  un atake son los locales, verificar si hay archivos  estra±os en sus cuentas
...
#! /usr/bin/ksh
# entrada.ksh - Guarda informaci≤n de los accesos 
...
# Fichero en el que se va a guardar la informaci≤n
 ...
 * iplog
 ...
 9.2.4  í Hay un Intruso en mi Sistema í ┐Que hago ?
------------------------------------------------------

Ante todo  !  Calma í... Que  ya hemos perdido  el puesto.. je  je , talvez no
...
- Desconectar nuestro  servidor de  Internet, asi  podremos  evaluar  el da±o, 
  cerrar el agujero, trabajar mas rapido y tomar decisiones acertadas.
  

- Evaluar  el  da±o, es importante  investigar  que se  a  comprometido  en el 
  ...
  O comprobar  si el  acceso no  causo ningun  da±o, y hacer  unos chequeos de 
...
informacion del servidor, desface de la pagina, hasta la toma de contrase±as y
...
problemas referentes a esto, entre los que podemos citar:
 ...
 > Cuentas con contrase±as debiles.

 > Cuentas sin Contrase±as.
...
-> Consejos para evitar el problema
   --------------------------------
- Escoja una Contrase±a Segura, e igualmente hagale saber esto a  sus usuarios 
  para que no comprometan el sistema, un cambio periodico de  la contrase±a es 
  realmente necesario, como la no anotacion de la clave en  ningun medio. Para 
  saber como escoger  una contrase±a  segura, lea de nuevo l a parte I de este 
  documento.

- Verifique las contrase±as de su sistema, con un crackeador de password.
...
Seg-l
------
En espa±ol, para subscribirce enviar un mensaje a majordomo@secnet.com con  el
