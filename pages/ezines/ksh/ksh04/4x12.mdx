...
sus  primeros años. Su  importancia es  tal,  que en la  actualidad  todos los 
servicios de Internet trabajan con el DNS.


---[ 1.1 Historia del Sistema de Nombre de Dominios ]----

En los años 1970, ARPNet  fue  pequeña, una  comunidad amigable  de unos pocos 
...
semana. A medida como ARPANet crecio, este esquema era inmanejable.  El tamaño
...
de  diseñar la  arquitectura del  nuevo sistema.  En 1984,  se emitieron  los
...
El  Sistema  de  Nombres de  Dominios  es  bßsicamente una  base  de  datos de
...
Recordemos que uno de los principales objetivos del diseño de los Sistemas  de
...
final. La palabra IN señala que la clase de datos es Internet.
...
Esta  direcci≤n  electronica  es  para   permitir  el  envio  de  correos   al
...
named.boot.
        ...
        En la configuracion anterior señala:
...
@               IN      SOA     ns.server.org  root.ns.server.org 
                                (
                                2000012001      ; Serial año|mes|dia|version
...
dominio, pero tambiΘn  lo pueden hacer  haciendo que otro  dominio resuelva en
...
1.  Administracion de  grandes  cantidades de usuarios, de manera  que  aunque 
    ...
    final. Esto es muy usado por compañias comerciales del tipo America Online 
...
con una pequeña descripcion del 
