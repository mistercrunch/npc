...
permaneceran en memoria y no tendrß que volver a a~adirlos.
...
--------== Caracterφsticas - (Sacado de la Web de Cisco) ==-------
...
2),  con velocidades  mßximas de  recepci≤n de  datos de  hasta 8.024  Kbps y
velocidades de transmisi≤n de datos de hasta 864 Kbps


* Futura compatibilidad con el  funcionamiento de g.lite a travΘs  de descarga
de software, con una velocidad mßxima de 1.536 Kbps en la recepci≤n de datos y
velocidades mßximas de 512 Kbps en la transmisi≤n de datos


* La conexi≤n fφsica ADSL admite la encapsulaci≤n de la capa de adaptaci≤n ATM
5 (AAL5)
...
* Interfaz Ethernet 10BaseT o 100BaseTX con negociaci≤n automßtica


* Inicializaci≤n/configuraci≤n local a travΘs del puerto serie RJ-45
...
*  Utiliza  la  tecnologφa  EZ-DSL  de  Cisco  para  proporcionar  las mßximas
...
* Admite PPP no encapsulado a travΘs de AAL5
...
(DHCP) para la asignaci≤n de direcciones IP dinßmicas


* Admite Relay Agent DHCP


* Opcionalmente, admite la asignaci≤n de direcciones IP y de mßscaras de red a
travΘs de IP Control Protocol (IPCP)
...
* Interfaz grßfica de usuario basado en usuarios Cisco Commander para conectar
...
*  Divisor  del  servicio  de telefonφa  bßsica:  Un  divisor  pasivo opcional
proporciona  simultßneamente  servicios  de  voz  anal≤gica  y  datos  de alta
velocidad a travΘs de una sola lφnea telef≤nica de par trenzado


* Microfiltros EZ-DSL en lφnea y  montados en la pared para instalaciones  sin
divisores
--------------------------------------------*
...
* Interfaz ADSL :
     ...
     G.992.1 Anexo A (DMT de velocidad completa a travΘs de POTS anal≤gico)
...
FCC  parte 15,  sub-parte B,  1997; CSA  estßndar C108.8  (1993); VCCI,  1995;
...
certificaci≤n de la CE sobre emisiones electromagnΘticas y seguridad
...
--: Conformidad con estßndares :-------

* ATM Forum UNI versi≤n 3.1 PVC

* Especificaci≤n de nivel fφsico IEEE 802.3 y 802.3u 10BaseT y 100BaseTX
...
* Interfaz de lφnea de comandos


* Interfaz grßfica de usuario (GUI) Cisco Commander
...
* Admite MIB SNMP (MIB-II, MIB PPP, MIB de ßrbol de extensi≤n, MIB de 
empresa)
