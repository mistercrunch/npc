...
server secundario de apoyo. claro estß, que eso implica una serie de gastos  a
...
ataques, pórque se sale del objetivo del articulo.
...
-con esto  le determinamos  que esta  maquina actuarß  siempre como el  server
secundario.
...
fichero /etc/rc.d/rc.local o bien usando este otro comando: ntsysv. claro estß
