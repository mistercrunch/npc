...
## Bueno hasta ahora la cosa va bien  .. SΘ que es un servidor y 
...
......                          < -- # para no cansar me volΘ algunos ... jeje
...
## es probable que estΘs pensando en lo inseguros que estΘn muchos hosts por ahi.. ;) ...
...
1) Desactiva todos los servicios que no estΘs usando FTP,news,http, etc.

2) Crea una  polφtica de passwords para los usuarios, que les obligue 
