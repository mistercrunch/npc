...
tendrß por nombre "eggdrop.conf" pues lo modificare a mi gusto, ya
...
"./eggdrop mybot" sin la opcion -m (que es la que le indica el dueño)
...
Ojala que les sirva de algo este pequeño manual, que aunque no es tan
