...
║  Date        │   Commentaire                                             ║
╟──────────────┼───────────────────────────────────────────────────────────╢
║ 14 / 03 / 93 │  - Aprés avoir codé BlackWorm me revoila au travail, mais ║
║              │    cette fois-ci se sera un Virus de fichier. Cette       ║
║              │    cette première version il n'infectera que les fichiers ║
║              │    .COM.                                                  ║
║              │  - Je commence donc par écrire les routines les plus      ║
║              │    faciles ; incluant : le Decrypteur/Encrypteur          ║
║              │                         le releveur du code original      ║
║              │    il reste beaucoup d'erreurs a corriger ....            ║
║              │                                                           ║
║ 15 / 03 / 93 │  - Aujourd 'hui je commence a écrire la routine résidente ║
║              │    elle aura la particularité de s'encrypter et se        ║
║              │    decrypter a chaque appelle, ce qui est très rare.      ║
║              │    La routine résidente intercepte l'interruption 021H    ║
║              │    (Bien sur !) la fonction 04B00H (éxecution).           ║
║              │    Et peut être même les fonctions 04EH, 04FH, 03FH pour  ║
║              │    camoufler le code virale, ce qui en fera un virus      ║
║              │    assez difficile à démasquer.                           ║
║              │                                                           ║
║ 16 / 03 / 93 │  - Encore là, j'écris la routine résidente - qui est la   ║
║              │    partie la plus complexe du virus. Plusieurs bogues ont ║
║              │    été fixés cette journée là.                            ║
║              │                                                           ║
║ 17 / 03 / 93 │  - Le premier essaie sur un fichier éxecutable est effe-  ║
║              │    ctué aujourd'hui  (Sans la partie résidente).          ║
║              │    Les résultats sont satisfaisants.                      ║
║              │                                                           ║
║ 18 / 03 / 93 │  - Cette journée là j'ai écris le Miner,   qui est chargé ║
║              │    de deposer les mines dans les fichiers .EXE.           ║
║              │    J'ai décidé que les mines seraient des NOP (je ne veux ║
║              │    pas causer beaucoup de dommage a l'utilisateur).       ║
║              │  - Aussi , j'ai écris le Memory Verifier. Ce code est     ║
║              │    chargé de detecter plusieurs anticorps (logiciels ou   ║
...
║              │    le virus et ceci est très delicat (et je n'ai pas un   ║
║              │    386 pour avoir S-ICE donc ..)                          ║
║              │                                                           ║
║ 20 / 03 / 93 │  - Un vrai cauchemard ... je n'arrive pas a comprendre    ║
║              │    pourquoi la routine résidente ne marche pas.           ║
║              │    Aprés plusieurs heures de travail (9..) je réussis à   ║              │                                                           ║
║              │    corriger quelques bogues. Mais même avec ça, je        ║
║              │    n'arrive pas à faire quelque chose de bon.             ║
║              │    Je n'ai presque pas dormi cette nuit là ....           ║
║              │                                                           ║
║ 21 / 03 / 93 │  - Je me lève tôt le matin et je commence à travailler sur║
║              │    une petite Mutation Engine,   Aprés 4 heurs de travail ║
║              │    ma Mutation Engine pris forme , d'une taille de 60     ║
║              │    bytes , c'est la plus petite Mutation Engine jamais    ║
║              │    conçu...                                               ║
║              │    Ensuite j'ai travaille sur le code résident et j'arrive║
║              │    enfin à le réparer .. à 7:22 de l'aprés midi, c'est    ║
║              │    la première propagation entièrement réussite .         ║
║              │    Je suis sur la lune ...                                ║
║              │                                                           ║
║ 22 / 03 / 93 │  - Bon, aujourd'hui j'ai ajouté quelques petites routines ║
║              │    très importantes , parmi eux : une routine pour        ║
║              │    detecter les fichiers inféctés par des virus comme     ║
║              │    Jeru , Vienna ansi que presque toutes les creations    ║
║              │    de RABID , car ces virus mettent la valeur 62 dans     ║
║              │    les secondes du fichiers infécté .                     ║
║              │  - J'ai aussi corrigé quelques erreurs (assez graves).    ║
║              │  - Je decide aussi d'écrire une Mutation Engine Plus      ║
║              │    performante.                                           ║
║              │                                                           ║
║ 23 / 03 / 93 │                                                           ║
║              │                                                           ║
