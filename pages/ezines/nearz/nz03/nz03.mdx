...
─=< issue 03 >=────│────=[     N e a r ( z )      ]=──────────=< issue 03 >=─
   ...
   Keywords: Hack, Crack, Linux, Zine, Programming, Virii, Exploit, NearZ    
                         ...
                         ┌┐                      ┌┐
  ┌──────────┐          ┌┘│                      │└┐          ┌──────────┐
  │ issue 03 │         ┌┘ │    Janeiro  1998     │ └┐         │ issue 03 │
  └───┐  ┌───┘        ┌┘  └──────────────────────┘  └┐        └───┐  ┌───┘
 ┌───┬┴──┴┬─────┬─────┘ ┌──────────────────────────┐ └─────┬─────┬┴──┴┬───┐
...
└─┴──────────────────────────────────────────────────────────────────────┴─┘
   ...
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [i]■         i n t r o          ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │  ├──────────────────────────────┤ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [1]■    SendMail 8.8.4 Xploit   ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [2]■       Windows NT bugs      ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [3]■           I C Q            ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [4]■        V i r u s           ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [5]■      Denial of Service     ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [6]■   Fake Email / Email Bomb  ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [7]■  Minicom  Buffer OverFlow  ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │  ├──────────────────────────────┤ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [M]■      M A i L   B O X       ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ │ [*]■      from  /   falow       ■ │ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒ ╚═─────────────────────────────────═╝ ░░▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
...
╚══╩═──┴─┴─┴─┴─┴─┴─┴─┴─╚╦═┬=┬────────────────────┬=┬═╦╝─┴─┴─┴─┴─┴─┴─┴─┴──═╩═╝
   ...
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   █▒▒▒▒▒ ┌───────────────────────────────────────────────────────┐ ▒▒▒▒▒█
   █▒▒▒▒▒ │ Estamos com pagina nova :^) http://nearz.home.ml.org  │ ░░▒▒▒█
   █▒▒▒▒▒ │ mas caso a nossa  queria monolith nao  esteja beleza  │ ░░▒▒▒█
   █▒▒▒▒▒ │ usa este : http://members.tripod.com/~nearz/.         │ ░░▒▒▒█
   █▒▒▒▒▒ │ Com um "poukinho" de atrazo estamos aki... EmaiL:     │ ░░▒▒▒█
   █▒▒▒▒▒ │ parece que a galera ta ficando com medo de mandar pra │ ░░▒▒▒█
   █▒▒▒▒▒ │ gente comentarios, correcoes, criticas, etc! mas em   │ ░░▒▒▒█
   █▒▒▒▒▒ │ todo caso: &lt;nearz@geocities.com> valeu?               │ ░░▒▒▒█
   █▒▒▒▒▒ └───────────────────────────────────────────────────────┘ ░░▒▒▒█
   █▒▒▒▒▒▒▒░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░▒▒▒█
   █▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒█
   ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
