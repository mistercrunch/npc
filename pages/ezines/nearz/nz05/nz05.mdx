...
issue05           │                                                 
   ...
   KeyWorDZ: Hack, [ FiLE: nearz05.txt  ]  ┌─┐ MeMBeRZ ┌───┐     ▄▄▄  ▄▄▄▄▄
     CrACk, Linux, [ SiZE: 60000 Bytes  ]  │ └─────────┘   │    █   █ █    
      ProGraMMing, [ DATE: 25 Abr 1998  ]  │ ThERevenge    │    █   █ ▀▀▀▀▄
    VirII, XpLoit, [ Format: Plain-Text ]  │ SouL Hunter   │    █   █     █
...
──────────────────────────────────────────────────────────────────────────────
 ...
 └┬┘  └┬───────────────────────────────────────────┘
  ...
  │
  └─> Antes dos ':' pode ser colocado qualquer nome. Esse nome serve para
