...
──────────────────────────────────────────────────────────────────────────────
   ...
   KeyWorDZ: Hack, [ FiLE: nz09.txt     ]  ▄▄▄   ▄▄▄   OBtRuDeR
     CrACk, Linux, [ SiZE: 70000 Bytes  ] █   █ █   █  SoUL HuNTeR
      ProGraMMing, [ DATE: 01 Dec 1998  ] █   █  ▀▀▀█  ReVeNGe
    VirII, XpLoit, [ Format: ASCII-Text ] █   █ ▄   █  im0rtal
        ZiNe, asm, [ Lang: Portuguese   ]  ▀▀▀   ▀▀▀   bahamas
...
──────────────────────────────────────────────────────────────────────────────
 ...
 └────────────────────  ╚╗   =────────────────────=   ╔╝  ───────────────────┘
   ...
   < NewZ >
    ...
    ╔═─────────────────────────────────────────────═╗                        
 ■──┤ [0x01] &lt;pRg> Aprenda C - Parte I              ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
void main()
{
 ...
 print("Windows has been slightly tuned up in
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x03] &lt;hCk> The Near(z) BaCkDooRs (reAL)     ├──────■ SoUL HuNTeR ■─
    ╚═─────────────────────────────────────────────═╝
...
------------------------------------------------------------------------------
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x04] &lt;cRk> Cloning Technology               ├────■ OBtRuDeR/im0rtal ■─
    ╚═─────────────────────────────────────────────═╝
