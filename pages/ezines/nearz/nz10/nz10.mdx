...
──────────────────────────────────────────────────────────────────────────────
   ...
   KeyWorDZ: Hack, [ FiLE: nz10.txt     ]    ▄▄  ▄▄▄   OBtRuDeR
     CrACk, Linux, [ SiZE: 70000 Bytes  ]     █ █   █  SoUL HuNTeR
      ProGraMMing, [ DATE: 18 Jan 1999  ]     █ █   █  ReVeNGe
    VirII, XpLoit, [ Format: ASCII-Text ]     █ █   █  im0rtal
        ZiNe, asm, [ Lang: Portuguese   ]     ▀  ▀▀▀   PsYCh0ByTe
...
──────────────────────────────────────────────────────────────────────────────
 ...
 └────────────────────  ╚╗   =────────────────────=   ╔╝  ───────────────────┘
   ...
   caras da fyodor's nao merecem isso.)
    ...
    ╔═─────────────────────────────────────────────═╗                        
 ■──┤ [0x01] &lt;iNf> Caffeine                         ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝                        
...
└─■                                             ─  ── ── ─── ──── ───── ─────┘
   ...
   ╔═─────────────────────────────────────────────═╗
■──┤ [0x02] &lt;pRg> Aprenda C - Parte II             ├──────■ PsYCh0ByTe ■─
   ╚═─────────────────────────────────────────────═╝
...
└─■                                             ─  ── ── ─── ──── ───── ─────┘
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x03] &lt;iNf> Kernel 2.0.36 PATCH              ├──────■ PsYCh0ByTe ■─
    ╚═─────────────────────────────────────────────═╝
...
└─■                                             ─  ── ── ─── ──── ───── ─────┘
    ...
    ╔═─────────────────────────────────────────────═╗                        
 ■──┤ [0x04] &lt;pRg> Sockets Programming              ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝                        
...
└─■                                             ─  ── ── ─── ──── ───── ─────┘
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x05] &lt;DoS> Smurf (papa)                     ├──────■ GhostOBtRuDeR ■─
    ╚═─────────────────────────────────────────────═╝
...
└─■                                             ─  ── ── ─── ──── ───── ─────┘
    ...
    ╔═─────────────────────────────────────────────═╗
 ■──┤ [0x06] &lt;cRk> Brute Force                      ├──────■ SoUL HuNTeR ■─
    ╚═─────────────────────────────────────────────═╝
