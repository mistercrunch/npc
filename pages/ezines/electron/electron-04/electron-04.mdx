...
intrucciones, asi como una formula para lograr un objetivo.  Ej:
	...
	Paso 1║ : Saque una taza y una "sopa para uno" (Obvio)
	Paso 2║ : Saque la tetera (Bueno si te incorporaste al presente 
                  tendras microondas)
	Paso 3║ : Llene la tetera con 350cc (Ejem... eso me suena a fye)
                  de agua
	Paso 4║ : Prenda el quemador (ALERTA: por favor hagalo con la
                  supervicion de un adulto )
	Paso 5║ : Hierva el agua ( hasta que llegue a los 100║ C)
	Paso 6║ : Vierta el contenido del sobre dentro de la taza 
                  (a gusto)
	Paso 7║ : Vierta el agua hirviendo dentro de la taza
                  (sin quemarse!!!!)
	Paso 8║ : Deje enfriar unos minutos (si no hace este paso va a
...
accion, no obstante  existen varios tipos de configuraciones para los NIDS.
     ...
     - Compañias con informacion de ataques conocidos
...
Hagamos otro ejemplo de resta para los que no entendieron, ísi tu, pon atencion!:
