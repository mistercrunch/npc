...
by Dean Costello
     ...
     &lt;Shh>Don't say anything.  Mark went to sleep, and he thinks I am
...
Birmingham BBS Scene Predictions for the 1990s
by Tyros
...
And I never did get to see the Superdome.
     ...
     somewhere between miffed and truly pissed off. &lt;And by the way, his
     password on Crunchy Frog is 'IM_WONDERFUL'. Check it out sometime.
     I was able to sneak it in since I had the last read of this
     article. Trust me.>. Besides, he probably won't even bother to
...
(J)oin      Allows you to switch to a different conference.  You may
            ...
            Don't use &lt;SPACE> in hotkey mode.  Examples:
               ...
               J;2;Q       ;quick join, bypassing conference news
                           &lt;Lets you skip the opening screen>

               J S         ;status of all conferences
                           &lt;This will list the conferences and which
                            ones are scanned, high message number etc.
                            The following is an example of mine from the
                            Crunchy Frog.>
...
message and when I hit &lt;Escape> I was prompted by the local program,
...
Mark,
   Why I outta...
     ...
     While entering text you can press &lt;escape> at any time and get a
