...
<────────────────────────────────────────────────────────────────────────────>
  ...
  ezine ;-)
        ...
        Por algun extraño misterio que no comprendemos, muchos de nuestros
...
()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()()
  ...
  Delincuencia Informatica de la Guardia Civil, pequeño ajuste que le he
...
------------ FIN -------------------------------------------------------------
 ...
 podremos obtener informacion del ordenador de usuario. Este codigo acompaña
 el applet llamado "Ungrateful.java", el cual esta mas abajo y asi podremos
 engañar al usuario y recibir su login y password de su ISP ;-)
...
------------ FIN -------------------------------------------------------------
        ...
        Este programa es el virus script que acompaña al programa Java
...
------------ FIN -------------------------------------------------------------
  ...
  que visite nuestro web (si!! su contraseña }:-) o cualquier cosa que se
  nos ocurra. Por desgracia java ofrece una seguridad efectiva contra este
  tipo de ataques.

        Como ya he dicho antes este codigo acompaña al applet llamado
  "LoginServerSocket.java". El siguiente codigo engaña al usuario diciendole
...
------------ FIN -------------------------------------------------------------
  ...
  tendra que resetear, como veis en este hipotetico caso los daños podrian
...
<────────────────────────────────────────────────────────────────────────────>
        ...
        Bueno, antes de nada, aclarar que TODO lo escrito aquí es puramente
  con FINES EDUCACIONALES y , ni yo ni ningún miembro de OiOiO'S Band se hace
  responsable del mal uso que se le pueda dar, y esas cosas m s que se dicen.
  Aclarado esto, vamos a por ello ;)

        Ante nada, decir que lo que aquí se va a comentar es una cosa muy
  cutre, que debemos agradecer a los coleguitas de la Timofónica.

        Voy a explicar como hacer beige boxing de guays en España, en otros
  paises no creo que varíe mucho la cosa, pero aquí est  facilillo.
  Pal que no lo sepa, el beige boxing consiste en llamar por telefono desde
  la calle o cualquier sitio donde encuentres una cajita de Timofónica para
  poder pinchar tu "móvil" ;)

        Lo primero de todo pasa por pillarte un telefono, preferiblemente
  pequeño, de esos que solo tienen el mango, pq va a ser nuestro móvil (si
  quieres uno grande, tú mismo, pero es m s dificil de esconder y m s palo
  ...
  de la Timo (las grandes, las pequeñas no se pq no he abierto ninguna, aun)
  Bueno, el proceso est  tirao, y pasa por cortar un cachito del cable que va
  a la roseta de la pared del telefono, y acoplarle ahí, o bien las pinzas, o
  bien el mencionado enchufe (en caso de tener cuatro cables, se ha de
  enchufar en los que quedaran enmedio , que generalmente son marrón y
  blanco). Tras ello ya tenemos móvil, y solo falta ir a llamar ;)

        Las cajas a las que me refiero est n a una altura del pecho, y llevan
  el logo de la Timofónica, y algunas llevan una pegata que pone: "manipular
  solo con el instrumental adecuado", y tb suelen llevar números para indicar
  a los chupópteros de que zona se encarga la caja XDDDDD El proceso para
  encontrar cajas es bien sencillo. Busca por:

        -Barrios residenciales, por dos cosas : todas las casas son plantas
  bajas, y en las zonas con edificios las cajas suelen ser de esas pequeñitas
  que se colocan en las fachadas de los edificios, a la altura del 1er piso, y
  sobre todo, porque piensa que al llamar la puta Timofónica no pierde nada,
  ya que llamamos cogiendo la linea de un pobre incauto, que desconoce lo
  poco que la Timofónica protege su línea de telefono. Así, si estamos en una
  zona de ricos es lógico pensar que va a pagar algún acaudalado ricachón, con
  ...
  las líneas que provienen de casas y van hacia la caja, que son los cables
  m s finos que hay, y a menudo hay muuuchos cables de estos finos, así que
  ...
  triangulares, o si no tienes (como yo), un buen destornillador (tiñaor de
  ahora en adelante ) har  de llave ;)

        Bien, si tienes la llave de contadores, te puedes saltar lo siguiente,
  que explica para paletos como abrir una caja con un tiñaor (la verd  es
  que no tiene secreto)

        Si eres de los que van con tiñaor en mano, sigue leyendo.
  Al toparte con la caja, puede darse la ocasión de que te encuentres con
  alguna de las m s antiguas, que son de hierro o algo así, y suelen estar
  por el campo, carreteras y dem s, así como en lugares donde la timo vaya
  poco, ya que parece que ahora todas las ponen de pl stico 8)''' ;)

        Bueno, en este caso, pilla el tiñaor, lo metes por donde queda la
  cerradura, y espero que sea un buen tiñaor, pq ahora hay que hacer
  palanca O:) XDDDDDD
  ...
  cajetín de los de pl stico, pues bien, estos son facilísimos de abrir.
  Puedes hacerlo como he dicho antes, con el tiñaor, o si se te ha olvidado
  en casa, simplemente pilla por la cerradura con las manos y pega un tirón ;)
  ¿F cil, verdad? }:)

        Vale, ¿y ahora? Que coño hago! Bueno, pues ahora pilla el enchufe al
  que me refería antes, que est  en la parte superior de la caja, aguantado
  ...
  que interesan, puesto que son los que tienen línea. Ahora solo hace falta
  ...
  endiñado el enchufe al móvil, solo te falta llamar, si le has puesto las
  ...
  usarlo, desde pinchar la línea auxiliar de tu casa a casa del vecino, a
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  hacemos, sobre todo porque nosotros no queremos dañar ningun servidor,
  ...
  :), que es la siguiente:
    ...
    DoS      <══════════╣│ │ │     4║    │ │ │ │
                       │ │ │ │ ┌────║──┐ │ │ │ │       Usuarios remotos
                       │ │ │ │ │   5║  ╠═════════════> pueden escribir en
    Usuarios           │ │ │ │ │ ┌──╩┐ │ │ │ │ │       archivos del sistema
    locales            │ │ │ │ │ │ 6 │ │ │ │ │ │
    obtienen sin       │ │ │ │ │ └───┘ │ │ │ │ │
    autorizacion       │ │ │ │ │   5   │ │ │ │ │
    permiso de         │ │ │ │ └───────┘ │ │ │ │
    lectura <════════════╣ │ │     4     │ │ │ │
                       ...
                       │ │ │       3 ╦  ║  │ │ │
                       │ │ └╦────────║──║──┘ │ │
    Usuarios           │ │  ║      2 ║  ╚════════════> Usuarios remotos 
    locales            │ └──║────────║───────┘ │       pueden leer archivos
    pueden escribir    │    ║      1 ║         │       del sistema {PELIGRO}
    en ficheros que    └────║────────║─────────┘
    no deberian  <══════════╝        ╚═══════════════> Usuarios remotos
                                                       obtienen sin
                                                       autorizacion logins
                                                       del sistema
  ...
  con toda la informacion recopilada diseñar un plan de ataque y conseguir
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  iba a enseñar "trucos sucios", y SI, les castigaria si los hacian mal.
  ...
  reseteas su reloj interno interno a 11:59 pm, hace que gane un año en
  minutos, asi que en poco tiempo, ya tenia 5 años :), despues de esto
  descubri que si le quitabas algun que otro minuto podrias alargarle la vida.
  "Borg5" murio con 35 años y 45 kilos. No iba a pesar mas, ademas que su
  ...
  reloj, es cuando empezoa probar con el "pequeño frankenstein". Darle de
  ...
  de feliz :).
        ...
        Todos los niños del vecindario querian aprender como se hacia para
  ...
  porque que pasaria si estos niños empiezan a probar en animales de verdad?
  ...
  al puerta?. Realmente pienso que a los niños de hoy hay que cambiarles su
  forma de pensar, nada de eso de "enseñame el triangulo azul" y esas cosas,
  de todas maneras, algun dia estos niños empezaran a usar ordenadores y a
  saber que haran..."
...
------------------------------------------------------------------------------
  ...
  de un ordenador, un 8086 o 80186, corria el año 85 (¿¿¿hace tiempo eh???)
  ...
  que le permitirian de una manera no dañina y recalco esto no dañina
  ...
  (incluso los lamers) puede enseñar algo (en el caso de los lamers lo que
  ...
  ultimos :))))) que le explicaron algunas cosillas y le enseñaron donde
  ...
  pequeño dragoncito se metio en este mundillo, por la que los hackers siguen
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  textos por ahi diciendo que tardaria años en sacar el passwd. Yo solo he
...
/tmp/sh 
  ...
  puede mandar "señales" a sendmail y controlarlo con los beneficios que ello
...
------------ FIN -------------------------------------------------------------
  ...
  pata (sobretodo a altas horas de la mañana jeje) y si por ejemplo haces un
  ...
  añadida al path canta un poco, que el tio se mosquee cuando el su le de
...
------------ FIN -------------------------------------------------------------
  ...
  makina de japon y luego a otra de noruega y luego a otra de españa, puedes
...
------------ FIN -------------------------------------------------------------
  ...
  *log* con lo que te buscara todos los archivos en la maquina que contengan
  ...
  una cuenta normal, ejecutar xploit, etc,... ya que esto es un coñazo.
  ...
  directoriopublico, ejecutamos ./cualquiera y tendremos una shell de root.
        ...
        En este momento es importante señalar las diferencias entre UID (User 
  ...
  linux (hay versiones posteriores del año 97 de esta rootkit):
  ...
  pequeñitos ke hay para esos sistemas operativos.
...
------------ FIN -------------------------------------------------------------
  ...
  PHRACK que esta diseñado para trabajar en SunOs, es muy pequeño y solo
...
------------ FIN -------------------------------------------------------------
  ...
  cualquier otra señal de comunicacion, sera castigado con las penas de
  prision de uno a cuatro años y multa de doce a veinticuatro meses. 
  ...
  tercero.
        ...
        3. Se impondra la pena de prision de dos a cinco años si se difunden,
  ...
  penas de prision de uno a tres años y multa de doce a veinticuatro meses,
  ...
  impondra la pena de prision de tres a cinco años, y si se difunden, ceden o
  ...
  apartado 5, la pena a imponer sera la de prision de cuatro a siete años. 
  ...
  de prision de uno a tres años y multa de seis a doce meses. 
  ...
  pena de prision de uno a cuatro años, multa de doce a veinticuatro meses e
  inhabilitacion especial para dicha profesion por tiempo de dos a seis años. 
  ...
  en el segundo parrafo del numero 4º del articulo 130. 
   
  Articulo 248. 
 
        1.- Cometen estafa los que, con animo de lucro, utilizaren engaño
  ...
  cuantia del daño, si este excediera de cincuenta mil pesetas. 
 
  Articulo 264. 

        1.- Sera castigado con la pena de prision de uno a tres años y multa
  de doce a veinticuatro meses el que causare daños expresados en el articulo
  ...
  o aplicacion de las Leyes o disposiciones generales. 
	...
	5º.- Que arruinen al perjudicado o se le coloque en grave situacion 
             economica. 
  ...
  Articulo 270. 
        ...
        Sera castigado con la pena de prision de seis meses a dos años o de 
  ...
  los medios o instrumentos señalados en el apartado 1 del articulo 197, sera
  castigado con la pena de prision de dos a cuatro años y multa de doce a
  veinticuatro meses.
 
        2.- Se impondra la pena de prision de tres a cinco años y multa de
  ...
  anteriores, se castigaran con la pena señalada en cada paso para los
  autores.
  ...
  sonido, de la imagen o de cualquier otra señal de comunicacion, con
  violacion de las garantias constitucionales o legales, incurrira en la pena
  de inhabilitacion especial para empleo o cargo publico de dos a seis años. 
  ...
  se comuniquen a la Oficina Consular de su pais.
        ...
        Deben olvidarse las vergüenzas, ya que esta en juego algo mas
  ...
  es diferente, y el mas preparado para diseñar la estrategia de ese momento
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  sentimientos nada mas y nada menos que casi un año y ahora resulta que se
  esta riendo de mi e intentando jugar conmigo sipcologicamente y me ha hecho
  un daño que te cagas y mi pregunta es si sabes si seria posible violar su
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  En primer lugar quiero felicitaros por la revista, porque íes c....!.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  en español programas ke hay,ejemplos de como suplantar otra ip etc...si
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  PlüE.. kalguien me traduzca el texto de iniciacion al phreaking. I si te 
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Hola tio, soy un chaval de 17 años que acaba de empezar a leer cosas sobre
  ...
  tengo ganas de aprender porque ademas esto no te enseñan en la carrera,
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  El motivo de mi mail era para el señor Nobody (me dirijo a el a traves de 
  ...
  o Excel (Win 95) y se acordaron que quieren jugarle una bromita (pequeña) a
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  fuera de UK y tampoco a relevado su contraseña a nadie jamas.

        CompuServe se niega a admitir culpabilidad. La compañia le a ofrecido
  ...
  nuestro ordenador para coger nuestra contraseña y datos personales."
  ...
  de estas tarjetas le cuesta a la compañia 78 millones de dolares.
...
<────────────────────────────────────────────────────────────────────────────>
  EL PENTAGONO ATACADO POR HACKERS.
        ...
        Las redes informaticas desclasificadas del Pentagono fueran dañadas
  ...
  Pentagono, como personal y nominas, dice el señor Hamre. Todos los servicios
  ...
  , dijo el señor Hamre. Estos ataques demuestran el devastador potencial de
  ...
  revelo un plan de cinco años para incrementar la seguridad en sistemas
  sensibles del gobierno y compañias privadas de defensa, energia, bancos y
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  resultasen ser un grupo de niños.

        Durante la detencion, los agentes cogieron a los adolescentes,
  identificando a un estudiante escolar de 15 o 16 años, en el proceso de
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  mi impresora, altavoces, todo," decia Makaveli.
        ...
        Vranesevich dijo que Makaveli le dijo que el y su compañero, quien
  ...
  por los medios de comunicaciones, el gobierno, y por el dueño del Servidor
  de Internet en Santa Rosa.

        "Ese tio (Bill Zane el dueño de Netdex) este fuera de onda - y nada de
