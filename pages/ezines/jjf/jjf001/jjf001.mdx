...
------------------------------------------------------------------------------
  ...
  en lengua hispana en el cual se discutira, enseñara, exprondra, denunciara
  ...
  en nuestros HD.
        ...
        Quiero señalar que este primer numero es de tanteo, por lo que no
 ...
 *       Proposito: Enseñanza sobre tecnicas                  *
 *       Autor: Vandals                                       *
 *                                                            *
 *                                                            *
 ...
 **************************************************************
 ...
 haria ruidos extraños ke sonarian komo ke el callback lo esta llamando, pero
...
------------------------------------------------------------------------------
   ...
   C= HOLA, ESTA EL SEÑOR JUAN GARCIA, POR FAVOR.
   V= SI, SOY YO.
...
------------------------------------------------------------------------------
     ...
     °STACK OVERFLOW EXPLOiTS EN LiNUX/BSDOS/FREEBSD/SUNOS/SOLARiS/HP-UXüE

                       THC Magazine nº3 1996 por Plasmoid
 ...
 clase. bueno, si quieres saber mßs sobre la base tecnica (programacion en
 ensamblador/debugging) de los stack overflows en sistemas linux y quieres
 leer un excelente articulo consigue el nº 49 de la Phrack Magazine, articulo
 ...
 lineas en ensamblador i80836 y deseas tener una guia mas praßctica, continua
 ...
 ~~~~~~~~~~~~
                  ...
                  [°a°]    °la pila - pequeña introduccionüE
                  [°b°]    °estructura de la pilaüE
                  [°c°]    °jugando con la direccion de retornoüE
                  [°d°]    °ejecutando una shell en ensambladorüE
                  [°e°]    °averiguando la direccion real de la pilaüE
                  [°f°]    °variables de entorno/command lineüE
                  [°g°]    °palabras finalesüE

           exploit[üE°]    °mount.c  - version linux: < 2.0.8üE
           exploit[üE°]    °rdist.c  - todas las versiones bsd: 2.0üE
           exploit[üE°]    °rlogin.c - version solaris: 2.5 & 2.5.1üE

          apendice[°A°]    °codigo asm y c para ejecutarüE
          apendice[°B°]    °comandos nop para diferentes sistemasüE
          apendice[°C°]    °get_sp() para diferentes sistemasüE
          apendice[°D°]    °findsuid.sh - shellscriptüE
 ...
 especiales muy rapidos. La pila es variable en cuanto a tamaño y posicion.
 ...
 [°b°] °estructura de la pilaüE
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        La pila estüEestructurada de un modo que confunde a veces a la gente
 ...
 esto para conseguir privilegios de rOOt). Cußl seria el aspecto de la pila
 ...
 (dinamicas) propias?
              ...
              -2048 bytes  |   array local 1[1024] |  ...
                           |-----------------------|
              -1024 bytes  |   array local2[1024]  |  tamaño 1024 bytes
                           |-----------------------|
 posicion actual de la pila|   puntero base        |  tamaño 4 bytes
                           |-----------------------|
                 +4 bytes  |  direccion de retorno |  tamaño 4 bytes
                           |-----------------------|
                 +4 bytes  :   parßmetros ...      |  ...
                           .                       :
                                                   .  .
 ...
 mision es señalar la posicion actual, se llama SP (de Stack Pointer). Las
 ...
 [°c°] °jugando con la direcci≤n de retornoüE
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 tamaño maximo, se sobreescribira la direccion de retorno y esto se llama
 ...
 direccion de retorno. Y la pila tendra este aspecto:
              ...
              -2048 bytes  |   array local 1[1024] |  ...
                           |-----------------------|
              -1024 bytes  |   1024 veces "X"      |  tamaño 1024 bytes
                           |-----------------------|
 posicion actual de la pila|      4 veces "X"      |  tamaño 4 bytes
                           |-----------------------|
                 +4 bytes  |      4 veces "X"      |  tamaño 4 bytes
                           |-----------------------|
                 +4 bytes  :   parametros ...      |  ...
                           .                       :
                                                  .  .
 ...
 ha añadido "/bin/sh" al codigo en la mayoria de los casos, si quieres
 ...
 ejemplo lv_size es el tamaño de la variable local que queremos desbordar y
 buffer es el nombre del campo de datos (que tambien es local).
 
 ej. #define lv_size=1024
     char buffer[lv_size+8]

        Añadimos exactamente 8 bytes, mira mas detenidamente la pila de
 ...
 ejecutar. ptr es un puntero que se±ala hacia el campo que copiaremos sobre
 la variable local.
 ...
 [°e°] °averiguando la direccion real de la pilaüE
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        Recuerdas que dijimos que la pila es variable en posicion y tamaño?
 Si no, lee de nuevo [b] para refrescar tu mente. Empleamos una pequeña
 ...
 ser de un tamaño tal que la CPU se encuentre un nop cuando salte a la
 ...
 que el tamaño de esta variable.
 ...
 los distintos sistemas unix, he incluido varias versiones en el apendice [C].
         ptr2 es un puntero dword a ptr que señala hacia la direccion de
 ...
 [°f°] °variables de entorno y de la linea de comandosüE
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 existe comprobacion de tamaño puedes usar dicha variable para desbordar la
 pila; para averiguar el tamaño de la variable de la linea de comandos prueba
 ...
 de segmentaci≤n"), puedes usar el programa para obtener root. Por supuesto
 ...
 ej. variable de entorno: set TERM=1234
        ...
        el programa copiara la variable TERM a un buffer, pero el tamaño de
 este buffer puede variar, por tanto para desbordarlo tendras que probar con
 diferentes tamaños como 256, 512, 1024, 2048, etc. Encontrar programas que
 ...
 exploits:           exploit[1]  mount.c  - version linux: < 2.0.8
        ...
        si tienes una sensacion extraña en el estomago y si quieres quejarte
...
------------------------------------------------------------------------------
  ...
  (España, Francia, Inglaterra, Alemania y Dinamarca). Los otros discursos
  ...
  que Microsoft no era la unica conpañia que produce software !!. El del
  ...
  Director de la Guardia Civil y nos solto un pequeño discurso, al acabar
  ...
  - Comercializacion no autorizada de programas por ex-empleados desleales de
    la compañia que ostenta su legitima propiedad.
  ...
  software.
  7- Ayudaras al desarrollo de empresas que diseñan programas. Asi mas
  ...
  Y desde aqui saludar a toda la peña de #hackers y #hack !!!!!!
...
------------------------------------------------------------------------------
   ...
   12. ...tenia sentido a la mañana siguiente?
   ...
   98. Le has enseñado a algun novato la tecla "cualquiera"?
   ...
   117. Tu ordenador viene con colores de "diseño"?
   ...
   234. Tienes documentos impresos de mas de tres años?
...
──────────────────────────────────────────────────────────────────────────────
 WEB DEL CONGRESO HACKEADA.
        ...
        A principios de Noviembre el web del congreso español fue hackeada
 ...
 "HAPPY HACKLOWEEN" y con otra que decia mas o menos "Señores del congreso,
...
──────────────────────────────────────────────────────────────────────────────
 ...
 ha introducido una nueva asignatura llamana Computer Hacking 101.
        Nicholas Lund-Molfese ha enseñado a muchos agentes de la policia como
 crackear password y construir y manejar Van Eck Devices, pequeñas
 ...
 Criminologia, Lund-Molfese esta enseñando como romper la ley mediante los
 ...
 dañados de un disco. Otra de las posibilidades es construir un Van Eck
 Device, romper criptografia debil o encontrar virus flotando por internet
 y diseñar un antivirus para ellos.
...
──────────────────────────────────────────────────────────────────────────────
 ...
 actos civiles, como con una carta Habeas Corpus.
        El los 2 ultimos años Mitnick se ha visto obligado para su propia
 ...
 principios de este año, el abogado de Mintick a enviado un recurso legal a
 ...
 fundamentos juridicos en el juzgado. A Mitnick le gustaria relleñar un
...
────────────────────────────────────────────────────────────────────────────── 
 ...
 posiblemente el primer programa para perseguir hackers en el mundo.
        Online SecuDr es un programa diseñado para diagnostigar las
 ...
 en ingles.
        Goh tambien añade que su grupo comenzara a mejorar el programa como
...
────────────────────────────────────────────────────────────────────────────── 
 ...
 necesitaban enseñar el monopolio que Networks Solutions ejercia en los DNS.
 Otros han criticado a Kashpureff, diciendo que sus actos son malvados,
 causan daños y se merecen un castigo.
 ...
 raton" dice Sexton. "Esto es fraude, pero el damaño real es minimo. El
 deberia ser declarado culpable y con una multa de un dolar".
        "Estoy sorprendido con la seriedad que se le trata," dice Hurst.
 "El es un informatico. No un cracker. El no ha causado daños en ningun
