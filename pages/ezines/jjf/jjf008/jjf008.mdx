...
<────────────────────────────────────────────────────────────────────────────>
  ...
  software/hardware: la Ingenieria Inversa.
        ...
        Aunque parezca extraño, WKT estüEdedicado a formar a los
  ...
  01 Web Site:                                    01
  01 http://wkt.cjb.net                           01 
  01 http://wkt.mypage.org                        01
  01 ECD ( ESTUDIO COLECTIVO DE DESPROTECCIONES)  01
  01 http://ecd.cjb.net                           01
  01010101001010101010101001010101010101001010101010
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Actual nº 104 escrito por Antonio Ropero. Creo que no se ha tratado este
  ...
  * BO:
  ...
  0.0.0.0:31337*.* esta instalado.
        - Eliminación: borrar el fichero *.exe, recordar que esta en
  ...
  * DeepThroath:
  ...
  nombre SystemDLL32 y el valor [path]systempatch. Sólo nos queda borrar dicha
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  if any of the admins feels it's neccessary to contact me:
  ...
  #
        ...
        [ Vaya, nada, pues demonos el piro, vampiro ]
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Comandos de uso Comun:
     ...
     bottree : Muestra el ßrbol de Bots. 
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Aqui esta la historia de un desengaño:

        Cuando consegui el ventanukos NT 4.0. Dije, ¡esto es la leche!, claro 
  ...
  Como realizar el ataque a un sistema NT, con acceso fisico.
        ...
        1º Realizar un disco PATA-NEGRA de arranque DOS "cualquier soporte",
  no debe faltar:
  ...
  evitar la carga de NT.
        ...
        2º El sistema que queremos burlar debe tener una disquetera de 1,44",
  ...
  
  ...
  esqVDNmWn6vQClCbAkbTCD1mpF1Bn5x8vYlLIhkmuquiXsNV6TILOwACAggAoOzJ
  ...
  
  =DCFX
  -----END PGP PUBLIC KEY BLOCK-----
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  En caso contrario la conexion sera rechazada.
        ...
        El programa que acompa±a este numero sera un sencillo, y facilmente
  ...
  *   la conexi≤n ha sido rechazada devuelve -1. Este sera nuestro
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  a) Usar CFS (Criptographif File System o algo asín) que b sicamente lo que
  hace es encriptar un directorio y si quieres montarlo, has de desencriptarlo
  y montarlo por NFS, o algo asín. Era un chow parecido.
  b) Parchear el kernel y el mount para soportar filesystems encriptados.
  Esta es la opción que me parece m s mejor, puesto que aquí lo que hacemos es
  que al hacer un fs, podemos decirle que este use encriptación de varios
  ...
  Este último tiene la ventaja de que puedes encriptar una partición, un
  floppy, amos, lo que quieras, mientras sea un FS entero ..
  Y por supuesto, todo ello totalmente open source, con el código fuente
  disponible.

  Bueno, que eso es lo que quería comentar.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Hola amigos del JJF team, soy Roberto, y les escribo desde México.

  Estoy estudiando Ingeniería en Sistemas Electrónicos, en el Tec de
  Monterrey. (la mejor del país, a lo que ingeniería concierne).

  Siempre me ha llamado la atencíón todo lo referente a la electrónica,
  ...
  ojala que yo también),sabre cual es la mejor opción para protegerme.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  volver a instalar el windows y no tengo discos de instalación. De antemano
  gracias.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Que tal desde los saludo desde Meéxico.
  Quiero felicitarlos por que tienen un e-zine chidisimo y aparte espero que
  me contestén este mail a mi dirección. Yo soy un wannabe que se dedica a
  ...
  los que opinan como la mayoría de la gente a la que le gusta el hacking
  debe de haber acceso libre a TODA la información en internet. Yo tengo un
  pequeño problemilla la computadora donde tengo internernet es de mi pap  y
  entonces no puedo usar mucho internet por que me regaña bien cabrón y por
  ...
  riesgo si no conoce a quién va a nukear por ejemplo: Si nukea a un hacker
  experimentado (lo que el no es ya que solo es un wanabe como yo) lo podría
  practicamente aniquilar y borrarle toda su pc o cualquier chingadera no????
  Bueno una última pregunta ¿Creen que un tipo como de 13 años pueda borrar a
  alguien del registro civil? Ya que eso dice un guey que conozco adem s dice
  que aprendió a programar por si solo.
  Espero que me conteste n pronto
  Les escribire muy pronto
  un wannabe mexicano                                                                                                                                                                                                                                                  emilla la computadora donde tengo internernet es de mi pap  y entonces no  puedo usar mucho internet por que me regaña bien cabrón y por eso no aprendo sobre el hacking tan r pido como algunos de mis "amigos". Adem s mi jefe solo tiene windoze i eso me caga por que no me deja (mi jefe) ponerle otros sisitemas operativos y programas tengo que ponerles a los programas passwords y ocultarlos.

  P.D. No conocen a algún hacker por aquí por méxico.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  m s en serio en esto del hacking, y cuando lo hice, me encontrüEcon que
  ...
  avanzados en el tema, pero falta mucha organización...
  Los hackers estudian todos por separado, o en muy pequeños grupos que no
  se inter-relacionan entre sí, por eso, me propuse empezar a hacer
  ...
  para darnos una mano con la p gina(que sería MUY bienvenida), manden un
  ...
  etiquetan como hackers por todas partes, y después, en la intimidad,
  ...
  autoetiquetando como uno, lo unico que quería era aprender, busque
  textos, lei, y en una tarde, instale el linux y lo configurüE sin
  ...
  Arriba los que llegaron a ser hackers después de querer aprender, y a
  los imbeciles que quieren ser hackers porque la pelicula hackers les
  pareció fashion, que se queden jugando a joder a gente inocente con su
  Netbus.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  quisiera saber si de alguna forma me podrían enseñar
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  He encontrado tu p gina sobre detección de intrusos. Me parece
  estupenda.

  Te escribo el mail para decirte que tengo una traducción del "COMO"
  Seguridad en Linux, por si te puede interesar. Evidentemente est 
  enfocado a Linux, pero también es v lido para otro sistema Unix.

  Después de ofrecerte algo, ahora te pido. ¿Sabes donde conseguir
  información en castellano sobre los est ndares de seguridad? B1, c2, ...
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  - Corregidme si me equivoco pero alguna vez habeis hablado de los archivos
    ...
    puede acceder a esos archivos?, o en su defecto sería un estupendo
    articulo...
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  A través de una lista de correo sobre seguridad me enterüEde la existencia
  ...
  Tamaño = 754
  Fecha = Oct. 1997
  Desinfección posible = NO

  Parece pues que el virus viene de getit.zip o de thiefnov.zip, o de ambos.
  Los bajüEpero no se copiaron al directorio en que estaba guardando todo.
  ¿Se combinaron para formar un virus?. No lo abrí. Se que vosotros solo
  ...
  ¿conoceis el virus?, ¿que hace?, ¿como desinfectarlo?. Os agradecería mucho
  vuestra ayuda.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  1º Buscarlo en el registro del windows y eliminarlo (busca
  C:/windows/system/.exe y elimina todo donde salga). Despues borra el server
  de win/system/.exe.

  2º Monta lal particion en la que tengas el windows en el linux y eliminalo
  desde alli (no se puede ni desde msdos ni desde windows)

  3º Pillate tu cliente de bo y ponte una clave (como por ejemplo me "me cago
  en
  ...
  4º Pilla un programa de proteccion contra el bo  (ahora no me akuerdo de
  ninguno pero si buscais en el altavista mismo encontrareis un güebazo).

  5º No ejecutes ningun programa "sin icono" ( bo server no lo tiene pero si
  no
  te fias de lo ke te mandan esta es una buena opcion)

  6º Sigue el consejo de tu mama y no te ajuten con desconocidos (mas de un
  "amigo" me lo ha intentado colar")

  7º Inventate tu este ke no tengo ni zorra de mas.
...
<────────────────────────────────────────────────────────────────────────────>
  ...
  Hola, me gusta mucho la investigaciòn en software, pero se muy poco de
  programaciòn me gustarìa que alguien me enseñase aunque sea algunos trucos
