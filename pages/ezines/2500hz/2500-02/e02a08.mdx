...
Hace ya a±os que microsoft nos sorprendio a todos con su Windows NT en
...
Despues de estos a±os Microsoft vuelve a la carga con Windows 2000 un
...
manera simple y eficiente en redes peque±as. Proporcionando tanto 
...
Microsoft en su implementacion limita el tama±o de los nombres a 15
...
nuestro caso obtenemos realizando un peque±o scaneo a una clase C 
...
bruta y testear asi la seguridad de las contrase±as de usuarios.
...
bruta a las contrase±as, para ello hacemos uso de NAT ( NetBIOS 
Auditing Tool )
...
Microsoft Windows 2000 [Versi≤n 5.00.2072]
...
una peque±a empresa, una gran empresa, o un simple usuario que dedica
