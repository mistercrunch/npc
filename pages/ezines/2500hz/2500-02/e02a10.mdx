...
Bueno, el documento tan esperado desde hace meses Ni decir tengo que esta informaci≤n s≤lo 
tiene pr≤positos educativos, y no me responsabilizo del mal uso que le podais dar. 
...
dise±ado para proveer de la seguridad necesaria con la finalidad de crear y mantener 
una VPN sobre TCP/IP (TRansmision Control Protocol/Interface Protocol).
Es el protocolo para hacer un t·nel que permite que se realicen 
las conexiones de Point-to-Point Protocol (PPP) a travΘs de una red IP, creando 
una red privada virtual (VPN). 

2. ┐que es VPN? 
-AVPN Microsoft Virtual Private Networking Adapter Microsoft  
El principal prop≤sito de las Redes Privadas Virtuales es el establecimiento de una 
conexi≤n segura a una LAN ( Local Area Network) privada sobre una estandar no-segura 
conexi≤n LAN o una conexi≤n via internet.
...
los PC conectarse a redes privadas a travΘs de redes p·blicas como Internet. 
...
3.1) CREAR EL ACCESO
Pongamos un ejemplo: supongamos que nos conectamos a travΘs de teleline. Cuando nos 
...
conectamos entraremos a internet y veremos como el iconito de conexi≤n.. si... ese...
...
resulta tan cantosa ( ipass o wcom...) asφ podremos conectarnos sin tener que usar wingates :)
...
conectarse a redes privadas a travΘs de redes p·blicas como Internet."
