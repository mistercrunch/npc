...
Add o Delete self: cuando el usuario puede a±adirse o borrarse, por ejemplo, de 
...
Caracteres minimos.
Cambios periodicos.
No permitir contrase±as ya usadas anteriormente.
...
* Apuntes de clase de Novell Netware de 1║ de Administracion de Sistemas Informaticos.
Curso 1998/99.
