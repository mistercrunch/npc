...
-------------------------------------------------------------------
 ...
 N U M E R O  T R E I Z E · P R E M I E R  F É V R I E R   9  4


Dans ce treizième numéro de NPC:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
- -──┼─────────────────────────────────────┬───────────────-- - ·
     ...
     │ Éditorial de  NPC #13               │ Blitzkreig         │
     │ The postman always quote twice      │ Votre Courrier     │
     │ Datapac à Québec                    │ Gurney Halleck     │
     ...
     │ Sécurité C2                         │ Gurney Halleck     │
     │ Datapac mondial                     │ L0grus!            │
     │ Def Con II                          │ Dark Tangent       │ 
     │ H-P Faq                             │ The Underground    │
     │ LLC Faq 1.0                         │ Murdock            │
     │ Don Quichotte nous a possédés!      │ Blitz & L0grus!    │
...
NPC are:       Officiers                Collaborateurs
       ...
       Invités spéciaux: Hellraiser et beaucoup d'autres!         
...
théorie, c'est toujours Atreid Bevatron qui est maintenant
l'éditeur de NPC, mais il s'est fait porter pâle cette semaine, et
j'ai appris à la DERNIERE minute que je devais préparer un NPC 13
pour hier... Ceci posé, j'espère SINCEREMENT pour Atreid qu'il est
est mourant...

     Ca me fait tout de même plaisir de vous reparler après quatre
mois d'absence aux commandes de la "machine NPC" (vous pensiez que
je l'avais oublié, celle-là? ;-) . Pas que nous ayions perdu tout
contact, non, loin de là. On se parle encore souvent (vous n'avez
pas égaré mon numéro de téléphone, au moins?), on s'écrit, et je
suis toujours à l'écoute de vos commentaires... même des plus
STUPIDES!!!

     L'un de nos gentils lecteurs m'a téléphoné la semaine dernière
pour me demander si j'avais écouté le reportage du Point Média
(Radio-Canada) sur Internet et l'autoraute électronique. Plus
précisément, il me demandait si je n'étais pas inquiet d'ouvrir un
site Internet alors que Vidéotron lance Vidéoway phase II. Je lui
ai promptement répondu que, oui, j'ai écouté l'émission, et que
deux, il y aura probablement autant de similarités entre Vidéoway
et LLC qu'entre un crapaud et un étalon. Écoutez, je ne vous ferai
pas l'insulte de vous raconter tout ce qu'on trouve sur I-net: vous
en avez déjà une bonne idée. Pensez-vous vraiment que Vidéotron,
qui est là UNIQUEMENT pour faire du cash, va se mettre à offrir aux
québécois des milliers de services gratuits? Vidéotron, mes chers
amis, ne veut pas de cybernautes, il veut des CYBERCONSOMMATEURS.
Relisez bien votre prospectus: Vidéoway 2 se targue de pouvoir vous
permettre de commander du St-Hubert à partir de votre téléviseur,
de vous permettre de voir votre compte d'Hydro, et d'effectuer
certaines transactions bancaires. En gros, je viens de vous décrire
Vidéoway 2. On espère de plus faire entrer rapidement dans la danse
...
vidéo.
     ...
     En clair, Vidéoway 2 s'adresse précisément aux gens qui
achètent déjà des zirconiums cubiques annoncés à la télé. Et c'est
définitivement le public que fuit LLC. Écoutez, les mecs (oups!
Pardon Criminal Mind!), vous aurez beau avoir un service comme
Vidéoway 25 ou 2000, vous allez toujours demeurer un cochon de
consommateur à qui ont offre quelques larmes d'interactivité, tant
que votre carte de crédit est bonne. Et c'est ça que vous appellez
de la compétition? Je crois que je vais dormir tranquille cette
nuit...

                              -----

     Avec un peu de chance, le prochain NPC va coïncider avec
l'ouverture de LLC (je sais, je sais: ça ressemble de plus en plus
à une promesse de programmeur!), et nous allons débuter un nouveau
chapitre dans l'histoire du cyberspace québécois. Déjà,
aujourd'hui, avec le numéro de NPC que vous consultez présentement,
vous avez un avant-goût de ce que le mariage LLC-NPC pourra faire.
Une bonne moitié de ce numéro 13 nous provient directement de gens
rencontrés sur Internet, et sans se forcer, encore! D'ici quelques
mois, ce magazine va prendre des allures dantesques: on va
probablement être capables de publier un truc, toujours gratuit, de
plus de 1 meg par MOIS! Je considère personnellement ce numéro 13,
monté en quelques heures, comme une simple ébauche de ce que
l'avenir nous réserve. Attachez bien vos tuques!

                              -----

     Je vous laisse maintenant à votre lecture, non sans prendre le
temps de saluer Mastertronics, une nouvelle recrue de Montréal,
Murdock, un bon bougre qui s'occupe de notre FAQ, et le retour de
Crime Lord, qui nous écrit du fin fond de son Australie adorée. On
se retrouve dans quelques semaines sur LLC, où venez nous dire
bonjour au rave de vendredi, au Musée de la Civilisation. NPC y
...
Blitz répond - Hum... Pour le copieur SNES, je sais pas. Pour les
mags, comme je l'ai dit dans mon édito, NPC va être disponible
officiellement sur Internet dans moins d'un mois (mais tu peux déjà
les trouver à des endroits comme....). Dès que LLC va être ouvert,
ça va barder! Merci de nous lire!

                         ---------------

Message #6/10 in Conférence Npc (Pri) - Local - [Local]
...
- Salpêtre En Poudre  (Nitrate de potassium)
- Sucre Blanc
- Une vieille casserole
- Une plaque de tôle ou une assiette, et recouvrez-la de Saran Wrap
  en masse.

Préparation:

1. Mettre 100 mg de salpêtre dans une casserole.

2. Mettre une meme quantité de sucre blanc dans cette même
casserole.

3. Crisser le feu à HIGH  - Allumez le fan, ça boucane!!!

4. Brassez beaucoup, pour ne pas que ça prenne en pain.

5. Après que le mélange ait donné une pâte uniforme chaude,
   étendez la totalité du mélange sur la plaque préalablement
   préparée. Laissez refroidir.

6. Une fois la substance à la temperature de la pièce, recouvrez le 
   dessus de la plaque de Saran Wrap. (Donc la pâte est           
   complètement recouverte de Saran Wrap) Mettez-la dehors au gros 
   frette, ou dans le congélateur.

7. Une fois le tout gelé dur, prenez une hache et pètez le mélange 
...
8. Recouvrez les morceaux de Kleenex et de tape electrique. Laissez
   sécher, et ensuite allumez....

That's All!

Vous pouvez rajouter d'autres substances, pour alimenter la
combustion.... Donnez-moi des nouvelles sur vos expériences avec
cette substance...
...
Blitz répond - &lt;Kof kof> Je vois même plus &lt;kof kof> les touches de
...
Subj : J'haiis l'hiver si frette...
    ...
    Des rêves gisent, gelés... 

    A c't'heur' qu'on est dans l'mois d'janvier
    C'est l'temps de geler ben dur
    A moins d'rester dans l'enchassure
    A r'garder l'jardin de givre ben dessiné.

    Avant qu'l'hiver nous encabane
    Y avait le rêve Internet
    Qu'une gang de pique-assiette
    A tout anéanti dans la chicane.

    Y en a encor' queqs'uns qui s'parlent
    De la pluie pis du beau temps
    Mais chez la plupart des gens
    L'rêve d'évasion est en cavale.

    Eh oui! la neige blanche en belle ouate
    Comme nos beaux rêves pis nos espoirs,
    C'est pas long qu'a r'tourne en bouette
    Un'fois qu'elle a touché l'trottoir.

                          -------------

Blitz répond - .....snif,snif! Comme c'est beau Méphisto! Allons
allons, le rêve n'est pas mort, mon enfant, et je suis surpris que
tu n'aies pas plus confiance en moi! LLC va vivre, tu vas voir, et
il va surgir du néant froid et sale avant le premier perce-neige!
Le printemps va arriver tôt cette année dans le cyberspace du 418!
...
-------------------------------------------------------------------
                ...
                L'annuaire complet de Datapac à Québec
                                par
                          Gurney Halleck


        Voici finalement la liste complète de tous les numéros de
Datapac à Québec. Avec la venue prochaine de DAS v3.0 (Datapac
Address Scanner) et les petits problèmes avec les forces de l'ordre
au sujet de Datapac, je cherchais un moyen de réduire le risque
d'être retracé en scannant sur Datapac. Alors l'idée m'est venue de
scanner seulement une vingtaine d'adresses avec chaque numéro.
Lorsqu'on a passé à travers l'annuaire, on recommence...

        Le moyen optimal de procéder serait bien sûr de scanner à
...
647-9524  -  Datapac  -  2400 bps
     ...
     Bonne chance à tous, et à la revoyure!
...
-------------------------------------------------------------------
     ...
     Premièrement, un gros bonjour d'Australie, où je réside
maintenant! Vivement l'ouverture de LLC, qu'on puisse se jaser à
tous les jours!

     Les fans de 2600 connaissent bien Emmanuel (aka Eric Corley),
éditeur du célèbre magazine. C'est un peu le pendant américain de
Blitzkreig, si on veut ;-) Et Phiber Optik était son bras droit.
Phiber est, au moment où vous lisez ces lignes, en prison. Pour
connaître toute l'histoire, pour lire sur cette saga judiciaire,
jetez un coup d'oeil à THE HACKER CRACKDOWN. 

     Mais nous publions ici, plusieurs mois avant 2600, un texte
inédit, un road movie prenant sur le chemin vers les portes du
pénitencier...
...
-------------------------------------------------------------------
     ...
     Vous avez peut-être ramassé ce fichier sur certains babs. Je
ne sais pas ce que vous en avez pensé, mais nous on trouve que
cette histoire n'est pas claire. Enfin, constatez par vous-mêmes et
faites nous part de vos commentaires... Ceci dit, c'est la toute
première fois que j'entends que j'ai été busté pour avoir vendu des
copieurs SNES. Franchement...

     En passant, la GRC m'a retourné mon matériel, le tout intact.
...
rendu coupable...
     ...
     Ce fichier est destiné à tous les SysOps et aux usagers
fréquentant les BBS Pirates ou privés, selon le cas. Je désire vous
informer que j`ai eu accès aux fichiers de la GRC ( Gendarmerie
Royale Du Canada ) par le biais de mon modem le 19 Décembre à 23
heures 45.

     J'ai fait le tour des documents concernant les BBS Pirates et
privés et j'y ai découvert une fuite... Un jeune de 14 ans du nom
de Karl Kirouak sous l'alias de Jumping Kid ou tout récemment celà
fut changé pour Nasgul. J'y ai vu que ce petit drôle avait dénoncé
3 BBS, 4 personnes ayant rapport au domaine en tant que
fournisseurs de logiciels, fournisseurs de matériel informatique
dérobé et ce que l'on appelle communément "trasheurs de babs".

Comment ce jeune idiot a fait pour avoir ses informations?

- Je me suis informé auprès de mes contacts sur le domaine et, j'ai
réussi à apprendre que cette "pourriture" aurait trouvé ses
...
STREET. Il aurait de ce fait eu des numéros de BBS pirates et bien
évidemment comme sur tous les BBS pirates, des usagers appelés
"élites". Il aurait, paraît-il, dénoncé les BBS qui ne l'auraient
pas accepté à cause d'une mauvaise réputation ou de la faible
vitesse de son modem ( 2400 soit-dit en passant ).

     Les élites, tant qu'à eux, ils se sont laissés prendre par
cette "impureté"... Celui-ci demandait, et je cite:" T'aurais-tu
par hasard un HD volé à me vendre please? Ou bedon une couple de
Warez?". Evidemment, de ce fait, il a pris en note ses
conversations et, les a donné à la GRC.

Quels BBS a-t-il dénoncé à la GRC?

- Voici la liste des 3 BBS ayant étés dénoncés par cette "chiure"
ainsi que les noms des SysOps.

■ Dark Side Of Reality - Master Of Darkness
■ CraftWorld's - Slum Dweller
■ The Doors of Perception - The Shaman

Qui a-t-il dénoncé à la GRC?

Voici la liste des personnes ayant été dénoncées par cette "merde".
...
Pour être pénétré sur les BBS sous l'alias de Fvladimir Kroutchefv
et s'être fait au dessus de 10 faux noms sur World Vision.

■ Android

Son modem Zyxel est un modem volé. Il l'aurait payé 150$.

--------------------------

     Bon jusqu'à présent vous avez le goût selon moi de lui faire
péter la cervelle ou de lui arracher les couilles (Oops! Il en a
pas...).

     Ce petit mongol aurait dénoncé toutes ces personnes car il ne
voulait pas que son BBS soit aperçu... Il aurait aussi selon mes
sources, sous son vrai nom en plus, envoyé une dizaine de virus ou
...
faibles et vous dérober des informations. Appelez sur son Board et
retournez-lui tous les virus qu'il a envoyé sur les BBS juste pour
vous faire chier et se sentir plus intelligent.

--------------------------

     Envoyez ça sur tous les BBS, Karl est une crisse de "puanteur"
qui mérite de ne plus avoir de modem!
...
-------------------------------------------------------------------
     ...
     On a publié, récemment, un article dans le journal Voir, celui
qui est gratuit, concernant le piratage informatique. Rien
d'étonnant, les gens ne savent plus de quoi parler. On nous
présente comme une espèce de gros méchants loups, des "Big
Brothers", comme l'indique le titre de l'article en question. Ce
qui m'étonne par contre, c'est qu'on nomme toujours les autorités
supérieures par "Monsieur, Professeur, Sergent, etc...". Les
gentils compagnons du peuple. Les protecteurs de la liberté. Les
imbéciles qui ont écrit ce texte ont l'air d'y croire dur comme
...
Le Cyberspace a attiré une nouvelle race de hors-la-loi: les
pirates de l'informatique, qui peuvent s'infiltrer dans à peu près
tous les ordinateurs de la planète. Gouvernement, entreprises,
écoles, rien ne leur résiste. [Belle intro, on se croirait déjà
...
Nirvana, un ordinateur, un modem. Banal. Mais attention! Voilà le
lieu de nombreux délits...


Un appel à la polyvalente, quelques prouesses au clavier, et hop!
...
d'imagination, les possibilités qui s'ouvrent aux pirates
informatiques - les hackers dans le jargon - font peur. Écoute de
conversation téléphonique,   [Et c'est à nous qu'on associe
l'écoute téléphonique! Et la GRC la-dedans??? Ah! oui! Ce sont les
gentils! Ils ont le droit, bien sûr!]    détournement d'argent,
accès à de l'information supposément confidentielle. De plus en
plus, on rapporte des cas de messageries vocales vandalisées, de
numéros de cartes de crédit volés... et de factures qui grimpent
vertigineusement. [A noter, encore ici, on dit "VOLÉS". Il faut
croire que le social engineering n'est plus ce qu'il était...]

"Les gens peuvent obtenir de l'information illégalement de toutes
sortes de façons", admet le sergent Robert Fillion,  [Bob!]  de la
nouvelle brigade de crimes informatiques de la GRC à Montréal. "Il
y a une augmentation de ce genre de crimes." "Chaque enquête est en
soi un apprentissage", commente pour sa part Robert Caston(-)gay,
responsable des enquêtes reliées au piratage informatique de la GRC
à Québec. Quelques ordinateurs, des manuels d'instruction, des
modems: les quatre enquêteurs montréalais et leurs deux collègues
de Québec sont bien équipés pour patrouiller l'autoroute digitale. 
[Quelle jolie comparaison! j'en vibre à mort, en dedans de
moi-même, sur la route à péage des mes sentiments les plus
décapotés]

Mais les hackers ne sont pas à pied eux non plus. Dans le comfort
...
plusieurs centaines d'autres à travers le monde, aux surnoms aussi
étranges pénètrent par effraction dans les systèmes informatiques.
[Et mal renseigné, en plus! Merlin un pirate: HA!]

"Pour moi c'est un jeu, confie Simon, 19 ans. Faut être meilleur
que le système. Le défi, c'est de posséder l'information, et de la
mettre dans ton carnet de notes." Pour la plupart, c'est un sport.
La chasse à l'information. Une fois capturée, l'info est attachée
sur le toit de l'ordinateur [HAHAHAHAHAHAHAHA!!!] et ramenée à la
maison. [mpff!!!] Comme un trophée, on l'accroche au mur. Et on
raconte ses meilleures histoires de chasse aux confrères sur des
babillards électroniques privés.

"Les jeunes en bas de 18 ans font ça pour le kick", explique Greg,
21 ans, étudiant en génie. [Wow!] "D'autres font ça pour l'argent.
Moi, c'est pour apprendre comment fonctionnent les systèmes. J'aime
pas ça être victime de la technologie.", ajoute- t-il en tirant de
sa poche un petit bidule émettant des bips-bips. "Ce son simule le
bruit que fait un 25 sous en entrant dans un téléphone public. Le
gadget marche très bien. Il suffit de changer le cristal à
l'intérieur."

C'est la base du hacker: savoir frauder les compagnies de
télécommunications. Son billet gratuit pour le cyberspace.


                        Piqueurs de codes

Chez Bell Canada, à Montréal, la méfiance règne depuis la
dérèglementation des services interurbains. A l'entrée, on doit
donner notre nom et épingler une carte sur son manteau. Sérieux,
l'espionnage industriel.

Le directeur de la sécurité, Jacques Desjardins, nous amène dans
une petite pièce. Il nous demande nos papiers de journalistes. Nous
n'en avons pas. Il appelle au journal pour vérifier si nous ne
sommes pas des imposteurs, puis revient. "Désolé, mais on ne peut
pas prendre de chances. Il ne faut pas devenir paranoïaque, mais
faut faire attention à ce qu'on dit." Sage. Les hackers sont
souvent maîtres du social engineering: se faire passer pour un
autre afin d'obtenir de l'information spécialisée.

Les hackers sont aussi spécialistes dans la fraude interurbaine.
Avant 1991, aux États-Unis, les transporteurs ont perdus 1.5
milliard de dollars en interurbains "volés", et 3 milliards l'année
suivante. En 1993, on parle d'environ 4 milliards. "Au Canada il se
perd plusieurs dizaines de millions de dollars par année", estime
Jacques Desjardins, sans vouloir avancer de chiffre précis. "Ce
n'est pas du domaine public."

Pour frauder, pas besoin d'être un hacker. Il suffit d'obtenir le
numéro de carte d'appel d'une autre personne. L'expert va dans les
endroits publics, regarde par-dessus l'épaule d'un voyageur qui
pitonne son code, le prend en note, puis l'utilise ou le revend.

Le hacker plus sophistiqué, lui, préfère s'infiltrer dans les
systèmes téléphoniques des entreprises et faire ses appels à leurs
frais. Une simple boîte vocale peut lui servir de base d'opération.
Lorsqu'il a découvert un tuyau, il s'empresse de le refiler à ses
petits copains. "Si le fraudeur est attrapé, ça devient difficile
de le rendre responsable de la totalité de la perte", explique
Jacques Desjardins.

[La seule partie réaliste, sans commentaires.]

                     Surveillez vos vidanges

Son réservoir à essence plein, le hacker peut ensuite cogner aux
portes de tous les systèmes informatiques. Et pas besoin de tout
dynamiter pour pénétrer. La clé l'attend souvent sous le
paillasson... Plusieurs mots de passe sont en effet ridicules. "99%
des incidents sont reliés à des mots de passe déficients", soutient
Pierre Cormier, responsable de la sécurité informatique à
l'Université du Québec à Montréal (UQAM). C'est quoi un mot de
passe déficient? Nom, numéro d'assurance sociale, nom de son chum,
de sa mère, de son chat...

"Toutes les compagnies sont vulnérables", indique Jacques
Desjardins. "Le principe fondamental en sûreté informatique, c'est
que les employés ne doivent accéder qu'à ce dont ils ont besoin
pour faire leur travail. Un réseau a beau être privé, l'ajout d'un
seul modem ouvre la porte à tout le réseau." Il est important de
...
suffisent pas, il faut aussi vérifier ses vidanges. "Ça n'a pas
...
listes de codes d'accès..." A Bell, on a compris. "Les informations
doivent maintenant être déchiquetées... et c'est appliqué", dit
Jacques Desjardins. [Mon cul! ouais!]

Même quand leurs portes sont défoncées, les compagnies oublient
souvent de poursuivre les délinquants. "Généralement on ne
publicise pas ce genre de choses", explique Pierre Trudel,
professeur de droit des communications à l'Université de Montréal.
"Les banques et les autres victimes préfèrent régler ces choses là
à l'interne pour ne pas saboter la confiance du public." Ça
dépend... "Quand une personne pogne une facture de 250 000 $ en 28
jours (c'est arrivé au Canada), elle change d'attitude pas mal
vite!" affirme le sergent Robert Fillion. [Bob!] Dans les
compagnies, on se la boucle. Impossible de soutirer une seule
syllabe sur le sujet à qui que ce soit.

"C'est rendu tellement facile de hacker, affirme Greg, qu'il n'y a
même plus de challenge! Les compagnies sont en retard sur nous. Ça
a l'air arrogant, mais c'est comme ça." Un vrai hacker. Hautain.
Élitiste. Fier. Ridiculisant [Surtout ridiculisé, à l'heure qu'il
est...]  l'industrie, mais mourrant d'envie de travailler pour une
grosse boîte comme... Bell.

                      Les nouveaux cow-boys

Impossible d'enlever de la tête des hackers leur sentiment de
supériorité. Ils se voient comme la nouvelle élite technologique,
les pionniers du nouveau monde informatique. [C'est Greg qui t'a
dit ça?]

Le hacker moyen commence sa carrière avec de vulgaires lance-pois.
"Moi, j'ai débuté avec un petit 2400, raconte Simon." Mais l'envie
de posséder un bazooka le hante. "Ça m'a pris des plus gros modems
pour aller chercher de plus gros jeux aux États- Unis."
[conclusion: Simon est un méchant Gilles. Il va chercher son K-RaD
3l33t3 StuFF aux U.S.! (C'est un VRAI Hacker)]

Petit à petit, il apprend des trucs, s'abonne au Hacker Quaterly,
...
autres membres par babillard électronique. Dans les noms de
groupes, le PH (Phone) remplace toujours le F. Des champions de
l'ironie. Phortune 500, The Phirm, IBM Syndicate, on se moque des
autorités. Cas célèbre: tous les appels acheminés au poste de
police de Delray Beach, Floride, aboutissaient dans un sex hotline
de New-York...

Bien sûr, les organisations secrètes et gouvernementales fascinent
le hacker. A partir du système de leur université, des étudiants
québécois ont cogné à la porte de la NASA, de la Maison-Blanche et
attiré l'attention. Le CIA a apellé l'Université pour savoir ce qui
se passait. A Québec, l'année dernière, des hackers ont pénétré 4
fois dans le réseau informatique du Conseil exécutif du
gouvernement québécois. "Ils ne cherchaient que la gloire, estime
Greg. Ceux qui font ça se font pogner tout de suite." [Ah ouais?]

Mais le hacker n'a pas le choix. S'il ne parle pas de ses bons
coups, il n'existe pas. Il doit montrer ses meilleures prises.
Voilà son talon d'Achille. Le hacker pèche par vanité. "Leur gros
problème, c'est qu'ils se vantent toujours de leurs coups",
explique le sergent Robert Fillion [Bob!] . "Le hacker se fait
souvent arrêter à cause de ses défauts humains", ajoute-t-il en
souriant.

Délicieux paradoxe... [Méchant malade]

                       La CIA sur le coup

Chaque hacker a son propre code d'éthique. Les lois? Pffff...
"C'est illégal, mais je n'ai aucun problème avec ça", lance Greg,
au sujet de la fraude interurbaine."

Ils n'ont tout simplement pas l'impression d'enfreindre la loi. Ils
ne tuent, ni ne blessent personne. Et puis aucun antécédent
...
service de télécommunication, d'utiliser un ordinateur sans
autorisation, de détruire ou modifier des données informatiques.
...
Contrairement aux biens matériels, l'information est intangible.
Combien "vaut" telle ou telle fraude? Difficile à dire. Même quand
un hacker fait pour 200 000$ d'interurbains, il ne voit pas où est
le crime là-dedans. [Les juges sont si intelligents!]
...
à pincer. "Au moins 99% n'ont pas l'expertise pour effacer leurs
...
peut faire son coup ici, et un hacker québécois peut frauder au
Mexique. Difficile d'enquêter dans ces circonstances."

Gambadant d'un système à l'autre, les hackers se bidonnent. Mais
les victimes ne rient pas. Aux États-Unis, en 1990, la police
lançait un raid sans précédent dans le millieu hacker. Le système
informatique de AT&T s'était effondré (de lui-même, semble-t-il),
et on a soupçonné un complot. Confiscations d'ordinateurs dans
plusieurs villes, procès... tout pour donner l'exemple.

Aujourd'hui, les systèmes informatiques contrôlent tout, partout.
Alors on imagine les pires scénarios. "Le gouvernement a peur qu'on
trouve des secrets militaires, qu'on parte des missiles", dit Greg.
Dans le film War Games (1984), un adolescent passe à un cheveu de
déclencher la 3e guerre nondiale. Exagéré, évidemment. Ce qui l'est
moins, c'est tout le fric qui circule sur les lignes téléphoniques
et qui peut être intercepté, détourné. Parlez-en à la compagnie
Volkswagen, qui a perdu 260 millions de dollars de cette façon
récemment. "Tout est faisable, avance Simon. Ce qui prend le plus
de guts, c'est de se présenter à la banque avec une valise et de
sortir 100 000$." [Pour aller chercher du StUff WareZ KRaD aux
U.S.!]

Afin de pourchasser adéquatement les terroristes et les
blanchisseurs d'argent de tout acabit, le gouvernement américain
s'est doté d'un gros bolide, le Federal Financial Crimes
Enforcement Network, qui a accès à toutes sortes d'informations
confidentielles. Un gros char, propulsé par les systèmes
informatiques du CIA, du FBI, du Service Secret, de l'IRS, etc.
Efficace, pas de doute. Mais peut-être aussi l'embryon de Big
Brother.

Nos hackers disent ne rien faire de "trop" illégal. Ni banques, ni
trucs militaires, ni espionnage industriel. Même pas pour du fric?
Allez les gars! Soyez... honnêtes. "Quelqu'un me donnerait 10 000$
pour faire quelque chose, je pense que je dirais oui", admet
finalement Greg.

N'oubliez pas ceci: non, ça n'arrive pas qu'aux autres. La
prochaine fois que vous entrez votre code téléphonique dans un
endroit public, regardez donc derrière vous.
...
"Hacker". Simon, à l'entendre, est plutôt un Warez Puppy. Son
crime, à lui, fait peut-être partie comme de ceux hackers, mais ne
...
utilisant MicroSoft Windows payait sa version? Je ne suis même pas
sur de pouvoir deviner le nombre de zéros dans tout ça.

Pourquoi, alors, pointe-on les hackers du doigt? Parce que c'est
moins facile de courir tout simplement après les copieurs! Parce
qu'il n'ont absolument rien pour contrer le phénomène! Parce que
n'importe quel juge, ou sergent, ou agent à la sécurité chez BCE,
ou n'importe quel fonctionnaire a sa copie de Windows, du Dos 6.0,
d'une dizaine de jeux, qu'il n'a pas payé. C'est combien de
milliards, tout ce fric??? Plus, en tout cas, que ce dont on se
plaint ici. Bande de pleurnichards!


       DORMEZ, MES BREBIS, SATAN EST A L'OEUVRE! - Jésus.
...
-------------------------------------------------------------------
    ...
    Computer Professionnals for Social Responsability (CPSR) 
     ...
     Il y a de cela quelques numéros, je vous avais bassiné un
papier sur Clipper, le chip d'encryption proposé par
l'administration Clinton. Je réitère l'exploit (!!!) en vous
soumettant le contenu de la pétition proposée par le CPSR. NPC
says: sign this!
...
-------------------------------------------------------------------
     ...
     On s'est acheté C2! On a eu un bon deal pour le programme
(original) écrit pour SCO Unix. Et on va l'installer sur LLC. Vous
le savez, nous sommes un tantinet préoccupés par la sécurité de
LLC. Un, la fable du cordonnier mal chaussé, très peu pour nous,
nous l'avons dit. LLC va être cité en exemple comme système dont la
sécurité est élevée. Deux, on se méfie des petits twits qui
feraient des gorges chaudes parce qu'ils ont réussi a "planter" le
système de NPC... Quoi qu'ils ne vivraient pas assez longtemps pour
s'en vanter. Et trois, ce qui est peut-être le plus important à mes
yeux, on ne voudrait pas que quelqu'un se serve de LLC pour
commettre des actes illégaux. On sait pertinemment que le système
va être surveillé, en amont, par la GRC. Et je n'investis pas des
dizaines de milliers de dollars dans une entreprise qui risquerait
de se faire fermer par les autorités. Je suis cinglé, mais pas au
point de risquer de tout perdre financièrement.

     On s'est acheté C2, donc. Voici un petit texte de Gurney (qui
devrait paraître dans le prochain Phrack) sur ce que représente ce
programme de sécurité. En passant, vous pouvez vous procurer C2
...
d'opportunités pour le hacker averti. L'intérêt dans DATAPAC réside
surtout dans le fait que c'est un excellent point de départ pour un
hacker débutant. DATAPAC est simple et facile à comprendre, tant et
si bien que même un WaReZ PuPpIe moyen devrait *PEUT-ETRE* pouvoir
s'y retrouver. DATAPAC est le réseau PSN (Packet Switching Network)
X.25 de Telecom Canada, un groupement de plusieurs compagnies de
téléphone au Canada, incluant Bell.

     DATAPAC est un réseau bâti dans le but de procurer des
services de transfert de données à haute-vitesse aux compagnies.


 Comment entrer dans DATAPAC?
 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~

     Le numéro du port public (ouais, public, c'est légal les mecs)
2400bps pour la région de Québec est le 647-3181. Voici une liste
des Ports Publics pour le Canada entier. Cette liste a été réalisée
par The Lost Avenger/UPi et je lui en donne tout le crédit.
...
le port public le plus près de chez-vous. Lorsque vous êtes
connectés, tapez un point (.) suivi d'enter. DATAPAC devrait vous
répondre comme ceci:

     DATAPAC: XXXX XXXX

      Le mask XXXX XXXX est le numéro du port public ou vous vous
êtes connectés. Le port public de Québec a le numéro 4820 0093.
...
comme un autre système de téléphone, qui fonctionne uniquement
data, et qui est constitué de NUA plutôt que de numéros de
téléphone. Le NUA est donc une addresse qui vous guide à travers
DATAPAC jusqu'à un ordinateur remote.

     Dès que vous êtes connectés sur DATAPAC vous devriez essayer
de contacter le DIS (Datapac Information Center). Son addresse est
le 92100086, que vous entrez après le (. &lt;cr>) ou le (SET 2:1 &lt;cr>)
(Toutes vos commandes seront interprétées sans le SET 2:1, mais
c'est quand même plaisant de voir ce qu'on ecrit). De là, vous avez
accès à une foule d'informations concernant l'utilisation du réseau
et ses tarifs (vous verrez où on paye plus tard. Jusqu'ici tout est
gratos). Le DIS devrait pouvoir vous être d'un grand secours en ce
qui concerne votre apprentissage du réseau DATAPAC.

     Certains NUAs utilisent le pattern à 8 chiffres (ex. 4820
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ...
     En scannant. De bons programmes existent à ce sujet, dont le
DAS (Datapac Address Scanner), un produit québécois qui porterait
sûrement la mention Qualité Quebec si cette organisation laissait
une place à des débrouillards comme nous. A ce que je sache,
scanner des NUAs sur DATAPAC n'est pas plus illégal que scanner des
numéros 1-800. Il existe aussi une foule de programmes un peu plus
"bas-de-gamme", que vous trouverez sur tout bon babillard
Hack/Phreak de la région. La plupart des NUAs d'intérêt ont huit
chiffres, et une majorité d'entre eux dans le pattern XXX00XXX.
Voici une liste des réponses que DATAPAC pourrait vous retourner
après l'inscription d'un NUA:


CALL CONNECTED TO XXXX XXXX

Dans la vie, certaines choses s'expliquent d'elle-mêmes.

CALL CLEARED -- ADDRESS NOT IN SERVICE

Le NUA que vous avez essayé n'existe pas.

CALL CLEARED -- DESTINATION BUSY

Le/Les points de connection du système sont tous occupés,
ré-essayez plus tard.

CALL CLEARED -- TEMPORARY NETWORK PROBLEM

Plutôt clair ça aussi, essayez de nouveau plus tard.

CALL CLEARED -- ACCESS BARRED

Le système que vous souhaitez rejoindre n'accepte pas votre
connection car vous (votre NUI, souvent) ne faites pas partie de
son User Group. C'est un systeme privé, finalement.

CALL CLEARED -- COLLECT CALL REFUSED

Le système que vous désirez appeler n'accepte pas de payer vos
frais d'appel (sucks!). Pour avoir accès à ce système, il faut
avoir un NUI valide (voir plus loin pour les NUIs).


D'autres messages plus weird pourraient vous sauter au visage, mais
à ce point vous devriez déjà avoir compris que Joe Average à 80 de
Q.I. peut tout piger ça sans problème.


Et les NUIs?
~~~~~~~~~~~~

     Network User Identifier. Le NUI est le numéro qui vous
identifie vis-à-vis le système Datapac. Tant que vous n'avez pas
entré de NUI, vous êtes anonyme aux yeux de DATAPAC. Les NUIs ont
entre 6 et 8 chiffres de long, et ont tous des passwords
(évidemment). La principale fonction d'un NUI pour Telecom Canada
est de savoir à qui envoyer la facture pour les services qu'ils ont
utilisé. ATTENTION! Il est _TRES_ imprudent d'essayer de scanner
pour des NUI, je ne recommande ce genre de pratique à personne. Le
possesseur d'un NUI a donc plusieurs avantages sur celui qui n'en
a pas:

1- Le système remote ne vous renvoie plus à cause qu'il n'accepte
plus les frais; les frais sont chargés à votre NUI (c'est bien le
vôtre, non? ;).

2- Si votre NUI fait partie de certain User Groups, cela peut vous
donner accès à certains systèmes privés. Normalement vous devez
contacter l'administrateur du système en question pour faire partie
de son User Group.

3- Votre NUI peut vous donner accès à plusieurs réseaux américains
et étrangers via DATAPAC. Telenet, Tymnet, Autonet, Acunet et
Dasnet en sont quelques exemples.

4- Vous avez (oh-oh) accès à des outdials data dans plusieurs
villes du Canada, ce qui en soit est plus qu'intéressant.
...
DATAPAC:
     ...
     Si tout est conforme, DATAPAC vous répond avec le message
suivant:
...
DATAPAC: network user identifier error.
     ...
     Si en cours d'appel vous voulez mettre votre NUI à off et
...
DATAPAC: network user identifier not active.
     ...
     Bien sûr, nous savons tous que vous désirez déjà acquérir
votre propre NUI, car utiliser celui d'une autre personne est
ILLEGAL!!!!!!!&lt;g>. Dans ce cas, contactez le DIS, il se fera un
plaisir de vous informer sur les derniers tarifs en matière de
...
l'enthousiaste des télécommunications (lire hacker) que tu es. En
voici quelques-unes:

 -) HP-2000 (-

Les Systèmes HP (pas Hack/Phreak! Hewlett-Packard!) runnent le
système MPS. Ce systeme est reconnu au prompt tout cute que voici:

               :

Pour logger, il faut suivre la procédure suivante:
...
Lord paru sur le sujet il y a de cela quelques NPC.
     ...
     Un des systèmes le plus largement utilisé (sinon le plus
utilisé). Vous répond habituellement avec un petit greeting et un
prompt comme celui-là:

login:

     Tout en minuscules, n'oubliez pas ça pour l'user ID.

 -) PrimOS (-

     Assez répandu, ce système vous reçoit avec un des messages
suivants:
...
Primecon 18.23.06
     ...
     Plusieurs variantes sont aussi possibles, mais vous avez noté
le 'Prime'. Certains systèmes vous reçoivent aussi avec le prompt
ER! qui peut aussi apparaître si vous appuyez sur enter. Pour
logger, inscrivez:

login &lt;Votre_ID>


     Voici quelques accounts/passwords à essayer:
...
Test                     Test
     ...
     Pas très répandu comme système. Le prompt est celui-ci:

     .

     Tapez 'systat' pour avoir une liste des accounts online. Vous
devriez être capables de tenter un login après ça.


     -) VAX/VMS (-

     The Subhuman Punisher a déjà parlé de celui-là. Le système VAX
est une création de Digital Equipement Corporation et runne l'OS
VMS (Virtual Memory System). Voici le prompt:

Username:
Password:

     Attention! VMS informe l'usager de toute tentative d'accès
manqué à son account alors faites gaffe, c'est plutôt safe de
l'extérieur. Voici quelques defaults accounts/passwords:
...
Default                  Dec
     ...
     Enfin, nous pourrions nous éterniser éternellement sur le
sujet, lisez des t-philes parues sur les différents OS, ils sont
...
~~~~~~~~~~
     ...
     Et voilà, les portes de l'univers DATAPAC vous sont maintenant
ouvertes, il ne vous reste plus qu'à y pénétrer. J'espère que vous
aurez bien du fun sur ce merveilleux réseau (le paradis, je vous
jure) et revenez-nous (hopefuly!) le mois prochain pour un petit
quelque chose d'autre de mon cru. Alors, à la prochaine!
...
-------------------------------------------------------------------
     ...
     Ma maigre contribution ce mois-ci se résume à quelques bonnes
...
J'ai aussi trouvé un BBs où on peut telnetter, UIowa bbs. L'Adresse
est bbs.isca.uiowa.edu. D'ailleurs, les posts qui suivent ont été
tirés de ce babillard. Nous n'avons pas eu le temps de vérifier
toutes les assertions qu'ils contiennent. C'est le genre de FAQ
indigeste qu'on trouve ici et là...
...
d'une version définitive car le projet est en constante évolution.
La dernière version de llcfaq sera toujours disponible sur Sietch
BBS.

Le lecteur de ce FAQ est encouragé à le distribuer gratuitement.

Le début des questions porte l'en-tête <#.#> ou #.# est le numéro
de la question.
...
<1.1>  : Hein ? On m'avait dit que c'était une coop ?
...
<4.0>  : Qu'est-ce que LLC rendra disponible à ses usagers ?
<4.1>  : Quel sera l'équipement de LLC ?
...
<5.1>  : De quoi aura l'air mon adresse sur le système ?
<5.2>  : Le FTP est-il limité ?

<6.0>  : Quand et où ouvrira LLC ?
<6.1>  : Wow ! Je veux embarquer ! Ca va me coûter combien tout   
         cela ?
<6.2>  : Qui gère LLC et comment les contacter...
<6.3>  : A quoi m'attendre avec LLC pour bientôt ?

<7.0>  : On m'a dit que LLC était une gang de hackers, pirates,   
         [autres noms dans le même genre] ?
<7.1>  : LLC servira-t-elle à des activités illégales ?
<7.2>  : Mon courrier privé sera-t-il 'privé' ?
<7.3>  : Qui est responsable de mon accès ?
...
Questions. C'est un texte dans lequel sont regroupées les questions
les plus souvent posées (ainsi que leurs réponses) sur un sujet
donné.

<0.1> A qui s'adresse ce FAQ ?
: Ce FAQ s'adresse à ceux ayant entendu parler de LLC et qui
désirent en connaître davantage sur ce point. Ce FAQ s'adresse
également à ceux voulant se tenir à jour concernant l'ensemble du
projet de LLC.

<1.0> Qu'est-ce que c'est LLC ?
: LLC signifie Liberté, Liberté, Chérie ! C'est le nom d'une
compagnie à but non-lucratif qui s'est donné pour mandat de fournir
un accès légal, public et accessible à tous sur Internet ainsi qu'à
Usenet, cela pour la region 418.

<1.1> Hein ? On m'avait dit que c'était une coop ?
: Afin de pouvoir bénéficier d'arrangements financiers très
avantageux, LLC est devenu une cie. Rien ne change pour l'usager,
à part qu'il n'y a plus de parts sociales à payer.

<2.0> Qu'est-ce que c'est Internet ?
: Voici une courte définition [tirée et traduite de whatis_i.txt]
:
  " Une question souvent posée est celle-ci : "Qu'est-ce
qu'Internet ?". La question est souvent posée car il n'y a pas de
consensus sur la réponse qui décrirait le mieux Internet. Internet
peut être vu sous le rapport de ses protocoles communs comme étant
l'ensemble physique des 'routers' et circuits le composant, comme
étant un ensemble de ressources qui sont partagées ou même comme
étant une attitude par rapport à l'interconnection et
l'intercommunication. Quelques définitions passées se résumaient à
ceci :

  * un réseau de réseaux basé sur les protocoles TCP/IP
  * une communauté de personnes qui utilise et développe ces      
    réseaux
  * un ensemble de ressources atteignables par ces réseaux

  Aujourd'hui Internet est une ressource globale reliant des
millions d'usagers. Bien que les réseaux formant Internet soient
basés sur des protocoles standards, Internet a aussi des 'gateways'
vers d'autres réseaux et services qui sont basés sur d'autres
protocoles."

  Pour plus d'info sur Internet voir le point 8.1

<2.1> Qu'est-ce que l'on retrouve sur Internet ?
: On retrouve tout d'abord d'autres sites situés à travers le
monde, accessibles en direct, en temps réel, et tout à fait
...
Unix jusqu'aux images graphiques des vues prises par Voyager.
  ...
  "  File Transfer Protocol (FTP)
      Un protocole permettant à un usager sur un site d'atteindre
et de transférer des fichiers vers un (ou d'un) autre site sur le
réseau. Egalement, FTP est habituellement le nom du programme que
l'usager invoque pour exécuter le protocole. " [tiré et traduit de
int_glos.txt]

  Vu la quantite énorme d'informations sur Internet, des
utilitaires servant à ramasser cette information (par exemple,
...
WAIS, WWW :
  ...
  " archie
      Un système qui ramasse, indexe et distribue automatiquement
l'information sur Internet. La première implantation d'archie a
servi à indexer un répertoire de noms de fichiers de tous les sites
permettant l'anonymous FTP à travers Internet. Des versions
subséquentes ont servi à ramasser d'autres types d'informations."
[tiré et traduit de int_glos.txt]

  Mais Internet c'est plus que des fichiers, c'est également des
millions d'usagers à travers le monde. Pour communiquer avec eux,
plusieurs moyens existent, le premier peut consister à envoyer un
email à une personne :

  "  Electronic Mail (email)
      Un système dans lequel un usager d'ordinateur peut echanger
des messages avec d'autres usagers d'ordinateurs (ou groupes
d'usagers) via un réseau de communication. Le email est l'un des
usages les plus populaires d'Internet." [tiré et traduit de
int_glos.txt]

  Des groupes de messageries sont disponibles. Usenet est un réseau
offrant de tels groupes. [voir 3.0 et suivant]

  On peut 'dialoguer' ou 'chatter' à plusieurs sur Internet via le
IRC :

  "  Internet Relay Chat (IRC)
      Un protocole mondial de 'party line' qui permet a un usager
de converser avec d'autres en temps réel. " [tiré et traduit de
int_glos.txt]
...
plusieurs) usager(s) en particulier 'logged' sur le système local
ou un système 'remote'." [tiré et traduit de int_glos.txt]

  Il existe aussi des 'jeux', ou mieux, des espaces virtuels, qu'on
regroupe sous le nom de muds :

  "  Multi-User Dungeon (MUD)
      Jeux d'aventures, de rôles ou de simulations qu'on joue sur
l'Internet. Ces jeux peuvent contenir des combats, des pièges ou de
la magie. Les joueurs interagissent en temps réel et peuvent
changer le 'monde' dans le jeu à mesure qu'ils jouent. " [tiré et
traduit de int_glos.txt]

  Ceci n'est qu'un éventail des possibilités qu'offre Internet.

<3.0> Qu'est-ce que c'est Usenet ?
: "  Usenet
      Un ensemble de milliers de 'newsgroups' nommés par le sujet
qu'ils représentent, les ordis qui utilisent les protocoles pour
Usenet et les personnes qui lisent et écrivent dans Usenet. Ce
n'est pas tous les sites Internet qui souscrivent à Usenet et tous
les sites Usenet ne sont pas sur Internet. " [tiré et traduit de
int_glos.txt]

<3.1> Qu'est-ce que l'on retrouve sur Usenet ?
: On retrouve des newsgroups, ce sont des messageries qui portent
sur un sujet donné. Ces messageries sont divisées en plusieurs
groupes.
  "Les groupes qui sont distribués mondialement sont divisés en
sept (7) grandes classifications : "news", "soc", "talk", "misc",
"sci", "comp" et "rec". Chacune de ces organisations est divisée en
groupes et sous-groupes suivant le sujet discuté." Les voici
...
recreational activities.
  ...
  Ces newsgroups 'mondiaux' sont (habituellement) distribués à
...
'techniques', et les groupes plus controversés ne sont souvent pas
distribués sur plusieurs sites (ces groupes sont souvent regroupés
dans les classifications "talk" and "soc")...

  Il existe des groupes dans d'autres sous-categories, mais ils
sont locaux à des institutions, des régions géographiques, etc...
" [tiré et traduit de newsgrp.zip]
...
necessarily VMS-specific).
  ...
  Pour une liste complète des newsgroups, il y a le fichier
newsgrp.zip disponible sur Sietch BBS (voir 8.1)

<4.0> Qu'est-ce que LLC rendra disponible a ses usagers ?
: Le but premier de LLC est d'offrir un accès à Internet, alors
...
disponible afin de simplifier les fonctions. En partant, le système
offrira l'anonymous FTP pour le reste d'Internet (voir 4.3). Après
quelques mois, un muds situé sur LLC sera disponible pour tout
Internet aussi (voir 4.4).


<4.1> Quel sera l'équipement de LLC ?
: La meilleure façon est de l'illustrer par un diagramme [édité et
tiré de npc-012.txt]
"
       I
  ...
  1) Utilité de chaque pièce du système
     Une compagnie fournit une 56 kbps high, jusqu'à present la
dite compagnie (dont on doit taire le nom pour le moment) n'a pas
fixé de limite de gigs par mois (i.e. the sky is the limit). Ce
sont les deux lignes parallèles qui entrent à gauche en haut du
dessin. Cette ligne, si l'entente est signée, coûte 2400$ par mois,
en plus des frais de départ.

     Cette ligne entre sur un modem special, un V-35, qui coûte
environ $500. Lui-même est ensuite connecté sur un router
NetBlazer. On garde en permanence un 386 (usagé si possible)
branché pour contrôler le flot du trafic et gérer les adresses. Il
y aura là un autre 386 qui servira de site FTP. Ainsi qu'un autre
qui servira pour le Mud.

     Le router NetBlazer est lui-même relié à l'ordinateur central
...
probablement de marque Annex, branché sur 10 modems (10 x 400$US),
eux-mêmes branchés sur 10 lignes téléphoniques Centrex, une ligne
par 10 usagers. C'est par ces lignes que vous allez entrer. Les 10
modems seront des Zyxels upgradables au v.fast.

      En gros, c'est ça. Ce que vous ne voyez pas, dans le dessin,
c'est une génératrice de secours (appelée couramment UPS) qui, en
cas de panne (on est au Québec, n'est-ce pas!), va prévenir les
usagers sur le système et fermer le tout EN DOUCEUR, de façon à ce
qu'il ne plante pas. Prévoyons aussi un 1000$ de programmes, un
tape backup DAT (1000$), et quelques gugusses. "


<4.2> Comment fonctionnera LLC ?
: LLC fonctionnera sous la forme d'un babillard. Les points 4.0 et
4.1 introduisent bien cette question. En plus, le système sera
équipé du caller-id. Seulement deux (2) numéros de téléphone par
usager seront permis. Chaque usager aura un espace-disque de deux
(2) megs extensible pour la période en ligne. Par exemple, s'il va
FTP pour huit (8) megs d'un site à son espace-disque, cela se fait
en 56 kps (ça dépend des sites mais prenons cette vitesse par
défaut). L'usager a donc huit (8) megs de fichiers qu'il peut
downloader du bab vers chez lui à la vitesse de son modem (v.fast,
v.32bis, etc...). En dedans des prochaines 24 heures, il faudra que
son espace-disque revienne dans les alentours de deux (2) megs. 

     LLC offrira un lecteur/éditeur offline pour les newsgroups et
le email, sur le principe de QWK. Sietch BBS sera un exemple de
l'interface-système que l'on retrouvera sur LLC (à peu de choses
près). Naturellement, les gens, en connectant, auront le choix
d'aller directement au shell Unix(pour les pros), ou d'aller au
babillard (pour les moins aventureux).

<4.3> LLC aura une section FTP 'made in Quebec' ?
: En effet, dès son ouverture, le site permettra à quatre (4)
autres usagers d'Internet de venir faire de l'anonymous FTP sur
LLC. Dans cette section seront regroupés tous les documents,
programmes, .mods (format de musique) et démos faits à Québec.

<4.4> Le site aura-t-il son propre muds ?
: Oui, quelques mois après l'ouverture, LLC sera doté de son propre
mud. Le 'sujet' du mud sera dévoilé en temps opportun.

<5.0> Quels newsgroups seront disponibles ?
: L'ensemble des newsgroups non-payants francais et anglais sera
supporté. Si un usager veut un newsgroups dans une autre langue, il
pourra en faire la demande. Le plus souvent elle sera honorée.
Après six (6) mois, LLC prévoit supporter certains newsgroups
...
<5.2> Le FTP est-il limité ?
: Non, aucune limite (à part le temps) est fixée pour le FTP.

<6.0> Quand et où ouvrira LLC ?
: Si tout va bien, LLC sera opérationnel le 1er mars 1994. Tout
l'équipement sera situé dans un local loué au nom de la cie.

<6.1> Wow! Je veux embarquer ! Ca va me coûter combien tout cela ?
: Il faut dans un premier temps comprendre que c'est assez coûteux
d'être sur Internet. Par exemple, une compagnie new-yorkaise
(mindvox) demande 18 $ US par mois pour un tel accès. Plus près de
nous, Communication Accessibles Montreal demande 25 $ par mois. Ici
dans le 418, l'Universite Laval demande à peu près 90 $. Tous ces
coûts représentent des services à peu près égaux. Etant une cie à
but non-lucratif, LLC veut avant tout offrir un accès Internet pour
tous. C'est pourquoi deux (2) tarifs seront offerts. Le premier est
de 25 $ par mois et le second de 35 $ par mois.

  La journée de 24 heures (appelée ici grille_journée) sera divisée
en deux (2) périodes : accès_jour et accès_soir (valide les sept
(7) jours de la semaine).

  Voici un résumé :

accès_jour :  de 3:00 AM a 16:59 PM., cela coûte 1 point / minute
accès_soir :  de 17:00 PM a 02:59 AM., cela coûte 2 points / minute

si je paie 25 $ : je recois 3600 points pour le mois
                  avec un maximum de 120 points / grille_journée
                  soit un maximum de deux (2) heures dans
                  l'accès_jour ou d'une (1) heure dans
                  l'accès_soir.

si je paie 35 $ : je recois 7200 points pour le mois
                  avec un maximum de 240 points / grille_journée
                  soit un maximum de quatre (4) heures dans
                  l'accès_jour ou de deux (2) heures dans
                  l'accès_soir.

  Le système s'occupera de calculer le coût en points dans les
différentes périodes de la journée.

<6.2> Qui gère LLC et comment les contacter...
: La compagnie a à sa tête Mario Cantin.
  Pour le contacter, faites un mail sur Sietch BBS (656-9451) à
Blitz. Ou pour l'appeler par voix, composez le 692-4711.

<6.3> A quoi m'attendre avec LLC pour bientôt ?
: En ce moment, Blitz attend de signer pour la ligne de 56 kbps. Et
si tout va bien, le 20 fevrier le tout sera opérationnel. De cette
date jusqu'à l'ouverture officielle du 1er mars, des séances
d'information pour les usagers seront dispensées. Par la suite, et
ce jusqu'au 1er mars, ces mêmes usagers pourront utiliser LLC
gratuitement. Un tirage au sort déterminera l'ordre dans lequel les
personnes auront leur séance.

<7.0> On m'a dit que LLC était une gang de hackers, pirates,
[autres noms dans le genre] ?
: Faux, LLC regroupe des avocats, analystes, médecins, programmeurs
et étudiants, entre autres. Même un (ou des?) membre de la GRC
était présent aux réunions ! On ne peut pas être plus légal ! :)
Ces gens ont en commun l'idée d'accéder à Internet.

<7.1> LLC servira-t-elle à des activités illégales ?
: Comme indiqué au point 1.0, le but premier de LLC est d'offrir un
accès public, LEGAL et accessible à tous les usagers. Les warez ne
seront pas tolérés. De plus, comme le veut le devoir de tout
citoyen canadien, si un opérateur du système se rendait compte de
quelque chose de 'louche' dans l'activité d'un usager, les mesures
nécessaires seront prises afin d'assurer l'intégrité du système.

<7.2> Mon courrier privé sera-t-il 'privé' ?
: Oui, l'opérateur du système ne lira pas le courrier privé à moins
qu'une plainte n'ait été déposée et que cela demanderait une telle
lecture.

<7.3> Qui est responsable de mon accès ?
: Chaque usager du système est responsable de son propre accès
ainsi que de son courrier. Le système offre une protection via
l'utilisation d'un mot de passe pour chaque usager ainsi que du
retraçage des appels via le caller-ID. Dans tous les cas, si une
personne autre que l'usager entre sur le système en utilisant
l'acompte de l'usager, peu importe la façon dont la personne a
accédé à l'acompte, l'usager est le premier responsable et non le
système.

<8.0> Comment contacter l'auteur de ce FAQ ?
: La meilleure façon c'est de me laisser un message sur Sietch BBS
(656-9451). Faites 'mail' et, au destinataire, inscrivez 'murdock'.
C'est une excellente façon de m'envoyer d'autres questions que
j'aurais oublié.
...
répondre à pas mal de questions.

<8.2> Je veux plus d'info sur LLC...
: Les NPC sont généralement une bonne source d'info. N'oubliez pas
que le projet évolue et ce qui est dit dans un numéro peut ne plus
s'appliquer. La conference sietch.discussion.internet sur Sietch
BBS devrait être une bonne place pour les infos.

  Lisez le dernier LLCFAQ.

  Envoyez un mail à Blitzkreig.

<9.0> Remerciements et sources d'infos.
: Je remercie les usagers de Sietch BBS qui ont repondu à mes
questions sur Internet et LLC : Blitz, Gurney Halleck, Evil-e,
l0grus!, Kermit, entre autres.
  Mes sources d'infos furent les textes cités au point 8.1, les
NPC, différentes conférences sur Fidonet ainsi que des détails
ramassés par-ci par-là.
...
-------------------------------------------------------------------
                ...
                par l0gRuS!, collaborateur à NPC.


        Les faits sont là. Il n'y a pas si longtemps, une liste au
contenu bizarre est apparue sur les babillards pirates de la région
de Québec. La liste contenait les noms, adresses et mots de passe
...
Politique avait donné des informations à la GRC. Pas un drame,
remarquez. La GRC a ces informations depuis belle lurette, tant
soit peu qu'ils sachent utiliser un bottin téléphonique. Les jours
ont passé et on en a quelque peu parlé. Puis, de nouvelles rumeurs
firent surface: la maison de Robert Bertrand, SysOp du Renouveau
Politique, aurait été mystérieusement endommagée, et Mr. Bertrand
rejetterait le blâme sur NPC.

        Donner la version d'NPC uniquement aurait été à quelque
part une obstruction de la vérité, alors nous avons contacté Robert
Bertrand et son SysOp associé (le nom m'échappe), qui nous a
gentiment (quoique froidement) donné quelques minutes de son temps.

        Robert Bertrand a fait la liste. Selon lui, NPC l'aurait
volée (de l'ordinateur du Renouveau Politique ou Music Art BBS) et
l'aurait ensuite publiée. Il dit en avoir les preuves. Il nie par
contre l'avoir envoyée à la GRC; il n'a dénoncé que les "Fraudeurs
Informatiques". Depuis la parution de la liste, le Renouveau
Politique a été victime d'une de ces fraudes, mais Robert Bertrand
nous assure que le babillard est maintenant hors de danger. Il va
sans dire qu'il soupçonne NPC d'avoir commis cet acte. Selon ce que
j'ai pu comprendre, il est également vrai que la maison de Mr.
Bertrand aurait été endommagée, et là encore il soupçonne NPC. Il
affirme qu'un "baveux" (Atreid Bevatron) l'aurait appelé le
lendemain de l'incident et lui aurait demandé si quelque chose
était arrivé à sa maison. Selon Robert Bertrand, c'est une preuve
de sa culpabilité. Selon NPC, Atreid ne voulait qu'avoir la
confirmation de la rumeur.

        Il va sans dire que la version de NpC est la plus credible,
et ce sans parti-pris. Seule une backdoor de SBBS aurait permis à
un membre de NpC d'aller chercher le texte qui n'était pas online,
et à ma connaissance personne içi n'en connait (il est d'ailleurs
fort probable que si c'était le cas, elles seraient déjà publiée).
Aussi nos informations tendent à confirmer que la liste aurait été
capturée du Music Art BBS par un ami du SysOp (que nous ne
nommerons pas pour des raisons évidentes), qui l'aurait donné à un
illustre inconnu, Ray Decay, qui l'aurait à son tour donné à un
illustre asshole, Nazgul, qui l'aurait donné à Evil-E et de la
jusqu'à Blitzkreig. C'est un peu long comme chaine pour que NPC y
soit impliqué, non? Aussi, j'étais en conférence avec Atreid
Bevatron juste avant qu'il n'appelle Mr. Bertrand, et si je ne me
trompe pas c'est moi et Evil-E (un autre hacker de la région) qui
lui avons appris le fait.

        La vérité? Robert Bertrand nous indique que nous allons la
connaître dans peu de temps. Peut-on croire à des arrestations?
Alors restez sur le qui-vive, et je serai des premiers à vous
informer des développements étranges de cette affaire.
...
délateur de la GRC (enfin, pas au moment où il a composé la liste).
Je crois juste que c'est un fieffé idiot qui s'est fait prendre les
culottes baissées. Cet halluciné notoire s'est accoquiné avec le
sysop de Musical (ou Music quelque chose, mais je ne crois pas que
ce soit Music Art) BBS, qu'on m'indique comme un parano certifié et
certifiable. S'il ne prend pas ses médicaments, le monde commence
rapidement à chavirer pour lui. Ce sysop, dont le nom m'échappe, a
dû en conter des vertes et des pas mûres à Bertrand, toutes le
fruit de son imagination de crétin congénital. Et Bertrand, en
étant un autre, a tout gobé. Souvenez-vous, dans NPC 10, quand je
le félicitais pour son babillard: pourquoi aurais-je voulu, moi ou
quelqu'un d'autre de NPC, l'emmerder? Mais Bertrand est, nous
l'avons dit, un amateur de la pire espèce. Derf, Méphisto, et
plusieurs d'entre vous lui ont ainsi parlé, lorsqu'il a décidé de
fermer les messageries sur son board. "Ca a pas de bon sang, un
board sans messagerie", lui avons-nous dit. "C'est comme un
sandwich au jambon sans jambon!". Mais lui a prétendu qu'il pouvait
très bien faire fonctionner un board sans messagerie... Et plus
personne n'a jamais appelé sur son board. 

     L'amateur qui arrive dans le portrait et qui pense tout
connaître. Vous savez très bien comment on appelle ça, je suppose:
un LAMER!

     En ce qui concerne le bris de sa résidence: je demande à voir!
Une autre connerie monumentale proférée par un imbécile qui ne sait
plus quoi inventer pour expliquer ses bourdes. Mais de quelles
bourdes s'agit-il? Eh bien, mes amis, voici, non-censurée, la
fameuse liste qui circulait. Vous allez voir, c'est plein de
conneries! Hell! J'y ai même découvert des collaborateurs de NPC
que je ne connaissais pas! 

     Cette liste, je l'ai dit, n'est pas censurée. C'est dans le
...
Il travaille ou a travaillé avec le conseiller de la Ville de 
Québec :  Réjean Lemoine.
...
Il est le responsable de Northern Phun Co pour la présentation du 
numéro 11.  Les responsables s'interchangent...

Son vrai nom:

Alex (Alexandre) Bourget,  686, rue de Brabant, Ste-Foy

rés. 650-9537;  fax ou modem: 623-3221

Fausse adresse donnée:  686, de la Bonne Aventure.

..................................................................


Jean-François Landry jef! 04-61-73   JEF      831-7461 faux

a envoyé  SBBSFIX  pour prendre la liste de nos usagers.

Il travaille ou c'est son nom emprunté avec 
...
A déjà fait un minimum de 6 babillards.
Voulait m'aider en ouvrant des doors
Il a treize ans et très débrouillard
Il a été rejeté de Bab-Kath.
...
Yves Sauvé  bouchon  6-03-72   Zonorglub the master   845-4324


relié avec le npc.... Pas plus.


................................................................


François Villeneuve  Kissing  9-12-76  The extremist  849-6308
...
Un éclaireur pour les amants des npc.   
C'est propre.
...
Participe à la réalisation des écrits dans le npc sous le nom
du vieux médée.

Donc peut présenter  diverses  facettes..... laquelle est la
bonne....   
...
Stéphan Bédard  RPFNVHGB  4-03-69  THE KEYMAN  mo 835-3388
                                             rés  835-3352

..............


Stéphane Proulx  Le mort.  15-0976   The Scripter  889-8039
...
Exporte un document qui l'amène directement  au  dos.
cette exportation a été envoyée chez MUSIC ART BBS
...
décidé de lancer (un autre) mag HP. Il s'appelle SPHEAR. Me semble
que, même à nos débuts, nous étions un peu moins lame que ces mecs.
C'est toujours le même ramassis de clichés et de propos non-
vérifiés. A preuve le t-file posté par Coaxial dans l'article
précédent, sur les redboxs, et le texte sur ces mêmes boxes qui
suit. Enfin...

     Ceci dit, il y a quand même quelques documents gouvernementaux
qui nous renseignent sur les derniers cas de fraude. Tout n'est pas
perdu, donc. Ils ont même inclu quelques programmes en UUENCODE
pour leurs lecteurs. Blitz me dit qu'on distribue aussi, avec ce
numéro 13 de NPC, UUENCODE, pour ceux qui ne seraient pas encore
équipés de cet outil qui va vous être fort utile bientôt, avec
l'ouverture de LLC. 
...
Note
~~~~
     Voici les services des différentes compagnies téléphoniques
locales (BOCs) à travers les Etats-Unis ainsi qu'à travers les
...
*57        Retraceur d'Appel        Permet de retracer
                                   ...
                                   reçu. Votre compagnie de
                                   téléphone gère probablement un
                                   'Annoyance Call Center' qui peut
                                   recevoir automatiquement un
                                   message contenant le numéro de
                                   téléphone de l'appel abusif reçu
                                   ainsi que l'heure et la date de
                                   l'appel en question. Ce numéro
                                   sera probablement surveillé.

                                      Utiliser : *57

*60        Blocage d'Appel          Prévient la dernière personne
                                   qui vous a appellé de vous
                                   rappeller à partir du même
                                   numéro téléphonique. Aussi,
                                   rejette les numéros que vous
                                   avez placés sur votre liste de
                                   bloquage d'appel.

                                      Utiliser : *60
                                      Canceller: *80, Prestige: *50

*61        Sélecteur d'Appel        Permet de créer une liste de
                                   numéros vous permettant d'être
                                   prévenu par une sonnerie
                                   spéciale lorsque l'appel en
                                   question est reçu.
                                   ...
                                   tonalité spéciale lorsque
                                   l'appel en question sera reçu.

*63        Transfer d'Appel         Permet de choisir un autre
                                   numéro de téléphone où l'appel
                                   doit être transféré.

                                      Utiliser : *63, #, numéro, #
                                      -Note-
                                     Si vous tranférez vos appels
                                   à des numéros longue distance,
                                   vous serez chargé pour chaqu'un
                                   de ces appels.

*66        Rappel automatique       Rappelle automatiquement le
                                   dernier numéro appellé.

                                      Utiliser : *66
                                      Canceller: *86, Prestige: *56
           
*67        Bloquage d'Appel         A chaque appel effectué, votre
                                   numéro de téléphone n'est pas
                                   affiché sur le 'Caller ID' de la
...
*69        Retour d'Appel           Retour d'appel au dernier
                                   numéro, que vous ayez décroché
                                   ou non le téléphone.

                                    Utiliser : *69
                                    Canceller: *89, Prestige: *59

*70        Désactiver Mise          Si vous avez le service Mise en
           en Attente              Attente, permet aux personnes
                                   qui vont vous appeller de leur
                                   émettre un signal engagé.

                                       Utiliser : *70

*71        Conférence à trois       Permet de joindre une autre
                                   personne à votre conversation.
...
*77        Rejet d'Appel            Permet de rejeter les appels  
           Anonyme                 ayant un service anonyme (comme
                                   *60). Lorsque vous activez ce
                                   ...
                                   contre pas à quel moment un
                                   appel a été rejeté.

                                    Utiliser : *77
                                    Canceller: *87
                                     -Note-
                                    Un message vocal peut-être lu
                                   à l'appelleur lorsque son appel
                                   a été rejeté.


-Note, Tranfert d'Appel [*63]-

 Lorsqu'un appel est transféré (forwarded) à un autre numéro,
l'afficheur affichera le numéro de l'appel transféré et non le
numéro de l'endroit où a été transféré l'appel.
...
-Note, Retour d'Appel et Rappel Automatique [*66, *69]-
 ...
 Si la ligne est occupée, le Retour d'Appel ainsi que le Rappel
Automatique vont automatiquement tenter d'appeler le numéro désiré
toutes les minutes durant une demi-heure.  Lorsque la ligne
deviendra disponible, vous allez entendre une sonnerie spéciale. Si
vous ne répondez pas, la sonnerie spéciale va recommencer à sonner
toutes les cinq minutes durant la prochaine demi-heure.

Si vous avez besoin plus de renseignements, vous pouvez toujours me
contacter à : mastertronics@uworld.mtlnet.org
...
-------------------------------------------------------------------
     ...
     Aujourd'hui, nous vous présentons LE texte qui a secoué
alt.2600 ce mois-ci. TOUS les lecteurs de ce post se sont roulés
...
Number of people on the Internet who know you're a dog: 0
      ...
      Tiré de Mondo 2000 - Article par Paco Xander Nathen 
...
Rich Siegel is quick to point out that custom FSR parts can be made
...
2100 - 805 684 8282 fax
      ...
      Twenty million strong and adding a million new users
        a month, the Internet is suddenly the place to be
           ...
           Article tiré de TIME Magazine (6 décembre)
...
∙ A signature is not forgeable and serves as proof that the
  signer deliberately signed the document.
∙ A signature is authentic and convinces the recipient that the
  signer deliberately signed the document.
∙ A signature is not reusable. It's part of the document, and an
  unscrupulous person cannot transfer it to a different document.
∙ Once signed, a document is unalterable.
∙ A signature cannot be repudiated. Since the signature and the
...
∙ The document's signature is not forgeable, since only Alice
  knows her private key.
∙ The signature is authentic. When Bob verifies the message with
  Alice's public key, he knows that she signed it.
∙ The signature is not reusable; the signature is a function of
  the document and cannot be transferred to any other document.
∙ The signed document is unalterable; any alteration makes the
  document unverifiable with Alice's public key.
∙ The signature cannot be repudiated. Bob doesn't need Alice's
...
∙ 'p', which equals a prime number 2**L bits long, where 'L'
...
∙ 'q', which equals a 160-bit prime factor of [p-1].
∙ 'g', which equals [h(p-1)/q], where 'h' is any number less
  than [p-1] such that [h(p-1)/q mod p] is greater than 1.
∙ 'x', which is a number less than 'q'.
∙ 'y', which equals [gx mod p].
...
[Paranoid- Si jamais il y en a qui comprennent encore, il est à
noter que "**" signifie "à la puissance", ex: b**2 = b². Plus loin,
