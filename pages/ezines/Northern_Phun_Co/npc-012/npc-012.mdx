...
Dans ce douzième numéro de NPC:
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
     ·
     :
     |
...
Greets: Merlin L'Emmerdeur (Sniff! Tout le monde a hâte au mois prochain...)
        Genghis Dan (Rave Hard...)
        Funk Lord (Ton maudit Bourbonnais est difficile à contacter!!!)
        Criminal Mind (Soit damné, jeune CRACKER inconscient!)
        Mental Floss (Envoie-moi tes buncers dans 3 semaines... ;] )
        KBM (Un bel effort sans prétention... ;-)   )
...
1er décembre 1993
     ...
     Lors de la première parution de NPC et durant les cinq ou six
parutions qui ont suivi, vous, gens de la région de Québec (418),
ne vous êtes pas gênés pour nous lancer des commentaires. Certains
étaients positifs, quelques autres négatifs (maintenant à peu près
inexistants, je parle des négatifs), mais là n'est pas la question.
La question est que vous réagissiez.

     Que se passe-t-il dans la belle région de Québec depuis
quelques mois? En fait, il ne se passe rien. La scène est morte
alors? Justement pas, elle n'est pas morte malgré cela. La scène
...
dû au fait que NPC est délaissé, bien au contraire, nous constatons
une trentaine de downloads sur chacun de nos distros à chaque
numéro. Je ne parle pas du nombre de downloads à vie, mais bien du
nombre dans la semaine qui suit chaque parution. Tout ça, c'est
sans compter tous les endroits où NPC est uploadé et downloadé sur
les autres babillards non-NPC.

     NPC est là, comme vous le savez tous, et est là pour durer, je
crois que vous vous en êtes tous rendu compte. Vous connaissez le
journal VOIR? Probablement oui. Il s'agit d'un journal gratuit, lu
par un grand nombre d'étudiants, dans les CEGEPs et les universités
et par beaucoup de gens intéressés par les arts et spectacles. VOIR
n'est pas que cela, mais ma description s'arrêtera là. Les gens du
...
excellent!)
     ...
     NPC n'est pas le journal VOIR. Vous avez tous lu mon éditorial
dans le numéro 11? L'idée de communauté, de philosophie et d'art de
vivre cybernétique. Voilà ce que NPC veut promouvoir. Comme le
journal VOIR, NPC est gratuit, nous savons environ combien de
personnes nous lisent à Québec, mais contrairement au journal VOIR
(je me trompe peut-être), le reste on ne s'en tape pas. Nous
voulons qu'il existe une communication, même une sorte de
complicité entre tous les lecteurs de NPC. (Gens de la GRC,
s'abstenir...) (Quoiqu'il pourrait être intéressant de... comparer
nos points de vue... :] )

     La scène, comme je le disais, semble morte. Elle n'est
...
il y en a forcément une vingtaine, voir une trentaine que nous ne
connaissons pas, qui ne lisent pas NPC que par curiosité, mais bien
pour en appliquer les pratiques (Je ne parle que de la région de
Québec!). Je parle d'une trentaine de personnes qui, semble-t-il,
n'ont aucun contact avec l'underground ou qui peut-être désirent
simplement agir dans la confidentialité de leur foyer. Je vous le
dis, à vous, qui vous acharnez malgré le fait que vous n'avez à peu
près aucun contact avec nous ou avec l'underground, vous qui avez
confiance en vous même et en vos propres ressources, je vous dis
joignez nos rangs!, ou du moins signalez votre présence. Je ne suis
pas en train d'offrir un poste comme officier de NPC; ce que je
veux vous dire, c'est qu'en chacun de vous réside peut-être un
pirate remarquable et chevronné. C'est de gens comme vous que la
scène a besoin, pas des grosses têtes vides qui peuplent les bbs
pirates depuis quelques temps. La scène n'a pas besoin de poseurs
sans connaissance et sans talent qui font semblant d'être
intéressés, mais bien de gens dont l'intention première est de
développer leurs compétences et leurs connaissances. Oui, à vous je
dis regroupez-vous et montrez ce que vous savez faire; pas pour
vous montrer vous-mêmes, mais pour faire profiter de votre savoir
la communauté underground.

     NPC a évolué et nous sommes maintenant lus à travers le
Québec, le Canada, les États-Unis et même dans certaines parties
d'Europe. Nous nous faisons connaître de plus en plus à chaque
numéro et avec l'avènement de LLC, notre distribution se fera à
l'échelle mondiale; comme les CUDs et les PHRACK que vous
...
Phrack ou CUD ou quoique ce soit. Nous sommes des mags différents
avec des contenus différents et de toutes façons, la question n'est
pas là... Où je veux en venir? Je veux dire que malgré le fait que,
possiblement, NPC devienne effectivement répendu à l'échelle
mondial, la région 418 de Québec continuera pour nous d'être une
importante source d'occupation et d'intérêt et qu'elle continuera
toujours de nous tenir à coeur par dessus tout. Ce qui s'y passe
nous tient donc à coeur, et ce que vous pensez tous aussi. Telle
est la raison de mon appel au troupeau, au regroupement, à la
communauté. Nous voulons nous regrouper avec des gens qui partagent
les mêmes intérêts que nous et les mêmes passions pour le monde
cybernétique et les nouvelles technologies...

     A PREVIOUSLY UNKNOWN LIFESTYLE, c'est vrai depuis le début,
c'est encore vrai et ce le sera toujours.

      Vous, que nous ne connaissons pas encore, établissez ce
contact! Rejoignez nos rangs! Nous pouvons être contactés sur
n'importe lesquels de nos babillards publics ou privés, ou par
notre adresse Internet, bien sûr et ce, en tout temps...

Hackez, Phreackez, performez, mais faites-le tous ensemble, en un
seul rang, une seule armée, une seule communauté...
...
j'en viens maintenant à l'objet de ma lettre, à savoir la
~démission~ de l'un de vos éditeurs &lt;me semble-t-il> THX 1138 est
très apprecié de la misérable personne que je suis. Ses écrits me
choquent et me réveillent.. Tant mieux, j'aime bien être réveillé.. 
N'ayant pu le denicher sur aucun des babillard où je vais, j'en
suis réduit à vous quêter une faveur, pour dire si cela me tient à
coeur!

Transmettez-lui, s'il vous plaît, mes sincères condoléances quand
à son découragement &lt;que j'espère temporaire> vis-à-vis de la faune
babillardesque québécoise.. J'espère le voir re-écrire un jour et
quand à moi, le plus tôt sera le mieux !

Sans lui, NPC ne sera plus le même...

Il disait que NPC ne comptait pour personne. que vos écrits ne
comptent pas.. C'est faux.. vous avez joué un rôle déterminant dans
ma vie.

De vous je n'attend pas de réponse.. parce que je sais que je n'en
aurai pas. De lui non plus parce qu'il ne me connaît pas et qu'il
n'a probablement aucune envie de me connaître...
 
Si je suis le seul à protester contre sa disparition, et bien 
tant pis! Mais au moins aurais-je la conscience tranquille s'il 
reçois mon message.. Je ne demande rien d'autre. 
                                   ~~~~ 
Remerciement sincères et gratitude, 
Fvladimir Kroutchefv   

[Atreid- Bien évidemment, nous gardons les portes ouvertes pour le
retour de THX 1138, mais je sais qu'il est parti pour de bon... Et
au fond je le comprends bien... Je l'ai toutefois contacté pour lui
lire ta lettre. Je vais écrire son commentaire... C'est tout ce
qu'il m'a dit à ce propos et la discussion a rapidement changé
immédiatement après.]

[THX 1138- En effet, je n'ai aucune envie de te connaître...]
...
Yo! 
Je végétais un Dimanche soir pis au lieu de continuer à m'acharner
sur mon travail de philosophie 301, j'me suis mis  à caller au
Black Palace (Nonon, c'pas une plogue!). Pour une très rarissime
fois, je réussis à m'infiltrer sur ce bab de façon expéditive et
découvrir la section NPC qui s'y cache (faut le dire pour le
croire...). Quelle ne fut pas ma stupéfaction et mon indignation
bienheureuse de downloader votre mag... Une force subconsciente m'a
dit avec générosité que NPC était un groupe (quoique énorme!) qui
était fou comme un balai! Les 3 longues heures que m'ont exigé
l'impression de votre manuscrit n'ont certe pas été perdues. En
vous lisant, je me suis dit: "Ma foi, ils se débattent comme des
diables dans un jeu de quilles ceux-là!" (Jean Perron, 90), quelle
équipe révoltée! Bref, continuez votre boulot comme vous l'entendez
pis longue vie! J'vous dis merde à la puissance 13! J'ai rien
d'autre à ajouter sauf déclarer mon célèbre proverbe: "Tout bon
chrétien se doit de crisser son éternel camp!"! A part de ça rien
de spécial...
...
[Atreid- Ben c'est ça! Trouve-nous ben comique! ;-)]

[Santa- Puisses-tu m'expliquer le sens de ton "éternel" proverbe?
        Je serais comblé à la puissance 13... Merci quand même pour
        ton "généreux" commentaire.]
...
-----------------------------------------------------------------
                ...
                The sendmail bug of the month club
                                OR
...
-----------------------------------------------------------------
     ...
     Oui. Et plus vite que vous pensez... Ceux qui étaient à la
dernière réunion savent à quoi s'attendre pour la troisième, I.E.
le plan d'achat. Eh! oui... Et qu'est-ce qu'on fait quand le stock
est acheté? On fonctionne.

     A la dernière rencontre, beaucoup de choses m'ont surpris.
J'ai vu notamment Mario Cantin, Président, beaucoup moins agressif
qu'à LLC #1. Nous n'avons pas eu droit à la guerre froide entre M.
tout-le-monde qui ne pense qu'à lui et les gens qui veulent que ça
marche... Pourquoi? Parce que M. tout-le-monde n'était pas
invité... 8) Certains ont fait beaucoup d'argent aussi! De nombreux
paris étaient déclarés lors de la "Discussion" sur les Statuts de
LLC: Un sympathique monsieur fumant la pipe, dont je ne veux pas
parler à tort, car Syndic il est devenu, a pratiquement contesté
TOUS les points de la charte! C'était drôle au début, mais vers la
fin, hhhhmmmmmmppppppffffff!

[Atreid- Le mot hhhmmmmmmppppppfffff! prend
 seulement 3 'h' et 5 'f' ! Tu devrais le savoir à ton âge!]
 
     Nous aurons donc droit à une charte quasi-totalement modifiée,
mais qui ne comportera pratiquement aucune ambiguïté. Elle devrait,
selon moi, être publiée dans le prochain magazine.
On a aussi parlé des plans d'achats, vaguement, mais le sujet est
quand même sur la table... Blitz vous en reparlera dans son
article. 


     Quelques figures ont aussi été élues:

     - Président: Mario Cantin
     - Vice-président: Réal Fournier
     - Trésorier: Hervé Lamarre
     - Secrétaire: Dr Claude Blouin
     - Syndics: Vincent Couture
              Me Jean-Louis Renaud


     Si tout se passe bien, vous devriez être emmenés à voter pour
différents plans d'achats lors de la prochaine réunion... Mais
d'ici là, hmm... faîtes ce que vous voulez...
                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
-----------------------------------------------------------------
                         ...
                         A vos Mac, Prêt, Raggez!

                                    par

                                The Shaman

   Plusieurs personnes voient d'un bon oeil la venue de Liberté,
Liberté Chérie dans le paysage cybernétique de Québec, mais
il n'en est pas de même pour plusieurs personnes au sein de la
direction du Club MacIntosh de Québec. 
   
   En fait le président du Club et son vice-président ont lâchement
profité de la tribune que Synapse, le bbs du Club, leur offre,  
pour vilipender l'idée d'une Coop Internet dans le 418. Pour
illustrer mes propos je cite les dires du président lui-même :

" Après certaines vérifications, il semble qu'il est plus que
raisonnable de ne pas se présenter à ces rencontres. Une rencontre 
a eu lieu dernièrement sur le sujet, et la GRC était présente (...)

...Leur but principal serait de contrôler les accès Internet à
Québec pour être capable d'en profiter dans un but pas tout-à-fait
catholique. (...) "

   Ce message n'avait pour seul but que de détruire la crédibilité
de LLC en s'attaquant a ses administrateurs. Il semble que cela ait
fonctionné car la plupart des membres du Club que j'ai contactés ne
toucheraient pas à LLC. Pas même avec une perche de 100 pieds.
  
   Je fût décu quand je lus les lignes qui précèdent mais je
devins littéralement enragé quand je lus ce qui suit. Encore
de la plume de Christian Gingras, président du Club :

"...Comme un accès Internet est très dispendieux, ils tentent
d'attirer des collaborateurs qui paieront avec eux. Ce cette façon,
ils paieront moins cher. (...)

...Et être collaborateur de ces gens, c'est éventuellement
participer à un crime informatique!  "

  Un ramassis d'inepties! Je ne puis figurer que des gens qui sont
sensé diriger un des plus importants regroupements de fans 
d'informatique au pays puissent s'attaquer à la libre entreprise et
...
quelques temps, l'exécutif du Club aurait fait des
démarches dans le but de doter le Club d'une node Internet...
Il est évident qu'il ont essuyé un échec. La jalousie serait-elle
le motif de toutes ces paroles mesquines?  Chers amis, je vous
rappelle que la jalousie est du nombre des péchés capitaux! 

  Mais cela ne restera pas là! Il n'y a pas dans LLC seulement des
"kids" comme moi. Il y a aussi des hommes et des femmes d'âges
mûrs, des médecins, des avocats et des PDG. Ceux-là n'accepteront
pas d'être traités de "criminels informatiques" par quelqu'un qui
parle sans preuves...  

  Je pourrais perdre un temps fou à vous citer les paroles du
SysOp de Synapse ou celles de Stephane-Billy Gousse, le
vice-président du Club. Mais je ne le ferai pas car ils répetent
tous les mêmes histoires.

  Je conclus en vous invitant, si vous êtes membres, à brûler votre
carte de membre et à la faire parvenir au président du club.
Investissez donc dans l'avenir et le progrès. LLC vous permettera
de détruire les dernières frontières qui vous limitent encore a
votre salon.
 
Et à vous, dirigeants du Club... N'hésitez pas à contacter nos
têtes dirigeantes ou même à vous inscrire sur l'un de nos
babillards pour discuter entre protagonistes des deux scènes. Pour
ma part, les portes de mon bbs vous sont ouvertes. Toutes les
informations reliées à mon bbs, qui est réouvert, vous seront
envoyées en même temps que cet article.
...
du nom est Harmonisateur d'Ondes Cérébrales. Elle porte ce nom
parce que c'est bien ce qu'elle est; elle harmonise notre esprit au
niveau qu'on veut bien lui donner. La Mind Machine fait rêver,
halluciner, relaxer, dormir. Elle te pousse aux confins de ton
imagination, de tes sens et de ta concentration.

     Le principe de la Mind Machine est assez simple. Son modèle le
plus commun existe sous la forme d'une paire de lunettes opaques
(style Oakley), avec quatre minuscules LEDs face à chaque oeil. La
Mind Machine est aussi munie d'un simple casque d'écoute comme on
peut en voir sur n'importe quel WalkMan... Les lumières clignotent
à une certaine vitesse et dans les écouteurs, on peut entendre une
série continue de BIPs synchronisés. Pour se servir de la Mind
Machine, on doit s'installer confortablement, mettre les lunettes
et les écouteurs et SE FERMER LES YEUX. Afin d'expliquer le rôle de
ces BIPs et de ces flash, un concept doit être éclairci.


     Chaque neurone de notre cortex vibre pour transmettre sa part
d'information. Ces vibrations sont communément nommées Ondes
Cérébrales. Une vibration rapide permet au cerveau d'être dans un
état alerte, prêt à répondre à des problèmes spécialisés et
compliqués, tandis qu'une vibration lente donne un point de vue
plus global, moins détaillé et moins réfléchi.

     Les Ondes Cérébrales sont regroupées en 4 grandes catégories:
Alpha, Bêta, Thêta et Delta. La vitesse de clignotement s'échelonne
de 1 à 30 Hz. Voici un petit tableau:

Nom    │  Fréquence (Hz)  │   État Psychologique
───────┼───────────────────┼─────────────────────────────────────
Bêta   │      14-30        │ Esprit alerte.
       │                   │
Alpha  │       8-13        │ En général les yeux fermés.    
       │                   │ Relaxé, mais tout de même éveillé.
       │                   │
Thêta  │       4-7         │ Profonde relaxation, premières 
       │                   │ phases du sommeil, rêves éveillés.
       │                   │
Delta  │       1-3         │ Sommeil Profond.
       │                   │


     La Mind Machine sert donc à harmoniser les vibrations de nos
neuronnes au rythme qu'on désire, pour faciliter l'acomplissement
de certaines tâches mentales ou simplement pour la détente.

     Le rôle, pour y revenir, des BIPs et des FLASHs de la Mind
Machine est simple. Selon les études, si vous commencez une séance
en imposant à la Mind Machine un rythme qui se rapproche du rythme
de vibration présent de votre cerveau et que, graduellement, vous
approchez lentement la machine à une autre fréquence de vibration,
votre cerveau sera lentement entraîné vers cette nouvelle
fréquence.

     Par exemple, si vous revenez de travaillez, vous pouvez
supposer que votre cerveau vibre vers les 25 Hz. Vous êtes alerte
à ce moment. Vous avez rendez-vous avec votre blonde à 23h00 et
vous prévoyez une nuit blanche très mouvementée. Comme vous ne
...
vibrations à environ 25 Hz et choisissez un programme qui abaissera
graduellement les vibrations à 2 ou 3 Hz. Trente minutes plus tard,
vous sombrez dans un profond sommeil. Pourquoi? Parce que la Mind
Machine a graduellement abaissé la fréquence de vos ondes
cérébrales au niveau de vibration qu'elles ont en pleine nuit
lorsque vous dormez très profondément. Votre alarme vous réveille
trois ou quatre heures plus tard, en pleine forme pour affronter
une nuit blanche mouvementée, grâce à votre Mind Machine.


LA VISUALISATION
^^^^^^^^^^^^^^^^
     Je dirais que c'est une des abilités les plus intéressantes
que la Mind Machine permet d'acquérir. Visualiser, c'est penser à
quelque chose, un acte ou un objet, et le VOIR.

     Essayez tout de suite tiens. Pensez disons à un avion dans le
ciel. Imaginez-vous cet avion. Vous pouvez bien sûr décrire cet
objet, car vous l'imaginez en ce moment, mais pour la plupart des
gens, l'objet imaginé sera vague, présent seulement par fraction de
seconde. Quelques fois même, vous ne le verrez pas du tout, vous ne
pourrez que savoir que vous êtes en train de penser à cet objet.

     Vous devez tenter de différencier le fait d'imaginer et le
fait de VOIR. Lorsque je parle de visualisation, je parle bien de
la faculté de créer devant soit une image concrète et réelle,
...
différent de la visualisation, du moins lorsque vous avez les  yeux
fermés. En fait, c'est une forme de visualisation. Fermez vos yeux
lors d'un trip de LSD et vous verrez défiler devant vous un
gigantesque kaléidoscope de couleur. Concentrez-vous sur l'avion de
tout à l'heure et vous verrez, du moins pour ceux qui maîtrise
l'effet, l'avion se matérialiser devant vous, avec le ciel
derrière. Imaginez du vent dans ce délicieux ciel bleuté, et vous
sentirez même une légère brise venir effleurer votre visage. Tendez
...
du moins pour les utilisateurs expérimentés. D'ailleurs, la Mind
Machine inculque la visualisation. Ce qui veut dire que, toujours
pour un utilisateur expérimenté, il deviendra possible d'accomplir
...
permanents. La visualisation est une faculté qui s'apprend et la
Mind Machine est un outil de taille pour accélérer cet
apprentissage.

     La visualisation ne s'arrête pas non plus à une hallucination
visuelle. Elle comprend aussi la faculté du touché, de l'odorat,
des sons et du goût, le tout uniquement par l'imagination.
Imaginez-vous en pleine baise et vous voilà parti, imaginez-vous en
train de bouffer une pizza et vous vous mettrez à goûter la pizza.
La faculté de visualisation est gradée en 7 parties. Voilà donc un
autre petit tableau:


┌──────────────────────────────────────────────────────╥────────┐
│ Différents types d'expériences de visualisation      ║  Cote  │
╞══════════════════════════════════════════════════════╬════════╡
│ Parfaitement clair et aussi réaliste qu'une          ║    1   │
│ expérience réelle.                                   ║        │
├──────────────────────────────────────────────────────╫────────┤
│ Très clair et comparable à une expérience réelle     ║    2   │
│ au niveau réaliste.                                  ║        │
├──────────────────────────────────────────────────────╫────────┤
│ Modéremment clair et réaliste                        ║    3   │
├──────────────────────────────────────────────────────╫────────┤
│ Pas très clair et réaliste, mais identifiable        ║    4   │
├──────────────────────────────────────────────────────╫────────┤
│ Vague et non réaliste                                ║    5   │
├──────────────────────────────────────────────────────╫────────┤
│ Si vague et non réaliste que l'image est             ║    6   │
│ difficilement identifiable                           ║        │
├──────────────────────────────────────────────────────╫────────┤
│ Aucune image présente. Tout ce que vous savez, c'est ║    7   │
│ que vous êtes en train de penser à l'objet           ║        │
└──────────────────────────────────────────────────────╨────────┘

     Je dirais que la majorité des gens se situe dans le 6 et le 7.
Avec la Mind Machine, pour un utilisateur expérimenté assisté d'un
spécialiste, il est POSSIBLE d'atteindre la cote 1. Je dis bien
possible, mais à ma connaissance (et elle est limitée ma
connaissance sur ce sujet!), ces cas sont rares. De plus, selon
quelques études, le fait de combiner certaines SMART DRUGS comme la
PIRACETAM avec l'utilisation de la Mind Machine pourrait permettre
d'atteindre des résultats beaucoup plus convaincants (cote 1?).


OU S'EN PROCURER ET A QUEL PRIX?
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

     Il n'existe pour l'instant aucun vendeur dans la région de
Québec, quelques-uns à Montréal (dont je ne connais pas les numéros
de téléphone, malheureusement!).

     J'ai toutefois sous la main le nom d'un centre où il est
possible de faire l'essai, et même de faire des thérapies contre le
stress, pour la visualisation, pour la créativité, etc. 

OVARIUM, Centre d'Éveil de l'être. 514-271-7515
5370, Ave du Parc,
Montréal, QC,
H2V 4G7

Probablement que de là, vous pourrez apprendre où il est possible
de s'en procurer.

Deux autres endroits, où vous pouvez en acheter, mais aux États-
...
bonne qualité est d'environ 350$. Le modèle le plus répandu et le
plus garanti pour sa qualité est le DAVID PARADISE, fabriqué par la
compagnie COMPTRONICS. Le modèle non-programmable à environ 400$ et
le programmable à 695$. Pas la peine de dire que le fait de pouvoir
programmer est très avantageux pour les utilisateurs expérimentés.


FINALEMENT
^^^^^^^^^^
     La Mind Machine n'est que le début. Avec l'avancement de la
...
devenir de plus en plus facile. Et encore, je n'ai pas parlé des
autres produits comme les bains flottants ou les appareils à
stimulation électrique. Il existe aussi quelques logiciels pour PC
qui arrivent à reproduire un peu ce qu'est la Mind Machine. J'en ai
JUSTEMENT un sous la main et en plus, c'est une version SHAREWARE!
Ah! Merveilleux... Pour ne pas courir après les troubles de droits
...
PRIVÉS DE NPC, dont vous pourrez trouver les numéros au début du
magazine. Le nom du programme est FLASHER dans l'archive
FLASHER.ZIP... Pour se servir du programme, vous n'avez qu'à
déterminer la vitesse de clignotement et le type d'image. Je vous
recommande particulièrement la vitesse 7 avec l'image ZETA.
Ensuite, fermez vos yeux et collez-vous la face à 10 centimètres de
l'écran. Essayez quelques fois aussi les yeux ouverts. Bref,
amusez-vous avec ça. Je vous rappelle de laisser tomber si vous
êtes épileptiques, et je ne blague pas! Bien sûr, ce n'est qu'un
avant-goût de la VRAIE Mind Machine, mais quelques de mes amis
l'ont adoré... (N'est-ce pas White Wizard? :]  )

Un fait intéressant en passant... Lorsque vous commencerez à voir
des kaléidoscopes de couleurs (les yeux fermés), ce n'est pas parce
que la lumière envoyée est colorée. C'est dans votre tête que ça se
passe!
...
-----------------------------------------------------------------
           ...
           LLC: C'EST TOUT UN BORDEL D'AMENER INTERNET A QUÉBEC!

                             par Mario Cantin


     Bonjour les amis! Tonton Blitz vient vous livrer les dernières
nouvelles à propos de LLC. Je ne vous parlerai pas de statuts,
d'élections ou de détails administratifs, je vous parle aujourd'hui
du système lui-même et du budget! Tout ce qui vous intéresse, quoi!

     En tout premier lieu, un beau graphique &lt;grin> de LLC, tel
qu'il sera conçu pour desservir 100 usagers. C'est bien important
que vous vous souveniez de cela: CENT USAGERS!


     ║
     ║ Ligne Fonorola de 56 kbps (maximum throughput: 2 gigs/mois)
     ║
     ║
     ║
    ◘◘◘ Modem V-35
...
│
│
░░░ 386-33 usagé          Antenne satellite Pagesat
░░░───────────────────────≡≡≡≡≡≡≡≡≡≡≡
░░░                       ≡≡≡  √  ≡≡≡
...
1) Fonorola nous fournit une 56 kbps (medium), d'une capacité de 2
gigs par mois. Ce sont les deux lignes parallèles qui entrent à
gauche en haut du dessin. Cette ligne, si toutes les conditions
sont observées, nous coûte 600$ par mois (plus 200$ de frais
d'installation de base -one shot-).
     
     Cette ligne entre sur un modem spécial, un V-35, qui coûte
environ $500. Lui même est ensuite connecté sur un router Cisco,
fournit gratuitement par Fonorola. On garde en permanence en 386
(usagé si possible) branché pour contrôler le flot du trafic. On
pourra un jour (dans le futur) installer un autre 386 là pour
servir de site FTP, et un autre (toujours dans le futur) pour ceux
qui voudraient tester leurs capacités de crackers (on installera
Linux full-configuré et vous pourrez essayer d'entrer!). 

     Le router Cisco est lui-même relié à l'ordinateur central de
LLC, plus que probablement un clone SPARC 10 (6,500$ US), à moins
que nous trouvions des commandites à Québec, ce qui est toujours
possible. Nous n'avons cependant pas encore commencé à les chercher
(vous verrez tout à l'heure pourquoi). Il faudra probablement y
...
maniables ainsi: 500$).
     ...
     En bas du Sparc, vous voyez une ligne qui va jusqu'à un 386-25
(usagé), qui va lui-même à un récepteur satellite. Qu'est-ce que ça
fout là? Ben, vous avez déjà entendu parler de Usenet, les
newsgroups d'Internet? Les sites dignes de ce nom les offre tous,
et ça représente de 50 à 80 megs par jour de data. De façon à ne
pas empiéter sur notre bandwith (largeur de bande) et notre
...
bataclan nous reviennent à 2000$ US, et il n'y a pas de frais
d'utilisation la première année. Après deux ans, ça va commencer à
nous coûter environ 30$US par mois...

     A droite du SPARC 10, il y a un serveur de terminal ($3000US),
branché sur 10 modems (10 x 400$US), eux-mêmes branchés sur dix
lignes téléphoniques, une ligne par 10 usagers. C'est par ces
...
usagers sur le système et fermer le système EN DOUCEUR, de façon à
ce qu'il ne plante pas. Prévoyons aussi un 1000$ de programmes, un
tape backup (500$), et quelques gugusses.



2) Faisons un calcul rapide du coût de l'équipement, payable une
seule fois, pour un système de dix lignes et cent usagers.
...
386-16    :    400$ (usagé)
386-25    :    800$ (usagé avec un disque d'un gig)
...
10 modems :    4000$
UPS       :    800$
Divers    :    1000$ (câbles et programmes)
----------------------------------------------------
Total     :    22,800$

Faisons maintenant un rapide calcul du coût de fonctionnement du
système, toujours sur la base de 100 usagers.
...
Local               :    150$ (électricité et chauffage compris) 
-----------------------------------------------------------------
Total               :   1144$

Faisons maintenant un rapide calcul des coûts d'installation du
système, toujours sur la base de 100 usagers.
...
en souvenez, est de 8 x 10$, soit 80$. A cent usagers, ça fait
8000$. Que nous devons utiliser avec parcimonie, car nous devons
être prêts à rembourser les parts sociales n'importe quand, si
quelqu'un quitte la coopérative.

Et le tarif mensuel? Deux tarifs sont encore à l'étude:

-25$ par mois: une heure d'accès dans la tranche de nuit
               deux heures dans la tranche de jour 
               pour un total de 60 points

-35$ par mois: DEUX heures d'accès dans la tranche de nuit
               Quatre heures dans la tranche de jour
               pour un total de 120 points

OK, à ce point-ci, vous avez certainement deux questions: 

a) Comment ça se fait que, contrairement à ce que tu disais, on a
pas un accès ILLIMITÉ?

b) C'est quoi la tranche de jour et la tranche de nuit?

On va répondre tout de suite aux deux questions. Suivez-moi bien et
vous allez tout comprendre.

     Nous avons fait un mini-sondage auprès de certains d'entre
vous, et l'écrasante majorité prévoient d'utiliser le système entre
17 heures et une heure du matin. Nous avons donc divisé la journée
en deux tranches:

Tranche A: de 3 heures du matin à 17 heures (durée: 14 heures)
Tranche B: de 17 heures à 3 heures (durée: 10 heures)

     A chaque fois que vous allez payer votre cotisation mensuelle,
vous allez recevoir 60 ou 120 points, dépendant du tarif choisi. UN
point correspond à une heure dans la tranche A, et à la moitié dans
la tranche B. Ce calcul prévaut même pour la fin de semaine.

     Maintenant, supposons que les 100 usagers prennent le tarif de
35$, qui représente 2 heures dans la tranche B. Nous parlons de la
tranche de soir, parce que nous savons pertinemment que la majorité
d'entre vous allez effectuer vos appels à ce moment. Une ligne va
...
théorie, être desservis dans la tranche de nuit. 50% des gens vont
pouvoir appeler dans la tranche B. Si maintenant on donnait 3
heures, 4 heures, ou un accès illimité, combien de personnes
pourraient se prévaloir, dans la tranche de nuit, des services de
LLC? Moins de 50%, that's for sure! Et mon bottom line, à moi,
c'est de tenter de donner un bon service à au moins 50% du monde...
En bas de d'ça, le jeu n'en vaut plus la chandelle. Voilà pourquoi
on ne peut pas décemment permettre, du moins au début, aux gens
d'avoir plus de 2 heures d'accès dans la tranche B. Ceci dit, les
gens qui appellent de jour vont pouvoir, à titre de récompense,
utiliser deux fois plus de temps. Ce qui va nous permettre,
probablement, de faire grimper le taux de satisfaction à 60 ou 70%
(ou plus encore, qui sait). 

     Mais, allez-vous me dire (si vous avez compris l'explication
précédente), pourquoi ne pas mettre plus de dix lignes de
téléphone? Pourquoi ce ratio de dix usagers par ligne? Simple,
c'est une question de coût: nous avons calculé, tout à l'heure,
combien il en coûtait pour partir le système, combien il en coûtait
pour acheter l'équipement, et quels seraient les frais mensuels
pour le faire fonctionner. car n'oublions pas que rajouter une
ligne, c'est rajouter une carte Ethernet, rajouter un modem,
rajouter... 

     Mais combien va nous rapporter le système?

Toujours sur une base de 100 usagers, calculez qu'il y en aura 50%
à 25$ et 50% à 35$. Ce qui fait:
...
22,800$ d'équipement emprunté à la banque à 8% = 1824$ d'intérêt

Ce qui veut dire qu'au bout d'un an, on est encore 2952$ dans le
trou. En gros, si on est ben chanceux, on réussit à peine à payer
l'équipement en 1 an.

En effet, on a nos parts sociales (8000$), qui servent à payer
l'installation (1331$) et le déficit de la première année (2952$),
ce qui nous laisse "dans le noir" de 3717$. C'est pas les chars,
mais c'est ça... Et cet argent sert à rembourser 46 parts sociales
si 46 membres nous quittent dans la première année.

     Bien sûr. il y aura peut-être quelques usagers corporatifs, ça
et là, et on va peut-être se faire commanditer la machine, et on va
aussi permettre aux gens de payer pour six mois ou douze mois (avec
une réduction à la clé, parce que ça va nous permettre d'emprunter
...
de téléphone pour dix personnes, et on ne peut pas, par conséquent,
permettre à quelqu'un d'être plus que deux heures en ligne dans la
tranche de nuit. Jusqu'à ce que le système soit payé... A partir de
là...

3) Limitations du système:

     On en a déjà vu une, de limitation, et une embêtante à part çà
(pour les gens qui passent plus de deux heures par soir sur
Internet, ce qui n'est tout de même pas la majorité, heureusement).
Mais on a un autre problème en vue: le throughput... Voyez-vous, la
ligne que Fonorola nous fait à un prix d'ami (conditionnel aux deux
autres 56 kbps, mais nous y reviendrons) est une 56 médium, comme
ils disent, avec une vitesse de 22 Kb\s, et un throughput (débit)
MAXIMUM de 2000 Megs par mois. 2 Gigs par mois, c'est pas beaucoup.
Juste le service Usenet complet représente 50 megs PAR JOUR
(minimum). Un mois (30 jours) de Usenet représenteraient à eux
...
pensé libérer la bande de Usenet en le recevant par satellite, avec
le service Pagesat. On a vraiment pas le choix. 

     Et encore là, faisons un calcul rapide: 2000 megs par mois, je
...
passante par mois. Divisez par cent usagers, ça veut donc dire que
chaque usager aura droit, AU MAXIMUM, à 15 megs par mois de
download SUR INTERNET. C'est comme pas beaucoup. Même que, pour
être safe, on devrait se garder une marge de sécurité et imposer
une limite de 12 megs par usager. 

     ATTENTION! Ces douze megs ne représentent pas votre limite
personnelle de download du système de LLC à chez vous! Uniquement
ce qu'on peut aller chercher sur la ligne de Fonorola. Ce qui nous
fait dire qu'il va impérativement falloir mettre nos ressources en
...
un coup d'oeil avant de downloader quelque chose à partir
d'Internet, pour voir s'il n'y est pas. 

Exemple: Je veux aller sur un ordi de la NASA chercher la dernière
...
Je reviens sur LLC (ça prend deux secondes), ou je consulte la
...
paquet n'est pas déjà sur LLC, je le ramasse, je l'amène chez LLC,
j'en fait une copie dans la section publique, et le tour est joué.
Ca s'appelle mettre nos ressources en commun, et c'est ce qu'on va
être obligés de faire, si on ne veut pas défoncer notre débit
maximum autorisé. Exemple: au lieu que chaque usager downloade sa
propre copie de Phrack 44 (600K x 100 usagers= 60 megs), un seul va
le chercher et l'amener sur LLC, où tous les autres peuvent aller
le chercher gratuitement, sans empiéter sur leur 12 megs. 

     Mais, me demanderez-vous, qu'arrive-t-il si on défonce notre
limite? Si on défonce notre limite de 2 gigs par mois, Fonorola
nous facture au prix d'une 56 high, ce qui représente, au mieux,
une sur-facturation de 1200$. Mais ceci est encore en négociation
avec Fonorola. 

     Encore là, cette situation ne durera que le temps que notre
matériel soit payé et qu'on puisse investir dans une ligne plus
puissante. D'un autre côté, ça nous garantit quasiment qu'on aura
pas affaire à des warez puppies sur le système, parce que 12 megs
de jeux, c'est pas beaucoup. Et puis, cette situation n'affecte en
rien ceux qui font du IRC, ou tout autre service, à l'exception du
FTP.

     Des limitations de temps, des limitations de download, c'est
plus Liberté Liberté Chérie!, c'est Liberté Liberté Conditionnelle!
Que voulez-vous, si on continue à pratiquer des tarifs populaires
(et, personnellement, je ne reviendrai pas là-dessus), on va
s'offrir le système qu'on est capable de se payer, et on
l'améliorera à mesure que nos dettes disparaîtront.

                           --------------------

     Je vous le jure, c'est tout un casse-tête que de tenter de
partir ce machin-là! Surtout que, souvenez-vous, pour bénéficier de
la 56 commanditée par Fonorola, il faut refourguer deux autres 56
au prix régulier! Je vous avais proposé de prendre à ma charge ces
deux foutues 56 kbps, à condition que je me déniche une vingtaine
de slips mais, au moment où j'écris ces lignes, je n'en ai guère la
moitié... et je ne suis pas très optimiste de ce côté-là.

     Quel bordel! Mais, vous me connaissez, têtu que je suis, je
vais trouver une autre solution... Il FAUT trouver une autre
solution. Quelle qu'elle soit, la seule chose que je peux vous
garantir, c'est une communauté cybernétique où vous aurez accès
pour pas cher. Pour le reste, la coopérative, Fonorola, et tout le
bataclan, pour moi tout est négociable. Je vous en reparle (mieux!
Je vous arrive avec des RÉSULTATS! Enfin... j'espère...) dans le
prochain NPC. D'ici là, on va sûrement se voir en assemblée ou se
consulter by phone...

     Enfin, ma propre expérience me dit que le système devrait
normalement être ouvert vers le 1er février (avec un mois de retard
sur mon précédent pronostic, mais vous comprendrez qu'il y a un
paquet de travail encore à effectuer), si on est chanceux.
...
-----------------------------------------------------------------
                ...
                The state of Hacking in Quebec City
                                by:
                          Gurney Halleck
...
-----------------------------------------------------------------
                      ...
                      Ce que WIRED n'a pas publié...

                            Intro de Blitzkreig

     Le dernier numéro de Wired ((1.6) publiait un petit texte sur
les 7 merveilles du monde techonolique. Pour la circonstance, ils
avaient demandé à un paquet d'écrivains, de chercheurs, de gurus de
l'info de donner leur opinion. Ils n'en ont publié que quelques-
uns. Nous avons réussi à mettre la main sur les autres... Les
voici, en primeur, en exclusivité, en ce que vous voulez. Des
textes de Nicolas Negroponte, de Arthur C. Clarke, et de plusieurs
autres. Des textes inédits. Qui d'autre que NPC pour vous les
offrir?
...
society, and in proving it he became one of the greatest, if
...
[Atreid- Ah! L'enquête se poursuit qu'il dit. C'est la phrase clé
que les coches utilisent pour dire, en clair, que l'affaire est à
peu près close, qu'elle n'avance pas, qu'ils sont payés à ne rien
faire, etc.]
           ...
           Leeched from POPULAR SCIENCE - Décembre 1993
...
[Paranoid- Peut-être que cet article va mettre fin à des rumeurs
...
[Paranoid- Bon! Enfin une bonne raison de hacker le Videoway ;-)]
       ...
       Leeched from LE JOURNAL DE QUÉBEC - Samedi 10 octobre 1991

                   LE PIRATAGE: UNE PRATIQUE RÉPANDUE

                           par Yves Thériault

     L'importante saisie de systèmes d'exploitation d'ordinateurs
effectuée par la GRC dans les quatre succursales de la compagnie
Microbec, plus tôt cette semaine, n'a guère surpris les experts
de la vente informatique au détail, industrie où tous les moyens
sont bons pour conserver ou augmenter sa part de marché.
...
réalisée au Québec (environ 300 000$ de matériel), s'est répandue
comme une traînée de poudre à travers l'est de la province.

     «Qu'ils soient de Thetford Mines ou de Baie-Comeau, tous mes
clients n'avaient que ce sujet de conversation. Ils voulaient
davantage d'informations sur cette affaire», a confié un
représentant oeuvrant pour un concurrent de Microbec.

     Ce même informateur, qui a demandé de taire son identité, a
confirmé ce que le journal avait avait appris de diverses autres
sources, à savoir que le piratage de logiciels était une pratique
répandue dans cette industrie. «La concurrence est tellement
féroce entre les détaillants que la plupart d'entre eux n'ont
d'autre choix que d'emboîter le pas.»

     «Je ne suis absolument pas surpris que Microsoft ait porté
plainte, a déclaré un autre intervenant. Ces dernier temps, il y
avait des compagnies qui allaient vraiment trop loin.»

     Il semble que ce soit surtout les compagnies se spécialisant
dans la vente de produits compatibles, communément appelés
"clones" et destinés au consommateur privé, qui usent le plus de
pratiques douteuses. «Celles qui distribuent les produits des
marques reconnues, comme IBM, ou qui s'adressent à une clientèle
institutionnelle ne peuvent se permettre de tricher», a expliqué
un représentant.

     Les personnes consultées ont aussi fait remarquer que le
piratage des logiciels ne serait pas une pratique aussi répandue
sans le consentement tacite et, dans une certaine mesure, la
complicité des utilisateurs. «Quand un client achète un système
d'exploitation d'ordinateur accompagné d'un logiciel dont le
guide d'utilisation est photocopié ou déjà usagé, il sait
pertinemment qu'il s'agit d'un logiciel pirate.»
      ...
      Leeched from LE JOURNAL DE QUÉBEC - Mardi 20 mars 1990

    DES LOGICIELS PIRATES EN USAGE DANS LE RÉSEAU DES AFFAIRES
                             SOCIALES

                       par Michel Marsolais

MONTRÉAL ── Au moins six intstitutions du réseau des affaires
sociales sont en possession de copies illégales d'un logiciel
américain utilisé dans les systèmes de paie. Au cours d'une
vérification, six établissements, dont trois CLSC, présentaient
des logiciels BLAST avec des numéros de série identiques.

     La vérification a été faite à la suite d'allégations d'un
ex-employé de Logibec, la firme qui a installé ces logiciels chez
les clients en question. Sur dix établissements joints, six
présentaient le même numéro de série, soit le 0396740010.

     Quant aux autres établissements interrogés, un centre
d'accueil a refusé de répondre, deux affirment ne pas être en
possession du logiciel en question et un CLSC présentait un
numéro différent.

     Un numéro de série unique doit obligatoirement être fourni
par le détaillant avec le logiciel pour prouver qu'il s'agit d'un
média original. La GRC a été saisie du dossier, vendredi dernier.

     Les établissements dont les numéros de série du logiciel
BLAST étaient identiques sont le Service de réadaptation du
Sud-Ouest, à Châteauguay, le CLSC la Saline, à Chandler, le CLSC
Mitis, à Mont-Joli, le Centre d'accueil Longueuil, le Centre
hospitalier Sherbrooke et le CLSC l'Estuaire, à Rimouski.

     BLAST est une entreprise de Baton Rouge, en Louisiane, dont
le logiciel est largement utilisé au Québec pour la paie. Le
logiciel en question se détaille autour de 995$ US, soit environ
1300$ CA chacun.

     Bien que l'entreprise de Baton Rouge reconnaisse que chaque
client devraiit posséder un numéro de série différent, le
vice-président, M. Ted Bordellon, n'a pas voulu commenter la
situation pour le moment, mais l'a qualifiée de sérieuse.

                       Pointe de l'iceberg?

     Au ministère de la Santé et des Services sociaux, on ignore
l'ampleur du phénomène, car chaque institution est responsable de
ses achats à l'intérieur de son cadre budgétaire. «Nous ne
faisons que donner l'autorisation pour ce genre d'achat», assure
Lauriane Collin, du ministère. Il s'agit toutefois d'un secret de
Polichinelle que plusieurs utilisateurs - y compris des
fonctionnaires gouvernementaux - emploient des logiciels copiés,
même si c'est parfois à leur insu.

     L'entreprise Logibec avait fait l'objet d'une perquisition
de la GRC, en février [1990], relativement aux allégations de
...
encore été portée.
       ...
       SURVEILLANCE ÉLECTRONIQUE CONTRE LE PROGRES CIVIQUE?

                        par Robert Fleury

QUÉBEC ── Le bureau des conseillers de l'opposition se croit
victime de surveillance électronique à l'hôtel de ville. Une
lettre sera adressée en ce sens au directeur général Denis de
Belleval.

     «Cela fait un certain temps que nous avons des doutes. Quand
nous répondons au téléphone, nous entendons parfois des déclics
suspects. Nous avions un document très confidentiel dans un
classeur barré à clef et le classeur était ouvert quand je suis
entrée ce matin. Mais le pire, c'est que nous avons découvert 12
virus sur notre ordinateur», commente Claire Vaillancourt,
attachée politique des conseillers du Progrès civique.

     «Nous avons fait venir un expert en informatique de
l'extérieur    

[Atreid- Probablement un spécialiste du Club MacIntosh!]

     et il nous affirme que les virus n'ont pu être
introduits qu'en insérant une disquette à cet effet. Tous les
logiciels que nous utilisons sont des originaux, ça ne peut venir
des nôtres...», affirme Mme Vaillancourt qui craint maintenant de
passer pour une paranoïaque à devoir se tenir sur ses gardes.

     «Nous avons fait changer toutes nos serrures

[Atreid- Comme BELL CANADA! ]

     et nous adressons une lettre au directeur général de la ville
pour qu'il procède à des vérifications», dit l'attachée après
consultation avec l'état major du parti.

     Le directeur général s'est dit surpris d'être informé par le
journaliste du contenu d'une lettre qu'il n'a pas encore reçue,
mais promet qu'il fera enquête.

     «Écoutez, si je reçois une plainte en ce sens, je ferai
faire une enquête, que ce soit auprès de Bell, de nos services
informatiques ou de la police. C'est la première fois que
j'entends parler d'une affaire comme ça depuis que je suis en
fonction», commente Denis de Belleval.

     Au bureau du maire de Québec et chef du Rassemblement
populaire, on invite les représentants de l'opposition «à
transmettre leurs allégations au plus tôt au service de police
pour qu'il puisse faire enquête».
 ...
 MALGRÉ LA LOI D'ACCES A L'INFORMATION, LA CENSURE FÉDÉRALE CACHE
                       EMCORE DES DOCUMENTS

                        par Gilles Paquin

     Un avocat montréalais qui tente de faire la lumière sur les
directives que le cabinet Trudeau donnait à la GRC pour lutter
contre le "mouvement séparatiste" devra s'adresser à la Cour
fédérale pour se prévaloir de son droit d'accès à l'information.

     «Depuis le début de l'an dernier, j'ai formulé de nombreuses
requêtes en vue d'obtenir des procès-verbaux des réunions du
cabinet et de ses comités, mais on me remet toujours des
documents censurés», affirme, preuves à l'appui, Me Pierre
Cloutier, du Centre de recherche sur la sécurité et le
renseignement de Montréal.

     Selon lui, la loi fédérale d'accès à l'information est
pourtant très claire: tous les documents et procès-verbaux du
cabinet et de ses comités, à quelques exceptions près, deviennent
publics après 20 ans. Or la réalité est fort différente, soutient
Me Cloutier.

     «Des fonctionnaires anonymes décident, de façon tout-à-fait
arbitraire et en prenant tout leur temps, de ce qui doit être
dévoilé au bon peuple», 

[Atreid- Est-ce moi qui est précosse où il le fait exprès?]

     ajoute l'avocat. Il a lui-même reçu des
documents tellement censurés qu'ils contenaient plus de pages
blanches que de textes.

     Pour illustrer son propos, Me Cloutier a remis à 'La Presse'
des copies de procès-verbaux des réunions du cabinet qui lui ont
été transmises par le bureau d'accès à l'information du Conseil
privé après de longues démarches. Il en a reçu trois versions au
fil des mois, ce qui lui a permis de découvrir, petit à petit,
une partie de ce qu'on cherche à lui cacher.

                      Une histoire sinueuse

     Toute l'affaire a commencé lorsque Me Cloutier a formulé une
demande d'accès à l'information au Conseil privé, en mars 1992,
après avoir lu dans 'La Presse' que certains documents du cabinet
et de la Commission McDonald étaient maintenant du domaine
public.

     Un mois plus tard, il reçoit une copie censurée d'un mémoire
sur "le séparatisme au Québec" rédigé le 17 décembre 1969 par le
premier ministre du temps, Pierre Elliott Trudeau, à l'intention
du comité sur la sécurité et le renseignement du cabinet. On lui
transmet également un procès-verbal expurgé de la réunion tenue
par ce comité deux jours plus tard dans le but d'étudier cette
question.

     «Selon les témoignages entendus à huis-clos par la
Commission d'enquête McDonald sur les activités illégales de la
GRC six ans plus tard, c'est en s'appuyant sur ce document que le
comité a alors élaboré le mandat secret de la force policière
fédérale visant à faire face à la menace séparatiste», soutient
M. Cloutier.

     Cherchant à en savoir davantage, Me Cloutier présente alors,
à la fin avril, une deuxième demande sur le même sujet. La
réponse ne se fait pas attendre, cette fois il reçoit quelques
jours plus tard de nouvelles copies des mêmes textes plus
censurés que les premiers.

     Dépité, il écrit alors au Commissaire à l'accès à
l'information du Canada, fin mai 1992, pour exiger des
explications ainsi qu'une version intégrale de ces documents. Le
5 juin suivant, on lui répond simplement que sa requête a été
confiée à un enquêteur de la Commission. Puis le temps passe.

     Finalement, le 14 septembre dernier, le bureau d'accès à
l'information du Conseil privé lui expédie une troisième version,
moins censurée, des deux textes litigieux. Il en manque encore
des grands passages note l'avocat, ainsi présentés ces documents
demeurent souvent mystérieux.

     «J'ai maintenant décidé d'écrire à nouveau au Commissaire
...
fédérale», dit Me Cloutier.

     Selon lui, si les documents étaient complets il serait
peut-être possible de percer l'énigme qui persiste au sujet des
ordres transmis au service de sécurité de la GRC dans sa lutte
contre le "mouvement séparatise". Il se demande même si la
censure ne cherche pas à cacher des décisions inavouables, voire
même illégales du cabinet.

     «En tenant compte de tout ce qui s'est passé au cours des
années suivantes, soit le vol des listes de membres du PQ par la
GRC, les vols de dynamite perpétrés par ses agents et une foule
d'autres activités illégales révélées par les commissions Keable
et McDonald, on a de bonnes raisons de se poser des questions»,
dit Me Cloutier.

     Il aimerait bien savoir également qui sont ces censeurs qui
charcutent les documents publics avant de les remettre aux
citoyens qui font des recherches sur les administrations
précédentes. Certains de leurs coups de ciseaux sont étranges,
dit-il, d'autres sont peut-être complices.

     Lorsqu'on compare les trois versions des textes transmis à
Me Cloutier, force est de reconnaître que les censeurs manquaient
parfois de suite dans les idées et cachaient même des choses
révélées dans des documents officiels.
   ...
   ANTI-DRUG UNIT OF C.I.A. SENT TON OF COCAINE TO U.S. IN 1990
     ...
     WASHINGTON, Nov. 19 ── A Central Intelligence Agency
...
force was headed by Gen. Ramón Guillén D vila, and that the
...
attaché in Venezuela, Annabelle Grimm, to discuss a proposal to
...
McFarlin of the C.I.A. and General Guillén had gone ahead anyway.
...
the C.I.A. officer and his colleague, General Guillén.
...
against General Guillén, the United States might have to cut off
...
although General Guillén has been subpoenaed to appear before a
...
MONTREAL ── Pierre Falardeau's film about the 1970 FLQ
...
Libération du Québec. Gigantes had received a copy of the script,
...
MOSCOW ── Computer hackers nearly succeeded in stealing $75.4
...
investigating.
     ...
     Avec la mise en marché de photocopieuses couleur de plus en
plus sophistiquées, les fraudeurs semblent s'en donner à coeur
joie: la contrefaçon de chèques de compagnie aurait rapporté, au
Canada seulement, la somme rondelette de 2 milliards de dollars
cette année. Cela représente une augmentation de 63% des fraudes du
genre par rapport à l'année précédente.

     Mais la défense s'organise: l'entreprise Data Formules
d'affaires a mis au point un logiciel appelé Laserfront et qui, par
la façon dont il imprime les chiffres, rend pratiquement impossible
l'altération de ces derniers une fois qu'ils sont imprimés sur un
chèque. 

     Data Formules d'affaires jouit d'un certain respect dans les
milieux financiers et autres car elle dispose de toute l'expérience
acquise par l'ex-multinationale Burroughs dans le domaine de la
lutte contre la fraude par copiage ou altération de chèques.

     Elle a en effet acquis et absorbé la filiale canadienne de
Burroughs lorsque cette dernière a connu des difficultés
financières. (Il faut rappeler ici que c'est Burroughs qui, en
1980, mettait au point la première machine permettant d'imprimer le
montant et de signer des chèques).

     Le logiciel Laserfront, disons-le tout de suite, n'est pas bon
marché. Il se vend, nous dit-on, entre deux 2 et 3 000$ et cela,
même si le principe selon lequel il fonctionne demeure assez
simple.

     En effet, Laserfront imprime les chiffres de façon
alphanumérique, c'est-à-dire qu'il imprime le chiffre numérique
lui-même sur un fond composé d'une série de représentations du même
chiffre écrit en toutes lettres (anglaises, pour l'instant).

[Atreid- Deux à trois milles dollars pour faire ÇA?]

     Ainsi le chiffre 8 apparait sur un champ de petits "eight". On
voit tout de suite le genre de problème auquel un fraudeur aurait
à faire face s'il décidait, par exemple, de changer le 8 en 9.

     Le logiciel Laserfont peut être utilisé par tout appareil PC
rattaché à une imprimante laser. Data Formules d'affaires offre
aussi à ses clients des fromules de chèques sur papier spécial qui
contient une trame le protégeant contre toute copie en couleur.

     Jean-Guy Paquette, porte-parole de l'entreprise, nous assure
que dès qu'une tentative est faite de photocopier un chèque émis
sur ce papier... les mots "Faux" "Void" ou "Nullo" apparaissent sur
le chèque, le rendant inutilisable. (...)

                                  - 30 -

[Blitz- ca devient comme une habitude, n'est-ce pas, ces compagnies
de "sécurité" qui présentent des produits à des prix défiant
l'imagination. En gros, Laserfont, ce n'est que celà, un "font". Un
font de dix chiffres, de 0 à 9, qui coûte 2500$!!! Et puis,
Paquette et son papier spécial peuvent probablement aller se
rhabiller: les photocopieurs lasers sont de bien meilleur qualité
aujourd'hui et leur tramage "magique" doit en prendre pour son
rhume. En tous cas, moi, je demande à voir!]
...
référence à la seconde guerre, qui prouve combien les gens
peuvent si bien cacher les choses, lorcequ'elles tournent à leurs
avantages.

     CHURCHILL SAVAIT-IL QUE LE JAPON SE PRÉPARAIT A ATTAQUER PEARL
                                 HARBOR?
                                    
LONDRES(AP)- Winston Churchill savait-il à l'avance que le Japon
se préparait à attaquer Pearl Harbor? Les archives des services
secrets britanniques rendues publiques, jeudi 25 Novembre 1993,
ne répondent pas à cette interrogation. Elles révèlent en
revanche que le premier-ministre britannique n'ignorait pas
l'existence des camps d'extermination nazis dès 1942.

La publication de ces documents intervient dans le cadre de la
politique de transparence voulue par l'hôte du 10, Downing
Street, John Mayor. Historiens et chercheurs ont ainsi pu se
plonger, hier, dans 1273 dossiers jusqu'alors tenus secrets,
relatifs aux années 1941 et 1942.

Si certains attendaient beaucoup de ces archives pour éclairer
des zones d'ombres de l'histoire, le Bureau des archives
publiques (PRO) s'est chargé de calmer leurs ardeurs: "Aucun
document n'indique clairement que des sources britanniques
étaient au courant de l'attaque japonaise sur Pearl Harbor, même
s'il était prévisible que le Japon allait entrer dans la guerre",
souligne-t-il dans un communiqué.

Le PRO ajoute toutefois que, "les historiens, après une étude
détaillée de ce matériel, pourraient parvenir à une conclusion
différente".

Pas un des documents rendus publics, jeudi, ne fait directement
allusion à l'attaque par des avions embarqués japonais de la base
Américaine de Pearl Harbor, aux premières heures du 7 décembre
1941. Cette agression nippone s'était soldée par la mort de 2400
personnes et la perte par les Américains de 120 avions et 19
navires.

Dans un ouvrage intitulé "Trahison à Pearl Harbor" (Betrayal et
Pearl Harbor), James Rusbridger et Eric Nave affirment que les
services secrets britanniques détenaient la clé des codes
japonais de première importance et ont pu intercepter des signaux
annonçant une attaque imminente sur Pearl Harbor.

Déchiffreur australien, Eric Nave avait décrypté plusieurs codes
secrets japonais avant et après le conflit. Il est décédé en
Juillet dernier.

L'un des documents consultables depuis Jeudi est un message daté
du 4 décembre 1941 et barré de la mention "Ultra Secret". Il
s'agit d'un ordre du ministère japonais des Affaires étrangères
appelant l'embassadeur du Japon à Washington à détruire tous les
codes secrets. Trois jours plus tard, la principale base
américaine de l'archipel d'Hawaii était attaquée et les États-
Unis entraient à leur tour dans ce nouveau conflit mondial.

Le rapport relatif aux activités de la police allemande date du
26 septembre 1942 et comprend des chiffres précis sur le nombre
de morts dans les camps nazis au mois d'août de cette année:
"Niederhagen 21; Auschwitz 6829 hommes, 1525 femmes; Flossenburg
88; Buchenwald 74." 

Ce document fait référence à une demande de main-d'oeuvre
prévoyant l'envoi de 1000 prisonniers d'Auschwitz dans des
chantiers ferroviaires. Il est précisé que ce contingent n'a pu
être envoyé en raison D'une "interdiction", apparemment une
quarantaine, frappant les occupants de ce camp. "Bien que le
typhus fasse toujours rage à Auschwitz, il semble que les
arrivées se poursuivent", peut-on lire dans ce rapport qu'avait
lu Winston Churchill.

Un autre rapport provenant de l'ambassadeur japonais à Berlin et
daté du 29 novembre 1941 cite le ministre allemand des Affaires
étrangères Joachim Von Ribbentrop: "Le fuhrer, dit-il, croyait
que la situation était mauvaise en Grande-Bretagne et pensait
qu'à la suite des opérations allemandes à venir, elle pourrait
être battue sans être envahie." Il était également signalé, chez
...
more widespread than security officials had acknowledged.
     ...
     au conformisme de l'Amerique, à l'époque d'Eisenhower. Dans les 
...
[Atreid- Terminator 2? Robocop?]
     ...
     valable peut éventuellement tomber entre les mains de gens qui
     en feront un meilleur usage, malgré les efforts de la
     censure, des copyright légaux et du service secret.

     TOUJOURS CEDER A L'IMPERATIF DE S'INFILTRER. Les Cyberpunks 
     maintiennent qu'ils peuvent mener la planète pour le mieux si
     seulement ils peuvent mettre la main sur la boîte de contrôle.

     PROMOUVOIR LA CENTRALISATION. La société se disperse en centaines 
     de sous-cultures et de sectes, ce qui est stupide.(1)

     'SURF THE EDGES'. Lorsque le monde change à chaque nanoseconde,
     ...
     - et le reste de l'univers - pour le prochain siècle. 

       (1) Il semble que ces quelques lignes diffèrent du texte original.
           ...
           a été sûrement ajouté. Le texte original est passé entre
