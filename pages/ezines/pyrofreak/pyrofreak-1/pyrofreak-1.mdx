...
m'habituer avec ce nom de zine la. Bon assez plaisantΘ maintenant.
...
ground (surtout au QuΘbec mais aussi dans tout autres endroit ou ca parle
...
Deuxiement, a qui cet zine s'adresse t'elle?:
                  Pyrofreakmag s'adresse α tous les gens qui veulent 
apprendre, cΘ clair et simple.


Troisiement, a quelle frΘquence va etre distribuer Pyrofrakmag?:
...
phreaker, vous avez eux tord. Meme si on reprend frphreak, on a dΘcider
de parler de underground en gΘnΘral, et non seulement du phreak.
...
2:DiskBomb                                             endrix
3:NumΘros intΘressant de tΘlΘphone AmΘricain           Neuro
...
Petite dΘfinition de la VMB: C'est une boite vocale,  qui est situΘe sur
un rΘseau (Compagnie, commerce, autres).

Comment trouver une VMB local?

Rien de plus simple, je vous explique quelques techniques.

1- Regarder dans le botin tΘlΘphonique.
       
   Comment trouver une VMB dans le botin tΘlΘphonique?
       ...
       des spΘcialistes de cet etablissement, c'est qui a surement un reseau
       de VMB.
    
   Ya aussi un deuxieme moyen qui est un peu plus complexe, mais on obtient
   de meilleurs rΘsultats. Je vous explique le principe. Le numero de tele-
   ...
   l'exemple-ci qui serait de 454-9818 α 454-9828. Vous avez de bonne chance
   de trouver un rΘseau de VMB qui est associer a la banque. Ceux-ci sont
   intΘressant, car 80% du temps elle contienne un systeme de PBX. Pour ceux
   ...
   , je vous conseille le *67, pour Θviter les callback.


   Ya deux avantages, et un dΘsavantage sur les VMBs local.
   ...
   Avantage #2: Vous pouvez mettre en application le Social Engenering parce
                ...
                qui vous reste a faire, cΘ d'Aller dans le botin tΘlΘphonique
  ...
  DΘsavantage #1: Pour rejoindre la boite vocale, ou pour que des gens la
...
liser le help (J'Ai l'impression d'avoir dΘja vu cette phrase ailleur :)).
Je vais vous donner quelques sΘries de numeros a scanner, qui ont un bon
pourcentage de VMB.
...
des compagnies, et prennent pas le temps de vΘrifier le numero, et ca bien
sur si y'on la possibiliter. 

Quand hacker,scanner les VMBs?

CΘ simple, apres 21h et avant 7h am, vous risquez moins de rejoindre une 
tΘlΘphoniste.
...
0318
8130
Un autre type de password par dΘfaut est d'essayer de 1945 a 1980, parce que
ya beaucoup de monde qui mette leur annΘe de naissance.


Ou et quand composer le password?

             Cela dΘpend du system auquel vous avez affaire. Dans tout les
cas, vous dever attendre que la VMB dΘclenche avant de faire quelque chose.
Quand le message d'intro dΘmarre, appuyer sur ## ou ** ou *0 ou 81 ou #,
ou autre chose semblable a ca (*7,*1,*4). La il y a une demoiselle qui va
vous demander d'insΘrer le numero de la boite vocale ainsi que le password
...
D'apres mon expΘrience, si vous avez un bon "cerveau", en moins de une heure
vous parviendriez a hacker une VMB. En passant, si vous hacker une sysAdmin,
(La box qui controle tout le rΘseau), vous pouvez creer a votre guise des
...
==                                                                    ==
========================================================================
=Tu habites en outaouais et tu as les Θditions prΘcΘdentes de 2600 ??? =
...
essayΘ sur mon vieux testeur de trojans, virus.. mon vieu boy(486 - 44)
Ca marche trΦs bien, ya meme fallut que je charge mon floppy colisse...
Alors suivez tout a la lettre dans ce zine et vous allez pourvoir en faire
sur les ordinateurs de votre Θcole ... :))) mouhhahhahaah !!!!
...
- Un ordi a ton Θcole           (pour le ...testing...)
...
1- PremiΦrement, il faut ouvrir la disquette DOUCEMENT !!!! Il faut faire 
   attention que le plastique ne casse pas,  sinon ca va Ωtre plus dur la
   refermer ...

2- Quant tu ouvres la disquette, tu vas voir 2 morceau de coton blanc pour
   empΩcher que le disque en tournant touche le plastique. Enleve-les ...
...
6- Mettre du souffre sur le vernie a ongle(qui est sur le disque) et essayer de 
   le faire des 2 bords. C'est juste plus efficase mais c'est pas nΘcessaire. 
...
8- Attendre que le vernie soie complΦtement sΦche ... Et aprΦs se trouvΘ un ordi
   sible, mettre la disquette dedans, l'allumer et PARTIRRRRRR !!!!!

9- Quand l'ordi va booter, il va pensΘ que c'est un boot disk(heehe) et il va lire
   dessus. QUand le disque va tourner, le souffre va brulΘ et ansi va la vie ...
...
hey bien ... J'espΦre pour vous que l'ordinateur ne brulera pas !!! =P 
...
'.________  __ __ ___________ ____ ______________ ____ ___ ______ __ __
NumΘros intΘressant de tΘlΘphone AmΘricain. 
Par Neuro

Voici quelques numeros de telephone que j'ai dΘcouvert dans un zine 
anglophone, vous pouvez peut-etre trouver une UtilitΘe a ceux-ci.
...
|              supΘrieur a un vol de vΘhicule (automobile,etc.)? 
'.________  __ __ ___________ ____ ______________ ____ ___ ______ __ __
Fini le trashing, allons y pour la poste!!!  

Vous avez besoin de numero de carte de crΘdit? Vous avez besoin d'information
...
Je vous explique mon aventure!!
    ...
    C'Θtais en un beau vendredi apres-midi. Je recois l'Appel de quelqu'un,
me disant ceci.
...
&lt;Neuro> Hello
&lt;Bobby> Slu
&lt;Bobby> Hey mec, ca te tante tu de fΩter a soir?
&lt;Neuro> Pourquoi pas!
&lt;Bobby> il y a un mΘga party chez nous, d'la bieres des filles, pis la musik
&lt;Bobby> Juste 10$ l'entrer, pis t'amene ton stuck si tu veux fumer.
&lt;Neuro> Ouais, cΘ intΘressant, mais...
...
Apres avoir eu ce tΘlΘphone, fallais que je trouve du cash. Je me suis mis a
penser. Durant que je pensais, J'entendis le facteur dΘposer les lettres dans
...
C'est quoi??? Une carte disant Joyeux Noel? De l'argent pour me fΘliciter
d'etre aussi gentil? J'ouvre la lettre, hΘ oui, j'avais bien raison, une 
lettre accompagner d'un beau billet de 50$. Mon problΦme Θtais rΘsolu.
...
une journer. Je vous explique comment procΘder.
...
est intΘressant dans la boite a malle de la victime.

Soit:
Relever de carte de crΘdit.
Envellope normal
Petit colis.
Votre Revue prΘfΘrer de la semaine.
Et tout autres affaire que vous juger intΘressant.

Dans un relever de carte de crΘdit, vous avez le numero de la carte, nom de 
...
date d'Expiration une a une. Vous avez juste 48 possibilitΘs, vu qu'habitu-
ellement, la date d'expiration est 4 ans apres l'entrer en vigueur de la 
carte. Essayer de trouver tout autres informations intΘressantes, mais 
essayer de vous faire discret, en laissant quelques envelloppes dans la boite
a malle, pour pas que le propriΘtaire de celle-ci s'en apercoive trop
rapidement.
...
Voici d'Autre temps durant l'annΘe ou c'est assez payant.
...
Si vous etes chanceux vous risquer meme de ramasser une vrai carte de crΘdit.
...
propriΘtaire ne sait pas qu'elle est en ce moment actif. Vous avez environ
3 jours pour la vider!!

Pour ceux qui sont plus bati, et qui aime travailler en Θquipe de 2 ou 3.
Je vous conseille de vous attaquer au boite rouge de Poste Canada, (Celle
pour l'extΘrieur de votre rΘgion, parce que le monde envois de l'argent en 
cadeau quand c'est trop loin de chez-eux). Je vous explique le principe.
Vous prΘparer votre coup pour un dimanche soir, parce que ca fais plus qu'une
...
un poid qui est assez considΘrable, d'apres mon expΘrience, qui est pres de
...
a devenir intΘressant.

Conclusion:

J'ai dΘja essayer de dΘfoncer une boite verte (Ca Θquivaut a toutes les 
boites rouge d'un quartier (environ 10), c'est tres tres tres rΘsistant, et
meme avec de l'acide a 90% ca ne peut marcher, car il a un espace entre la 
porte et la serrure. Dans le #2 je vais essayer d'etre plus prΘcis en mettant
...
|           qui ont ΘtΘ distribuer au public en francais depuis 1993,
|     Correspond a l'Θquivalent d'un dictionaire en longueur de texte?
|                              Soit 2000 pages!!!
'.________  __ __ ___________ ____ ______________ ____ ___ ______ __ __
Le dΘmΘrol
Par Neuro

DΘja en lisant le titre de cet article, vous avez plusieurs questions en tete: 
Qu'est-ce que le dΘmΘrol? A quoi ca sert le dΘmΘrol? Comment en tirer profit?
J'ai rΘponse a vos questions dans les prochaines lignes.


Qu'est ce que le DΘmΘrol et a quoi sert-il?

	Le dΘmΘrol est un mΘdicament tres puissant. Il sert a enlever la douleur.
On appele cette catΘgorie de MΘdicament, des anti-douleur (Θvidamment). Dans
cette meme classe on retrouve la morphine et l'hΘroine (Celle-ci n'est plus
vraiment utiliser de nos jours contre la douleur, a cause de sa dΘpendance 
quel entraine). Le dΘmΘrol est utiliser comme anti-douleur juste avant la
morphine, ce qui veut dire que celui-ci est tres puissant, mais bien entendu
moins que la morphine.

Avantage du dΘmΘrol a la morphine:

-Cout moins ΘlΘver
-Peut etre sous forme de pilule a avaler
-Les mΘdecins les prescrive plus facilement que la morphine, qui celle-ci 
 est quasi improcurable si vous n'etes pas hospitaliser.
-DΘpendance moins Θlever

Comment en tirer profit?

Je vous explique le principe. Vous voulez tripper sans avoir de grosse 
dΘpense. Et vous voulez tripper assez fort. La solution, le dΘmΘrol.
Vous aller chez un mΘdecin "dΘbutant" (Qui en passant sont plus facile a 
...
avez dΘja eu ce probleme auparavant, et le medecin qui vous avais suivi vous
avait prescris du dΘmΘrol. La, il va vous examiner un peu, et dans sa tete,
il va penser vous prescrire du dΘmΘrol pour suivre son confrere. 
...
dΘmΘrol.Le cout est d'environ 25$, mais si vous etes assurer, le cout rΘduit
considΘrablement, et peut etre meme gratuit.Serait-ce une facon de frauder
le gouvernement?? 
...
cΘ assurer. Le buzz dure environ 2h et cela de facon intense. Vous allez 
etre parti dans les nuages, cΘ le cas de le dire.
...
avertir que le dΘmΘrol entraine une dΘpendance. Apres 4 ou 5 expΘrience, 
...
Attention: Prener pas plus que 3 pilules de 50 mg, dΦs votre premier trip,
           parce que vous risqueriez de le regretter.
Attention: Le dΘmΘrol engage une dΘpendance tres importante.
Attention: Il cause de la sommenolance, facque conduisez pas.

Bon c'Θtais l'idΘe principal que je voulais passer a travers ce texte. Pour
conclure, je voudrais dire que le dΘmΘrol existe sous forme d'injection, soit
...
cas c'est le medecin lui meme qui l'injecte. 
               ...
               //en absence de dΘmΘrol je n'avais pas d'alcool//
                          CrΘdit: Jean Leloup
 ____ __ _ _ _______________ ________ ________ __PyroFreak Magazine #1
...
d'achat favoris. Tout-α-coup vous avez les larmes aux yeux, et vous n'etes
...
40 ml d'acide muriatique 20%  (HCL)
	On retrouve l'acide muriatique α la quincaillerie du coin, dans la
...
Vous mΘlanger c'est 3 produit ensemble dans une bouteille 2 litres de 
...
d'achat, et vous vider votre bouteille dans une poubelle. En moins de 5 α 10
...
de merde yΘ fou si il reste assis la plus que 2 minutes. 
...
Cela est un truc que moi-meme j'Ai dΘcouvert en faisant du peroxyde
d'acΘtone dans ma maison. Faite attention , si il y a des petits bΘbΘs
...
l'ΘtΘ ou autre moment que les fenetres sont ouvertes. Pour une plus grande
...
Pour conclure: La yΘ 5h30 du matin, j'ai un cours "d'Θducation physique"
dans 1h30, pis chu ben saoul et cela sans avoir dormi de la nuit. Bizzare
c'est quand je suis saoul que j'ai des idΘes pour mes articles.


La yΘ rendu 10h am de la meme journer, pis je me suis fais crisser dehors de
mon cours pour l'anner, spa grave c'Θtais poche.
...
je l'aurais pas fait, vous auriez rien compris. Amuser vous bien.
 ...
 ____ __ _ _ _______________ ________ ________ __PyroFreak Magazine #1
:
|        Un numero a essayer au Quebec sans vraiment une utilitΘe
|                                320-0048
|
'.________  __ __ ___________ ____ ______________ ____ ___ ______ __ __
...
- -──┼─────────────────────────────────────┬───────────────-- - ·
 ...
 Hey bien, voici a une Θdition par moi, endrix, sur le web page hacking. 
AprΦs avoir lu ce texte, vous devriez Ωtre capable de modifier une page 
selon vous le dΘsirez mais certaines conditions s'appliquent. Je n'ai 
pas Θcrit ca pour que tout le monde commence a hacker tout le monde. 
...
pouvez m'envoyer un email α lordendrix@hotmail.com ou sur mIRC, sur les 
...
site web α l'addresse suivante : Http://endrix.cjb.net. Si vous possΘdez 
...
Have fun !!!
 ...
 PremiΦrement, il faut savoir quelque matiΦre de base avant faire tout ca.
...
utiliser un ftp, mais si vous Ωtez un internet wizzard, skipper cette section
au plus sacran !!! Bon, pour mettre un site sur l'internet, il faut un serveur
qui est connectΘ 24h sur 24h sur l'internet et qui offre un service de web 
hosting comme : 
...
monde entier !! AprΦs que votre page web est fait(index.html) il faut 
...
l'offre. Je vous conseille malgrΘ cela, de toujours le faire par FTP. il y a 
plusieurs ftp sur le marchΘ du web mais je vous suggΦre d'utiliser le plus
connu : CuteFTP. Il est facile a utiliser et trΦs complet. Allez le cherchez
α http://www.tucows.com et pour l'enregistrer, emailer moi... Donc, une fois
installΘ cuteftp, connectez-vous a votre serveur. Si vous Ωtes a xoom, dans 
le host marquez : ftp.xoom.com, votre nom d'usager et le mot de passe. 
Une fois connectΘ, vous pouvez envoyer tout vos fichiers sur le net sans 
difficultΘ. 
...
DΘmarrer, ExΘcuter et Θcrire "command" et clicker sur "Enter". Une fenΩtre va 
apparaitre(MS-DOS) : 
...
Il faut Ωtre dans le c:\win98>. Alors tapez c:\win98\bureau>cd..
...
pour faire plusieur choses.. chatter, vΘrifiez ces emails, uploader sont site web,
.... Faites ca : 
...
what tha  ???? La, vous Ωtes conenctΘ a un serveur whois.internic.net qui vous
...
d'aprΦs ce qu'a donnΘ ca, le domain worldhacking.com est hostΘ par le serveur 
...
heehe le fameux fichier que tout le monde aimerais avoir !!! Et bien, j'ai trouvΘ
...
- Changement d'email 
- Partage de fichier
- Exploit de linux par un trou de sΘcuritΘ
...
sont le password encryptΘ. Pour le dΘcrypter, il faut un programme. Le meilleur que je connaisse
...
PortScanner : Ce programme va servir α scanner un IP(xxx.xxx.xxx.1 α xxx.xxx.xxx.255)
              et trouver des personnes qui sont infectΘ par un trojan.
...
Avec des trojans, il y a deux maniere que j'ai trouvΘ. Avec un trojan et permet de voir
les cached passwords(DeepBO) ou avec un qui donne accΦss au HD(Disque dur). DeepBO est un
trojan, qui quand tu es connectΘ, il permet de te montrer les passwords que la personne
...
trouvΘ une personne qui est infectΘ et a une page web avec geocities... quand tu vas faire 
voir les cached passwords, ca va te donner les passwords et les usernames ... tu peux aussi
infectΘ le web master d'un site web si tu veux en fesant du se .... Avec netbus ?!? Et bien, 
cette maniere va marcher avec n'importe quel trojan qui permet d'avoir access au HD de 
l'utilisateur du PC. Si la personne a CuteFTP, dans sont rΘpertoire, il y a un fichier qui
se nomme smdata.dat Ce fichier contient les informations des ftp que la personne a mit dans 
sont bookmark. Tu peux voir le user name, le host mais le password est encryptΘ. Voici la 
clΘ de dΘcryption pour CuteFTP : 
...
ou bien, vous avez juste a tΘlΘcharger le fichier smdata.dat et le remplacer par celui que
vous avez en ce moment dans cotre CuteFTP a vous. Maintenant, vous avez juste a ouvrir votre
cuteftp et vous connectΘ au ftp du mec et modifier ca page web a votre guise ...
...
travaille la.... de vous faire confiance et de vous donnez des informations trΦs importante
qui vons vous permettre d'accomplir votre but avec succΦs !! Si vous voullez le fichier
smdata.dat vous avez juste a faire un petit scΘnario comme celui-ci :
...
&lt;vous> il faut que j'update mon site au plustot mais ma soeur ou mon pere ont du touchΘ a
...
DCC send = smdata.dat
&lt;vous> si tu Θtais a c⌠tΘ de moi, je te donnerait un gros bec !!!
&lt;vous> merci, merci beaucoup !!!
&lt;victime> np
&lt;vous> tiens, t'ira voir mon travail dans 20 minutes α : http://www.domaine.com
...
ca peut Ωtre trΦs long car, il y a des word lists, et contiennent comme 10000 mots... mais
il s'agit de trouvΘ une bonne word list et ca risque de marcher a tout coup !!! Voici quelque
...
Bien cette technique, a ΘtΘ il y a trΦs longtemp dΘcouvert mais il y a encore 5% des serveurs
qui n'on pas changer leurs programmes et qui sont vulnΘrable. Cette maniere, est une des plus
...
entrer vos coordonΘes, le nom d'utilisateur et le mot de passe. Pour activer votre compte,
il faut aller voir vos emails et avec votre password, activΘ le compte. Donc, pour commencer
il vous faut avoir un email qui est presque pareille que le web master du site. AprΦs, allez
sur le site de votre web hosting, aller dans aide et faitez un changement d'adresse email. 
Quand ceci va Ωtre fais, demander pour vous envoyez le mot de passe a votre nouveau car, vous
...
rΘseaux, vous jouez a des jeux comme, Starcraft, Quake, Doom, Duke 3D, Blood.... Mais aprΦs
quand vous avez finnit, vous allez mettre le HD de votre ami en partage de fichier(qui te 
donne accΦss au HD de ton chu) et tu vas chercher des fichiers cool, des jeux, ou meme des 
logs de mIRC ... AprΦs avoir fait tout ca, vous partez, mais doooooohh !!! Tu as oublier
de copier des fichiers...GRRRrrrrrrr !!!! Tu peux pas lui demander parce que tu n'es pas 
supposΘ avec ces fichiers... alors quand il va Ωtre sur le Net, tu vas le voir tu dit
salut, blah, blah ... Tu prends sont IP(/dns nick). PremiΦrement, il faut vΘrifier s'il
l'a autΘ.. comment !!!!???? Ouvrez une fenΩtre dos(DΘmarrer, ExecutΘ tappez command et 
peser sur enter).
...
bon, allez dans votre rΘpertoire de windows, c:\win98\bureau>cd..
c:\win98>
...
pas la, vous ne pourrez jamais, au grand jamais, vous connecter α cet ordinateur. 
...
Ceci va crΘe le fichier lmhosts avec tout les choses dedant pour faire fonctionner 
le hack. Si le lmhosts n'est pas la, ou est mal Θcrit, rien de vais marcher. Et 
voila, il ne vous reste qu'α rester le cache du netbios en tappant la command suivante :
...
Bon, apres avoir fait ca, vous pouvez voir quel drives vous avez accΦss. D'apres celui-ci, 
le A, le C, le D sont en partage donc, vour pouvez avoir accΦss au A, C et D. Pour vous 
...
Et bien la, vous Ωtes connectΘ sur l'ordinateur du mec. Maintenant vous pouvez 
...
Hey bien pour cette section je ne vais que montrer un exploit trΦs cunnu 
qui a comme fonction de faire un bug dans le systΦme et vous donnez le r00t 
du Pc. Cet exploit de nomme : 
SendMail v8.8.4
il crΘe un programme dans le /tmp/x qui donne le root apres ...
...
ces exploits !!!
            ...
            maniere que je n'ai pas penssΘ, faites moi le
            savoir !!!
...
|                                /timer1 off
|                   Pour ceux qui avaient pas pensΘ a ce truc
'.________  __ __ ___________ ____ ______________ ____ ___ ______ __ __
Qui sont-ils ?
Par [G]r4FX
...
l'informatique. Ces lois sont Θtablies par chaque pays, cela pose un problΦme 
car Internet est accessible α tous les habitants de la planΦte et certains 
actes sont des infractions pour les uns mais pas obligatoirement pour les 
autres. (Informatique et LibertΘ).  Le pirate est une personne qui viole les 
droits d'autrui ou des sociΘtΘs α son profit. Les pirates les plus communs 
sont les hackers, les crackers et toute personne copiant du software pour son 
utilisation personnelle ou pour la vente.  Nous laisserons de c⌠tΘ la copie 
de software, pour nous intΘresser de plus prΦs α ceux qui veulent prendre le 
contr⌠le d'un systΦme informatique alors qu'ils n'y sont pas autorisΘs. 



Hackers.

Le hacker est une personne qui rentre dans un systΦme informatique en sautant 
les barriΦres de protection (Le roi des hackers), souvent par dΘfi 
intellectuel et pas toujours par profit matΘriel. Certains ne font que 
visiter le systΦme causant, malgrΘ tout, la panique des services de sΘcuritΘ. 
D'autres hackers appelΘs parfois crackers sont beaucoup plus actifs; ils 
pΘnΦtrent un systΦme et en dΘtΘriorent le software en le modifiant, en le 
dΘtruisant, en lui implantant un virus, etc.  Un exemple simple de " cracking 
" pourrait Ωtre celui de changer un lien (" link ") par une autre sans en 
changer le nom.  C'est α dire une personne qui voudrait rentrer pour 
connaεtre les offres d'une banque serait renvoyΘe sur un autre site. 


 
Les hackers sont-ils dangereux? 

Outre le fait qu'une attaque de hackers peut endommager ou dΘtruire votre 
software, hackers ou crackers peuvent aussi violer l'intimitΘ de n'importe 
quel citoyen. Beaucoup de personnes ont dans leur ordinateur ou dans celui de 
leur entreprise une grande partie de leur vie personnelle : accΦs aux comptes 
en banque, courrier Θlectronique qu'il soit personnel ou professionnel, 
etc...Une attaque de hackers peut donc se traduire par une destruction de ces 
donnΘes ou pire par une utilisation frauduleuse et α votre insu de celles-ci. 



Comment procΦdent-ils? 

Certains pirates rΘussissent α rentrer dans un rΘseau en utilisant un code 
d'entrΘe ( mot de passe ). Ils essaient, d'abord, de se renseigner sur le 
nombre de caractΦres possibles dans le code. Ensuite, ils tentent, par 
l'intermΘdiaire d'un programme de leur fabrication, tous les codes possibles 
par rapport au nombre de caractΦres obtenus auparavant et ce  jusqu'au 
succΦs.  Une autre mΘthode est la suivante: les pirates recherchent des 
informations personnelles sur le propriΘtaire du systΦme qu'ils veulent 
visiter. Les statistiques dΘmontrent que la plupart des personnes prennent 
leurs donnΘes personnelles comme code d'entrΘe dans leur ordinateur. (nom de 
leurs enfants, date de naissance, etc...). Alors, les hackers essayent 
diffΘrentes combinaisons avec ces donnΘes.  Il n'est bien entendu pas 
possible de recenser toutes les mΘthodes, l'imagination des hackers est sans 
bornes. 
...
De la Une du New York Times aux journaux tΘlΘvisΘs diffusΘes aux heures de 
grande Θcoute, tous les mΘdias ont retenu du 3 novembre 1988 l'arrivΘe d'un 
virus qui a paralysΘ pendant plusieurs jours la quasi totalitΘ des centres de 
calcul universitaires et de recherche des Etats-Unis.  L'auteur Robert Tappan 
Morris a ΘtΘ condamnΘ par le tribunal de Syracuse USA α 400 heures de " 
service communautaire ", α trois ans de surveillance judiciaire et α 10 000 
dollars d'amende.   C'est la diffusion fulgurante du virus qui constitue la 
caractΘristique la plus Θtonnante de l'action du " ver " de Robert T.  
Morris. Les premiers signes de l'ΘpidΘmie sont apparus presque simultanΘment 
sur les c⌠tes Est et Ouest. A une demi-heure d'intervalle, le Massachusetts 
Institute of Technology ( MIT ) et la Rand Corporation se trouvaient 
infectΘs, le 2 novembre 1988 vers dix-huit heures. Le lendemain, des 
centaines de Vax, des stations Sun ainsi que d'autre machines fonctionnant 
sous Unix Θtaient elles aussi touchΘes. Les opΘrateurs relevaient des temps 
de rΘponse fortement dΘgradΘs, leurs machines Θtant surchargΘes de travail 
par l'exΘcution simultanΘe d'une multitude de tΓches qui renaissaient 
spontanΘment en dΘpit des efforts visant α les Θliminer. Pire, une machine 
arrΩtΘe puis redΘmarrΘe se trouvait instantanΘment contaminΘe. En tout cas, 
l'importance du fuck up provoquΘe par Robert T. Morris en ce " jeudi noir " a 
dΘmontrΘ que, contrairement α ce que l'ont pense, les minis et moyens 
systΦmes fonctionnant sous Unix ne sont pas plus α l'abri des "ΘpidΘmies 
informatiques " que les micro-ordinateurs.  


Internet, le rΘseau attaquΘ, relie entre elles toutes les universitΘs 
amΘricaines et des milliers de sites. Son premier r⌠le reste l'acheminement 
du courrier Θlectronique des enseignants, des chercheurs et mΩme des 
Θtudiants, ce qui reprΘsente une population de plusieurs millions d'usagers. 
Le mΩme rΘseau autorise le transfert de fichiers et l'ouvertures de sessions 
" console " sur des machines distantes. 
Sit⌠t l'attaque dΘtectΘe, les meilleurs chercheurs d'outre-Atlantique se sont
empressΘs de la combattre. Il leur a fallu deux jours pour dΘmontrer le 
mΘcanisme du ver. Un programme composΘ d'une centaine de lignes de C couplΘ α 
deux fichiers " objet " (l'un propre aux serveurs Vax et l'autre aux stations 
Sun) constituaient le vecteur d'infection. Aussit⌠t entrΘ dans un 
calculateur, le " Morris worm " Θtablissait la liste des autres machines 
connectΘes au mΩme noeud du rΘseau et consacrait alors toutes les ressources 
de la machine nouvellement conquise α la contamination des autres postes. 

Un des processus de l'attaque consistait en une routine de craquage des " 
mots de passe " (Comment font-ils?), remarquable pour sa vitesse. C'est α 
cette tΓche que le ver dΘpensait la plus grande partie du temps de travail 
des machines colonisΘes. 

     
Pour se dΘfendre, le ver maintenait son propre code sous forme cryptΘ 
(cryptage). Et pour dΘcourager les tentatives visant α le dΘsassembler, il 
changeait rΘguliΦrement de numΘro de processus se rendant plus difficile α 
dΘceler. MalgrΘ tout, l'infection restait somme toute bΘnigne puisqu'elle ne 
dΘtruisait aucune donnΘe.  Pour mΘmoire, notons que le pΦre de l'Θtudiant 
facΘtieux compte parmi les plus grands experts amΘricains de la sΘcuritΘ 
informatique. Nul doute que R.T Morris suive le mΩme chemin.  Il est α noter 
que les responsables de la sΘcuritΘ ont su tirer les leτons de la 
mΘsaventure. Dix ans aprΦs, une infection de cette envergure ne semble plus 
possible. 



Le roi des hackers ( d'aprΦs la revue espagnole Web ) 


Kevin Mitnick est le hors-la-loi le plus cΘlΦbre d'aujourd'hui.  SurnommΘ par 
la presse le roi des hackers, il a ΘtΘ arrΩtΘ par Tsutomu Shimomura et 
l'histoire nous est racontΘe par un journaliste tΘmoin de l'aventure John 
Markoff sur http://www.takedown.com/.  Deux pirates informatiques ont menacΘ 
de dΘtruire des millions d'ordinateurs si les autoritΘs ne relΓchaient pas 
Kevin Mitnick, incarcΘrΘ il y a deux ans pour Ωtre entrΘ dans diffΘrents 
ordinateurs. Il a volΘ les codes secrets de quelques milliers de cartes 
tΘlΘphoniques et accΘdΘ virtuellement α une base de missiles, entre autres. 
Les deux pirates, qui se sont appelΘs eux-mΩmes " Pants/Hagis ", ont accΘdΘ 
au serveur du populaire moteur de recherche Yahoo ! Et y ont laissΘ un 
message menaτant : "tous ceux qui ont utilisΘ le mois dernier le moteur de 
recherches Yahoo ! ont attrapΘ une bombe logique qui s'activera le jour de 
Noδl 1998, semant le chaos dans tous les rΘseaux informatiques du monde ". Et 
ils ont ajoutΘ qu'ils ne donneraient l'antidote uniquement si Mitnick, 
condamnΘ ni plus ni moins qu' α 35 ans de prison, Θtait libΘrΘ. Le 
porte-parole de Yahoo! Diane Hunt, a reconnu que des hackers Θtaient rentrΘs 
dans la page de l'entreprise mais sans rien dΘtruire. Elle a ajoutΘ que " il 
est impossible que les ordinateurs s'Θtant connectΘs au serveur soient 
infectΘs ". C'est en effet ce qui s'est passΘ, et la bombe imaginΘe par les 
pirates n'a pas explosΘ. Mais le fait de sensibiliser l'opinion au cas 
Mitnick avait ΘtΘ rΘussi.   Qui est K. Mitnick ? Comme hacker sa carriΦre a 
commencΘ α 16 ans quand, obsΘdΘ par les rΘseaux informatiques, il a forcΘ la 
barriΦre de sΘcuritΘ du systΦme administratif de son collΦge. Pour Kevin, le 
passetemps de ses dix derniΦres annΘes fut d'explorer et exploiter les 
compteurs d'autrui et les systΦmes tΘlΘphoniques. Sa profession ? " cracker 
", et sans aucun doute trΦs bon. Selon le DΘpartement de Justice des Etats 
Unis, ce " terroriste Θlectronique " connu sous le nom de " El Condor ", a 
ΘtΘ capable de crΘer des numΘros de tΘlΘphones impossibles α facturer, de 
s'approprier 20000 cartes de crΘdit d'habitants de la Californie, d'Θchapper 
au FBI pendant plus de deux ans avec comme outil seulement un tΘlΘphone 
cellulaire et un ordinateur portable. 


Mitnick avait dΘjα ΘtΘ arrΩtΘ en 1988 pour avoir envahi le systΦme de Digital 
Equipment. Il fut dΘclarΘ coupable du chef d'accusation suivant "fraude 
utilisant des ordinateurs", et pour possession illΘgale de codes d'accΦs de 
longue distance. Il fut alors incarcΘrΘ puis privΘ de tΘlΘphone par la Cour 
car, selon eux, il Θtait capable d'accΘder et de prendre le contr⌠le
d'un ordinateur avec un simple tΘlΘphone!


Credit: e-zines Anglais et Espagnol dΘjα publier.
...
1-  Un Hacker crois en la liberter de l'information et que l'Θchange de cette
information en toute libertΘ est essentielle au bon fonctionnement d'une
sociΘtΘ.  Cet dans l'Θthic du Hacker de faire partager son savoir en Θcrivant
des "Software" gratuit pour que cette information soit lu par le plus de 
personne possible.  En plus, un Hacker doit faciliter l'acces α cette 
information par les "soft" qu'il a Θcrit et de faciliter l'acces de partout
au ressources informatiser.

2-  Un Hacker croit aussi que le "cracking" d'un systeme informatik pour 
le plaisir et pour la curiositΘ est Θthiquement correct, tant et aussi 
longtemsp longtemps que le "cracker" ne commets aucun vol vandalisme, ou
un "breach" de confidentialitΘ.  Ces deux principes Θthics normatif sont 
acceptΘ par par plusieurs Hackers en grande partie mais ce ne sont pas
tous.  La plupard des Hckers adΦrent a l'Θthic vu en (1).  

Le sense numΘro 2 est tres contreversΘ: il y a des hackers qui disent 
...
J'espere que vous avez aimΘ le #1 de pyrofreakmag , si ce n'est pas le cas,
lisez pas le #2 parce que il va etre semblable. Si vous dΘsirer faire publier
...
numero, on va peut-etre faire une FAQ, cela va dΘpendre si on a beaucoup de
