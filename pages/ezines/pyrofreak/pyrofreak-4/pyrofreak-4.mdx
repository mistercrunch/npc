...
```
-::- La meilleur religion c'est croire en sois mΩme!!!
...
Plusieurs graphiques que Endrix produit, sont affichΘs sur le site. Ils sont
updater plusieurs fois par mois. Allez voir ca!!!!!!

Si vous voulez que votre article paraisse dans le #5, envoyez le α
...
'.________ __ __ ___________ ____ ______________ ____ ___ ______ __ __
         ...
         8- SystΦme GSM pour les cel       SlasHerZ

         9- La Theorie Du Phreaking de 
            Cellulaire Analogique          SlasHerZ
            
         10- Pipe bomb α la moi!!!!!       endrix
...
Extras =   - Porte Bouteille α la Pyro-Phreakers par CyberRider (13ko)
...
└ Venir par endrix : - Initiation au Basic
                     ...
                     - Initiation α l'assembleur dos


================================================= SpΘcial !!!!

J'aimerais bien dire a tout le monde, en lisant, de prendre quelques secondes pour
penser α un de mes chums qui est mort il y a 2 jours avant d'avoir Θcrit ceci. Il est
mort d'une overdose....
...
Vous avez, ou allez peut-Ωtre remarquer que notre zine est mieux orthographiΘ...et 
...
PS: Toi le petit con assis devant ton ordinateur en train d'examiner ce zine pour
    trouver le plus de dΘfauts possibles, personnelement, je t'emmerde. Dis toi
    que ce n'est pas une obligation d'Θcrire un zine sur l'Underground, mais 
...
-=-=-=-=-=-=-=-=-=-=-=-
-Remerciments spΘciaux-
-=-=-=-=-=-=-=-=-=-=-=-

└ date, tout au long de notre existence, nous avons reτus de l'aide
mais  nous  n'avons jamais pris le temps de remercier les personnes 
responsablent   pour  l'amΘlioration   de  ce  e-zine qui est rendu
...
Et oui... Depuis HAQCH, nous commencons α recevoir  de plus en plus
de suggestions, de compliments, de commentaires pour nous amΘliorer
Merci en particulier SnowCrash de m'avoir remontΘ le moral un peu ;)
...
nous sommes pas encore au "top", mais je suis s√r que partis comme nous 
sommes en ce moment, c'est sur que nos zines ne vont que s'amΘliorer et 
j'espΦre  un  jour    Ωtre   plus  populaire  que  nous  le  sommes.
...
La plupart des hacks d'aujourd'hui sont fait α partir des "bugs" des
serveurs et/ou une mal configuration du systΦme. C'est donc pourquoi
j'ai dΘcidΘ d'Θcrire un article sur quelques unes de ces attaques, 
mais bien sur, les Crews de sΘcuritΘ comme, rhino9, Technotronics...
En savent que personne connait. Les attaques que je vais montrer, pour
quelques unes, sont trΦs connues mais pour d'autres un peu moins......
Ce sont des attaques en exploitant le CGI (Common Gateway Interface)
d'un serveur Unix/NT. C'est trΦs simple a rΘaliser mais moins simple de le trouver.
...
»»»»»»»»   souvent aussi fait en C. Avec cette commande, il est possible 
           ...
           empΩche d'exploiter le test- cgi. 

Normalement, le test.cgi est situΘ dans le rΘpertoire suivant :
...
QUERY_STRING = Ici, seront lister tout les rΘpertoires
               »»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»»
...
Pour se promener dans les rΘpertoires, il ne s'agit que d'ajouter le /*rΘp*/
aprΦs le /*
...
informations sur une machine sans avoir α entrer dedans ;) Je sais pas 
encore si c'est illΘgal de faire ca.. Si vous le savez, svp, 
...
Le PHF est un bug que presque tous les ordinateurs ont rΘglΘs mais, il 
en reste encore quelques uns qui sont vulnΘrables α cette attaque. Le CGI 
est normalement placΘ dans www.serveur.com/cgi-bin/phf.cgi. Voici quelques 
facons trΦs simple d'exploiter ce Bug :
...
Mais en plus de pouvoir prendre le etc/passwd, vous pouvez avoir accΦs
aux autres fichiers et mΩme les exΘcuter sur le serveur sans avoir α Ωtre devant.

http://www.serveur.com/cgi-bin/phf?Qalias=x%0a/bin/ls%20/

Ceci permet de voir le dir listing et pouvoir exΘcuter des programmes surla machine

-

Ceci est pour avoir un accΦs COMPLET α la machine... /root ;)

http://www.serveur.com/cgi-bin/phf?Qalias=x%0a/bin/ls%20/bin

- 

AprΦs avoir eu le root, vous pouvez mΩme voir les permitions des fichiers et rΘpertoires !!!
...
Conclusion :
»»»»»»»»»»»»
Bon, alors j'espΦre que vous avez bien aimΘ ca et... faites pas de conneries ;)))
...
Ok le Sat hacking n'est pas tres tres rΘpandu au quebec est pas tres tres pratiquΘ 
un peu partout!! Dans le fond jai decider decrire la dessus parce que c'est pas full 
connu pis on en parle pas dans la moitiΘ des zines fake st'un bon sujet a faire quand 
ta rien a ecrire.
...
On a mis une echostar α c⌠tΘ d'une expressvu et α cotΘ d'une dss.. qui remporte la 
...
qui est dans s'te zip la nommΘ dss.zip kewl?? ok c'est kewl!! Ensuite tu te prend une 
bonne biΦre froide car ca va peut-Ωtre etre necessaire faut bien se refroidir les 
neuronnes. Refroidir ca veut pas dire de fumer un bat non plus la tsΘ!! bon ok that's kewl??? 

ok aussi il te faut une carte p2 H serie de dss sinon tu peut bien 
sure rien faire avec cette merde!! ok si tu as une F card hmmm desolΘ, try again later. 
Les f card c'est depassΘ tu peux juste ecouter les postes de musique avec ca alors... 
hmmm fouille sur le net pour un programme nommΘ tornado32. De toute facon avec ces infos, 
ta carte va Ωtre full ca c'est sure !! Aussi, il vous faut des progs pour shooter les 
infos sur la carte. Moi le best des best que je vous suggere est 
Winexplorer, ils sont rendus α la version 3.5.! Pour le dΘnicher tu vas sur www.dr7.com 
&lt;http://www.dr7.com/> 

Dans dss tool il va y avoir dautre tool mais winexplorer = the best !

Bon, vu que je possΦde winexplorer mon article sera donc expliquΘ en fonction de Winexplorer.
...
ok aprΦs avoir shooter un clean, se qui efface toute la carte... Nous allons mettre 26 
...
suite. Maintenant votre carte est supposΘe Ωtre a 26 update! Alors quand ca a fini 
de shooter le file dans la boite du log c'est supposer Ωtre Θcrit quelque chose 
...
ca prend une autre machine qu'un proggramer de carte. DΘsoler c'est pas de ma faute !!
ok jusqu'ici tout va bien!!

Bon, on va continuer α shooter des choses sur notre carte!! avant de continuer on va 
ouvrir le hole 09 de la carte pour pouvoir programmer Bon on shoot τa sur la carte!!
...
on le shoot c'est tout! bon maintenant la carte est complΦtement vide on en est sure. 
Bon, maintenant nous allons envoyer un fichier da'ctivation que jaime beaucoup c'est 
normal y'ai conτu par moi ;)) Il expire en avril 2005 donc vous allez avoir beaucoup 
de plaisir α ecouter la tv ;)) pis c'est τa, mais ca ne vous donne que 650$ de location 
...
Maintenant la carte est activΘe! youpi!! dΦs que vous la metterez dans un receiver 
...
ok! Que la carte marche ou pas c'est pas mon problΦme. Une carte normal devrais 
marcher aprΦs tous ca! Si vous ne voyez aucune image mais avec toutes les postes, 
c'est parce qu'il y a eu avant sur votre carte, un 3m mal dΘsinstallΘ(un 3m passe 
par dessus tout, il y a pas d'expiration et tu payas pas les film, c'est comme un 
decodeur pirate.) Alors, essayez d'aller dΘsinstaller votre 3m dans vortex! C'est 
...
voulez savoir comment toute rΘavoir votre cash dans les pay per view hein!! ok shootez 
...
seulement marcher avec win explorer car il est scriptΘ pour win explorer. Tout au 
long de son dΘroulement il sera entiΦrement customizable..... c'est cool hein!! 
Bon essaye ca.
...
Super comme fichier non?? entk y'ai super jai trouvΘ ca quelque part sur le net, 
c'est bien cool!

Ok c'est pas mal tout, bon merci α la seule personne au monde qui aura lu mon article. 
Sans doute seulement parce que ce fut un mordu des ezines pis qui l'a lu pour le fun 
entk! J'ai pu vraiment rien d'autre α dire que FΘlicitation aux seuls personnes qui 
hack les satellites!! 
...
de comment piquer l'acces α son chum ou a un trou de cul qu'on connait meme pas mais 
...
Sans le savoir Sympatico nous offre des occasions illimitΘs de pouvoir se denicher 
...
surement pas trΦs trΦs longtemps.
...
une seule connection de 50 hrs!! Mais bon, un numero de sΘrie ca se change par chez 
nous!!! ;)
...
disquette (lα elle te dit ca dans un accent d'anglais laid, on dirait qu'elle parle 
espagnol au lieu de francais!) Donc, lα tu dit; stu veut toΘ criss!!! Nenon sans joke, 
tu dis oui tu fait ce qui faut faire et c'est gratuit!!

Bon ensuite, passons α nos heures gratos de Sympatico!! hmmm!!
...
lα τa entre sur le net et te demande ton # de serie et ton mode de paiement!! Tu dis par 
...
dΘjα Ωtre prit a l'heure qu'il est!!!
...
τa va marcher et t'a le net 50 hrs gratosse pendant 1 mois mais quand τa te demande le prix 
apres le paiement metton tu marque 10 piasses!! mais une coupe de semaine aprΦs ton 
abonnement tu appelles α la centrale sympatico et tu dis que tu souhaites stopper ton 
abonnement α la fin du mois!! Et UP! aprΦs ce mois lα, tu t'en fait un autre! 
...
Hey bien voilα... Tout a commencΘ quand.......... {

Pendant la journΘe, j'avais pratiquement rien a faire alors j'ai
appeller des amis(es) et j'ai aprit qu'il y avait un party α
Gatineau ce mΩme soir. Nous avons dΘcider d'y aller !!! Bon, le
soir venu, mon chum vient me porter chez une amie et nous nous
sommes rencontrΘs la. Bon, il fallait se rendre aux Promenates
pour prendre un autobus qui allait nous menez jusqu'au party.
Nous marchons, Nous marchons, Nous marchons.... Ah j'ai faim,
alors nous nous sommes arrΩter au Burger King. J'aime bien ca
la bouffe qui font la mais ca l'air que mon ami ne va plus y
retournΘe parce qu'il a vu la femme entrain de faire le HamBurger
se pognΘ le cul et aprΦs mettre des tomates... C'est vraiment
dΘgeulasse non ??? En tk... Nous repartons... ArrivΘ aux
Promenades, il fallait attendre 20 minutes criss au froid.. en
tk.. Bon, j'ai trouvΘ quelque chose α faire !!! Un journal !!!!!
Mais, merde.. J'ai pas d'argent... grrrr... Un ami me dit : "Pas
besoin d'argent pour ca voyon... !! ". Je dit "ok ouin et
comment?" Et bien α ce moment, il tire la petite porte doucement
et la il commence α donner des petits coups dessus, juste en
haut ou il y a la barrure !!! Et la... CLICK !!! La portiΦre
ouvre ;) Bon.. C'est pas un journal qui est bon.. Ahh !! Il y a
Le Droit ;) Hey bien bam, bam, bam pour le droit aussi!! hΘhΘhΘ

Ca marche trΦs bien !! Essayez le et vous verez !!!
...
( La plupart des SYSTEM de SΘcuritΘ CELLULAIRE fonctionnent sous la meme base )
...
de 334 α 666 (Satan!) seront utilises. Si le PS est sur 1 les canaux allant de 1 a 333 seront
...
J'aurai les frΘquence bien vite !! tk je l'espΦre !
...
Vous devez tenir compte qu'une pipe bomb est TR╚S dangeureux. Sa
construction peut Ωtre dangeureuse.. C'est pourquoi je vous demande
de faire trΦs attention en la construisant et sourtout avant de la
faire exploser, tout vΘrifiΘ pour ne pas qu'elle vous pete dans la
face, car si c'est le cas, vous risquez d'Ωtre trΦs sΘrieusement
blaissΘ et mΩme possible d'y laisser votre peau. Je veux aussi dire
que je ne fais que vous informer avec ce texte, je vous incite pas
α la faire!!! Alors s'il y arrive un problΦme en fesant exploser
...
Quand la pression α l'intΘrieur est devenu trop ΘlevΘ pour qu'elle
reste intacte, BAAAAAAOOOOOOMMMMMMMMMMMMM!!!!!!!!!!! Ce qui veut
dire, construiser la minucieusement.. :)


MatΘriels : - Ciseau (TrΦs coupant)
»»»»»»»»»»» - Pourdre a canon (vous pouvez en prendre dans des jeux 
              d'artifices)
            - Condom :)
            - Gaz
            - Tuyau de plastique ou mΘtal avec 2 bouchons
            - Clous (optionnel)
            - Duck TAPE!
            - MΦche
            - Perceuse

Construction : 1 - DΘfaire le feux d'artifice pour y prendre la 
»»»»»»»»»»»»»» poudre et aussi pour prendre la mΦche.
...
Note : il faut que ce soit TR╚S solide pour qu'il y ai
...
3 - Prendre le condom, le mettre dans le tuyau, remplir
    ...
    tuyau et faire un noeu au bout pour empΦcher le gaz 
    de s'Θchapper.
...
Note : Remplir jusqu'au bord mais il faut laisser de la
       place pour pouvoir boucher cet extrΘmitΘ du tuyau.


5 - Percer un PETIT trou dans le bouchon restant. Je vous
    conseille d'en utiliser un qui se visse de maniΦre a
    ce que si vous voullez faire une modification a votre
    bombe, il est plus facile en dΘvissant qu'en dΘcollant =P

Note : il faut faire un trou assez gros pour y laisser
       passer la mΦche mais assez gros pour que le feu
       entre dans la pipe bomb...


6 - Mettre du tape α l'entour de la mΦche, sans obstruer
    l'orifice ou la flΓme va passer. 


7 - Avec le tape, il faut accrochΘ des clous α l'entour de
    la pipe bomb.

Note : Le plus qu'il va y en avoir, le plus de domage il va
       y avoir :)))))

8 - Maintenant elle est prΦte a faire exploser :))))))))


Voici le motif de la bombe :


         \!/ <------ FlΓme, qui veut dire... RRRUUUUUUNNNNNNNNN!!!!!
          |
          | <--- MΦche
          |
...
Enfin on peut dire que c'est un pΘtard a mΦche gΘant!



En tk.. M'a vous dire que si vous suivez mes instructions α la lettre la,
c'est sur que vous vous allez Ωtre capable de faire pΘter n'importe quoi!
Mais n'oubliez pas de faire attention α la construction de la bombe et
comment vous allez la faire pΘter !!!
...
une utilitΘ au prog tsΘ! bon ok!!

mes box ip et lautre Socks ensuite lautre status

ensuite pour starter un peut dans le source allons dans gΘnΘrale!! bon on va i 
dΘclarez 2 tite variable ic sa va etre le fun ;)

Option Explicit
Dim Freeze As String
Dim Socks As String

bon nos 2 varaible son dΘclarez a koi y vont servire ?? hmmmm 2 sec!!! bon Freeze 
sa va etre pour le stop ou le start genre on va faire des if avec des true or false 
tsΘ comprendo? non! ok c est cool! bon pis scok sa va etre le nombre de socks a 
...
plus de victim sans ta criss de perte de temp bon bon bon avant de chailer tsΘ 
...
CECI PEUT ╩TRE TR╚S DANGEUREUX, JE NE VOUS FORCE PAS A FAIRE AUCUNE DES
...
PERSONNE QUI PEUT ╩TER DANS LE TORD EST VOUS M╩ME !!!
...
Le Beige Boxing sert α se connecter α une ligne qui n'est pas la votre
...
victimes vulnΘrables α ce genre d'attaque(une facon de dire les 
choses, hehe) et je vous souhaite de prendre des vistimes qui sont pas
trΦs riche comme ca souvent la centrale(Bell) va prendre beaucoup plus
de temps a rΘagir a cela mais si la personne est riche, quand tu as de 
l'argent, tout va plus vite et mieu :)

Je tiens a dire que cette box est sourtout bonne en France MAIS elle
fonctionne au QuΘbec aussi !!! Je sais, je l'ai essayer avec des amis
l'autre jour
...
- Un tΘlΘphone a quadran numΘrique
- 3 Pinces crocodiles
- Un fer a couder
- Tourne-Vis
- Couteau
- SaC α dos(de prΘfΘrence, voir plus loin pour plus d'info)
...
1 - Prendre le tΘlΘhone, et le dΘmonter doucement avec le tourne-vis
    de facon d'avoir access α l'intΘrieur mais il faut pouvoir le remonter :)
...
Notes : DΘgeiner le fil avant de faire ca avec le couteau
»»»»»»»

3 - Maintenant, aller vous trouvez une victime. Ceci peut Ωtre umpeu d√r 
    parce que dite vous qu'il va falloir que vous alliez monter dans le poteau
    de Bell ou les lignes de tΘlΘphones et ou vous allez pouvoir voir la boεte
    anti-foudre(FT). Pour les reconnaitres, c'est pas trΦs d√r, c'est une boite
    Blanche qui a une insigne "FT".

Extras : Quand vous allez avoir ouvert la boite, vous allez voir plusieurs fils
»»»»»»»» donc 2, le fil blanc et le fil gris. Maintenant, il faut les dΘnuders sans
         les coupers(IMPORTANT!!!!!!!!) Maintenant ils faut brancher la pince blanche
         sur le fil blanc et la pince rouge sur le fil gris. DΘcrochez le tΘlΘphone, 
...
cette personne dans la merde, vous avez juste α redessendre et brancher votre portable
...
1 - Ne pas trop endomager la boite aprΦs utilisation
2 - Ne pas faire trop de bruit
3 - Passer α l'action aprΦs minuit
4 - Ne pas choisir une personne qui vous connais
5 - Je suis s√r que vous en savez d'autres..


Conclusion :
------------

Bon hey bien j'espΦre que vous allez vous amusez avec tout ca :)
...
- endrix
 ...
 ____ __ _ _ _______________ ________ ________ __PyroFreak Magazine #4
: 
| Hacking sur les ordis de l'Θcole 
'.________ __ __ ___________ ____ ____________ ____Par CyberRider __



Bon dan cette article je vous explique comment hacker votre Θcole ! bon faut
sentendre la on changera pas nos notes je vous dis seulement style avoir des
acces de prof bon avoir accces aux autre ordi des chose du genre tsΘ! Bon
...
la ta propriΘtΘ et plein d autre truc don le premeir de la liste qui est
...
dΘsoler!! tu as VB3 sur le win 3.1 se qui serait cool! ou ta une icon qui
...
peut etre tres simpel ;)) ouvre le fait toi une nouvelle base de donΘ la tu
...
on sais que notre proff a lanschool qui fait toujours planter nos pc sΘrieux
ya rien de plus chiant que le prof qui part le broadcasting et nous explique
des chose quon sais tsΘ! bont k la on sais qui a sa alors on sais qui a un
...
school sur leur server principal (α la courvi ya 2 server principal dison
...
trouver cest que a courvi toute les poste sappelait elev204 sa va bin tsΘ!!
...
de elcole dΘsoler il y aura probeblement une belle suite!!
...
Hey bien voici encore un autre ezine qui vient de ce terminer!!! J'espΦre
que vous l'avez aimer la :)

L'ΘtΘ est arrivΘ, enfin!! Alors la c'est le temps de faire autre chose que
de rester en face de vos Θcrans, profiter de la vie, fΩter en masse faite toute
les choses que vous ne pouvez pas faire en temps normal, c'est le temps. La crew
de pyrofreak allons cesser nos activitΘs durant cet ΘtΘ pour profiter de la vie
en tant que jeune mais vous pouvez toujours nous contacter par courrier Θlectronique
alors j'espΦre que vous allez passer un bel ΘtΘ et faites attention avec vous parce
...
========================================================================
                         	      	...
                         	      	'::-::`
    	       	                         (o o)    	
                                       ooO--(_)--Ooo-
            cOPYRIGHT (c) tOUT lES dROITS r╔SERV╔S α pYRO-pHREAKERS mAGAZINE
