comun. Nuestras identidades pueden distribuirse a travΘs de muchas
...
esa base. Pero no podemos aceptar las soluciones que estßis tratando de
...
contagio durante un pequeño tiempo, pero no funcionarßn en un mundo que pronto
...
Este texto esta sacado de la pßgina de FrEE. Si te interesa este tema podes
encontrar informacion y links en www.hacktivism.org, www.eff.org, estas
paginas tienen links, e incluso estßn en español. Si alguien esta interesado
en unirse a esta campaña, formando una pagina o por mero intercambio de este
...
victima o a alguien cercano o con conocimientos de Θsta, por E-Mail o por IRC.
...
todo. Incluso te va a dar seguridad en vos mismo y te va a ense±ar a mentir y
a improvisar.
...
extraño, por el ruido de fondo, conseguite un telefono lejano, donde no hay
a ruidos. Y recorda que pueden saber tu telΘfono con esas mierdas de VeriFone.
...
esta en el mail que le da el servidor de internet. E.J.: victima@servidor.com,
...
Si estßs pidiendo informacion sobre la cuenta de alguien en algun sistema,
...
2. Correo Verdadero.
   -----------------
Si, esa cosa extraña hay afuera, esa cajita rara que dice "CORREO" y que
...
promociones, algo asi como Reader∩s Digest o promociones de Garbarino o de
algun banco. Trata de imitarlas, no va a ser muy caro. Y trata de hacerte
pasar por una compañia desconocida, pero que a la vez parezca
tener un nombre importante. Algo como "La Puñeta Hnos. 50 años al servicio de
...
computaci≤n y rogar que le digas su password y darle un telefono para que te
...
Master∩s Paradise, etc) y robar passwords, ya que haciendote pasar por una
señorita en busca de amor todo se logra, jejeje. Pero, lo mas importante de
...
Recomendacion: te recomiendo busques alg·n otro lugar que de mailz grßtis, ya
que esos son muy conocidos, o, si te llega un mail de fulano@hotmail.com pidiendo la password, 
...
religiosa, bañandote, incluso, lo podes agregar a tus habitos diarios, ademas
de joder al gato del vecino y escupir desde el departamento a la gente.
Si sos muy gordo (400 kilos) o si pareces menor de 15 a±os, no pruebes hacer
...
que ganar. Pasa rßpido, como si fueras apurado, mostrando la tarjeta de
identificaci≤n o esas de visitante o visita. Busca la computadora central, la
...
de informaci≤n de ahi. Si encontrßs la computadora, no trates de hackearla,
pueden haber cßmaras observandote, incluso atrßs de los espejos, estßn en
...
Los ports estßn divididos en tres rangos: los well known port numbers (ports
...
llegaron mßs frecuentemente fueron "Que es NetBios?" y "Que son SMBs?". Bueno,
...
preguntas o comentarios, envialos a NeonSurge@abyss.com.
...
Los SMB∩s son usados por Windows 3.x, Win95, WintNT y OS/2. Cuando se trata
...
SMB∩s estan codificados como estructuras de datos Network Control Blocks
(NCB). Las estructuras de datos NCB son codificadas en formato SMB para
transmitirlas a travΘs de la red. SMB es usado por mucho software de redes de
Microsoft e IBM:
...
==============================================================================
==============================================================================
Esto fue hecho como una introduccion rßpida a SMB, para mas informacion:
...
mßs bßsico que alguien debe saber en ASM: Las instrucciones de Comparacion:
...
ASM les sera mas facil (recomiendo el del grupo español de VIRII 29A).
...
tierra. Con este Debugger se puede ver hasta quΘ carajo esta haciendo Bill
con nuestro microprocesador, de todo. Pero principalmente, se puede ver el
momento en que un sencillo programa que pide un n·mero de serie, compara el
n·mero correcto con uno que le metimos nosotros de casualidad... Esto es lo
mßs importante: "Tracear" el programa, hasta llegar a la rutina de
des/encriptacion de un numero de serie, o inclusive de un password, etc. El
mΘtodo que se usa para crackear con el SoftICE es poniendo un BreakPoint
...
programa: (ya anticuado pero igualmente util) el Sourcer (DespuΘs me fijo en
...
porque estamos tratando de crackear un programa sin ejecutarlo, o sea estß
...
n·mero introducido es incorrecto!" y volver un poco atras en el codigo para
...
Obviamente hay muchisimas mßs aplicaciones de este tipo, pero nunca habrß
tiempo de comentarlas todas.

Las Contribuciones de los Grandes Crackers:
εεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεεε

Esta seccion es la mßs apasionante: unos genios de la division de CODERS de
...
uCFProcDump, que sirve para cuando tenes un programejo estß comprimido
(ejemplos varios: el WinAMP con Petite, el HomeSite (un editor de HTML
excelente) con Shrinker, y muchos mßs, entre ellos mi desafφo: el Cuentapasos,
con el Hasiuk/Neolite) de una manera que se descomprime solo a memoria, y a
partφr de ahφ contin·a su ejecuci≤n, si no se pudiera conseguir un serial
...
Otro programa tambien difundido por uCF es el "Bye! PE-Crypt" a·n en versiones
preliminares, les ha sacado un duro dolor de cabeza a muchos crackers, que
tenφan que crackear programas: no comprimidos, aun peor: ENCRIPTADOS. Es del
mismo tipo que el uCFProcDump. Y asi de buena.

Utilidades Especφficas:
...
Descompilador que nos devuelve el codigo directamente a su origen, pero s≤lo
...
de cualquier programa tambiΘn) 1,2,3,4,5,6,etc. Jaja sφp todas sus versiones.
Excelente para crackear programas de VB5 que te piden n·mero de serie, ya que
para hacerlo con el SI, tardariamos a±os (esto es debido a que VB no es un
ejecutable real, mßs bien un script compilado que deja que una librerφa tonta
y estupida, MSVBVM50.dll, haga todo el laburo, y obviamente ralentiza la
ejecutci≤n hasta un 70%). Con el SmartCheck, podemos ver desde el resultado
de la funci≤n DateDiff() (resta de fechas, exclusivo para crack a triales de
30 dφas) hasta c≤mo cambia los valor es de la cadena Will Gates III a su
valor de 666 por medio de las funciones Asc() y Hex(), obviamente un programa
que no debe faltar en el hd de ningun cracker.
TambiΘn tenemos que comentar quΘ nos queda para lo demßs (Visual C, Delphi,
etc.) otra joya de NuMega (ya son tres, lo pari≤) el BoundsChecker, que hace
lo mismo que el SmartCheck, pero con la diferencia de que es mßs detallado,
e interpreta de mucha mejor manera las llamadas API, devolviendo resultados
mßs explicitos, ojo si se hiciera esto con VB no tendriamos suficiente HD o
...
******************************************************************************    
        ...
        de textos muy interesantes sobre seguridad inform▀tica. Te recomiendo
...
administradores de sistemas, est▀n todos en ingles. Algunos ejemplos:
