...
```
 ...
 un numΘros pour ecouter les messages a distance, qui est le xxx-6245.
 ...
 en dehors faut fair ses trois (3) premier numΘros accompagner de 6245.
 (Ex: 555-6245). Un fois que tu a appeler, ta suposer entendre une 
 bonne femme qui te demande le numΘros de ta boite vocal (numΘros de
 tΘlΘphone), et ton password. Tu a trois (3) chance, quand tu essaye
 un password pour la 3eme fois ... sa racroche. Donc meme essayer de
 le cracker serais long en kΓliss. Mais comment?
 ...
 petite femme qui demande le numΘros de la boite vocal et le password.
 ...
 timing est bon, elle devrait entendre "Appuillez sur le carrΘ et 
 entrer votre numΘros de boite vocal". Si a les asser twit pour tapper
 son numΘros, a vas entendre 
 ...
 plutot pour mettre plus de chance de votre cotΘ. Premierement
 arrenger vous pour enregistrer toute se que si passe sur votre 
 tΘlΘphone. Pourquoi? ben quand la victime vas entrer son password
 ...
 vas avec chaque numΘros, et re-Θcouter votre enregistrement;) 
 Au pir, si vous ne dΘcouvrer pas toute le password, vous savez au 
 moin comment de numΘros il prend ... 
   
 Quand tu appelle au xxx-6245, le commencement du message dit ceci:

 1er  - Appuilez sur le carrΘ et entrez votre numΘros de boite vocal.

 Bon, quand tu ne tappe rien ... apres un boute sa te dit ceci:

 2eme - Le carrΘ est la touche en bat de ton tΘlΘphone blablabla 
        et le numΘros de ta boite vocal est gΘnΘralement ton 
        numΘros de tΘlΘphone ... [en gros c'est sa;)]
 ...
 A vous maintenant de dΘssider quelle message voulez vous que la victime
 entende (1er ou 2eme). 
 Le temps des messages devrais vous aidez α calculer votre coup!
 
 

 TRUC 2

 Le password ne peu pas etre plus long que 7 numΘros. 555-5555 ... hum 
 7 chiffres hehe! Ya pas de password par default, mais ya surment des
 gens qui on seter leur password avec leur numΘros de tΘlΘphone. Mais
 ...
 votre livre de tΘlΘphone un samedi soir et let's go !!!
 ...
 vas dedans sa te demande un password (et le nom prΘ-enregistrer). Bon a
 meton que je laisse un message au 555-5555, une fois envoyer sa dit que le 
 message a ΘtΘ envoyer a Ti-Pierre (exemple). Le nom Ti-Pierre a ΘtΘ 
 enregistrer par la personne meme. Si la personne na jamais seter son 
 nom prΘ-enregistrer, quand on laisse un message sa nous dit selement
 le numΘros du gars. Se qui veu dir que aucun password ni nom prΘ-enregsitrer
 n'a ΘtΘ seter. Le truc est le suivent: Si vous envoyer un message a quelqu'un
 et α la place de dir son nom prΘ-enregistrer sa dit le numΘros de tΘlΘphone, 
 sa veu dir que aucun password a ΘtΘ seter (ni nom prΘ-enregistrer). Bon a 
 metons vous avez trouvez quelqu'un qui na pas seter son password, appeler au
 xxx-6245, entre le numΘros de boite vocal. 
 ...
 comme password entrer simplement le numΘros de tΘlΘphone. 
 ...
 du cotΘe que le systeme vois que c'est la premiere fois
 que t'essaye de entrer sur ta boite vocal, mais en rΘaliter tu n'est pas 
 chez vous. En tk ... a vous avez quand meme asser de renseignement pour 
 savoir comment dΘtecter que la personne na pas seter de password, et comment
...
-[ Ne jamais sous-estimer le pouvoir du pickle ]------ ---- --- -- - -
 ...
 collΘs ensemble, il est donc desfois difficile de savoir
 combien il y en a... dans ce cas, se fier a la largeur 
 de la bande.) 
 Ensuite, voyons comment fonctionnent les chiffres:

 Premierement, ce code est divisΘ en 4 parties qui forment les 12
 chiffres, soit:
...
9:  0001011   (11)     0010111   (23)    1110100   (116)
 ...
 Juste α suivre les tables et associer les chiffres aux 
 valeurs de ces dernieres et le tour est jouΘ!  Mais bon,
 il fallait bien qu'il complique ca un petit peu!  La
 deuxieme moitiΘ des chiffres (7 a 12 inc.) utilisent toujours
 la colonne C.  Par exemple, si le 7ieme chiffre est "8", il 
 vaudra donc "1001000" pour le scanner, soit 72.  Jusque la,
 rien de bien compliquΘ.  Mais le hic, c'est que pour les
 6 premiers chiffres, au lieu de suivre une colonne bien prΘcise,
 CHAQUE chiffre suit une colonne diffΘrente (soit la A ou la B).
 Comment faire pour savoir ca ?  La clΘ se trouve dans le tout
 ...
 Pas trop compliquΘ dans le fond...
 ...
 *** Ce code UPC est evidemment un faux tirΘ au hasard...
 
 Voila!  
 Mais encore une fois, c'est quand meme assez simple si on
 connait les tables... Alors ils ont rajoutΘ la touche ultime
 qui fait que c'est difficile d'inventer des codes:
 le "checksum security number", soit le chiffre de securitΘ.
...
par Du pis fini pas par k3st4r.  On va supposer finalement que vous Ωtes
un humano∩de dotΘ d'au moins 40 de QI (donc que vous arrivez pas de sur
...
J'me fou d'la faτon que vous le faites, j'me fou du temps que vous
prenez.. chui pas ici pour critiquer votre faτon, non  je ne parlais
pas de ce que vous faites le soir en pensant α un acteur quelquonque 
...
dans cet article est... la plate forme de la box que vous avez hackΘ,
oui oui la plateforme on s'en fou.

On va commencer par se demander pourquoi un leet h4x0r comme toi 
voudrait backdoorer une box qu'il a hackΘ.  Il est Θvident que si vous
avez rΘussi a la rooter, c'est parce que la sΘcuritΘ Θtait vraiment
mais vraiment nulle(prenez ca personnel).  Donc vous pourrez vous
resservir de votre exploit ou encore de peu importe la faτon que vous 
auriez pu rooter la box pour y retourner.  Il y a de multiples
avantages α la backdoorer par example:

-	Si par un malencontreux hasard l'admin venait α dΘcouvrir qu'il est 	
        vulnΘrable, il va fixer sa faille et vous ne pourrez plus accΘder α
	la box.
...
-	Le plus gros avantage je trouve est la disponibilitΘ de la box par 	
        aprΦs, je m'explique.  Je suis au cegep, j'ai besoin de la box pour 
	une raison quelquonque.  Vous allez avoir besoin d'une plate linux 	
        ...
        nΘcessairement me direz-vous, parce que vous pouvez toujours vous 	
        connecter en telnet chez vous et runner l'exploit de chez vous. Mais 	
        il y α quatre principales raisons pourquoi ca ce n'est pas bon :
	
		1- Pourquoi ne pas avoir un surplus de sΘcuritΘ en vous 		
                connectant directement sur la box a partir de l'Θcole plutot 		
                 que de mettre votre propre connection α dΘcouvert?
		
		2- Si vous vous faites dΘconnecter pour une raison X α la 		
                maison vous Ωtes cuits.

		3- La vitesse de connection est toujours plus grande quand 		
                vous ne passez pas par une gate (votre ordinateur personnel 		
                dans ce cas-ci)

		4- L'admin vous retrace, remonte jusqu'α votre ip α la 			
                maison, envoie la GRC qui arrive 2 semaines plus tard, vous 		
                avez dΘmΘnagΘ parce que vous Ωtes leet et que vous savez que 		
                vous vous Ωtes fait pogner.  Mais vu que vous Ωtes dans QHA 		
                votre leet crew vous stoule pour se dΘcriminer d'avoir 			
                utilisΘ la box eux aussi. Donc vous mangerez des marshmallows 		
                en Θcoutant Bouscotte le mardi soir α place de chatter avec 		
                vos copains d'IRC.  On apprend par la suite que QHA est 		
                dΘmantelΘ parce qu'ils ont pu de supreme leader.
			



Je vous explique ma petite histoire. ╔tant pas coder pour 2 cennes,
j'ai mis mon dΘguisement de script kiddie pour trouver une bonne
backdoor.  Malheureusement les rootkits sont diffΘrents pour chaque
plate-forme... et puis il y en avait pas pour toutes justement.  Bon
revenons aux faits... je cherchais une bonne backdoor, c'est 
alors que je suis allΘ sur un site quelquonque.. s√rement 
...
tΘlΘphone et avec mon coloc, que j'Θcoutais km/h, que je lisais un 
e-zine et que je me promenais sur la box que je venais de rooter),
quand finalement, j'ai trouvΘ mon petit code source miracle, un 
trojan universel.

Alors je le compile sur ma box, ca marche, je le compile sur la box 
SCO UNIX (#iga-unix ... SUBTIL) que javais rootΘ dans l'heure
prΘcΘdant mes multiples heures de recherche intensive.... ca marche aussi.

Bon.. je l'ai installΘ seulement sur la box que javais rootΘ (par
soucis de sΘcuritΘ personelle peut-Ωtre? :P)... je suis les 
instructions... assez compliquΘes hehe.  The final test... je me log sur
la box en windows, avec CRT parce que le telnet de windows est trop lent.  

Bon maintenant, pour vous, petits visuels que vous Ωtes, je vais vous
montrer la mΘthode pas-α-pas ...
...
7. Allons-y.
		...
		Ceci est un Eterm transparent incrustΘ dans le 
...
|Linuxqc 			----> le tout se fait aveuglΘment :P
...
Assez compliquΘ hein...
On va passer α la section TroubleShooting
...
Bon dans ce cas la...
moi ce que j'ai fait quand ca m'est arrivΘ... tu prend un binary que tas 
dΘja compilΘ sur une box DE LA MEME PLATEFORME DΘja que c'est risquΘ de 
...
trouvez pas de box avec cc ni gcc d'installΘ... msg moi ca se peut que
...
|-----------------------------------------------------------------------|
|dunnoh:~$ bon mettons que vous avez backdoorΘ votre box
|bon mettons que vous avez backdoorΘ vot box: command not found
...
Si vous obtenez ca... vous avez cassΘ le login
Ca m'est arrivΘ un soir ou j'Θtais trΦs fatiguΘ, connectΘ avec un 56k 
dans la chambre chez mon pΦre.  J'ai malencontreusement effacΘ le
...
les logs, pis touchez pu jamais α cte box la... sauf si vous vous sentez
...
|
|door
|# Le voici enfin ce petit # tant recherchΘ!
|# Le voici enfin ce petit # tant recherchΘ!: not found
|# exit
|Connection closed by foreign host.
|dunnoh:~$
|-----------------------------------------------------------------------|
...
Bon yΘ 3h am... jsuis mieux daller me coucher avant de ne pas pouvoir 
rΘsister α la toune de Dragon Ball Z.

Je vous ai donnΘ le code... ca s'appelle utrojan.c
Je l'ai modifiΘ un peu pour le protΘger des VRAIS script kiddies, 
vous savez.. ceux qui laissent tomber si le code qu'ils ont downloadΘ
marche pas. Si vous trouvez pas le problΦme dans le code, vous viendrez
faire ma vaisselle j'vous expliquerai quelques rudiments :P

Si vous avez des commentaires... suggestions... menaces de mort
emailez-moi α bismuth@the-pentagon.com
...
Maintenant le cotΘ tricky du HSE que j'aime bien, ici je parle surtout
...
-[ Vous etes maintenant forcer a utiliser le bbs ]------ ---- --- -- - -
 ...
 '------------------------------------------ ------------ ---- -- --  --
           ...
           Un jour je suis nΘ, je me suis vu offert la vie : aller  α  l'Θcole
      faire devoirs et lecons, se forcer le cul pour avoir des bonnes notes au
      secondaire pour  entrer  au  cΘgep.  Aller  α  l'universitΘ  pour  faire
      plaisir  α  maman  et  papa, en sortir endettΘ de 30 000$. Se trouver un
      emploi   pour payer,  sur  10 ans les dettes accumulΘes par le passage α
      l'universitΘ.  Emprunter  120 000$  pour acheter une maison qu'on finira
      de payer 5ans avant de crever. Se  rΘveiller   α   l'intΘrieur  de cette
      mΩme maison α tous  les  matins  auprΦs  d'une  femme  qu'on  n'est  pas
      vraiment s√r   d'aimer.  Passer  5  jours  sur 7 au boulot, et les 2 qui
      restent  α  s'occuper  du  terrain  d'une maison qui nous appartient pas
      encore pour Ωtre s√r d'avoir le gazon le plus vert du quartier. Voici la
      vie que la plupart de nos parents nous souhaitent,  voici  la vie que la
      sociΘtΘ nous dΘmontre comme  Θtant  une  utopie,  le  but  α  atteindre,
      voici o∙ 2000ans de religion et de croyances bidons nous ont menΘ.


           Ironiquement,  c'est  ce que 7 milliards d'Ωtres humains souhaitent
      pour  eux-mΩmes. Mais  ceci  ne  reste  accessible  qu'α  une   certaine
      "Θlite".  Pour  les  autres,  malchance  et  pauvretΘ  veilleront  α les
      Θloigner de ce but si paradisiaque croient-ils Ωtre... Voici ce  qui  en
      est rΘelement:

      Nos rues sont pleines de trous, nos porte-feuilles aussi d'ailleurs. Big
      Brother  nous  fout  une  sonde  anale  α  notre  sortie du berceau, nos
      scientifiques s'excitent α essayer de cloner Elvis,  des  fanatiques  se
      font exploser pour propager leur religion. Un  gars  Θcope  de 2ans pour
      avoir pisser dans une calotte alors qu'un  autre  prend  1 an pour avoir
      violer une fille de 12 ans. En Asie, ils s'excitent  α  se  faire pisser
      dessus, non mais dans quel monde de  fous  on  est  rendu??? personne ne
      le sait bien s√r. Du pain et des jeux,  voilα  ce  qui  nous voilent les
      yeux. D'o∙ croyez-vous que le mot "divertissement" vient? Je ne sais pas
      pour vous, mais pour moi, τa sonne foutrement "diversion".


      Il  y  a  pourtant  une  autre classe de gens, plus minime, plus infime,
      celle  que   le   pain   et  les  jeux ne suffisent pas α appaiser.  Ces
      personnes sont malheureuses.  Malheureuses  de  vivre  dans un monde  de
      cons  dirigΘ  par  des  cons pour des cons. L'intelligence amΦne α  Ωtre
      malheureux, alors pour avoir  une  population  heureuse,  on   encourage
      la stupiditΘ. Mais  nous  qui  n'avons  pas  acheter  notre   cerveau  α
      l'Θcole, nous qui  n'avons  pas  vΘcu  le  lavage  de  cerveaux   qu'est
      le cΘgep et l'universitΘ. Nous nous voyons souvent refuser  des   postes
      par manque de dipl⌠mes, alors  qu'on  sait  trΦs  bien  qu'on   pourrait
      faire  la  job  aussi  bien  que   le   crΘtin  nouvellement  pondu   de
      l'universitΘ, tout neuf, tout prΩt  α  aller  rejoindre  le troupeau  de
      nΘo-zombies  et   α  servir  fidΦlement  Big  Brother.  Et  nous,   nous
      sommes les  mΘchants,  tout  simplement parce que nous avons appris  par
      nous-mΩmes. Nous avons appris ce  qu'ils  ne disent pas α l'Θcole,  nous
      avons  apprivoiser un monde qu'ils ne contr⌠lent pas encore puisqu'il  a
      ΘtΘ bΓti pour nous par des gens comme nous. Ils ont peur d'en perdre  le
      contr⌠le,  nous  sommes des criminels. Serais-je un jour pardonnΘ de  ne
      pas  avoir  ouvert  le  bon  bouquin?   Serais-je   un   jour   pardonnΘ
      d'avoir appris ce qui ne doit pas Ωtre  appris? Je  suis un enfant de la
      ...
      /join #iga
      *** Now talking in #iga
      *** Topic is 'Rap et Hip Hop = Musique de crottΘ, faite par des crottΘ, 
      pour des crottΘ...) http://www.demtrip.simplenet.com/rap/'
      ...
      * H3[aw] est maintenant de retour, j'Θtais parti a [00:12:54] mes lugz Θtais a [OFF]        [Gº]
      *** H3[aw] is now known as H3||B0Y
      ...
      &lt;g463-AWAY> connaitre le rΘsultat c'est agir en tant que script kiddie
      /part #iga 
     ...
     *** CableGuy is now known as Wyzeman
     ...
     &lt;Pooh_> tu prend un long manche α balais et tu le couvre de beurre et tu l'enfonce 
     profondΘment dans ton anus et une fois qu'il a perforΘ tes intestin tu cours 
     jusqu'α ce que mort s'en suive
...
-[ Qwzykx is now a official non-original expression lifeform  ]-- -- -
 ...
 fonctionnent a l'aide ce que l'hummanite s'accorde α appler
 l'ΘlectricitΘ. Mais comemt reussir α comprendre ou encore a
 ...
 dans cette article, car dans ce dommaine c'est avec l'expΘrience
 qu'on est aptes α bien cerner de diffΘrents principes.
 Donc ce mois-ci je ne ferer qu'une introduction α la mentaliter ou
 plutot α l'objectiviter qu'il vous faudra avoir avant de vous
 proclamer leet electro power tweaker. 

 Bien sur il est trΦs utile de connaitre les rudiments des pieces
 ...
 (Resistances, bobines, condensateur en cΘramique).
 Les condensateurs Θlectrolytiques ont tendances α etre plus α risques
 ce ceux de la catΘgotie prΘcΘdante.

 D'autre par, les pieces qui subissent des tempΘratures Θlever sont
 souvent, tres souvent une belle cause de problemes. En fait il
 devrait etre isolΘs et α vΘrifier en premier. On reconnais ces
 pieces par les HeatSink qui leurs sont souvent attahcer. On retrouve
 surtout dans cette catΘgorie les transistors de puissances, les
 rΘsistance de 1/2 Watt.

 Les circuits intΘgrΘes sont sensibles aux haut voltage, des haut
 voltage pouvant provenir d'une dΘcharge statique par exemple.
 ...
 complet qui sera instables et non une section spΘcifiques... mais
 encore la il faut etre prudent, on ne sais jamais!

 Avant tout il serait intressant de savoir a quel sorte de systeme
 vous avez a faire avant d'Θmuler de la connaissance. En somme vous
 ...
 d'amplifier le voltage afin de faire declancher diffΘrents systΦmes.
 En somme, une Θtude logique serait un prΘrequis essentiel α l'annalyse
 d'un circuit, et ce meme sii vous n'avrez aucuns plants.. aprΦs tout,
 faut pas avoir 150 de QI pour savoir qui a un moteur dans votre
 schΘcheuse... surtout si elle est munie d'une prise de courrant!
 ...
 gear de pΦtΘ, une strape qui est slack ou qui est tellement sec
 ...
 le regler. Par exemple, si votre PC ne veux plus dΘmarer, la premiere
 ...
 faire il vous faudra un outils de prΘdilection du technicien en
 electronique :Le multimΦtre. Essyer simplement de voir si vous
 ...
 illuminer vos pensΘes. Pour etre sur que le problΦme rΘside dans ce
 power supply, remplacer le si possible afin de verifier vos
 intΘrogations. Si rien de marche apres cette dure Θpreuve, il vous
 ...
 celui-ci. Tache dΘlicate certaine fois, dans des circuits
 ...
 30v continue.
 Le procΦder ne s'effectue seulement lorsque le circuit est
 ...
 comme les condensateur ont comme proprieter de conserver l'Θnergie
 qu'ils ont enmagasiner. Mais ces condensateur sont plutot facile
 α dΘceler car ils ont une magnifique forme phalique qui est beaucoups
 ...
 opΘration a coeur ouvert, aller donc souper ou, avec votre multimΦtre,
 vΘrifier le voltage aux bornes du condensateur. Si vous obtener une
 reponse qui est du genre 0v, tout va bien, passer α l'Θtape suivante,
 sinon, deux coix s'offre α vous: Prendre une rΘsiatance d'environ
 10kOhms de 1/2 Watt et reunir les deux poles du condensateur avec ses
 deux autres pates de rΘsistance (affin de dΘcharger l'Θnergie atravers
 la rΘsistance soyez encore une fois prudent, ne toucher pas aux metal
 qui relie ces deux bornes, car le but est de justement Θviter de
 pognier le courrant! Une autre mΘthode plus expΘditive existe pour
 ceux qui n'aiment pas se trscasser la tete, le classique short, en
 somme vous prener une paire de pince en mΘtal, (avec le manche isoler)
 et puis vous rΘunisser les deux bornes du condensateur. Un bon SPARK
 devrais se produire, dequoi vous laisser le coeur en palpitation pour
 un bon moment, depluis cette mΘthode a souvent comme effet secondaire
 de faire fondre le mΘtal de vos pinces au point de contact. Mais vous
 serez assurer plus que jamais que ces copndensateurs seront dΘcharger.
 Une fois ce rituel accomplie, passons α l'Θtape suivante. Sacher 
 repΘrer les Hots Sport, et par cette affirmation je vous convie a 
 ...
 trouverez a ces endroits des transistors de puissances, et Θvidament
 il vous faudra les vΘrifier. Avant d'aller plus loin, je tiens a vous
 inciter a faire preuve de logique, si vous voyez un condensateur
 ouvert ou une rΘsistance toute noir, sacher que vous devriez commener
 par ces endroits en premier. Dans le cas contraire, il vous faudra
 d'abord dΘsouder ce transistor et le vΘrifier hors du cricuit. Porter
 attention au type de composente, sur chaques pieces moindrement
 complexe, vous trouverez un numΘro de sΘrie, ce numΘro est catloger
 dans un livre applerm ECG quie vous pourrez trouvez chez un dΘtaillant
 de piΦces Θlectroniques pour moins de 6-7$ et croyez moi, si vous
 jouer souvent dans ce type de circuits, ca vaut la peine. Vous serez 
 capable avec ce numΘro de sΘrie de voir la nature mΩme de la 
 composente (sa fonction ainsi que son branchement) Une fois ceci
 trouver, vous pourrez vous affΦrer a tester la dite composante.
 Et comme ces bons vieux trappeur des bois, manipuler cette piΦce,
 gibier de la technologie, regarder la, senrter la attentivement et
 tenter de dΘcouvrir si elle de serait pas abimer ou elle ne sentirait
 pas ce doux perfum d'Θlectronique burned.. (un conseil ici, c`est
 toujours profitable de faire bruler des chips,rΘsistance,condensateur
 ...
 piΦce, pour ce faire , votre multimetre en main, en mode Test de
 ContinuitΘe, vous devrez vΘrifier si la composente est Shorter ou
 elle est aucontraire completement ouverte. Malheureusement pour vous,
 cette article de prΘcise pas comment vΘrifier les diverssent
 composentes, mais si le dΘsirs de certains se manifaissent j'en
 parlerer surement dans le prochain Zine. Apres cette vΘrification, si
 la piΦce est bonne, remetter la en place et passer α la suiivante.
 Sinon, vous venez simplement de trouver votre problΦme. La plus part
 des circuits sont diviser en des diffΘrents blocs ces blocs sont de
 vΘritables aide dΘbuggage, en somme simplement par le shΘmas de
 ...
 dΘdier pour les donnΘes ou le controle (mais pas dans le cas d'un  
 power supply Θvidament!) Un des points de test important, est la 
 sortie du transformateur. Cette emplacement permet tout d'abord de
 vΘrifier si ce dernier est fonctionelle (si il transforme le courrant)
 et en second lieux il sert de dΘpart pour votre circuit. Suivre une
 trace sur un circuit imprimer est un travail complexe et nΘcΘcite  
 souvent l'usage du test de continuitΘe de votre multimΦtre. Avec 
 cette connaissance du chemin emprunter par l'allimentation de votre
 power supply, vous pouverz vΘrifier directement les piΦces qui sont 
 relier au dit chemin. Encore une fois on tente d'isoler le problΦme.
 ...
 trouver des potentiometres, ces petites rΘsistances variables servent
 ...
 probleme de trensistor se resume  souvent a un des evΦnements suivants:
 Marche, marche pas. Tandisque qu'un condensateur α la particuliaritΘe
 de ce charger rapidement selons un model expodentiel et de ce
 dΘcharger selont le meme model. En somme si voyus voyer un degrader
 ...
 condensateur sur le chemin du ROUGE (si c'est celui qui fuck) VΘrifier
 ...
 fiable comme technique c'est de vΘrifier en touchant aux transistors
 ...
 ECG vous pouvez aussi vΘriifier les signials de I/O de la puce qui
 controle vos couleurs, le multimetre est encore  une fois 
 indispensable. Mais je vous en conjure immΘdiatement, commencer par
 le plus simple, c'est α dire de jouer avec votre fils d'Θcran de
 facon a voir si le mauvait contact n'est pas directemetn la ou encore
 sur votre carde video (a noter que les trois suppositions ΘnumΘrer me
 sont arriver... je parle encore une fois par expΘrience.) 
 ...
 encore la continuitΘe du lien.
 Si vous avez une carte qui commence a dΘconner apres une temps X
 d'utilisation, vous pouvez en dΘduire qu'il sagit surement d'un
 porbleme de surchauffage. Afin de rΘduire le champs de recherche du
 ...
 etant isoler (je l'espΦre) le fait de faire "travailler" la carte
 ...
 celui-ci est encore chaud (et je parle encore par expΘrience.)
 Trouver  un probleme est un travail parfois long et pΘnible mais
 toujours instructif! 

 En conclusion, souvent en Θlectronique comme en programmation, on
 cherche toujours des gros problΦmes de la mort quand finalement
