             ...
             M  .       qu'on existe encore, donc sur ca passons au contenu :)            |       
                ...
                `                                                                         |      |
                         ...
                         - Toute reproduction sur papier, vocalement , encadrer ou        |      |
                           laminΘ du mag est illegale sans notre concentement. C'est      |
                         ...
                         - Ne lisez pas ce ezine a l'envers, y a aucun message            |      |
                           subliminaux. !rialc utS                                        |      |
                                                                                        ...
                                                                                        .-```````-.
                                      Voici , fini les formalitΘs, next step.          /     .   ''\
                                                                                      (   '  |      )
                                                                                     _| `____|____' |_
                                ---- ------- ------------- ----------------- ------- \ \ `=-' `-=' / /
...
10) pendant le mois suivant la sortie du iga #14, l'ange assis sur 
 ...
 :
     ...
     ;   3x04]  [L]eτon d'[H]ypnose                       Moebius  ;
     ;   3x05]  [T]cp/[I]p  1/3                           Kh3ops   ;
     ;   3x06]  [F]uck [T]hat                             FalConZ  ;
     ;   3x07]  [C]omment [F]aire [D]e [L]'alcool         Kher⌠-Zen;
     ...
     ;   3x0D]  [L]a [S]ΘcuritΘ [S]ous [W]in [N]T         Wingaman ; 
     ...
     la plupart assimilΘe d'ici les prochaines heures.  Au courant
     des lignes qui suivent,  ces lignes renferment le rΘsultat de
     un mois complet de travail et d'apprentissage. Voilα sur quoi
     repose  l'avantage d'Ωtre  une grosse  Θquipe.  Plus on a une
     grosse  Θquipe et plus l'information arrive rapidement.  Pour
     notre part, nous n'avons pas une trΦs grosse Θquipe mais elle
     s'agrandit quand mΩme assez vite.Donc on peut parier que plus
     les  Ezines  vont sortir  et plus il y aura  d'information  a
     chaque fois.  Si vous voulez  participer α nos zines, je vous
     rΘpΩte encore une fois que vous Ωtes les bienvenue.
    ...
    --- WzGATE aurait-il ete a la meme ecole de d'intro fast-food
     ...
     ;   3x00]  [D]isclaim                                wzGATE   ;
      ...
      4- Tout ceux qui  liront ce Ezine accumulerons une dette de 1
         pichet de biΦre au kamarad envers wzGATE.
     ...
     Comme  je  vous   ai  dΘjα    prΘsenter  cet   article   dans 
     l'introduction, commenτons  d'abord  par  les  questions  qui 
     m'on ΘtΘ  envoyΘes paremail.
     ...
     ---
       ...
       44 sacres/jurons/impolitesses ont ete rΘpertorier dans son
       torchon(article)

       219 mots incomprenhisbles ont ete rΘpertorier dans son 
       torchon(torchon).
    ...
    "Le lendemin matin  je ouvre  mon winamps  et  ben pu  de  son 
     ...
     statique. Surtout que je dors dans des draps santΘs. Une fois le boitier
     ...
     .Comme  on vient de  le dire vous Ωtes un hacker et  puis 
     vous vous faites buster  malgrΘ toute  les  prΘcautions que 
     vous aviez prise.
     ...
     quoted---
      ...
      l'underworld en gΘnΘral. Et de ce qui risque de vous arriver
      si  vous vous  faites buster.  Je parle par expΘrience ayant
      deja  ΘtΘ deux  fois  en  prison  (HΘhΘ)   Pourquoi?  Trafic
      d'hΘroine! Combien  de  temps?  La 1░ fois 5 mois  et  la 2░ 
      14 mois.  Vous  allez me  dire c pas  beaucoup  mais  τa m'a
      suffit merci! Avant je ne m'intΘressais pas aux  ordinateurs
      jusqu'α ce qu'un pote en taule  m'explique toute  les belles
      choses que l'on  peut faire avec  un pc comme le carding par
      exemple  hΘhΘ .  Depuis  je  suis   passionnΘ !  Comme   par
      enchantement  hΘhΘ. Bon  passons  aux  choses sΘrieuses.  La
      premiΦre chose  quand vous vous  faites buster: ne dites pas
     ...
     ---
       ...
       mette a vous jugez comme etant un enemi de la societΘ vous allez
     ...
     quoted---
          ...
          Eh bien, le millenium phreak fest s'est une idΘe comme une
          autres  de 912HD afin de faire  bouger un peu la scΦne qui
          semble enfin se rΘveillΘe.
     ...
     *J'arrive α peine sur le canal et dΘjα une fauve tente de
     *m'extorquer des CC
     [18:32] &lt;wzGATE> yeah
     ...
     *Le gars α dΘjα une mastercard mais il veut une visa...
 ...
 :
     ...
     j'ai crus bon vous parler de chose lΘgale pour une  fois.  Car
     apres tout,la diffΘrance est bien mince entre ces deux extrΦme
     on α qua voir le monde dire qu'on est un zine de hacker et non
     un advisory pour les admins reseaux et bien laisser  moi  vous
     faire mention d'un fait troublant, le hacker cherche α rentrer
     tandis que le admin chercehe α pas laisser de  porte  ouverte.
     ...
     si il connais les techniques que notre amis le mΘchant Hacker
     fera afin de dΘvisser ca porte patio-passe-asortit saura qu'il
     vaut mieux mettre des des bars de metals ou  de  s'acheter  un
     doberman afin d'assurer ces biens matΘriel.  Donc  vous  α  la
     suite de ces explications vous constaterer que peut importe du
     cote ou vous pretender Ωtre, l'excuse est vaine!

     Et sur cette idΘe de lΘgalitΘ total auquel α droit chaques nord
     AmΘricains, dans ce texte, il sera question  de  sauvegarde de
     vos fichiers, et plus  explicitement  de  votre  code  source.
     Donc,  si  vous  coder  un  programme  qui  vas  rΘvolutionner
     l'industrie de la livraison de bananes  α domicile, vous serez
     surement tenter d'aller faire Enregistrer  votre  code  source
     afin d'avoir un certain brevet sur celui-ci. Mais voila, comme
     ce type de procΘder est un peu couteux(ne seraise que pour  ce
     rendre au burreau d'administration)  deplus  que  votre  copie
     lociciel se discute mal en cours.  Je  vous  suggΦre  donc  la
     mΘthode suivante.

     [1st Step :]
     Votre code source Θtant terminΘ,  faite le  imprimer  afin  de
     possΦder une  preuve  matΘriel  de  votre  programme.  Ensuite 
     glisser ces belles pages α l'intΘrieur  d'une  belle  envloppe
     ...
     sur l'envloppe. Destinataire Θtant  bien-sur vous-meme. Sorter
     prendre une marche α l'extΘrieur et poster le tout.
     ...
     [4th Step]
     Retournez α la malle chercher vos comptes α payer et rapporter
     avec vous cette envloppe jaune qui est de retour.

     [5ft Step]
     Prenez cette envloppe et dΘposer la dans un coin pour le reste
     de vos jours sans JAMAIS l'ouvrir.

     Comme ca si vous vous faite ripper votre code, pis que le gars
     est prΦs α aller plus loin que "4h10 en arriere du Petro Canada"
     vous  aurez  l'ultime  preuve  que ce code, vous l'aviez Θcrit
     avant que celui-ci ne s'avoue  propriΘtaire.  Car  l'enveloppe
     encore  sceller  portant  la  marque  de  la Poste Canadienne.
     Suite α ces recomandations, vous pourriez toujours vous  auto-
     envoyer 2-3 de votre code sous envloppe,  et  en  deposer  une
     dans votre grenier sous la mousse isolante, une  α  la  caisse
     pop, quoi que d'apres de recentes Θtude effectuα dans ce  zine
     il serais peut-etre plus sage d'en deposer une derniere  copie
     dans une banque digne de votre rΘputation, α suposΘe que cette
     Θtablissement ne sois pas une caisse pop bien-sur!
                                                                                   ; 
 '                                                                                 .
 :                                                                                 ;
 :                                                                                 '   
 ...
 ===================================================================================================
                                                                                       Pub-O-sticker 
 &lt;maniak>  Cherche femme taille forte de MontrΘal qui aime se faire brouter 
  la chatte,pour rencontre sur une base rΘguliΦre!
 ...
 :
     ...
     bon ici ce termine mes tutorial en C, je sais que  celui ci est plutot cour, mais 
 ...
 :
     ...
     ce qu'est un socket et ensuite α programmer des sockets en langage C.
     ...
     aux tΘlΘphones (que je suis comique!). 

  	     Pourquoi? Parce-que batir un socket c'est comme installer une ligne
     tΘlΘphonique (ou presque). Tu dois commencer par l'installer, ensuite choisir
     le type de fils, etc...
     ...
     ============
  	     ...
  	     Les sockets sur internet ont le mΩme concept de base que les
     tΘlΘphones: Θtablir une connection entre 2 h⌠tes pour ainsi pouvoir y passer
     des conversations, dans notre cas des packets. Les sockets sont comme des
     tΘlΘphones dont le fil utilisΘ pour la communication est Internet en
     utilisant le protocole TCP/IP (Transmission Control Protocol/Internet
     Protocol).

     Comprennez vous? RΘcapitulons...

               SOCKET ==  TELEPHONE
     INTERNET(TCP/IP) ==  FILS DE CUIVRE

  	     En espΦrant que vous le savez, TCP/IP est le protocole utilisΘ pour la
     transmition de donnΘes numΘriques sur Internet.

     if(reaction == "IPIT/CTPTTI?!?!") exit(1);

	     L'information circulant sur Internet avec le protocole TCP/IP est 
     divisΘe en packets. Les packets sont des branches de donnΘes ayant une 
     grandeur en bits Θgale. Les packets sont au TCP/IP ce que les mots d'une
     conversation sont au tΘlΘphone. 

  	     Pour Θtablir une conversation avec quelqu'un au tΘlΘphone il faut
     son numΘro! Pour les socket, c'est le mΩme principe. On appele cela une
     ...
     connection stream (SOCK_STREAM) est le fait d'avoir une connection o∙ les
     caractΦres vont parvenir en flot, sans interruptions. Le meilleur exemple
     d'une connection SOCK_STREAM est telnet. Tandis que SOCK_DGRAM indique une
     connection o∙ les packets vont arriver en gang. UDP (User Datagram Protocol)
     est le protocole utilisΘ pour transmettre des packets de type SOCK_DGRAM.
     Le plus facile α utiliser est SOCK_STREAM, et c'est aussi le seul dont je
	...
	Avouez que vous n'aimer pas ce mot. Vous voulez mΩme pas savoir ce
     que c'est que l'encapsulation de donnΘes juste parce-que le mot vous semble
     compliquΘ. DΘtrompez-vous, ce n'est pas si sorcier. L'encapsulation consiste
     α la transformation de donnΘes dans un format spΘcial qui permettra leur 
     transmission α une autre machine qui elle effectuera une dΘcapsulation.
     ...
     Exemple:
	     ...
	     Vous voulez transmettre une commande FTP α un serveur. Dans ce
     processus il va y avoir 4 Θtapes α l'encapsulation(transformation) de la
     commande pour la transformer en packet:

     1) la commande sera transformΘe(encapsuler) par le premier protocole, dans
        notre cas: FTP (File Transfer Protocol)
     2) le tout sera retransformΘ par le deuxiΦme protocol: TCP (Transmission
        Control Protocol)
     3) le tout sera reretransformΘ par le troisiΦme protocol: IP (Internet 
        Protocol)
     4) le tout sera rereretransformer par le quatriΦme protocol: le hardware
     ...
     dΘcapsulation qui est le rΘsultat du procΘdΘ inverse de l'encapsulation
     (effectuer les 4 Θtapes en commencant par la derniΦre jusqu'α la premiΦre).

	     Cette partie qui explique l'encapsulation n'est pas nΘcessaire pour
     la programmation des sockets. Mais ceci explique en gros ce que vont faire
     les fonctions qui serviront α transmettre des caractΦres. Si vous voulez en 
     savoir plus sur les diffΘrents protocoles et comment ils fonctionnent
     rΘellement, je vous conseil d'aller lire des RFC (Request For Comment) qui
     sont disponibles α l'adresse mentionnΘe α la fin de ce texte.
     ...
     =============	
	     ...
	     Une fois que tu as un tΘlΘphone et le numΘro d'une personne, que
     fais-tu aprΦs? Et oui! Tu compose! On appele ce processus se connecter.
     Dans notre cas, je vais seulement vous expliquer comment faire pour vous 
     connecter α un serveur distant, et non pas comment vous ouvrir un port sur
     votre machine. Peut-Ωtre que j'en discuterai dans un article α venir.

	     PremiΦrement, nous devons inclure dans notre programme les fichiers
     qui contiendront les modΦles des fonctions dont nous aurons besoin pour la
     programmation de sockets:

     #include &lt;sys/types.h>
     #include &lt;sys/socket.h>

	     La fonction pour Θtablir une connection α l'aide de socket est: 
     socket(). 

     int socket(int domaine, int type, int protocole);

	     Cette ligne dΘfini la facon selon laquelle socket() sera appelΘ. Elle
     contiendra 3 arguments:

     1) domaine: cet argument dans notre cas sera "settΘ" α "AF_INET".
     2) type: cet argument dΘfinira le type de socket utilisΘ, dans notre cas:
        "SOCK_STREAM".
     3) protocole: et puis "setter" ce dernier argument α "0".

     Ce qui donnera: 

     socket(AF_INET, SOCK_STREAM, 0);

 	     Nous devons ensuite insΦrer ce socket dans une variable pour 
     utilisation Θventuelle:

     scktest = socket(AF_INET, SOCK_STREAM, 0);

     NOTE: si vous avez lu la section des explications, vous devriez Ωtre en 
           mesure de comprendre pourquoi on attribut un domaine, un type et un
           protocole α un socket.
	
	     Cette fonction va vous retourner un socket (scktest) qui sera 
     utilisable plus tard dans le reste du programme. Si il y a difficultΘs α
     crΘer ce socket pour n'importe quelle raison, la valeur de la variable 
     socket (scktest) sera -1. Ce qui vous permettra d'implΘmenter vous-mΩme 
     une routine de traitement d'erreurs de connection.

	     La prochaine Θtape sera d'Θtablir la connection. La fonction qui 
     sera utilisΘ pour Θtablir la connection sera connect(). Ceci permettra de 
     vous connecter α une machine distante.

     int connect(int socketvar, struct sockaddr serv_addr, int addrlen);

     La fonction connect() contient 3 arguments:

     1) socketvar: la variable qui contient le socket que nous avons ouvert α 
                   l'aide de socket(). 
     ...
     #define DST_IP "134.232.11.21"   /* DΘclaration de variables globales */
     #define DST_PORT 23              /* DST = Destination */

     main() {

     int scktest;     /* DΘclaration de la variable du socket */
     ...
     /* Bon, ici on devrais faire une routine qui vas vΘrifier si le socket est
        capable d'Ωtre ouvert ou non. Je ne vais pas vous Θcrire le code parce-que
        vous devriez Ωtre capable de le faire. Il faut juste faire un IF qui vas
        vΘrifier si la valeur de scktest == -1. Si elle Θgale -1, c'est qu'il y a
        une erreur et qu'il est impossible d'ouvrir le socket. */

     dest_addr.sin_family = AF_INET;  

     /* On dit α la variable qui contient l'adresse du serveur
        (dest_addr) quel mode d'adressage elle devra utiliser α l'aide 
        de la propriΘtΘ sin_family (sin signifie: "s" pour socket 
        et "in" pour internet. Dans ce cas ci: AF_INET */

     dest_addr.sin_port = htons(DEST_PORT); 

     /* On dΘfini la propriΘtΘ sin_port de la variable
        dest_addr pour indiquer sur quel port se connecter.
        "htons" signifie Host TO Network Short. */

     dest_addr.sin_addr.s_addr = inet_addr(DEST_IP);

     /* On dΘfini la propriΘtΘ s_addr de la variable
     ...
     /* On se connecte α l'hote distant en utilisant la fonction 
        connect(). Le deuxiΦme argument est la troncature des 
        variables sockaddr et dest_addr pour ainsi former le 
        3iΦme argument tout en 1 qui indiquera l'adresse du
        serveur.*/
     ...
     NOTE: N'essayez pas d'exΘcuter ce petit programme. Il n'est lα qu'a titre
     ...
     =====
     	     ...
     	     Il se peut que vous n'ayez pas compris tout les petits dΘtails ou 
     ...
     code, regardez comment sont codΘs les exploits et regardez le code ligne par
     ...
     - Le reste, on verra.
     - Peut-Ωtre coder un petit remote buffer overflow ;).
     ...
     Texte Θcrit par Cub1c, pour IGA, terminΘ le 4 novembre 1999.
     Version finale terminΘ le 14 novembre 1999
 ...
 :
     ...
     *** http://www.sickboy.com
     ...
     sera en realitΘ stocker dans un fichier sous windows. un fichier de 100
 ...
 ,---------------------------------------------------------------------------------,
 | [007]                                                                           |
 |                           Mes mΘsaventures avec un Mac                          | 
 :                                 so called                                       :
 ;                            /invite apple #ANN╔ES1990                            :
 ,                                                                                 .
 .    


     Introduction: jme suis trouvΘ une job comme technicien dans une
     compagnie qui utilise exclusivement des macintosh dans ses
     bureaux. Jusqu'ici tout va bien. Mais ce qui compte, ce n'est pas
     la chute, c'est l'erreur systΦme qui va survenir.

     J'ai connu quelques gros tripeux de mac α l'universitΘ (dont un
     certaint mr. DubΘ de Cap-Rouge, mamma mia qu'y Θtait fanatique
     lui)... Tellement convaincus de la supΘrioritΘ incroyable de leur
     mac par rapport α Windows+Intel. Bon moi qui avait une expΘrience
     trΦs limitΘe dans les macs j'Θtais tolΘrant, jme disais bof la
     diffΘrence c'est toujours une bonne chose et tant mieux si y'aime
     mieux son mac, moi j'aime mieux mon linux et windows sur PC.

     Mais maintenant que je commence α avoir une expΘrience considΘrable
     sur Mac, jpense qu'y est temps de remettre les pendules α l'heure
     et vous donner les outils pour vous dΘfendre la prochaine fois que
     vous rencontrerez un trippeux de mac!

     Avant de comparer, jveux dire une chose... Y'a deux niveaux
     complΦtement diffΘrents ou on peut faire la comparaison: Comparaison
     ...
     mΘlanger ces deux discussions en une seule grosse discussion confuse
     parce qu'ils sont trΦs habiles α tout mΘlanger (exemple: Vous lui
     dites que sa souris a rienque 1 piton pis que c'est ridicule, y
     va vous rΘpondre que Windows est tellement laid qu'il a vomi dans
     le clavier. Vous lui rΘpondez qu'au moins un clavier PC ca coute 15$
     au lieu de 70$ pour un clavier Apple, y vous rΘpond que son CPU est
     ben plus performant que votre carte de son. Et si vous lui rΘpondez
     qu'au moins votre CPU vous pouvez l'overclocker dans des menu au
     lieu comme lui d'Ωre pognΘ pour ouvrir le case et teter aprΦs des
     jumper/dip switch ou meme changer des puces, il va vous rΘpondre
     que lui il peut ejecter sa disquette en software au lieu d'avoir a
     peser sur un piton, mais vous pouvez rΘpondre a ca que ca prend un
     ...
     Si votre MacTrippeux fait rΘfΘrence α des benchmarks qu'il a vu sur
     www.apple.com, oubliez ca! Apple a rΘcemment comparΘ un iMac 400mhz
     a un Celeron 500mhz a Quake3 (www.apple.com/imac/techspecs.html),
     et ils ont trouvΘ que le iMac faisait un meilleur score que le Celeron
     500! Great! Sauf que y'a un bug... Le Celeron a une carte vidΘo
     ATI Rage Pro, qui date de 1997 et qui est franchement pas vargeuse
     cotΘ performance avec les jeux de 1999 et 2000 comme Quake3 (demandez
     α Qwzykx ou Netlord), tandis que le iMac a une ATI Rage 128, sortie il
     y a moins d'un an, et qui performe α peu prΦs aussi bien qu'une TNT!
     ╔VIDEMMENT que le iMac gagne, maudite marde! Le test est truquΘ! Selon
     le gars qui a fait Quake3, Dieu lui-mΩme (A.K.A. John Carmack): "The
     ...
     Donc a propos des banchmarks, dites vous que Apple se gΩnent jamais
     ...
     test ou je verrais un iMac battre un PC, c'est en accΘlΘration
     gravitationnelle dans un escalier, vu qu'il est rond il va dΘbouler
     plus vite que le PC carrΘ et se rendre en bas en premier!

     Comparaisons Hardware:

     La grosse faiblesse avec les Macs, c'est qu'on a trΦs peu de choix sur
     le hardware. En rΘalitΘ, le motherboard, le ram et le CPU sont tout a
     fait comparable α ce qu'on retrouve sur PC, et le concensus gΘnΘral
     parmis les gens objectifs est qu'a n'importe quelle Θpoque donnΘe,
     le plus fort processeur PowerPC est gΘnΘralement comparable au plus fort
     processeur Intel. Donc on peut dire vaguement qu'un G4 450 (le plus gros
     sur le marchΘ prΘsentement) est probablement α peu prΦs Θquivalent au P3
     600.

     Sauf que quelqu'un qui veut de la performance α Quake3 aura pas la
     possibilitΘ de mettre une TNT2 Ultra, une G400 MAX, une Rage Fury MAXX
     ...
     Rage128 16megs (acceptable mais pas torcheux - demandez α Wyze).
 
     Au moins, pour les amateurs de programmes intensifs sur le HD comme
     Photoshop, les propriΘtaires de iMac ont la possibilitΘ d'upgrader leur
     systΦme de IDE α SCSI... C'est le genre de chose sur lesquelles souvent
     Apple laisse pas le choix... Ouf.

     Mais finalement je pense qu'il y a maniΦre de se dΘbrouiller pour faire
     la job sur un Mac aussi bien que sur un PC, le hardware est gΘnΘralement
     capable de fournir... En fait cotΘ hardware j'ai rien de nΘgatif α
     dire, a part peut-Ωtre que Apple, comme toujours, chargent une fois et
     demie le prix vΘritable pour chaque ordinateur. Si quelqu'un veut un
     Mac de puissance comparable α un PC de 2000$, y peut s'attendre α payer
     ...
     J'ai montΘ pour un ami (FreeQ) rΘcemment un systΦme double celeron 366
     avec moniteur 17 pouces, TNT2, 34 gigs de HD (!) UDMA66, pour α peu
     prΦs 1800$ avant taxes. Un bon kit quoi, α un bon prix. Pour avoir
     en mac quelque chose de vaguement Θquivalent cotΘ performance Quake3,
     ...
     clockΘs α 480mhz) en mac, faudrait un G4 serveur modΦle "Faster"
     ...
     mais demandez α Apple y vont vous dire que c mieux que la PCI du modΦle
     "Fast"), 20 gigs de HD UDMA33 seulement mais c'est quand mΩme respectable,
     mais pas d'Θcran. Si on met le mΩme Θcran que FreeQ (Optiquest Q71) on
     rajoute 350$ et donc notre systΦme Θquivalent Mac coute environ 4200$
     canadiens avant taxes.

     4200$ pour un systΦme Θquivalent α un PC de 1800$? Excusez moi je
     ...
     qu'on voit qu'α condition de payer plus cher, y'a moyen d'avoir un
     mac α peu prΦs Θquivalent α un PC, on arrive α la comparaison du
     ...
     Grosso modo MacOS supporte α peu prΦs pas le multitasking. MacOS on
     dirait un espΦce de DOS avec une interface graphique. Quand un
     logiciel Mac s'ΘxΘcute, il a le contr⌠le total de la machine pour lui
     tout seul. Les autres applications et le OS vont avoir la possibilitΘ
     de faire leur travail seulement si le programme est "gentil" et leur
     donne rΘguliΦrement la chance de prendre quelques cycles de CPU.
     Si notre programme veut empΩcher toutes les autres applications de
     fonctionner, c'est trΦs facile, il a juste α garder le contr⌠le complet
     de l'ordinateur pour lui tout seul et jamais le redonner. Jusqu'α MacOS
     8 par exemple, le programme qui s'occupe de copier des fichiers Θtait
     fait comme ca: Pour copier le plus rapidement possible, il gardait le
     contr⌠le complet de l'ordinateur pendant la copie. Aucun autre programme
     ne fonctionne, impossible de cliquer sur quoi que ce soit a part dans
     la fenΩtre du Copy, pour faire Annuler par exemple. Un autre exemple
     classique est que si vous tenez le piton de la souris (si vous savez
     pas lequel c pas dur de chosir y'en a rienqu'un) enfoncΘ sur un menu,
     un icone ou une scrollbar, alors TOUT est arretΘ dans l'ordinateur,
     aucune application n'avance, l'horloge arrΩte, les downloads arrΩtent,
     l'entiΦre puissance de tout un ordi est consacrΘe α attendre que vous
     vouliez bien lacher le piton. Whooo tu parle d'un multitasking
     impressionnant.

     Le multitasking on peut oublier ca de toutes faτons, par exemple si
     je fais une job difficile comme compiler un programme et que je switch
     a une autre fenΩtre, le compilateur va prendre de 5 a 10 fois le temps
     qu'il prendrait si je l'avais laissΘ en fenΩtre active.

     Pour comparer α Windows, on n'a plus vu cette faτon de fonctionner depuis
     1995 et l'Θpoque de Windows 3.1. Il existe un concept en design de
     systΦmes d'exploitation qui s'apelle le "Pre-emptive Multitasking".
     La diffΘrence entre un systΦme pre-emptive et un qui l'est pas, c'est que
     dans le systΦme pre-emptive c'est le OS qui a le contr⌠le de combien de
     temps chaque application a le droit de garder le CPU. Par exemple, sous
     Windows 95 ou Linux, les applications n'ont pas α s'occuper de redonner
     le contr⌠le du CPU au OS aprΦs quelques fractions de secondes, car c'est
     Windows (ou Linux) qui va lui enlever le contr⌠le quand il va juger qu'il
     l'a eu assez longtemps. Le rΘsultat est ce a quoi on est habituΘs sous
     Windows... On peut aller sur IRC en compressant un mp3 sans avoir peur
     que le mp3 prenne 45 minutes α compresser, on peut continuer de se
     promener dans Explorer pendant que winzip travaille sans que ca prenne
     le triple du temps, etc etc...

       Protection de la mΘmoire:
     ...
     Windows 95 a ptet pas tout a fait reglΘ le problΦme, mais au moins y l'ont
     rendu moins pire... Maintenant, on se fait dire "Le programme X a fait
     une opΘration illΘgale et va Ωtre terminΘ immΘdiatement", mais on a pas
     ...
     "Une erreur systΦme est survenue. Cliquez ici pour redΘmarrer".
 
     Ce genre d'erreur arrive gΘnΘralement quand un programme essaye
     d'aller lire ou Θcrire en dehors de la zone de mΘmoire qui lui a ΘtΘ
     rΘservΘe. Sous MacOS et Win3.1, qui n'implΘmentent pas vraiment une bonne
     gestion de la protection de mΘmoire, pour une raison que j'ignore ces
     erreurs font paniquer le systΦme. Windows NT et Linux sont totalement
     fiable quand ca arrive (Segmentation Fault = erreur de protection de
     mΘmoire), le programme se fait stopper net et le systΦme continue sans
     problΦme, et Windows 95/98 lui fait de son mieux et essaye de garder son
     calme et se contente de fermer le programme... GΘnΘralement ca suffit,
     Mais il n'est pas rare qu'un programme buggy en train de crasher
     rΘ-Θcrive des zones de mΘmoire ne lui appartenant pas et rende le
     systΦme totalement instable... Mais dans le pire des cas faut rebooter,
     et c'est mieux d'avoir le choix que de jamais avoir la chance d'essayer
     de continuer comme en MacOS.

       LibertΘ! Pitons!

     J'ai toujours trouvΘ cool sous windows 95 que dans un dialogue open/save
     file, on puisse cliquer de la droite pour crΘer des rΘpertoires, effacer
     ou renommer des fichiers, etc.... C'est le genre de libertΘ qui est partout
     ...
     sur α peu prΦs tout... Properties de la task bar, du desktop, du start
     ...
     tout α la portΘe de 1 click.

     Malheureusement, c pas comme ca sous MacOS. Dans les fenΩtres Finder
     (homologue d'Explorer (je dis homologue parce que je dirais certainement
     pas Θquivalent! c rienque un ti prog hyper simple) on peut tenir CTRL
     enfoncΘ en cliquant sur un fichier, et on va avoir quelques petites
     options qui vont apparaitre... GΘnΘralement ben moins qu'en windows,
     par exemple espΘrer pas changer grand chose, mais au moins y'a quelques
     options.
     ...
     faire des options de base... J'ai jouΘ α Warcraft2 sur Mac une fois... Moi
     je suis habituΘ d'utiliser le clavier pour donner des ordres fuckΘs,
     selectionner des groupes et finalement ma main sur le clavier est trΦs
     active tout le temps, ce qui me permet d'Ωtre plus efficace... Demandez
     α Wyzeman y'aimait ben me voir aller α Starcraft en mode usine α Zerg :)
     Mais sur Mac, si en plus falait que je me mette a tenir ALT enfoncΘ α
     chaque fois que je veux simuler un deuxiΦme bouton pour donner un ordre
     α une unitΘ, ca commencerait α Ωtre laid!
     ...
     tΓches de base. Il faut toujours plus de clics de souris, plus de tetage
     d'une fenΩtre α l'autre, plus de temps. Par exemple pour switcher d'une
     application α l'autre, sur Windows il suffit de cliquer sur le bouton de
     ...
     Si on a 15 fenΩtres ouvertes et qu'on veut tout minimiser pour voir le
     desktop, ben on a le choix dans ce menu de faire "Masquer toutes fenΩtres
     inactives" mais la fenΩtre active va rester dans l'Θcran; il est
     impossible de tout minimiser d'un coup comme en Windows avec le bouton
     Show Desktop du Quicklaunch. Pour se dΘbarasser de la fenΩtre active, on
     ...
     et agaτante, ou on peut simplement la dΘplacer dans un coin pour plus la
     voir. Wow comme c'est user friendly. 3, 4, ou 5 clics pour faire α moitiΘ
     ce qu'on pourrait faire en 1 clic sous Windows.

     Ou encore, le Control Panel. Sur Macintosh, ca s'apelle les Tableaux de
     bord, et c'est quelque part dans le Menu Pomme. Une espΦce de liste de 50
     items complΦtement mal classΘs, du genre que par exemple au lieu de
     regrouper toutes les options d'Affichage dans une seule fenΩtre comme en
     Windows, ben t'a la fenΩtre "Moniteur et Son" (y'auraient pu Ωtre sΘparΘs)
     et la fenΩtre "Apparence" et la fenΩtre "GΘnΘral" (ouf y pourraient tu
     essayer d'Ωtre moins clair)... Et y'a un device manager, sauf qu'on peut
     pas changer aucune option, juste lire et se demander Ou c'est tabarnak
     qu'on peut aller pour avoir accΦs α changer l'option. Pas question de
     cliquer de la droite (y'a rienque 1 piton anyway calisse) non plus!

       Microsoft α la rescousse!

     Une chance que Microsoft sont prΘsent sur mon macintosh. Leurs logiciels
     font plein de ptites affaires cool, et viennent avec plein de ptits
     utilitaires pour aider le Mac a Ωtre aussi user-friendly qu'un Windows.
     ...
     application α l'autre. Aussi, Internet Explorer a l'option gΘniale
     que si tu tiens le piton de la souris enfoncΘ sur un link plus d'une
     demi seconde, alors un menu apparaεt comme si on avait cliquΘ sur le
     deuxiΦme piton d'une souris PC.
     ...
     1) Double Celeron + Windows2000. Vive Quake Vive le prix vive la stabilitΘ.
 ...
 .    
     ...
     tel code propre a chaques personne qui lui sera universel
 ...
 .    
     ...
     Voici quelques extraits de notre Θpisode prΘcΘdant.
     "Comme les volvos ?"
     "La soeur de liloo ?"
     "Oui j'tΘcoute"
     "Ta yeule"
     ...
     "Hey man! ╟a fait 1 mois que j'ai Linux, pis je chie rien avec.
     KΘcΘ je peux faire ?"

     Ben tu peux faire du CafΘ. COFEE-HOWTO (c'est pas une joke en passant (: )
     Pis sinon, tu peux te faire un petit firewall, comme τa tu peux Θcoeurer tes amis
     pis ils pourront pas faire planter ton WinBlows9x ! (FANTASTIQUE !)
     Et en plus, tu peux partager un lien internet avec tout un rΘseau local!
     Et faire chier vidΘotron en plus, lΘgalement !
     (COOL, MA POUVOIR ╔COEURER LE MONDE! NANAN╚REUH!)
     Ta Yeule.
     "Ok."

     Bon, alors, on y va. Si tu as installΘ RedHat comme je l'avais dis,
     ya pas grand chose α faire. Sinon, le fun commence.

     ************ D╔BUT DU FUN NOIR *****************
     Bon, mettons t'as installΘ la distri IGA-Linux 0.1b :] &lt;subliminal>
     Pis que ta carte rΘso MARCHE. (#linuxqc pour les help, on est fort la dessus)
     Pis la le kernel mesure 2k :)
     ben ya bien des chances que le support pour (attention le long mot)
     IP MASQUERADING (masquarade d'ip en Franτa !) sois pas mis.

     Fake suis les instructions suivantes.

     habituellement les sources du kernel sont placΘ dans /usr/src/linux
     ou dans /usr/src/linux-&lt;version> (ex: linux-2.0.36)

     mais anyway ya souvent un lien linux@ ->linux-2.0.36
     (WOw man, la tu m'As fourrΘ !
	...
	&lt;wyzeman> nous nous excuson du fait que Synoptic semble avoir pris recamenet possession d'un ecran
     ...
     (hein quelle suce !?!?
      - celle la --> PAF!
      - Ouch! innocent, m'as t'en crisser une moΘ --> BANG!
     ...
     la t revenu au prompt (α l'invite pour ceux de QuΘbec :P)
     ...
     *
     ...
     Moi j'aime ca les modules effouarΘs
     J'aime ben ca quand chus fatiguΘ

     (c) Alliance BARF-Synoptic
           Tous droits reservΘs
                           1999
     ...
     Avant, faut ke tu aie configurΘ un Carte rΘso pour une ip locale
     soit eth1 (deuxieme carte PHYSIQUEMENT prΘsente)
     ou soit eth0:0 (carte rΘso virtuelle, en fait c'Est une deuxieme assignatin d'adresse a eth0)
     bon whatever, tu adapte en consΘquence pour l'exemple.
     ...
     pis ajoute ces lignes la:
        ...
        ipchains -A forward -s 192.168.1.0/24 -j MASQ                     #ipmasquerading rule
                               ^^^^^^^^^^^
                               adresse IP LOCALE DU R╔SEAU correspondant a eth1 ou eth0:0 genre.

       l'adresse ip de la carte ici pourrait varier de 192.168.1.1 α 192.168.1.254.
       Bon ben naturellement, tu adapte l'adresse ip avec celle que ta choisi
       (souvent 192.168.1.0 ou 192.168.0.0) --> tout dΘpendement de l'ip de la carte locale.
     ...
     le netmask tu met
     255.255.255.0 (genre)
     pis le GATEWAY tu met l'ip de la carte rΘso local de ta box
     192.168.1.1
     ...
     pour les FTP sois assurΘ que a ctheur tu te connect en mode passif (PASV)
     IRC, les DCC vont marcher.
     Pour icq c plus tochΘ.
     ...
     ok bingo !
	      ...
	      Tout ce que tu veux faire marcher comme programme sur windows ma is
   	      ...
   	      c'est LA rΘfΘrence. Sans farce, vas faire un tour. ca donne full truc.
     ...
     LE IDENT MARCHERA PUS. IL EXISTE UN PROG POUR EMULER UN GENRE DE IDENT
	  	     mident
     CHERCHE LE, J'AI PAS PLUS D'INFO LA DESSUS. MAIS JLAI D╔JA FAIT MARCH╔ YA 2 ANS :)
     ...
     Bonne nuit les copain, pis surtout bonne veillΘe!!!
 ...
 .    
   ...
   ______________                             _____     __ _____
    ...
    |__          __|__ __    __ _____           \     \  | /     /__
      ...
      savoir quen VB l'unitΘ de calcul cest des TWIPS, pas des PIXELS, pour pouvoir
     ...
     TYPE Publique et privΘ:
     -----------------------


     il y a 2 types de variables sous VB, les PUBLIC et les PRIVATE. Leurs usages
     est identique, la seule difference cest que la variable privΘ se declare qua
     ...
     Cette fonction va permettre d'ecrire dans la boite DUMP avec le plus de securitΘ et
     de simplicitΘ possible. le programme va tout d'abord s'auto-connecter des son demarrage
 ...
 .    
      ...
      So called: Criss y'a pas une doc α jour sur le net

     Windows 2000 c ben cool aprΦs 3-4 ans de Windows 95 et 98. On
     dirait que 95% des problΦmes sont rΦglΘs, sans en ajouter de
     nouveaux genre :) Vla une liste rapide des avantages de runner
     Windows 2000 au lieu de 98:

     1: Ca crash a peu prΦs jamais.
     2: Un programme qui crash va avoir ben dla misΦre a faire crasher
        le reste du systΦme. On peut toujours faire ctrl-alt-del et
        le killer.
     3: Utilisation intelligente de la mΘmoire: avec windows 98, au
        bout d'une heure ou deux toute ma mΘmoire Θtait utilisΘe mΩme
        si je faisais RIEN avec l'ordi, et je me mettais α swapper
        tranquillement de plus en plus. Criss 192 megs de ram devraient
        garantir la paix α n'importe qui en thΘorie, eh ben NON. Mais
        Windows 2000 se stabilise (sur mon systΦme) avec 80-105 megs
        utilisΘs et ne grossit plus. MΩme aprΦs une semaine d'Ωtre
        bootΘ mon RAM est encore la, ca fait du bien de pu se le faire
        piper dans /dev/null!
     4: NTFS: NTFS est un filesystem capable de rΘcupΘrer sans
        difficultΘ d'une panne de courant ou d'un Reset. Plus jamais
        vous aurez d'Θcran "Windows a ΘtΘ fermΘ incorrectement blablabla"
     5: NTFS Permet aussi de compresser α la doublespace seulement les
        fichiers ou les rΘpertoires que vous voulez. Par exemple moi j'ai
        fait compresser mon C:\Program Files... Tout est encore accessible
        mais ca prend moins de place sur le HD.
     6: Quand je demande de faire un delete sur un rΘpertoire, la criss
        de fenΩtre "yes no cancel ALL" vient juste UNE FOIS j'ai pas
        besoin de cliquer sur ALL 20 fois!
     7: Mon disque dur vient pas hyper lent sur les opΘrations de move et
        rename quand y'approche de plein comme avec Windows 98
     8: Support multiprocesseur: Ca c plus FreeQ qui en profite, mais ca
        donne un boost apprΘciable de performance α Quake3 avec R_SMP 1 !
     9: Beaux ptits menus fade-in cute et le curseur de la souris a une
        ombre (bof) :)
     10:A peu prΦs jamais besoin de rebooter quand vous faite un changement
        de configuration (les changement au rΘseau par exemple)
     11:Mixage sonore: Vous pouvez jouer α Quake3 en Θcoutant des MP3, et
        vous allez encore entendre les calls de ICQ, mΩme sur une vielle
        Sound Blaster 16. Inutile d'avoir une carte de son PCI α 100$
        dΘsormais!

     Et contrairement α Windows NT4, DirectX 7 fonctionne avec Windows 2000
     (il est dΘja inclus). Contrairement α NT5 Beta2, les programmes de
     graveur marchent aussi.

     La question des drivers: Windows 2000 reconnaεt la plupart des cartes
     vidΘo, mais pour Ωtre certain que vos jeux vont marcher jvous conseille
     de trouver des drivers pour Windows 2000 (les drivers Win98 Win95 ou
     NT4 ne marcheront *PAS*). Demandez moi mΩme pas ou en trouver, faites
     ...
     que je vais vous expliquer ici, mais la plupart du temps sont passΘ
     ...
     que je pourrais sharer mon expΘrience...

     Au cas ou ca vous tente de rΘussir votre CD du premier coup sans
     en peter 4-5 au cours d'un long processus d'essai et erreur...
     Voici la recette authentique, directement de ma famille α la v⌠tre:

     IngrΘdients:
     1    Graveur
     1    CD gravable (ou plus dΘpendant de votre habilitΘ)
     1    Cdrwin.exe (www.goldenhawk.com) (Oubliez Easy Cd Creator)
     1    Notepad.exe (ou edlin ou copy con)
     5186 Fichiers du rΘpertoire \i386 d'un CD non bootable ou d'une
          distribution warez de windows 2000 pro RC2
     1    Fichier image du boot sector d'un cd de Windows NT 4 bootable
          (en thΘorie inclus avec le zine, nt4boot.bin)

     Instructions:

     1: CrΘez un rΘpertoire de travail sur votre HD, disons C:\WIN2000
     ...
     2: copiez les 4002 fichiers 0401.CS_, 0404.CS_, 0405.CS_, 0406.CS_, 0407.CS_,
        ...
        ZAPOTEC.BM_, _BEFAULT.PI et les rΘpertoires COMPDATA, LANG,
        SYSTEM32, UNIPROC, WIN9XMIG, WIN9XUPG et WINNTUPG dans le
        rΘpertoire C:\WIN2000\i386

     3: Dans notepad.exe, crΘez un fichier qui dit 'All⌠ maman' et
     ...
     4: Maintenant vous pouvez starter CDRWin. Suivez ce cheminement:
         ...
         Directory Options:
          Recurse Subdirectories α ON
          Include Hidden Files α ON
          Check Directory Depth α OFF
          Include System Files α ON
          Include Archive Files Only α OFF
          ISO9660 Options:
          Long Filenames (Joliet) α ON
          Disable Version Numbers α ON
          Disable DOS Compatibility α OFF
          Advanced Options:
           Bootable Disc:
            Make Bootable Disc α ON
            Media Emulation Type α CUSTOM
         ...
         Recording Options:
          Disc Type: CDROM
          Track Mode: MODE1
          Finalize Session α ON
          Write Postgap α ON
          Open New Session α OFF     
          Test Mode α OFF
        START

     Pour graver un CD bootable de Windows 2000 RC3 Pro, la recette est
     exactement la mΩme sauf que y'a ptet quelques fichiers de plus ou
     de moins.

     Pour graver un CD bootable de Windows 2000 RC2/RC3 Server, renommez
     le fichier CDROM_IP.5 α CDROM_IS.5
 ...
 .    
  ...
  stupide  puisqu`∞l  est  prouver que  la terre est bien ronde ( en 2d ou en 3d, ) 
 ...
 .    
     ...
     Si vous Ωtes un lecteur habituΘ des zines IGA et bien vous vous demandez probablement 
   pourquoi un autre article sur les buffer overflows il y en n'a dΘjα eu dans le zines prΘcΘdents.
   Eh bien les autres articles on surtout ΘtΘ axΘe sur windoze donc j'ai eu envie d'en faire un pour
   linux .


     Commenτons par ce que vous devez savoir avant de continuer
   (pas obliger mais ca facilite la tΓche) :

 	- vous devez avoir lu le texte de __2 (#10) et de _rix(#11) sur les buffer overflow
	  ce que vous avez probablement dΘjα fait vu votre admiration pour les zines IGA

	- connaitre le C et l'assembleur

	- un peu de connaissances Linux

	- une tΩte sur les Θpaules

     Ce texte n'expliqueras pas en dΘtails exactement quoi faire mais donneras des exemples sur
   certain techniques pour aider a exploiter des buffers overflows sous linux. Vous n'avez qu'a
   expΘrimenter par vous mΩmes pour apprendre le reste.

   1-Comment passer le filtrage

     Certains programmes sous linux utilise dans leur code pour prΘvenir les buffers overflow une
   technique qui consiste a filtrer certains caractΦres ou qui les remplaces par d'autres
   afin de rendre plus compliquer la rΘalisation de votre plan dΘmoniaque qui est le
   "stack smashing".
   ...
   --- snip --------------------------------------------------
     ...
     La vous vous demandez mais quest que ca fou si ca filtre les caractΦres?? Eh bien dans ce cas
   ...
   peut par exemple insΘrer "\x2f\x12\x19\x1e\x2f\x23\x18" au lieu de
   ...
   executer un shell.
     ...
     On peut facilement changer d'un α l'autres en ajoutant "\x50" a chaque membre. Dans le genre
   ...
   Ben on pourrait le changer pour une instruction qui fait la mΩme chose mais sans lettre
   ...
   Bon c'est fini pour cette article ci, un peu court mais bon manque de temps . Peut-Ωtre
 ...
 .        
    ...
    Comment semer la zizanie α Washington, avec un AK-47 et un peu de coca∩ne


 
    Mis α jour le samedi 20 novembre 1999
    ...
    renseignement des Etats-Unis, s'irriterait de ses propos rΘvΘlant  quelques-uns des 
    mots-clΘs grΓce auxquels le rΘseau d'espionnage Echelon Θcoute la planΦte entiΦre ? 
    Ses indiscrΘtions, en tout cas, ont eu de  redoutables  effets,  qui  expliquent la 
    colΦre  des  responsables  de  la  NSA,  une  agence fΘdΘrale que dirige le gΘnΘral 
    Michaδl  Haydon  depuis  Fort  George Meade, dans le Maryland, et qui emploie 38000 
    personnes α travers le monde,  aux  Etats-Unis,  bien s√r, mais aussi au Canada, au 
    Royaume-Uni,  en   Australie  et  en  Nouvelle-ZΘlande,  pour s'en  tenir aux sites 
    principaux.

    Selon  un  spΘcialiste  de  l'espionnage,  Jacques Baud,  la NSA contr⌠le une vraie 
    ½ multinationale ╗ du renseignement, baptisΘe  Echelon, ½  qui  a  fait  Θclater la 
    notion  traditionnelle  d'Θcoutes  tΘlΘphoniques ╗ .  Ce  rΘseau  peut  intercepter 
    l'ensemble  des  transmissions  et  transferts  de  donnΘes  (fax,  e-mail,  telex,
    tΘlΘphone) qui transitent par le moyen des satellites  de  communication  dans  le 
    monde et dont le contenu est conservΘ sous  forme  de  bibliothΦques informatiques.
    ...
    dictionnaire, distribuΘ aux agents d'exploitation  dans  les stations, qui contient 
    des mots-clΘs permettant α un logiciel  spΘcial,  dΘnommΘ  Oratory, d'aller repΘrer 
    automatiquement  le  message  intΘressant  dans  la  galaxie  des    communications 
    interceptΘes.

    Echelon ramΦne,  dit-on,  chaque demi-journΘe, l'Θquivalent en information de toute 
    la bibliothΦque du CongrΦs amΘricain,  soit 1 000 milliards de bits. Les mots-clΘs, 
    une  fois  identifiΘs,  servent  α sΘlectionner dans les messages l'informatio n de 
    nature diplomatique, Θconomique,  militaire ou autre, voire privΘe, qui est c ensΘe 
    intΘresser  le gouvernement fΘdΘral. Le professeur Simpson a livrΘ quelques-uns  de 
    ces mots-clΘs. ½ AK-47 ╗ (l'autre nom du fusil d'assaut Kalachnikov), ½ Coca∩ne ╗ , 
    ½  Stinger ╗ (du nom du missile antiaΘrien portable), ½ TWA 800 ╗ (l'identification 
    du  vol  du  Boeing  qui a explosΘ au-dessus de l'Atlantique en 1996), ½ Militia ╗, 
    ½ Davidian ╗ (le surnom de la secte de Waco en 1993) ou ½ Vince Foster ╗ (un ami de 
    Bill  Clinton  travaillant  α  la  Maison  Blanche qui s'est donnΘ la mort en 1993) 
    constituent  autant de mots-clΘs qui permettent aux ordinateurs de la NSA de gagner 
    du  temps,  dΦs  qu'ils  sont  dΘtectΘs dans la traque des messages qui auraient un 
    rapport, par exemple, avec le commerce des armes, le trafic de la drogue, des actes 
    de terrorisme ou avec de mystΘrieux ½ proches ╗ de M. Clinton.
 
    Depuis, et c'est ce qui explique la colΦre de la NSA, ces mots-clΘs sont repris par 
    des  services  secrets  Θtrangers,  des  chancelleries  ou   par  des  particuliers 
    ½ internautes ╗  qui  en  Θmaillent  systΘmatiquement leurs communications ou leurs 
    conversations.  Avec  cet  espoir û  jubilatoire û de saturer les ordinateurs de la 
    NSA,  de  prendre  α  son  propre piΦge tout le rΘseau amΘricain d'espionnage et de 
    perturber,  en  les  noyant sous les messages α dΘcrypter, le travail des analystes 
    attachΘs  α  Echelon.  Plus  qu'un  jeu,  sans  doute,  c'est un moyen utilisΘ pour 
    dΘclencher  inutilement  l'interception,  le tri et l'exploitation du renseignement 
    ainsi  rΘuni.  Nul  ne  doute  que la NSA cherche dΘjα α inventer la parade α cette 
    ½ cyberwar ╗. 
    ...
    ΘlΘgante que de nombreux  trous du cul semblent avoir choisi. Pour ca, ouvres 
    un session DOS par Windows et tape  fdisk  /mbr. Ca va effacer lilo qui etait 
    installΘ sur le MBR de ton disque dur, comme ca tu  n'auras plus a te soucier 
    ...
    C'est une question bien naturelle. J'ai pensΘ a toi petit looser et voici une 
    ...
    - "Ralala le bouffon  que  c'est  lui !  Il s'est installΘ un Red Hat !! Tain 
    ...
    Avec ce genre de petites phrases, tu te retrouveras tres vite classΘ dans  la 
    categorie "OK c'est un trou du cul,  mais  un trou du cul sous Linux", ce qui 
    est la premiere Θtape pour etre  un vrai hacker. Maintenant que tout le monde 
    sait que tu as ton Linux, il faut passer au  stade  suivant, celui du pro des 
    reseaux, genre le mec qui maitrise ICMP a mort. C'est la deuxieme  Θtape   de 
    ton long periple.

    Je ne suis qu'un assoiffΘ de connaissance.
    ...
    titre soit compliquΘ. Un petit  "Protocole  rlogin  sur  reseau  Ethernet  en 
    ...
    compliquΘs aux  endroit  les  plus  visibles. Corne quelques pages pour faire 
    ...
    conneries du genre "Je ne suis qu'un  assoifΘe  de  connaissance".   OK,   tu 
    quadruple ta seconde, mais bon c'est pas grave, tu aimes quand meme apprendre, 
    c'est ta grande passion et tu as beaucoup de volontΘ. Precise bien que jamais 
    ...
    La communautΘ des hackers a 1 piace.
    Quand on est  un  mec  dangereux  comme toi,  on doit se rΘunir avec d'autres 
    bandits pourmettre en peril la suretΘ de l'Etat.  Pour ca il existe LE rendez 
    vous de toute la racaille, c'est le Meet 2600. Tous les mois, tu iras dans un 
    MacDo de QuΘbec, Place d'Iyouville, et la tu rencontrera des grands monsieurs, 
    des mecs qui ont rebootΘ tout Internet avec un prog en  Visual  Basic  et qui 
    ont des coupes de cheveux de rebels de la sociΘtΘ. Bon, tu n'y apprendras pas 
    grand chose, les loosers qui viennent la bas se branlent entre  eux  en    se 
    disant "Ouais, on est des hAcKeRz, on est sans pitiΘ, on est des vrais  durs, 
    ...
    truffΘ de cameras et de micro, et que tous les employΘs sont des agents de la 
    ...
    La communautΘ des hAcKeRz aime bien aussi les raves.  Ca fait  partie du trip 
    ...
    paumΘ que d'aller jouer les chauds dans ces soirΘes.
    ...
    bouquins sur Unix, tu n'as jamais hackΘ la moindre machine de  ta vie donc tu 
    ...
    plus compliquΘ, personne n'ira  verifier,  donc  vas  y  lache  toi  t'es  un 
    assoiffΘ de connaissance, oublie pas.
    ...
    leur a encore collΘ un virus d'Internet. Il va donc falloir, au quotidien, se 
    ...
    que tes amis et ta famille auront bien vu que  tu as changΘ, que tu n'es plus 
    ...
    ou  les #amitiΘ_fr, maintenant tu devras aller dans les bas fond de l'IRC, le
    ...
    -=DarkNet=- de vous faire part de nos commentaires sur nos plus rΘcentes
    dΘcouvertes en matiΦre de jeux. Je ne vous parlerai pas de tous les
    nouveaux jeux, juste une couple. (faut ben finir un madnΘ)
    ...
    Rating; 8╜/10
    Commentaires; Driver est trΦs populaire au playstation, la raison est
                  sans-doutes  la   qualitΘ   de   ses  graphiques, assez 
                  impressionnants  pour une machine comme le playstation. 
                  Au PC, les graphiques sont  encore plus poussΘs. Driver 
                  est biensur un jeux d'char, mais ou l'on doit accomplir 
                  des missions. (un peu comme GTA2)  Le   jeux  peut   se 
                  dΘrouler  dans   4   villes connues,  et  une cinquiΦme 
                  "bonus". Le jeux se dΘroule trΦs rapidement, la  police 
                  est souvent  α notre  cul, et elle est assez agressive; 
                  quand on est vraiment  poursuivi,  on dure pas plus que 
                  deux minutes. Driver est un  exelent   jeux,  mais j'ai 
                  trouvΘ dommage qu'on ne puisse pas aller dans   les   4 
                  villes dΦs le dΘbut, et aussi.. y'a pas mal de   police
                  au km▓ hehe.
    ...
    Commentaires; Unreal Tournament est la suite du populaire jeux UNREAL.
                  ...
                  donnant au jeux une toute autre allure. Contrairement α
                  ...
                  seul,  mais  sont  plus  apprΘciΘs  en multiplayer. Les 
                  graphiques  du  jeux sont d'une trΦs bonne qualitΘ, les
                  dΘcors  biens construits, et le "gameplay" interessant. 
                  CotΘ que j'ai plus ou  moin  aimΘ  est  l'irΘalisme  de 
                  cerains   mouvements,  et  la  stupiditΘ  des  bots  en 
                  "capture   the   flag".   Pour   downloader   la  dΘmo:
    ...
    Commentaires; Grand Thief Auto 2 plus connue sous le nom de GTA2, qui 
                  est la suite  du  jeux  GTA,  Θvidament  :-). Jeux trΦs 
                  grandement amΘliorΘ. je parle surtout  des  graphiques, 
                  son  et  mission.  En  rΘsumΘ pour ceux ou celle qui ne 
                  connaissent pas le principe du jeux, qui d'ailleure est 
                  trΦs simple. C'est que vous  recevez  des  missions par 
                  des leaders de contrebandes de  toute  sorte,  et  vous
                  devez  effectuer c'est mission que vous devez accomplir 
                  pour reτevoir de  l'argent  c'est  comme  une  sorte de 
                  guerre des motards sauf que  dans  ce  cas-si il sont 3 
                  clan. Graphique  asser  bien  rΘaliser  une extremement 
                  grande amΘlioration a comparer au 1. Pour des videos ou 
                  infos: www.gta2.com


    -Home World-
    Type; "StratΘgie/action"
    `System requirement; Pentium II 233 mmx, win 95, 64 MB RAM, 150 MB HD
    Rating ; 9/10
    commentaires; Home World dans le  mΩme  style que starcraft, warcraft 
                  et j'en passe.

    Wyze said:    (peu etre resumer par l'appelation Warcraft like) 

                  Mais ce qui caractΘrise le plus c'est que le  jeux  est 
                  en "freespace". Vous jouer dans un espace en profondeur 
                  en hauteur. le premier jeux de sa catΘgorie
  
   wyze said:    (ya aussi mankind dans le genre, www.mankind.net)
              
                  a avoir ce type "d'espace jouable". Les graphiques sont 
                  d'une trΦs bonne QualitΘ.  Jeux qui asser difficile, on 
                  s'adapte asser vite α son  espace  de  jeux.   Il   est 
                  possible de regrouper les unitΘs, faire des formations,
                  des "convois" etc..
    ...
    J'Θcris cette article pour prouver la vulnΘrabilitΘ de service  internet  de 
    videotron qui ce dise les  meilleurs   provider  internet . Si  il  y  a une 
    personne  qui  est  abonner  a  videotron  qui vous Θnerves, vous verrez ici
    ...
    cela dis α videotron que vous  Ωtes en sur le net donc que vous demander des 
    informations .  Maintenant  si  vous  voulez  enlevez la connexion vous avez 
    seulement α commencer par vous faire un fichier  .log qui va vous servir  de 
    ...
    l'heure qui a parler .AprΦs avoir fais un .log  avec  une 10 de tentative de 
    ...
    la personne .Vue que videotron son trΦs sΘvΦre .  Votre cible n'aura plus de 
    connexion avec videotron a moins qui  prouve que ce n'est pas vrai mais avec 
    les preuves que vous  avez  fournis  sa va Ωtre pas mal dure et peux importe 
    ...
    est abattu... videotron va s√rement lui redonner  sa  connexion mais si vous 
    envoyer un autre .log qui vient de la  mΩme  personne  votre cible ne pourra 
    plus jamais avoir un account  avec  videotron  et  devra ce trouver un autre 
    provider.  S.V.P  n'utiliser pas cette mΘthode pour une petite niaiserie car 
    c vraiment chien... cela ne  marche  que pour ceux qui ont un modem cable et 
    donc toujours le mΩme IP. Et oui maintenant vous savez que videotron son pas
    ...
    Ouin aller au beau milieu de la nuit dans nos chere poubelle du QuΘbec.
    Cest ca du Trash pour ceux qui le saurais pas, cest peut-etre pas trop hygiΘnique
    ...
    ΘnormΘment dinfo mais ceci debutera une sΘrie de petit article.
    ...
    - Bureau FΘdΘral , Bureau davocat...etc *
    ...
    *Notes*
    ...
    Videotron: le ╛ sont surement surveiller, a revoir dans autre article
               Bureau davocat(pas les legumes biensur): Est situΘ proche du marcher a qc
