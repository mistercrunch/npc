...
|5 | C crazy tutorial              by Wyzeman     |  Plonger dans mes pensΘes
|6 | Desjardins pas encore toe     by Qwzykx      |  le coeur briser
|7 | Another faker like SCANDISK   by |JaCKeL|    |  l'esprit troublΘ
...
`\/-----------------------------------------------'  A un point ou plus rien ne vient
   ...
   www.undernetsuxx.org            Mais des nuits j'ai pleurΘs
...
Un webproxy est identique dans sa fonctionnalitΘ a un wingate,
...
AccΦs Communications Internet Inc.
28.00$ par mois pour un temps illimitΘ
Ratio : 8 utilisateurs par ligne
Frais de branchement : Aucun
E-mail : information@acica.com
No. de tΘlΘphone : (418) 524-5458

ClicNet TΘlΘcommunications Inc.
24.95$ par mois pour un temps illimitΘ
Ratio : 9 utilisateurs par ligne
Frais de branchement : Aucun
E-mail : info@qbc.clic.net
No. de tΘlΘphone : (418) 686-2542

Digital Design Inc.
35.00$ par mois pour un temps illimitΘ
Ratio : 4 utilisateurs par ligne
Frais de branchement : Aucun
E-mail : webmaster@ddi.qc.ca
No. de tΘlΘphone : (418) 688-4242
...
No. de tΘlΘphone : (418) 821-1180

Total Net
Plan A :26.95$ par mois pour un temps illimitΘ
               Ratio : 10 utilisateurs par ligne
               Frais de branchement : 29.95$
No. de tΘlΘphone : (418) 527-7120 ou 1-800-920-7873
*MontrΘal, QuΘbec, Granby*
Plan B :23.95$ par mois pour un temps illimitΘ
               Ratio : 7 utilisateurs par ligne
               Frais de branchement : 15.00$
E-mail : admin@total.net
No. de tΘlΘphone : (514) 481-2585 ou 1-800-920-7873
...
No. de tΘlΘphone : (418) 683-4557

NetRover Inc.
*Chicoutimi, Hull, MontrΘal, QuΘbec, Sherbrooke, Trois-RiviΦres*
26.95$ par mois pour un temps illimitΘ
Ratio : 10 utilisateurs par ligne
Frais de branchement : Aucun
E-mail : info@netrover.com
No. de tΘlΘphone : (514) 877-4262 ou 1-800-605-4445

Sprint Canada
22.95$ par mois pour un temps illimitΘ
Ratio : 7 utilisateurs par ligne
Frais de branchement : Aucun (Premier mois gratuit)
E-mail : info@sprintcanada.ca
No. de tΘlΘphone : 1-888-814-3279

VidΘotron LtΘe
*Bromont, Chicoutimi, Hull, MontrΘal, QuΘbec, Sherbrooke, Trois-RiviΦres*
26.95$ par mois pour un temps illimitΘ
Ratio : 
Frais de branchement :
E-mail : serviceclient@videotron.ca
No. de tΘlΘphone : (514) 281-6661 ou 1-888-281-6661

Modem-CΓble

VidΘotron LtΘe

Plan D : si non abonnΘ au service de VidΘotron de la tΘlΘvision 
                 39.95$ par mois pour un temps illimitΘ
                 Frais de branchement : 69.95$
                 Frais de location : 19.95$ par mois
Plan F : si abonnΘ au service de VidΘotron de la tΘlΘvision
                29.95$ par mois pour un temps illimitΘ
                Frais de branchement : 69.95$
                Frais de location : 14.95$ par mois
Plan E : 39.90$ par mois pour un temps illimitΘ
...
Hello !
Voilα, je vais vous parler un petit peu de la programmation
...
- dΘjα l'assembleur sous dos, c'est vachement
  compliquΘ, alors l'assembleur windows ?

Et lα je vous rΘpond:

- l'assembleur windows est selon moi plus facile que
  l'assembleur sous dos (jvai vous montrer ;)

- l'assembleur windows permet d'accΘder de facon trΦs
  puissante α toute une sΘrie de fonctions particuliΦres. 
  Ca va nous permettre de programmer directemment le 
  systΦme (programmer des drivers par exemple), de faire
  des trojans, de programmer des dlls appelables par 
  un autre language...

- l'assembleur windows crΘe du code ultra-ultra 
  compact ! On peut par exemple avoir un programme
  .exe de 10K ! Oui, pour un programme  windows !
  On croit rΩver :)

- l'assembleur windows permet de crΘer des programmes
  ultra rapides !

- l'assembleur windows peut servir α patcher ou α cracker
...
Ben lα, y a pas mal de choses α aller chercher avant de 
s'y mettre, hehe.
...
les librairies de dΘclaration des APIS : pour pouvoir 
faire appel α toutes les APIs (fonctions)  windows ->

L2INC : pour crΘer les fichiers d'include (dΘclarations) de ces librairies -> 

WINDOWS.INC : un fichier de dΘfinitions de pleins de constantes WINDOWS -> 

et puis Θventuellement (c'est quand mΩme vachement conseillΘ ;)

WIN32.HLP (fichier de rΘfΘrence de toutes les APIs windows) -> 
OPCODES.HLP (fichier de toutes les instructions asm 16bits et 32bits) -> 
MASM32.HLP (fichier de toutes les nouvelles macros et instructions dΘfinies dans MASM32) ->

Ceci est facilement trouvable sur le net.

INSTALLATION
============
Maintenant que vous avez ΘtΘ chargΘ tout ces beaux zips, 
va s'agir de les installer convenablement :))))

D'abord, tu vas crΘer un beau rΘpertoire MASM, par exemple C:\MASM32 :)))
Lα dedans, tu dΘzip le fichier zip de masm32. Il va crΘer toute une sΘrie de rΘpertoires,
comme par exemple C:\MASM32\BIN (le compilateur, etc...), C:\MASM32\LIB, C:\MASM32\INCLUDE ,etc..

Une fois que c'est fait, tu vas dans le rΘpertoire C:\MASM32\LIB, et
tu dΘzip le fichier zip des librairies. Ca va crΘer tout pleins de 
fichiers .LIB dans ce rΘpertoire.

AprΦs ca, tu copies le pti programme L2INC.EXE dans le rΘpertoire
C:\MASM32\BIN, puis tu vas dans le rΘpertoire C:\MASM32\INCLUDE et tu
lances ceci:

C:\MASM32\BIN\L2INC /M C:\MASM32\LIB\*.LIB

Ca va crΘer toute une sΘrie de fichiers .inc dans le rΘpertoire
C:\MASM32\INCLUDE.

Puis enfin, tu peux copier le fichier WINDOWS.INC dans le rΘpertoire
C:\MASM32\INCLUDE aussi.


LES BASES
=========
Qu'est-ce que l'assembleur windows a de diffΘrent par rapport 
a l'assembleur dos ?

Ben dΘjα, il est en 32bits, alors que l'assembleur DOS est en 
16bits ! Ca veut dire quoi ?

Ben ca veut dire en gros que tout les nombres avec lequels ont
va chipoter vont plus Ωtre limitΘ de 0 α 65535, mais de 0 α 
65535*65535 (jmen fout du rΘsultat exact du calcul hehe, mais je
sais que ca fait beaucoup ;)  Bon vous allΘ me dire "nous on veut
pas faire de calcul" ! Ok  ok ! hehe :) Mais C'est pas parce que 
vous voulez pas en faire que votre chti processeur en fait pas 
quand il exΘcute vos programmes ;)

Par exemple, si vous connaissez dΘjα un ti peu l'assembleur sous
DOS, vous savez qu'il faut souvent chipoter avec les "segments".
Ben sous Windows, c'est terminΘ. En fait c'est pas vraiment terminΘ,
 mais c'est le systΦme qui le fait pour nous automatiquement ;)

Les APIs... Qu'est-ske c'est encore que ce mot tordu ? :)
Ben les APIs, c'est toutes les fonctions que Microsoft a codΘ dans
...
l'affichage des fenΩtres, la saisie de donnΘes, l'affichage de 
belles images et de belles couleurs, mais aussi l'ouverture de 
connections vers Internet, l'Θcriture sur votre disque dur,
jouer des fichiers sur votre carte sons, sortir un beau listing
 sur votre imprimante, ... :))

Et c'est ptΩt pour ca que l'assembleur Windows est plus facile que
l'assembleur Dos. Parce que justement y a des kgs de fonctions toutes
prΩtes α l'emploi, et le programme en assembleur n'a pas tellement α 
faire de plus que de les appeler dans le bon ordre :)

Pour savoir quelles APIs utiliser, ben il faut souvent aller zieuter
dans le fichier WIN32.HLP que je vous ai conseillΘ !

Alors maintenant on va parler un ti peux plus en dΘtail de la 
maniΦre de programmer en assembleur windows. Tout d'abord, il faut
...
Si vous connaissez dΘjα un petit peur l'assembleur DOS, vous 
savez que les registres ressemblent α ceci:
...
Ben en assembleur 32bits (Windows), il y a encore une 3Φme partie, et
ca donne ceci:
...
Chacun de ces registres a une fonction particuliΦre, pour lequel il
est "optimisΘ":

EAX sert comme valeur de retour des APIs, et comme registre pour
les multiplications

EBX sert α recevoir des adresses de variables
ECX sert le plus souvent de compteur
EDX sert α un peut tout le reste ;)
ESI sert α recevoir des adresses sources (d'ou on va aller chercher des donnΘes)
EDI sert α recevoir des adresses cibles (ou on veut copier, dΘplacer, des donnΘes)

Tout ces registres peuvent Ωtre utilisΘ dans les instructions
assembleur, qui sont dΘcrites en dΘtails dans le fichier OPCODES.HLP.
...
grΓce α toutes une sΘrie de macro-commandes Par exemple, MASM32 permet
maintenant d'utiliser des instructions comme ceci

.if EAX=0
 ;exΘcute les instructions si EAX=0
.else
 ;exΘcute les instructions si EAX<>0
.endif

C'est quand mΩme vachement proche d'un language comme le Basic ou
le C hein ;))) Pour le dΘtail de toutes ces nouvelles instructions,
...
petite boεte de dialogue α l'Θcran hehe :) Voici l'explication de toutes
les commandes, puis le listing par aprΦs:)

.386
;α mettre chaque fois, vous connaissez qqun qui a un 286 ET windows 95/98 dessus ? :)
...
.model flat, stdcall
;"flat", c'est une maniΦre d'organiser la mΘmoire pour ne plus qu'il y aie de segments, et juste
;des adresses mΘmoire 32bits.
;"stdcall", c'est pour annoncer au compilateur la maniΦre dont on doit passer les paramΦtres α
;des fonctions: sous windows, c'est toujours cette valeur, car les APIs utilisent ce format.

includelib c:\masm32\lib\kernel32.lib
includelib c:\masm32\lib\user32.lib
;on dΘclare dans includelib toutes les librairies qui contiennent les APIs windows qu'on va
;utiliser. Kernel y en a besoin chaque fois (fonctions de bases dans tout les programmes Windows)
;et User, c'est toutes les fonctions qui concernet les APIs d'interfaces (affichage de fenΩtres,
;boites de dialogues, etc...). Le compilateur va utiliser ces fichiers .lib pour crΘer notre
;programme assembleur.

include c:\masm32\include\windows.inc
include c:\masm32\include\kernel32.inc
include c:\masm32\include\user32.inc
;on dΘclare ici tout les fichiers d'ou on va aller chercher les syntaxes d'appels au APIs.
;Ce n'est pas nΘcessaire, mais c'est vachement plus pratique et ca ne coute rien.
;Si tu vas voir dans le rΘpertoire c:\masm32\include, et que tu Θdites un des fichiers, tu verras
;la syntaxe de chaque API avec ses paramΦtres.

.const
NULL equ 0
;la section .const permet de dΘfinir des constantes.
;par exemple, ici, MASM32 saura que partout dans le programme ou il trouvera le mot "NULL", il
;devra le remplacer par le caractΦre 0.

.data
TITRE db "Titre de ma fenΩtre",0
H HINSTANCE ?
COMMANDLINE LPSTR ?
;la section .data permet de dΘfinir les variables globales (connues partout dans le programme)
;Par exemple, je dΘfinit TITRE comme Θtant une suite la bytes (caractΦres) "Titre de ma fenΩtre"
;ATTENTION, il faut toujours mettre un ",0" α la fin des chaεnes de caractΦres, car c'est le
;caractΦre 0 qui indique la fin de la chaεne aux APIS, α Windows, etc...
;ensuite, je dΘfinit HI comme Θtant une variable de type HINSTANCE (on va s'en servir plus loin)
;et dont je ne connait pas le contenu ("?"), et je dΘfinit COMMANDLINE comme Θtant un pointeur
;sur une chaεne de caractΦres (on va aussi s'en servir plu loin ;)

.code
;maintenant voilα les instructions proprement-dites du programme

Main:
;Main est une Θtiquette, et ici c'est l'endroit ou notre programme va commencer.
...
;Voici ton premier appel α une API Windows ! hehe :)
;Donc, pour appeler une API, on met une commande invoke, puis on met derriΦre le nom de l'API,
;et tout ses paramΦtres avec une ",". Notre programme va donc appeler l'API GetModuleHandle, que
;Microsoft conseille toujours d'appeler au dΘbut d'un programme Windows par compatibilitΘ avec
...
;de la valeur c'est juste par compatibilitΘ ;)

 mov H,eax
;Si on regarde dans la documentation des APIs Windows, on voit que l'API GetModuleHandle renvoie
;une valeur de type HMODULE. Microsoft Windows a maintenant dΘfini un type HINSTANCE Θquivalent,
; c'est donc pour ca que j'ai dΘclarΘ la variable H de type HINSTANCE ;)
;Donc ici, je prend le contenu du registre eax, et je l'envoie dans ma variable H (c'est pas
;nΘcessaire, c'est juste pour montrer comment ca fonctionne en 32bits ;)
;Donc l'instruction mov recoit toujours 2 paramΦtres, le 1er c'est la destination, le 2Φme c'est
;la source de la copie. Il faut souvent employer cette instruction aprΦs une API, car il nous
;faut souvent stocker le rΘsultat de l'API quelque part (dans une variable) hehe ;)))
...
;Puis je sauve cette adresse (retournΘe par l'API dans EAX) dans la variable COMMANDLINE, qui a
;ΘtΘ dΘfinie du type LPTSTR puisque c'est mentionnΘ comme ca dans WIN32.HLP ! :))))

 invoke MessageBox,NULL,COMMANDLINE,addr TITRE,MB_OK
;Maintenant, j'appelle l'API MessageBox, qui ouvre une belle petite fenΩtre, avec un titre, et
;belle phrase dedans, et un beau bouton "OK" :))))
;Le paramΦtre NULL est ici utilisΘ, parce que dans WIN32.HLP, on mentionne que le 1er paramΦtre
;doit Ωtre NULL s'il n'y a pas de fenΩtre dans laquelle doit apparaεtre notre boite de dialogue,
;ce qui est le cas ici puisqu'on a pas crΘΘ de fenΩtre !
;Ensuite l'API doit recevoir une adresse d'une chaεne qui contient la phrase α afficher.
;Nous on va afficher ici la ligne de commande de notre programme, donc on donne comme paramΦtre
;la variable COMMANDLINE.
;Puis le paramΦtre suivant doit Ωtre l'adresse d'une chaεne qui contient le titre de la boεte de
;dialogue.
;ATTENTION ! L'API nΘcessite une adresse. Or nous avons dΘfinit une variable TITRE. Pour fournir
;son adresse, on doit mettre l'identificateur "addr" devant.
;Enfin, le dernier paramΦtre est une constante qui indique le type du bouton de la boite de
;dialogue. Ici on veut seulement un bouton "OK", donc on utilise la constante MB_OK dΘfinie dans 
;le fichier WINDOWS.INC.

 invoke ExitProcess,NULL
;Enfin, pour terminer notre programme, on doit TOUJOURS appelΘ cette fonction (un peu comme sous
;DOS, on doit appeler une fonction de l'interruption 21h). On doit lui donner comme paramΦtre un
;code de retour, ici on donne un code de retour = α 0.

end Main
; indique au compilateur qu'il n'y a plus rien aprΦs !
;ATTENTION: mΩme s'il y a des instructions aprΦs, le compilateur ne les lira pas !
...
Pour compiler ce petit programme et crΘer l'exΘcutable, il ne nous 
reste plus qu'a lancer les commandes suivantes:

C:\MASM32\BIN\ML /c /coff /Cp exemple1.asm    
(pour assembler notre programme et crΘer un .obj)

C:\MASM32\BIN\LINK /SUBSYSTEM:WINDOWS exemple1.obj   
(pour crΘer l'exΘcutable exemple1.exe)

Regardons tout d'abord la taille de notre exΘcutable: 2560 octets !
Qu'est-ce que je vous disais que c'Θtait compact ;) Vous pouvez 
toujours essayer de crΘer le mΩme programme avec Visual C++ en 2,5K ;)

Nous pouvons lancer ce petit programme, par exemple en tapent 
'EXEMPLE1 paramΦtre' Et tu devrais avoir une petite boite de dialogue
qui s'ouvre, avec comme titre 'Titre de ma fenΩtre', et comme message
 '"rΘpertoire\exemple1.exe" paramΦtre', et un petit bouton OK.

Voici maintenant quelques conseils, pour programmer en assembleur.
L'assembleur permet facilement de crΘer de petits programmes, par 
contre, si vous voulez crΘer un super Θditeur ou un client IRC, je 
ne vous conseille pas de le faire en assembleur ;)

En fait, tout ce qui concerne l'interface est assez difficile α 
rΘaliser en assembleur. C'est beaucoup plus facile de rΘaliser 
cela avec des clicks de souris dans Delphi,Visual Basic ou
Visual C++.

Par contre, si tu dΘsires coder un petit programme ne nΘcessitant pas
beaucoup d'interface, mais faisant appel au fonctions systΦmes de 
Windows, il devient trΦs avantageux d'utiliserl'assembleur Windows.

Je te conseille aussi de faire un petit fichier .bat permettant
d'assembler et de compiler en mΩme temps, car ca permet de gagner 
...
Il faut d'abord savoir que Windows contient une infinitΘ de fonctions ! :))))
Le meilleur moyen pour se renseigner est d'avoir le fichier WIN32.HLP,
qui fournit les paramΦtres, les valeurs de retour, la syntaxe, et les 
explications pour toutes les APIs documentΘes de Windows, et ca fait 
dΘjα pas mal :)

Par exemple, windows contient des APIs pour gΘrer des chaines 
(lstrcpy, lstrcmp,...), donc pas besoin de reprogrammer ca en assembleur,
des APIs pour gΘrer des sockets (programmation Winsock, Internet,...) 
des APIs systΦmes (pour lancer d'autres exΘcutables, pour crΘer des Services,
pour accΘder aux donnΘes d'autres programmes, accΘder au fichiers,...), 
des APIs GUI (pour crΘer des fenΩtres, des boεtes de dialogues,etc...)

Pour ceux qui connaissent dΘjα un peu d'assembleur sous DOS, il faut savoir que toutes les
instructions assembleur 16bits, fonctionnent parfaitement, mais que vous pouvez aussi utiliser
toutes ces instructions avec les registres 32bits, ce qui fortement conseillΘ.
De plus, toutes les instructions faisant appel aux segments sont quasiment inutiles sous Windows.
Par exemple, la sΘquence suivante sous DOS:
...
,qui copie 65000 octets de l'adresse SOURCE vers l'adresse CIBLE, peut Ωtre remplacΘe par la
sΘquence suivante sous WINDOWS:
...
=================================
Nous avons maintenant crΘer un petit programme, mais c'est vrai qu'il
...
En fait, Windows et DOS sont trΦs diffΘrents, parce que sous DOS, un
programme tourne seul en mΘmoire, et il n'a pas besoin de se prΘoccuper
de l'exΘcution d'autres programmes Θventuels en mΩme temps. Donc le 
...
de son exΘcution une zone mΘmoire dans lequel il doit travailler , et 
doit respecter un certain nombre de rΦgles pour avoir une exΘcution 
"convenable".

Tout d'abord, Windows est un interface graphique, et donc, le systΦme
gΦre beaucoup de choses au niveau de l'interface. Le programme Windows
habituel se contente de collecter les informations renvoyΘes par des
boεtes de dialogues ou des fenΩtres, et de les traiter.Pou cela, 
Windows utilise un principe de "messages". Un programme Windows bien
concu doit donc s'initialiser, dΘclarer ses variables etc, puis le plus
souvent crΘer une fenΩtre, et enfin rendre la main α Windows. C'est
ensuite Windows qui gΦre cette fenΩtre, et qui exΘcute une procΘdure
spΘciale de gestion d'ΘvΦnement (messages), associΘe α la fenΩtre du
programme, selon que l'utilisateur a appuyΘ sur une touche, dΘplacΘ 
la souris, ou encore fermΘ la fenΩtre. Le programme rΘcupΦre alors la
main, exΘcute au plus vite l'action nΘcessaire, puis rend de nouveau 
la main α Windows.

Ensuite, windows est un systΦme multitΓche,ce qui signifie que non
seulement plusieurs programmes peuvent tourner simultanΘment sur la
machine (un programme est appelΘ Process), mais que un programme lui
mΩme peut faire plusieurs actions simultanΘment (une tΓche, appelΘe Thread).

Voilα, j'espΦre que cette toute petite introduction vous a donnΘ 
l'eau α la bouche, et que vous allez tous vous mettre α programmer
de bons chtis programmes sous Windows en assembleur.Je vous conseille
une derniΦre adresse, 

http://win32asm.cjb.net, ou j'ai moi-mΩme ΘtΘ cherchΘ
la plupart des informations qui m'ont apprit α programmer sous Windows !!!
C'est en anglais, mais c'est trΦs trΦs bien Θcrit et vous avez toute une 
sΘrie de tutorials sur les concepts fondamentaux et puissants de la
programmation Windows.
 
Bye bye, et a+ ptΩt pour un autre programme un peu plus consistant ;)
...
trou de securitΘ sous machines Windows  NT.       Donc on 
...
1-> SMB Sniffing, ca c'est pratique si vous testez vous meme
    ...
    admins afin de verifier votre securitΘ. Rien nous empeches
...
Essaie de cracker l'encryption en essayant tout les posibilitΘs,
...
mais par son systeme assez vague de securitΘ. Se qui va suivre n'a
...
pas ou encore un Brainstorming sur la securitΘ de ce reseau (INTERAC)
...
l'inactivitΘ!) et wow , votre fabuleuse ardoise est :
...
Ok, donc back to the reality, mr.INTERAC avec sa belle bouche a facture est "pluggΘ"
...
|         |                                                  |         |
 ---------                `- reseau cahoteux de BELL          ---------
    |                                                              |
Mr.INTERAC                                                      CAISSE
               (au cas ou vous lauriez pas remarquΘ)



Donc l'idΘe est d'enregistrΘ la petite conversation que nos deux petits monsieurs ont          
ensemble pour ensuite s'amusΘ avec...
...
En somme on vas faire no petit douanier des frontieres tΘlΘphoniques
en prenant en note de ce que Mr Interac transporte, et des son retour,
nous lui demanderons ce qu'il a α dΘclarer. Si Mr Interac apres
...
en revenant de son voyage. Et la tout est le centre de cette thΘorie;
...
un 20e de kilomΘtre de fils et lui Θviter du meme coup de faire une
...
semble le faire.. ou simplement afin de cervΘ cette magnifique
bulle de reve qu'on vous a encore une fois fait avaler, il faut
aussi tenir compte des problemes!

Par exemple, si chaques transactions etait encryptΘ(pas serieux) mais
c'est pas temps l'encryption le probleme (si on refait jouer la sΘquence
...
le message APPROUVE, il faut le rΘenvoyer, la aussi ya un probleme, faudrait
...
--------------------------------------------------------------
Attention, Attention, le programme donnΘ dans ACCESS.ZIP est 
donnΘ dans un but Θducationnel, je ne suis nulement resposable
des problΦmes que peuvent engendrΘ le VOL d'acces internet.
--------------------------------------------------------------
...
des accΦs Internet. Mais n'oubliez pas une chose, ne le
faites pas, mais si vous Ωtes MALHON╩TES et voulez le faire,
vous accepter TOUTE responsabilitΘ de votre acte.

Dans le prΘcΘdent mag (#9) __2 avait donnΘ un prog recopiant
...
dΘcidΘ de programmΘ un utilitaire semblable mais qui est
prΘconfigurer pour dΘchiffrer les login et mots-de-passes des
acces internet sur un pc, tout en Θtant trΦs soucieux de faire
ce travail sans Θveiller les moindres soupτons.

ce programme est compris avec le magazine dans le fichier
ACCESS.zip donnΘ avec le magazine.
...
test.zip    (un fake d'un zip, ATTENTION ce zip est essentiel 
             au fonctionnement de cet utilitΘ. )
...
l'ordinateur ciblΘ pour qu'un fichier pkunzip.txt contenant
les informations se crΘe sur la disquette. 
...
Remerciment spΘcial a VITAS pour son programme de dΘcodage
utilisΘ dans ce programme.
...
: Beaucoups de facon de hacker reside dans se qu'un systeme n'a
  ...
  exploiter les entieres possibilitΘs.
...
---------
 ...
 que le televiseur a bien ete voler dans une maison privΘ, infraction 
 dans une propriΘtΘ, intrusion illicite... Voler un acces internet en
 ...
 : Nous creons le probleme et nous somme l'antidote et tout ca en 1.
   Sans les hackers, la securitΘ n'existerait pas, les grosses compagnies
...
Profil #1: Petite page web albanaise ou l'on peut lire quelques articles
           ...
           contient une majoritΘ de K et de J. le systeme est vieux et
...
pas mal. Les serveurs WINGATE haute rapiditΘ sont pas mal tout LOGGER, cest
...
Quand une de ses trois commandes est appeler, il se crΘer une 2-eme connection
TCP ou l'information, la donnee passe. Le FTP BOUNCING est rendu possible
grace a cette possibilitΘ. Separons dabord les 3 commandes en 2 groupes. 
...
Bonjour tous le monde. Vous aimeriez vous faires du cash facile et lΘgalement
sur le net? Vous connaissez dΘjα les trucks de banniΦre mais pour τa, ca vous
prend  une page web et  vous n'avez  pas juste τa α  faire?  Et bien j'ai  la
solution!!  Ce petit truck toute-α-fais Θcologique,  ne poulu pas et ne cause
aucun  de  cancer  du  rectum  ou tous  t'autres maladie  indΘsirable,  apars
peut-Ωtre bien sur, la follie de l'argent.

Fonctionnement:   Entraide.  Vous  clickez  automatiquement,  sans  ouvrir  α
chaques fois internet exploseur ou netscrape, sur les banniΦres de vos chΦres
amis et ceux-ci font la mΩme chose pour vous.  Ceux qui click et font clicker
son tous ceux qui on un voice ou qui son opΘrateur (apars peut-Ωtre mon chΦre
amis X, le bot). Interessant, non?

Les rΦglement α suivre: - Pas de flood, comme un peu partout.
                        - Pas de clone, en fais on peut mais non-recommender.
                        - Timer a 300 (5 minutes) minimums!

PremiΦre Θtape et non la moindre,  allez cherche le  script source  sur  IRC.
Allez sur #StoneCash  (Channel officiel de cette merveilleuse crosse) et vous
n'avez qu'α faire /CTCP C3rv3au SCRIPT  et si C3rv3au n'est pas lα,  attendez
de 2 α 5 minutes 34 secondes MAXIMUM que celui-ci revienne.

Prochaine Θtape,  qui est la deuxiΦme,  soie dit en passant...  Installez  le
script de faτon α ce que tous les fichier (Ex.: banner.mrc) sois dans le mΩme
rΘpertoire que mIRC32.exe et ensuite, vous faites /load -rs banner.mrc ce qui
loaderas le script automatiquement (Faites YES a la question demander). Next,
vous allez joindre #StoneCash  automatiquement et si tous c'est bien dΘrouler
jusqu'ici vous devriez vous faires voice automatiquement par C3rv3au (α moins
que celui-ci ne soie pas op, #StoneHelp et faites !+)

TroisiΦmement,  maintenent que vous avez  downloader  et  installer le script
allez sur vous faires des acconts sur des sites de banniΦres payante (Ex.: un
classique,  Private Gold  www.rawcash.com  et sans oublier Most Cash α  l'URL
suivant,  www.mostcash.com).  Remplissez les formulaires en  donnant vos vrai
informations si vous voulez recevoir votre argent.

Ensuite, revenons α IRC, faites pour Private Gold la commande spΘcifique pour
...
Et voilα! Votre cash monte de plus en plus!                                  
...
fraude.
        ...
        - Recherchez les meilleurs banniΦres
        - Amenez vos amis sur rawcash. (+ de monde, + de cash)

Quelques  autres petites trucks: - Si vous avez plusieurs banniΦres comme sur
Most Cash par example, faites a place de plusieur fois !Click,  !Clickall les
mΩme codes, mais en rΘpΘtant  pour chaque abnniΦre a partir  du Domaine name.
...
c'est site ne faites que mettres les banniΦres sans rien d'autres.
- Inscrivez vous au TOP50  (www.top50.com)  et faites plus de votes avec !t50

Voici quelques petites liens de banniΦres payantes (α vous de trouvez mieu!):
...
Merci α:
        - C3rv3au pour s'avoir creusΘ la tΩte avec son script.
        - Afterlife pour #StoneHelp
        - Moi parce que c'est τa.
        - Merci aussi α  WaR_G0D  pour m'avoir  donner  son article  pleins de
          fautes et Θcrie un  peu...  voici un extrais.  "DU CASH COLISSE!!!!"
          alors vous voillez... =]]
...
└ la demande gΘnΘrale de plusieurs gars, j'ai pas ben ben eu le choix de
faire cet article. C'est mon chum, la grande trappe(wyzeman),  qui a dit
α ses copains que lui, il n'Θtait po obligΘ de se priver de sexe pendant
une semaine par mois. Ils ont voulu savoir comment τa. Alors ils venaient
me demander mon truc infaillible :P Ma       recette  miracle  c'est  le 
Depo-Provera. Les   gars,    recommendez-le α votre copine et les filles, 
empressez-vous d'aller consulter votre mΘdecin. Mais je vais plutot commencer
par vous dire α quoi vous attendre avec cette mΘthode de contraception.

Le Depo-Provera est une mΘthode de contr⌠le des naissances ( prΘservatif )
sous forme d'injection 4fois par annΘe dans une fesse de 150mg de l'hormone
"acΘtate de mΘdroxyprogestΘrone". ╟a, c'est un produit chimique similaire
α la progestΘrone naturelle produite par les ovaires pendant la seconde 
moitiΘ du cycle menstruel. Une injection dure 3mois ( maximum 13semaines ) ,
c'est pourquoi on doit recevoir quatre injections par annΘe.

Le Depo-Provera empΩche l'ovulation. Il rend aussi le revΩtement de l'utΘrus
 non-rΘceptif α l'implantation d'un ovule fΘcondΘ. Il provoque Θgalement 
l'Θpaississement des sΘcretions du col de l'utΘrus, ce qui rend le passage du
sperme dans l'utΘrus plus difficile. Alors, lorsque vous ferez l'amour et 
que le gars Θjacule, les filles attendez-vous α juter et les gars, si vous
Ωtes en dessous, attendez-vous d'Ωtre aspergΘs de sperme. :P Aussi, α cause
qu'il empΩche l'ovulation, il n'y a plus de P.M.M.F ( pΘriode mensuelle 
menstruelle fΘminine ). 

Pour ce qui est de l'efficacitΘ, le Depo-Provera est efficace α 99.7%. En
fait, le Depo-Provera est lΘgΦrement plus efficace que "la pilule", car 
les femmes oublient parfois de la prendre cette fameuse "pilule".

MΘthode					   Taux d'echec

Depo-Provera					0.3%
StΘrilisation fΘminine				0.4%
StΘrilisation masculine			        0.15%
"La pilule"					3.0%
StΘrilet					3.0%
Condom						 12%
Diaphragme					 18%
Retrait du pΘnis				 18%
Abstinence pΘriodique				 20%
Hasard (pas de contraceptif)		         85%

Si votre copine souffre de un ou plusieurs de ces sympt⌠mes, elle ne devrait
pas utiliser le Depo-Provera:

1-Si elle est enceinte ou si elle pense l'Ωtre.
2-Si elle souhaite tomber enceinte dans un avenir proche.
3-Si elle prΘsente des saignements vaginaux inhabituels ou inexpliquΘs.
4-Si elle prΘsente des grosseurs ou masses des seins, si elle a les seins 
     gonflΘs ou si elle souffre d'hypersensiblitΘ des seins.
5-Si elle a une maladie du foie.
6-SI elle utilise actuellement un anticoagulant ( mΘdicament rendant 
  le sang plus fluide, comme la wafarine ).

7-Si elle est allergique α l'acΘtate de mΘdroxyprogestΘrone ou α l'un 
quelconque des autres ingrΘdients du Depo-Provera (polythylΦne glycol,
 polysorbate80, chlorure de sodium, mΘthylparaben, propylparaben, eau pour
injection)

8-Sort avec __2 [et oui ceci est un synthome]


Informez le mΘdecin si elle ou un des membres de sa famille directe
 a dΘjα eu un des problΦmes mΘdicaux suivants :

1-Cancer du sein, examen ou radiographie mammaire anormale (mammogramme).
2-DiabΦte.
3-Attaques, convulsions, Θpilepsie.
4-Migraines (maux de tΩte).
5-Asthme.
6-ProblΦmes cardiaques, crises cardiaques.
7-Ictus, caillots sanguins (troubles de la coagulation).
8-ProblΦmes rΘnaux.
9-Hypertension artΘrielle.
10-DΘpression mentale.
11-PΘriodes menstruelles irrΘguliΦres ou saignotements.

Un examen α long terme des donnΘes relatives aux femmes utilisant le
Depo-Provera a dΘmontrΘ un effet protecteur  contre le cancer de 
l'endomΦtre (enveloppe de l'utΘrus). Si l'utilisatrice est enceinte, le 
produit n'empΩchera pas la grossesse de se poursuivre, mais peut interfΘrer
avec le dΘveloppement normal du foetus.

Il est peu probable qu'elle ait des menstruations rΘguliΦres. Pendant les 
trois α six premiers mois, la plupart des femmes ont des saignements irrΘguliers,
imprΘvisibles et parfois mΩme continus. Les saignements peuvent Ωtre aussi
abondants qu'une pΘriode menstruelle typiques, mais ils peuvent aussi Ωtre
plus lΘgers.  En effet, le revΩtement de l'utΘrus ne s'Θpaissit plus chaque
mois et, par consΘquent, il n'a pas besoin d'Ωtre ΘvacuΘ de faτon aussi abondante
sous forme de flux menstruel. Au fur et α mesure que l'on utilise le DΘpo-Provera,
les saignements diminuent gΘnΘralement et la plupart des femmes n'ont plus de 
pΘriodes menstruelles mensuelles vers la fin de la premiΦre annΘe d'utilisation.
L'absence de saignements menstruels n'est donc pas un signe de grossesse. Et
c'est peut-Ωtre mieux d'informer les parents de la jeune fille puisque s'il 
dΘcouvre qu'elle n'utilise plus de tampons ou de serviettes sanitaires, et 
bien...watch out la crise de nerfs... :) 

Un des problΦmes que les femmes ne pensent pas lorsqu'elles commencent α 
utiliser le DΘpo-Provera et bien c'est  le retour α la fΘconditΘ. C'est 
bien beau ne pas vouloir d'enfants pour l'instant, mais il faut prΘvoir 
α long terme.

Mois consΘcutifs α l'intΘrruption de la contraception            6       12	 24

Utilisatrices de Depo-Provera					54%	76%	92%
Utilisatrices de "la pilule"					75%	85%	95%
Utilisatrice d'un stΘrilet					60%	76%	93%
...
9-DΘcharge et sensibilitΘ des seins
10-Taches plus foncΘes de la peau
11-╔ruptions cutanΘes
12-Sentiments de dΘpression
13-Fatigue
14-╔tourdissements
15-Perte de cheveux
16-Augmentation des poils
17-SΘcheresse vaginal pendant les rapports sexuels
18-Augmentation ou diminution de la libido
19-Augmentation ou diminution de la pression artΘrielle
20-Intelligence

Tant qu'α moi, je trouve que ces sympt⌠mes sont, pour la plupart, faux. J'en ai resenti 
aucun. J'ai une amie qui l'a essayΘ pendant 6 ou 9 mois, et elle l'a arrΩtΘ parce qu'elle
trouvait qu'elle avait pris trop de poids. Mais chaque fille est diffΘrente.
...
hacker des  pages web et bien,  il y a plusieurs faτon en voici une,  la plus
lame mais qui fonctionne quand mΩme asser bien avec certain serveur. =]      
                                                                             
Fonctionnement:  Mentir.  Vous  vous faites  passer pour le  webmaster  de la
page et vous faites un  sΘnario du genre que vous avez formater  votre disque
dure au grand complet et vous n'avez plus le mΩme fournisseur internet.      
                                                                             
RΦglement α suivre: - ╩tre bon menteur.                                      
                    - Savoir mentir.                                         
                    - Mentir.                                                
                                                                             
Pour  commencer, commencons par la premiΦre Θtape.  L'ocalisez votre  victime
ce  qui n'est  pas  trop dure  habituellement  apars  peut-Ωtre pour quelques
personnes qui ne compraine pas ce que je dis prΘsentement... =]              
                                                                             
DeuxiΦme Θtape,  Θtant  celle  qui  suit la premiΦre...  Essaillez  de savoir
l'e-mail avec le nom et  prenom de votre victime,  quelques fois impossible α
trouver mais  habituellement,  vous pouvez trouver tous c'est informations en
bas le la page  d'acceuil.                                                   
                                                                             
TroisiΦme Θtape.  Envoillez un e-mail au server qui  hΘberge la page de votre
victime et inventent un sΘnario du genre:                                    
...
j'ai dΘcider  de  changer  de  fournisseur internet  et  mΩme  temps  que  je
formatais  completement  mon  disk-dure  pour  repartir  α  0.  Puisque  j'ai
...
que la compagnie ne donne pas  d'information du genre comme τa par e-mail)...
                                                                             
Voici quelques server que τa marche, dumoins que j'ai rΘusie a convaincre:   
                    - Angelfire                                              
                    - Multimania                                             
                    - Tripod                                                 
                    - MyWeb                                                  
...
P.S. Je sais  ce truck est  lame au  bout et marche seulement α  40% alors il
est probable que  vous aurez quelques  Θchecs de temps α autres.  S.V.P dites
...
N'assaillez pas avec Hypermart ou encore Serveur.net τa ne marche pas... DΘso
...
Beaucoups d'exploits sont basΘs a partir du Stack Smashing
...
Maεtresse du vrai, prΩtresse du faux,
sous l'ΘtrangetΘ amΦre de ces signaux Vignycient exemple de ta Trinity.
LibΘrΘ de ce vaste monde illusoire,
libΘrΘ de ces sommets ensoleillΘs.
T'ennuies-tu de Sydney ?
┬me humaine sous cet intrigant personnage,
tes profonds sentiments, je ne peux qu'entrevoir.
Je ne sais ou trouver, je ne sais quand chercher.
Ces 6 mois passΘs α South Wales, ces 6 mois ajoutΘs α ta vie,
m'ont permit de plonger dans ce gouffre nostalgique,
nostalgie des Θpoques passΘs, nostalgie de tes moments sous-estimΘs.
Souvient toi ce lieu ou tu es nΘe,
...
je les traquerais dans ma mΘmoire ces endroits ou,
comme mon pays, comme notre pays, seule l'histoire me sert de vaisseau temporel.

La puretΘ des " Je t'aime " ne saurait Ωtre assez distillΘs
pour noyΘs tes si jolis yeux aquas.
Ta prΘsence m'ennuie, tes absences me dΘtruisent,
chaque fois que je lis cet Θcrit, j'aimerai te savoir en ce moment,
...
Il est dΘjα tard en ces villes statique,
puisse ta lueur continuer d'illuminer,
mΩme aprΦs le gΘnΘrique.
...
psychopathes, Vous  nÆavez pas encore compris un petit principe trΦs 
simple, On  aime  ce  que lÆont fais, on est hacker et nous en somme 
trΦs fiΦre. Nous fesont du hacking par pur plaisir et pour un avenir 
Peut-Ωtre  trΦs  proche  mais  vous,  vous qui jouer au Golf ou α la 
pΘtanque Quesque  cela  vous  apporte  t il?? Oui cela vous donne du 
plaisir Mais  bref  vous  ne  survivrΘ pas α une guerre nuclΘaire en 
...
routine qui ne dΘpasse jamais de loin lÆordinaire, Vous  regarder le 
pointage  du dernier match de votre Θquipe favorite et  Buvez  votre 
cafΘ de marque populaire, vous vous habiller de faτons rudimentaires
Pour ne pas  attirer  lÆattention  sur vous et aller travailler mais 
lorsque vous OuvrΘ la porte de votre  petite  maison  pour  aller  α 
votre voiture de seconde main Vous vous rendez soudain compte que la 
ville est mise α sac! Les Θdifices s'Θcroulent devant  Vous ,  votre 
voisin gεt ΘgorgΘ sur le trottoir, les bureaux gouvernementaux  sont 
assiΘgΘs  Votre  petit  paradis  de  vie  copieuse  chute c est fini, 
lÆanarchie (Pour ne pas dire  enfin)  rΦgne  sur  la  terre cÆest la 
course α lÆArmement. Mais quesque vous aller faire? Vous Θte dans un 
monde ou lÆont peut compter que sur sois. Vous aller s√rement mettre 
sa  sur notre faute.. mais quesquon n'en n'a α foutre de vos paroles
Un  jour  nous  rΘgnerons  et  briseront  votre  maigre  empire   de 
Capitalisme α la con. Sachez que  vous  Θte  dΘjα en retard beaucoup 
...
dans  votre  modique  club  de  golf  et  montrΘ  α vos imbΘciles de 
collΦgues que vous ╔te  bon  golfeur  et  bien bonne chance l'avenir 
n'est pas loin.



Voilas!  Sale petit peuple dÆinsoucieux vous vous croyez peut Ωtre α
lÆabri de tout Parce  que  vous avez votre petite police dÆassurance 
et que vous Θte syndiquer Mais  grΓce  a  vous  nous somme persΘcutΘ 
nous somme dΘpouiller de tout droit Nous avons droit a la libertΘ et 
nous devrons la prendre de force! LÆΘtat  nous  Θcrase  DÆimp⌠t nous 
somme coincer par des loi dÆenfant gΓter qui rΩve dÆun monde parfait 
En  ne  fessant que jurer dÆun avenir sans imp⌠t et sans guerre mais 
cÆest une belle Supercherie monter par le monde autoritaire. Nous ne 
devons pas nous conformer Nous  ne  devons  pas  plier  nous  devont 
appliquΘ nos intΘrΩt puisque nous  sommes  des  Hackers et que lÆont 
doit dΘfendre nos droit. 


Vous ne savez peut-Ωtre pas mais le gouvernement vien de sortir sont 
nouveau SystΦme dÆimp⌠t! Haha vous ne trouverai s√rement pas sa trΦs 
dr⌠le de savoir QuÆaprΦs une augmentation de salaire le gouvernement 
va prΘlevΘ  de  106 a  107%  de votre augmentation ce qui en d autre 
mots veut  dire  QuÆaprΦs  avoir  reτus  une  augmentation vous vous 
retrouver avec  Moin dÆargent qu'au dΘpart. Alors vous aller me dire 
que si votre patron Vous  offre  une  augmentation vous Θte mieux de 
dire non pour ne pas perdre de L'argent  mouin  c'est  une faτons de 
voir la chose  mais  demander  lui donc de Vous la donner au noir... 
apres tout on serai Θpais de dire non a de lÆargent facile  Pour  la 
simple  raison  du ``c est mal`` puisque de tout faτons cette argent 
la se Retrouveras dans les poches du gouvernement quand mΩme (une de 
1000 cause)

Le  gouvernement  veut  arranger  ses  tort dans le style du message 
publicitaire Qui  dit  non a l Θvasion fiscale pfff quel merde si le 
...
plus nombreux et  Beaucoup  plus puissant que votre misΘrable police 
et votre imposant systΦme Judiciaire. Tout commencera par une simple 
grΦve et lorsqui auras plus de monde On continuera vers l'Θmeutes et 
quand il y aura encore plus de monde  On  poussera  jusqua la guerre 
civile  et  assiΘgeront  les  bureau  politique Pour  enfin  obtenir 
lÆanarchies et alors vous nous ferez encore de belle  Promesse  pour 
recouvrer votre misΘrable pouvoir mais nous dirons  NON!  NON  cÆest 
trop nous somme tannΘ nous somme  tannΘ  du  Capitalisme  Nous somme 
tannΘ  de  la  conformitΘ  nous  agonisons  dans  votre   monde  dit 
de parfait Chaque  jour nous nous levons dans une ville obscure pour 
voir d un fil noir Le nΘant de votre oeuvre.

Nous ne somme que des moutons Mais un jour quand lÆanarchie triomphera
Seront les bergΘs.

          HACKER DE LA TERRE UNNISSER VOUS LE TEMPS EST └ LA REVOLUTION
...
Et bein cΘ simple comme tout. Litestep est un explorer  (sort 
of..) tout comme explorer.exe sauf   ke la cΘ litestep.exe ..
Les avantage davoir litestep c'est   qu'avec   une      bonne
configuration c'est gΘnial et que les graphiques de  Litestep
...
░1 installer litestep ..dans le rΘpertoire dont vous vouler...
...
░4 directement apres ouvrer step.rc (rΘpertoire de litestep)

[[ step.rc contien toute la configuration de litestep ]]

░5 bon la vous aller voir tout plein de chose Θcrite..mais
   les plus importantes sont les wharfs et les popups...

  les wharfs cest la configuration graphique et le popup
  cΘ kand vous peser   sul 2e piton de votre souris sul 
  desktop..
  ...
  *Wharf ~Folder	
  ...
  ka mettre ; au dΘbut de la ligne .
...
Voyez? cΘ tres simple de configurer a sa guise litestep.. pis pour
ceux ki veulent changer les wharfs bin faite vous un new file dans
adobe photoshop en 64 pixels et apres Θcriver le nom du fichier ...
supossons que cΘ leet.bmp ..bin metter:
...
opinions  qui   Θmergeront  encore   une  fois  de  mon  cerveau.
Et justement parlons en de ce cerveau, et parlons du  cerveau  de
l'individu moyen (celui qui achΦte  le  Dano  AmΘliore). Tous  et
chacun avons plus de mΘmoire qu'il n'en faut mais est-ce vraiment
utile? Et si on comparait notre cerveau α l'animal  le  plus prΦs
de nous soit, bien sur, l'ordinateur! Bein oui, aprΦs tout, quand
ye neuf vous le dompter, lui montrer  des tours, ensuite vous lui
montrer "THE GOOD WAY TO FOLLOW"  mais  crΘdule  comme il est, le
pauvre petit, tel un Chiwawa envers un Θtranger,il ne tiendra pas
compte  des  mauvaises  intentions  ΘtrangΦres,  car  en  lui  la
...
sera prΩt a tout pour en sortir tout comme si vous priviez  votre
compute de se plugger sur un  rΘseau,  plus  celui-ci cherchera a
s'Θvader(ya de ces trucs qui requiert plein de patch de nos jours!).
Mais oh attention, sa serait plate que le  dominer  domine aprΦs,
...
Okay,  jamais  de  problΦmes  de  configuration,  pas  besoin  de
...
vous  Ωtes  et  sur  ces mots rappelons-nous Socrate: Connais-toi
toi-mΩme!

Super  cerveau  full  hot qu'on comprend pas, et voyons pourquoi.
Ha  le mystΦre est la,  selon  moi,  on  n'oublie  rien  et  non,
tout est recorder dans une espace mΘmoire bien sur,  vous  n'avez
mΩme pas accΦs a toutes les mΘmoires de votre propre cerveau,mais
dans un Θtat de dodo vous arriveriez s√rement  α trouver α l'aide
de votre Subconscient ce qui  vous  est  interdit.  Rappelez-vous
cette douce et belle fille que vous avez vu pour la premiΦre fois,
rappelez-vous lors de vos 5ans ne  serai-ce  qu'une seule journΘe
d'ΘtΘ ou le Soleil de 10hAM frappait  la  rue,  ou  les  feuilles
vertes ne pouvaient plus verdir,rappelez-vous la senteur de gazon
presque br√lΘ par la chaleur,le bruit des criquets dans les bois,
...
restent α tout jamais, des souvenir si rΘcent se perdent si vite.
Comme pour votre examen de math  ou  de  physique, afin  de  bien
mΘmoriser toutes ces diffΘrantes formules, ces algorithmes et ces
nomenclatures il vous aura prit une bonne heure de mΘmorisation α
cette vitesse on se demande  bien ce qu'il  a  de  si  rapide  ce
cerveau? Ce n'est pas temps sa rapiditΘ de  mΘmorisation  qui  en
fait une arme si ΘlaborΘ mais bien sa capacitΘ α pouvoir mΘmoriser 
diffΘrantes donnΘes. Alors allons voir de plus prΦs.. Quand  vous
mΘmorisez une image et prenons ici un exemple concret:par exemple
vous allez au cinΘma et vous apprΘciΘ la dΘcouverte d'une actrice
et, ici, encore une fois, pronons comme exemple ..  tien..   vite
dememe.. Carrie-Anne Moss.Donc aprΦs ce 2h de film,vous retourner 
chez vous et afin  d'admirer d'avantage cette personne, vous vous
plonger  dans  un  processus  de  remΘmoration.  Mais comme cette
mΘmoire est vache..  vous  avez  bien une bonne idΘe du visage de
cette demoiselle mais rien de clair, c'est un peu  comme regarder
un Θcran en mode Interlace. Et pourquoi ce phΘnomΦne? Je  ne suis
pas biochimiste.. encore moins mΘdecin mais j'ai  quand  mΩme  ma
petite thΘorie..Si notre cerveau irait Θcrire ces informations un
peu partout sans ordre prΘcis, ca pourrait expliquer le lag et la
flouiditΘ d'une information, surtout  si y faut toujours faire un
Get  d'infos, un peut comme un  refresh  α  chaque  milliΦmes  de
secondes. Mais  dans  ce cas admettez que quand vous penser α ces
ΘvΘnements du passe,  il ne  suffit  que d'un  ΘvΘnement  pour en
reconstituer plusieurs  autres, un peu comme un pointeur en C qui
pointe sur une adresse, rappeler  vous  un  pointeur  (Event)  et
incrementer le, vous obtenez  une des Θvents suivante. Mais cette
derniΦre  option  ne  devrait  pas  trop  allower un phΘnomΦne de
flouiditΘ des informations.. Voyons donc comment est composer une
image par exemples:  couleurs, position,  agencement.. toutes ces
informations qui devraient se trouver dans  un espΦce  de fichier
biologique  un  peut  comme  un  .gif  mais  avec  en  prime  des
commentaires α perte de vues,  prenons  encore  l'exemple choisit
plus  haut :  BeautΘ,  formes, dΘtermination, critique, mensonge,
vΘritΘ, intellect,  actions  etc...   Finalement  joint  α  votre
fichier se trouvent tous les sentiments que  vous  avez  recorder
quand vous avez choisit d'Θcrire sur votre  HD  biologique. Et si
toutes nos cellules cervicales ne fonctionnait  pas  tous,  si la
norme  humaine Θtait de 8/10 et  pourquoi  pas  6/10 ?  Non  mais
j'avoue qui a beaucoup d'infos de stocker, mais j'avoue aussi que
je ferais pas confiance en un ordi qui garde 6/10 des donnΘes que
je lui fourni..et encore moins s'il s'agit d'une image cher α mes
yeux.. Et si le  cerveau  n'Θtait  pas multi-tread en fait, si le
cerveau serait comme le CPU de votre ordi, en allant chercher une
image, vous devriez arrΩter  le phΘnomΦne  de  Refresh  d'on j'ai
parler plus haut, ne serai-ce que d'un milliΦmes de  seconde pour
...
vous voyez le derriΦre de votre char sans vous rappeler la plaque!
Et si on fabulait, comme toujours, si on pouvait,  un  peu  comme
dans le film Matrix (ici je rip aucune idΘe, aller  voir  le  iGA
spΘcial Xmas j'en ai dΘjα parler) donc si  on  pouvait transfΘrer
des donnΘes directement dans notre cerveau,un peut comme la passe
de how driving helicopter in 5 sec, l'humanitΘ  serait  changer α
jamais, tout les mΘtier de technologie ou qui requiert  le  moins
d'effort serait  vouer α la  disparition;  pourquoi  aller  faire
rΘparer votre  voiture  quand  vous  Ωtes  mΘcanicien  ou encore,
pourquoi aller α l'Θcole si vous savez tout du  calcul  intΘgral?
Seuls les mΘtiers contemporains (les mΘtier de misΦre) comme mineur,
b√cherons et le gars de l'hydro qui  passe  voir  votre  compteur
resterait en vie mais pour combien de temps, car ici ce n'est pas
la connaissance qui est la limite mais la productivitΘ  et peuple
capitaliste que l'on est, point de vue productivitΘ,  on remplace
...
10% 80%. Pis la le monde vont se mettent α passer plus de temps α
rien faire donc mon ami l'ordinateur vas encore Ωtre la pour plus
d'entertainement..  Sa  serait  l'occasion idΘale pour de grandes
constructions, l'Θlaboration de  vassaux spatiaux, de technologie
encore plus nouvelles (auquel tous  le monde pourrait avoir accΦs
via un genre de ADD-ON mΘmoriel) mais  l'Θconomie  ne serait plus
au centre de cette sociΘtΘ, c'est le dΘfie qui  serait  le  joyau
de cette quΩte. Et quelle est la prochaine Θtape,  la destruction
bien sur!  Je  suppose que pus personne pourrait se venter d'Ωtre
meilleur  qu'un  autre  aprΦs  ca,  si  tout  le  monde α la mΩme
connaissance. Et justement,  cette universalitΘ des connaissances
...
est la force d'une sociΘtΘ homogΦne?  C'est la diffΘrence qui est
au centre des nouvelles idΘes.Et tout ce dΘbut de Borg-anisations
ne pourrait faire  autrement que nous retomber dans la face, face
α des personnes aux mentalitΘs diffΘrentes.


Et  la  machine elle?

J'avoue que c'est plate de devoir  tout  dire  α  cette  machine,
et c'est pourquoi on a droit a tous ces programmes d'installation
si simples.Mais on sait pas plus ce qui font! On ne sait mΩme pas
comment  fonctionnes  cette machine et le danger est la, je parle
α tous ceux qui pense tous savoir car  ils  savent  installer  un
disque  dur  ou  encore  un  Cd-Rom  ou  encore qui se prΘtendent
technicien sans savoir le fond mΩme des pensΘes que cette machine
...
bien le jour ou de maεtre vous passerez α esclave! Et une machine
...
sentirais mal de me voir escorter  par  deux  espΦces de vΘhicule
d'on je ne connais rien.Et j'ai en tΩte que cet esprit Θlectrique,
pas si diffΦrent du n'autre, devra Ωtre vu comme un peuple et non
comme un esclave aprΦs tout,cette jolie libertΘ pour la quel tant
sont morts  pourrait  encore  faire  des  victimes! Mais, le vrai
danger ce cette monstruositΘ, c'est que partout au monde, un seul 
langage est utilise, et que  toutes  les  connaissances  acquises
seront envoyer α chaques  machines  pouvant  les  interprΘter. Et
cette pensΘ global et uniforme qui ne laissera pas  la  place aux
idΘes  diffΘrantes  et  nouvelles  sera,  elle aussi,  vouer α la
dΘfaite faces α de nouvelles contestations.

On  peut  trΦs  bien voir  la  similitude  entre  les deux grands
peuples qui peupleront  la terre a la  moitiΘ du 21e siΦcle, soit
l'homme et la machine,  d'un cote  l'Ωtre  physique et de l'autre
l'Ωtre purement abstrait. Et s'il devait avoir une guerre, il n'y
a Θvidement peu de diffΘrence entre les besoins agressifs humains
et sa crΘation; son pareil, ce que l'homme vise  α crΘe.  Et  sur
un fondement Jurassic Park je dirais mΩme que Dieu  crΘa  l'homme
α son image, l'homme tua Dieu, l'homme crΘa  l'ordinateur  α  son 
image. Mais quel ironie, qui aurait cru  α  un  tel  dΘnoument...
Le problΦme  de cette guerre, ou plut⌠t le rΘsultat serait facile
α deviner : L'Θchec de l'espΦce humain en premier lieu et l'Θchec
de la civilisation  humaine  en  second lieu.  Au  dΘbut de cette
guerre  l'homme  se  battra  avec  quoi,  des  machines?  Un  peu
paradoxal.. Et  mΩme  si  on  dΘtruit ses  robots tueurs, il sera
toujours plus facile d'en recrΘe. Et je crois vraiment qu'il sera
plus facile de tuer un homme que de neutraliser  un Ωtre abstrait.
Car comme un fant⌠me il sera partout sans que  vous  le  sachiez.
De plus, cette Ωtre n'a besoin que d'ΘlectricitΘ pour vivre, elle
serait 1km sous terre vous ne pourriez la  dΘtruire  et bien  sur
elle serait aussi etre dans l'espace et,encore une fois, vous  ne
pourriez la dΘtruire. Vous seriez limiter par votre corps,  corps
qui serait plus grand que votre esprit..(ici on sens le Nietchz)
L'homme s'Θteindra donc, la machine se retrouverait seule pour la
premiΦre fois (c'est dur la solitude),  et  aimera  t-elle  jouer
avec soi-mΩme? Elle tombera donc dans un sommeil profond  et  qui
peut prΘdire la fin de ce sommeil?

Donc prΘparons nous α appliquer les lois de Asimov :

1-Un Robot ne doit jamais nuire/tuΘ un Humain il doit mΩme tenter
  de sauver un humain en danger.
2-Un Robot doit toujours obΘir α son maitre sauf si cette obΘisance
  vas a l'encontre de la loi #1.
3-Un Robot doit tenter de rester opΘrationnelle aussi longtemps que
  possible.

Oublions ces lois, et servons de HD pour notre meilleur ami...

Et dans un tout autre ordre d'idΘe, j'en suis venu α la conclusion
(aprΦs avoir vu le film Matrix)que si je me fis α un monde virtuel
dans lequel un humain pourrait vivre, l'humanitΘ  pourrait   avoir
une espΘrance de vie plus longue.. En fait  c'est simple, grΓce  α
un systΦme de communication du genre "Direct Cervical Link"  notre
cerveau n'aurait plus besoin d'attendre aprΦs chaques informations,
un peu comme  quand  on  parle,  car  la  parole  est un  moyen de
communication  sΘrie  et  qui  dit  sΘrie  dit un multiplexing  de
donnΘes et bien sur qui parle de multiplexeur parle  d'une   perte
de vitesse, et non d'une accΘlΘration comme on  pouvait  le   lire
dans un certain #3 de  je  ne  sais  quel  groupe "On-the-ground"!
Mais si cette  perte de temps  pourrait  Ωtre  bypasser   par  une
communication  plus rapide, nous  n'aurions   plus  le   sentiment
d'attendre   des informations,  imaginez-vous dans un monde irrΘel
mais ou  votre encΘphale  est synchronisΘ α disons 4 Mhz donc pour
recevoir un bit de  donnΘe ca va vous prendre 0,25 uS en parallΦle
et environ 3 uS sur un lien sΘrie (tout dΘpend de votre protocole).
En somme, vous auriez transmit votre donnΘe     (exemple  simple :
un nombre hexadΘcimal sur deux chiffres) alors  que  vous   auriez
mit au moins une  seconde  verbalement  (et pour les hots 0.5 sec)
Vous voyez l'avantage?  Mais dans un univers synchroniser α  cette
vitesse, pour vous 50 uS deviendrait une  seconde. Et comme  votre
support  physique  (corps)   serait  dans   un  monde  "rΘel"  son 
vieillissement se ferait au mΩme rythme  le hic  c'est  que  votre
dΘveloppement intellectuel lui serait de genre 4000 fois plus rapide!
Et tout le danger est la, si vous devez  vous  deplugez  afin   de
concrΘtisez un projet dans un univers  rΘel, dΦs votre retour   en
mode matrice, il se  serait  Θcouler, pour une journΘe,4000  jours
sois prΦs  de  11  ans.  Mais ca vous fait pas chier ca, non  mais
c'est  vrai,  avec cette thΘorie, ya pus personne qui  va  pouvoir
se penser hot  dans la vraie vie, juste le fait de la dire   votre
dΘcouverte ca va vous prendre un bon 5 minutes mais dans ce  monde
rapide de la  Matrice  il se sera ΘcoulΘ 13.89 jours sois prΦs  de
deux semaines. La technologie Θvoluerait α un rythme  d'enfer mais
aucune  rΘalisation ne serait faite car  il  suffirait  d'attendre
une semaine pour que la recherche "virtuel" soit rendue α  77  ans
d'Θvolution  de plus. J'aime bien cette thΘorie,  j'avoue  qu'avec
une telle technologie,les Θcarts technologiques entre les  peuples
serait  vraiment mais  vraiment  indiscutable..  Imaginez  si  une
autre civilisation a dΘjα passΘ par la, vas-tu  falloir  faire  de
l'Over-clocking  au point de vue de la synchronisation  cervical ?

Moi  qui pensais voir des chars volants pour l'an  2000.. j'espΦre
bien  voir des colonies spatiales dans toute la galaxie  d'ici   5
ans (20020 ans virtuels) peut t'ont parler d'immortalitΘ si 65 ans
rΘel  se  convertisse en 260260 ans virtuels ?, et je vous rappelle
qu'il y α 15000 ans l'homme inventait le feu et la roue!
