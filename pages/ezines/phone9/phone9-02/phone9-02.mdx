...
[Ph0ne9.]			 +--- ---  ---  - -----  ---  ---  -+ Punkass Stuffs
  ...
  The Phone9 Communications Systems, &lt;table of contents.> 
    ...
    5] Microsoft Internet Exploder BUG!!! &lt;object> boguzes
...
Primeiro passo:
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
&lt;BODY TEXT="#29C413" BGCOLOR="#000000" LINK="#FDF511" VLINK="#FDF511"  
ONLOAD="startclock();">
^^^^^^^^^
O seu &lt;body> deve ficar assim:
...
// thanks 
Go to the web site and copy from &lt;script> to &lt;/script>
// -->&lt;/SCRIPT>
...
&lt;TABLE CELLSPACING="0" CELLPADDING="0" WIDTH="100">
      &lt;TR>
        ...
        &lt;/TR>
      &lt;TR>
        &lt;TD>&lt;FONT FACE="verdana">&lt;FONT COLOR="#FFFFFF">&lt;FONT SIZE="-1">Kevin
...
.[news].		       - breaking tha news -                      .[news]. 
   ...
   [14/09] - Slashdot, o centro de informacoes para linux nerds, foi in-
		 ...
		 mais interessante na sua invasao Θ que durante a invasao da
...
n28=%encrypto = $replace(%encrypto,δ,a)
n29=%encrypto = $replace(%encrypto,Ñ,b)
n30=%encrypto = $replace(%encrypto,ú,c)
n31=%encrypto = $replace(%encrypto,",d)
n32=%encrypto = $replace(%encrypto,τ,e)
n33=%encrypto = $replace(%encrypto,⌠,f)
n34=%encrypto = $replace(%encrypto,│,g)
n35=%encrypto = $replace(%encrypto,φ,h)
...
n41=%encrypto = $replace(%encrypto,σ,n)
n42=%encrypto = $replace(%encrypto,í,o)
n43=%encrypto = $replace(%encrypto,ñ,p)
n44=%encrypto = $replace(%encrypto,½,q)
n45=%encrypto = $replace(%encrypto,▓,r)
n46=%encrypto = $replace(%encrypto,╡,s)
n47=%encrypto = $replace(%encrypto,╢,t)
n48=%encrypto = $replace(%encrypto,⌐,u)
n49=%encrypto = $replace(%encrypto,ó,v)
n50=%encrypto = $replace(%encrypto,╖,w)
n51=%encrypto = $replace(%encrypto,`,x)
n52=%encrypto = $replace(%encrypto,▀,y)
n53=%encrypto = $replace(%encrypto,Σ,z)
n54=/echo 4 %encrypt
n55=}
n56=Encrypto {
n57=set %encrypto *1
n58=%encrypto = $replace(%encrypt,.,║)
n59=%encrypto = $replace(%encrypt,?,▒)
n60=%encrypto = $replace(%encrypt,!,╗)
n61=%encrypto = $replace(%encrypt,a,δ)
n62=%encrypto = $replace(%encrypt,b,Ñ)
n63=%encrypto = $replace(%encrypt,c,ú)
n64=%encrypto = $replace(%encrypt,d,ô)
n65=%encrypto = $replace(%encrypt,e,τ)
n66=%encrypto = $replace(%encrypt,f,⌠)
n67=%encrypto = $replace(%encrypt,g,│)
n68=%encrypto = $replace(%encrypt,h,φ)
...
n74=%encrypto = $replace(%encrypt,n,σ)
n75=%encrypto = $replace(%encrypt,o,í)
n76=%encrypto = $replace(%encrypt,p,ñ)
n77=%encrypto = $replace(%encrypt,q,½)
n78=%encrypto = $replace(%encrypt,r,▓)
n79=%encrypto = $replace(%encrypt,s,╡)
n80=%encrypto = $replace(%encrypt,t,╢)
n81=%encrypto = $replace(%encrypt,u,⌐)
n82=%encrypto = $replace(%encrypt,v,ó)
n83=%encrypto = $replace(%encrypt,w,╖)
n84=%encrypto = $replace(%encrypt,x,`)
n85=%encrypto = $replace(%encrypt,y,▀)
n86=%encrypto = $replace(%encrypt,z,Σ)
...
Entao a bash morre (sniff ;)) ai, Θ facil, 
        [raquerzao]:~$ ls -l /tmp/sh
        -rwsr-sr-x   1 root     root       304676 Sep  4 20:55 sh

	
	Mas espere, nao Θ so issu!!! Se voce ligar (011)1406, voce podera
...
&lt;OBJECT
CLASSID=111111111111111111111111111111111111111111111111111111111111111111
...
prova:
     ...
     Pressione &lt;tab>, para ir para a segunda coluna;

     Selecione o menu "Ajuda (?)" e em seguida "Sobre o
     Microsoft Excel...";

     Pressione ctrl + alt + shift e (mantendo-as pressionadas),
     selecione a opτπo "Suporte tecnico" na janela de ajuda.
     ...
     parede que estava as suas costas ao comeτar o jogo. E
     branca e quadriculada...

     Tecle EXCELKFA. A parede se abre e revela uma passagem
     secreta. Entrando nela, vocΩ ira andar num caminho elevado
     (tente nao cair, o que Θ muito dificil). Quando vocΩ chegar
     ao final vera algo REALMENTE aterrorizante!

Poderia ser uma brincadeira dos programadores da Microsoft ou
nπo? Realmente, nao seria surpreendente que Bill Gates fosse o
...
arsenais nucleares, fazendo estragos nos sistemas de seguranτa, e
...
nome. (...) este n·mero e 666." Apocalipse 13:16-18
...
capaz de comprar, vender, fazer transaτ⌡es comerciais etc...
entπo, minha pergunta e: a Internet hoje em dia nao e uma
...
Internet? Comprar/vender bens, transaτ⌡es comerciais... E a
Microsoft nπo estß sempre tentando ter o monop≤lio da tecnologia
dos softwares que produz, e agora principalmente, da Internet???

O Apocalipse tambΘm diz que "...a marca da Besta estarß na mπo
e no rosto de cada um...". Se a Internet fosse em realidade o sinal
da Besta, nπo estamos comeτando a levß-lo nas nossas maos
(usando o mouse) e em nossos rostos (monitor)?

Finalmente, tudo se encaixa (ou tudo Θ apenas fruto da nossa
imaginaτπo?)...

Lembre-se, o dem⌠nio vem para enganar, roubar e destruir...
assim, fique atento com respeito a Bill Gates e a Microsoft.

"Estar ou nπo estar de acordo com a WWW ou a Besta", essa nπo
Θ a questπo. E se WWW Θ o 666? Ou Bill Gates Θ a Besta?? O que
vamos fazer??? Cancelar nossa conexπo com a Internet? Nπo
utilizar mais os produtos da Microsoft? Formatar os micros com
Windows95 pra sempre? AAAHHHHHHH!!! Isto nπo te faria nenhum
bem, nem teria resultado algum contra o homem mais rico do
mundo!
Apenas releia este texto com atenτπo... e tire suas pr≤prias
conclus⌡es...

Lembre-se, "o fim estß pr≤ximo!"
Nunca deixe de crer... The truth is out there...

bill Θ a besta (c) 1998. productions
by "beltra" o bill Θ a besta, (c).
 ┌────────────────────────────────────────────────────────────────────────┐
...
Vulnerabilidade:
 ...
 pagina e coloca o seguinte: 
	...
	&lt;A HREF="usrmgr.exe">User (dumb) manager&lt;/A>
 ...
 acesso.htm, no acesso.htm voce tera o seguinte:
    ...
    &lt;EMBED SRC="whoaminerd.wav" NAME="snd" WIDTH="1" HEIGHT="2" MASTERSOUND>

    &lt;A HREF="http://www.microsoft.com"OnMouseOver="window.status='Where do 
    you want to go tommorow???';return true">Microsoft's nerds Page&lt;/A>

    &lt;A HREF="http://www.ibm.com"OnMouseOver="window.status='International 
    Butt-plug Machines';return true">IBM's 31337 Homepage&lt;/A>

    &lt;IMG SRC="billnerd.gif">

    Hi, i'm a windows NT nerd, which makes me more nerd even :)

	&lt;A href="http://seuhost/seulogin/accesso.htm">acesso.htm&lt;/A>
...
-EOF
 ...
 [ Editorial do lixao ] ---------------------------------------------------
  ...
  elektrochok.  Welcome to the 31337 part of our zine,  where any one dump
  their stupid and uncompreensive bullshit in here, and then wait for some
  guy stupid enought to do something with it grab it  :) But who  knowz???
  Since somebody goes into the middle of a forest to take pictures with so
  me ugly dude, i believe that every piece a shit in the world is vulnera-
  ble, as soon as being a dumbass is a lot easier then being a rich micro-
  shit owner.

					Wanna knowz what tha fuck was writen in it??
					C'mon?? Learn english to really dominate the
                              World, isn't it the Pinkye!!!??? :)
 ...
 Anarxisty??? klpetomaniak e bloodroot ensinam as tecnicas mais estupidas e
 explosivas dos filmes da secao da tarde da poderosa :) McGayver perde, ele
 diz para todos esta frase: "Com as aulas anarxistas da Phone9 eu consegui
 construir um mulher com um pedaco de madeira e um pouco de argila que caiu
 do bolso do utlimo cara que eu matei la nos Emirados Arabes" - McGayver.

 Entao sente e relaxe  enquanto seus filhos explodem a sua casa com as  li-
 coes anarxistas da Phone9... :)
 


   - Destruindo telefones com 109 (somente no rio de janeiro)
   by bloodroot.

 Bom, depois de umas cartas promissorias enviadas pela telerda, nos ficamos 
 um tanto perdidos, entao nos vamos liberar alguns truques para voce testar
 em telefone publicos da telerj... :)

 109, e' um sistema de loopback o numero habilitado no rio de janeiro intei
 ro, faz com que um proprio telefone ligue para o mesmo numero, sem dar ocu
 pado, este codigo e usado por tecnicos da telerj para testar se o telefone
 esta realmente funcionando. 
 Comumente voce acha no rio telefones do qual o gancho telefonico sao deste
 tipo:

   
       __        __
      /     __	 \
      |    (__) -- | ----> Botao de desligar o telefone... :)
	\__        __/
...
--
 ...
 min fica boqui-aberta para tal forca hack power :)
                ...
                Novell NetWare Logon Hack, by &lt;bloodroot>
...
╖╖╖╖╖╖╖
 ...
 -  LIGANDO DE GRACA DE ORELH╒ES, por meio de linhas 0800  -  
...
Tire o orelhπo do gancho e disque:

0801 111 234

(apos voce discar esse numero das duas uma, ou a mensagem programada ira 
 dizer que nao existem linhas disponiveis para ligaτπo - ai e so voce ligar
...
Obs.: Esse truque foi descoberto e testado no estado de SP, ainda nπo sei se
...
Recentemente isto tem chamado atenτπo dos usußrios do ICQ de que a Mirabilis
...
foi colocado pelo cliente do ICQ desde a primeira versπo.
...
tador, numeros de serie que vocΩ usou, seu nome, sua compania e outras coi-
sas relativas ao seu endereτo residencial!
