...
;──┤ First open the input file (for compression) ├───────────────────────────
...
;──┤ First open the input file (for decompression) ├─────────────────────────
...
;══( Lord Julus' Huffman Compression Engine )════════════════════════════════
