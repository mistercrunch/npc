...
achar a informaτπo util e usar em diversas ocasioes.
...
afetar sua vida. Resumidamente, o problema é o seguinte: softwares e 
firmwares (softwares de chips, placas) foram programados para reconhecer as 
datas em um formato de seis dígitos (por exemplo, 21/10/99.) Durante os 
últimos trinta anos, isso n╞o foi problema algum. Mas, quando 1o de Janeiro 
do ano 2000 chegar, será interpretado como 1o de Janeiro de 1900 (01/01/00.) 
Isto irá causar má funcionamento em várias maquinas afetadas.

Muitas pessoas n╞o d╞o a mínima. Dizem que o que vai acontecer é apenas o 
"resetamento" da data de seus computadores em 01/01/2000, e será só isso. 
Isso pode ser verdade para a maioria de usuários de PC. Mas os PCs s╞o os 
...
problema, milhares de pessoas ser╞o afetadas.

Este tipo de bug n╞o é uma novidade. Alguns mainframes antigos da IBM 
tinham um bug similar:  
o IBM 360 n╞o podia lidar com datas a partir do dia 31 de Dezembro de 1969. 
O bug afetou todos os continentes, menos o Americano e o Asiático, pois a 
IBM assim que detectou o bug disse a seus clientes para voltar a data um dia 
até que a soluç╞o fosse encontrada. Muito dinheiro foi perdido por causa deste 
bug.
A soluç╞o encontrada pela IBM n╞o poderia ser usada nos dias de hoje. Muitas 
funçΣes dos computadores modernos usam a data e o horário para calcular 
valores a serem usados. (Exemplo: funçΣes randomicas do Adobe Photoshop e 
TODOS os softwares de finanças)

O Y2K será solucionado em alguns casos, mas em outros n╞o. No Brasil, por 
exemplo, várias coisas ser╞o afetadas pelo Y2K, como:

 . Alarmes e sistemas de segurança
 . Placas de telefones modernos com secretária eletrônica digital
 . Cofres eletrônicos
 . Equipamento médico
 . Sistemas de controle de tráfego aéreo (até 21/10/1999 o sistema usado pela 
   INFRAERO no Aeroporto Internacional de Brasília era vulnerável)
 . Sistemas de aquecimento e refrigeraç╞o

Estes s╞o alguns dos casos mais sérios, mas mesmo assim, n╞o é muita gente
que se importa quanto ao Y2K. As cias. que fabricam este tipo de 
equipamento normalmente n╞o fabricam os chips.

Em alguns países de primeiro mundo, como os Estados Unidos, para o dia 31 
de Dezembro de 1999, já existe a recomendaç╞o de que seus habitantes n╞o 
usem elevadores de qualquer tipo.
(A maioria dos elevadores destes países trabalha por agendamento; só param 
em alguns andares em dias de semana, ou só em algumas horas, para prédios 
que contem cofres, por exemplo. Imagine ficar preso em um elevador por dois 
dias.)
Nestes países também existe a recomendaç╞o de que se estoque água, 
alimentos e agasalhos, e também que paguem pelo menos três meses de suas 
contas adiantadamente, por medo de possíveis falhas que possam ocorrer a 
bancos e assim o cidad╞o fique impossibilitado de fazer uso de seu dinheiro 
por algum tempo.

        Na Internet brasileira, os usuários de computadores pessoais n╞o ter╞o 
dano algum quanto a hardware ou a software de acesso a Internet. Já os 
provedores poder╞o encontrar problemas em seus roteadores, pois 20 dos 
roteadores que ainda est╞o a venda no mercado s╞o vulneráveis. Os 
provedores e grandes empresas que contrataram programadores que n╞o eram 
de confiança, poder╞o ter problemas em um futuro n╞o t╞o próximo. Vários 
hackers brasileiros enquanto arrumavam o problema do Y2K instalaram 
backdoors nas máquinas. Para descobrir se o programador que arrumou o 
problema do Y2K em seus sistemas é um hacker, basta comparar o preço 
cobrado por ele com o preço de outros programadores. Normalmente, os 
hackers no Brasil est╞o cobrando mais barato.
