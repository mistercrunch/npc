...
07.0  More on the Chris Buckley Saga
      ...
      "I find this to be an insult to the people that are paying their ú50 a month [for unmetered
...
16.0  BO2K Marketing Plan (Very funny reading, check this out)
      ...
      family shares in the Cult's upcoming IPO."
       ...
       Lee will then point proudly to the new tag line pinned on her derriΦre:
      "You've got B.O.!"
...
25.0  Another from Cuartango: More Microsoft Security Holes 
      ...
      Nov. 15 ù  Forget for now about the BubbleBoy
      Virus, which has yet to cause anyone harm.
      ThereÆs a real vulnerability lurking in Microsoft
      Outlook and Outlook Express capable of
      delivering your machine into malevolent hands.
      
      DISCOVERED BY JUAN CARLOS GARCIA
      CUARTANGO, the ôActive Setup Control Security
      Loopholeö can download and save an e-mail-borne
      ...
      updates. The trick is that you donÆt need to save such a
      ...
      normal security standards could think they are safe,ö
      explained Lisa Gurry, a Microsoft product manager for
      Office. ôThe danger is someone could exploit it and create a
      CAB that could do who knows what.ö 
      ...
      its Security Advisor site. But itÆs not for Outlook or Outlook
      Express. ôThe vulnerability is in Internet Explorer,ö said
      Gurry. ôIt is an ActiveX control that ships as a part of
      ...
      the fileÆs signature would create a traceable fingerprint. 
             However, the patch only works on versions 4.01 running
      Service Pack 2. If youÆre running IE 4.01 with Service Pack
...
35.0  Dell Gets Some FunLove 
     ...
     industry source estimated that it may have cost as much as ú14
...
57.0  TORVALDS: COUPLE OF QUESTIONS
      ...
      By Michael Martinez
      ABCNEWS.com
      L A S   V E G A S ù No one knows more about
      ...
      ôBig Guysö (IBM, Hewlett-Packard, Compaq/DEC, Sun)
      from adding their own features to Linux and causing
      incompatibilities among different vendorsÆ products?
                               ù Doug MacDonald   
 
      A N S W E R:   ôI really donÆt think thereÆs a problem
      there,ö says Linux creator Torvalds. ôA lot of these
      so-called big guys in particular have been burned by
      operating systems in the past. Just look at what happen to
      (IBMÆs) OS/2. Nobody wants to touch operating
      systems. Everybody is so damned happy that somebody
      else is doing it! 
           ôEveryone that IÆve worked with has been very open
      with what they are doing with regard to Linux,ö Torvalds
      says. ôThey arenÆt really even trying to be very aggressive
      ...
      and there just arenÆt many developers willing to do it.
      WeÆve seen Linux users grow from 1,000 to 10 million,
      but the number of people working on the kernel has
      grown from maybe 100 to 200. 
           ôAnd remember, the license prevents them from going
      too far. Everything they do has to be open source. Any
      competitor can then come along and grab that code and
      add it to their version of the system.ö 
      ...
      A N S W E R:   ôYour reader is obviously right because,
      fundamentally, nobody actually buys operating systems,ö
      Red Hat founder Bob Young says. ôPeople choose the
      ...
      CompUSA, all the shelves have software for Windows. 
           ôWe are very actively focused on this problem, and we
      ...
      Applixware is doing with their suite. WeÆre happy with
      ...
      $674 million. Young says this deal will also help. 
           ôCygnus makes the kind of tools that developers need
      to create the applications people want,ö Young says.
      ôThis could go a long way to help provide this total
      solution that people need to do the kind of things they
     really want to on the desktop.ö 
