...
00.5  HWA FAQ v1.0 Feb 13th 1999 (Abridged & slightly updated again)
 ...
 03.0 NetBus suffers same industry pitfalls as Bo2k
      ...
      authors say thatÆs hurting sales, and the toolÆs legit
                                                          By Bob Sullivan
                                                                    MSNBC
      July 16 ù While one ôremote administration tool,ö
      ...
      intruders take control of a victimÆs PC from
      anywhere on the Internet. NetBus Pro authors,
      who charge $12 for the product, say itÆs a
      legitimate software tool. They might sue anti-virus
      vendors for interfering with their right to sell it
               
      ITÆS A STICKY STORY. The first version of NetBus
      was a favorite among hackers ù it even included easy ways
      to taunt victims, such as buttons to open and close a victimÆs
      CD-ROM door.
             Earlier this year, author Carl-Fredrik Neikter came out
      with an updated version, which he said was redesigned to be
      used as a professional ôremote administration tool.ö And he
      ...
      and NetBus Pro owners say thatÆs stifling their sales. Even
      worse, according to NeikterÆs partner Judson Spence, itÆs
      anti-competitive ù he says the anti-virus companies are
      squelching his product because itÆs competition for their
      remote administration software. Symantec, which makes
      NortonÆs AntiVirus Utility, sells remote administration tool
      PC Anywhere for $159.
             ôOn its face, it looks like a good case,ö said attorney
      Mark Rubin, who has been retained my NetBus. 
             ôThe product belongs to a corporation. ItÆs designed to
      do a function. YouÆve got another business telling people,
      æYou canÆt use that productÆ ... YouÆve got Symantec saying
      you shouldnÆt use NetBus Pro. ThatÆs the classic definition of
      an anti-competitive act.ö
             Members of the Cult of the Dead Cow, which authored
      Back Orifice, agree with RubinÆs premise. Back Orifice is
      also removed by anti-virus programs.
             ôItÆs a huge problem for anybody who wants to use our
      product legitimately that they have to
             completely disable their AV software to use BO2K,ö
      said a member calling himself Tweety Fish. 
             ôWeÆve talked about suing them, but since our product is
      free, and we gain no income from what we do, the legal fees
      would probably be prohibitive. From what we can tell, we
      would have a pretty good case.ö 
      ...
      victimsÆ machines without their knowledge. The lawsuit
      would be frivolous, as it would be difficult to persuade a judge
      that NetBus is a legitimate software product.
             ôOur policy would be if they were to release a version
      which very clearly identifies itself as NetBus every time it
      ran, then we would not detect that,ö said Stephen Trilling,
      director of research at SymantecÆs Antivirus Research
      Center. Further, he said, Norton users are given an option
      when NetBus is detected ù they can leave the software on
      their machine. 
             He denied Symantec would ever consider using
      NortonÆs AntiVirus program to disable a competitive product.
      ôWeÆre in the business of protecting customers,ö he said. 

    


             The issue does have some shades of gray ù when
      NetBus was released in February, Data FellowsÆ F-Secure
      product initially didnÆt detect the new NetBus, deferring to
      the notion it was a commercial product. But later, after
      customers complained, NetBus detection was added.
             ôNet administrators I know would get fired for using
      NetBus,ö said Dan Takata, spokesman for Data Fellows. ôIt
      can be used for good, but itÆs inherently a hacker program.ö
             ThatÆs just not so, complains Spence, who says more
      ...
      tool.
             ôIÆm optimistic that once we raise the issue, legal
      departments [at AV companies] will act,ö says Rubin.
      ôEvery day this costs money to NetBus Pro.ö
 ...
 04.0 Spreading Viruses Equal A Terrorist Attack 
      ...
      sophisticated virus detection programs, now "a basic
...
05.0 Y2K Bug Fixes May Cause Other Problems       
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      ...
      WASHINGTON, July 16 ù Security experts believe that
      computer fraud, linked directly to the so-called
      Year 2000 computer bug, will cost AmericaÆs big
      ...
      ôCLEARLY, SOMEONE is going to be hit on their
      balance sheet pretty hard,ö said Bob Mack, vice president of
      the Gartner Group.
      ...
      and codes ù leaving the companies and their computers
      wide open to theft.
             ôThey have to have access to your most critical
      systems. YouÆre essentially giving them the keys to the
      kingdom,ö said Ira Winkler, chief of the presidentÆs Security
      Advisors Group. 


             The consultants, itÆs feared, can insert their own codes
      into a company computer ù trapdoors ù that would permit
      them to hack back into the system at will.
             ôTheyÆre inserting malicious activity, if you will, into the
      code that will allow them to do things that the code was
      never allowed to do,ö said Mike Higgins, of Para-Protect
      Services, of Alexandria, Va.
             Once inside, the computer thieves could electronically
      steal money or the companiesÆ latest trade secrets, be it the
      latest cure for cancer or design for a new sneakers,
      potentially worth billions of dollars.
             ôWhy do people hack into computers today in the
      business world?,ö Higgins said. ôBecause thatÆs where the
      money is.ö And global financial systems are largely
      electronically connected now, and the interconnection is only
      expected to increase. 
             ôY2K remediation, by definition, creates and increases
      the opportunity for theft and fraud,ö said Joe Pucciarelli, a
      Gartner analyst, in a statement on the companyÆs advisory. 
      Advertisement



             ôGiven the enormity of the Y2K task, the vast number of
      ...
      next five years,ö Pucciarelli said. 
      ...
      another Gartner analyst, in an interview. 
             ôThe point weÆre making is that there are things
      corporations can do to limit fraud,ö Mack said. All Y2K
      ...
      forever ù leaving some companies vulnerable long after the
      Y2K New YearÆs celebration.
...
06.0 Security Fears are Slowing UK E-Commerce 
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      ...
      misplaced. One attendee was quoted as saying "There is
      ...
      Lloyds TSB banking group. "There's only one problem --
      ...
      insecure than any other type of business. "All the
      ...
      Bell said Visa was the "biggest proponent" of scare
      stories. "They say there's 45 percent fraud on the
      Internet," he said. 
      ...
      customers run data at 64K over their lines. "People
      ...
      governments didn't try to legislate for it. "Our objective
...
07.0 More Defc0n than you can shake three sticks at
     ...
     Forbes:http://www.forbes.com/tool/html/99/jul/0716/feat2.htm
      ...
      Of the 3,000 hackers, crackers, geeks, "scene
      ...
      to watch the "BO2K" release. Last year, Cult of
      ...
      says. "[They] give people the impression their
      software 'raises the bar' against the average
      hacker. Unfortunately, this also fools people
      with really critical networks into thinking that
...
10.0 The Back Orifice 2000 Controversy
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      Microsoftφs products stand to lose a good percentage of market
...
11.0 Year Old IIS Hole Still Causing Problems 
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      Microsoft security warning and were left vulnerable
               ...
               July 19 ù A security expert was able to
     ...
     July 17 of last year ù confirming a long-held suspicion that
     ...
     ôpatchesö to security holes, or ôexploits,ö found and
     ...
     follow each bulletin. In this case, many sites did not. 
            ôItÆs one thing when thereÆs a problemö said Russ
     Cooper, who administers the popular NTBugTraq mailing
     list. Cooper publicized the flaw on his list Monday morning.
     ôItÆs another thing when companies know about something
     for a year and havenÆt done anything.... These companies
     have just ignored MicrosoftÆs recommendation.ö 
            The flaw was discovered a year ago, and Microsoft
     published a "fixö and added it to the security checklist for
     ...
     sites running MicrosoftÆs Internet Information Server Web
     server software ù with no user name or password
     required.
            Sites that followed MicrosoftÆs instructions from a year
     ago would have been immune, but Gonzalez said about half
     the sites he checked were vulnerable. 


            ôWith a lot of exploits you see æprofessionalÆ hackers
     writing code,ö he said. ôThis exploit does not require
     anywhere near that level of expertise.ö
            This morning, Microsoft re-issued its security alert
     about the problem ôto serve as a reminder about this
     vulnerability, to restate the threat and encourage system
     administrators to evaluate their systems.ö 
            At the center of the problem, according to Cooper, is
     lack of due dilligence on the part of some companies to
     protect consumersÆ private information.
            ôLots of companies went to the trouble of putting
     together a privacy statement. ThatÆs all well and good,ö he
     said, ôBut if companies donÆt have an effective way of
     ...
     big-name Web sites that was discovered to be vulnerable. 
            ôWe get about 15-40 of these alerts every week,ö the
     ...
     ôWeÆre not Fort Knox.... We rely on third parties to say
     whether they are yellow or red situations.ö He says
     ...
     password protected, encrypted, and stored ôelsewhere on
     its site.ö 


            ôThe net of it is when an issue arises, we need to be
     proactive to take care of our customers,ösaid Craig
     Beilinson, a product manager for Windows 2000 at
     Microsoft. 
            The security hole itself involves the use of MicrosoftÆs
     ...
     database. From there, the hacker by default gains ôsystem
     privileges,ö and using Visual Basic can execute any
     ...
     information to the Web server ù including a database of
     ...
     card numbers ù perhaps storing such numbers on a
     different network, behind another user name and password.
            ôThe top 10 e-commerce sites may or may not have an
     additional layer,ö he said. ôBut thereÆs a zillion other sites
     that arenÆt going to have additional layers in place.ö
...
17.0  cDc Challenges Microsoft to Recall SMS (wicked!)
      ...
      Equally hypocritical quotes from Microsoft about Back Orifice: 
           ...
           "In fact, it really ends up doing bad things -- thatÆs what a Trojan horse does. Back Orifice falls into that
           category because it is intentionally designed to hide itself from detection. The creators claim that this is a
           useful administration tool, but it doesnÆt even prompt people when it installs itself on the system. It doesnÆt
           warn them that itÆs getting installed. And, once itÆs installed, it makes the system available to other people on
           the Internet. That is a malicious act." 
      
           "ItÆs incomprehensible why a tool like this would be created. [...] [T]hereÆs no purpose for this tool other than
...
23.0 National ID Card Law Set to be Enacted 
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      ...
      For his part, Smith angrily denies that
      ...
      Security numbers," says one Hill source.
...
24.0 Local Agencies Not Concerned About Computer Intrusions 
     ...
     From HNN http://www.hackernews.com/ 
      ...
      and state agencies on this issue," said Clark L. Staten, executive director of
...
27.0 The Truth About Abe - MTV "Punk Hacker" 
     ...
     From HNN http://www.hackernews.com/
      ...
      Rules" excursions, several of whom dropped by for a
      ...
      Real World," an abrasive loudmouth whose temporary "family"
      ...
      Abe," says Murray, who learned of Abe's attack after the show
      had wrapped. "To some extent, that's what Abe is about." "Abe
      has tremendous charisma and he has unique experience," adds
  ...
  Abe was the second-youngest of seven children -- six of them
      ...
      getting in a dumpster." And yet, as Ingersoll admits: "We did have
      ...
      fired up Procomm Plus, and that was the end of it," he says. He
      ...
      Bueller trick" (back-dooring into the school's computers and
      ...
      typical hacker!" he insists -- but he does read "bug reports," in
      ...
      control" program that allows someone like Abe to operate a
      ...
      vast empty void," he says. But he also found inside dope:
      ...
      what it comes down to is the sex and the conflict," Abe observes.
      ...
      Rules" hack to the now infamous fight with Gladys. While beetling
      ...
      ha! I've got information on you!'" Then he made himself seem
      ...
      guys in the cast recently," Abe says. "He watches the show and
      says, 'That's not the trip I remember.'" That's the way Abe feels,
      too. "I had no idea that I'd be as big of a troublemaker as I ended
      up being," he confesses. "I expected there'd be people just as bad
...
29.0 Man Sentenced for Using Cell Phone 
     ...
     From HNN http://www.hackernews.com/
      ...
      negligently endangering" a British Airways flight carrying
      ...
      ignorant behavior," Judge Anthony Ensor told Whitehouse at Manchester crown court. 
      ...
      said. 
                             ...
                             of the hazard from mobile phones," BA spokesman Jamie Bowden
                             said. 
      ...
      complex electrical equipment," he told Whitehouse. 
      ...
      violence. Luckily they weren't but that is no guarantee for the future," he said. 
...
30.0 HILLARY CLINTON AND HACKERS
     ...
     NEW YORK û Is someone sympathetic to
     ...
     poisoning" hack, in which would-be site
     ...
     the [hillaryno.com] site," Franklin said. He
     ...
     change the DNS entry," he said. "They would
     almost have to have committed an illegal
     act." Irvine added that most such hacks are
     ...
     1999 Friends of Giuliani." It labels itself "a Web site dedicated to the
     ...
     a proving ground." Although Giuliani has not declared himself a
...
33,0 What makes UNIX users so smart? (well some of em)
     ...
     http://www.insecure.org/reading.html
      ...
      $10..." though not syntactically correct (and less-than-scintillating
...
34.0 Statement by Legions of the Underground Released 
     ...
     Statement of Optiklenz (Steve Stakton), of Legions of the Underground 
      ...
      what separates the "hackers" (those who's main purpose
      of life is to learn, expand, and apply what they learn) from
      those that go as far as turning the computer on." (-The
      ...
      government" - "Hackers strike again" (false) Call them
      ...
      ------------------001--------------------------------
      the below is an email, and responce excerpted from Keen
      Veracity 4
      -----------------------------------------------------
      [mail] 
      Do you still hack?
      ...
      down." Read my introduction in Keen Veracity 3 I go into
...
36.0 Bill to Limit Crypto Exports Approved 
     ...
     From HNN http://www.hackernews.com
      ...
      strength" that companies may export and
      ...
      Committee," said Jim Lucier, an analyst at
      ...
      information technology industry," Rhett
...
39.0 Virus Infestations on the Rise (?)
     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      dangerous," Bridwell said. "Viruses have become very
      dynamic," spreading through downloads and attachments. 
      ...
      personnel issues affecting professionals engaged in securing their organizationÆs data,
      ...
      "Employee access abuses continue to be the most common security breach, but itÆs
      clear that the growth of e-business has intensified the threat of computer attacks
      from outside the companyÆs walls," said Andrew Briney, editor-in-chief of
      ...
      For complete survey results, visit Information SecurityÆs Web site at
...
42.0 Highschool crackers 
     ...
     years worth of the principalÆs work. School officials said that their system has been
...
43.0 Unauthorized Access to IIS Servers through ODBC Data Access with RDS
     ...
     instructions in MS98-004". Just a reminder this advisory deals with The RDS
...
44.0 Who's fault is the Y2K bug?
     ...
     everyone?" she says. She points proudly to her husband. "That all started
     with this kid!"
     ...
     Avoid the Coming Worldwide Computer Systems Collapse," they predicted
     ...
     says, they might have known it was unwise. He knew. 
...
49.0 Windows2000 introduces Public Key Encryption 
     ...
     http://www.aviary-mag.com/Archive/News/Public_Key_Cryptography_In_Win/PKI_in_Win2k_White_Paper/pki_in_win2k_white_paper.html
      ...
      Primarily, these support the PKCS standards and evolving Internet Engineering Task Force (IETF)
      ...
      In this model, children are certified by parent CAûissued certificates, which bind a CA's public key to
      ...
      CAs. There are several practical reasons for supporting multiple issuing CAs. These include: 
           ...
           UsageùCertificates may be issued for a number of purposes (for example, secure e-mail,
           ...
           Organizational divisionsùThere may be different policies for issuing certificates, depending
           upon an entity's role in the organization. Again, you can create issuing CAs to separate and
           administer these policies. 
           Geographic divisionsùOrganizations may have entities at multiple physical sites. Network
      ...
      in this process include: 
           ...
           Selecting the host serverùThe root CA can run on any Windows 2000 Server platform,
           ...
           NamingùCA names are bound into their certificates and hence can not change. You should
           consider factors such as organizational naming conventions and future requirements to
           distinguish among issuing CAs. 
           Key generationùThe CA's public-key pair is generated during the installation process and is
           unique to this CA. 
           CA certificateùFor a root CA, the installation process automatically generates a self-signed
           ...
           Active Directory integrationùInformation concerning the CA is written into a CA object in
      ...
      Issuing policyùThe enterprise CA setup automatically installs and configures the
      ...
      Physical protectionùSince CAs represent highly trusted entities within an enterprise,
      ...
      Key managementùThe CA keys are its most valuable asset because the private key
      ...
      RestorationùLoss of a CA due to hardware failure, for example, can create a number of
      ...
      the PKI defines five standard certificate stores: 
           ...
           MYùThis store is used to hold a user's or computer's certificates for which the associated
           private key is available. 
           CAùThis store is used to hold issuing or intermediate CA certificates to use in building
           certificate-verification chains. 
           TRUSTùThis store is used to hold Certificate Trust Lists (CTLs). These are an alternate
           ...
           ROOTùThis store holds only self-signed CA certificates for trusted root CAs. 
           UserDSùThis store provides a logical view of a certificate repository that is stored in the
      ...
      propagated to Windows 2000ûbased client computers.
      ...
      has been dramatic. For many uses, security is a key consideration. Notably: 
           ...
           Server authenticationùTo enable clients to verify the server they are communicating with. 
           Client authenticationùTo allow servers to verify the client's identity and use this as a basis
           for access-control decisions. 
           ConfidentialityùEncryption of data between clients and servers to prevent its exposure over
      ...
      Public Key Infrastructureûbased security is relatively new, and there are very few case studies of
