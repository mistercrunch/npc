...
crear daño, o tambien, para favorecer al creador con su locura
...
exe (o "ZM")
despues hay que conocer el tamaño del archivo y modificar el header, calcular
...
hay:
        ...
        sub     ax,3                            ;Pone el tamaño del file
