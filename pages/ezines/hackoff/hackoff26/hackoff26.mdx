...
`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°
     ...
     /                                                                        \
    /  Bienvenue dans ce Hackoff No 26 LAst Θdition pour l'annee 2001, une     |
   /  edition plutot tardive Θtant donnΘ qu'elle est a cheval avec 2002, et    |
  /  aussi discutable puisque "LAst" et Θgalement "FIrst" est son Θdition...   |
 |  Avant le sommaire de ce hackoff, on vous dΘconseille de taper ce qui suit  |
 ...
 | AOL et FDO, des IDS et des hertz, du Gard derniere cuvΘe, des castors en   /
 | purΘe, du php bafouΘ, du jargon expliquΘ, et 73 fois le caractere "@"     /
...
\ Dec 2001 /    |     [1]   Edito                             lansciac         |
 »»»»»»»»»»     |     [2]   Aol Protocol                      tobozo           |
                ...
                |     [6]   PrΘsentation PHP sΘcuritΘ         tobozo           |
...
rΘtractent car  hacker et  triquer en  Θtant traquΘ c'est trop cinoque. On n'est
pas  ventriloques mais juste assez loufoques pour pouvoir bricoler un micro sans
pare-chocs braquΘ sur le frolic.
...
que  le  morceau de cuir  finement cousu, reliΘ α  une semelle assez solide pour
...
Ωtre  la mΘthode shadok ou encore la mΘthode Θchelon, le broyage verbeux de gros
dictionnaires  comportant des  mots que  seuls eux  et leurs  gΘniteurs sont  en
mesure  de comprendre, α la condition sine qua non d'un test de paternitΘ validΘ
et  non pas  l'adoption enarquiale  usuelle ne  rΘvΘlant en  gΘnΘral que  peu de
vΘritΘ,  tel  shakespeare en faux  seigneur, mais  vrai rustre et critique qu'il
Θtait.

A qui ne profite pas la guerre?

[guerre non-profit]
A  mes chaussures, α  mon lacet defait, α mon cd foirΘ, α mon tΘlΘphone portable
dont  la  carte SIM est hs,  au carrΘ qui ne  sera jamais un cercle, α Pythagore
qui  est  mort, aux jumelles qui  sont mortes, α  l'agenda de 1984, α un windows
3.11  sans rΘseau, α l'imprimante sans papier, aux sans papiers avec certificat,
aux certificats bidons, aux bidonvilles crΘΘ, aux villes en deuil, au deuil sans
mort,  aux  sacs plastiques non  recyclabes, α la  m⌠le occidentale, au port usb
qui  ne sera  jamais parallele, α la rfc  1042, α la pommade numΘro 75 610, au 3
rue de l'impasse. La liste est sans nulle doute immensΘment longue, et il serait
injurieux  de vouloir la dresser, pouvant de ce fait vouloir limiter l'intellect
et  l'imagination  que chacun possΦde. Devant  cette sentence ainsi faite, il ne
nous reste plus grand choix que de nous plier α l'autre c⌠tΘ.

[guerre benefits]
Au  3  rue de  l'impasse qui  sera bient⌠t rebatisΘe  au nom  de l'inconnu, α la
pommade  numΘro  75 610  qui  servira  son  producteur  dans les  soins  qu'elle
apportera  aux blessΘs, α la rfc 1042 qui va connaεtre un complΘment de cryptage
intΘressant,  au port  usb qui dans un soucis de reconnaissance instantanΘe fera
disparaεtre  un port parallΦle depuis longtemps usΘ, α la m⌠le occidentale α qui
ont  prΘfΦre  un chacal  bien cuit,  aux sacs plastiques  non recyclables car on
augmente  le  prix du  pΘtrole, aux  deuils sans mort,  car l'espoir rΘside, aux
villes  en deuil  car  la vengeance  est  leur, aux  bidonvilles  qui vont  Ωtre
reconstruits,  α l'agenda  de 1984  qui prend  son repos  au sein  de 2002,  aux
jumelles  qui sont  mortes  car emblΩme  elles demeurent,  α  Pythagore qui  est
thΘorisΘ  dans  n'importe quelle cible,  au cercle qui  ne sera jamais carrΘ, au
fondeur  qui pour la peine rΘalisera ma puce SIM, un nouveau CD, α mon lacet qui
contre  un scratch  s'est fait echanger, α mes savates qui encore quelques temps
devront me supporter.

[ndt:allegro ma non troppo]
Bien,  mal,  petit ou grand,  blanc ou noir,  chrΘtien ou musulman, combien dans
...
partie  de la  vie de l'insouciant. Cependant α Ωtre prisonnier dans une libertΘ
antΘrinΘe, ne prΘfereriez vous pas de votre propre main pouvoir dΘcider... Libre
de  mourir  ou mourir libre, la  subjectivitΘ et le positionnement prend tout de
mΩme  un  certain emplacement. Dans la  position, il faut faire attention, de ne
pas sur la tΩte, se prendre un tronc...
...
Traduit de l'anglais et adaptΘ par tobozo (2001)    tobozo@users.sourceforge.net
...
protocole AOL et comment se bricoler un client avec du VB. Il est diffusΘ sur le
...
En Θvoquant "Le protocole  AOL", le premier mot qui devrait venir a l'esprit est
FDO. Et bien  que  FDO fasse  partie  du protocole  AOL, il  n'en  sera que  peu
question dans  ce  document.  Le  terme  "Protocole  AOL"  est  utilisΘ  ici  en
rΘfΘrence a une  relation interactive entre un client et un serveur AOL, comment
les donnΘes sont prΘparΘes, envoyΘes, et comment elles peuvent etre manipulΘes.
...
protocole  AOL  (en tous cas pas publiquement) et dont la disponibilitΘ permette
d'en parcourir le contenu.

Il n'existe pas  pour  le  moment de  documentation  disponible publiquement  (a
part  celle ci) qui dΘcrive formellement  le protocole  AOL.
...
3)  Logguage des Paquets de DonnΘes d'AOL
4)  Formation des paquets de donnΘes
5)  Pinger
6)  A propos de la dΘcompression FDO
7)  Vue d'ensemble
...
A. Serveurs -
-------------
Le serveurs AOL sont  gΘnΘralement sur le port 5190. Le serveur auquel le client
se  connexte   est  sΘlΘctionnΘ   au   hasard   par   la  DNS   roulette   russe
'AmericaOnline.aol.com'. Il y a des centaines de serveurs AOL liΘs ensemble (des
stades  de  foot remplis de serveurs !!).  Mais comment ils  font pour Θviter le
...
port 5190. Rien de  bien compliquΘ jusqu'ici, ca peut meme etre fait par telnet.
En general les  serveurs sur lesquels on  est redirigΘ lors d'une connexion a un
...
verra dΘconnectΘ.
AOL utilise  ca de  facon a dΘsactiver  les vieilles versions  de clients et les
forcer a upgrader (ca fait vachement penser a m$ quand meme;-));
Quand le serveur  ne donne aucune rΘponse  c'est que le paquet n'etait pas formΘ
correctement...

Client:
5A413800347F7FA3036B0100F5000000050F00002152CBCA070A1000080400000000035F00000100
04000300080000000000000000000000020D
Client:   ZA8┼4ú♥k┼⌡┼┼┼♣┼┼!R╦╩►┼♦┼┼┼┼♥_┼┼┼♦┼♥┼┼┼┼┼┼┼┼┼┼┼┼☻
...
C. Envoi du Pseudo et du Mot de passe -
---------------------------------------
Apres que  le serveur ait acceptΘ  le "handshake", le  Pseudo et le mot de passe
sont envoyΘs. Si  le Pseudo et le  Mot de passe correspondent, le serveur envoie
alors l'information de  dΘsactivation du Master Tool, et envoie aussi la fenetre
...
Θchecs successifs,  le serveur enverra des  paquets d'insultes (XS) et le client
sera dΘconnectΘ..
...
Client:   Z$?┼C►►Dd┼§┼┼♦┼┼┼♦┼┼┼♥holytable ↔┼↔┼♦┼┼┼☻♥satan666↔┼┼☻┼

D. ComplΘter le login -
-----------------------
...
c'est configurΘ,  d'afficher la  Buddy List.  Une fois  l'IP assignΘe il devient
...
00D
Client:   ZN║┼♥►↑ñZ╞æ┼-∟yaZ\4┼" ∟tl┼↨┼┼♦┼{╡Φ►♦↔ª▌≥E♦┼┼┼┼☻┼ZoJ┼‼∟SC┼§┼┼┼☻┼
...
Server:   ZA¢┼5↔‼ ya♥♦¼Ö.►☻☻┼♦♦ÿú╬å♣☻♥└§153-46-16.ipt.aol.comZ~æ┼--‼
tj┼{╡Φ↔ª▌≥┼┼┼┼┼imfartp.but┼
...
2) Les paquets -
----------------
La structure de ces paquets est restΘe mystΘrieuse pendant longtemps (il parait)
...
en  Hexa). Tout ce qui se  trouve apres les  10 premiers octets est compressΘ en
FDO ou en ligne de donnΘes.
Le passage au detail des 10 premiers octets :

A. Sur  toutes les version  AOL, le premier  octet est toujours  Θgal a z (5A ne
...
(VΘrification de Redondance Cyclique). Non il ne s'agit pas d'un gaz qui dΘtruit
la  couche d'ozone,  mais  il  est  quand meme  utilisΘ  dans  le  cadre  de  la
compressions. Par exemple pour s'assurer qu'aucune donnΘe n'a ΘtΘ corrompue dans
un  fichier, l'entete CRC doit correspondre  aux donnΘes du fichier lui meme. Il
...
Le CRC est extrait  du paquet duquel ont ΘtΘ supprimΘs les 5 Octets (le header).
Le nombre  produit par l'algo  est alors utilisΘ pour  produire les bits 'Hi' et
'Lo' qui sont  alors  placΘs  dans le  2e  et  le 3e  point  du  header. Le  CRC
s'applique seulement sur les versions 3.0 du client AOL et versions anterieures.
Les versions  plus  rΘcentes  d'AOL  envoient simplement  '**'  en  deuxieme  et
troisiemes Octet. On  peut donc tres bien  s'en sortir avec ces versions la sans
avoir a utiliser ce maudit CRC, mais dans tous les cas il y aura plus de donnΘes
a envoyer. Si  le CRC  doit  etre utilisΘ  coute  que coute,  les choses  seront
...
de C++ et Visual Basic (merci a la communautΘ AOL et a l'auteur anonyme).
...
D. Le  5e Octet est  l'Octet de  longueur, il dΘfinit  plus ou moins la longueur
...
L'octet situΘ directement  avant tout  chaine contenue  dans le  paquet (pseudo,
chat, donnΘes  de formulaires,  etc) est  aussi un Octet  de longueur. Cet Octet
reprΘsente la  longueur de  la chaine  qui suit. et  n'est pas comptabilisΘ dans
la reprΘsentation du  5e octet  de longueur.  Voici un  subroutine Visual  Basic
...
octet qui doit etre placΘ dans le paquet.
...
de quoi sera composΘ la prochaine paire. Ces paquets sont differents pour chaque
nouveau paquet.  Cette enigme  n'est  pas  rΘsolue  dans  ce document  mais  une
solution  de remplacement y est considΘrΘe :
...
IdΘe :
Avant l'envoi  de chaque  paquet, on peut  incrΘmenter chacun de  ces bits de 1.
Bien que le  client semble se livrer a une distribution completement diffΘrente,
cette methode marche a merveille ;-))
On ne peut  pas incrΘmenter de 1 a  l'infini bien sur ;-) Au bout d'un moment le
...
Partant de  ces donnΘes,  seule l'imagination limite  les implΘmentations, le 6e
et 7e octet avec des valeurs de 127 et 135 par exemple (hehehe).
Par hypocrisie on va appeler ces octets "octets de comptage".

SpΘculations mode="parano":
ces octets peuvent  etre citΘs  en rΘfΘrence  comme "battements  de coeur".  Les
paquets "ping-like"  de 9 caracteres  qui sont envoyΘs en permanence contiennent
probablement des  valeurs qui  informent le serveur  sur la santΘ/utilisation du
client AOL, et qui sait peut etre d'autres informations plus consistantes ??


F. Le 8e octet est simplement un espace.

G.  Enfin, le 9e et 10e Octet  (en ASCII) reprΘsentent le token. Les habituΘs de
FDO savent que le token prΘvient le serveur de ce qu'il attend.
...
3) Logguer  les paquets de  donnΘes AOL est  une compΘtence tres important quand
...
rΘalisΘ en direct  et a la main  (a moins d'avoir un implant dans la cervelle;),
l'opΘration (pour  former  les  paquets,  pas  pour  l'implant)  Θquivaudrait  a
Θcrire en  FDO, compresser le FDO  et ajouter le  header, le tout en temps rΘel.
Bien que cela ne soit pas completement impossible (les implants c'est pas cher),
la meilleure  mΘthode reste  encore le  recyclage de  paquets dΘja logguΘs qu'on
peut modifier a volontΘ la ou c'est nΘcΘssaire.
RΘcuperer des paquets  AOL  est assez  simple, il  suffit  de crΘΘr/utiliser  un
programme qui va  ecouter sur le port 5190 pour toutes les connexions entrantes.
Ensuite il faut jeter son dΘvolu sur la version d'AOL a espionner..
...
entre  la crΘation, la diffusion et la traduction de cet article, qu'AOL ai fini
...
situΘ dans  le repertoire 'ccl' et remplacer l'occurence 'AmericaOnline.aol.com'
...
On peut alors  lancer  le client  AOL  et  vΘrifier que  lors  d'une demande  de
connexion le programme de logging forwarde bien la demande.

On peut  alors commencer  a intercepter  les donnΘes en  sΘparant les donnΘes du
serveur des donnΘes du client.

A partir  d'une machine  windows  cela  peut poser  des  problemes  a cause  des
caracteres "NULL" qui, quand ils sont mis dans une textbox, reprΘsentent une fin
de  ligne et rendent  illisible le  texte qui  suit sur  la fin  de la ligne. en
Θditant le caractere  NULL d'une  chaine  on peut  rendre lisible  le paquet  en
entier.
...
est inutilisable et ne peut etre renvoyΘ au serveur.
...
Avant tout il faut un des paquets qui ont ΘtΘ logguΘs plus haut.
Voici un paquet logguΘ IM :
...
IM EnvoyΘ au pseudo 'godsmisf1t' avec le message 'hi'.
...
On a donc identifiΘ  les donnΘes a changer, il ne reste plus qu'a les Θditer, et
aussi a  Θditer l'octet  situΘ directement  avant les chaines  en accord avec la
longueur des varaibles modifiΘes.
...
en  hexa  et  les  octets  qui  les  prΘcedent  directement  sont  supprimΘs  et
remplacΘs par  la  valeur  hexa correspondant  a  leurs  longueurs  respectives.
...
Juste apres le  login  on avait  remarquΘ  que les  valeurs du  6e  et 7e  octet
...
soient stockΘes dans  des variables  publiques afin  de pouvoir  les incrΘmenter
et ainsi produire  les  "battements  de coeur".  Comme  expliquΘ  plus haut  ces
valeurs doivent  etre rΘinitialisΘes  des qu'elles atteignent respectivement les
valeurs 127 et 135.
...
doivent etre remplacΘs avec les variables :
...
Le paquet  est pret  a etre  envoyΘ avec la  fonction DeHex  qui va l'envoyer au
serveur.

whatyousend$ = DeHex(packet$)

Il suffit d'envoyer  whatyousend$ au serveur, et si tout a ΘtΘ fait correctement
...
Form1.Winsock1.SendData whatyousend$ 'On part du principe que le formulaire
                                     ...
                                     'Microsoft Winsock Control est utilisΘ.
End Function
...
5) Les Ping
-----------
Apres avoir rΘussi  a  Θtablir une  connexion  avec  AOL  (ca  peut prendre  des
annΘes;), on peut  constater qu'AOL  envoie des  petits paquets  qui ressemblent
a ca :
Serveur:   5A647D00032313260D
Serveur:   Zd}┼♥#‼&

Ces paquets sont  similaires a des ping.  Le serveur vΘrifie si la connexion est
toujours en  bonne santΘ. Le fait de ne pas y rΘpondre  met la connexion en mode
suspendu (aucune autre  donnΘe  ne  peut circuler  jusqu'a  ce  qu'un ping  soit
envoyΘ et/ou rΘpondu).
La rΘponse attendue  par le serveur est heureusement simple a produire, on prend
...
Dans le 'Winsock Data Arrival event' dΘposer ceci :
...
Pour une utilisation applicative, il est recommandΘ d'intΘgrer un timer qui aura
pour role d'envoyer constamment des ping au serveur AOL.

Note : lors d'une rΘponse a un ping, il est inutile d'incrΘmenter le 6e et le 7e
...
Les paquets traitΘs plus  haut ne reseemblent pas vraiment a du FDO, et pourtant
il sont  bien compressΘs en  FDO. Un rapide coup  d'oeil permet de localiser les
zones de compression.  Il est meme possible d'Θcrire une subroutine qui va faire
le travail :
...
savent dΘclarer  une fonction  depuis une  DLL (pour les  autres faudra lire des
...
Voici les fonctions qui se trouvent dans le fichier æada.dllÆ :
...
Le rΘsultat des  sujets abordΘs dans ce  document, c'est un client AOL en Visual
Basic capable d'envoyer  des IM. Ce client utilise les fonctions expliquΘes plus
haut.

1)  DΘmarrer un nouveau projet
2)  Ajouter Microsoft Winsock Control au projet
3)  CrΘer un controle sur le formulaire
4)  CrΘer deux boutons de commande (Connect, Send IM)
5)  CrΘer cinq boites texte(Status, Screenname, Password, IMName, IMMsg)

Dans 'Declarations' dΘposer ceci :

Dim sixth as String
Dim seventh as String
Dim packet as String

Dans le bouton 'Connect' dΘposer ceci :

Call Winsock1.Connect("AmericaOnline.aol.com", 5190) 'Ouvrir une connexion vers
                                                     'le serveur AOL

Dans les Θvenement de 'Connect' du Winsock control, dΘposer ceci  :
...
Dans les Θvenement des 'DataArrival' du Winsock control, dΘposer ceci:

Winsock1.GetData sData, vbString 'DΘpose les donnΘes envoyΘes dans 'sData'
...
"1010A044640015000100010A0400000001010B04000000010301" & screenname1$ &
"20011D00011D00010A04000000020301" & password1$ & "011D000002000D")
Winsock1.SendData packet$ 'Sends the screenname/password.  If you donÆt
...
Dans le bouton de commande 'Send IM' dΘposer ceci :
...
Dans l'Θvenement 'SendComplete' du Winsock control dΘposer ceci :
...
Dans l'Θvenement 'Change' du status de la boite texte, dΘposer ceci :
...
Il faut s'assurer  que status.Text est dΘfini en multiline=true et qu'il possede
bien des barres de scroll.

Si tout a  ΘtΘ fait correctement, on a maintenant une version fonctionnelle d'un
...
La seule raison  pour laquelle  ce document  n'a pas  ΘtΘ diffusΘ  plus tot  (sa
traduction remonte  a 1999)  est  l'abus  que  certaines personnes  et  sociΘtΘs
...
rend la totalitΘ de ce document obsolete, have phun  ;-))
...
ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,
  ...
  /------------------------------------------------------\
  | La rΘcursivitΘ et l'appel sΘquentiel des scripts PHP |
  | ---------------------------------------------------- |
  | un dΘlire schizophrΘnisant proposΘ par GarD - 16/8/1 |
  \------------------------------------------------------/


Avertissement  formel: Cet  article est un ensemble de conjectures aboutissant α
une  thΘorie,  il ne faut  donc pas s'attarder  α l'aspect illogique de certains
points  car  la  thΘorie finale  est  en  elle  mΩme  un paradoxe  et  constitue
d'ailleurs  le seul but dudit article, concentrez vous seulement α comprendre o∙
on  veut  en venir et ensuite  vous en ferez  ce que vous voudrez (des confettis
probablement,  ou  pour les plus  cinglΘs d'entre vous  tenterez de la mettre en
pratique  ou de  la dΘformer en soufflant  dans la valve pour en faire un castor
hΘliumisΘ).

Tout  est parti de la rupture thermo-nuclΘaire d'une veine cΘrΘbrale, d'une idΘe
rebondissant dans tous les sens, et de cet Θchange verbal digitalisΘ:
...
lui meme et sexecuter avec des argues en postvar '#!! t'as une idΘe? -
...
Seulement... Seulement voilα. Un script qui s'appelle lui mΩme et un utilisateur
par procuration, que ce soit possible ou non le concept est assez intΘressant de
par le fait que la thΘorie en Θveille d'autres.

CONJECTURES

1) PremiΦre conjecture:

Imaginez  d'abord un script qui s'appelle lui mΩme, un script qui exΘcuterait un
script  en  quelque sorte,  alors l'exΘcution  du second  script (qu'il soit lui
meme  ou non) est inhΘrente α la fonction fsockopen qui mourra en mΩme temps que
le  premier script  dΘcimΘ  par le  timeout d'exΘcution.  Aussi  nous sommes  en
prΘsence  d'un second  script qui bien que n'Θtant pas exΘcutΘ par l'utilisateur
lui  mΩme est  dΘpendant  de celui-ci  (et  si vous  fermez  votre browser  tout
s'arrete). Fin de conjecture.

2) Seconde conjecture:

Imaginez  dΘsormais un  script php qui crΘerait un fichier, se copierait dedans,
et  exΘcuterait le  script crΘΘ  qui  lui mΩme  crΘerait un  nouveau fichier  se
crΘerait  dedans et  l'exΘcuterait et  caetera et  caetera; une  fois ΘcartΘ  le
tourbillon  mental de  la rΘcursivitΘ  dans  les exΘcutions  subalternes et  les
copies  d'entitΘs  destinΘes α l'exΘcution  nous serons en prΘsence d'une chaine
d'exΘcution  de scripts  dΘpendante  du simple  timeout  d'exΘcution du  premier
maillon de la chaine. Fin de conjecture.

3) TroisiΦme conjecture:

Dans  un tel shΘma  nous sommes donc en prΘsence, α un bout ΘloignΘ d'une chaine
d'exΘcution,  d'un  script (d'execution sub^n) dΘpendant des couches supΘrieures
mais  α  y regarder  de plus  prΦs il  dΘpend prioritairement  du script qui est
derriΦre lui et qui l'a initiΘ via fsockopen, script qui lui mΩme est exΘcutΘ de
la  mΩme maniΦre.  Alors en observant cette portion de la chaεne nous constatons
des  scripts  php qui ne  sont apparemment pas  d'une exΘcution dΘpendante α une
action  de l'utilisateur.  Le paradoxe prend toute son ampleur ici. Car imaginez
dΘsormais  ce qu'il se  passerait α l'instant prΘcis o∙ le premier maillon de la
chaine  (le  script que vous  exΘcutez) mourra  de timeout cancΘrigΦne; en toute
logique  le  lien fsockopen vers  le deuxiΦme  maillon sera brisΘ et l'exΘcution
du  deuxiΦme maillon  se  terminera puis  le lien  fsockopen  vers le  troisieme
maillon se brisera et le troisieme maillon se cassera etc. Mais imaginez qu'il y
ait  200  (ou 200000)  maillons et  imaginez que la  mort sΘquentielle de chaque
maillon ne soit pas "absolument" instantanΘe, alors...
Alors  nous serions en  prΘsence, pendant un temps x, d'un script, le dernier de
la  chaine, qui  s'executerait  sous la  tutelle du  maillon  infΘrieur qui  l'a
initiΘ,   alors  que   le  script  que  VOUS  avez  exΘcutΘ  est  DEJA  terminΘ.
Un  script PHP  qui continuerait a s'executer sans la prΘsence de l'utilisateur.
Fin de conjecture.

4) QuatriΦme conjecture:

Reprenons  les  fondements de  la troisiΦme  conjecture et dΘveloppons. Imaginez
que  le temps de  dΘcallage entre la mort du premier maillon et celle du dernier
maillon  soit  quantifiable, et qu'il existe  un moyen paliatif α ce dΘlai. Pour
cela  prenons l'hypothΦse  d'un script  qui au  lieu de  crΘer et  d'exΘcuter un
nouveau  script en  crΘerait 10 et que  chacun d'entre eux en crΘerait 10 autres
(histoire de donner dans la logarythmique), nous serions en prΘsence d'un nombre
plus  consΘquent de  maillons de chaine α  dΘtruire et un dΘlai de destruction x
allongΘ. Prenons dΘsormais l'hypothΦse d'une Θquation possible entre le nombre y
de  scripts crΘΘs  et le temps de  crΘation de nouveaux scripts α un Temps donnΘ
(la  mort du  premier maillon) qui deviendrait infΘrieur au temps de destruction
des  maillons,  nous serions en  prΘsence d'une  exΘcution infinie de scripts en
dehors  de la prΘsence de l'utilisateur et donc la conclusion fondamentale de la
thΘorie fracassisante (crΘnom d'un ours blanc):

THEORIE CONCLUSIONNANTE

Un script php pourrait s'exΘcuter sans utilisateur.

Paf.

La  thΘorie intΘressant  dΘjα plusieurs personnes avant mΩme qu'elle soit Θcrite
il  est  possible (possible  disais-je,  non  plausible)  que  vous ayez  un  ou
plusieurs  dΘveloppements lors  de numΘros ultΘrieurs de ce zagamine electrique.
D'ici lα, dΘtruisez vous bien le cerveau,

Bonsoir.



placard... quart d'heure heureux retour tournoi noyΘ yΘpresque squesΘlong longue
vue  vulnΘrable Θrable en sirop iro-shima ima-laya l'aya ca se fume noyΘ dans la
colle ΘcoliΦre ΘcornΘe corne de brume et de brouillard entre les feux arriΦre et
les  warning clignotant  tantot ou  tard tardivement  vivement demain  mains aux
fesses  supposΘe suppositoire fuite de gaz gaz hillarant larant fabian bian bian
ach  sehr  gut goute  moi ca  sataniste istambul  tamboula labas bataille rangΘe
gΘrant rentable table α manger genant
...
hertz@securix.org
23-06-2000
Introduction α LIDS (Linux Intrusion Detection/Defense System).

PrΘsentation

LIDS signifie en anglais "Linux Intrusion Detection/Defense System", en franτais
cela  pourrais donner  : "SystΦme  Linux de  dΘtection et  de protection  contre
l'intrusion.

Ce document est en rΘfΦrence du Howto sur Lids-0.8.1pre1.

A l'heure actuelle, faute de moyens, seule les architectures i386 sont
supportΘs.

Le  but du projet  est de protΦger les systΦmes sous Linux contre des intrusions
sous  root  par dΘsactivation des  appΦles systΦme au  niveau mΩme du kernel. Du
fait  que  vous avez besoins  d'administrer le systΦme,  LIDS peut Ωtre bien sur
dΘsactivΘ.

La premiΦre partie est de protΦger LIDS lui mΩme contre des intrusion sous root.
Ceci bien sur en admettant deux choses:

        -Le systΦme est sain (pas de backdoors, ...) jusqu'α la premiΦre
        installation de LIDS.
        -Vous Ωtes la seule personne α avoir un accΦs sur la console de
         l'ordinateur (de sorte  que vous pouvez  passer des  commandes au
         kernel  α  travers lilo, vous pouvez  booter sur un noyau de sauvegarde
         ou vous pouvez booter sur une disquette).


ProtΦger LIDS contre une intrusion sous root signifie:

    -Interdire les modules
        -Interdire l'accΦs α la "raw memory" (/dev/mem, /dev/kmem, /dev/kcore)
        -Interdire l'accΦs au "raw disk" (/dev/hdxx, /dev/sdxx)
        -ProtΦger  les fichiers ayant  pour r⌠le le dΘmarage du systΦme  (lilo
         files, kernel image, daemons, rc scripts, modules)
        -Interdire "raw access" au ports I/O (/dev/port, ioperm and iopl
         syscalls)


Ensuite, vous pouvez pensez α la dΘtection d'intrusion. Pour cela LIDS fournit:

        -Journalise quasiment tous les refus d'accΦs.
        -Place  des  flags read-only  et  append-only sur les programmes ou
         journaux
         contre une intrusion sous root.
        -Cache votre propres dΘtecteurs d'intrusion.


Pour la protection de votre systΦme, LIDS fournit:

        -Bloque  contre  toute modification  vos tables de  routage,  ainsi  que
         les rΦgles du firewall.
        -Bloque les opΘrations de montage.
        -ProtΦge les daemons contre les signaux.
...
Pour le compiler, allez dans le rΘpertoire et tapez:
...
Vous  devez  aussi Ωtre  sur  que  votre rΘpertoire  /etc  se  trouve sur  votre
partition  racine (/)  car LIDS α besoin de pouvoir lire /etc/lids.conf quand il
n'y a que / de montΘ.
...
Les systΘmes de dΘtection d'intrusions. Brouillon de document, commentaires
bienvenus.


PrΘsentation:

Les  systΦmes de  dΘtection d'intrusions  (IDS) sont  des outils  permettants de
dΘtecter                 des                activitΘes                suspectes.
Il  peuvent  Ωtre mis  en  place  sur une  machine  pour  dΘtecter les  attaques
effectuΘs  sur celle-ci  (IDS  locaux)  et peuvent  aussi  Ωtre configurΘs  pour
dΘtecter  toutes les  attaques effectuΘs  sur le  rΘseau; dans  ce dernier  cas,
l'on fera plut⌠t rΘfΦrence α NIDS (Network Intrusion Detection Systems).

L'approche   la  plus  courament  utilisΘ  pour  la  dΘtection  d'intrusion  est
la recherche de signatures (un peu comme les anti-virus).


Les systΦmes de dΘtection d'intrusion (IDS)

Les  IDS  locaux, sont les  systΦmes qui ne vont  dΘtecter que les intrusions en
local.
...
la     totalitΘ     du     segement     rΘseau     auquel     il     appartient.
Les  IDS  locaux et  NIDS ont  des avantages et  des inconvenients chacuns, nous
reviendrons plus tard sur ces diffΘrences.
...
En  addition, les  agents devront analyser les accΦs et changement effectuΘs sur
les  fichiers sensibles  du system. Ils pourront par exemple analyser le contenu
des fichiers de log pour dΘtecter des messages suspects.

Les outils qui fonctionnent de cette maniΦre sont par exemple:
...
Les systΦmes de dΘtection d'instrusion rΘseau (NIDS).

Les     NIDS     sont    des    dΘtecteurs    d'intrusion    orientΘs    rΘseau.
C'est  α dire  qu'ils  sont conτues  pour dΘtecter  les  activitΘs suspectes  se
dΘroulant sur le rΘseau et non sur une seule machine.

Architecture.

Comment les NIDS font leurs dΘtections.

Il y a deux techniques principales:

DΘtection d'activitΘ anormale:

L'approche  la  plus courante  de  la  dΘtection  d'intrusion est  la  dΘtection
d'activitΘ anormale grace aux statistiques.
L'avantage  de  cette technique est qu'elle  ne nΘcessite pas la connaissance de
types d'attaques.
...
signifie  que tout type d'attaque devant Ωtre dΘtectΘ doit au prΘalable avoir sa
signature  ajoutΘe  au system. Par exemple,  le NIDS va en permanence rechercher
des  motifs  telles que:  "/cgi-bin/phf?" (ceci reprΘsente  une requette sur une
application  CGI vulnΘrable). Les NIDS possΦderont souvent une base de donnΘe de
types  d'attaque connues.  Vous pouvez trouver des informations et rΘcupΦrer des
fichiers de signatures sur http://www.whitehats.com

Comment font-ils la comparaison des signatures avec le traffic entrant:

Un NIDS capture les paquets circulants sur le rΘseau, puis appliques quelques
techniques:
...
mal  formΘs  pour rΘaliser l'attaque.  Une simple vΘrification sur chaque paquet
permet de dΘtecter de tels attaques.

Application  protocol verification: Les attaques sont aussi souvent effectuΘs au
...
Creating new loggable events: Un NIDS peut aussi Ωtre conτu pour rapatriller des
logs (WinNT Event, UNIX syslog, SNMP TRAPS, etc.).

Plus tard il pourra les rΘassembler/triller sur un machine dΘdiΘe.


Placer le NIDS dans le rΘseau:

Les NIDS sont plus efficaces en pΘriphΦrie du rΘseau, tel, qu'a c⌠tΘ d'un
firewall, serveur d'accΦs distant,
et sur le lien d'un rΘseau partenaire.
...
-http://www.whitehats.com                        -->>  Base de donnΘe de rΦgles
pour Snort.
...
α  augmenter  ses capacitΘs. Dans  cet article, nous parlons  de ce que lids est
capable de faire et comment construire avec lui un systΦme Linux sΘcurisΘ.


Pourquoi LIDS.

Avec  l'augmentation de la  popularitΘ de Linux sur Internet, de plus en plus de
bug de sΘcuritΘ sont trouvΘs dans le systΦme GNU/Linux. Vous pouvez entendre sur
Internet  que -  Il y a des  bugs dans Linux, qui rendront le systΦme facilement
attaquable par un hacker.

Depuis  que Linux est  un art de la comunautΘ open source, les trous de sΘcuritΘ
peuvent  Ωtre trouvΘs  facilement et  peuvent  aussi Ωtre  aussi vite  corrigΘs.
Mais  quand  un bug  est publiquement  connue, et  que l'administrateur est trop
fainΘant pour corriger ce bug.
Il  est alors trΦs facile de pΘnΦter le systΦme et parfois plus grave encore, il
est possible d'obtenir  un shell sous root. Maintenant vous pouvez vous demander
quelle est la solution?

Qu'est-ce qui ne va pas avec le systΦme GNU/Linux.


- superuser (root) peut abuser de ses droits

        Sous root, il peut faire absoluement ce qu'il veut.
        Il peut changer les fonctions propres au systΦme.

- De nombreux fichiers systΦme peuvent Ωtre facilement changΘs.

Il  y  a de nombreux  fichiers importants, tel  que /bin/login, dans ce systΦme.
Si le hacker entre dans ce systΦme, il peut facilement changer ce programme pour
qu'il  puisse plus  tard se reconnecter avec n'importe quel pseudo/mot de passe.
Mais  normalement ces mΩme fichiers n'ont pas besoins d'Ωtre changΘs frΘquement,
sauf si vous faite un update du systΦme.
...
flexible  et modulaire.  Mais  une fois  le  module insΦrΘ  dans  le kernel,  il
devient  une  partie du kernel  et peut faire ce  que le kernel originel pouvait
faire.

De  cette maniΦre, du code nΘfaste peut Ωtre Θcrit et insΦrΘ dans le kernel α la
maniΦre  des  modules,  le  code  peut mΩme  rediriger  les  appels  systΦme  et
fonctionner de la mΩme maniΦre qu'un virus.

-       Les processus ne sont pas protΦgΘs.

Certains  processus, tels que les daemon web, qui sont critiques pour le systΦme
ne  sont pas  protΦgΘs de maniΦre stricte. De cette maniΦre, ils sont vulnΘrable
α l'attaque de crackers.


Avec  cette  description, comment  peut-on construire  un systΦme sΘcurisΘ? Nous
devons  premiΦrement avoir  un kernel sΘcurisΘ et en suite construire construire
une sΘcuritΘ autour.
...
"Linux  Intrusion  Detection System"  est un  patch qui  augmente la sΘcuritΘ du
kernel  de Linux. Quand il est en activite, l'accΦs α certains fichier, α chaque
opΘration  d'administration  systΦme/rΘseau, "raw device", "mem" et "I/O access"
peuvent  Ωtre rendus  impossible, mΩme  pour root.  Il utilise  et augmente  les
capacitΘ du systΦme en placement ces fonctionnalitΘs directement dans le kernel.

En rΘsumΘ, LIDS fournis Protection, DΘtection et RΘponse aux intrusion dans le
kernel de Linux.

- Protection.

LIDS  peut  protΦger les fichiers  importants de  votre systΦme, peu importe sur
quel  systΦme de  fichier ils se trouvent, personne ne pourra les modifier, mΩme
pas le root.

LIDS  peut  aussi portΦger les  systΦmes importants et  les empΦcher de se faire
tuer.  LIDS peut  prΘvenir contre des opΘrations de programmes non authorisΘ sur
"RAW  IO". Il peut  aussi protΦger le disque dur, en incluant une protection sur
le MBR, etc.

- DΘtection.

Quand  quelqu'un scan  votre  machine,  LIDS peut  le  dΘtecter  et en  informer
l'administrateur.  LIDS peut aussi dΘtecter des activitΘ annormales se dΘroulant
sur le systΦme.

- RΘponse.

Quand quelqu'un viole les rΦgles, LIDS tiens un journal dΘtaillΘ en rapport avec
cette  violation. LIDS peut aussi envoyer un message par mail. Dans ce cas, LIDS
peut aussi dΘconnecter l'utilisateur.


 Construire un systΦme sΘcurisΘ par LIDS.

Nous allons vous comment construire ce systΦme, pas α pas.

TΘlΘcharger le patch LIDS et le kernel correspondant.

Vous pouvez tΘlΘcharger le patch lids depuis http://www.lids.org  et
ftp://ftp.lids.org, vous pouvez aussi essayer les miroirs rΘpartis mondialement
sur  http://www.lids.org/mirrors.

Le nom du patch sera lids-x.xx-y.y.y.tar.gz, x.xx reprΘsente la version de lids
et y.y.y reprΘsent la version du kernel.

Vous  devez absolument tΘlΘcharger le kernel correspondant. Par exemple, si vous
tΘlΘcharger  lids-0.9pre4-2.2.14.tar.gz,  vous devrez tΘlΘcharger les sources du
kernel 2.2.14. Vous pouvez tΘlΘcharger les sources du kernel sur
ftp://ftp.linux.org

1. dΘcompressez le code source du kernel.
# cd linux_install_path
# bzip2 -cd linux-2.2.14.tar.bz2 | tar -xvf -

2. dΘcompressez le code source de LIDS..
# cd lids_install_path
# tar -zxvf lids-0.9pre4-2.2.14.tar.gz

Pacher LIDS sur le kernel de Linux

AprΦs avoir tΘlΘcharger le code source du kernel et lids, dΘcompressez les.
Par exemple, si vous tΘlΘcherger lids-0.9pre4-2.2.14.tar.gz et
...
4. copiez bzImage dans /boot/ et Θditez /etc/lilo.conf
...
Maintenant,  avant de  rebooter,  vous  devez configurer  lids  pour opΦrer  vos
besoins en sΘcuritΘ. Vous pouvez dΘfinir les fichiers α protΦger, les processus,
etc. Dans le chapitre suivant, nous vous montrerons les dΘtails de se sujet.

Rebooter le systΦme

AprΦs  avoir  configurΘ   votre  systΦme,  rebootez  le.  Quand  lilo  apparait,
sΘlectionneez le kernel patchΘ par lids. AprΦs cela, vous entrerez dans le monde
merveilleux de LIDS.

ProtΦger le kernel.


AprΦs avoir rebooter, n'oubliez pas de protΦger le kernle grace α lidsadm, vous
pouvez placer cette commande α la derniΦre ligne de /etc/rc.local.
...
AprΦs avoir protΦgΘ votre kernel, votre systΦme est maintenant protΦgΘ par LIDS.
Vous  pouvez faire des tests dessus. Si vous souhaitez changer la configuration,
vous pouvez changer votre niveau de sΘcuritΘ en fournissant un mot de passe.
...
PremiΦrement,  vous devez dΘterminer quels sont les fichiers α protΦger. Dans la
plupart  des cas, vous pouvez protΦger les fichiers binaires et de configuration
tel que /usr/, /sbin/, /etc/, /var/log/.

DeuxiΦmement, vous devez dΘcider la maniΦre pour protΦger ces fichiers. LIDS
fournis trois types de protection:

- Fichiers en lecture seule.
Les fichiers marquΘ en lecture seule, signifie que personne ne peut les changer.
...
1. Pour protΦger l'ensemble des fichiers de /sbin/ en les mettant en lecture
seule.

 # /sbin/lidsadm -A -r /sbin/

2. Pour protΦger le fichier /etc/passwd en lecture seule
...
La plupart des fichiers qui doivent Ωtre en ajout unique sont les fichiers de
journaux, tels que /var/log/message
,/var/log/secure.
Ces  fichiers  peuvent uniquement Ωtre ouverts  pour un ajout, et ne peuvent pas
Ωtre modifiΘs du contenue prΘcΦdement ajoutΘ, elle ne peuvent pas Ωtre supprimΘs
non plus.
...
1. Pour protΦger les fichiers de journaux du systΦme

# /sbin/lidsadm -A -a /var/log/message
# /sbin/lidsadm -A -a /var/log/secure

2. Pour portΦger les fichiers de log httpd
...
LIDS  peut protΦger les processus qui ont pour pΦre init(pid=1), pour cela, vous
devez bloquer le kernel avec les options suivantes.

# lidsadm -I -- +INIT_CHILDREN_LOCK


ProtΦger avec les "capability".

Les  "Capabilities" sont  comme  des  privilΦges que  vous  pouvez  donner α  un
...
prochain redΘmarage. (Voir http://www.netcom.com/~spoon/lcap)

LIDS  modifie ce  comportement pour  vous permettre  de les  dΘmarrer ou  de les
arrΩter a tout moment. Un accΦs α /proc/sys/kernel/cap_bset est attrapΘ et lance
une allerte de sΘcuritΘ. lidadm fait tout le travail.

Vous pouvez lister toures les capabilities en lanτant lidsadm, et vous pouvez
...
Avec cette "capability on", nous pouvons
       permettre l'accΦs α ioperm/iopl et /dev/port,
       permettre l'accΦs α /dev/mem et /dev/kmem et
       permettre l'accΦs α "raw block devices" (/dev/[sh]d??)

Quand  nous  dΘsactivons  cette  "capability", nous  pouvons  rendre  touts  les
processus du system sans aucun droits sur la "raw device", tel que lilo.

Mais  certains processus  peuvent avoir  besoin de  cette capacitΘ  pour pouvoir
...
Cette "capability" α les fonctions suivantes,
...
Pour  des  raisons de  sΘcuritΘ, nous  devons dΘsactiver  ceci pour interdire le
changement  de configuration  rΘseau. Quand  ceci est  dΘsactivΘ, les  rΦgles du
firewall ne pouront Ωtre changΘs.

Choisissez  les "capability"  et scellez  le kernel,  vous devez  chosir quelles
"capability"  vous  devez dΘsactiver  au moment  de sceller  le kernel. Voici un
exemple.

Vous  pouvez placer ce script dans un script de rc/ (rc.local, /etc/init.d/lids,
/etc/rc.d/init.d/lids,  etc.) cela dΘpend de votre distribution et de la maniΦre
dont vous administrez le systΦme.
...
LIDS fournis des amΘliorations au niveau sΘcuritΘ rΘseau..

SΘcuritΘ rΘseau avec "capbility"

Avec  les  capability, nous  pouvons augmenter la  sΘcuritΘ rΘseau. Nous pouvons
faire  de l'anti-sniffing,  empΦcher  l'ouverture d'un  port  infΦrieur α  1024,
empΦcher la modification des rΦgles du firewall et la table de routage.

Donc je vous conseille d'examiner avec attention chaque "capability" pour
comprendre son sens.

DΘtecteur de scan au niveau kernel

LIDS fournis un dΘtecteur de scan au niveau kernel pour pouvoir dΘtecter qui l'a
scannΘ.   Cette   fonction  peut  dΘtecter   des  scan  mi-ouvert,  nomaux  etc.
L'utilisation d'outils tels que nmap, satan peut Ωtre dΘtectΘ

Ceci  est trΦs  utile quand "raw socket"  est dΘsactivΘ. Dans ce cas, des outils
fonctionnant de dΘtection basΘs sur le sniff ne pourront fnctionner.

Si vous souhaitez cette fonctionnalitΘ, il vous faudra la sΘlectionner au moment
de la compilation du kernel.

Systeme de rΘponse face α l'intrusion.

Quand LIDS dΘtecte quelque chose violant les rΦgle dΘfinient, il peut rΘpondre α
cette action par les mΘthodes suivantes.

Journalise le message

Quand  quelqu'un  viole les  rΦgles, lids_security_log journalisera les messages
grace  α  klogd, la  journalisation  α  aussi  les  capacitΘs de  lutter  contre
l'inondation  "anti_logging_flood". Vous pouvez l'activer lors de la compilation
du kernel.

Journaliser les messages α travers un serveur de mail.

LIDS  α  une nouvelle fonctionnalitΘ pour  envoyer les messages sur votre compte
email. Vous pouvez dΘninir l'adresse IP du serveur de mail, l'adresse email, etc
au moment de la compilation du kernel.

Extinction de la console

Quand  un utilisateur  viole une  rΦgle, le  systΦme fermera  la session  de cet
utilisateur.

Merci.

PremiΦre  je tiens  α remercier mon amie, Kate lee, qui m'encourage α l'Θcriture
de documents de ce type, ceci est une dΘdicace α elle.

Je  souhaite aussi  remercier Philippe Biond et Christophe Long qui m'a beaucoup
aidΘ sur le projet. Sans eux, ce projet n'aurait pas pu si bien se dΘvellopper.

De   nombreux  remerciements  α  tous  les  utilisateurs  de  LIDS,  sans  leurs
contributions et discussions, LIDS n'aurait pas eu de si bonnes idΘes.


Traduction
Document traduit le 24/06/2000 par hertz@securix.org

[ndt: Certains mots ont ΘtΘ laissΘs tels quels, il  est trΦs souvent plus facile
d'exprimer  une  notion technique  en anglais,  et souvent  sa traduction en est
impossible, du au fait que un grand nombre de mots n'existent pas en franτais ou
sont encore que peu employΘs, mieux vaut se rΘfΘrer au jargon file.]
...
Snort. DΘbut de documentation.

PrΘsentation de Snort

"Snort  est un detecteur d'intrusion, capable d'analyser en temps rΘel le trafic
et  les paquets IP. Il peut analyser le protocole, et dΘtecter par rapport α une
base  de donnΘes de DOS et d'attaques diverses et variΘes (overflows, scans, SMB
probes,  CGI  attacks, OS  fingerprinting, et  plein d'autres...) les tentatives
d'intrusions.  De base Snort utilise des rΘgles pour collecter ou laisser passer
le  trafic,  et posΦde  un module  de dΘtection. le  journal alerte utilise soit
...
Consulter http://www.whitehats.com/ pour avoir la base de donnΘe d'intrusion.
...
Petit  mammifΦre carnivore  α  pelage brun  dense et  court,  la loutre  possΦde
Θgalement des pattes palmΘes et une queue Θpaisse. Ce qui fait que la loutre est
...
eau  douce,  dans les riviΦres,  que dans l'eau de  mer, comme dans le Pacifique
...
protΘger  des  orques et pour ne  pas dΘriver dans les courants marins, s'amarre
dans de grandes algues, et dΘguste au soleil quelques coquillages qu'elle Θclate
sur  son  petit  bidon  avec  des  galets.  Puis,  une  fois  repue,  elle  dort
tranquillement,  laissant aux  oiseaux  les  restes. Ce  qui  prouve de  maniΦre
irrΘfutable  sa  supΘrioritΘ intellectuelle,  car jamais on  ne verra une loutre
s'exhiber dans un Aqualand.

En  riviΦre, l'ennemi de la loutre est le castor et le trappeur canadien. Il y a
une  grande inimitiΘ entre la loutre et le castor. Les motifs de querelles entre
loutre  et  castor sont  innombrables  et  remontent α  la  nuit  des temps.  On
reconnaεt  le  castor  α  ses  dents avants  proΘminentes,  signe  d'une  grande
vulgaritΘ et de perfidie. Ce dernier est prΩt α toutes les bassesses et n'hΘsite
pas  α dΘnoncer la loutre au trappeur. Quand ce scΘlΘrat, ce fourbe, ne nuit pas
α  la loutre,  il passe le plus clair  de son temps α martyriser les arbres, les
tordant,   les  dΘcoupant,   les   rongeant,  sectionnant   chaque  fibre   d'un
gloussement guttural lugubre.

C'est donc tout naturellement que la loutre ne peut pas sacquer ce petit enfoirΘ
de  castor,  dont la fatuitΘ le  pousse α construire (maladroitement) de piΦtres
chΓteaux, qui ressemblent davantage α des tas de bois superposΘs. En plaτant des
charges  de  TNT dans les terriers  de ce fΘlon,  la loutre fait oeuvre de salut
public.

Elle  n'a  pas grand chose  α craindre  des trappeurs, car  la loutre se rit des
piΦges que ces gros nigauds utilisent. Des fois, elle pousse l'insolence jusqu'α
dΘsamorcer  les piΦges avec des hΘrissons. D'autre part, elle ne redoute pas non
plus les coups de carabines, car avec sa queue Θpaisse, elle joue au jokari avec
les balles. Parfois, ingΘnieuse qu'elle est, elle fabrique de petites catapultes
...
Animal  sympathique, qui mΘrite toute notre estime, la loutre se fout de tout et
plus  particuliΦrement des castors. La loutre n'est pas bΩcheuse ni aussi rustre
...
vie  rΘglΘe,  rangΘe.  Elle vit  au  grand  air,  la  loutre. Elle  envoie  tout
valdinguer,  la loutre,  elle  envoie  chier tout  le  monde,  les petits  chefs
arrogants,  pΘtris  de sΘrieux, les  connards de castors  ! Mais ouais, elle dit
merde  aux  tabous, la  loutre, α  toutes ces  conneries. Et  mΩme, elle TE CHIE
DESSUS  la  loutre ! Mais ouais  ! Elle en  a rien α  foutre de ce que tu penses
d'elle, la loutre. Elle vit sa vie, c'est tout.


[ndt: suite a des recherches il s'est avere tres difficile de savoir qui a Θcrit
ce  texte en premier;  il semblerait que ce dernier soit deja un pompage partiel
d'un  compte  rendu sΘrieux  qui Θtait lui  meme pompΘ dans  un bouquin. Bref si
l'auteur  se reconnait,  qu'il nous  contacte  afin qu'on  rectifie les  crΘdits
associΘs a cet article]

RΘfΘrences : http://www.chez.com/sheular/brice.htm
...
Le Docteur Brice Berger. Le problΦme que ce dernier est mort dans un accident de
moto  en  septembre 2000. Je  te donne l'autorisation  de le publier, puisque il
m'appartiens,  mais je  dΘsire que  figure son  nom et  un photo  de lui  que je
t'envoie.
...
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
>        Exploitation des vulnΘrabilitΘs avec les applications PHP             <
< InspirΘ du Document original de                   Shaun Clowes SecureReality >
...
9. Fonctions ciblΘes
10. ProtΘger PHP
11. ResponsabilitΘ - Langage et Programmeur
12. Autre


--- < 1. Introduction > -------------------------------------------------------

Ce  document  est une  traduction  basΘe  sur  un  discours lu  aux  confΘrences
Blackhat  de Singapour  et Hong  Kong  en avril  2001. A  l'origine le  discours
Θtait  intitulΘ  "Forcer  l'entrΘe  par  la  porte  de  devant  -  L'impact  des
applications  web  sur  des  modeles traditionnels  de  sΘcuritΘ",  et  traitait
des  problemes  rencontrΘs sur  des applications  ASP, les  trous exposΘs et les
mΘthodes utilisΘes pour les mettre a jour.
Le  reste  de la conference  Θtait consacrΘ a PHP.  Pour les nΘophytes, PHP veut
dire  "PHP Hypertext  Preprocessor" (encore  un acronyme  rΘcursif ;).  C'est un
langage  de  programmation (spΘcialement concu pour  le web) dans lequel le code
...
d'executer le code, le resultat est envoyΘ au client.

Evidemment  cette  approche est bien  plus appropriΘe pour traiter des problemes
rencontrΘs avec PHP qu'avec des langages comme Perl ou C.
...
suivantes :
 ...
 + Riche en possibilitΘs - Des centaines de fonctions tres souples
 + Syntaxe simple - DΘclarations de Variable optionnelles, nommage intuitif des
   fonctions

On  va  expliquer dans ce  document pourquoi les deux dernieres caracteristiques
font  que les  applications Θcrites en PHP sont faciles a attaquer et difficiles
a  dΘfendre.  On finira par  une distribution de palmes  et de bonnets d'anes en
matiere de sΘcuritΘ logicielle.


--- < 2. Tour d'horizon > -----------------------------------------------------

Presque  toutes  les observations de ce  document se rΘferent a une installation
par  dΘfaut de  PHP 4.0.4pl1 (avec MySQL, PostgreSQL, IMAP et le support OpenSSL
activΘ) en tant que module avec Apache 1.3.19 sur une machine linux.
...
radicalement diffΘrent pour une meme situation.

Bien   que  les   fans  du  PHP  dΘfendent  ce  langage  en  plaidant  l'extreme
configurabilitΘ  de ce  systeme, la plupart d'entre eux ne vont pas modifier les
valeurs  par  dΘfaut du  package lors de  la mise  en place par  peur de voir la
majoritΘ  des applications  qu'ils utilisent ne pas fonctionner. Le dΘbat autour
du  fichier de  configuration  PHP est  cependant nΘcΘssaire  pour  ceux qui  se
sentent concernΘs par la sΘcuritΘ de telles installations.


--- < 3. Variables Globales > ------------------------------------------------

Comment  mentionnΘ  plus  haut,  les  variables  PHP  n'ont  pas  besoin  d'etre
dΘclarΘes,  elles sont automatiquement crΘΘes lors de leur premiere utilisation.
Elle n'ont pas besoin non plus d'etre typΘes, le typage etant Θgalement effectuΘ
automatiquement  en rΘfΘrence  au contexte dans lequel elles sont utilisΘes. Ces
faits  rendent les  choses tres pratiques d'un  point de  vue programmation  (et
prΘsentent  des horizons  tres  larges  a ceux  qui  prΘferent  les langages  de
dΘveloppement  rapides  pour les  applications).  Aussitot  qu'une variable  est
crΘΘe,  elle peut  etre  rΘfΘrencΘe n'importe  ou dans  le  programme (sauf  les
fonctions  dans  lesquelles il  faut explicitement les  inclure avec la fonction
'global').  Le rΘsultat  des ces  caractΘristiques  est que  ces variables  sont
rarement  initialisΘes  par le programmeur lui  meme, car apres tout la crΘation
initiale d'une variable lui voit assigner une valeur nulle (ex : "").

Apparemment  la  principale fonction d'une  application web PHP est de rΘcuperer
des  donnΘes du  client (variables  de formulaire,  fichiers uploadΘs,  cookies,
etc),  de procΘder au  traitement de ces donnΘes et de renvoyer un rΘsultat basΘ
sur ces memes donnΘes. Afin de simplifier au maximum la tache au script PHP lors
de  l'acces, les donnΘes lui sont fournies sous forme de variables globales PHP.
ConsidΘrons l'exemple suivant basΘ sur du code HTML :
...
sur  le  bouton  submit,  le  script test.php  sera  ΘxΘcutΘ  pour  procΘder  au
traitement  des  donnΘes envoyΘes.  Au  moment  de  son ΘxΘcution,  la  variable
...
tapΘ  dans la boite  texte avant de cliquer sur submit. Il est tres important de
noter  les implications que cela engendre, cela veut dire qu'un petit malin peut
crΘer  n'importe quelle variable et la voir dΘclarΘe globalement avec les autres
...
crΘΘe et se verra assigner la valeur "jambon", ces deux variables Θtant globales
et utilisables sur tout le script test.php.

Ceci  peut  devenir un  rΘel probleme  dans le cas  d'un script  qui a pour role
...
avec  une valeur  donnΘe (hello),  puis  dΘcider si  l'utilisateur distant  peut
accΘder  ou  pas aux infos  importantes en stockant  une valeur dans la variable
$auth.  Le probleme c'est  que le code part (a tort) du principe que la variable
$auth  sera vide jusqu'a ce qu'elle se voit assigner une valeur. Avec la mΘthode
citΘe   plus  haut   on  peut   donc   facilement  construire   une  URL   comme
'http://server/test.php?auth=1'  qui permettra  de  ne pas  avoir  a fournir  de
password et d'etre quand meme considΘrΘ comme authentifiΘ.

Pour  rΘsumer,  on peut  dire qu'un  script PHP  "ne peut  pas faire confiance a
N'IMPORTE QUELLE variable qui n'a pas ΘtΘ EXPLICITEMENT assignΘe".
D'ailleurs  plus un  script traite de variables  et plus la tache est ardue pour
sΘcuriser le tout (ndt : heureusement il y a les classes ;0).

Une  approche  plus protective consiste  a vΘrifier  qu'une variable ne fait pas
partie  du tableau  HTTP_GET/POST_VARS[] (un  choix  en fonction  de la  methode
utilisΘe  pour soumettre  les formulaires, GET ou POST). Quand PHP est configurΘ
avec  'track_vars'  (par dΘfaut), les  variables envoyΘes par l'utilisateur sont
disponibles  globalement mais  aussi sous  forme de  tableaux associatifs  comme
mentionnΘ  plus  haut. Il est quand  meme important de noter qu'il existe QUATRE
tableaux  associatifs  differents et  qui peuvent  etre sujets  a des attaques :

-HTTP_GET_VARS  pour  les variables  envoyΘes dans l'url  (ou formulaire avec la
 methode GET).

-HTTP_POST_VARS  pour les  variables postΘes par formulaire avec la methode POST
 d'une requete HTTP

-HTTP_COOKIE_VARS pour les variables envoyΘes comme partie du header d'un cookie
 dans une requete HTTP

-HTTP_POST_FILES  tableau prΘsent  dans la plupart des versions rΘcentes de PHP,
 correspond aux infos relatives a un fichier uploadΘ via methode POST

C'est  l'utilisateur final qui dΘcide quelle mΘthode utiliser pour soumettre ces
variables,  une  simple requete peut  parfaitement placer des variables dans ces
quatres  diffΘrents  tableaux, un  script qui  se veut sΘcurisΘ  a besoin de les
vΘrifier  tous les  quatres (a l'exception de HTTP_POST_FILES qui ne devrait pas
poser de problemes exceptΘ dans certaines circonstances qu'on pourrait qualifier
d'exceptionnelles).


--- < 4. Fichiers distants > -------------------------------------------------

Sans  vouloir  radoter, PHP est un  langage extremement riche. Il est livrΘ avec
une  panoplie  tres complete  de  fonctionnalitΘs  et  fait  de son  mieux  pour
faciliter  la tache  au codeur  (ou web  designer comme  c'est souvent  le cas).
D'un  point de  vue sΘcuritΘ,  plus  les fonctionnalitΘs  offertes sont  riches,
moins  les  possibilitΘs sont intuitives, et  plus il est difficile de sΘcuriser
les  applications qui  y  sont Θcrites  (merci  m$ pour  ce  joli theoreme).  Un
excellent  exemple  de  fonctionnalitΘ  est l'utilisaton  distante  de  fichiers
avec PHP :

La portion de code qui suit est censΘe ouvrir un fichier :
...
Ce  code va essayer d'ouvrir en lecture le fichier dont le nom est spΘcifiΘ dans
la  variable $filename  et affiche  une erreur  si l'ouverture  Θchoue. Certains
sites  en  ont fait  les frais,  car il est  facile de  forcer la dΘclaration de
$filename  dans l'url et ainsi d'acceder au contenu de fichiers sensibles sur le
serveur  (ex :  /etc/passwd),  il est  aussi  possible de  lire  des donnΘes  en
provenance  de  serveurs  distants,  ftp,  etc.  Les  fonctionnalitΘs  distantes
...
Ca  devient encore  plus intΘressant dans le contexte de quatre autres fonctions
qui  tolerent les  fonctionnalitΘs d'acces aux fichiers distants ( *** sauf pour
...
elles  sont utilisΘes  typiquement dans  un contexte  d'inclusion de  librairies
de  code, un cas  ou des portions de script rΘutilisables sont stockΘes dans des
fichiers  qui seront  inclus quand c'est nΘcessaire (ex:phplib). Examinons cette
portion de code :
...
On  peut prΘsumer  que $libdir  est une  variable de  configuration a  qui on  a
assignΘ  une valeur  Θgale au  rΘpertoire qui  contient le  fichier langages.php
et  ou  se trouvent  d'autres  librairies.  Si un  petit  malin  peut forcer  la
dΘclaration   de  cette  variable  il  lui  devient  possible  de  rediriger  la
...
ne  serait possible  que  d'acceder  a un  fichier  langages.php  situΘ dans  un
repertoire  ou  une url de  son choix.  Par exemple, si  le petit malin place un
fichier langages.php sur un serveur web distant et y dΘpose le code suivant :
...
(sans quoi le code ne sera pas envoyΘ mais interpretΘ).


--- < 5. Upload des fichiers > -------------------------------------------------

Comme si PHP n'avait pas assez de trous, le langage met a disposition un support
automatique pour l'upload conformΘment au RFC 1867. Prenons le formulaire
...
Cette  fonctionnalitΘ est  bien sur  tres  utile, c'est  la rΘponse  de PHP  qui
en  fait une  situation  dangereuse. Au  moment  ou PHP  recoit  la requete,  et
*avant  meme* d'avoir  commencΘ  a interpreter  le fichier  php  qui la  recoit,
le  fichier  sera  recu, la  taille  comparΘe  avec  la  valeur de  la  variable
$MAX_FILE_SIZE  (ici fixΘe a 10 ko) et cette derniere valeur comparΘe avec celle
spΘcifiΘe  dans  le php.ini. Si  ces deux tests  sont concluants, le fichier est
alors  SAUV╔ sur  le disque  local du  serveur, dans  un repertoire  temporaire.
...
ait  commencΘ  a etre  executΘ (ceci  ecarte l'option que  ce meme script puisse
refuser le fichier qui est quand meme SAUV╔ sur le disque local du serveur).

Imaginons  un script  qui  *est* concu  pour recevoir  des  uploads de  fichier.
Comme  dΘcrit  plus haut le fichier  est recu puis  sauvΘ sur le disque local du
serveur  (dans  un rΘpertoire  spΘcifiΘ dans  le php.ini  ex :  /tmp) et se fait
assigner  un nom de  fichier au hasard (ex: "phpxXuoXG"). Le script PHP a besoin
d'infos  sur ce fichier uploadΘ pour etre capable de le traiter. Ceci est fourni
de  deux  facons diffΘrentes, l'une d'elles  est en service depuis les premieres
versions  de php3, l'autre a ΘtΘ dΘveloppΘe suite a des bulletins de sΘcuritΘ en
rapport avec la description fournie dans ce document.

Le  probleme est nΘanmoins  toujours existant et en bonne santΘ, a tel point que
l'ancienne  methode  et ses vulnerabilitΘs est  toujours en pratique sur pas mal
d'applications  bien en  vogue (ex:phpnuke).  PHP ajoute  quatre variables  pour
dΘcrire le fichier uploadΘ, par exemple :
 ...
 $hello_type = Le format Mime du fichier uploadΘ (ex:"text/plain")

Ensuite  le script  php  peut travailler  sur  le fichier  localisΘ  grace a  la
variable  $hello,  le probleme c'est qu'il  n'est pas forcΘment Θvident pour PHP
que la variable $hello doive etre dΘclarΘe via l'url ou pas, considΘrons l'url:

http://vulnhost/vuln.php?hello=/etc/passwd&hello_size=10240&hello_type=text/
plain&hello_name=hello.txt

Le  rΘsultat correspondra  a peu  pres a  ces declarations  de variables  qui se
retrouvent  globalisΘes  (ca marche egalement  avec la  methode POST ou avec les
cookies) :
...
exceptΘ  que  normalement c'est PHP qui  les dΘclare, et qu'ici on se retrouvera
avec  le contenu  du fichier /etc/passwd sur quoi travailler. Cette meme attaque
peut  etre utilisΘe  pour mettre en Θvidence toute sorte de fichier sensible (en
particulier   les   fichiers  de  config   ou  tiers  contenant  des  infos  sur
l'assignation des droits sur le serveur).

Comme  expliquΘ plus haut, les version plus rΘcentes de PHP peuvent utiliser des
methodes  diffΘrentes  pour dΘterminer  quelles  sont  les infos  relatives  aux
fichiers  uploadΘs  (via le tableau HTTP_POST_FILES[]). Plusieurs fonctions sont
Θgalement  fournies dont  une permet  de comparer  si le  fichier sur  lequel on
travaille  est bien celui qui a ΘtΘ uploadΘ. Ces mΘthodes reglent dΘfinitivement
le  probleme  mais ne corrigent pas  les scripts qui utilisent encore l'ancienne
mΘthode, et on est loin d'atteindre une pΘnurie en la matiere.

Comme  alternative  a  l'attaque  par l'upload,  on  peut  Θgalement  considΘrer
l'exemple suivant :

 <?php
  if (file_exists($theme)) // VΘrifie si le fichier existe sur le systeme local
                           //(pas de fichiers distants)
   include("$theme");
 ?>

Si  l'attaquant  peut controler $theme,  il peut evidemment l'utiliser pour lire
n'importe  que fichier  sur le  systeme distant  (exceptΘ les  fichiers qui  ont
des  tags php "<?" (qui vont etre interpretΘs au lieu d'etre lus). Bien que cela
pose  un probleme, le  but ultime de tout attaquant est d'arriver a Θxecuter des
commandes  sur le serveur distant, et il est impossible d'y arriver en utilisant
des  fichiers distants etant donnΘ que la methode file_exists ne s'applique qu'a
des  fichiers locaux. Il faut donc au prΘalable arriver a uploader du code avant
de  faire appel a cette faille. Si l'attaquant crΘe un fichier sur sa machine et
comme  contenu  y dΘpose le code a Θxecuter (ex  : passthru, eval), puis crΘe un
...
sauver  le  fichier et dΘclarer $theme  avec la valeur du fichier de l'attaquant
sur  la machine  locale. Le methode file_exists() se vΘrifiera avec succes et le
code de l'attaquant sera alors ΘxΘcutΘ sur le serveur.

Une fois que ses droits en ΘxΘcution PHP sont obtenus sur le serveur web distant
l'attaquant  pourra s'adonner a des taches plus investigatoires en vue d'obtenir
des  privileges plus  avancΘs sur le serveur local ou sur d'autres serveurs, ces
deux  mΘthodes nΘcessitant une boite a outils ne se trouvant pas (encore) sur le
...
car  l'envoi de fichier a ΘtΘ rendu "legal" par la methode dΘcrite plus haut. Le
...
gΘnΘralement  utilisΘes en  respect  du  concept des  librairies  de code.  Cela
implique  que des portions de codes communes a plusieurs applications sont mises
a disposition dans un repertoire prΘvu a cet effet (lib, phplib, promotheus-lib)
et  que ces  portions de codes sont incluses directement quand c'est nΘcessaire.
...
posΘ  pas  mal de  problemes sur  des serveurs  qui se  contentaient de lire ces
fichiers sans les interprΘter comme de vulgaires fichiers textes. Aussi certains
de ces fichiers pouvant contenir des infos sensibles (user/pass base de donnΘes)
se  voyaient  affichΘs en  mode texte  alors qu'ils  auraient pu etre facilement
protΘgΘs.  La plus  simple des solutions (c'est egalement la plus prisΘe) est de
...
memes  privileges  d'acces en rΘutilisant des  portions de code qui sont prΘvues
pour  etre utilisΘes dans  un autre contexte, ce qui nous ramene aux memes types
d'attaques dΘcrites plus haut.
...
Quand  libdir/loadlangage.php  est appelΘ  dans le  contexte dΘfini de main.php,
le  script  est parfaitement sΘcurisΘ,  mais parce que libdir/loadlanguage porte
l'extension  .php (ce  qui n'est pas nΘcessaire car include() marchera sur toute
...
la methode url citΘe plus haut.


--- < 7. Les fichiers de session > --------------------------------------------

Les  versions rΘcentes  de PHP(4  et supΘrieures)  offrent un  support pour  les
sessions.  Leur utilitΘ basique consiste a pouvoir sauver des infos d'une page a
l'autre  au sein  d'une application  PHP. Par  exemple quand  un utilisateur  se
loggue  sur un site  web, le fait qu'il soit logguΘ (et ce a quoi il est logguΘ)
pourrait  etre sauvΘ  dans cette session. Ces informations seront disponibles au
autres  pages  PHP au fur  et a mesure  de son Θvolution sur  le site. Ce qui se
produit  quand une  session  est  dΘmarrΘe (lors  du  premier  chargement de  la
premiere  page  si spΘcifiΘ dans le  php.ini) revient a gΘnΘrer alΘatoirement un
...
champ  de  formulaire ou  une variable dans  l'url. La session  est une unitΘ de
stockage  de variables  , une  application  PHP peut  choisir d'enregistrer  une
variable  particuliere avec  la session,  sa valeur  est alors  stockΘe dans  le
fichier  de session a  la fin de chaque script PHP et ainsi chargΘe au dΘpart de
chaque script comme dans cet exemple :

 <?php
  session_destroy(); // Effacer les donnΘes prΘsentes dans la session
  $session_auth = "savate";
  session_register("session_auth"); // Enregistrer $session_auth comme variable
                                    // de session
 ?>

Tout  page visitΘe  ulterieurement aura  la variable  $session_auth prΘ-dΘclarΘe
avec  comme valeur  "savate". C'est  tres  pratique et  parfois nΘcessaire  pour
une utilisation sur un environnement qui ne nΘcΘssite pas d'Θtat dΘfini.

Un  probleme Θvident  consiste a s'assurer que les variables viennent bien de la
session,  par exemple  si on  ΘxΘcute  le code  suivant apres  avoir utilisΘ  le
script prΘcΘdent :
...
Ce  code  part du  principe que  $session_auth est dΘclarΘ  lors du dΘmarrage de
l'instance  de la  session et  non  pas dans  l'url.  Si un  attaquant force  la
dΘclaration  de  $session_auth via l'url ou  un formulaire, il peut ainsi gagner
l'acces  a  tout le  site. A  noter que l'attaquant  doit utiliser cette methode
avant  que  la variable  soit enregistrΘe avec  la session, car  une fois que la
variable  fait  partie de la session,  elle viendra Θcraser toute autre variable
du meme nom, qu'elle provienne d'une url ou d'un formulaire.

Les  donnΘes  de la session sont  sauvΘes dans un fichiers (configurable dans le
php.ini  -> habituellement /tmp) appelΘ 'sess_&lt;session id>'. Ce fichier contient
...
petit  malin  peut facilement se crΘer  un fichier de session afin de s'octroyer
des  droits sur  un autre  site que  le sien  ou meme  examiner les  fichiers de
session existants et ainsi avoir acces a des donnΘes sensibles.
...
Enfin  un  autre probleme auquel  il n'a pas  ΘtΘ trouvΘ d'exemple pratique mais
qui  n'en  est pas moins prΘoccupant  est que l'on peut spΘcifier n'importe quel
ID  de session (ex:'hello') et ainsi crΘer un fichier de session avec ce meme ID
(ex:   '/tmp/sess_hello').   L'ID   ne   peut  contenir   que   des   caracteres
alphanumΘriques  mais  cela  peut  quand  meme  s'averer  utile  dans  certaines
situations.
...
qu'une  variable  peut avoir plusieurs valeurs  en meme temps, cela dΘpendant du
contexte  dans  lequel elle est  ΘvaluΘe. Par exemple  si la variable $hello est
Θgale  a  une chaine vide  "", elle aura  comme valeur 0  si elle est ΘvaluΘe en
...
ΘvaluΘ  numeriquement. Donc  l'entrΘe du tableau $hello["000"] n'est PAS la meme
chose que l'entrΘe du tableau $hello[0].

On a besoin de faire attention a bien Θvaluer et valider les entrΘes utilisateur
...
source),  il est  tres utile d'avoir la liste des fonctions qui sont frΘquemment
mal  utilisees  ou sont de  bonnes cibles si  elles sont utilisΘes d'une maniere
vulnΘrable  dans une application ciblΘe. si un utilisateur distant peut affecter
...
-require() et include() : Ces deux fonctions lisent un fichier spΘcifiΘ et
 interpretent le contenu comme du code PHP
-eval() : Interpreter une chaine donnΘe comme du code PHP
-preg_replace() : quand utilisΘ avec le modificateur /e cette fonction
 interprete la chaine de remplacement comme du code PHP

Execution de commandes :
-exec() : Executer une commande specifiΘe et retourner la derniere ligne
 rΘsultante de cette commande.
-passthru() : Executer une commande spΘcifiΘe et retourner tous les resultat
 directement dans le browser
-`` (apostrophes inversΘes) : Executer la commande spΘcifiee et retourner tous
 les rΘsultats directement dans un tableau
-system() : un peu la meme chose que passthru() mais ne gere pas les donnΘes
 binaires
-popen() : Executer une commande spΘcifiΘe et connecter le flux de sortie vers
 un descripteur de fichier PHP

Manipulation de fichiers:
-fopen() : Ouvrir un fichier et l'associer avec un descripteur de fichier PHP
-readfile() : Lire un fichier et Θcrire son contenu dans le browser
-file() : Lire un fichier et mettre son contenu et ses infos dans un tableau


--- < 10. ProtΘger PHP > ------------------------------------------------------

Toutes  les attaques dΘcrites plus haut marchent a la perfection sur une install
par  dΘfaut  de PHP4.  En revanche  la configurabilitΘ de  PHP permet de pouvoir
fournir  une  rΘponse radicale a  chacune de ces  situations. La facture a payer
(en  matiere  de sΘcuritΘ il  y a  toujours une ardoise  ;) peut varier selon la
mΘthode  choisie,  voici une liste des  mΘthodes classΘes de la plus douloureuse
a la moins couteuse.
...
retrouve  avec une installation "sΘcuritΘ maximum" de PHP sur laquelle n'importe
quelle application PHP sera sΘcurisΘe, et pour cause, aucune ne fonctionnera ;)


**** - Set register_globals off
Cette  option  va  stopper  l'enregistrement  des  variables  pour  les  entrΘes
utilisateur.  A  savoir, si un utilisateur  essaye de crΘer une variables $hello
via  l'url  ou un  formulaire,  PHP  ne  dΘclarera  pas $hello,  mais  dΘclarera
$HTTP_GET_VARS['hello']  (ou  POST_VARS selon  le cas). C'est  la mere de toutes
les  autres  options  pour  la  sΘcuritΘ PHP,  l'effet  secondaire  d'une  telle
dΘsactivation  est  la mort de  toute tierce application ainsi qu'une difficultΘ
a programmer comparable a celle qu'on a avec java (sorry le dany;)

*** - Set safe_mode on
On  ne  dΘcrit pas ici tout  ce que le  safe_mode propose car ca n'est documentΘ
nulle  part au moment ou ce texte est traduit. On peut cependant constater qu'un
grand  nombre  de restrictions  sont activΘes  en meme temps  que lui, parmi ces
restrictions on peut compter :
 - La possibilitΘ de restreindre les commandes qui peuvent etre executΘes par
   exec(), etc)
 - La possibilitΘ de restreindre les fonctions de PHP (ex : multimania a
   dΘsactivΘ fsockopen)
 - Restreindre l'acces a un script ou un fichier cible sur une base
   d'appartenance a un groupe ou a un utilisateur.
 - L'impossibilitΘ d'uploader
C'est  une excellente  option pour les environnements FAI (c'est d'ailleurs pour
eux  que  le safe_mode a ΘtΘ  concu) et elle permet d'augmenter considΘrablement
la  sΘcuritΘ  d'une environnement  PHP normal. Cette  option peut egalement etre
la cause de violentes migraines.

** - Set open_basedir
Cette  option  permet de restreindre  les operations  sur les fichiers aux seuls
repertoires  impliquΘs  lors de l'appel au  fichier. Cela peut avoir comme effet
d'invalider  toute une variΘtΘ d'include() et aussi d'attaques distantes mais ne
protege pas forcement les failles d'upload ou des fichiers de sessions.

** - Set display_errors off, log_errors on
Cette  option  dΘsactive l'affichage vers  le browser des messages d'erreur PHP.
...
Cette  option permet  de dΘsactiver  toutes les  fonctionnalitΘs relatives  a la
manipulation  des  fichiers distants, il  est recommandΘ de l'utiliser dans tous
les cas de figure, meme si cela ampute pas mal d'applications interessantes.

Il  y  a certainement  d'autres options  tres pratiques pour  la sΘcuritΘ, et il
...
--- < 11. ResponsabilitΘs - Langage et Programmeur > --------------------------

Il  faut  admettre qu'ils  est tres  difficile d'Θcrire  une application PHP qui
soit  vraiment  sΘcurisΘe (en  tous cas  avec la  config par  defaut de PHP). Le
probleme  n'est  pas que  PHP  soit  un mauvais  langage,  au  contraire il  est
tellement  accessible et a tellement de possibilitΘs que d'autres langages n'ont
pas. Si on observe bien on peut relever ces deux faits :

- Les  Web  Designers   et  non codeurs  finissent  toujours  par  Θcrire    des
  applications  PHP.  Ils n'ont  pas a  la base  (a part  dans certains cas) une
  connaissance  de  ce qu'implique la sΘcuritΘ  du code qu'ils Θcrivent car leur
  philosophie  de codage  n'est pas orientΘe comme elle devrait. Une application
  PHP  est par  dΘfinition exectuΘe dans le type d'environnement qui est le plus
  exposΘ  aux  attaques : une  page universellement accessible depuis un serveur
  web.  L'etat  d'esprit devrait plutot  etre similaire  a celui utilisΘ lors du
  codage  d'un  network daemon  qui va  subir des  attaques rΘgulieres, ou d'une
...
- Le comportement  du code est  impossible a  prΘvoir.  Un include() qui utilise
  une  entrΘe utilisateur avec "image.php" par exemple, normalement devrait etre
  sans  danger pour  la sΘcuritΘ. L'utilisateur ne pouvant influer sur le chemin
  d'acces,  ni  crΘer un fichier  image.php sur la  machine distante, on peut se
  persuader  que  tout va bien.  Seulement quand les fonctionnalitΘs de fichiers
  distants  sont activΘes  cette situation peut devenir un vrai cauchemar et PHP
  n'a pas rendu cette situation tres intuivite.

On  aurait  tendance a blamer  le programmeur pour le  code qu'il ecrit, mais si
un  langage rend  la tache difficile au  programmeur pour Θcrire du bon code, le
...
"essayΘ" de mettre de  la sΘcuritΘ, mais a laissΘ tomber quand il s'est retrouvΘ
face  aux  implications que cela  engendre avec le  comportement de PHP. Dans sa
recherche de l'ultime fonctionnalitΘ, PHP a completement tuΘ chez le programmeur
la  facultΘ  a pouvoir comprendre le  fonctionnement de son code dans toutes les
...
Cette section rassemble d'autres ressources diverses et variΘes
...
SecureReality a postΘ plusieurs advisories sur les applications PHP qui
devraient etre citΘes en exemple dans ce document :
...
- SRADV00006 - ExΘcution de commandes a distance avec phpGroupWare
 http://www.securereality.com.au/sradv00006.html
- SRADV00008 - ExΘcution de commandes a distance avec phpMyAdmin et phpPgAdmin
 http://www.securereality.com.au/sradv00008.txt
- SRADV00009 - ExΘcution de commandes a distance avec phpSecurePages
 http://www.securereality.com.au/sradv00009.txt
- SRADV00010 - ExΘcution de commandes a distance avec SquirrelMail
 http://www.securereality.com.au/sradv00010.txt
- SRADV00011 - ExΘcution de commandes a distance avec WebCalendar
...
J'Θcrivais tranquilement un mail en le finissant par une crise dΘdiΘe a echelon,
comme  cela m'arrive parfois (oui, quelques mots clΘs α la fin juste pour rire),
quand je me suis dit une chose qui peut Ωtre intelligente.
[Ndcybz : A votre place j'irais pas plus loin la...]
Oui,  je  sais, la plupart  d'entre vous ne  croiront absolument pas la derniΘre
...
n'est pas le sujet du jour) rΘfΘrencent des sites?
...
quel  mots  clΘs on  a soumis cette  page web  et regarde si  ces mots clΘs sont
prΘsent  dans cette page et si oui, combien de fois...
...
ne  contient que  les mots  clΘs  "cybz" et  "intelligent" (mots  clΘs qui  sont
d'ailleurs  antinomiques mais c'est une autre histoire) pour cause de "spamming"
(oui, c'est comme τa qu'ils disent les moteurs de recherche.

Ne pensez vous pas qu'il existe une forte probabilitΘ pour qu'echelon ignore lui
aussi  les  densitΘs de mots clΘs  visiblement trop fortes pour Ωtre honnΘtes et
donc  dΘstinΘes α le  faire tourner en bourique (echelon, pas le mot clΘ, suivez
nom de diou!).
...
Il  est probable qu'echelon s'en contrefoute malgrΘ le fait que ce sont des mots
gravement α la mode?

Pourtant,  si l'on prend la premiΘre lettre de chacun de ces mots, on obtient un
message  clair  (JAVA) qui est destinΘ  pour les initiΘs α contenter maddany (ou
bien α proposer une pause cafΘ α sa charmante voisine de bureau dΘveloppeur tout
comme vous mais c'est une autre histoire).

Bien  sur, cette forme de "codage" est tout α fait grossiΘre mais ne pensez vous
pas  que l'on pourrait  faire tourner echelon en vinaigre (oui, y en α marre des
bourriques  (non cybz,  ce  n'est pas  une  attaque personnelle  de  plus ))  en
utilisant les mots clΘs echelon associΘs α un soft du genre de celui ci:
...
The Jarg[O]n File.
------------------
Un dossier honteusement baclΘ par tobozo et lansciac.

Le  jargon file en  est deja a la version 4.3, c'est en partie grace a Gutenberg
qui  a  en a  beaucoup favorisΘ  l'enrichissement (avec  l'aide de la communautΘ
Θvidement..).  Pour  les quelques  uns  qui  auraient  profitΘs des  fΩtes  pour
enrichir  leur armoire,  sachez que  Gutenberg n'a  aucun rapport  avec Johannes
Gensfleisch  qui  mit  au  point  α Strasbourg  le  procΘdΘ  de  composition  en
caractΦres mobiles fondus en alliage d'imprimerie. Notre Gutenberg ne s'est donc
pas  associΘ  avec j.fust et ne  fut pas le maεtre  d'oeuvre de la bible dite "α
quarante  deux  lignes", que vous  ne trouverez  pas en franτais courant anyway.
...
rapproche est en italien. MalgrΘ les  essais hΘsitants de clonage du jargon file
en  francais,  on a quand meme  pu observer une activitΘ contributive suffisante
pour se permettre de croire a une Θvolution autour des memes modeles.
Ces  modeles vont  vous etre  reprΘsentΘs en  trois volets  car ils  intΘressent
...
Rapport direct sur la pensΘe dite.
Exploiteur officiel     : Docteur Eric S. Raymond, maεtrise en science du
                          langage souterrain.
...
Hacker :
========
Toute  personne capable  de rΘdiger, lire ou agir en harmonie avec la dΘfinition
suivante :
...
2. n. Un extraordinairement bon travail, mais trΦs accaparant, qui produit
   exactement ce qui est demandΘ.
...
4. vt. Travailler sur quelquechose (typiquement un programme). Dans un sens
   ...
   gΘnΘral (extension de temps) : "Qu'est ce que tu fais par lα?" "Je hack
   TECO." Plus gΘnΘralement, "Je hack 'foo'" est equivalent α "'foo' est mon
   interet premier (ou projet)". "Je m'introduis dans le coeur du systΦme".
   Voir Hacking X ou Y.
5. vt. Mettre une niche. Voir sens 2 et hacker (sens 5).
6. vi. Interagir avec un ordinateur dans la gaitΘ et l'exploratoire plutot
   qu'agir selon une voie prΘ-tracΘe. "Whatcha up to?" "Oh, just hacking."
7. n. Diminutif de hacker.
8. Voir nethack.
9. [MIT] v. Explorer les sous-sols, les toits et les tunnels enfumΘs, les
   bΓtiments institutionnels, α la consternation des ouvriers d'entretien et
   (puisque cela se produit habituellement dans les Θtablissements de
   l'Θducation nationale) de la police de campus.bCette activitΘ s'est assimilΘe
   au fait de jouer α des jeux d'aventure tels que Dungeons & Dragons ou Zork.
   Voir vadding.

On  retrouve ΘnormΘment  de  constructions  sur ce  terme.  Elles incluent  'bon
...
commentaire  amical,  souvent  utilisΘ  comme une  adieu  temporaire).  Pour  la
plupart de ces termes, rΘfΘrrez  vous au  terme gΘnΘral "Le sens  du Hack". Voir
...
simples  expriment  tant bien  que  mal  des  idΘes d'un  simplicisme  complexe.
Ces  idΘes  sont elles  mΩmes  formΘes  de mots.  La  boucle  est ainsi  formΘe.
L'histoire  du  serpent qui  se mort  la queue  est donc  vΘrifiΘe, et tout cela
en  serait  restΘ  α  cet  endroit  putride si  un  castor  affamΘ  n'avait  pas
dΘcidΘ  de  mettre fin  α ce  jeu stupide  et en  guise d'avertissement avala le
tout, assaisonΘ d'un chat redonnΘ d'un de ces amis savatΘ....

Exegi monumemtum aere perennius...
C'est en fait seulement cela que vous devriez retenir. Le langage est la facultΘ
propre  α  l'homme d'exprimer et de  communiquer au moyen d'un systeme de signes
vocaux.
Autrement  dit,  les signes ici  rΘtribuΘs sont des  mots. Ces mots peuvent Ωtre
chantants,  complexes, exigus; mais ils peuvent aussi Ωtre vicieux, salaces. Qui
...
du  liberalisme. En  effet, qui a imposΘ  ces rΦgles? Qu'est ce qui vous empeche
d'imposer  une  signification symbiotique  α  n'importe  quel syntagme  nominal.
...
reine  de tous,  dΘcriant  la primalitΘ  de  chaque; de  meme,  le precedent  du
suffixe prΘfixe le debut de la fin....ou plutot dans la langue interdite:
abadcominsub  && alardotoyer.  j'abuserai encore  quelque peu  en argant  que la
monosΘmie  bien que  peu mon fort renforce  de par sa prΘsence l'existence de la
polysΘmie et affirme le vΘritable sens de la rΘalitΘ.
...
A l'emminente question que le commun des mortels n'osait pas mΩme esquisser,j'ai
promptement  accable  le tres  saint fondateur,  afin d'avoir un Θclaircissement
plus que necessaire:
...
Je reτois les suggestions d'ajouts et de modifications par e-mail.
J'Θdite la plupart d'entre elles, mais pas toutes.

Mais  la question  qui dΘmange  les contribuables  que vous  serez se  rΘsume en
quelques  mots.  De maniΦre α  ne pas choquer  quelques Θrudits qui comblent nos
rang, je formulerai cela de maniΦre simple et coersitive:

"Qu'est ce que le Jarg[0]n File?"

Bien que n'ayant aucune rΘponse directe et explicite, il y a un fac simile de la
pierre  de rosette  qui  permet  de s'approcher  d'une  explication possible  et
plausible. Elle ne peut Ωtre tenue comme seule vΘritΘ, cependant, elle ouvre une
voie  de  comprΘhesion et d'Θlaboration vers  l'esquisse de ce que l'on pourrait
envisager comme une norme communΘment appelΘe "rΘponse α forme coersitive"(1).

Translated answer:
La  'culture des hackers' est actuellement une vague ramification de collections
de  sous-culture  qui est  nΘanmoins chargΘe d'important  partages au niveau des
expΘriences,  de l'administration  et des  valeurs. Elle  a ses  propres mythes,
hΘros,  traitres,  lΘgendes populaires, blagues,  tabous et rΩves. Parce que les
hackers font partie des groupes qui sont formΘs de crΘateurs qui dΘfinissent eux
mΩme  d'une part  par rejet des valeurs 'normales' et d'autre part les habitudes
de  travail; Ils ont une culture exceptionnelle, lourdement chargΘe en tradition
et  trΦs  riche. Le plus Θtonnant  est que cette culture  est a peine agΘe de 40
ans.

Ces quelques lignes dΘcrivent la rΘalitΘ et la philosophie du jargon file.
Certains de ces points mΘritent peut Ωtre un Θclaircissement.
Il  est difficile  de dater  de maniΦre  prΘcise la  naissance du  mouvement des
hackers.  En effet,  celui-ci Θtant  clandestin et  souterrain, mais  aussi trΦs
jeune  (la majoritΘ des protagonistes sont encore vivant), il n'y a que trΦs peu
de  documents  attestant ca ou  la α  propos d'une officialisation. Nous pouvons
cependant  poser  une pierre d'angle  en 1961, dans le  sacro saint MIT. le TMRC
(Tech  Model  Railroad Club) du MIT  crΘa des outils de programmation, imposa un
jargon et toute une culture associΘe afin de faire vivre leur passion et Θvoluer
leur savoir.
...
(1)  Une demande de grΓce a ΘtΘ envoyΘ aux saintes rfc de maniΦre α ce que cette
blague d'Θtudiante ne soit nullement retenue lors de son passage en instance...
...
-Les entrΘes sont formattΘes comme suit:


  :T: /T/  1. [terminologie LISP pour `true' (vrai)] Oui.  UtilisΘ
     en reponse a une question (plus precisement si la question est
     posΘe en respect de {La convention -P}. En LIST, la constante T
     signifie entre autres `true' (vrai). Certains hackers Lisp
     utilisent presque par rΘflexe le `T' et `NIL' au lieu de `Yes'
     et `No'. Cela peut parfois provoquer certains malentendus.
     Quand un garcon de cafΘ ou un stewart propose un cafΘ a un
     hacker, ce dernier peut rΘpondre de facon absente `T', voulant
     dire qu'il veut un cafΘ; et bien sur il se fera livrer un thΘ
     a la place...
     Heureusement la plupart des hackers (en particulier ceux qui
     frΘquentent les restos chinois) aiment le thΘ autant que le
     cafΘ -- donc le probleme n'est pas Θnorme. 2. Voir {moment T}
     ...
     Autre facon d'Θpeler thΘ {tee}.  5. Un dialecte du {LISP}
     dΘveloppΘ a Yale. (C'est une allusion voulue a NIL, "Nouvelle
     ImplΘmentation du Lisp", un autre dialecte du LISP dΘveloppΘ
     pour le {VAX})


-La convention de formattage est plutot simple, les trois regles suivantes
 doivent etre respectΘes :


 Les mots sont classΘs par ordre alphabetique, le sΘparateur de lettre utilise
 le format suivant :

 = A =
 =====

 Chaque DEFINITION peut etre localisΘe en trouvant le MOT qui est prΘcΘdΘ et
 suivi du symbole ":".

 Dans la DEFINITION, les liens vers d'autres MOTS sont encadrΘs par les symboles
 "{" et "}".


[concentrΘ]
Le  prΘ-indexage  etant fait au  moment de l'ajout d'un  mot dans le jargon, les
possibilitΘs  d'exploitation sont  suffisantes  pour  permettre une  utilisation
...
moteur spΘcialisΘ ou dΘdiΘ au format qui est propre au jargon file, et au niveau
du mot ou de la definition selon les criteres recherchΘs.
[/concentrΘ]
...
long)  sans en  afficher la dΘfinition, ou encore afficher toutes les lettres de
l'alphabet,  et  enfin afficher une ou  plusieurs dΘfinitions qui rΘpondent a un
critere de recherche sur le mot ou dans les dΘfinitions elles-memes.

Voici deux exemples d'extraction du jargon file, un en php (orientΘ page web) et
l'autre  en C  (orientΘ ligne de commande), pour d'autres exemples, se rΘfΘrer a
      ...
      default :
        if($this->op!="") {
          ...
          if(!$this->IsInTheIndex($this->op)) { // empty results?
            $this->output.="\n  ... DΘsolΘ aucun terme n'a ΘtΘ trouvΘ ".
...
int main( int argc , char *argv[] )
{
    ...
    if (argc==1)
    {
        puts("Jargon File outil  "VER", "__DATE__" original par Kai Risku - revu par tobozo\n\n"
             ...
             "jarg -i jargonfile      - creΘr un index pour le jargonfile (chemin complet)\n"
             "jarg -f [nb max lignes] - Θcrire un mot au hasard\n"
             "jarg -l truc            - lister tous les mots contenant 'truc'\n"
             "jarg -d machin          - afficher les entrΘes contenant le mot 'machin'\n"
             "jarg [-] chose          - afficher l'entrΘe pour le mot 'chose'\n"
             );
        exit ( 0 );
    }
#ifdef __MSDOS__
...
void make_index( char *indexfile, char *textfile )
{
    ...
    if ( idx==NULL )
    {
        fprintf( stderr , "Impossible d'ouvrir le fichier %s en Θcriture.\n" , indexfile );
        return;
    }
...
j'ai  trouvΘe  permet non seulement  de voir  l'arborescence du site, mais aussi
celle du disque dur.
Elle  affiche  donc non  seulement les  dossiers, mais  tout les fichiers qu'ils
contiennent.  Elle affecte  de nomreux site, puisqu'elle est basΘe sur un script
php proposΘ par PHP-Nuke.
HΘ  oui, encore  une faille sous PHPNuke,  qui, bien qu'elle ne soit pas la plus
impressionnante, peut s'averer bien utile...
Cet article explique comment je l'ai trouvΘe, et comment l'utiliser (ou du moins
comment moi j'ai rΘussi a l'utiliser).

c) Description d'admin.php
**************************

Un  jour,  sur un site (  dont je ne me  rapelle pas l'url), j'ai trouvΘ un demo
d'un  script offert  par PHPNuke : Admin.php . Ce script, aprΦs authentification
par login et pass de l'administrateur, permet (dans le "File Manager") :

- D'uploader un fichier dans le site
- De crΘer un fichier ou un dossier sur le site
- De dΘplacer un fichier ou un dossier dΘjα sur le site
- De renommer un fichier ou un dossier dΘjα sur le site
- De copier un dossier ou un fichier dΘjα sur le site
- De dΘtruire un fichier ou un dossier du site
- De visualiser n'importe quel dossier ou fichier du site
- D'Θditer un fichier se trouvant sur le site.

Bref, tout ce qui est utile α un webmaster, ainsi que d'autres options du style:
...
Voici, pour info, la liste des titres proposΘs (en plus des premiers que j'ai de
citΘ,  et dont les 3 derniers) ainsi que leurs urls respectives (ceci est appelΘ
par PHPNuke "Menu D'administration") :
        ...
        File Manager (lα o∙ se trouve les options qui nous interessent) :
...
(entre autre) α gΘrer des "news".

Voici  les urls  directement  accessible sur  la page  "File  Manager", celle  α
laquelle on accede grΓce α la faille expliquΘe + tard :

        Copier, renommer ou dΘplacer un fichier/dossier :
...
Comme  vous  l'avez remarquΘ, je  ne donne ici ni  l'url pour uploader, ni celle
pour  crΘer  un dossier ou  un fichier,  pour la simple  et bonne raison que ces
options sont dans une &lt;FORM> d'action post (on pourra donc en faire des urls par
la suite, et c'est lα que τa deviendra rΘellement interessant).

On peut donc voir dans les derniers urls 3 valeurs :

"op", qui donne la valeur de l'opΘration α effectuer
"wdir",  qui a  par dΘfaut la valeur /,  / signifiant que l'on se trouve dans le
dossier  de base du  site. Cette valeur, toujours pour rester dans le dossier de
base,  peut Ωtre changΘe  par // ou par /./ (remarquez la similitude avec le "."
de la commande "CD ." alias "CHDIR ." en DOS, qui nous envoie dans le dossier o∙
on se trouve).
et  enfin "file", ayant  des variantes comme "touchfile", et qui donne le nom du
fichier ou dossier sur lequel la commande choisie dans "op" doit Ωtre appliquΘe.
...
crΘer un dossier et uploader un ficher) dont on a si peu parler jusqu'ici :
...
admin.php .
On y voit aussi un checkbox appelΘ "html"... vu que cette url ne nous
servira a rien,
je prΘcise juste que le texte "(html template)" se trouve α c⌠tΘ de ce
checkbox.
...
Vous  pouvez  taper toutes  ces urls  α la suite  d'un site possedant admin.php,
...
J'ai  donc  testΘ sur  le site http://site.de.test1/,  qui utilise admin.php les
urls en rajoutant le "name" et la valeur des buttons, ce qui donnait cela :

Pour crΘer un dossier :
...
trouvant dans le dossier par dΘfaut du site !!!

L'erreur nous informe de la place de ce dossier dans le disque dur :

/home0/truc/Serveur/htdocs/

Toutes les options vues plus haut sont prΘsentes ! Mais aucune ne fonctionne...
Toutes demandent toujours un AdminID et un mot de passe...

Tant pis, voyont comment se servir de notre dΘcouverte.
Je  sais  que si j'enleve  la partie de l'url  "&upload=Go!", je reviendrai α la
demande d'authentification habituelle... donc je n'y touche pas.

Commenτons par la fin, changeons la valeur de "userfile", pour donner :

http://site.de.test1/admin.php?wdir=/&userfile=test&upload=Go!

Rien ne change, α part l'erreur :
...
Bon, dΘcidemment cette partie ne nous apprendra rien, supprimons-la.
Il nous reste donc :

http://site.de.test1/admin.php?wdir=/&upload=Go!

"upload"  ne  doit pas Ωtre changΘ,  "admin.php" non plus (lol)... il reste donc
"wdir".
...
Le Current Directory reste toujours au dossier par dΘfaut du site avec, pour
...
bien que l'erreur n'ait pas changΘe.
Je vois par contre ces lignes changΘes :
...
Autre changement, les urls pour les options propres au File Manager ont changΘ,
elles sont du style :
...
Pas de grands changements, α part l'erreur :

        Warning: Unable to open '' for reading: No such file or directory in
        /home/machin/chose/public_html/admin.php on line 532

Encore une fois, rien que de tres logique : ce n'est pas le mΩme HD, ce n'est
donc pas la mΩme arborescence =))

Bien, on sait comment descendre dans cette arborescence... maintenant :
comment remonter ?
C'est  le moment de se rappeler ce qui a ΘtΘ dit α propos du DOS : "CD ." permet
de  rester dans le  dossier o∙ on se trouve, wdir=/./ se met dans le dossier par
dΘfaut.
HΘ bien, tantons le coup : "CD.." nous fait remonter au dossier parent...
testons l'url :
...
Il suffit donc de rajouter autant de "/../" que dΘsirΘ pour remonter
l'arborescence du disque dur, sans se limiter au site lui-mΩme.

Voilα, on peut se promener dans le HD α sa guise... youpi...


e) PrΘcisions/Astuces
*********************

Attention : Ce n'est pas parce qu'il y a une erreur que la faille est prΘsente.
Pour exemple :
...
Des bugs de ce genre sont tout de mΩmes assez connus, et appelΘs failles α cause
...
que la commande wdir ressemble fortement α la commande CHDIR (CD) sous DOS :
...
dossiers/fichiers. Bien s√r les URLS des opΘrations sont maintenant du style :

/admin.php?op=edit&wdir=1212&file=1212article.php .

Ayant  remarquΘ que  les "op" Θtaient egaux  aux noms des buttons dont la valeur
est "Go!", j'ai testΘ des urls genre
/admin.php?rblocks=Go!
/admin.php?mod_users=Go!
/admin.php?hreferer=Go!
(le  wdir n'est  pas indispensable, car il  a une valeur par dΘfaut) mais τa n'a
rien donnΘ...


Voir uniquement le contenu d'un HD peut ne pas paraitre trΦs utile, mais on peut
trouver l'accΦs de dossiers avec des informations sensibles.
Exemple :
...
f) Conclusion
*************
Voilα...  il  y a  surement  des  faτons  plus  pratiques d'utiliser  le  script
admin.php  ; comme  par exemple pour uploader, envoyer ou crΘer des fichiers, ou
crΘer des dossier.
Mais  ceci etant la premiere vΘritable faille (bug?) que je trouve par moi-mΩme,
n'en  demandez pas trop :) je sors seulement de la catΘgorie "script kiddie", et
j'ai  encore un long chemin α faire dans la sΘcu informatique.
Merci α FLoW, qui a fait un tuto nommΘ "PHP" et qui m'a inspirΘ.
Si  quelqu'un, grΓce α  ce texte (ou non) arrive α exploiter mieux le script, je
lui serais extrΩmement reconnaissant de m'en avertir.
Thx,
bye =)
...
Faille dΘcouverte le dimanche 4 novembre 2001 par frog-m@n
Article achevΘ le lundi 5 novembre 2001, toujours par frog-m@n =p
...
ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,
                ...
                Je sau - rai bien te rΘpandre
                Tes neurones dedans-dehors
                Vieux Castor

                Je t'ai r'τu poumons ouverts
                Vieill' SAVATE
                T'avais l'pΘtard a l'envers
                Vieill' SAVATE
                T'as br√lΘ tous mes tapis
                Des trous d'boulettes dans mon lit
                T'as fumΘ tout mon kashmir
                Vieux Tapir

                Puis j't'ai prΘsentΘ mon dealer
                Vieille SAVATE
                Puis j't'ai prΘsentΘ mon dealer
                Vieille SAVATE
                Tu y a parlΘ de l'euro
                Maintenant t'es son hΘros
                Et moi je paye le prix fort
                Vieux Castor

                Puis t'as parlΘ d'pΘnurie
                Vieille SAVATE
                Puis t'as parlΘ d'pΘnurie
                Vieille SAVATE
                En squattant tous les bons plans
                Sans rien m'laisser sous la dent
                T'as tout fumΘ sans remords
                Vieux Castor
                ...
                Vieille SAVATE
                └ p'tites taffes de shit mal cuit
                Dans ta trachΘe endolorie
                T'auras la santΘ qui s'gate
                Vieille SAVATE
                Vieille SAVATE
                Vieux Castor
...
ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,╕╕,°ñ║░`░║ñ°,
                ...
                Grosse lameuse ayant floodΘ tout l'ΘtΘ
                Se trouva fort dΘpourvue
                ...
                La voisine est dΘnonceuse ;
                C'est lα sa moindre parano.
                ½Qui floodiez vous jusqu'a sitot ?
                Dit-elle α cette lameuse.
                Nuit et jour α tout connectant
                Je spammais, ne vous dΘplaise.
...
Et hop -=#~ c'est terminΘ pour ce numΘro 26 du hackoff, bouclΘ en vitesse avec
perte et fracas mais sans odeur de pieds (on a changΘ de chaussettes pour
l'occasion), pour le prochain numΘro qui devrait sortit avant la fin de cette
annΘe, on ne vous promet rien que l'on ne puisse tenir (ca change), et on vous
assure que toute date anticipΘe n'est que trop en avance sur son temps pour
etre fondamentalement applicable sur un tel plan. gr·
