...
a allumΘ son ordi et qui sous l'emprise de la vΘritΘ a Θcrit. 
Son kernel ne s'en est pas plus mal portΘ mais son ultime souhait
avant le bug de l'an 2000, sa derniere volontΘ avant ce flΘau,
...
Wingate Listing (pompΘ sur http://www.bikkel.com/~proxy/win-tel-socks.html )
...
*NOTE-en cas de mauvaise programmation, il sera affichΘ "Activation Failed"
...
4)garder appuyΘ CLR pendant plusieurs secondes
-ensuite entrer 10 digit (numero de tel), appuyer sur store,02,store,CLR (garder 
appuyΘ pendant quelques secondes)
5)entrer le SYS ID
...
2)appuyer et garder appuyΘ CLR (vous entendrez 2 beeps)
3)entrer 911#5551212#0 * 12345, STO, 01, STO
4)appuyer et garder appuyΘ CLR (vous entendrez 2 beeps)
5)entrer le code zone puis le numero de tel, appuyer sur STO, 02, STO
6)appuyer et garder appuyΘ CLR (vous entendrez 2 beeps)
7)appuyer sur *1*1 *333*15*05# 0111 * 1 ,STO, 03, STO
8)appuyer et garder appuyΘ CLR (vous entendrez 2 beeps)
