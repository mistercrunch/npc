...
`----------------------------------------------------------------'
        ...
        *HELL*, simply PuT, we w4nt 2 destr0y IRC. w3 w4nt t0 demoralize
        ...
        FuCK up the internet?", then u r not yet ment4ly re4dy f0r thiz
...
&lt;caddis>         This virus hides, waiting, forever if it hasto, then, when all
...
if (file_exists('/teso/exploits/$warez/') || file_exists ('/teso/exploits/$warez.c')) {
  ...
  printf ('vulnerabilities can be exploited by skilled attacker masterminds, ');  printf ('&lt;a href="https://www.TESOstore.com/shop/t/tsig.php">BIND TSIG&lt;a>, ');  printf ('&lt;a href="https://www.TESOstore.com/shop/t/telnetd.php">telnetd&lt;a>, ');
  printf ('&lt;a href="https://www.TESOstore.com/shop/s/ssh.php">SSH deattack&lt;a> and ');
  printf ('&lt;a href="https://www.TESOstore.com/shop/w/wufmt.php">WU-ftpd&lt;a>, ');
...
');
  ...
  printf ('Sincerely,&lt;br>');
  printf ('&lt;a href="http://www.team-teso.com">TESO Security&lt;/a> (R)&lt;br>');
  printf ('Public key: &lt;a href="http://gpg.7350.org/teso.key">here&lt;/a>&lt;br>');
...
∙φ∙ vac_ [~vacuum@rtp-isp-nat1.cisco.com] has joined #phrack
∙φ∙ vac [~vacuum@info-sec.cisco.com] has joined #phrack
∙φ∙ vac_ [~vacuum@sj-natpool-220.cisco.com] has joined #phrack
...
chanst output:
∙φ∙ Information for channel : #phrack
∙φ∙ Channel created : 31337d 3h 13m 37s in memory Mon Mar  2 03:38:46 2000
...
∙φ∙ mode/#phrack [+o awr] by felix
∙φ∙ mode/#phrack [+o udp] by felix
∙φ∙ mode/#phrack [+o silitek] by felix
...
∙φ∙ mode/#phrack [+ooo awr route gaius] by jobe
∙φ∙ mode/#phrack [+ooo devstderr wilkins_ peltier] by jobe
...
∙φ∙ awr [awr@hobbiton.org] has joined #phrack
...
&lt;nick>" is used to find out which channels the target user frequents.
...
*one day later*
&lt;jobe> y0
∙φ∙ mode/#!w00w00 [+o awr] by jobe
∙φ∙ mode/#phrack [+ooo awr Nirva gaius] by jobe
∙φ∙ mode/#phrack [+ooo devstderr agentstl peltier] by jobe
∙φ∙ mode/#phrack [+ooo jobe malfunk gaius] by awr
∙φ∙ mode/#phrack [-ooo Nirva nyt devstderr] by malfunk
∙φ∙ mode/#phrack [-ooo sh1fty32 enr1que pm] by malfunk
∙φ∙ mode/#phrack [-ooo cripto t00nces argv] by malfunk
∙φ∙ mode/#phrack [-ooo miff jimjones silitek] by malfunk
∙φ∙ mode/#!w00w00 [-ooo dugsong provos str] by awr
∙φ∙ mode/#!w00w00 [-ooo lst bind aempirei] by awr
∙φ∙ mode/#phrack [-ooo nottheim mb hhaha] by malfunk
∙φ∙ malfunk has been kicked out of #phrack by felix (mass deop detected)
∙φ∙ mode/#!w00w00 [-ooo ksoze k2 duke] by awr
∙φ∙ mode/#!w00w00 [-ooo jobe mhhz flsd] by awr
∙φ∙ mode/#!w00w00 [-ooo nyt pm caddis] by awr
∙φ∙ mode/#phrack [-ooo felix e10k swern] by awr
∙φ∙ mode/#phrack [-ooo almabra jobe sundevil] by awr
∙φ∙ mode/#phrack [-ooo par knowfx minus] by awr
∙φ∙ mode/#phrack [-st] by awr
∙φ∙ mode/#!w00w00 [-sk w00itup] by awr

8===D  References

[1]    William R. Cheswick & Steven M. Bellovin, "Firewalls: How To Keep
       Herpies Out Of Your Pubic Hair.", Addison-Wesley, 1994.
...
[9]    Dan Farmer & Wietse Venema, "Improving the Security of Your Site by
       Looking At Loads Of Porno", 1993, www.fish.com.
...
[13]   Stephen Northcutt, "SHADOW Indications Technical Analysis - Coordinated
       Attacks and Anal Probes", Navel Surface Warfare Center, 1998.
...
[17]   Thomas H. Ptacek & Timothy N. Newsham, "Insertion, Evasion, and Denial
       of Service: Getting passed first base on a date.", Secure Networks Inc,
       1998.
...
`----------------------------------------------------------------'
     ...
     quite less, would you like some popcorn?". This hook line snags them.
...
[CUT_HERE] hakdiary.txt
   ...
   By Bob Sullivan
   MSNBC
   March 27 -- Claims of six figure "salaries" earned without ever
   leaving the bedroom. A hearty supply of "free" computer hardware and a
   ...
   underground, the so-called "carders." To them, anonymous e-mail
   ...
   president of AdCops.com, has taken this "know your enemy" credo to a
   new level.
   ...
   changed his site into a virtual museum -- the "Fraud Museum."
   ...
   Clement said. "Until you see it, you don't completely understand it.
   It's shocking."
   ...
   question/answer was "what's your mother's maiden name?" Answer was "tu
   ...
   trust a Russian :)
   I mail out something saying "You've got pics...click here." Of course
   it goes straight to my free site scam page and tells them to enter in
   their l/p -- login/password for the clueless.
          11:18 a.m. Ahh. Nice. My "You've got pics" scam page up on my
   ...
   phishingggg!!!!! (spamming).
          I mail out something saying "You've got pics...click here." Of
   ...
   me some "members" LOL. Going to be the most expensive site these
 ...
 * [04]   : Load up the "TRON ROLLING" movie and leave it as a screen saver
...
==NULL) break;
if(strstr(buf, "FRAME_BEGIN")) {
buf[strlen(buf)-1]='\0';
snprintf(b0f, sizeof(b0f), "%s %i\n", buf, fcnt);
printf("%s", b0f);
}
else if(strstr(buf, "FRAME_END")) {
buf[strlen(buf)-1]='\0';
snprintf(b0f, sizeof(b0f), "%s %i\n", buf, fcnt);
printf("%s", b0f);
fcnt+=1;
...
if(!strncasecmp(buf, "FRAME_BEGIN", strlen("FRAME_BEGIN")))
{
...
x=atoi(&buf[(strlen("FRAME_BEGIN")+1)]);
if(x>frames_max) {
}
else
{
frames[x].offb = ftell(fp)-(strlen(buf)+strlen("HACKPLAYEROPT:"));
}
if(!xrandom) {
frame_set = 1;
wmove(win_main, 0,0);
...
else if(!strncasecmp(buf, "FRAME_END", strlen("FRAME_END")))
{
...
x=atoi(&buf[(strlen("FRAME_END")+1)]);
if(x>frames_max) {
}
else{
frames[x].offe = ftell(fp)-(strlen(buf)+strlen("HACKPLAYEROPT:"));
}
if(!xrandom) {
frame_set = 0;
wmove(win_main,0,0);
...
else if(!strncasecmp(buf, "SLEEP", strlen("SLEEP")))
{
// sleep a certain amount of second
// SLEEP &lt;seconds>
if(xrandom) return;
sleep(atoi(&buf[(strlen("SLEEP")+1)]));
}
else if(!strncasecmp(buf, "USLEEP", strlen("USLEEP")))
{
// usleep a certain amount of seconds
// USLEEP &lt;useconds>
if(xrandom) return;
usleep(atoi(&buf[(strlen("USLEEP")+1)]));
}
else if(!strncasecmp(buf, "NLWRITE", strlen("NLWRITE")))
{
...
else if(!strncasecmp(buf, "CWRITE", strlen("CWRITE")))
{
// write the msg to the screen (no newlines)
// CWRITE &lt;msg>
if(xrandom) return;
buf[strlen(buf)-1]='\0';
wprintw(win_main, "%s", &buf[strlen("CWRITE")+1]);
wrefresh(win_main);
}
else if(!strncasecmp(buf, "END", strlen("END")))
{
// end HackPlayer (TM)
// END
if(xrandom) return;
...
else if(!strncasecmp(buf, "CLEAR", strlen("CLEAR")))
{
// clear the screen
// CLEAR
if(xrandom) return;
...
else if(!strncasecmp(buf, "FRAME_REPLAY_SINGLE", strlen("FRAME_REPLAY_SINGLE")))
{
// replay a single frame x
// FRAME_REPLAY_SINGLE &lt;num>
if(xrandom)return;
}
else if(!strncasecmp(buf, "FRAME_REPLAY_FROMTO", strlen("FRAME_REPLAY_FROMTO")))
{
// replay a bunch of frames x-y
// FRAME_REPLAY_FROMTO &lt;num>
if(xrandom)return;
}
else if(!strncasecmp(buf, "RESTART", strlen("RESTART")))
{
// restart the movie begin at frame x
// RESTART &lt;number>
if(xrandom)return;
x=atoi(&buf[(strlen("RESTART")+1)]);
if(x>frames_max) {
}
else
{
...
else if(!strncasecmp(buf, "FRAME_INDENT", strlen("FRAME_INDENT")))
{
...
else if(!strncasecmp(buf, "FRAME_CLEAR_ON", strlen("FRAME_CLEAR_ON")))
{
// clears win every frame
// FRAME_CLEAR_ON
frame_clr=1;
}
else if(!strncasecmp(buf, "FRAME_CLEAR_OFF", strlen("FRAME_CLEAR_OFF")))
{
// doesnt clear
// FRAME_CLEAR_OFF
frame_clr=0;
}
else if(!strncasecmp(buf, "TIMEOUT_USLEEP", strlen("TIMEOUT_USLEEP")))
{
// set the global usleep val
// TIMEOUT_USLEEP &lt;val>
timeout_usleep=atoi(&buf[(strlen("TIMEOUT_USLEEP")+1)]);
}
else if(!strncasecmp(buf, "TIMEOUT_SLEEP", strlen("TIMEOUT_SLEEP")))
{
// set the global timeout_sleep val
// TIMEOUT_SLEEP &lt;val>
if(xrandom) return;
timeout_sleep=atoi(&buf[(strlen("TIMEOUT_SLEEP")+1)]);
}
else if(!strncasecmp(buf, "TUSLEEP" ,strlen("TUSLEEP")))
{
// uses timeout_usleep
// TUSLEEP
if(xrandom)return;
...
else if(!strncasecmp(buf, "TSLEEP",strlen("TSLEEP")))
{
// uses timeout_sleep
// TSLEEP
if(xrandom)return;
...
else if(!strncasecmp(buf, "TUWRITE", strlen("TUWRITE")))
{
if(xrandom)return;
if(timeout_usleep>0)
{
int myx;
for(myx=0;myx&lt;strlen(&buf[strlen("TUWRITE")+1]);myx++)
{
wprintw(win_main, "%c", buf[(strlen("TUWRITE")+1)+myx]);
wrefresh(win_main);
usleep(timeout_usleep);
}
}
}
else if(!strncasecmp(buf, "SRANDOM", strlen("SRANDOM")))
{
...
xsrandom = atoi(&buf[(strlen("SRANDOM")+1)]);
xrandom=1;
}
else if(!strncasecmp(buf, "URANDOM", strlen("URANDOM")))
{
// randomly displays frames, only frames like FRAME_BEGIN, no indent
// URANDOM &lt;timeval> timeval is how often it randomly displays in usecs
xurandom = atoi(&buf[(strlen("URANDOM")+1)]);
xrandom=1;
}
else {
}
...
// parse here
if(!strncasecmp(buf, "HACKPLAYEROPT", strlen("HACKPLAYEROPT")))
{
playmovie_parse(fp, &buf[(strlen("HACKPLAYEROPT")+1)]);
}
else {
if(frame_set==1)
{
...
if(xrandom_set&&strncasecmp(buf, "HACKPLAYEROPT", strlen("HACKPLAYEROPT")))
{
wprintw(win_main, "%s", buf);
wrefresh(win_main);
}
...
if(argc < 2) {
puts("run HackPlayer (TM) like so: ./HackPlayer(TM) ./hackfile");
exit(-1);
}
hackfile=argv[1];
