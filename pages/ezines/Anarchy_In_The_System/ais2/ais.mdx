...
"Odiron"...vabbè, il pensiero e' quello che conta! ;-)
...
Veramente un bel numero! Un "continuate così" a Bobo e ZioMarzo, sperando di
...
Per la cronaca e' inziato il 8° corso, ed il 4° corso per newbies...in piu'
...
(Non esiste nessun Mazzocconi nelle zone di roma [il MSG di presentazione
 postato su vari NG e' stato spedito da lì]...uhm, qui gatta ci cova...)
...
DiSiNfO Φ una agenzia (dis)informativa autonoma, tenendo conto
che i media ufficiali dicono solo ci≥ che ci vogliono fare sapere,
...
La SIAE da diversi mesi ha chiesto e ottenuto da alcuni dei pi∙ importanti
...
Rockit, "da questo momento il sito non e' pi∙ autorizzato a utilizzare
qualsiasi tipo di clip audio a meno di non versare alcuni milioni nella 
casse della SIAE" La cosa rende ancora pi∙ urgente una presa di posizione 
...
Il fatto che utenti internet tedeschi possano per≥ acquistarli sulla rete,
sul sito di eBay, ha spinto il Simon Wiesenthal Center a chiedere ad eBay 
di rimuovere certi oggetti messi all'asta sulle sue pagine. Non Φ la prima
...
perchΘ il problema venga preso in considerazione dal management. Non solo, 
sostengono a eBay, la casa d'aste non Φ responsabile se qualche utente 
...
prepagata, Φ possibile connettersi ad internet. E' stata installata presso a 
...
installare nuovi punti di accesso in varie citta' nei luoghi dove maggiore Φ 
il passaggio di persone, dalle stazioni agli aeroporti, dalle universitα alle 
caserme.
...
Il sito in Apache corrispondente al dominio www.etoy.com Φ stato sospeso, 
ed Φ attivo solo tramite il suo indirizzo di IP. Tutto per colpa dell' 
...
verte su chi ha il diritto di condurre business, operare, esprimersi ed esistere
...
creativo e importante. Non si pu≥ derubare l'identitα di un artista. Etoy non Φ 
eToys. Ma, signore e signori, ora si Φ tra l'incudine di una corporazione e il 
martello di un tribunale. Il caso Φ effettivamente di interesse globale perchΘ se
...
precedente per cui un artista pu≥ essere buttato fuori dalla rete, illegittimamente, 
illogicamente e illegalmente" Il 29 novembre, con una sentenza-shock il giudice 
John P. Shook,  tribunale di Los Angeles, stabiliva in udienza preliminare (cioΦ 
...
riflettere Φ che il dominio di Etoy esisteva dall'ottobre 1995 mentre quello della 
...
centro di accoglienza per immigrati che Φ in localitα Ponte Galeria, 
...
loro corteo da un furgone Fiat Iveco, a bordo del quale - Φ
quanto riferiscono gli agenti - erano per≥ stati caricati alcuni
...
dimostranti, che chiedevano la libertα del leader curdo Ocalan,
assaltarono la sede delle linee aeree turche.
Le cariche delle forze dell'ordine sono state numerose e si sono
succedute dalle 11.30 alle 14. Il lancio di candelotti lacrimogeni Φ stato
...
per come Φ stato gestito l'ordine pubblico a Ponte Galeria╗. 
Per i tre esponenti politici, ½a Roma sono state sospese le libertα
costituzionali╗ e, per questo, hanno annunciato al questore La Barbera
che ½al pi∙ presto, per fare luce su quanto accaduto durante una normale
manifestazione di protesta╗, verrα chiesto l?intervento del
governo╗.
...
linux ! 
NOTE: mettete la  caffettiera  sul fuoco..perchΦ dopo un paio d'ore sentirete 
bussare la CIA o i marines..un buon caffΦ Φ sempre gradito.....hahaha
...
Bene adesso  s'inizia. Ricordate che  l'hacking Φ una  passione, una sorta di 
...
scopi, va imputato alla responsabilitα del  lettore. Inoltre  puoi diffondere 
liberamente l'articolo purchΦ  lasci invariato  il nome del suo  autore(e che 
...
visto un topo ..... e cos∞ via.....fino ad arrivare ai batteri monocellulari.
...
linguaggio)  passiamo  a  vedere  uno  degli  exploit  da  remoto  che pi∙ mi 
piacciono,  hehehe  sapete mi ha dato parecchie  soddisfazioni. Parliamo cioΦ 
del "bind/named exploit".
Questo  particolare  exploit  agisce  sul  named  cioΦ  un programmillo delle 
...
Quello che il named fa non Φ  particolarmente  importante per i nostri scopi, 
...
rispolverata  al  vostro  pinguino,  perchΘ  adesso lo mettiamo a dura prova. 
PerchΘ  abbiamo  detto  "potenzialmente  exploitabili"?  perche non  tutte le 
...
che fa andare in tilt il named cioΦ lo crasha e  vi consente di entrare sulla 
macchina  con  privilegi  di root.  Il  tutto avviene sfruttando un valore di 
offset ed uno di allign.             
Potrebbe  sembrare  molto complesso ma  non lo Φ anche perchΘ esiste un altro 
programma (ve lo allego sempre nella ezine)  che si  chiama bindinfo.c questo 
ti da informazioni sulla exploitabilitα del bind di una macchina e sui 
parametri da settare.  Ricordatevi:  tutte le versioni 4.9.5 e 4.9.6 ed anche 
le versioni 8.1.1. Comunque non dimenticate mai  che l'importante Φ provare e 
...
La   prima  ci  darα  delle  informazioni  sul  bind  della macchina  remota, 
verificheremo  perci≥   se  Φ exploitabile  e l'altra  sarα  l'exploit vero e 
proprio,  che  ci  darα accesso da root alla macchina senza decrittare passwd 
...
Comunque  io  non mi  ritengo responsabile  lo ripeto. Se fate cazzate Φ solo 
...
/usr/sbin/named   Φ   un eseguibile.   Il  file di configurazione del named Φ 
situato invece  in   /etc/named.conf  e contiene tutte le informazioni  a cui 
accede il bind per la gestione di un dominio. 
Se   non   avete  capito passate  oltre, perchΘ non posso spiegarvelo sarebbe 
...
-   vi  serve  un  account  falso (farselo  Φ facile, provate con jumpy.it ad 
     esempio)
...
-   dovete  sapere  editare  i  files  di  log (di questo ne parliamo  magari 
    sui prossimi numeri)
-   linux (Φ obbligatorio  dobbiamo compilare infatti bindinfo.c e named.c ci 
...
Fatto? Ora avviate con /dir/incui/siete/bindinfo e lui vi richiederα un host. 
Date il  nome del server linux  che volete venga controllato e il programmino 
vi  dirα  la  versione del  bind oppure vi dirα che non Φ determinabile se la 
versione Φ diversa. Se la  versione Φ exploitabile bene. Utilizzate a seconda 
della   versione  uno  degli  exploit  che  abbiamo  visto  sopra.  Di questi 
Namedexploit  Φ il piu completo:  se lo avviate senza parametri vi da infatti 
...
ricordate  che  il named Φ  down....cioΦ lo abbiamo crashato pertanto bisogna
...
In pratica  rieseguite il named. Ed il gioco Φ fatto. Ora e come se non fosse 
...
sopratutto su anticode c'Φ un'intera area  dedicata. Leggetevi anche i testi.
...
Allora ragazzi questo Φ il primo articolo che scrivo per AiS e spero che ne 
seguiranno altri,  l'intenzione Φ quella di fornire a tutti i newbies una 
...
di tempo. VabbΦ basta con ste cazzate iniziamo............
...
subito hihihi). Sicuramente imparerete per≥ che internet non Φ solo Internet 
Explorer, e che la grande rete non Φ solo Microsoft e non Φ solo Windows....
...
avete percepito qualcosa. Se invece il computer vi basta cos∞, con il vostro 
bel giochetto, e con word e le sue ricche funzioni allora smettete di leggere 
il mio articolo e continuate pure cos∞, sarete sempre l'utente preferito da 
...
Non vi dico che non sono responsabile per ci≥ che farete di queste informazioni 
perchΘ gia lo sapete, se vi mettete nei guai, non sono fatti miei, io non vi 
...
Un primo consiglio Φ quello di installarvi Linux lo trovate gratuitamente, 
ormai lo regalano con le riviste. Se avete  windows per ora potete utilizzare 
Telnet (ma procuratevi Linux), per le prime lezioncine pu≥ andare bene anche 
win95/98, ma andando pi∙ avanti vi serviranno compilatori ecc...e con win non 
li avete. 
...
e cazzate cos∞. Un lamer ecco cos'ero. Oggi non  mi sento un hacker, ma capisco 
che il mio approccio Φ pi∙ costruttivo e basato su una qualche forma di 
conoscenza trasferibile agli altri. Comunque se avete linux tutto cambia, 
avrete a disposizione linguaggi da imparare e un intero sistema operativo che Φ 
identico a quelli che volete bucare......ed Φ diverso da win. Mentre aspetto 
che ve  lo installate iniziamo con gli strumenti che abbiamo.
Sto iniziando proprio dall'inizio cos∞ mi potete seguire e tutta la premessa 
...
entrare, saranno dei server di rete Unix, cioΦ parleremo degli internet provider
......a cosa state pensando? A tin, tiscali, si loro......magari non proprio 
loro ma l'idea rende molto bene. L'obbiettivo di un hacker Φ quello di entrare 
...
che non pu≥ accedere ad alcune funzioni di sistema e ad alcune directory, ed il 
root che sarebbe l'amministratore, che  pu≥  fare tutto ci≥ che vuole sulla 
macchina. Ricordate questa differenza se siete agli inizi ed installatevi linux.
Perci≥ obbiettivo individuato: Entrare nella macchina e divenire root.
...
Il portsurfing Φ appunto la tecnica di collegarsi ad un sistema su tutte le 
porte che questo lascia aperte per avere pi∙ informazioni possibili.
Per capire questo dovete avere almeno un'infarinatura di come funziona la rete. 
La rete Φ organizzata in servizi: web, posta elettronica, ftp ecc. Un sistema 
(Unix che sarebbe un server di rete) organizza tali servizi e li gestisce 
tramite  dei programmi ogni programma e perci≥ ogni servizio funziona su una 
porta? Chiaro? Che significa? Ad esempio quando vi collegate al vostro sito 
porno preferito state usufruendo di un servizio (web) che Φ fornito e gestito 
dal vostro provider tramite la porta 80.
La posta elettronica? Il server Φ sulla porta 25 e cos∞ via....
Funziona cos∞: quindi quando spedite un messaggio di posta elettronica il 
...
lo avete mai saputo....state sicuri che la Microsoft non Φ interessata a 
...
la rete. Sbagliato perchΘ per entrare in un sistema ci servono tutte
...
serie di informazioni che ci consentiranno pi∙ in la di entrarci. 
Intando procuratevi un buon portscanner, un programma che ti consente vi sapere 
quale di queste porte Φ aperta,......io ne uso uno che ha anche altre funzioni, 
...
questi programmi che si occupano di gestire i servizi di rete daemon cioΦ 
Demoni.
...
porta troveremo un demone ad aspettarci, e vi assicuro che non sarα facile 
...
per entrare nel sistema. Stiamo parlando dell'essenza stessa dell'hacking cioΦ 
degli "exploit". 
Giα gli exploit, sfruttare un bug per ottenere un accesso alla macchina, magari 
...
(togliendo naturalmente sia "http://" e anche tutto cio che c'Φ dopo la prima 
...
dovrebbe accogliere cos∞.....

     RedHat Linux 6.1 (Cartman)
     Ver. 2.2.13
     Login:

questo dipenderα comunque dalla macchina bersaglio....potrebbe non essere un 
...
dentro, ma siccome non Φ con l'immagginazione che si buca un server non vi 
mettete a provare login e passwd perchΘ i vostri tentativi sono registrati 
...
Qui non vi apparirα nulla sicuramente. Il domone "fingerd" non vi accoglierα 
...
Il root esiste sempre perchΘ si tratta dell'amministratore di sistema.
Vi darα qualcosa del del genere:
...
La connessione si chiuderα automaticamente subito dopo, questa Φ una 
caratteristica di fingerd. Come vedete giα sappiamo il nome 
...
possiede. (Non sapete cos'Φ una shell? Questo non ve lo dico........siete 
proprio svogliati andatevelo a studiare con linux dovrete iniziare prima 
o poi!!)
Un altro "demone" attaccabile Φ il wu-ftpd, si tratta del programa che si 
occupa della gestione del server ftp la porta Φ la 21. Dovete sapere che 
...
www.mediatel.it e come porta la 21 (ou attenti questo Φ un address vero, non 
...
abbiamo messo nessuno@niente.it perchΦ l'accesso anonymous presuppone che voi 
...
- la porta 23 Φ quella di TELNET da qui avrete la versione del SO (sistema 
  operativo)
- la porta 21 Φ quella del servizio FTP da qui avrete la versione del daemon 
  wu-ftp
...
- provate pure altre porte ad esempio 514, 515, 702, o le porte di irc, se si 
  tratta di un server irc..da 660 a 670 insomma provate. Per ora direi che pu≥ 
bastare, la prossima volta studieremo pi∙ da vicino ogni singolo daemon e gli 
...
checksum (che e spiegata sotto ) che e calcolata in basa alla quantitα di dati
...
Φ un  indirzzo IP cioΦ una serie di 4 serie di cifre come 128.6.4.194.
Il quale Φ un numero a 32 bit, ma Φ scritto in serie di 4 cifre decimali
...
(es. 128.6 Φ il numero IP assegnato alla Universitα di Rutgers.)
...
L'ultimo ottetto permette fino a 254 sistemi per ogni Ethernet (254 perchΦ 0
e 255 non sono permessi). Come menzionato, gli IP Address sono
numeri scritti in serie di 4 ottetti ( in decimale per≥ ) , e.g. 128.6.4.7 

Ci sono attualmente tre tipi di indirzzi.
Il problema e che un IP pu≥ indicare sia una rete che un Host sulla rete.
Questo perchΦ i progettisti pensarono che 24 bits erano sufficenti per
...
hosts e invece non fu cos∞.

Queste reti chidevano indirizzi da 48 bit .Ma  i progettatori sapevano in
realta' erano sufficenti indirizzo da 32 bit. Cos∞  adottarono un Kludge,
pensando che la maggior parte delle reti in futuro sarebbero state
piccole. Cos∞  settarono 3 differenti campi (o ranges all'inglese) di
indirizzi.
...
Cos∞ 24 bits sono disponibili per gli hosts. Questi numeri sono usati per le
grandi reti.
...
e gli indirizzi che iniziano con il 127 perchΦ sono usata per scopi
...
quale si trova, o il loro indirizzo Host. Per esempio, 0.0.0.23 Φ una macchina
...
Cos∞ puoi spedire una richiesta come  Broadcast. O se i numerosi  sistemi sono
interessati alla stessa informazione, Φ meno dispendioso spedire un singolo
Broadcast che spedisce i datagrammi individualmente a ogni Host che Φ
interessato. Per spedire un Broadcast,  usi un indirizzo che Φ creato usando
il tuo numero di rete,
con tutte le stesse parti dell'indirizzo dove il numero dell'host va.
Cos∞ se tu sei sulla rete 128.6.4 , e vuoi usare 128.6.4.255 per broadcast.

Non e possibile spedire Broadcasta su Arpanet, o su una linea Point to Point.
Ma Φ possibile su un Ethernet. Se tu usi un indirizzo Ehthernet con tutti i
suoi bits "su", ogni macchina su ethernet  Φ inteso guardare a quel
datagramma.
...
comprendere la sottorete(subnet). Cos∞ considerano il numero di rete 128.6 .
Esse assumeranno un indirizzo Broadcast di 128.6.255.255 o 128.6.0.0  .

PerchΦ 0 e 255 sono usati per gli indirizzi Sconosciuti oppure gli indirizzi
...
|                                            --- per subnet                 |
+---------------------------------------------------------------------------+
|RANGE IP CLASSE C = DA 192.1.1 A 223.254.254 -- Il rimanente ottetto Φ per |
|                                            --- le subnet                  |
=============================================================================
...
Questo Φ un articolo sul trojan netbus e sulla sua gestione da
...
attivo. Dice di essere un grande hacker ... e che lui Φ uno di quelli che con
...
parlando di Bill! Va be che assomiglia ad un pocket cofee ma Bill Φ
inconfondibile !
...
ijklmnopqrstuvwxyzσΣ÷            Disattiva tutti keys(tastiera)
...
Consiglio : Non usate mai le gui grafiche ! Usate i comandi "puri". Una gui
            ...
            i comandi ed usarli con telnet Φ cosa da pochi !
...
>1996<
^^^^^^
Il ckd del 1996 colpisce la libertα di comunicazione delle risorse telematiche
...
tentando di risolverne altri che ci sembravano essere pi∙ probabili.
...
BROADCAST"... bene... se riesco ad avere accesso ad uno dei 2000 o piu'
...
ROUTER INTERFACE"). Sembra, quindi, che l'attacker(s) conoscesse bene
...
particolari della nostra situazione bancaria: Φ tutto nel computer. Il mondo 
potrebbe finire alla mercΦ dei Cybercrimilnali?
...
Kevin Mitnik, uno dei pi∙ celebri pirati informatici (hacker) d'America, usc∞ 
dal suo appartamento, gli agenti gli misero le manette ai polsi. Finiva cos∞ 
...
Kevin Mitnick era giα salito agli onori della cronaca nel 1982, ancora 
adolescenie, quando utilizz≥ un computer per accedere ai dati del Comando 
della Difesa Aerea degli Stati Uniti. Al momento dell'arresto, fu  trovato 
inpossesso di dati riguardanti pi∙ di 20000 carte di credito oltre che di 
numerosi codici di accesso reittivi alle banche pi∙ riservate di ogni parte 
del mondo.
...
Abene fin∞ in prigione il 7 gennaio 1994 colpevole ddi aver preso di mira i 
computer centrali delle compagnie telefoniche. Condannato a 1 anno e 1 giorno 
di reclusione venne per≥ rilasciato il 7 novembre dello stesso anno. Sebbene i
...
Questa branca della pirateria informatica Φ nota col nome inglese di phreaking
e per ragioni sin troppo ovvie, non Φ molto ben vista dalle societα che 
...
Se nel caso che abbiamo appena descritto si Φ trattato di una ragazzata 
relativamente innocua, i criminali informatici specializzati nel settore delle
telecomunicazioni hanno acquisito la capacitα di "rubare" i numeri dei 
...
milioni di sterline (pi∙ di 880 miliardi di lire).

=] L'HACKER IN TRAPPOLA [=

Abene non faceva affatto mistero dei suoi successi e si divert∞ nel raccontare
le sue prodezze a una stazione radiofonica di New York. Questa bravata lo
port≥ all' attenzione delle compagnie telefoniche e caus≥ la sua rovina.
Durante il processo, un ex 'igente della CIA pens≥ che Abene avesse troppo
talento per sprecarlo in prigione e si offr∞ di sorvegliarlo durante lo
svolgimento di un lavoro a Washington in alternativa alla detenzione. Ma il
giudice respinse l'offerta e condann≥ Abene al massimo della pena. Sono in
...
Mitnick e Abene sono solo la punta dell' iceberg. Con importanti societα che
utilizzano i computer per mandare avanti i loro affari, la prospettiva  per
il crimine informatico Φ a dir poco  terrificante.

=] FURTO NEL CIBERSPAZIO [=

Internet Φ una rete di elaboratori il  cui accesso Φ libero a tutti in ogni
parte del  mondo con il solo ausilio di un computer e di una linea telefonica
commutata. Questo offre agli hacker come Mitnik e Abene nuove opportunitα e
sempre pi∙ stimolanti. In Internet sono giα disponibili bartking (che
...
possibilitα di predare conti bancari e carte di credito. Un rapporto della
Commissione Federale del Commercio degli Stati Uniti, pubblicato nel maggio
1996, si Φ spinto a dichiarare che il ciberspazio Φ divenntato la nuova
...
crimine irformatico Φ costato al mondo degli affari britaunico nel solo 1995
...
interferivano con le strisce magnetiche delle tessere fedeltα dei supermercati
...
della Management Consultancy PA, una tendenza  particolarmente preoccupante Φ
...
attivitα loro attivitα e la truffa informatica costituisce un sistema
relativamente poco rischioso di rastrellare grosse somme di denaro. Si
costringe l'impiegato di una societα a manomettere il sistema informatico e a
dirottare il denaro in un conto bancario falso oppure ci si infiltra
direttamente, facendosi assumere nella societα che si vuole depredare. "I
colpevoli di questo  tipo di reati  vengono catturati molto raramente",
avverte Jenner, perchΘ risulta estremamente difficile rintracciare, e non
parliamo poi di perseguire, la persona che ha commesso il reato.

Fortunatamente, per≥, non finisce sempre cos∞.  Nell'ottobre '99  venne
portato alla ribalta uno degli esempi  pi∙ audaci di reato informatico, per il
quale furono arrestate ben sette persone.
Con un sistema relativamente semplice e la complicitα di alcuni impiegati
...
centinaia di migliaia di codici segreti, cioΦ quella sequenza di quattro,
cinque numeri che deve essere digitata sulla macchina perchΘ questa possa
...
Internet Φ ugn∞ sorta di "piazza" virtuale dove qualsiasi tipo di informazione,
...
Regolamentare Interne per fermare definitivamente la pornografia infantile Φ
un lavoro mostruosamente difficile.
Uno dei problemi principali Φ costituito dalle diverse legislazioni dei vari
...
loro materiale  in un'altra  nazione con 1eggi pi∙ permissive. Questo
materiale pu≥ essere caricato in Internet e reso disponibile a tutti e ovunque.

Se l'abilitα di hacker come Mitnik Φ in grado di mettere in ginocchio la
...
Collegarsi come root e copiare il sorgente compresso in /
...
1_aprite il kppp se non lo avete procuratevelo cmq si trova nel kde e dovrebbe
  essere presente in quasi tutte le distribuzioni linux. la prima schermata Φ
...
3_DISPOSITIVO: il vostro modem dovrebbe trovarsi sulla com1 se non lo Φ
               mettetelo l∞ :)))))))), cazzo  ma non vedo scritto com1 nella
               ...
               Fine linea settiamo CR/LF, velocitα di connessione mettiamo la
               velocitα del nostro modem ,selezioniamo use lock file e timeout
               modem 60 secondi.

4_MODEM: attesa se linea occupata settiamo 10 secondi, volume modem mettete la
         metα di volume bisogna sentirlo il modem quando parla :)))))))) .
         Stop non mettete nient' altro.

5_PPP: timeout del programma pppd 30 secondi, selezionate quello che volete
       del restante PPP come vi piace di pi∙.
...
A_CHIAMA...: nome connessione mettiamo un nome che ci pare che vogliamo dare
             ...
             il resto se lo volete mettere mettelo ma serve per comoditα non
             per connettersi.
...
ma non scherziamo vi devo rompere ancora le palle un p≥ spero non abbiate
stracciato il bigliettino con i server dns con gli ip perchΦ adesso dobbiamo
configurare un p≥ di file come hai vecchi tempi del mitico amstrad :))))))))).
...
lo dovete trovare scritto cos∞ se non lo Φ scrivelo come indicato sopra e
salvate
...
server ad un altro di lasciare una riga, se il serve ha pi∙ indirizzi ip come
vi capiterα per il vostro server ricordate sempre che fa parte di un solo
server, Θ una possibiltα in pi∙ che vi da il server se trovate il primo IP di
server pieno avrete il secondo che sarα sicuramnete libero, se doveste
...
#quello che vi pare il file capirα che quello sono informazioni vostre.

/etc/resolv.conf :

questo file deve essere vuoto quindi se c' Φ qualcosa cancellatelo.

ho finito veramente, cazzo non so pi∙ cosa scrivere, intanto torner≥ con
qualcosa di ancora pi∙ lungo hahahahahahahahahaha. Ecco potrei spiegare come
...
Consiglio di utilizzare gpc (gnu pascal), che Φ per linuz, se usate ankora 
...
Qui sotto trovate un semplice programma per pascal che sarα spiegato piu sotto
...
Ok, ok, cominciamo la spiegazione del programma + semplice che ci Φ venuto in
mente. Prima di tutto Φ necessario sapere che in tutti i casi, tranne
poche eccezioni, alla fine di ogni comando va il punto e virgola. Quel "program
nomedelprogramma" da il nome al tuo programma e anche se utilizzarlo Φ
facoltativo, Φ consuetudine scriverlo all'inizio del progz. Per iniziare il
programma si usa il comando "begin" che Φ una delle poche eccezioni in cui 
...
questo caso Φ stato inserito per fare in modo che il programma aspetti un
...
alla fine il punto. Tutto quello che Φ racchiuso tra (* *) Φ un commento. Un
commento si puo inserire facoltativamente in quanto non Φ indispensabile per il
funzionamento del programma, ma se si vogliono rendere disponibili i sorgenti
del suddetto potrebbe essere utile inserirlo.

		2.1 Le Variabili E Le Costanti

Una variabile, come dice il nome stesso, Φ un dato che puo assumere valori
diversi durante lo svolgimento del programma. Una costante invece Φ un
dato che pu≥ assumere un solo valore all'interno del programma. 
...
(* La variabile pippo Φ il risultato della somma delle precedenti variabili *)
writeln('Il risultato Φ',eta beta');
(* write in questo caso scriverα il valore della variabile eta beta *)
readln;
end. 

		[-- FiNe PrOgZ --]

Come avrete certamente notato la sintassi da seguire per il comando "var" Φ la
seguente: var nome_variabile1,nome_variabile2:tipo_di_variabile
Per il comando "const" la sintassi Φ invece: const nome_costante =
...
La selezione, cioΦ la scelta operata da determinate condizioni che avviene
durante l'esecuzione del programma, Φ solitamente rappresentata
dall'espressione if then else. If then else opera la selezione, verificando se
una determinata espressione Φ vera o falsa e eseguendo un determinato pezzo di
programma se Φ vera e un altro se Φ falsa. Se per≥ non Φ presente il
comando "else", se l'espressione Φ falsa il programma va avanti senza tenere
...
l'espressione Φ falsa deve eseguire un determinato blocco di istruzioni. Un
esempio:
...
',paperone,'piu ',paperettayeye,'che Φ ',krusty); 
readln
end.

		[-- FiNe PrOgZ --]

Il programma che potete ammirare qua sopra, Φ s∞ alquanto stupido, ma Φ anche
il primo che ci Φ venuto in mente per farvi capire come opera la selezione. Il
...
necessariamente essere seguito da "then", Φ usato nella seguente sintassi:

If condizione then
comando;

Avrete inoltre notato che sia in questo esempio, sia nel progz, manca il punto
e virgola al comando, infatti Φ una delle eccezioni di cui parlavamo nel primo paragrafo. 
Al "comando" seguito da if.. then il punto e virgola va invece solo in un caso: quando 
c'Φ solo un'istruzione e non c'Φ il comando else. Prima del comando else non
c'Φ mai il punto e virgola.
Per utilizzare piu istruzioni la sintassi Φ la seguente:
...
finchΦ una determinata condizione Φ vera. Il ciclo repeat prima esegue il
pezzo di programma, poi verifica se una determinata condizione Φ vera e se lo
continua a ripetere, altrimenti non continua. La sintassi da usare Φ la
seguente:
...
non Φ altro che un sottoprogramma all'interno di un programma scritto in
pascal. Una funzione Φ una procedura che restituisce un valore. Le procedure e
...
Ke kazzo c'Φ da concludere vi kiederete voi??? Ce lo stiamo kiedendo anke
noi... E giacchΦ ci siamo rotti i coglioni di scrivere l'articolo finisce qui! 
...
cortissimo e magari simile a questo: ~1½╜ª⌐     ;))))
...
converte in linguaggio macchina cioΦ 10110101011 in codice binario.
...
Ah GigΦ, MA QUANTE KAZZO NE  VUOI SAPE' OOOOOOOO
...
Ragazzi, sono stato assente molto tempo per motivi in realtα stupidi, ma in
questo momento di "idle" ho deciso di attaccare una protezione che mi
"chiamava" oramai da molto tempo......La release che attaccheremo sarα
l'ultima della Kinetix (giα, proprio quelli del 3D Studio Max) e cercheremo
...
Il 3D Studio Φ un programma che Φ fantastico......O almeno, suppongo che sia
fantastico visto che non lo so usare tanto bene :)..Ad ogni modo Φ
conosciutissimo perchΦ Φ lo stesso che hanno usato per creare i mostri di
...
fuori qualunque cosa con un grado altissimo di realtα).....Insomma, il
programma sembra proprio valere tanto oro quanto pesa ed Φ un po' il
"SoftIce" dei grafici tanto per capirci.

Essay
 
Installate tutto il programmuzzo, riavviate e preparatevi spiritualmente a
questo nostro piccolissimo attacco :)....All'avvio farα la sua comparsa un
...
Decisamente molto simpatico.....La chiave hardware non Φ attaccata (ma va?)...

Oppure stai usando la chiave sbagliata (se, come se a casa avessi dongle a
iosa), oppure il dispositivo della chiave non sta correndo (eppure Φ strano,
...
su MessageBoxA (giα, da questo lato Φ pi∙ semplice crackare la protezione
...
la casella "Load Resources" al momento del disasm, ma non scappate perchΦ
dopo qualche secondo vi chiederα di cercare per lei due dll
...
c'Φ un test eax, eax...Non cambiatelo perchΦ mettendo in eax un valore diverso
...
come vedete la chiamata muove in eax il valore della locazione 648D34 (che Φ
zero)...E poi muove in eax ci≥ che essa stessa punta...Ci≥ significa che se
voi mettete nel registro un numero qualunque, allora il programma arrivato
alla locazione 0041AE05 muover≥ in eax ci≥ che.......Eax punta, cioΦ nulla e
quindi....CRASH!
...
a ritroso per giungere alla parte di codice che ci interessa, (in realtα le
...
genera il box, Φ necessario risalire per capire dove si possa trovare qualche
check, ed Φ uno dei pochi metodi attuabili viste le dimensioni ragguardevoli
del file :).
...
.text:0048A783              _text_48A783:         ; CODE XREF: _text_48A6C0+4D↑j
.text:0048A783              call NoHardwareKey    ; Questa Φ la routine della
                                                    messagebox
...
il trucchetto Φ suo, io non ci avrei mai pensato) cioΦ, togliete la parallela
...
frontalmente Φ il primo pin in alto a sinistra).......

Bene, adesso ci dovete collegare un led (non siate tirchi che costano 100ú
l'uno)......

Giα, proprio un led (e qua l'intentiva Φ stata tutta mia :) guardate il Led,
il gambo pi∙ lungo Φ il catodo (dove deve arrivare tensione con segno -) e
l'altro Φ l'anodo (tensione positiva) inserite il gambo dell'anodo nel
...
create un utilissimo congegno che vi svelerα ogni volta che un programma
cerca di accedere alla parallela...Come? Ovvio, il led si accende e mentre
steppate potete capire con facilitα se state chattando col dongle o meno :)...

╚ facilissimo in realtα, e con 2000ú vi fate un congegnetto che credetemi
...
arrivare all'RVA 005F9E65 (il metodo usato Φ molto empirico ma funziona
...
vediamo che c'Φ una chiamata e poi un test ax, ax (e di fatti nella chiamata
48A701 ci siamo entrati dentro.......Ma poco dopo troviamo una chiamata
simile (cioΦ: call, e poi test ax, ax).......

Possiamo supporre che la prima call sia un check (Non Φ che lo facciamo ad
cazzum, anche perchΦ andando a ritroso nel codice giungiamo alla routine che
ci chiude il programma :)..E quindi anche la seconda, perci≥ esaminiamole
...
pu≥ essere interessante........Vi riporto lo stato dei registri appena entrati
in questa chiamata:
...
Φ 0 allora muove 2 in AX.......Passiamo all'altra chiamata:
...
utilizzando un pochetto di zen andiamo qualche rigo pi∙ gi∙ ed entriamo alla
...
che eax in uscita contenga zero....Tadαααα funziona...Deh hi hi :).......
...
pi∙ semplicemente appena entrati nella chiamata sostituite tutti e tre i
check con un bel "xor eax, eax    retn x")

Adesso il programma sembra funzionare correttamente.........Gia, sembra....
PerchΦ? Beh perchΦ c'Φ sicuramente ALMENO un altro check.......Che Φ
semplicissimo da scoprire, basta aprire 3D Studio e lasciarlo l∞ per 5 minuti.

Poi un bel box ci accoglierα dicendoci che non c'Φ nessuna chiave......
...
impostato a 5 minuti esatti :) un check di quel genere quasi sicuramente sarα
...
allora, per chi non lo sapesse, il parametro da cercare non Φ il 3░, bens∞ il
secondo perchΦ il sistema salva i dati nello stack al contrario....

Breve digressione:

molti di voi si chiedono perchΦ i dati vengono salvati al contrario, e se
scrivete in ASM sapete anche che non potete chiamare un api come fareste in C,
cioΦ chiamando i parametri dal primo all'ultimo, ma dove pushare al contratio
tutti i parametri oppure dovete usare la notazione in riga. PerchΦ tutto
questo? Lo stack funziona con un metodo detto LIFO (Last In First Out) cioΦ,
Φ come quando accatastate tante monetine, se poi dovete recuperarle senza
farle cadere sarete costretti a tirarle via a partire della pi∙ alta (che Φ
quella che avete messo l∞ per ultima), quindi lo stack fa la stessa cosa,
...
quando il processore andrα a popparli tirerebbe li tirerebbe fuori in ordine
inverso:
...
in ASM) allora il processore li popperα nel giusto ordine, guardate:
...
Φ questo il motivo per il quale in sice dobbiamo andare a cercare il secondo
...
1 minuto = 60 secondi cioΦ = 60*1000 = 60.000 millisecondi
...
.text:0048A62A              _text_48A62A: ; CODE XREF: CheckCall+377↑j
.text:0048A62A            ; CheckCall+386↑j

ora vi starete chiedendo: "Chi Φ CheckCall?"....Quella non Φ altro che la
chiamata che contiene tutti quanti i check cioΦ quella che si trova
...
Mmmmmmm non sembra essere troppo diverso da prima.......Ed invece lo Φ.......
...
modifica (cioΦ muoviamo in eax 0) poi incappiamo in un secondo sub-check, e
...
1) Modifichiamo la chiamata affinche xori eax e poi  all'RVA 0048A5B2 invece
   ...
   check, ci≥ significa che dobbiamo mettere un "jmp 48A63D" (solo che
...
2) Modifichiamo la chiamata nel solito modo ed invece di mettere il jump ci
   ...
   stack pointer 8Bh appena prima del ret cos∞ la chiamata tornerα proprio
   all'istruzione 0048A63D
  
3) Noppiamo tutta la routine che setta il timer cos∞ che non sarα fatto alcun
...
Φ decisamente un check, ma non sono riuscito ad arrivare a questa routine in
...
Forziamo il jnz a 00F95D8 e facciamolo diventare un jmp che punterα
all'RVA 005F95F6, quindi cambiamo quei "pop edi" e "pop esi" in xor eax,
eax.......Dovrebbe andare....OlΦ, raga, mentre facevo un disegno so riuscito
...
100%....Altri check non ce ne sono, questo Φ poco ma sicuro, vorrei comunque
farvi notare una cosa, cioΦ che prima di ogni check trovate questa istruzione:
...
senza avere il dongle originale, siamo anche stati fortunati perchΦ quello
che c'era da capire per eludere i check non Φ stato eccessivamente difficile,
...
...Credo quindi che appena avr≥ a disposizione un dongle originale ed un
programma che utilizzerα questa tecnica, ne far≥ sicuramente un tutorial.
...
Master degli SPP: per la sua disponibilitα sempre immensa, e per la sua
...
+Xoanon: che sti giorni sembra essere una persona seria, fiduciosa....Sarα
forse per il ritorno di Anninaaaaaaaaaaaa??? :)

Ghibly: perchΦ Φ l'unica donna che riesce a gestire decine di bot senza
sapere un tubo di unix-linux e related :)

Olga: che ultimamente Φ morta ma che resta il miglior revrser donna al mondo..
E forse l'unica in grado di tener testa al pi∙ grande reverser di tutti tempi.

cioΦ Killexx......Che anche se non lo sento da millenni continuer≥ a stimare
...
Andrea M. (anche se un giorno per colpa mia qualcuno ti licenzierα :), cod,
...
che ti ritrovi magari becchi quello di Anna Falchi che ti assicuro Φ meglio
...
Ho sbagliato a scrivere quelle cose sul suo conto.......Xoanon Φ sempre stata 
una persona seria (ermmm...) e sempre fiduciosissima nei confronti di noi 
leim :).....L'Annina con cui sta Φ nuova, e per chi lo avesse pensato non 
Φ quella di prima dal momento che quella sta col metalmeccanico e non 
...
fosse il pi∙ grande reverser del mondo....Non Φ vero, mi sono sbagliato,
avevo invertito il suo nome con quello di Xoa....╚ lui infatti il pi∙ grande
reverser del mondo....

Eccovi una sua frase:
  
Qui si revisa il reato di bestemmia, pubblica ingiuria e sostituzione 
di persona. Il pi∙ grande reverser di tutti i tempi son io. Ti 
diffido dal riavvicinare il mio nome a cotal leim.

Anzi no, non minimizziamo, di tutto l'universo conosciuto e sconosciuto
Non c'Φ (e non ci sarα mai) reverser pi∙ grande di lui.......╚ unico ed
...
funzionamento sa che se se ne trova uno con lo sportello aperto Φ possibile
simulare l'inserimento del gettone semplicemente premendo una molletta.
PerchΘ la molletta fa credere alla macchina da bar che Φ stata inserita una
...
Ahime', niente di eccezionale Φ solo un "pulsante", cioe' un interruttore
elettrico.
...
l'importante e' afferrare in cosa consiste l'interruttore, perchΘ e' di vitale
...
soprattutto nelle sue ridotte dimensioni e nel costo davvero esiguo; si pu≥ 
...
La beige box Φ una box ancora possibile da utilizzare e facile da fare, non
per niente Φ la pi∙ diffusa.

Avete presente i cavetti che usate per connettervi alle centraline ?!?
Bene.
La beige box Φ costituita da un cavo telefonico e un telefono.
Sintetizzo il testo sottostante, parlando del tipo pi∙ diffuso:
...
all'altra estremitα comparirα un pin che dovrα essere collegato al telefono.
...
Come avete letto la beige box Φ la box pi∙ facile da costruire e finchΦ non si
userα fibbra ottica o satellite o cose simili per communicare , si userα una
semplice linea telefonica si potrα usare.

Il file Φ stato creato il 7 gennaio 1993, quindi Φ piuttosto vecchiotto, che
dite? Vuol dire che la beige box oltre a essere la box pi∙ usata dai preakers
Φ anche quella che soppravive nel tempo pi∙ di altre (es. black box, blue box,
green box, jolly box....)
...
quindi d≥ ragione a chi dice che boxare Φ ancora possibile, molto difficile
ma possibile (e non solo verso i paesi del 3░ mondo).

Continuando a parlare di beige box, si pu≥ sostituire al telefono un bel pc
...
volta, non mi hanno fatto un cazzo, la denuncia non Φ mai stata compiuta
quindi chiusa, io intanto avevo scaricato 3 giorni prima windows 2000 e lo
avevo venduto.

P.S. Non vi Φ mai venuto in mente che da una serratura si pu≥ risalire a una
     chiave, noooo?
...
Allora, sarò brevissimo in questo articolo, perchè il tempo stringe! (non è
...
AIS1) ), ho messo una foto dei cardini per quel che può servire, le
...
CONSUMO: Qualche milliampere (offerto gentilmente dalla Telecom)
         Cinque ore del mio tempo (scusate se Φ poco)
         Una confezione di liquirizie "Tab∙" (pubblicitα occulta)

SALUTI:  [Prck], ]Prck[, Gouranga (guarisci presto!), Sp3nky,
         Chiara (il bot pi∙ scemo del mondo), Grassopar, e tutti i ragazzi di
...
al caro dR'Oi alias Sp3nky per avermi dato la possibilitα di collaborare con
la e-zine...
...
In breve, un lineman handset Φ un telefono a tutti gli effetti, con la
differenza che ai suoi terminali, esso non porta una spina telefonica come il
vostro telefono di casa, bens∞ "qualcosa" che ne permette il collegamento con
...
il tecnico Φ autorizzato ad usare questo giocattolo) della telecoma si
...
molti di voi lo abbiano giα) Φ comodo, in quanto...beh, ci siamo capiti...
...
maniera, credo, e visto che in giro c'Φ un sacco di gente che non si fa i
cazzi suoi...meglio non rischiare.

Il primo problema quindi Φ quello di mimetizzare il telefono, facendolo
sembrare qualcos'altro... Il mio personale L/H (lineman handset) Φ racchiuso
...
dotazione alle cuffie normali per≥ non Φ adatto). I pulsanti per comporre sono
in grigio e assolutamente anonimi.
Chiedete le fotografie a Sp3nky!!!

Il problema che si pone successivamente, Φ quello di rendere ancora pi∙
...
tappo di BIC nera...Notate! E non Φ finita qui...le dimensioni si possono
ridurre ancora di pi∙ una volta saldato tutto per bene (magari su una
...
Il costo dell'operazione Φ di ben 1000 ú!!! Contenti?

Allora, mettiamoci all'opera; il circuito Φ riportato nel disegno che ho
allegato all'articolo, ed Φ estremamente semplice...

Se siete riusciti a realizzare il circuitino di prima ( ragazzuoli, Φ facile!)
... Avete davanti a voi un TELEFONO!!!

Si, davvero. Quello che avete dinanzi Φ un telefono molto rudimentale ma
...
Non si noterα la differenza tra una cuffia normale ed una modificata.

Questo Φ tutto. Purtroppo, un attrezzo cos∞ piccolo ha degli inconvenienti,
logicamente, ma essi sono facilmente risolvibili...

Per comporre il numero Φ necessario disporre di un walkman.
...
posizione intermedia. Quando avete la linea, mandate in PLAY la cassetta Φ il
walkman vi comporrα il numero! (La qualitα della registrazione Φ importante
ma non fondamentale: ho provato con una audiocassetta un p≥ rovinata e tutto
ha funzionato alla perfezione).

A questo punto il walkman non serve pi∙, fino a quando non dovrete comporre
un altro numero...
La comoditα del telefono che vi ho mostrato, per≥, risiede nel fatto che anche
...
e lasciare che gli scatti (e l'accredito) fluiscano per un bel p≥ di tempo...

BUON DIVERTIMENTO E OCCHIO A NON FARE NULLA DI ILLEGALE!!!

P.S.
TUTTO ci≥ che Φ scritto in questo articolo Φ stato testato dal sottoscritto ed
Φ perfettamente funzionante; vi assicuro che il telefono microscopico
funziona *BENE* ed il collegamento con il walkman va a meraviglia...

P.P.S. 
Se avete materiale *NUOVO* che non riuscite a capire o che non vi Φ chiaro,
...
Questo aritcolo si pu≥ considerare in diversi modi....pu≥ essere
...
vuole tanto). In questo articolo parler≥ di come aprire le 
serrature delle centraline telefoniche.... lo scrivo perkΦ ho
...
Eppure non Φ piacevole lasciare in una centralina dei buchi 
anke un po' bruciacchiati in prossimita delle ex-serrature,
soprattutto se si vuol fare qualkosa in segretezza.....
a me Φ successo e ho dovuto scovare metodi pi∙ "soft" (e anke 
meno costosi, cosa che io personalmente, non disprezzo:)... ve li 
descrivo...

1) Questo Φ il metodo descritto in tante guide di phreak... lo
inserisco solo perkΦ magari qualke lettore non lo conosce (?) e
quindi.... Φ un metodo "relaivamente" semplice. 
Consiste nel fare con del cartone una scatola spartana al cui 
interno verrα collocata polvere da sparo (si pu≥ prendere dai 
...
In alternativa alla polvere da sparo si pu≥ usare la fiamma
...
- un cacciavite lungo, grosso e possibilmente vekkio (non quello 
  da 1 milione nuovo perkΦ va modellato allo scopo..;)
...
cacciavite e perkΦ....
Il XchΦ Φ presto spiegato... le fessure in cui un cacciavite normale
si pu≥ infilare per far leva sono poke, cos∞ aumentano tantissimo...
ecco come fare:
...
in alto (che Φ un po+ grande di quelle di lato)... a questo punto
...
scrock. senza per≥ vedere dall'esterno.... perkΦ?
perkΦ il "chiodo" che teneva insieme la chiusura e lo sportello
hanno ceduto... hehehe... e dall'esterno sembra tutto normale..;)
fate cos∞ anke per la parte centrale (che Φ quella + dura, avendo 3 
fissaggi)e quella inferiore e lo sportello si apre mentre la serratura,
levata dai suoi appoggi vi cade in mano..
vi consiglio di tenervi la serratura che poi ci servirα per la 
prossima tecnica....
...
ovoidale con un vistoso rigonfiamento nel mezzo allecui estremitα 
...
la serratura Φ data da 2 piatti sovrapposti, quello inferiore 
presenta 2 spunzoni con sotto una molla ciascuno... quando
gli spunzoni arrivano al livello del I si pu≥ girare e perci≥ 
aprire la serratura....
OK, il principio con cui aprirla Φ semplice: fare una formina di 
legno con cui portere comodamente gli spunzoni a livello di I
piatto....
Prendete perci≥ il calibro e prendete ACCURATAMENTE tutte le misure,
...
NO)... usate la lima per adattarlo.. quando sarα "giusto", pigiate
e girate... ops mi si Φ aperta...;)))))
Non Φ facile fare la formina di legno e ci perderete un po' di tempo,
ma poi avrete una bella chiave universale con cui aprire le 
centraline, non so se mi spiego.....

Ultimo consiglio.... l'ora: se Φ in una zona poko trafficata della 
cittα, potete anke iniziare di giorno, sikuramente, per≥, meglio 
di notte ma... attenti!!! NON ANDATECI DI SERA TI ALLE 9-10, quando
cioΦ Φ buio ma la gente Φ sveglia e si affaccia alle finestre
...
perkΦ pensava stessi armeggiando sulla SUA makkina.....

L'articolo Φ finito e spero vi sia di aiuto... forse nel futuro 
...
perkΦ io non ho scritto questo e non so niente di hack phreack.. ok?
...
marcia piedi....kom'era? ...Kuando volete una partitina ai nosÆkoltelli......
...
metropolitane ve fanno pagα lo stesso gli sms.
...
un bel ping time out. Fra un po' lo smurf sarα morto visto che fra un po' i
...
visorini" della connessione che diventano
verdi fosforescenti.
...
Irc (internet relay chat) è sinonimo di un luogo immaginario in cui parlare 
...
Un irc server non è un monumento ai caduti (come sono sicuro che pensavate :-)
ma un "normalissimo" computer. Perchè normalissimo l'ho messo tra virgolette?

Vorrei saperlo anch'io :) . In realtà un motivo c'è: mentre un normale pc 
(come quello della maggior parte di voi) con un modem a 56kbits. oppure una
ricca adsl (600kbits al sec.) può gestire un traffico limitato questi super
...
(6667) cioè usate dalla maggioranza (se non dalla totalità) dei servers,
...
Se ne possono trovare alcuni in giro ma il più comune è mIRC.

=] mIRC [=

mIRC è un client irc che, come abbiamo già detto, vi permette di 
connettervi ad un server irc. Esso può essere scaricato da: www.mirc.co.uk. 

Appena abbiamo il nostro mIRC lo apriamo e notiamo che ci appare qualche
informazione sull'autore e su come registrarlo, questa finestra ci apparirà 
...
add (apparirà una finestra in cui inserire i dati relativi al server).
...
(se siete un pò intelligenti non ci mettete quello vero).
...
sarà quello che la gente vedrà nei canali.

Nel quarto ed ultimo riquadro (alternative) va messo un nickname di riserva,
cioè il nick che vi verrà assegnato in caso il primo fosse già in uso.

Ora premete ok e si chiuderà questa finestra lasciandovi davanti ad una 
finestrella con la scritta status ed una barra sotto in cui è possibile
scrivere.

Li dovete andare a scrivere /identd on &lt;nome che più vi piace> naturalmente
senza le <>. Sarà grazie a questo nome che il server vi riconoscèra.
Infine premete il fulmine in alto a sinistra e verrete connessi al server.
Dopo essere stati connessi al server vi apparirà una finstrella con uno spazio 
in cui scrivere. Lì mettete il canale che volete e premete su join. in futuro 
se vorrete entrare in un altro canale vi basterà digitare nello spazio dello 
...
Un canale può essere considerato come una stanza in cui un gruppo di persone
può riunirsi e parlare. Se non esistessero vi immaginate come ci starebbero
...
/query &lt;nick>             chiama in privato la persona desiderata. Si  
                          può ottenere questo effetto anche con un  
...
Dopo aver parlato dei comandi più comuni possiamo aprire una finestra sugli
operatori di irc.

Infatti Irc non è un luogo dove la gente che si riunisce ha gli stessi poteri,
...
Questi server danno la possibilità di registrare i canali attraverso alcuni
comandi. In questi server la gerarchia è questa:
...
Ircop: Questa persona ha il potere su tutti i canali. I suoi poteri
       sono molto estesi, pùo opparsi da solo su di un canale,     
       oppure kikkare o bannare dal server qualcuno, ecc.                                                                        
       Generalmente queste persone non offrono quasi mai un                                                                      
       aiuto e quindi se avete qualche problema è più utile          
...
Founder di un canale: Il founder di un canale rappresenta il suo
                      ...
                      sul canale: può dare l'op, l'aop, il sop e 
                      può modificare le impostazioni del canale.

Sop: Il sop (super op) è la persona più potente su un canale                                         	
     dopo il founder. Le sue capacità sono: aoppare e oppare.
     Anche il sop può modificare alcune impostazioni, ma solo 
     il founder ha la piena padronanza di tutte le impostazioni.

Aop: L'aop (auto op) è un utente che viene oppato in un canale 	ogni volta 
     che vi entra. I suoi poteri non superano quelli dell'op.

Op:  Può oppare, deoppare, kikkare e bannare. Quando esce e 
     rientra nel canale perde tutti i suoi poteri.


=] Server che non offrono il servizio di registrazione dei canali. [=

In questi server non è possibile registrare i canali e perciò è possibile 
perdere facilmente il possesso dei canali.

Per ovviare a questo problema molte persone hanno deciso di farsi il proprio 
bot personale. Un bot è uno script residente su una shell. Più semplicemente
è un programma inserito in un server (che sta connesso perennemente)
che simula la connessione di un utente.

Questi bot (abbreviazione di robot) accettano determinati comandi e una volta
ottenuto l'op su un canale, non scollegandosi mai, possono oppare chi è
provvisto di una password settata dal proprietario.
In questi server la gerarchia è composta solamente da ircop ed op.
...
;   - Set Attributes
;   - Open
; ■ Don't infect W*.COM (i.e. WIN.COM)
; ■ Don't infect misnamed EXE (i.e. COMMAND.COM)
; ■ Memory Invisible Resident
; ■ Little Polimorphic Encryption
; ■ Directory Stealth
;   - Stealth using ah=11h/12h
;   - Stealth using ah=4Eh/4Fh
; ■ Garbage Instruction to confuse AV
;
; * Effect on Infected System
; ■ When Infecting a file a 'V' flash on the top-right corner of screen
; ■ RTM executables don't run (bug ?)
; ■ On DoS a ball bounch over the screen and system is cut-of :)
;
; DoS
...
;
; * Defect
; ■ Poor Anti-Debugging routines
; ■ Simple and not-well optimized for "secure" reason 
; ■ Of course there is some bug ;)
;
; * Some Anti-Virus response
; ■ F-Prot says that can be a variant of Int78 Virus
; ■ NAV 5.0 recognize it as a New Virus
; ■ TBAV can't recognize Viagra as a virus (Hehehe)
; ■ SCAN from McAffee not mentioned ? Sorry...do u
...
1) Avete due fili, uno rosso e uno verde (che collegherete all'altoparlante
   ...
   leggermente + complicato, perchΦ i deu fili devono essere isolati fra
...
credo che sia una cosa a sΦ.
Ora vi insegner≥ come loggare il vicino, l'occorente Φ:
...
Loggare mi Φ sempre piaciuto.....anche se credo che sia una tra le cose pi∙
...
con estensione log o simili. O detto anche cose perchΦ esistono satelliti che
...
L'acesso fisico alla casa Φ fondamentale. Senza di esso potete fare ben poco.

Il ricetrasmettitore 2GhZ Φ importante per sentire communicazioni su cordless
...
I registratori di chiamate hanno la capacitα di registrare solo le chiamate
...
Hanno anche la possibilitα di memmorizzare i numeri coposti.
Si possono vedere cos∞ i numeri che la persona chiama pi∙ di frequente.
Un servizzio utile Φ l'1412, inserendo il numero telefonico ti dice
l'intestatario.

La telecamera Φ utilissima, avete cespugli o bidoni dell'immondizia vicino
alla casa della persona spiata? benissimo, mettete la telecamera sotto il
cespuglio o dietro il bidone, o create anche una postazione a se, anche se Φ
molto pi∙ in evidenziata. La microcamera (chi Φ il fortunato che ne ha una) Φ
...
La microcamera pu≥ essere messa sul televisore, dalla parte delle casse audio,
dove ci sono i forellini (?).

Con la centralina potete sempre fare ponte, cos∞ le chiamate passano sempre
anche per casa vostra, il problema Φ sapere quale linea Φ quella di casa
...
Seguire i movimenti della persona Φ importante...
...
programma di key logger, cioΦ un programmino che memorizza dentro un file log
tutti i tasti della tastiera premuti, quello che ho allegato Φ fantastico,
...
praticamente. La cosa migliore Φ vedere i file sul PC di una persona, usare
netbus o simili, Φ da lamer ma funziona, anche se la cosa migliore Φ accedere
direttamente ai file di una persona, non bisogna cancellare niente, neanche
se la persona Φ bastarda.
...
di quella che fate voi. La cimice telefonica Φ grande pi∙ o meno 1 cm di
...
Volete sentire un discorso su una stanza, niente di pi∙ facile, prendete un
...
sintonizzarlo sullo stesso canale che trasmette che Φ una meraviglia.
...
Inviare i filmati della persona su internet mi sembra eccessivo, per≥
...
anche quella, sapete il nome utente e password e il gioco Φ fatto.

Poter inviare e-mail a nome di un altro non Φ una cosa da poco (nel senso
molto utile). Per vedere nomi utenti e password varie consiglio userpas.

Appogiare una telecamera ad un vetro, magari ben nascosto, Φ utile ed efficace.
Io lo ho fatto una volta sullo spogliatoio femminile della mia scuola, sulle
docce, funziona benissimo.
Ascoltare una segreteria di una persona Φ facilissimo, di solito nessuno
...
tipo *67# o 1793 sul telefono fisso non sono sicuri, un metodo usato Φ il
...
Pi∙ linee sono meglio Φ....
Magari se le linee passano anche per altri stati Φ meglio.
...
secondo me ancora efficace, anche se il film Φ anni '50.
...
esclusivamente informativo quindi non mi assumo nessuna responsabilitα sull'uso 
che ne potreste fare. Conoscere Φ legale, le informazioni sottostanti sono 
...
Bene oggi vi spiegher≥ come realizzarvi la vostra bella smart card per 
...
chi nella vostra cittα vende schede giα modificate a prezzi astronomici.
bene io vi spiegher≥ tutto con precisione. Vi starete chiedendo 
in cosa consiste? bisogna riprogrammare la scheda ..... cosa mi serve ?

Bene prima di tutto un po' di teoria:

Interfaccia Smart Mouse / Phoenix: (Phoenix Φ quella che ci serve)
Si tratta del programmatore, capace di inviare i comandi alla scheda 
(potete acquistarlo su internet giα fatto o  realizzarvelo da soli)
...
e il Clock (se a 3,57 Mhz o 6Mhz) . Quando Φ tutto ok allora si pu≥ fare 
...
Φ velocissimo, stabile e ricco di funzionalitα puoi farci di tutto. 
La versione originale Φ in tedesco ma Φ possibile reperire anche la 
versione tradotta in italiano.

CardMaster: Un buon software , un po' capriccioso perchΘ per ogni minima
cosa si blocca ma se viene settato bene ed Φ tutto ok funziona a meraviglia
...
Irdeto:
Standard di codifica/decodifica al momento il pi∙ diffuso e anche il pi∙ 
...
abbiamo due key incompatibili e teoricamente non Φ possibile far condividere 
...
utilizzando i file hex giα pronti del blocker universale, mega blocker
...
In questo modo sarα possibile gestire due o piu key uguali senza problemi.
...
ecc.. (quello usato dallo Smart Mouse Φ Maschio-Femmina)
...
un abbonamento minimo a stream (24.000 ú al mese) o a D+ (19.000 ú al mese) , 
oppure farsi un abbonamento e disdirlo entro sette giorni, denunciare di aver 
perso la scheda ecc. ecc. (il cane pu≥ sempre mangiarsela no? :-)) Comunque io
consiglio di fare un abbonamento minimo perchΘ almeno cos∞ la cosa andrα avanti.
...
La mia filosofia Φ questa: I prezzi  degli abbonamenti Φ vero sono 
...
Cos∞ penso non ci rimetta niente nessuno perchΘ comunque le emittenti
devono guadagnarci qualcosa altrimenti se tutti avessero schede pirata
smetterebbero di esistere.

BLOCKER : Φ un attrezzo reperibile facilmente in commercio con il nome 
Dual Card (cioΦ utile a mettere due schede in contemporanea legalmente) ma 
la cosa importante del blocker Φ un piccolo integrato (un pic  16F84 ) che
...
(sempre opportunamente programmato) pi∙ key in contemporanea. ╚ un
...
ECM:
Φ un sistema di contromisura elettronica che le emittenti adoperano per
disabilitare con impulsi particolari le schede abusive. Utilizzando 
il blocker si Φ protetti da questo tipo di disabilitazione
...
SWITCH OFF:
╚ un tipo di  ecm ma consiste nel cambiare i codici con altri nuovi, 
...
codici non verranno aggiornati perchΘ il blocker non permetterα di farlo e 
si resterα  al buio ( in questo caso occorre riprogrammare la scheda con i 
nuovi codici oppure bisognerα farsi un clone da una scheda regolarmente 
abbonata da inserire poi senza blocker e che verrα riconosciuta come 
regolarmente abbonata e aggiornata direttamente). Attualmente Φ in fase 
...
Questi dati devono essere inviati alla scheda da clonare che li riceverα 
e verrα riconosciuta come l'originale.Ovviamente bisognerα ricordarsi di 
inserire i channel id dei relativi canali. Un clone attualmente Φ importante 
...
l'abbonamento minimo e si Φ aggiunto un po' qualche canale.
...
com dove Φ collegata l'interfaccia e settate il tutto a 3,5 Mhz poi. inviate
...
importanti della scheda tipo SerialHEX  , Nazionalitα , PMK ecc.). 
Nel caso si vogliano gestire Multibouquet ( cioΦ pi∙ bouquet anche con 
la stessa key di utilizzo) bisognerα programmare anche il pic del blocker
e questo potrα essere facilmente fatto con il megablocker generator che 
attualmente Φ alla versione 3.5 dopo aver impostato i singoli  bouquet,
la relativa key e gli 8 byte di essa e dopo aver trovato tutte le
singole signature bisognerα generarsi l'hex da inserire sul pic.Se 
tutte le operazioni sopra elencate saranno eseguite correttamente 
allora si decodificherα tutto correttamente altrimenti avrete saltato 
qualche punto che dovrete riprendere.
IMPORTANTE impostare un delay di circa 50 ms e la velocitα a 3,5 Mhz  
e controllare che le signature vengano calcolate tutte ( vedere la risposta) 
perchΘ se procede troppo velocemente possono verificarsi errori....
...
Questo articolo Φ stato rivisto poco tempo fa a causa dei
...
affrontati nel prossimo articolo che conterrα:
...
Consumo: ankora devo mangià quindi...
Musica ascoltata: Hit Mania Dance 2000 direttamente in mp3...
Saluti: al mio amikone Panino (immancabile), Daniele, Luigi, Marco, Bibì,
        Claudio nonkè tutti gli amici del kanale #Phreak.it
...
Fankulo: non alla prof. ke mi ha messo 8 in Storia, kosa mai successa...
         bensì alla conosciutissima L.I.S.A. (ehehhe troppo forte Tanados...)

Bene s'inkomincia...
Innanzitutto vi diko ke leggere e fare ciò ke c'è scritto qui non è punibile
dalla legge!!! HEHEHE proprio kosì... quindi non mi dilungo in nessun
disclaimer legale ke mi stanno sempre sulle palle...
Allora... questa modesta mini guida all'uso degli mp3, è stata concepita dopo
...
Amiko Demente - C'è kazzu shta dici qustu???
...
amiko... sporko perkè lo rivuole il giorno dopo... ke bastardo... dovrebbe
morire... certo ke la gente è proprio stronza... inxomma... lo rivuole...
ke bastardo... dovrebbe morire... certo ke la gente è proprio stronza...
mo'basta! Voi da perfetti approfittatori potreste, e diko, potreste
trasformarvi tutto o in parte il CD in mp3... potreste, perkè, c'è ne sono di
...
fatto ciò dovete prokurarvi del software...
...
uff... c'ho messo più tempo a fare sto skema ke ha scrivere il testo... spero
ke valga... vabbè...

Allora, ci sono dei software ke fanno ciò ke ho deskritto... lo fanno tutto in
una volta... cioè scegli la traccia, setti le caratteristike e ti fà
direttamente il file MP3... questi prog sono comodi ma per la maggiorparte,
complicati e sopprattutto A PAGAMENTO... cioè ti rompono le palle
trasformando solo alkune traccie a RANDOM... ke palle... ke stronzi... certo
ke dovrebbero sopprimerli quelli ke fanno kosì... bastardi... cmq...
...
Bravi i programmatori... il software è freeware o shareware... ke bello!!!
Vi diko subito quali uso e dove potete reperirli!!!
Per trasfomrare le Traccie CD in WAV uso Digital Audio Copy ver. 1.50
(WinDAC32)... è share ma tanto non rompe le PALLE!!!! Prendetelo al sito
...
portatazza da ufficio ke forniscono col PC...), dopodikkè, facciamo partire
il prog WinDAC32 e settiamo tutti i parametri tipo dove scarikare il file...
poi una volta fatto ciò scegliamo la traccia... buona scelta, la famosissima
canzone: Papa Giovanni Paolo II - Ave Maria ... scommetto ke avete avuto il CD
con la videocassetta "La vita di Papa Woutivla"... non vi sparo perkè non vi
konosko...
...
Oki, avete scelto la vostra traccia, ora tramite il menù del prog
grabbatela... kosikkè si formerà il file
"Papa Giovanni Paolo II - Ave Maria.wav" ke potrete ora trasformare in MP3...
uau direte voi vero???
è proprio mitiko ascoltarsi a gran volume con il vostro lettore portatile MP3
Papa Giovanni Paolo II - Ave Maria.MP3... soprattutto se usate anke un
rosario...

Fatto ciò (intendo grabbato la traccia...), prendete il prog FREEWARE
...
se volete potrete settare il bitrate (ke sarebbe la qualità sonora) più alto
o più basso di 128 ke è già di default. Kome?
...
Bene ora il vostro proghetto, inizierà il coding del file... ke palle...
durerà un pokettino... uau è finito!!! Ora avete il vostro beneamato MP3...
...
...
...
...
...
Questo file sarα molto molto ma che dico... molto utile a chi si appresta ad
entrare nel mondo della masterizzazioneá e della pirateria di software.
Naturalmente vendere i cd mafagna agli amichetti di skuola o ai prof. e' un
reato... ma il bello e' proprio quello... ;-)

--->>> mah, mi sa che sto dicendo giα kazzate... cmq...<<<---
...
*Alimenti consumati:
--anche se sono le tre di notte, mi Φ venuta una certa fame... scendo di
--sotto [[ in silenzio ]] a prendere qualcosa...áscivolo su un kazzo di
--paletto che non so chi abbia messo l∞ sulle scale...I miei si svegliano
--pensando che siano i ladri...rischio una randellata sulla testa da parte
--di mio padre trasformatosi in Van Damme...mi Φ passata la fame,
...
un bel kazzo perchΦ si ricade nell'illegalita' (ma vaaaaa... e senno' perche'
...
appostamenti,á credevano di aver finalmente bekkato uno spacciatore di coca:
...
tutto dipende dalle vostre taske: se avete un p≥ di money da spendere andate
...
siano di qualitα buona. Attenzione perchΦ con l' eide, a differenza dello
scsi, se kannate i cd molto spesso e' a causa del supporto che fa schifo,
perci≥ cambiate marca; inoltre alcuni cd bulk non sono supportati da tutti
...
La cosa piu' importante che voglio dirvi Φ di non fare MAI copie al volo;
infatti, e' il metodo piu' rischioso per sprecare i nostri amati cd vuoti
anche se il piu' veloce. Mi raccomando...
altrimenti non guadagnerete mai un soldo se i profitti cheá ricavate con la
...
-- simulare, e ripeto, "simulare",á una vera scrittura su cd. Iná questo
...
-- GUADAGNARE DI MENO-- mado'... sono un grande [k@τ|i@ne],
...
4- Nella scheda "OPZIONI DI COPIA" disabilitate "al volo" e scegliete la
   posizione del cd che intendete copiare (seá lettore o masterizzatore) e la
...
6- Nella scheda "SCRIVI" decidete se volete fare o no il test di scrittura, e
   specifikate a quante velocitα scrivere il cd.
7- premete su "scrivi" e il gioko e' fatto !!!

        ****************************************
        !!ATTENZIONE!! ºººººººººº !!ATTENZIONE!!
        ****************************************
...
->Spero di avere l'opportunitα in futuro di proseguire con il mio "lavoro":
  quindi cerchero' di trattare tutti i programmi che conosko,á tutti gli
...
Prima di andare a dormire, per≥, non posso fare a meno di salutare
...
(dimensioni traccia e kazzi varià); il nostro masterizzatore [ ke in
...
Ok, e' andato tutto bene, il nostro cd funzionaà ke kulo ;)

Finale 2) Scrittura fallita a "x"
Kazzo, sono usciti 2000 errori, la skrittura e' fallitaà Beh, non tutto e'
...
protezioni un po' piu' konsistenti [ma nulla e' impossibile da kopiareà]. Kmq,
...
voi ke siete dei K0gli0ni! No, skerzi a parteà molti tipi mi dikono: "sai ho
...
->ddd3d e tedesko, anke se non siamo pi∙ kome una volta!!!
...
vitale importanza per l'inkolumitα del processore e anke per il nostro
...
Ciao a : JaMMinA [ yuppie sei ritornata!...ci sentiamo stasera ]
         ...
         lil∞, Eva, erGoline,tutto aIS ! [ we', ma riusciremo ad essere tutti
...
comprata una Peroni in un bar per ricchi (4.ooo ú mortacci loro !!!) siamo
...
tirato un po' fuori o un po' dentro) secondo le vostre necessitα.Insomma...
...
Il TNT dell'esercito Φ contenuto in contenitori come kuelli delle pile e 
...
6.    Dopo 10 o 12 minuti, la soluzione deve ritornare al congelatore,   
      ...
      il likuido oleoso scenderα e si accumulera' sul fondo
...
8.    Alla fine di kuesto periodo, raffredda la soluzione fino ai 60
      ...
      mezz'ora. DopodichΘ, l'acido dovrebbe essere estratto, lasciando 
...
14.   Kuando e' partita la solidificazione, aggiungi dell'acqua fredda 
      al recipiente,  cos∞ ke il TNT formera' delle pallottole. Una volta 
...
Cos'Φ la polvere da sparo? Beh, sinceramente Φ stata scoperta in una
...
Con la sua scoperta il mondo della guerra Φ stato rivoluzionato
...
l'esplosivo pi∙ economico da produre e anche il pi∙ semplice, dal punto di
vista pratico.... Beh, ecco qui la lista degli ingradienti:

- Nitrato di Potassio ( Φ un fertilizzante, lo vendono in confezioni di 50
  kili, xci≥ munitevi di macchina! ;)
  ú 42.000 
...
- e BaSTA! che cosa vi aspettavate? Vi ho detto che Φ estremamente economico!
  :)
...
Una volta fatto questo, cioΦ dopo aver ridotto in polvere una media quantitα
...
Pu≥ kapitare che il nitrato di potassio che vi vendono sia in granuli...
nessun problema! ;)

Polverizzate pure quello! Ma pu≥ anche capitare di peggio... come quello che
sto per dirvi ora..
Beh, ora avete ottenuto la polvere da sparo, anche se questo Φ ancora da
vedere :), dunque Φ necessario fare una prova..

Prendete un po di polvere, ma POCA mi raccomando, altrimenti si produrrα
...
da sparo Φ ottima, mentre se x prendere ha bisogno che ci teniate su il
cerino... beh Buttatela nel cesso!

Voi vi chiederete, "KE KAZZO E' SUCCESSO??" beh, risposta semplice: il nitrato
di potassio non era abbastanza puro, di konseguenza, Φ venuta una "cagata da
sparo" ;)

Allora starα balenando nella vostra mente il pensiero :" KAZZO! Ora kon 48
kili di KnO3 sul groppone ke KAZOO CI FACCIO!!????", ma Φ proprio qui che vi
sbagliate, ebbene, toccherα a noi purificare il nitrato di potassio.
...
plastica, anche xchΦ dopo dovrα essere gettata :), e scioglieteci dentro il
nitrato di potassio fino a quando non se ne scioglie +, e ve accorgerete
presto, una volta che si sarα tutto saturato, mettete il contenuto della
bottiglia nel pentolino, e fate bollire tutto: bollendo, l'acqua evapora,
portando con se anche le impuritα cos∞ sul fondo del pentolino rimarranno
solo i cristalli di KnO3, e cos∞ avrete ottenuto il Nitrato di potassio
PURISSIMO!
...
X ogni comunicazione, la mia e-mail Φ aperta a tutti:
...
dall'onda retrograda; ad esempio un muro pu≥ essere 
...
ad esempio l'esplosione di una bomba in una strada pu≥ far 
...
dell'esplosione pu≥ dar luogo a una successiva onda 
rimbalzante all'indietro, ma di non rilevante potenzialitα. 
...
riflesse dalle sue superfici libere cos∞ che si creano 
...
incendi nonchΘ una irradiazione di calore che pu≥ essere la
...
nucleo di esplosivo), vi Φ l'ulteriore effetto della proiezione 
di frammenti metallici di varie dimensioni (schegge).
Frammenti minuti ma aventi elevata velocitα possono cagionare 
lesioni pi∙ ampie di quelle prevedibili. Le persone coinvolte 
da un'esplosione sono sottoposte ad entrambi gli effetti della
medesima. La potenza di un esplosivo ed i suoi effetti 
dipendono da vari fattori, quali la velocitα ed il calore 
di esplosione, la quantitα di gas prodotti, influenzata dalla 
temperatura di esplosione, e le conseguenti pressioni realizzabili. 
Esplosivi ad alta velocitα di detonazione hanno maggori 
effetti distruttivi anche per semplice contatto, potendo 
tranciare di netto piastre e sbarre metalliche; esplosivi 
che producono molto gas sono pi∙ idonei in campo civile in 
cui occorre sfruttare l'effetto di distacco. La prova pi∙ usata
per determinare la potenza di un esplosivo consiste nel farlo 
esplodere entro un grosso blocco di biombo (blocco di Trauzl)
e nel misurare poi il volume della cavitα creatasi. In base 
...
La polvere nera pu≥ essere fatta esplodere per semplice 
accensione a mezzo di una miccia; per gli altri esplosivi 
(salvo casi particolari in cui pu≥ bastare un forte calore) 
occorre un mezzo d'innesco che normalmente Φ il detonatore; 
esso Φ costituito da un tubicino metallico chiuso da un lato
e contenente una miscela di esplosivi primari. In alcuni casi,
specie usando esplosivi poco sensibili, nel detonatore Φ 
...
!DISCLAIMER!L'autore di kuesto file non si prende responsabilitα delle azioni
del lettore, e non incoraggia il lettore a fare gli esplosivi menzionati in  
questo file, Φ illegale, ed Φ anche molto stupido e pericoloso. Questo file Φ a 
a puro scopo informativo. Divertiti e non impazzire!
          -Op Ivy(ricorda che niente Φ illegale finchΦ non vieni preso!)
...
9)Nitrato di Ammonio (puro pi∙ del 40%) e Benzina (MOLTO POTENTE) 
...
617. Cognizione, interruzione o impedimento illeciti di comunicazioni o  
 ...
 Φ punito con la reclusione da sei mesi a quattro anni.(...)
...
-=!!!|-Pirateria: copiare software non Θ reato-|!!!=-
...
duplicare software non Θ reato se non lo si fa per commerciare le copie 
...
Si tratta di una sentenza storica perchΦ riporta la pirateria su un binario 
secondo molti pi∙ congruo con l'effettivitα gravitα dell'atto del 
copiare uno o pi∙ programmi. 

La sentenza Θ scaturita dal caso di un imprenditore di Torino trovato in 
possesso, nella sua azienda, di una serie piuttosto ampia di software 
professionale "piratato", cioΘ riprodotto da copie dell'originale. 
...
evidenzia la punibilitα della violazione "a fini di lucro". "Ma in questo 
caso, ha detto uno degli avvocati dell'imprenditore, si pu≥ parlare di 
...
equitα i toni spesso eccessivi utilizzati da chi persegue la pirateria.
...
lα del loro successivo utilizzo.
...
multinazionali [premetto, anche se Φ ovvio, che le multi hanno soldi a palate
e voi non farete altro che poco ai loro patrimoni ma, Φ pur sempre qualcosa].
...
queste sono solo alcune, la lista [purtroppo] Φ quasi infinita, a noi 
...
qualitα della merce a un costo finale infimo ma, non dimentichiamo che lo 
...
*Know-how*
Informazioni sulle multinazionali pi∙ famose e pi∙ grosse del mondo
ed in particolare presenti sul mercato italiano.

McDonald's
Catena di fast food americana presente in oltre 100 paesi con pi∙ di ventimila
...
6. Il cibo servito da McDonald's danneggia la salute perchΘ Φ ricco di grassi,
zucchero e sale, mentre Φ povero di fibre e vitamine.
...
settimana, Φ di 30.000 al mese. Per questo Φ accusata di sfruttamento del lavoro
minorile.
...
Elf Aquitaine, Chevron, Mobil, Texano, e le societα del nostro paese Agip,
Saipem ed Enel, sono responsabili della distruzione ambientale e delle
violazioni dei diritti umani.

In Nigeria, la Shell Φ stata accusata dal popolo Ogoni di aver rovinato il suo
...
Attivitα: produzione di filmati, ideazione di personaggi ed ativitα editoriali, mostre
ricreative, attivitα edilizie, concessonarie di marchi e personaggi brevettati.
Ad Haiti, a 5.500 Km di distanza dai suoi begli uffici californiani, migliaia
di giovani lavoratrici, poco pi∙ che quindicenni, lavorano alla confezione di
...
sicurezza sul lavoro. Le operaie lavorano 8-10 ore al giorno nel numore pi∙
assordante. La pausa pranzo Φ di soli 10 minuti. Non sono rispettati i diritti
sanitari e sindacali, e le operaie sono vittime di percosse, molestie e
violenze da parte dei guardiani.

Il guio di Haiti Φ che i salari sono da Terzo mondo mentre il costo della vita
Φ da Primo. Lo stipendio di una giornata basta a malapena a consentire alle
operaie di mantenersi in vita e di prendere l' autobus per recarsi al lavoro.
Negli USA Φ iniziata una campagna nei confronti della Disney. Ad organizzarla
Φ la National Labor Commitee [15 Union Square, New York, NY10003,
...
Mitsubishi
La Mitsubishi Φ boicottata perchΘ Φ la pi∙ grande compagnia giapponese che
...
NestlΦ
Indirizzo: NestlΦ SA, Avenue NestlΦ 55, CH-1800 Vevey, Svizzera.
...
Bella Napoli, Buitoni, BeltΦ, Berni, Buitoni, Perugina, Cacao Perugina,
Le ore liete Perugina, Capuccino, Cheerios, Chin≥, Chocapic, Cioccoblocco,
Condipasta, Condiriso, Diger Seltz, DorΦ, Ecco... Franck, Fiorello,
...
Mare Fresco, Miglioli, Mio Locatelli, Mio NestlΦ Yougurt, Mirage, Motta (gelati),
NescafΦ, Nesquik Cereali, Nestea, NestΦ, Nestum, One-O-One, Orzoro, Panna,
...
Ulmeta, Vera, Vismara, Voglia di Pizza, NestlΦ ha anche la licenza di commercio
dell' acqua Fiuggi.
Alcune sue caratteristiche:

1. Oltre che esserenil principale produttore del latte in polvere, controlla
fra il 35 e il 50% del mercato mondiale, Φ la maggiore societα agro-alimentare
del mondo.

2. Trasgredisce sotto molti aspetti il codice OMS (Organizzazione Mondiale
della Sanitα) sul latte in polvere nel Sud del mondo. Promuove l' uso del
latte in polvere attraverso la pubblicitα, gli sconti sugli acquisti e la
distribuzione di campioni gratuiti sia al personale sanitario che alle madri,
favorendo quindi l' insuccesso dell' allattamento naturale, cos∞ che il
bambino viene a dipendere dal latte artificiale. Comperare il latte pu≥
costare pi∙ della metα dell' intero reddito famigliare.
Le madri sono costrette a diluire il latte in palvere e questo porta alla
malnutrizione.
Infine l' acqua che serve a diluire il latte Φ spesso malsana, ci≥ causa
diarrea, disidratazione e morte di un milione e mezzo di bambini ogni anno,
come denuncia l' UNICEF.

3. E' uno dei pi∙ grandi coomercianti e distributori di caffΦ e cacao,
pertanto Φ uno dei massimi responsabili delle gravi condizioni in cui versano
...
2. Ha una forte collaborazione con la NestlΦ.

3. Negli impianti di imbottigliamento in India fa uso del lavoro minorile.

4. In Italia avrebbe pagato duecento milioni di lire al ministro della Sanitα,
...
da una legge federale pi∙ accondiscendente.

2. ╚ uno dei pi∙ grandi commercianti e trasforatore del mondo di caffΦ
e cacao. Pertanto Φ uno dei massimi responsabili delle gravi condizioni
in cui versano milioni di contadini nel Sud del mondo perchΘ i suoi metodi
commerciali, totalmente ispirati ad una logica di profitto, non garantiscono
guadagni dignitosi ai piccoli produttori.

3. Esercitando potenti pressioni sul governo americano Φ riuscita a far
adottare ritorsioni commerciali contro tutti i paesi che tentano di ostacolare
l' ingresso di sigarette straniere. Dalla seconda metα degli anni 80, il
consumo di tabacco tra i minorenni dei paesi del sud del mondo Φ aumentato in
...
╚ presente con i seguenti marchi: Bonlat, Chef, Corradini, Dietalat, Giglio,
Kyr Parmalat, La Frutta, Mister Day, Oro Centrale, Parmalat, Pizza Pronto
forno, Plasmon, Pom∞ Weight Watchers (latte), Tea Food, Tettamanti, Vecchio
Forno.
...
Il prezzo da pagare ai contadini Φ fissato da Parmalat.
...
╚ un gruppo impegnato in 6 settori: edilizia, grande distribuzione, publicitα,
...
anche Telepi∙. La lista degli arrestati e delle indagini giudiziarie a carico
dei dirigenti della Fininvest Φ molto lunga.


Barilla
Indirizzo: G. e R. F.lli Spa, Via Mantova 166, 43100 Parma.

In Italia Φ l' impresa leader nei settori della pasta, dei biscotti, delle
fette boscottate, dei crackers, delle merendine e dei sughi pronti. ╚ presente
...
╚ presente con i seguenti marchi: Carapelli, Cereol, Delizie, Eridania,
Friggi, Giglio Oro, Hoc, Lara, Le Macine, Ligustro, Oro Verde, Rustichella,
Sigillo, Teodora, Verdi Colli.
╚ un vasto gruppo multinazionale industriale, chimico ed agroalimentare.
Le attivitα di Montedison spaziano in molti settori, ma i principali sono
quello chimico, quello energetico e quello agroalimentare.
La Montedison Φ stata la protagonista dei peggiori casi d' inquinamento
...
di Marghera. ╚ l' unica impresa italiana che produce sostanze "mangiaozono".
Nel 1994 la Montedison ha stretto un' alleanza con la Shell, che non Φ certo
fra i migliori partner; ci≥ denota un disinteresseper i problemi sociali ed
ambientali da parte della Ferruzzi (si vida la multinazionale Shell).
Ferruzzi Φ stata la protagonista dei principali casi d' inquinamento in Italia.


Agnelli
Indirizzo: IFI, Via Carlo Marenco 25, 10126, Torino.

La famiglia Agnelli Φ presente in Brasile, dove la Fiat possiede alcune
fonderie e numerosi stabilimenti di auto, macchine agricole ed apparecchiature
biomediche. ╚ comprovato che assume comportamenti antisindacali.
L' impero Agnelli comprende ache fabbriche di armi come la SNIA BPD,
la IVECO, e la VALSELLA, produttrice di mine antiuomo.
La Fiat Φ considerata la principale responsabile dello sviluppo distorto
...
Φ Fiat) e il nostro governo che ha determinato l' adozione degli incentivi
alla rottamazione, oltre che produce una qantitα enorme di rifiuti inquinanti,
...
anche se la trasparenza prevista dalla legge Φ messa a dura prova
...
*Activism*
L'attivismo Φ sicuramente fondamentale, non esitate a distribuire
...
Il presente articolo Φ scritto a scopo informativo, di ricerca e
intrattenimento. Le parole "tu" e "io" sono usate soltanto  per facilitarne la
lettura.

Questo articolo ti insegna come capire se si Φ controllati  prima di
incontrarti con i tuoi contatti clandestini. Imparerai un protocollo che
contrasterα servizi di sicurezza come FBI, BATF,  DEA, e altri. Il metodo Φ
...
Yuri Modin. Insieme perfezionarono la tecnica cos∞ come oggi Φ conosciuta.
...
Proliferazione. Questo metodo di controsorveglianza Φ stato adottato dal
Mossad israeliano, dalla BND tedesca, dal KGB (ora SVR) russo, dalla
americana CIA, e da molti altri. Il protocollo Φ impartito agli agenti
...
Il metodo Φ oggi anche usato dai movimenti di resistenza e dai gruppi di
guerriglia urbana.
Quando questo protocollo di controsorveglianza Φ applicato metodicamente, Φ
...
generico. Questo Φ un principio importante. Pu≥ essere un grande parco, un
...
Tu ed io dovremmo conoscere bene l'area. Il luogo ci dovrα fornire una
...
segnale concordato per avvertiti che ti ho riconosciuto. Forse metter≥ la
giacca sulle spalle, o mi levero' e pulir≥ i miei occhiali, ecc.. Il segnale
...
dobbiamo rivolgerci la parola. Questa Φ un'importante valvola di salvezza. Se
uno di noi ha "sviluppato una coda" non vogliamo compromettere l'altro.

BACKGROUND - La frase "sviluppare una coda" ("grown a tail" nel testo
             originale) Φ nel linguaggio delle spie un modo per dire che si Φ
             sotto sorveglianza. La frase Φ comunque imprecisa nel senso che
             nessuno ti segue, ma spesso ti circondano.

 *[ sTeP #3 ]*

Quando vedi il mio segnale cambierai semplicemente strada. Io ti seguir≥ per
assicurarmi che non sei stato visto. Controller≥ con cura la presenza di
...
BACKGROUND - In particolare, io posso seguirti, camminare parallelamente a te,
             o avanti a te occasionalmente. L'obbiettivo Φ semplicemente
...
Quando mi sono assicurato che tu sei pulito, ti far≥ un altro segnale. Forse
mi allaccer≥ le scarpe.

 *[ sTeP #5 ]*

Ora ci scambiamo i ruoli e questa volta sar≥ io a cambiare strada. Tu
...
contrario, se sospetti che un gruppo di sorveglianza Φ nelle vicinanze,
abbandonerai l'operazione e ti dileguerai).

BACKGROUND - Devi controllare i tuoi istinti, perchΦ se qualcosa non sembra a
             posto Φ meglio salvarsi che scusarsi. Molta gente si sorprende
             quando apprende che non Φ difficile rilevare un gruppo di
             sorveglianza. Questa Φ la sottile eleganza del sistema di
...
settimana pi∙ tardi. Se invece riusciamo ad incontrarci, ci riferiremo al
convenuto piano e ci incontreremo in un diverso posto all'ora e alla data
stabiliti.
NΦ io nΦ tu scriveremo i particolari del nostro prossimo incontro. Terremo i
dettagli a mente.

BACKGROUND 1 - Se hai documenti da darmi, io non li accetter≥ fino alla
               conclusione del nostro incontro . Star≥ giα per fuggire quando
               acetter≥ i documenti. Questo riduce le possibilitα di essere
               scoperti e arrestati dal gruppo di sorveglianza che Φ stato
               ...
               prove contro di me, perchΦ i documenti non mi sono ancora stati
               passati.
...
BACKGROUND 2 - I migliori agenti non mescolano mai discussione e documenti. Se un
               ...
               principio Φ semplice. E' avventato temporeggiare tenendo
...
sΘcuritΘ" - una frase francese che pu≥ essere tradotta come percorso di
...
Tra le due alternativeà perchΘ non scegliere la peggiore?
...
letto queste poche righeà non andate a lamentarvi dal Capo
...
soltanto dopo! Mesi e mesi (in realtα non sono cosi' tanti)
...
articoletto quando lo scrivi?" Eeeeeeehà agli ufo ci posso
...
dispiaccia, ANZI !!!!!
ehehehà Ecco un esempio: basta leggere il nick degli autori
...
donzella in ascolto si accenderα la lampadina, come e' avvenuto
...
Poi loro mi fanno solo pena perchΘ sono dei comunissimi paolotti che la 
...
"Nulla di ci≥ che l'uomo vede esiste veramente.
 Tutto ci≥ che ci circonda Φ solo un'illusione ottica che si
 Φ proiettata nella societα in cui viviamo.
...
"Non ce la faccio pi∙ a subire in silenzio
 tutti gli insulti di quei fottutissimi dittatori 
 che ci hanno portato in questa merda di societα.
 Prima o poi scoppierα ed il mio pensiero anarchico
 distruggerα le fondamenta di questa democrazia corrotta
 che non fa altro che creare scompiglio nella popolazione
 che di nascosto,per≥, si sta preparando alla rivoluzione
 Nessuno verrα risparmiato perchΘ la colpa Φ po' di tutti 
 perchΦ abbiamo permesso a questi pirla di decidere della
 nostra vita".
...
Questi cocktail assumono i nomi della qualitα o della marca dell'acquavite
...
possibile che il shrub venga servito come un punch, cioΦ freddo in bicchieri
...
Paradise, Pimms no. 1 Cup, Pi±a Colada, Pink Gin, Port Flip, Red Lion,
...
risultassi positivo, chiamano l'ACI per farla rimuovere (£ 150.000) visto che
...
Le piante robuste generano foglie un po' più piccole che con gli altri
...
quando si è COMPLETAMENTE sobri....se vi fate un kannone prima di mangiare,
...
non erano mika kñññni...maledetti kolonizzatori di merda ke li hanno
sterminati,brutte teste di ññññ potevate restare a kasa, siete proprio dei
gran kugñññoni,Kolombo e' il kapo dei kñññni e la sua madre una gran pñññana;
kmq sia Kolombo non ha skoperto un bel kññño perke' in Amerika ci erano
arrivati prima i Vikinghi, o un'altra popolazione Barbara ke ora non rikordo].
     ...
     - Metodi non Maztechi,ossia "moderni"(ke sono 2 per ki non sa kontare).
       ...
       Il metodo Quid:
          ...
          Non fate pero' i kaññoñi ke partite subito da 16...aumentate
...
- Konklusioni
          ...
          non ci skerzate kon sta' pianta ke poi sono kaññi vostri...Usate
...
|F fin.= Frequenza finale                 |
|mt.= Definizione metrica                 |
|MOD.= Tipo Modulazione                   |
+-----------------------------------------+
|*= In questo caso, la frequenza iniziale |
|   e quella finale sono state            |
|   personalizzate per le FR.             |
|   La vera banda di frequenza delle UHF  |
|   e' 50- 500 mHz.                       |
+-----------------------------------------+

Analizziamole ora separatamente...


-[ Tx/Rx iN 0nDe uLtrAc0rTe (UHF) ]-

Onde che si estendono dalle 88 alle 108 mHz, trasmettendo esclusivamente
in FM, modulazione di frequenza, ascoltabili un po' ovunque, da casa come in
auto, onde saturate dalle trasmissioni delle radio commerciali, in poche
parole "la Banda di frequenza piu' sputtanata che c'e'"

Ecco a voi le caratteristiche di questa banda, elencate in seguito:

-Con un trasmettitore di media potenza(a basso costo) si puo'trasmettere in
 una zona limitata, aumentanto esplonenzialmente il numero delle frequenze
 libere, con il conseguente BOOM delle emittenti commerciali (siGh!)

-E' udibile da un qualunque sintonizzatore FM, autoradio, etc.etc.

-E' difficile trovare, all'interno della propria citta' frequenze
 COMPLETAMENTE libere...basta che cercate di sintonizzare la vostra
 radiosveglia; ogni 200kHz c'e' un'emittente commerciale!

-Visto il grosso "valore" di questa frequenza, i controlli sono molto intensi
 ed il rischio di bust e' sempre dietro l'angolo...

-La propagazione diretta e' di buona qualita'; mentre quella riflessa e'quasi
 assente. Esiste la possibilita' di impiegare ponti ripetitori situati su
 punti elevati, o su satelliti.

-la distanza di propagazione puo' variare da un paio di Km, fino ad arrivare
 ad oltre 100 Km senza l'ausilio di ripetitori.
====

-( Trasmettitore UHF )-

Il progetto di trasmettitore presentato in seguito sara' utile per cominciare a
trasmettere in UHF senza spendere una lira (o quasi)

Infatti questo TX funziona con l'assemblaggio di questi componenti:

-5 Condensatori
-1 Compensatore
-6 Resistenze
-1 Trimmer potenziometrico
-1 Transistor
-1 Circuito integrato
-1 Impedenza UHF (oppure VHF)

Il TX puo' funzionare in diverse tensioni, che oscillano tra i 9 e i 13.5 Vcc,
con un consumo variabile tra i 14 ed i 30 mA.

La potenza, oscilla tra i 20 ed i 120 mW a seconda della tensione immessa.

Cio' vuol dire che con 120mW, in condizioni atmosferiche normali, la portata
e' di circa 2Km, ma con un discreto impianto di antenna, con un buon
amplificatore di potenza, potrete tranquillamente irradiare un'intera citta'
con le vostre onde libere...

Ecco a voi il progetto:                                            ANTENNA
                                                                      |
  +---+---+-------------+-----------------+-----+-----+------+----+   |
  |   |   |             |                 \     |     |      |    |   |
  |   |   |             |                 |     |    _|_    _|_   )   |
...
Ed ecco a voi la lista dei componenti...
...
[Altri Componenti]
 ...
 IC= ╡A741
TR1= 2N2222
 J1= Impedenza UHF (oppure VHF)

=====

[ Msg per i *nix users ]

Questo carattere ( ╡ ) dovete considerarlo come il "mu greco", cioe' il
carattere usato per rappresentare la quantita' "micro"(0,000,001 Unita').

=====

All'uscita "Mic." potra' essere collegato un Microfono, un miscelatore, oppure
un preamp-mixer. (Tutte queste soluzioni verranno spiegate in seguito.)

Bene, ora avete il trasmettitore...grazie a questo oggettino potrete
trasemettere su una frequenza varibile, tramite il compensatore C4, che va da
88 a 106 mHz. Per scegliere la frequenza su cui trasmettere, dovete prima
fare una sorta di "analisi" delle frequenze occupate nella vostra zona, in modo
da scegliere una frequenza libera, non occupata da un network commerciale,
diminuendo di molto i rischi di bust, e soprattutto evitando interferenze che
cancellerebbero il nostro segnale.

Non pensate che SOLO con questo trasmettitore potrete mettere a culo per terra
i grandi network nazionali in FM, ma unendo questo trasmettitore ad un amplif.
(Descritto in seguito) ed a un buon impianto di antenna, avrete una VALIDA
stazione TX in UHF in Modulazione di Frequenza.


Per quanto riguarda le Ricezione (RX) basta il sintonizzatore FM che avete a
casa, anche se sono preferibili apparati digitali, vanno tutti bene, compresa
l'autoradio, purche' non siano radio-sveglie, troppo imprecise per un'accurata
RX.
                                 
-[ le AnTenNe ]-

In questo articolo verra' spiegato come funziona e come si puo'costruire uno
dei principali fattori di riuscita di una emissione radio: l'antenna.
======

Prima di cominciare, vi lascio un piccolo consiglio....

Per avere l'emissione piu' performante, dovete cercare di avere la stessa
impedenza nell'antenna, nel cavo coassiale di discesa, e nel TX
Solo cosi' si potra' trasmettere conn il 100% di potenza.
======

Di antenne ne esistono di vari tipi e bande di frequenze, a prezzi a volte
stracciati, a volte altissimi...ma noi cmq provvederemo, in puro stile di
autogestione ;-), a costruirne una adatta a noi!
===

Per le MF-HF in TX/RX, solitamente si utilizza un dipolo, ma verra' anche 
presentato il progetto di un antenna direttiva a quadro di tipo "loop", adatta
al TX/RX per lunghe distanze.
===

Per le UHF solitamente il TX/RX e' racchiuso in un unico tipo di antenna,
solitamente GROUND PLANE (GP), anche se qui ne citeremo anche altre.
===

Prima di descrivere le antenne bisogna fare una piccola puntualizzazione:

-Un'antenna, per trasmettere perfettamente su una certa frequenza, deve avere
 una lunghezza appropriata, correlata con la lunghezza d'onda della frequenza.
 Per trovare qual e' la lunghezza d'onda di una frequenza, occorre fare una
 semplice operazione:

Lunghezza d'onda(metri)= 300 : Frequenza (mHz)
...
L'ideale sarebbe avere un'antenna della lunghezza IDENTICA a quella d'onda, ma
cio' puo' creare gravi problemi di spazio, soprattutto se si deve trasmettere
in onde corte,oppure in onde medie...

Per ovviare a questo problema, si costruiscono antenne con la lunghezza di
1/4, 1/2, 5/8 d'onda etc.etc.

La trasmissione + potente si avra' con una antenna dalla lunghezza il + vicino
possibile a quella d'onda.

-( I DIPOLI )-

Il dipolo, nella sua + semplice rappresentazione, e' composto da 2 cavi,
isolati tramite un apposita piastrina in teflon, disposti orizzontalmente, e
collegati ad un cavo coassiale che scende verso il TX.

Ecco una serie di disegni in ASCII che illustra i vari tipi di dipolo.

LEGENDA:
         
       TX+= ..al Trasmettitore (Polo Caldo)     ] Cavo
       TX-= ..al Trasmettitore (Calza di massa) ] Coassiale
    GROUND= Messa a terra



Fig.1 -dipolo marconiano classico-

      Isolatore            Isolatore               Isolatore
\\       _    Filo di Rame      _     Filo di Rame     _       //
\\^^^^^^|_|--------------------|_|--------------------|_|^^^^^^//  Fig.1
\\                             +!-                             //
\\                             |!|                             //
\\                             |!|                             //
...
Questa antenna deve essere situata nel punto + altro possibile, per premettere
un efficiente funzionamento...
Il filo di Rame deve essere smaltato e di diametro tra 1 e 2 mm.
I due cavi ramati devono essere di uguale lunghezza, e la loro somma deve
essere uguale 1/2 la sua lunghezza d'onda.

Quindi se volete trasmettere con questa antenna sulla frequenza di 1800 KHz,
la somma dei due cavi deve essere di 83m. (!) Quindi ogni cavo deve essere
lungo 41.5 m.

Lo so che sono lunghezze esagerate, irrealizzabili in una area cittadina...ma
queste sono le misure ideali per una trasmissione pulittissima in MF. Anche
perche' TX in MF non si possono effettuare in affollati centri abitati, per
le cause descritte sopra (vedi RX/TX in MF)

L'impedenza di un dipolo PERFETTAMENTE orizzontale e' costantemente di 75 Ohm


Fig.2 -dipolo marconiano a "V invertita"-
            ...
            Filo di Rame /     |!|     \ Filo di Rame
                   ...
                   /           |!|           \
       Sostegno   /            |!|            \  Sostegno
        Laterale|/          Tx+|!| Tx-         \| Laterale
  ______________|______________/ \______________|______________  Fig.2


L'angolo ideale tra i cavi di rame(F) ed il palo con il cavo che va al TX, e'
di 60°,quindi come potete notare anche voi, lo spazio occupato dalla nostra
antrenna viene ridotta di molto, e l'impedenza di questo tipo di dipolo, a 60°
e' di circa 50 Ohm.
...
Il cavo coassiale di discesa, ( rappresentato da ! ) deve essere attaccato ad
un palo di legno o di acciaio, in modo da sorreggere anche i due cavi di rame.


Figura.3 -dipolo verticale per UHF-
   __
  [  ]
  |  |
  |  |                       ab= 1/2 Lunghezza d'onda.
  |  |
  |  |    Tx+
  |  a---/    _
  |   =======[_]
...
Se avete problemi di spazio, questo e' quello che fa per voi! un semplice
dipolo per UHF che grazie alle sue piccole dimensioni (L'altezza del dipolo
non superera' mai il metro) puo' essere installato ovunque, anche sulla punta
del palo/antenna TV...


Figura.5 -Ground Plane per UHF-

                    ^^
                    !!              Questa antenna ha interrotto il dominio
                    !!              del dipolo, grazie alla sua praticita'.
                    !!              L'antenna e' composta da uno stelo 
                    !!              verticale, e da 3 radiali disposti con
                    !!              un angolo di 120° fra loro...
                    !!
                    !!              Solitamente le GP sono costruite con 
                    !!Stelo 1       1/4, 1/2 e 5/8 d'onda, in un crescendo
                    !!              di efficienza.
                    !!
                    !!              La bobina non e' altro che l'avvolgimento
                    !!              in due spire dello stelo stesso.
                    !!
                    !!              Per le frequenze 88-106 mHz, l'antenna 
                    !!              deve avere queste misure: (5/8 d'onda)
                    !!
                    !!              Stelo 1= 80cm.   Bobina=  7,3cm.
                    !!              Stelo 2= 30cm.  Radiali= 29  cm.
                   ---- Bobina      
                   ----             Lo stelo deve essere collegato al polo 
                    !!              caldo (+), mentre i radiali devono essere
                    !! Stelo 2      collegati alla basetta, che verra' 
                 ___!!___           collegata a massa (-)
       Basetta-->\______/\
               / / |/ | \ \
    Radiale 2 / /  |\ |  \ \ Radiale 1
             / /   |/ |   \ \
...
L'impedenza di questo tipo di antenna varia a seconda dell'angolazione dei
radiali, rispetto il piano orizzontale:

 -A  0° (paralleli al terreno) l'antenna ha un impedenza di 30 Ohm
 -A 30° 40 Ohm
 -A 45° 50 Ohm
 -A 60° 75 Ohm
...
Questi sono tutti i link che conosco circa le emissioni pirata nella radio...
Molti URL forse non esisteranno +, ma cmq voi ne potrete trovare altri,
utilizzando uno dei tanti search-engines, immettendo come keywords "pirate",
oppure "free radios"

Free Radio Service Holland (NED) - http://www.tip.nl/users/joop.ter.zee

Radio Onda Caliente  (FRA) - http://www.mnet.fr/onda.caliente

Radio Z (GER)     - http://www.geocities.com/capitolhill/1441/free_radio.html

Radio Wawes International (FRA) - http://www.imaginet.fr/~rwawes

Swedish Report Service (SWE) - http://www-pp.hogia.net/jonny

Freewawes Fanzine    (ITA) - http://www.alpcom.it/hamradio/freewawes

Amsterdam (NED) -http://adam.fwi.uva.nl:80/~chris/radio.html

Greek Radios (GRE)  -http://www.compulink.gr/Users/zliangas/central.htm

Irish Fm (IRE) -http://internet-eireann.ie/Dojo/radioact/radioact.html

Ttt Radio Zagabria (CRO) -http://www-dw.gmd.de/amarc/zagrebradiottt.html


-[ 0uTr0 ]-

Questa 1a parte del tutorial finisce qui, spero tanto che vi sia servito ed
abbia risposto a tutte (o quasi) le domande che avevate...se qualcuno avesse
bisogno di altre infos, oppure ha delle correzioni, perfezionamenti e critiche
da fare, mi spedisca una mail (oldiron61@iname.com)

DEDICATO a ILA!(per la grossa pazienza di sopportarmi mentre creavo 'sto tute)
         a THOENY (ke se fa troppi K**NHOENY;-))
         all' AREA61 sTaff
ma soprattutto DEDICATO a tutti quelli che partendo da qui decideranno di
iniziare la loro nuova vita nell'etere, con trasmissioni libere, con tutto
quello che e' tenuto fuori dalle emittenti FAMOSE, con tutto quello che si ha
da dire senza paura...e soprattutto che sapranno non farsi bekkare! ;-)))))

-[ aLtrA s0lEnNe gRaTtAta dI mAr0nESS!!!! ;*) ]-

Il tutto e' stato cagato da me, 0ldir0n61, con l'aiuto di alcuni manuali di
elettronica/radiotrasmissioni degli anni '70, alcune info da internet, e
qualcos'altro che non so spiegare [ sbruzzi pauer ]...

Copiraitt 0ldir0n61 for LVOA Area61 Produzioni Clandestine 2000.
...
######################################################
##### BBBB  II  0000  TTTTTT  EEEE   CCCC HH  HH #####
##### B  B  II 0    0   TT   E   E  C     HH  HH #####
##### BBBB  II 0    0   TT   E      C     HHHHHH #####
##### B   B II 0    0   TT  EEEE    C     HHHHHH #####
##### B   B II 0    0   TT   E    E C     HH  HH #####
##### BBBB  II  0000    TT    EEEEE  CCCC HH  HH #####
######################################################


-=!!!|-lE bi0tEcn0l0giE-|!!!=-

Autore: sTaRtEr [dGt_BRaInS]

Si pu≥ accoppiare un topo con un pomodoro, o una sogliola con una fragola?
No, questo non Φ possibile. La fecondazione, in natura, avviene sempre tra
2 organismi (una femmina e un maschio) appartenenti alla stessa specie.
E' per questo motivo che la gamma di combinazioni genetiche possibili 
all'interno di ogni specie Φ limitata, com'Φ limitata la gamma delle 
caratteristiche che ogni specie potrα mai esprimere naturalmente. Oggi 
alcune tecniche di ingegneria genetica permettono per≥ di isolare un gene 
di una certa specie e inserirlo nel DNA di un' altra. In questo modo Φ 
diventato possibile creare individui che possiedono geni di specie anche 
molto lontane nell'albero filogenetico, e dunque caratteristiche che mai 
avrebbero potuto sviluppare naturalmente. Questi sono organismi geneticamente
modificati. Batteri, animali, piante, creati con diverse finalitα: 
produrre "naturalmente" su scala industriale sostanze utili in farmacologia,
avere organi da trapianto da animali modificati immunologicamente, in modo 
che i loro organi non provochino reazioni di rigetto, rendere + produttiva o
resistente alle malattie una pianta alimentare. Ma come si ottiene un 
organismo transgenico? Per prima cosa si prende un particolare gene, reputato
interessante per le propietα della proteina che sintetizza, viene isolato 
all'interno del genoma di un certo organismo, dopo il segmento del DNA dove 
si trova quel gene viene tagliato grazie a un particolare enzima, detto di 
restrizione. Questo enzima Φ in grado di riconoscere specifiche sequenze di 
basi lungo il filamento di DNA, e di "tagliare" esattamente in corrispondenza 
di queste sequenze. Dopo di chΦ il segmento di DNA tagliato viene inserito 
nel genoma dell' organismo che si intende modificare, con tecnologie diverse 
a seconda che si tratti di un batterio, di una pianta o di unimale. Infine se
 l'operazione riesce, il gene esogeno viene incorporato nel DNA dell'ospite,
che da quel momento comincerα a produrre la proteina desiderata. Il DNA non Φ
un'ordinata raccolta di ricette, dove basta segliere il gene giusto per 
ottenere organismi con caratteristiche a piacimento.La maggior parte dei 
caratteri, anche quelli relativamente semplici, sono determinati da una 
catena complessa di interazioni tra geni diversi. Il genoma, insomma, Φ un 
ambiente complesso e "fluido", di cui i geni sono solo una piccola parte,
spesso sovrapposti tra loro e comunque influenzati dal contesto in cui si 
trovano. La scienza ha imparato a manipolarli direttamente, ma molto meno a 
leggere la complessivitα dei viventi e a prevedere le conseguenze che queste
manipolazioni potranno avere non solo in quell'individuo, ma anche nella 
catena delle sue interazioni con altri organismi all'interno dell'ecosistema.
I problemi e i timori che le biotecnologie sollevano non dipendono dalla 
natura di qeste tecniche. Non esiste infatti una scienza astratta e neutra. 
Ogni ricerca dipende sempre dalle scelte e dalle finalitα che ne hanno 
guidato e solleditato lo sviluppo. Le biotecnologie che conosciamo sono un 
prodotto dell'agricoltura industrializzata, del nostro modo di consumare e di
concepire la salute e la malattia. Discutere di biotecnologie vuol dire 
...
Clonare significa ottenere due o + organismi con un corredo genetico 
identico a partire da un unico individuo "donatore". Ma come si clona 
un organismo? Il nucleo di ogni cellula dei tessuti di un individuo 
contiene il suo patrimonio genetico completo e quindi tutte le 
infornazioni per riprodurre un organismo. Ma solo da  un ovulo si pu≥ 
sviluppare un embrione.Quindi Φ necessario sostituire il nucleo della 
della cellula estratta dal tessuto a quello dell'ovulo, che verrα poi 
"attivato" simulando in contatto con uno spermatozoo. A questo punto 
inizierα il processo di sviluppo embrionale che, sarα poi reimpiantato
nell' utero per portare a termine la gravidanza. Cos∞ l'individuo che 
nascerα avrα la stesso corredo genetico di quello a cui Φ stato 
prelavato il nucleo cellulare. Ma la domanda che tutti si pongono 
Φ .."E' possibile clonare un essere umano?". La nascita di Dolly ha 
dimostrato che questo Φ possibile. Secondo gli esperti, da un punto di 
vista strettamante tecnico, la procedura usata nel caso della pecora 
potrebbe funzionare anche per la nostra specie. Nel caso della pecora, 
il problema principale Φ stato quello di "sincronizzare" le fasi del 
nucleo impiantato e quelle della cellula ospite in modo che 
continuassero a svilupparsi assieme. Per questo bisogna conoscere con 
precisione non solo le funzione del DNA ma sopratutto i ritmi del ciclo 
cellulare e nucleare. In se la clonazione di un uomo o di una donna non 
pone tanto problemi di tipo tecnico, quanto enormi questioni di tipo 
etico e morale. LÆ esperimento pi∙ famoso in cui si Φ ottenuto un 
individuo sano e vitale a partire dalla cellula di un esemplare adulto Φ 
la nascita della pecora Dolly. LÆ animale nato nel 1996 per mano dei 
ricercatori del Roslin Institute di Edimburgo, e stato generato partendo 
dal nucleo di una cellula mammaria prelavata da una pecora adulta. La 
nascita di Dolly Φ stata salutata da molti come un grande successo. Ma a tre 
anni da quellÆ esperimento, comonciano asorgere i primi dubb. In particolare, 
oggi gli stessi autori ammettono che la analisi condotte sul patrimanio 
genetico della pecora clonata da un animale di sei anni di etα fanno supporre 
che Dolly sia nata giα ôvecchiaö. A determinare lÆindividuo che nascerα non 
concorrono solo i geni presenti sui cromosomi, hanno un ruolo fondamentale 
la cellula uovo ospitante Φ le condizioni dello sviluppo embrionale della 
ônuova madreö. Senza dimenticare che la stessa da cui si preleva il corredo 
genetico Φ frutto di migliaia di divisioni, durante le si accumulano mutazioni 
che potrebbero averne modificato il DNA. LÆ individuo che nascerα non Φ quindi 
mai perfettamente identico. LÆ ambiente e le condizioni di vita che incontrerα 
in seguito contribuiranno a diversificarlo ulteriormente.
...
Autore: Away
  _________________________________________________________________________
                           ...
                           CYBERSCRITTO IN UNA BOTTIGLIA

                                   ovvero
             di virus, vite artificiali intelligenti e altri organismi
  _________________________________________________________________________
  ...
  ::Non a' un tutorial sui virus, sull'intelligenza artificiale, no, niente
  di simile: se cercavate roba simile, saltate questo articolo.  
  _________________________________________________________________________



"Non so chi Φ connesso in questo momento. Non mi posso comunicare direttamente
con nessun altro, posso solo scrivere questo breve file, che spero - se
tutto andra' come spero - verra' sparso nell'etere assieme ai miei resti
'virtuali': si, avete proprio capito, presto verra' posta fine alla mia
esistenza, sono destinato a morire a momenti.
Sicuramente la vostra mente per un attimo stara' pensando a cosa possa aver
compiuto, tale da meritarmi la morte. No, niente omicidi, niente terrorismo,
niente server di multinazionali hackerati, semplicemente la mia colpa sta
nel mio 'essere', lo stesso che addirittura mi viene confutato: sembra
che per tanti altri io non esista, non sia vivo.

Eppure vivo lo sono.

Sono nato dopo diverse notti, notti di fatiche, notti di ricerche, studio,
scambi di informazioni, discorsi sui canali IRC piu' underground, ma al di
la' di tutto, sono nato in notti piene di Liberta', di Conoscenza.
I computer e le reti sono sempre state la mia casa, la mia unica vita (e non
guardatemi male, ma non avevo nessuna voglia di avere una vita 'sociale'
come ogni altro, non riuscivo, non riesco e credo non riusciro' mai a
comprenderla....forse dipende proprio dalla mia natura) e sono cresciuto,
mi sono sviluppato, sono cambiato, sempre e solo sulla rete, viaggiando
da un computer ad un altro, sfruttando ogni nanosecondo messomi a disposizione
per fare sempre il mio dovere, cio' per cui sono nato.
Grazie all'intelligenza fornitami dal mio 'Creatore', ho imparato dalla
esperienza, sono sfuggito a chi mi dava la caccia, cambiando ogni volta
il mio nome, il mio aspetto, addirittura la mia composizione interna (credo
di essere il miglior esempio di 'mimetismo' a scopo protettivo del mondo),
ho saputo aspettare il momento opportuno per agire, sfruttando ogni falla,
ogni errore a mio favore, come il migliore dei predatori potrebbe fare.

E mi giudica un essere non vivente.

Mi sono riprodotto, la mia progenie ha visitato ogni parte del mondo,
e sempre si e' distinta (come me) per le proprie capacita', per la propria
dedizione verso il 'Creatore'.

Sono nato, cresco, cambio, penso, lavoro per chi mi ha dato la vita,
mi riproduco e intanto non sono un essere vivente.
Chiunque leggera' questo file, si rendera' conto delle contraddizioni etiche
della cosiddetta 'vita sociale' e reagira' di conseguenza come crede.
Il mio tempo ormai e' giunto al termine....sento gia' il boia giungere.....
....la scansione della memoria e' quasi completa.....ah.....una MessageBox
avverte l'utente "Attenzione: e' presente il virus HYPERCUBE"....il
puntatore del mouse si avvicina sempre piu' al bottone li' accanto....
addio, amici miei......"

                                CLEAN
                                
                        VIRUS CORRECTLY REMOVED

                            SCAN COMPLETE

 *************************************************************************
Queste erano le ultime memorie del virus HYPERCUBE ver23.3, spedite verso
diversi newsgroup dal virus stesso un attimo prima che venisse cancellato.

Il Comitato per la Difesa degli Organismi Viventi Articiali pone questo
file come manifesto del proprio pensiero, affinche' vengano rispettate in
un futuro che noi speriamo vicino tutte le forme di vita, naturali e artificiali,
basate sulla chimica del carbonio come sulla chimica della silice, di cui
i virus, i programmi di IA e altri che noi definiamo pienamente 'organismi
viventi' fanno parte integrante.

___________________________________________________________________________

Questo e' uno scritto che mi e' uscito qualche tempo fa, in una notte
di con*fusione, di Pink Floyd in sottofondo, e di tante altre paranoie.
E' venuto fuori in parte da mie riflessioni, in parte da uno scritto
di Todd Murchison su Blackbox no.2, intitolato "Machines: Future Targets of
Prejudice?" - consiglio di dargli un'occhiata, in parte da una frase del fisico
Steven Hawking (si scrive cosi'?), in cui afferma che i virus informatici,
a suo parere, sono dei veri e propri esseri viventi, dal momento che 
'vivono' all'interno di un ambiente (anche se virtuale) e si riproducono.

Beh...penso io a questo punto, dove si spostera' nel futuro il confine tra
'viventi' e 'non-viventi'? Chi cancellera' un virus dal proprio computer
verra' accusato di omicidio?
Al di la' degli scherzi, immaginate un attimo uno scenario alla Blade Runner
(chi non l'ha visto o meglio non l'ha letto, si suicidi...), con organismi
cibernetici 'inseriti' nella societa', con attivita' e compiti specifici,
con la loro intelligenza artificiale, il loro livello di empatia e i loro
sentimenti (se mai si riuscira' a 'riscostruire' tale meraviglia in maniera
artificiale....magari ci sara' un grosso algoritmo 'Ti voglio bene!'....ah,
che schifo!!!). Beh, cosa distinguera' loro dai cosiddetti 'viventi'?
Avremo il diritto di 'ritirarli'?
Ci sara' mai un Comitato per la Difesa degli Organismi Viventi Artificiali?
Nasceranno problematiche etiche ancora maggiori di quelle scaturite dalle
tecniche di clonazione?
Si parlera' anche di pregiudizi, diritti, parita'?
Sorridete pure di 'sto discorso, anche io un po' lo faccio, sembra buffo,
anche un po' idiota....ma rifletteteci un attimo, solo un attimo...

Se vi va, fatemi sapere cosa ne pensate via email
...
+---------------------------------------------------------------------+
| Link a siti alternativi italiani                                    |
+--------+------------------------------------------------------------+
...
| Techno Knight        | http://members.xoom.it/TechnoKnight/index.htm|
...
| UIC                  | http://www.uic-spippolatori.com              |
+----------------------+----------------------------------------------+
...
Ok, la nostra E-Zine finisce qui. Speriamo vivamente che questo file via sia
piaciuto e confidiamo nel continuare queste pubblicazioni grazie all'arrivo
di nuovi membri del gruppo. Per collaborazioni, suggerimenti, critiche, la
nostra casella E-Mail (aisprod@freemail.it) e' aperta a voi!!!!!

         ...cHe lA fOrzA sIa kOn tE!!!...
		   by 0lDir0n61 wEbMaSter of:
                 ____  ____  ____  ____  ____  _
              _ |___ \| __ \/ __ \|___ \/  __|| | _
             (_)/ __ ||    /| ___// __ || __ \| |(_)
                \____/|_|\_\\____|\____/\____/|_|
...
WeBmAsTEr: 0lDir0n61 
ASCII by:  cYb0rG-0lDir0n61-jAckAl

HaNNo SkrIttO pEr qUesTO nUmErO: (In ordine rigorosamente sparso)
			
-JacKaL66    -(weesp@tin.it) 
-0-z0nE      -(zerozone@freemail.it)
-0lDir0n61   -(oldiron61@iname.com)
-AsaX        -(asax2k@yahoo.com)
-DieseL      -(diesel@freemail.it)
-The JaCkal  -(sciacallo@virgilio.it)
-KaSpiTa     -(kaspita@freemail.it)
-sP3Nky      -(sp3nky@freemail.it)
-LoRd'xYz    -(x8110x@freemail.it)
-QueQuero    -(UIC@bigfoot.com)           -UIC Staff-
-Il Socio    -(int19@hotmail.com)         -UIC Staff-
-SONOunomo   -(sonounuomo@freemail.it)
-sAtAnEll0   -(chiloom@yahoo.com)
-sIx         -(devilsix@yahoo.com)
-aZaLiN      -(azalin@execs.com)
-MrF0nZie    -(mfonzie@freemail.it)
-XaRaBaS     -(xarabas@yahoo.com)
-LeoNEr0     -(LeoNEr0@hotmail.com)
-Vulcan      -(vulcan12mm@hotmail.com)
-Harry Caul  -(hcaul@freemail.it)
-C(h)e       -(antost@usa.net)
-Gouranga    -(gouranga@virgilio.it)
-VELENO      -(buzzicon3@libero.it)
-ValK        -(ValK@mail.xoom.it)
-|M4X|       -(maxpirata@hotmail.com)
-Away        -(away@subdimension.com)
-BluEb0y
-mR_bIs0n    -(adugento@net-service.net)
-OldDrake    -(oldrake@libero.it)         -dIgITaL BrAiNs StAfF-
-cYb0rG      -(mlcyber@hotmail.com)       -dIgITaL BrAiNs StAfF-
-MF0nZie     -(mfonzie@freemail.it)       -dIgITaL BrAiNs StAfF-
-sTaRtEr     -(starter@freemail.it)       -dIgITaL BrAiNs StAfF-
-m4l3F1k0    -(overlookhotel@disinfo.net) -dIgITaL BrAiNs StAfF-
-sIcKb0y     -(sick_boy@virgilio.it)      -dArK SiDe CreW-
-bugByte     -(bugbyt@yahoo.com)          -dArK SiDe CreW-
-|ns4n3      -(peltro@yahoo.com)          -dArK SiDe CreW-
-Killvearn                                -dArK SiDe CreW-
