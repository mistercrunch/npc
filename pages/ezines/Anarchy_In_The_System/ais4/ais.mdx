...
e' a rischio l'hackmeeting 2001!!!! Il file e' "freaknet.txt"   Grazie.
                              ...
                              .╧555.
               .┴┴┴┴┴555555.  ╬╬╬╬55   .ºººººººººº555.
               A555' '555555  'III5'   SS5555'   'SS55
               Aα55   A55555           S$S555     S$S5
               αAα5   αA5555 ∞5555555  $S$s55.
                     .ααα555 ∞'555555  '$$$$$$$$5555.       
               .αaαaαaαaα░55   ∞55555          's55555
...
un minimo di consegne, pur mantenendo l'aperiodicità di questa zine.
...
La nostra filosofia si basa sullÆinformazione libera per tutti, purtroppo 
mi sono accorto che ognuno Φ un poÆ disperso per i "cazzi" suoi, nel senso 
...
Salve a tutti, eccoci di nuovo quì.
...
TCP/IP. Mi Φ venuto in mente per due motivi 1 serve a me per 
...
in modo particolare per ci≥ che riguarda internet e il suo mondo.
...
"non sapete che cazzo Φ una WAN?" una rete geografica ragazzi.
Avete presente una normale rete? bhe! la stessa cosa solo che anzichΦ
avere tutti i Pc nello stesso posto li si ha disposti sul territorio.
Che s≥ un nodo a Roma uno a palermo ed uno a Venezia. Collegati frα 
loro di solit≥ tramite router (che cosΦ un router?) CAZZO SCARICATE 
...
Stiamo parlando del periodo che vα trα la fine deglia anni 60 e 
...
TCP/IP come abbiamo potuto vedere si Φ evoluto e ad oggi viene 
utilizzato come protocollo di rete aziendale pi∙ completo ed accettato
...
Φ anche il protocollo standard per INTERNET. Insomma avrete capito
TCP/IP Φ un protocollo di comunicazione. "ne conoscete di altri tipi?"
Un altro vantaggio derivato da questo protocollo Φ la possibilitα di 
...
questo articolo avrα su il SO del vecchi zio Bill (BASTARDO!!!)
Dicevamo, TCP/IP Φ inoltre un protocollo scalabile racchiuso in una 
...
interface" utilizzata per le applicazioni Windows. Questa interfaccia 
permette di sviluppare applicazioni Client/Server che all'occorrenza 
possono utilizzare anche protocolli di rete diversi che s≥ NWLINK per
le reti Novell.
Arriviamo ora ad una cosa che mi fα incazzare. voi direte ma con 
...
IAB: internet architecture board Φ il consulente tecnico della 
     ISOC ed Φ a sua volta responsabile della IETF
...
comment" sono i documenti ufficiali nei quali reperire informazioni
sul nostro protocollo. Qualsiasi membro della internet society pu≥
...
Limited use = Non Φ obbligatoria e CMQ riservata ad usi particolari.

Not recommended = Non obbligatoria anzi sconsigliata.
---------------------------------------------------------------------
Questi documenti non muoiono qu∞ ma sono continuo oggetto di studio e
sviluppo, verifiche ed accettazione. Queste fasi vengono identificate
come livelli di maturitα vediamo quali.
...
Internet standard = Questo mi sembra ovvio Φ orami assodato che questo
                    Φ uno standard e come tale non viene messo in 
                    discussione in quanto Φ chiaro che oramai la sua
                    diffusione ha portato un implementazione
                    vantaggiosa per l'intera comunitα internet.
--------------------------------------------------------------------
...
una di queste Φ il telnet attraverso il quale ci si pu≥ collegare ed
...
Mano mano che avrete la bontα di seguirmi in questo mio farneticare 
impareremo ad usarle. Coraggio s≥ che Φ noioso questo articolo ma Φ
...
PING = Verifica che TCP/IP sia configurato correttamente, ed inoltre
       ...
       altro host. (Per quelli di AIS che stanno ridendo, lo s≥ che 
                    serve anche ad altro ma questo art Φ sul TCP OK!)
...
IPCONFIG = Controlla una configurazione TCP/IP compresi gli indirizzi
           ...
           prendeteli cos∞ prossimamente vedremo a che servono ed il 
          loro utilizzo.
...
HOSTNAME = Vi dα come ritorno il nome host del PC locale o remoto
...
ARP = Vi permette di visualizzare una cache degli indirizzi IP 
      risolti in locale in indirizza MAC "Media Access control
--------------------------------------------------------------------
Per questa volta abbiamo finito, non preoccupatevi non Φ cos∞ 
difficile come sembra s≥ che avrete ora molta confusione in testa e
non avrete capito un gran chΦ ma piano piano le cose che avrete 
letto saranno pi∙ chiare. Calma e sangue freddo andando avanti tutto
risulterα chiaro. Se ne avete voglia leggetevi gli allegati. Non
...
craccare" un algoritmo di 1024 bit, potrebbero ridursi drasticamente se 
...
massa" non perdono occasione per intraprendere delle vere e proprie
...
Tratter≥ due argomenti I LOG e CELARE DEI FILEZ.
...
EVENT LOG 
Un possibile modo di "fare le pulizie" Φ utilizzando l'Event Viewer, ma NON
FATE "CAZZATE" ,perchΦ se lo modificate comparira nel event log che Φ avvenuta
...
l'auditing sarα attivato se invece pensa : "a che mi serve, mi rallenta solo
il sistema" potete intuire il suo quoziente intellettivo.....
Questo registra (in base a come Φ impostato) delle nostre azioni, Φ this
isn't good. :)) con auditpol  (viene dal Resource kit)  Φ possibile
...
Voi dite : beh si fa attirib +h [pizza] per≥ se l'opzione "Mostra tutti i
file Φ attivata" non serve a niente... 
...
SE nel sistema Φ installato il NTFS (NeTwork File System) possiamo usare il
...
sua dimensione !! :)
Per questo un file stram Φ difficile da trovare. Il file nascosto puo essere
...
*^2 = cp: Φ l'utilitα POSIX presente nel Resource Kit di WIn.NT
...
linguaggio con programmazione ad oggetti infatti non 
...
Cos∞ facendo appena l'utente fara' il login sul server il vostro programma
...
cos∞ facendo il vostro file verra' eseguito solo una volta dopo di che verra'
cancellato e .bashrc tornera' ad essere quello originale (cos∞ cancelliamo 
...
di hacking... ma Φ una miniguida su come installare e far funzionare 
...
Ora... se non ce li avete giα installati di default dovete scaricarvi
...
girare Q2 in modalitα GL, (io per es con una Voodoo2 non ne ho
...
questo Φ il mio primo tutorial, xci≥ non venirmi a rompere le balle se  non
funzia, xchΦ in questo caso le soluzioni sono 4:
...
INTRO....
-- age of empires 2 Φ u gioco di strategia in real time veramente bello a mio
...
Qualunque cosa io abbia scritto dopo queste linee Φ assolutamente e
totalmente a scopo informativo. Scritto col puro scopo di far CONOSCERE al
lettore ( Φ questo che vi rode ehe stronzi?...). L'autore (io) non si assume
nessuna responsabilitα per l'uso che verrα fatto delle informazioni e delle
pratiche descritte in questo tutorial.

---!!!!Il possesso di questo file Φ comunque del tutto lecito!!!!---
...
# Scaricare il Debugger e riprovare #  ok 1░ protezione anti SICE; avviare
  frogsice e dal suo menu runnare il prog, il frogsice si bloccherα + volte
...
< alunno         > ma xchΦ l'anti sice non ri-appare?
< prof. AnarKya  > perchΦ il programmillo bypassa le protezioni di AOE2
< alunno         > WOW professore lei Φ un grande....
...
Il file Empires2 nella directory del gioco Φ FASULLO, uno specchietto per
...
< alunno         > WOW professore com'Φ colto....    (da 'na pianta) 
< prof. AnarKya  > lo so... lo so...
...
oppure... forse Φ meglio, ne allego una copia a 'sto file (tanto Φ piccolo)

--- aperta parentesi sul C.U.Dilla ---

Il C.U.Dilla Φ un simpatico programmino che riconosce la vera parte  del
...
< prof. AnarKya  > ottima soluz.... hey aspetta, rimetti il cd nella custodia
                   e apri Sice...
< alunno         > hoh professore, lei Φ cos∞ intelligente 
< prof. AnarKya  > lo so.... lo so....

Dicevo.... aprite SoftIce e settate ORA il bpx getdrivetypeA... Il sice si
bloccherα e voi premendo F12 potrete entrare nella routine di UnWrap.exe al
...
un  foglio tutta la  riga del jump) fatto. no, aspetta, + avanti c'Φ un altro
...
tutta la riga del jump di nuovo mi raccomando) steppate ancora un p≥ pi∙
avanti fino alla prossima call, non eseguitela e uscite dal Sice premendo F5
............. WOW ...

E adesso potete fare una campagna o avere accesso a tutte le funzionalitα del
gioco, l'unico buggo Φ che dovete rifare la stessa operazione ogni volta che
...
occorrono...
cos∞     0041F18D:740D JE 0041F19C   deve diventare
...
Conclusione:
Non Φ stato poi tanto difficile crackare il gioco, certo se non fosse stato
...
P.S: msg x Oldiron61 und company...    
     il tute non Φ xfetto... xci≥ al fine di migliorarlo si aspettano
     consigli, suggerimenti, blasfemie e quant'altro pare a VOI... tanto sarα
...
TNX to: Quequero (my cracking teacher anche se lui non lo sa...;-);  Alor;
        ...
        Oldiron61; il mio amico al***s*o (DarKfLightER) e il suo picc∞... non
...
del PDC, poi che possa essere copia pi∙ o meno fedele del primo, che si
possano affidare le gestioni di alcuni servizi all'uno o all'altro mirrorarli
etc..e un altro discorso che non affronteremo qu∞.
...
dominio due PDC. (Spiegatemi COME si fα io non lo so) dovreste fare un mega
backup di dati.
...
Ovviamente Φ possibile anche la procedura inversa da BDC a PDC.
...
la PlayStation 2. Almeno per me lo Φ, infatti, in qualitα 
...
fondamentale Φ che l'intera guida si riferisce alla
versione JAP mod. SCPH 10000; questo Φ molto importante in
...
NON FUNZIONANO!
Riguardo alla versione PAL, la data di uscita Φ stata
...
provando a fare le cose che vi descriver≥ pi∙ avanti
distruggerete 1.200.000 di PS2 perchΦ sarα solo la
dimostrazione di quanto siete cazzoni. 
In questa guida non ci saranno saluti o ringraziamenti 
perchΦ ultimamente mi stanno tutti sulle palle, amici e 
parenti...
Quante pi∙ cose fai, pi∙ calci nel culo ti tirano...
...
notiamo che la PS2 ha la particolaritα di poter essere 
disposta sia in orizzontale che in verticale; per quest'
ultima posizione, per≥, Φ necessario un supporto ap-
positamente realizzato, che scongiurerα ogni rischio di
caduta della vostra preziosissima macchina... Da quanto si
Φ saputo, sembra che la PS2 abbia dei problemi di sur-
riscaldamento, prorpio come la prima SCPH 1002: perci≥
sembra essere molto importante la dissipazione del calore.
Bisognerα quindi lasciare la PS2 in un posto dove l'aria
circola liberamente, senza impedimenti, come pu≥ succedere
...
/\ Osservando il pannello frontale possiamo dire che Φ ben 
...
* Pulsante RESET, che oltre alla sua normale funzione Φ
...
a queste due porte Φ intuibile la grande facilitα di
espansione della PS2, che godrα dell'apporto di stampanti,
tastiere, ecc...

* Porta i-link, molto interessante dal punto di vista
tecnologioco, Φ attualmente utilizzata da molte fotocamere
e telecamere digitali, che potranno essere cos∞ collegate
alla macchina.
...
tipo PCMCIA, come modem o hard disk, proprio come giα fac-
...
usa sulla PS2 JAP. Ma... a tutto c'Φ un rimedio...
...
Lo swap trick e lo swap time trick funzionano solo se Φ 
...
aperta la macchina, Φ fissato con un p≥ di colla. Sotto
si trova un altro disco, questa volta bianco, ed Φ quello
che ci interessa; infatti Φ un disco magnetico che permette
...
Premete il tasto Reset/Power: il lettore partirα prima a 
1x, dopo un secondo andrα a 4x. Adesso dovrete essere molto
...
masterizzato dovrebbe funzionare. Se cos∞ non Φ, spegnete
...
Se avete incontrato delle difficoltα nell'eseguire lo swap
...
- Lo schema necessario alla realizzazione Φ negli
...
Molta gente mi chiede: "Ma la PS2 si potrα modificare per
farci girare i cd masterizzati come la vecchia PSX ?"
La risposta Φ a metα tra si e no: infatti se Φ vero che
esiste la possibilitα di modificare la consolle, Φ anche 
...
supporto; perci≥ la "modifica" attualmente disponibile 
servirα solo a far girare i CDrom.
...
modifica Φ composta da un PIC 12c508B a 18 piedini: chi
effettua giα modifiche avrα subito colto la parentela del 
...
8. Dopo questo il carrello si richiuderα automaticamente e 
   il gioco parte.
...
5. Inserire un qualsiasi gioco giapponese per PSX sul 
   carrello che si Φ aperto
6. Premere ancora OPEN per chiudere il carrello con il 
   gioco PSX
7. Dopo circa 10 secondi il carrello uscirα in automatico,
...
9. Pochi secondi dopo il carrello uscirα nuovamente, 
   bisognerα nuovamente sostituire il gioco di backup con un
   gioco originale PSX.  
10. Dopo questa operazione il carrello rientra 
    automaticamente 
11. Pochi secondi dopo il carrello uscirα per l'ultima 
    volta, sostituire il gioco PSX originale con un gioco 
    PSX di backup entro 2 secondi. 
12. Dopo questa operazione il carrello rientrerα per 
...
PerchΦ calibrare il laser? Molto spesso succede che i cd 
masterizzati diano dei problemi, soprattutto nei filmati di
intro; anche il drive DVD stesso pu≥ dare noie, come rumori
e fruscii. L'unica cosa da fare consiste quindi nel
calibrare il laser, cosa che giα si Φ vista fare con la PSX.
Partendo dal presupposto che abbiate giα provato lo swap
trick, non dovreste pi∙ incontrare difficoltα nell'operare
...
che abbia una capacitα isolante (anche il tappetino del 
mouse va bene) e mettetela sulla scheda madre. Ora metteteci
sopra il drive DVD capovolto: dovreste vederne la parte
inferiore. Se cos∞ non Φ, accendete per un attimo la PS2.

Ora potete vedere l'unitα laser: qui ci sono due piccoli
...
Se avete delle novitα riguardante la PS2 non esitate a
...
la deve inoltrare...cos∞ l'SCp manda un mess (..all'SSp che gli ha rotto i
...
un altro ).
L'STp pu≥ inoltre comportarsi da "firewall" per monitorare i messaggi ss7
...
La Parte di Trasporto del Messaggio (MTP) Φ divisa in tre livelli:
 
- MTP Livello 1.
 
Il livello pi∙ basso, MTP Livello 1, Φ equivalente all'OSI Physical Layer
...
messaggio (o il set di messaggi) Φ ritrasmesso.
MTP Livello 2 Φ equivalente all'OSI Data Link Layer (Strato collegamento dati
OSI).
Un messaggio SS7 Φ chiamato un'unitα di segnale (SU). 
Ci sono 3 tipi di unitα di segnale: 
Unitα di segnale di compilazione [Fill-In Signal Units (FISUs)], Unitα di
segnale di stato di collegamento [Link Status Signal Units (LSSUs)], e Unitα
di segnale di messaggio [Message Signal Units (MSUs)]
 
Figura 4.

Le unitα di segnale di compilazione (FISUs) sono trasmesse continuamente su
un collegamento di segnale in entrambe le direzioni finchΦ altre unitα di
segnale (MSUs o LSSUs) sono presenti. FISUs portano solo informazioni di
livello basico 2 (per esempio, riconoscimento di unitα di segnale ricevuta da
un punto di segnale remoto). PoichΘ una somma di controllo CRC Φ calcolato
per ciascuna unitα di segnale di compilazione (FISU), la qualitα del
collegamento di segnale Φ controllata continuamente da entrambi i punti di
segnale a ciascuna fine del collegamento.(Nota: Nella variante dell'ITU-T
giapponese, la qualitα del segnale dicollegamento Φ controllata dalla continua
trasmissione di flag octets (8-bit bytes) piuttosto che dalle FISU; le unitα
...
Le unitα di segnale di stato di collegamento (LSSUs) portano uno o due
ottetti (8-bit bytes) di informazione sullo stato di collegamento tra i punti
di segnale a ogni fine di collegamento. Lo stato di collegamento Φ usato per
...
Le Unitα di segnale di messaggio (MSUs) portano tutto il controllo della
...
Il valore dell'LI (Indicatore di lunghezza) determina il tipo di unitα di
segnale:

LI Valore 0 Unitα di segnale di compilazione (FISU)1..2 Unitα di segnale di
stato del collegamento (LSSU)3..63 Unitα di segnale di messaggio (MSU).


- Message Type Length Indicator Value(s).

Il 6-bit LI pu≥ registrare valori tra zero e 63. Se il numero di ottetti che
segue l'LI e che precede il CRC Φ meno di 63, l'LI contiene questo numero.
Altrimenti, l' LI Φ settato a 63. Un LI di 63 indica la lunghezza del
messaggio Φ uguale o pi∙ grande di 63 ottetti (fino a un massimo di 273
ottetti). La massima lunghezza di un'unitα di segnale Φ 279 ottetti: 273
ottetti (dati) + 1 ottetto (flag) + 1 ottetto (BSN + BIB) + 1 ottetto
(FSN + FIB) + 1 ottetto (LI + 2 bits liberi) + 2 ottetti (CRC).

- Flag.

Il valore binario del flag Φ 0111 1110. Prima di trasmettere un'unitα di
segnale, MTP Livello 2 rimuove "i falsi flag" aggiungendo uno 0-bit dopo ogni
sequenza di cinque 1-bit. Ricevendo u'unitα di segnale e togliendo il flag,
...
rimossi attraverso unitα di segnale.

BSN (Sequenza del numero a ritroso)
La BSN Φ usata per mettere a conoscenza del ricevimento di unitα di segnale
dal punto di segnale remoto. La BSN contiene la sequenza del numero
dell'unitα di segnale che Φ stata riconosciuta. (vedi sotto FIB.)
...
La FSN contiene la sequenza di numeri dell'unitα di segnale. (vedi sotto FIB.)

- FIB (Indicatore di Bit in avanzamento).

Il FIB Φ usato per recuperare gli errori come il BIB. Quando un'unitα di
segnale Φ pronta per la trsmissione, il punto di segnale incrementa l'FSN
(forward sequence number) di 1 (FSN = 0..127). Il valore del CRC (ciclico
controllo di redondanza) checksum Φ calcolato e apposto al seguente messaggio.
...
la trasmissione indietro al punto di segnale di partenza. Se il CRC Φ
corretto, il messaggio di ritorno Φ trasmesso. Se non Φ corretto, il punto di
...
Siccome il 7-bit FSN pu≥ riportare valori tra zero e 127, un punto di segnale
pu≥ mandare fino a 128 unitα di segnale prima di richiedere riconoscimento
dal punto di segnale remoto. La BSN indica l'ultima sequenza di unitα di
segnale ricevuta correttamente dal punto di segnale remoto. La BSN mette a
conoscenza anche di tutte le unitα di segnale ricevute precedentemente. Per
esempio, se un punto di segnale riceve un'unitα di segnale con BSN = 5
seguito da un altro con BSN = 10 (e il BIB non Φ inserito), il secondo BSN
implica una ricevuta corretta di unitα di segnale 6 anche attraverso 9.
...
nazionale o internazionale) e la prioritα del messaggio (0..3 con 3 che Φ la
prioritα pi∙ alta). La prioritα del messaggio Φ considerata solo sotto
condizioni di congestione, non per controllare l'ordine con cui i messaggi
sono trasmessi. I messaggi di bassa prioritα possono essere eliminati durante
i periodi di congestione. I messaggi di test del collegamento del segnale
ricevono una pi∙ alta prioritα piuttosto che i messaggi di preparazione alla
chiamata.
L' indicatore di servizio specifica l'utente MTP, permettendo cos∞ la
...
non contengono nΘ un'etichetta di instradamento, nΦ un SIO poichΘ sono
mandate tra due punti di segnale direttamente collegati. Per pi∙ informazioni
...
Il valore del CRC Φ usata per trovare e correggere gli errori di trasmissione.
Per pi∙ informazioni vedere la descrizione di BIB di seguito.

- MTP Livello 3.

MTP Livello 3 provvede l'instradamento di messaggi attraverso i punti di
segnale nella rete SS7. MTP Livello 3 Φ equivalente per funzioni all'OSI
Network Layer .
MTP Livello 3 instrada i messaggi basati sulle etichette di instradamento nel
campo di informazione del segnale (SIF) delle unitα di senale di messaggio.
...
messaggio Φ distribuito alla parte di utenti appropriata (ad esempio, ISUP o
...
ricevente ha capacitα di trasferimento messaggi (come un STP). La selezione
di collegamenti verso l'esterno Φ basata sull'informazione nel DPC e nell'SLS.
...
L'interazione tra reti ANSI e ITU-T Φ inoltra complicata da diverse
implementazioni di protocolli e procedure di pi∙ alto livello.
Un punto di codice ANSI consiste di rete, cluster, e ottetti membri (ad
esempio, 245-16-0). Un ottetto Φ un byte 8-bit che pu≥ contenere qualsiasi
valore tra zero e 255. Telcos e altre grandi reti hanno singoli identificatori
di rete, mentre gli operatori pi∙ piccoli hanno un singolo numero di cluster
che hanno all'interno reti da 1 a 4 (e.g., 1-123-9). La rete numero 0 non Φ
usata; la rete di numero 255 Φ riservata per uso futuro.
...
punto di codice 5557 (decimale) pu≥ essere dichiarato come 2-182-5
(binario 010 10110110 101).


Signaling Link Selection - Selezione del Collegamento di Segnale (SLS)

La selezione dei collegamenti verso l'esterno Φ basata su informazioni nel
DPC e nel campo di selezione del collegamento. L'SLS Φ uata per:
...
* Permette un uguale una condivisione del carico di traffico su tutti i
  ...
  messaggio collettivo da pi∙ mittenti, il livello di traffico dovrebbe
...
collegamento.
Nelle implementazioni ITU-T, l'SLS Φ interpretato come il codice di segnale
del collegamento nei messaggi MTP. Nel messaggio della parte utenti telefono
ITU-T, una porzione del codice di identificazione del circuito Φ immagazzinata
...
congestione. Comunque, una discussione dettagliata a riguardo Φ fuori dai
...
Questa interfaccia Φ tuttora in studio.
...
chiamate dati e voce attraverso la rete telefonica pubblica (PSTN). ISUP Φ
...
la chiamata Φ indirizzata a un numero fuori dallo switch, l'SSP originante
...
Nell'esempio sotto, lo IAM Φ indirizzato dall'STP dello switch originante allo
switch destinazione(1b). Nota che che lo stesso collegamento(i) Φ usato per
la durata della chiamata finchΦ un errore del collegamento forza lo switch a
usare un collegamento di segnale alternativo.

Figura 8.


Lo switch destinazione esamina il numero chiamato, determina ci≥ che serve
alla parte chiamata, e la disponibilitα della linea a squillare. Lo switch
...
collegamento Φ stata riservata. L'STP indirizza l' ACM allo switch originante
...
continuano finchΦ tutte le linee per completare il circuito voce dallo switch
...
connessa alla linea riservata e, se cos∞, inizia la tassazione.
...
Se la parte chiamata riattacca prima, o se la linea Φ occupata, lo  switch
...
inattivitα, e trasmette un messaggio di rilascio completo (RLC) ISUP allo
...
stato di inattivitα in preparazione alla prossima chiamata.
...
L'informazione ISUP Φ portata nel campo informazioni di segnale (SIF) di un
...
portare la chiamata. Il CIC Φ seguito dal campo tipo di messaggio (esempio,
...
solo il campo del tipo di messaggio. La parte fissa ingiuntiva pu≥ essere
...
Φ indicata da un ottetto contenente tutti zeri.

Messaggio di indirizzo iniziale

Un Messaggio di Indirizzo iniziale (IAM) Φ mandato "avanti" da ciascuno switch
richiesto per completare il circuito tra parte chiamata e chiamante finchΦ il
circuito connette allo switch destinazione. Un IAM contiene il numero della
parte chiamata nella parte ingiuntiva variabile e pu≥ contenere nome e numero
...
Un Messaggio con Indirizzo Completo (ACM) Φ mandato nella direzione opposta
per indicare che l'estremitα remota del circuito del collegamento Φ stata
prenotata.
...
parte chiamante Φ connessa al canale prenotato.

Figura 12. 

Un messaggio di Rilascio (REL) Φ mandato in entrambe le direzioni indicando
che il circuito sta essendo rilasciato per l'indicatore di causa specificato.
Un REL Φ mandato quando o la parte chiamante o quella chiamata chiude la
conversazione (causa = 16). Un REL Φ anche mandato nella direzione opposta se
la parte di linea chiamata Φ occupata (causa = 17).

Figura 13.

- Messaggio di Rilascio Completo. 
Un Messaggio di Rilascio Completo (RLC) Φ mandato nella direzione opposta del
REL per attestare il rilascio dell'estremitα remota di un circuito di
...
circuiti analogici; i circuiti digitali e le capacitα di trasmissione dati
...
esperienza. Proprio per questo motivo, andr≥ a ripetere cose giα dette, ma
[forse] non scontate per chiunque... quindi non rompetemi i coglioni venendomi
a dire che sono stato ripetitivo !

Personalmente, il nuovo telefono pubblico "DIGITO" [cos∞ si chiama] l'ho
visto prima alla smau, poi in funzione nella mia cittα. Senza dilunguarmi
...
- Il design Φ stato fatto da Giugiaro e l'intero scatolotto di dimensioni di
  circa 30 cm x 40 cm  Φ interamente fatto in acciaio stagnato, ragion percui
  sono propenso a credere che sarα pi∙ difficile portarsene a casa uno,
  rispetto ai precedenti. Solamente la cornetta Φ in plastica dura.

  > No comment.

- La tastiera Φ alfanumerica in quanto si possono anche inviare SMS, e in pi∙
  ci sono altri tasti che sulle vecchie cabine non c'erano e sono:
  * il tasto per selezionare la lingua (infatti questo esisteva giα!) 
  * il tasto per alzare/abbassare il volume 
  * il tasto canc ... tipo calcolatrice, che elimina l'ultimo numero
  * il tasto R ... non Φ il repeat del numero, ma serve a riprendersi il
    segnale di libero
  ...
  * due piccoli tasti, posti sotto il display, da loro funzionamento ancora
  ...
  > Anche qui non c'Φ da dire molto. L'unica cosa ancora ingota [a me] Φ il
    funzionamento dei due piccoli tasti posti sotto al display.

- Il display ha 4 righe e il trucco dell'overflow di 0 non funzia pi∙.
  Il numero massimo di cifre che si possono inserire [quelle che compongono
  il numero telefonico] Φ 25.

- Per le comunicazioni utilizza una linea ISDN :) , ed Φ supportato dalla
  Piattaforma di Rete Intelligente :( .


  > Il nome di Rete Intelligente si Φ dato quando si sono cominciate ad usare
...
- Il lettore di schede non ha pi∙ la classica entrata per le schede sopra, e 
  l'uscita sotto, infatti Φ composto di una sola fessura per schede; proprio
  ...
  > In dettaglio:
    ...
    cabine Φ pi∙ cazzuto dei vecchi. Infatti dovrebbe funzionare cos∞: voi
    inserite la scheda, e lui non se la "succhia" tutta, ma la accetta fino a
    metα. A questo punto controlla se ci≥ che avete inserito Φ una scheda che
    lui riconosce, o meno: se la riconosce (ovvero Φ delle sue) la prende
  ...
  > Per quanto riguarda il cambio della scheda, ecco quello che ho potuto
    ...
    telefono vi darα la possibilitα di cambiare scheda. Per cambiare scheda
    dovete premere l'ultimo pulsante in basso, a sinistra della tastiera;
    cos∞ facendo esce la scheda telefonica e avete 16 secondi [circa] di
...
- Per quanto riguarda le schede, funziona sia con le schede telekom a banda
  ...
  sarα poi un altro modello).

  > Vagabondando in rete, da qualche parte, mi Φ capitato di vedere che il
    telefono Φ strutturato in due parti: una fissa, dedicata alle schede, e
    una parte opzionale per la gestione delle monete, in euro, credo [ma
    questa parte opzionale la vedremo fra un po'].

- C'Φ la possibilitα di usufruire di vari servizi innovativi molto
  interessanti, del tipo:

  * Possibilitα di lasciare dei messaggi vocali, che verranno inviati una
  ...
  * Servizio di casella vocale personale, dove chiunque e da qualsiasi
    numero, avrα la possibilitα di lasciare un messaggio;
...
- Servizio ASSURDO: una porta infrarossi per collegare portatili e palmtop 
  ...
  > Questo Φ quanto sono venuto a sapere io; dal momento che l'ho reso
    pubblico sono affiorati i primi commenti e le prime critiche. C'Φ chi ha
    detto [giustamente] che di una porta IRDA non se ne vede l'ombra: bΦ, se
    Φ vero che Φ presente una porta ad infrarossi, non credo che la mettano
    ...
    casi sono 1) c'Φ 2) non c'Φ. Ma va ?! Eheeh... e la soluzione: aprire un
    rotor e vedere cosa c'Φ realmente al suon interno.
    Ponendo il caso che sia vero, Φ altrettanto inaspettata la affermazione
...
Non posso dire che ci≥ che mi Φ stato detto non sia vero, ma non escluderei
cmq il fatto della porta IRDA e del collegamento in rete.

- Altra cosa innovativa Φ il metodo di come fa a riagganciare il telefono. Mi
  ...
  appoggio Φ diversa da quella dell'intero scatolotto e la cornetta forse
  pesa leggermente di pi∙.

  > S∞, il riaggancio Φ magnetico... sto giα studiando qualcosina.

- Infine ho la chicca delle chicche. Siccome questo telefono Φ stato
  ...
  sui 900Mhz. Questa feature delle nuove cabine Φ molto interessante, anche
  se comporta un grosso svantaggio, e cioΦ che i rotor potrebbero essere
  rintracciabili con uno strumento tipo il GPS. Quindi fate molta attenzione,
  se avete idea di portarvene a casa una!

  > Anche qui le solite critiche... lo s≥. Anche A ME SUONA MOLTO STRANO, ma
    questo Φ quando sono venuto a sapere. Quindi, NON prendetelo come buono,
    ma sappiate che pu≥ esistere la possibilitα che queste cabine siano
    rintracciabili dal punto di vista di locazione geografica.

- Infine, dal punto di vista "hardware", tutto ci≥ che s≥ Φ:
...
E la porta IRDA? Non c'Φ. Ovvero non c'Φ ancora, in quanto resta anche uno
...
FRODE - Ah, questa Φ bella: se voi inserite una carta telefonica al contrario,
...
CONGESTIONE - Dopo 10 min che smanettavo, scrivendo numeri assurdi, mi Φ
...
Poco tempo fa, parlando in IRC con MrBison, Φ venuto fuori un discorso
...
A questo punto la cornetta Φ agganciata, la tua scheda Φ dentro e il telefono
...
BΦ, 1000 dubbi e pochissime certezze... insomma diamoci da fare e cerchiamo
...
PREMESSA DI OLDIRON61: Questi sono due post circa il menu del famigerato   |
                       ...
                       e' di PHCV e Jeky (SP Ml)                           |
                                                                           ...
                                                                           |
                                                                           |
*--> 1a Versione <---[ ½~{┼rtΩmis ╖ 23πm}~╗ &lt;worldnew@libero.it> ]---------+
|
|
| Allora... eccovi il men∙ COMPLETO del men∙ manutenzione:
|
+=*=*=*=-=*=-=-=*=-=*=-=*=-=-=*=-=*=-=*=-=-=*=-=*=-=*=-=-=*=-=*=-=*=-=-=*=-=*=
...
#TEST COMPONENTI
   ...
   ╗DISPLAY
        (riempie il display e poi se non Φ danneggiato esce la scritta FINE)
...
testo l'ho buttato gi∙ come mi veniva in mente. Solita merdata del disclaimer:
...
so come si fa, quindi se vi beccano Φ solo e soltanto colpa vostra, se perdete
una mano mentre cercate di aprire con la fiamma ossidrica una cabine nn Φ
colpa mia.
...
- ESPULSIONE TESSERA per togliere la scheda e sostituirla durante una
                     conversazione
- DUE TASTI A FORMA DI FRECCIA sotto al display; l'uso ne Φ ancora sconosciuto

Il tipo di interfaccia con la centrale Φ isdn, ma prevede anche due slot per
l'inserimento di due schede gsm per utilizzare il telefono su questa rete.
Il telefono Φ dotato anche di una batteria da 8 volt, per mantenere l'orario
...
( nemmeno questa funzione Φ giα implementata)e altre cosette simili.

La serratura Φ un casino, di tipo a mezza spina, e il sistema di chiusura
ancora pi∙ complicato.(da mettere in evidenza per≥ che alcuni telefoni sono
perfettamente bloccati, mentre altri hanno abbastanza lasco).

Il test mode Φ cos∞ strutturato:
...
Il telefono Φ attaccato al muro con soli tre bulloni, quindi una volta aperto
Φ mooooolto facile staccarlo e portarselo via. Attenzione, per≥... Se fosse
cos∞ semplice, ognuno di noi avrebbe uno di questi giochini in garage.
Ecco il per≥: La cabina Φ allarmata, lo so per esperienza personale:

&lt;esperienza personale>

Stavo cazzeggiano per la citt≥. Decido di andare alla stazione. Vado. Trovo
la solita cabina in test mode. comincio a tirare qua e lα e il telefono si
...
1) Se dovete fare cose cos∞ fate alla svelta, primi che arrivi qualcuno
...
oppure (come Φ successo una volta a me) aprire lo sportello di un auto
...
accenderα il led rosso che segnalera' il test per vedere se si e' collegati
...
BARZELLETTA: Pierpaolo: Senta, ci può installare il kit ISDN???
        ...
        P25F425: è impossibile, qui non si tratta pi- di frequenza, sono i
...
Questo è un piccolo log tra mR_bIs0n (chi è?ndMr_Skull) e il suo amico \zOKA\
...
&lt;mR_bIs0n> allora
&lt;mR_bIs0n> diciamo ke è un'artikolo [notate l'apostrofo ndMr_Skull] ke tratta
           di phreaking
&lt;mR_bIs0n> in partikolare di green...
<\zOKA\> ...fin qua ci arrivavo pure iol... [pubblicità okkulta ndMr_Skull]
...
La lettura di questo articolo potrebbe essere pericolosa per la vostra sanità
mentale e oltre. Quindi se registrate i seguenti sintomi: voglia di emularci
(il più grave), disturbi psicosomatici (se sapete cosa vuol dir scrivetecelo),
disturbi visivi, voglia di uccidere Fiorello (conduttore tra l'altro del
Festivalbar, terribile esaltazione di musica commerciale che si può ascoltare
solo per un mese perché poi passa di moda)... e altri non segnalati,
...
non ce ne fotte un cazzo, però sfrizionate la capocchia come un fiammifero e
...
dimenticavo, è tornato Bruce Dickinson.
mR_bIs0n: Ma tu le pubblicità le sai tutte a memoria?
Mr_Skull: solo quella degli Irons! Ma non mi faccio mica influenzare dalle
  pubblicità, infatti ho subito comprato Brave New World...
mR_bIs0n: Rimanendo in tema, vi è mai capitato di incontrare un amico poco
  sveglio che vi informava:
  A.P.S.: "Ce uè sienti lu nummuru ti l'effebbiai?"
          (trad. "Salve oh Straniero, potrei avere il piacere di domandarLe
           ...
           desinare?")
  se non vi è mai capitato, il numero non ve lo daremo certamente noi...
...
Mr_Skull: ...degna della figlia stordita (di PUTTANA!ndmR_bIs0n) del tenente
  Colombo...
mR_bIs0n: no, su come succeda tutto ciò...
...
tutto ciò è confermato dal fatto ke se provate altre kombinazioni di numeri:
800-874093
800-874194
rispondono altri numeri, e se ne fate uno sbagliato la mignottella della
Telekom Amerikana vi dirà ke è sbagliato in amerikano...
Mr_Skull: Miiiiinkia, allora io posso chiamare ad una mia "amica" che sta in
  america ('a' minuscola perché l'america fa skifo)!!!
mR_bIs0n: Teoricamente si, perché, hai una "amica" americana?
Mr_Skull: no.
mR_bIs0n: :-2(|ATDP800-874093 (faccia perplessa), ogni giorno mi stupisci
  sempre di più [e si mette a canticchiare Lithium perché ha subito un danno
  tentando di capire la mentalità contorta di Mr_Skull, e ora legge il
...
mR_bIs0n: secondo la mia teoria, la nostra chiamata dovrebbe essere,
  ipoteticamente, "fantasma", e ciò vuol dire che gli amicici americani non
  possono sapere da che numero chiamiamo... tutto ciò ipoteticamente perché
  infatti standomi a chiamare miliardi di volte il povero agente Molder
  dell'FBI, non mi sono venuti ad arrestare a casa. OK, per ora questo è tutto
...
Brutti bastardi figli di puttana? Ora, cordialmente vi illustrerò qualke
numero ke vi può piacere...

Rispondono società telefonike
800-874444 - Giappone
800-876590 - Amerika
800-874469 - Italia!!!
...
800-876559 - C'è uno ke risponde: "Ambalalailaì"
...
C'era una volta... ma poi l'hanno abbattuta perché era in pericolo di krollo.
...
&lt;Mr_Skull> (voce castrata) e cioé Nakkio!!!?
...
tutte però mutilate o orbe oppure travestiti, e dopo ben 23 spacciatori
che hanno tentato di vendergli dal semplice fumo fino all'eroina (attenzione
con l'eroina, a lungo andare può portarvi alla mariuana!), i nostri arrivano
alla sede telekozza... Descrizione:

  * recinzione alto voltaggio, che gli omini telecom hanno disattivato perché
  ...
  * enorme parcheggio pieno di Panda degli omini telekom privi di bordini
    neri indelebili
  * un ufficio che non ci interessa perché è chiuso e gli mancano anche i
    bordini neri indelebili
                             TECNICAAA    1
                             SCATOLAAA    1
                             PERFORMAAANS 1
...
però ne fa volentieri a meno. Per fortuna anche se non erano orbe, le vecchie
puttane erano sorde perché parecchi clienti, al loro tempo, sborrarono nelle
...
database, che studieremo più avanti.
...
Mio cuggino è un bambinetto pervertito, dolce, e anarchico.
...
2) Invece prima che mio nonno (che è CIECO) scenda le scale, sistema
...
i vecchi e gli inabili e si comprano la droga con la pensione di anzianità
o invalidità)
5) Quando non può avere le figurine dei Pokémon (il mio preferito è Figachu)
...
7) Vende la frutta del suo giardino a £ 2.000 all'assaggio.

Con questo è tutto.

-----------------6) Finale

BENE: ANCHE PHREAK ON A LEASH II É GIUNTO AL TERMINE...
&lt;mR_bIs0n> Skull, hai dimenticato il caps lock!
AH, SI, LO TOLgo subito. Dicevamo, siamo giunti alla fine. Speriamo che questo
seguito sia stato all'altezza del suo predecessore (speriamo di no così non
dovremo per forza scrivere la 3 parte). Speriamo che un domani ci sarà un modo
per telefonare senza pagare...
&lt;mR_bIs0n> Esiste già skull, col nopay o con picus, ma questà è un'altra
  storia
&lt;Mr_Skull> si, una storia che però non funziona per niente...
Dicevamo, senza pagare, così il mio amicone Giorgio Qulo non riceverà più
...
Da Marte è tutto. Ma io so anche cantare. Giro giroo toondooo, caaascaaaa
...
feriali è talmente sporca che sembra il suolo marziano?
...
casi, è molto pi- comodo chiamare dal salotto di casa ma molto pi-
...
Bene, mR_bIs0n, ora non ci servi pi-, ti abbiamo solo usato... Bob (c'è
...
Da fare:
 - Crearsi un gruppo di amici fidati, per lavorare insieme... è molto pi-
...
Φ possibile costruirsi un circuito in grado di pilotare direttamente un
normale registratore a microcassette per registrare le conversazioni sulla
linea telefonica a cui Φ collegato. Ogni qualvolta sarα alzata la cornetta
del telefono collegato alla linea il registratore entrerα in funzione
registrando ogni cosa (compresi i toni DTMF) fino a che la cornetta non sarα
abbassata.
Il registratore da utilizzare deve essere munito di presa Remote e di 
un'ingresso Micro. Ovviamente l'uscita LINE OUT andrα collegata 
all'ingresso del registratore mentre i contatti del RelΦ andranno 
collegati alla presa Remote del registratore che dovrα essere posizionato 
...
del registratore. Collegate alle estremitα del cavetto tagliato due 
spezzoni di filo che collegherete poi ai poli del relΦ. Cos∞ la corrente 
delle batterie passerα al registratore solo a cornetta alzata.
...
- Luther Blissett - Tot≥, Peppino e la guerra psichica 2.0 - Einaudi - 20.000
...
incomincio ad avere paura ad accendere anche il cellulare. Si perchΘ dalle
...
cos'Φ una gita in campagna, cosa significhi uscire con gli amici o innamorarsi
...
dimensione virtuale che non tiene conto della loro etα, ma solo delle loro
qualitα.
...
farsi toccare perchΘ, se non lo sapevate, loro non sono come noi: pare abbiano
le squame e le lingue biforcute, si nutrano di insetti e, cosa ancora pi∙
...
PC, chissα da quanto tempo uno di loro con le sue potentissime tecnologie mi
sta giα spiando? Chissα se sono al sicuro? Chissαà?

Ho deciso! Per difendermi, diventer≥ come loro! 
Sento giα che la pelle si sta trasformando, sento le pupille diventare come
quelle di un gatto, mi sento giα pi∙ sicuro. Una nuova coscienza mi pervade e
vedo tutto pi∙ chiaro, Finalmente mi accorgo che il vero pericolo non sono
quelli come me, che la mia diversitα non Φ altro che il prodotto della mia
nuova condizione mentale, che il pericolo non Φ la mia sete di conoscenza, ma
...
alla legalitα, perchΘ Φ superiore ad essa. In fondo sono solo diverso perchΘ
...
Adesso vi lascio, ho fame ed Φ appena passato un bug da sfruttare al volo.
...
Procedura:
   ...
   * riempi la bottiglia da 2 litri kon 20 o pi∙ strisce del foglio
   ...
   * Posiziona il palloncino sopra la bottiglia per prendere l'Idrogeno (H)
     ke uscirα dalla bottiglia
   * Kuando il palloncino si Φ gonfiato, mettici dentro parzialmente lo
     stoppino, e lega il palloncino kon un nodo.

-Nota: L'Idrogeno Φ pi∙ leggero dell'aria, kuindi se lasci il palloncino,
       volera' via.
...
Se non puoi trovare uno o pi∙ ingredienti provane altri
Se proprio non puoi, puoi sempre prenderne un po da skuola, o da varie
kompagnie kimike.  Kuando lo fai, fai in modo ke sia il pi∙ pikkolo possibile.
...
Causa la morte in 3-4 ore...a volte anke pi∙ velocemente
...
Kuando la vittima verrα graffiata da kueste... Lui/Lei morirα

Veleni Parte 2
--------------
I secondi e pi∙ komuni veleni sono kuelli di metalli mortali ed estratti
terrosi

Arsienuro di Sodio.
=-=-=-=-=-=-=-=-
Kuesto insieme all'arsienuro del piombo sono nella top ten dei materiali +
letali. L' Arsienuro di Sodio pu≥ essere akuistato in un negozio di articoli
per la pulizia dei vetri...
Si mette nel cibo delle vittime, etc.

Cianuro di Potassio.
=-=-=-=-=-=-=-=-=-
Kuesto elemento kimiko Φ kontenuto nei semi della mela..
Per averlo devi macinare circa 12 once di semi della mela.
L'effetto Φ vicino all'avvelenamento da radiazioni....
Uccide in 6 ore.

Curaro.
=-=-=-=
Kuesta sostanza Φ non basilarmente unveleno..SOno varie droghe-veleni
kombinati insieme e dati in una dose letale.Uccide nel giro di 45 min..

Piombo.
=-=-=
Anche se kuesto materiale Φ molto komune allo steso tempo Φ altamente mortale.
Prendi circa 30-40gr di polvere di Piombo e mettili nel cibo di kualkuno...

Mercurio.
=-=-=-=-
Il Mercurio Φ una sostanza mortale a kontatto kon la pelle.. Per usarlo molto
...
Plutonio.
=-=-=-=-=-
Questo materiale kome il merkurio, Φ &lt;ALTAMENTE> mortale ...Causa il cancro
anke nel pi∙ pikkolo dosaggio
Se la vittima Φ ad esso esposta morirα ne giro di una settimana di
avvelenamento da radiazioni....

Altri (skonosciuti)
=-=-=-=-=-=-=-=-=
Certamente Φ impossibile fare una lista di tutte le sostanze letali in kuesto
testo. Ma vi far≥ vedere kome fare dei veleni kombinati:
(credit to Ima Hacker)

prendi tre strisce moschicida (tm)
mettile in un recipiente kon della trementina per tutta la notte.
La mattina prendi kuel gel bianko/marrone ke si trova l∞ vicino.
...
"conservarlo" per contaggiare qualcuno in un secondo momento, allora appena
...
Questo Φ un metodo testato piu' e piu' volte, che logicamente ho usato piu'
...
poi accertano che la causa del danno qui descritto Φ vostra siete voi nella 
merda e NON io!!Detto questo si pu≥ procedere.
...
telefono sarα muto, e lo scambio di cavi non si noterα nemmeno.
Adesso chiamate il 187 della telecozz da un cello, tanto Φ gratis, e 
segnalate il vostro "guasto" (se cos∞ si pu≥ definire...).
...
intanto voi avete giα fatto e fregato un casino di cose.
Vi assicuro che il metodo funziona; l'ho giα sperimentato due volte ed 
...
sapete...tnx!
Attenzione a non esagerare con questo metodo, per≥!! La telecazz logga tutte 
...
L'importante è non possedere la stampante usata da Gutemberg!!! Quella kol
torkio!!!Ihihihihiihh!!!

Autore: mR_bIs0n
Musica ascoltata: niente mp3, causa tasto accensione rotto!
Consumo: aspe'ke kiedo qualkosa da mangiare a mia madre:
         Io: MAAAAAAAAAA, ke c'è qualkosa da mangiare???
         Mamma: AAAAAH! Non c'è nulla da mangiare! ESCI DAL COMPUTER!!! AAAH!
...
rivista scientifica, mi domando: "Qual è il numero di Asia Argento?
E'possibile telefonarle? Se si perkè?"... Anzi no!: "Può esistere il formaggio
dopobarba?"... no!: "E'possibile usare il tagliando ke c'è sulle kartoline di
...
Tutto vi sarà più semplice vedendo l'immagine jpg contenuta nel file zip
"sborra.zip"... ah, non volevano ke lo kiamassi kosì, già... "mR_bIs0n.zip"!

<---Kosa succede, sekondo la tua modesta teoria senza senso???--->
Inxomma, tenterò di abbozzare qualkosa... Secondo me, l'ufficio postale,
poterbbe notare il fatto ke è una cartolina col il tagliando di affrankatura
...
farvene di vostre, ma attenzione! Usate più konti korrenti, quindi cerkate
quante più cartoline o lettere di abbonamento... Le lineette sul fianko
imitatele nella loro frequenza e grandezza (es. grandezza: 3mm frequenza: ogni
2.5mm...).

<---Manka ankora qualkosa...--->
Si, infatti ci sarebbero delle altre prove ke è possibile fare:
...
L'aria,forse Φ meglio dire il fumo, passa prima nell'acqua e quindi si
raffredda.
...
questo sarα assolutamente unico perchΦ vi presenter≥ una tecnica invetata da
me (o quantomeno non l'ho sentita da nessuna parte) e soprattutto non vi dar≥
rigide dosi di prodotti da usare a tale giorni a tale ore...Coltiverete il
tutto sul vostro balcone (come me) nella massima libertα e con i pi∙ felici
risultati.
Ma iniziamo....
...
un paio di consigli:
Il seme NON deve essere bianco bens∞ scuro
...
╚ importantissimo, in questa fase, esporre i semi alla luce perchΦ il seme Φ
come un batterio congelato, se non viene stimolato non riprenderα mai a
vivere. Se per qualche motivo non potete metterlo al sole perchΦ Φ ancora
freddo o nuvoloso, allora mettete il seme sul termosifone (purchΦ non si
...
il panno, l'unico difetto di questa soluzione Φ che una volta germinato, il
seme resterα intrappolato nel cotone e voi dovrete farvi il mazzo per
...
Se c'Φ luce, il periodo Φ aprile-maggio (o se siete al sud va bene anche metα
marzo), allora in 5-10 giorni i vostri semini caccieranno delle graziose
radici...

Pu≥ sembrare stupido ma se i semini sono in compagnia germogliano meglio,
questo me lo insegn≥ mia nonna che mi disse: "I semini non crescono 
perchΦ si sentono soli"...Sarα una credenza popolare, ma se ne mettete 
in uno stesso bicchiere 7-8 nasceranno velocemente e meglio. Per 
curiositα ho fatto una prova e devo dire che per qualche strano 
motivo i semini che non erano soli sono nati pi∙ velocemente e meglio, 
mentre i semini solitari o non hanno germogliato o sono morti poco dopo :(.

Questa Φ (per il coltivatore) la parte pi∙ difficile perchΦ passerete il 
...
foglioline rugose, beh, Φ arrivato il momento di trasferirle, se potete
...
5 Kg di terra per piante grasse (si si, quella per piante grasse Φ fantastica)
1 bottiglia di sangue di bue.
Con 14.000ú comprerete tutto il necessario per 6 piante (QueBonzo docet :).
Una sola cosa Φ importantissima.....Il sangue di bue, ora Φ fuori legge ma
al fioraio sotto banco e con un piccolo extra riuscirete e comperare una
bottiglia di questo preziossissimo elisir...Ah, il piccolo extra Φ di lire
1000...Cos∞ una bottiglia costa 2000ú :))
...
bue (dite che Φ per il vostro luppolo) e se proprio non ci riuscite allora
dovrete ripiegare sul latte che Φ circa 10 volte meno "potente".
...
Piccolo consiglio: la parte interrata dello stelo sarα bianca perchΦ non
prende luce, bene, voi dovete interrare nel vaso la piantina fino a 1mm pi∙
su bianco altrimenti il tronco marcirα.
...
MUORE.
Ma datele pi∙ luce possibile ed annaffiatele con mezzo bicchiere d'acqua 
appena vedete la terra asciutta (di solito ogni 5-6 gg)

-== QuePack ==-

Deh hi hi, ora il FANTASTICO metodo QuePack :), in cosa consiste?
Beh il coltivatore serio di Maria potrα spendere milioni di umidificatori,
corrente, neon per piante e soprattutto potrα coltivare la sua pianta
nell'armadio...Que non pu≥ fare tutto questo e soprattuto...Que NON ha soldi,
cos∞ si Φ dovuto inventare qualcosa....

Hihihihihihi, la pianta della maria nei primi stadi di crescita ha bisogno di
umiditα pressochΦ costante e calde temperature. Io non ho soldi per un
...
in un vaso pi∙ grande se prima stavano in uno piccolo, altrimenti potrete
lasciarle l∞....Ma dovrete cacciarle fuori di casa e dargli del buon caldo
sole.
C'Φ un problema: il vento, l'umiditα ecc....Come ovviare?
...
DomoPack fino alla base del vaso, una buona cosa sarebbe inserire 3 o pi∙
...
Questo Φ il vaso visto dall'alto, i buchi sono paralleli alla corrente.
PerchΦ ci≥? PerchΦ questa Φ una mini-serra davvero funzionale, in quanto si
preoccupa di mantenere la pianta ad una temperatura OTTIMALE di circa
30-34 ░C (e non Φ roba da poco), oltretutto mantiene alta l'umiditα (80%)
...
infilate un dito nella serretta e vedete che la temperatura interna Φ uguale
a quella esterna, allora sono troppo grandi, empirico come ragionamente ma
molto molto funzionale.

A questo stadio della crescita date acqua a volontα ogni 5 giorni, secondo me
non Φ vero che bisogna tenerle a stecchetta, appena vedete la terra quasi
...
sangue di bue Φ troppo forte per ora (ve lo dico perchΦ ho perso 3 piantine).
L'ideale inoltre sarebbe quello di illuminarle 16-18 ore al giorno, ma la
corrente costa cara, cos∞ 8 ore di sole le faranno crescere benissimo
...
allo scoperto, il vento difficilmente le danneggierα, ma di certo se Φ forte
le dovrete mettere sotto un tavolo o in casa. Se inizia a piovere togliete le
piante da sotto l'acqua perchΦ anche pochi minuti saranno sufficienti a
dissolvere TUTTA la resina prodotta finora....E si sa che la resina Φ 8 volte
pi∙ forte delle foglie.
...
fatevi problemi perchΦ resisteranno alla siccitα (ovvio che una bottiglia
darα una mano), e non tenetele sul balcone ma mettetele sotto un tavolo o in
...
di temperatura e prenderanno tempo per infoltirsi. Per 15gg non c'Φ problema
ma se diventano oltre 20 allora preoccupatevi di farle innaffiare almeno una
volta.

La fertilizzazione Φ semplicissima: ogni 8 giorni (alternativamente) darete
...
sangue....e cos∞ via, questo procedimento lo dovrete ripetere "ad libitum"...
E le piantine cresceranno con tanta rapiditα, se le foglie si arricciano
avete usato troppo fertilizzante e l'unico metodo per salvarle Φ innaffiarle
...
altrimenti la pianta per difendersi ne farα crescere in modo disordinato
molte che resteranno piccole e la piantina morirα per squilibrio idrodinamico,
quindi resistete ancora un po'...resistete Φ molto relativo visto che nel
frattempo avrete giα ricavato pi∙ di 200.000lire di foglie morte che sono
ottimissime :))) diciamo che la pianta mediamente perde 2-3 foglie al giorno
:) ecco fatto.

-== Quarta fase ==-

La pianta sarα ora alta oltre 40cm ed inizierete a capire se Φ maschio o
femmina, lo so che il PiΦ sarα ora contrario, ma vi garantisco una cosa:
a questo stato della crescita la pianta maschio Φ di un verde molto scuro,
mentre la femmina Φ molto brillante, ad ogni modo la pianta maschio riuscirete
a riconoscerla gia quando sarα alta 30cm per il semplice fatto che mentre le
...
Tenete presente a paritα di etα ecco le differenze che avrete tra le due
piante:
...
- Poco folta                | - Molto folta (cmq pi∙ folta del maschio)      |
...
- I fiori vanno verso il    | - I fiori vanno verso l'alto e crescono solo   |
  basso                     |   sulle estremitα della pianta e sono          |
...
Le possibilitα che la pianta sia femmina o maschio "dovrebbe" essere la
stessa, fatto sta che a me su 7 piante (3 morte) solo 1 Φ maschio :).
Appena vedrete la pianta bella forte potrete togliere qualche foglia, ma non
esagerate perchΦ se vedete la pianta con molte foglioline piccole vuol dire
...
quella che si fuma Φ la femmina, ma se coltivato bene il maschio ha contenuti
di THC (il principio attivo) piuttosto alti ed estremamente vicini a quelli
della femmina, quindi non buttatela visto che vi servirα per i semi.

-== Quinta fase ==-

Le specie di cannabis sono varie, la cannabis italica Φ differente perchΦ le
...
a 2.5/3 (il massimo Φ 4 e 3 Φ un contenuto molto alto) quindi se scoprite di
avere cannabis italica in casa:
rilassatevi perchΦ non state commettendo reato :) e poi coltivatela bene
perchΦ sarα ottima.

La specie che dovremmo avere noi si chiama Cannabis Sativa variante Indica, Φ
la pi∙ potente ed oltretutto fa piante basse ma molto molto folte :)),
generalmente a fine crescita si possono ottenere circa 700-750g tra foglie e
fiori.
Ad ogni modo la Cannabis resta sempre un'erbaccia perci≥ in questa fase 
crescerα molto molto velocemente fino ad oltrepassare i 2.5m (ma ci vogliono 
...
vostri.
Vi dico una cosa che un po' vi irriterα, la parte pi∙ forte della pianta 
non la possiamo fumare perchΦ Φ una sostanza che contiene quasi totalmente
THC che Φ altamente volatile e praticamente evapora appena la pianta lo
emette :(((.
...
Appena la pianta inizia ad emettere polline avrα giα perso il 10% della sua 
...
2) Fateli germogliare, manteneteli al sole ed al caldo e sempre con abbondante
   acqua
3) Dopo 10 giorni piantateli in un grosso vaso che conterrα solo terra per
...
- Una canna fa meno male di una sigaretta, il tabacco Φ altamente tossico
- La parte che produce THC (TetraIdroCannabinolo) sono le radici NON le 
  foglie (fumate tutto :)
- La cannabis ha una lieve (ma non pericolosa) tossicitα che pu≥ dare mal di
  testa, se innestate del luppolo (luppolo e cannabis fanno parte della stessa
  famiglia) non avrete problemi con i vicini ed il luppolo Φ totalmente
  atossico, questa sarebbe la soluzione migliore.
- Offrite la vostra erba agli amici, vendere droga Φ anche una questione di
  etica, Φ meglio vivere   nella filosofia del Peace&Love (IMHO), non c'Φ
...
- Non guidate dopo una canna, aspettate almeno 45min, i tassi di incidente 
  ...
  denuncia.
- La pianta della maria Φ incredibilmente simile alla Passiflora ed all'Acero
  Cinese

-== Disclaimer ==-

Io non coltivo ne faccio uso di alcuna droga, non mi prendo nessuna
responsabilitα per ci≥ che ho scritto su questo tutorial, ho appreso codeste
...
questa materia da gente che mi ha obbligato ferocemente, Φ stata una congiura
...
sventando cos∞ il pericolo di "voler fumare", se dovesse succedere qualcosa
...
Grazie al PiΦ per il suo libretto, grazie al coder di HighGrow che ha fatto
...
1 merendino mister day - marlboro light - caffΦ borghetti-
tempo sottrrratttoooo all'ufficio.

Allora ragazzi salve a tutti.
Questa volta voglio dirvi una cosa che mi Φ stata tramandata dal passato, non
ci azzecca un cazzo con IT ma funziona meglio di qualsiasi OS.

Dunque siamo in estate, e chi in estate non Φ stato in una di quelle feste
dove ci sono tante donzelle in abiti succinti che solo a guardarle senti
fortissimo, il desiderio di dare la testa al muro perchΦ la danno agli altri
e non a te?

NON FATE I MACHI "TUTTI E DICO TUTTI" o a voi Φ andata sempre bene.

Mi scuso con le gentili lettrici, ma visti la paritα dei sessi il discorso
vale all'inverso.

Tanto ormai siamo liberi no?
Ok basta cazzate.

Siamo a questa splendida festa magari in piscina, magari c'Φ lei, magari ci
fila!
...
Si vanterα di essere un intenditore.
Allora voi rivolgetevi a lui con tono polemico ma sempre gentile
contravvenendo a ci≥ che dice. qualunque cosa sia ma fatelo con gentilezza e
garbo.

Lui che non vuole fare la figuraccia vi risponderα "fate in modo che sia lui
a far  salire il tono del discorso"
Poi ditegli: "Secondo me non ti bevi 1 bicchiere di vino uno solo senza
              andare lungo."

Il pollo e troppo pieno di sΦ per dire no, ma siccome fondamentalmente Φ
coglione dirα:

No tu ci metti qualcosa dentro o chissa che mi fai bere.

allora voi: La bottiglia la scegli tu purchΦ rossa e a temperatura ambiente,
tu la stappi, sempre tu ti versi il vino nel bicchiere l'unica cosa che ti
chiedo e di berlo con 5 CANNUCCE.

Davanti a queste affermazioni il coglionazzo non potrα rifiutare
"Non dimenticate che lei Φ li a guardarlo"
ed allora il rito inizia.

Dopo avergli fatto scegliere il vino, dopo che se lo Φ versato, fategli
...
Poi chiedetegli come si sente lui dirα BENE!! ma vedrete che appena si alza
cadrα in terra ubriaco come se avesse bevuto una botte.

SPIEGAZIONE: NONSTANTE IL VINO SIA POCO RICORDATE SEMPRE CHE Φ CMQ UNA
             BEVANDA ALCOLICA, ED IL SUBDOLO E' PROPRIO LI.

METTENDO LE 5 CANNUCCE IN BOCCA E SUCCHIANDO IL VINO, O SI Φ PARENTI DI
...
Introduzione: Non avevo molta voglia di scrivere questo articolo perchΘ mi
sembra molto scemo,...ma che cazz.
Il testo ke ho scritto Φ dedicato alla mia ragazza Claudia: 6 magnificaaaaa !!
Uno speciale ringraziamento Φ a Zapotecz !!!

Ecco a voi alcuni esempi di come fare i pi∙ famosi COCKTAIL cos∞ vi potete
...
- Acqua tonica
Dove:
In un tumbler grande pieno a metα di ghiaccio in polvere
Preparazione:
...
Questo Φ quanto...se non vi Φ piaciuto questo articolo non me lo dite, Φ
