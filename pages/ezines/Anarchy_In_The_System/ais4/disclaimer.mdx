...
-Usa queste informazioni a TUO rischio e pericolo. 
 Chiunque abbia scritto articoli per questa E-Zine non si assumera' NESSUNA
 responsabilita' per l'uso o l'abuso delle infos contenute in questo testo.
...
-La redazione non si assume alcuna responsabilita' circa gli argomenti
 trattati in ogni singolo articolo, sia per quanto riguarda la parte "etica"
 (Laming, Ripping etc.etc.)
...
-L'informazione non e' in alcun modo illegale. Non si incoraggia tuttavia,
 chi volesse usufruire delle informazioni contenute  per scopi illegali, o
 comunque non attinenti ai principi di civilta', di etica e di morale.
...
-Chi si dovesse ritenere offeso dagli argomenti divulgati in questo
 file cancelli immediatamente questo documento dal proprio disco.
