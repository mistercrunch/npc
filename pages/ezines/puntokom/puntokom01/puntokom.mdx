...
```
      ...
      =============================================================
             PuntoKOM Zine - Argentina - Numero 1, Año 1
                             Marzo del 2000
      =============================================================
...
-----------------------------------------------------------------------------
 ...
 PuntoKOM Zine nacio en mi mente hace aproximadamente 1 año. Por vagancia,
...
---- AMD E INTEL ROMPIERON LA BARRERA DEL GhZ ----
 ...
 Finalmente, y calentando las cosas en el mercado, las compañias Amd e Intel
...
---- NINTENDO DEBE FABRICAR GUANTES POR DAÑOS EN JUGADORES ----
...
queramos: 'Uindors 1492' pero OJO no pasarse del tamaño de 'Windows 98...'
...
nuestro personaje (por ejemplo, Flash). Al encontrarlo veremos varios símbolos
...
que no no viene mal una pequeña introduccion.
...
tipo de tecnologia es muy dificil que se pueda engañar o cometer fraudes.
...
que se roben tus huellas que tu contraseña? Solo el tiempo dira si se puede
...
aparato electronico que se les cruze).
 Siguen una ETICA, que les enseña, por ejemplo, a no ALTERAR datos.
