...
devuelve, Turbo C convertirß el valor de la variable al tipo especificado en 
la funcion.
...
El dato que va entre parΘntesis, en funcion del cual se saltara a una u otra 
