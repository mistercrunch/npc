...
NOTA: íBuaaaa! Cuanta mejora.... ┐Como se las habran apa±ado?
...
íOstia! se nos ha complicado.... ┐que es todo esto?
...
origen. íVaya! ┐Y que pasa si un router recibe un paquete demasiado
...
1.-SIGUIENTE CABECERA (8 bits): íDios! que pesados se estan poniendo :P
