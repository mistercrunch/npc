...
#> 2) Como nace CatHack?
 ...
 casualidad, luego por contactos se unieron aásef y barner, la idea
...
#> 3) Por que publicar en catalan?
 ...
 (quands, cat-linux..), y tambien queriamos a±adir nuestro granito de arena.
...
#>    ezine?
 ...
 segunda 2 meses de diferencia y entre la 7 y la 8 un a±o de diferencia.
...
#>    la scene, como Hispahack. Explicad un poco los motivos.
 ...
 ense±anza/diversion donde no habia lugar para jerarquias ni malos rollos.
 ...
 granitos en la cara". En el mismo mensaje insultaban a algun miembro de
 ...
 como ellos". Como su mensaje estaba de nuevo lleno de insultos pero vacio
 ...
 bien, ense±ar, aprender, y que no nos creemos los dioses de la scene ni
 lo queremos ser.
...
#>    respecto?
 ...
 quien es el malo, el que entra en el piso? o el que avisa al due±o de
...
#> 10) Que opinais de la LSSI?
 ...
 En Espa±a la LSSI es menos restrictiva que en resto de Europa, pero
...
#>     Que es exactamente un hacklab y como nace la idea de crealo?
 ...
 donde aprender, ense±ar, y todo por supuesto sin olvidar el activismo,
 ...
 un a±o devido a agresiones que sufrieron y finalmente el desalojo) luego se
 trasladaron los trastos desde la "Academia" hasta "Les Naus" el CSOA donde
 esta actualmente el lab. El a±o siguiente el hackmeeting se traslado a
