...
instaladas ahi pueden ser vulnerables. Una clßsica solucion para reducir el
...
obtenci≤n de un clasico "chroot /home/chrooted &lt;programa>" en la linea de
comandos. Tras hacer...
...
que el chroot siempre va acompa±ado de un chdir vemos que no habra problema
...
/*
 * Hemos a±adido estas dos funciones para juguetear un poco con los dentrys :-)
 */
...
---/ fs/open.c /---
     ...
     Como podeis ver, he a±adido dos funciones al fichero, getdentryway() 
...
remota, asi que debemos dise±ar una. La shellcode que veis a continuacion se
