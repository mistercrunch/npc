...
2. ┐Proque el PIC 16F84?:
  ...
  mar PICs y se puede hacer bastantes cosas interesantes con Θl.
...
6. Instrucciones Y Ejemplo:
  ...
  ; Esto se llaman fuses y los explicarΘ mas adelante en el siguiente punto
...
7. Fuses:
  ...
  7.2 WDT:
      ...
      tro del Watchdog durante un tiempo, el PIC se resetearß.
