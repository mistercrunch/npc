...
de directorio contiene varios campos:
    ...
    * El tama±o de la entrada en bytes.
...
El superbloque contiene una descripcion del tama±o y forma del sistema de
...
struct ext2_super_block {
 ...
 __u32 s_log_block_size;	/* Tama±o logico de los bloques */
 __s32 s_log_frag_size;		/* Tama±o logico del fragmento */
...
__u32 bg_inode_table;		/* Direccion del primer bloque de la tabla de inodos en este grupo */
 __u16 bg_free_blocks_count;	/* N║ de bloques libres en este grupo */
 __u16 bg_free_inodes_count;	/* N║ de inodos libres en este grupo */
...
struct ext2_inode {
 ...
 __u32 i_size;		/* tama±o del archivo en bytes */
...
struct ext2_dir_entry {
 ...
 __u16 rec_len;		/* Tama±o en bytes de la entrada del directorio*/
...
directorios:
    ...
    * ext2_readdir: esta funcion implementa la operacion readdir. Utiliza la 
      ...
      el directorio se ha modificado (al menos un archivo ha sido a±adido o
...
fuente fs/Ext2/namei.c:
    ...
    * ext2_lookup: esta funcion efectua primero una busqueda del nombre de 
      ...
      funcion ext2_find_entry, el resultado se a±ade a la cache de nombres por
    ...
    * ext2_add_entry: esta funcion se llama para crear una nueva entrada en un 
      ...
      decir, una entrada disponible de tama±o suficiente o una entrada 
...
13.- Cambio del tama±o de un archivo en Ext2
--------------------------------------------
