...
{
	/*	Han a±adido desde el area de usuario una nueva Regla */
...
/* idsrule.c
 * Zisxko Chistems Presents IDS Espa±ol
...
1.-Introduccion
---------------
    A±os atras, cuando se demostro la existencia de los buffers overflow, una
...
man page, si el tama±o del buffer de origen coincide con maximo numero de
...
Sencillo, porque en el strncpy(buf2, argv[2], 8); argv[2] tiene un tama±o de
...
problema no es explotable, pues el buffer que tendra un tama±o superior a 
...
---/ expl1.c /---
   ...
   Veamos si este sencillo explit, explota bien vuln1.c.
    ...
    Exploting...
    Message   ┐
    sh-2.05#
...
y compa±ia. Dichas funciones aceptan un argumento que es un array en la que
...
priva el control del tama±o del buffer que se va a crear, sinembargo si hacemos
algo como "%.8x" nos aseguramos que se imprimiran 8 cifras/caracteres.
     ...
     Vamos ahora a hacer una peque±a prueba con gdb, para que veais lo facil
...
---/ exploit.c /---
    ...
    A probar...
      ...
      Exploting...
        ┐
      sh-2.05a#
...
void mata_hilo_kernel(kthread_t *khilo)
{
	lock_kernel();
      	...
      	kill_proc(khilo->thread->pid, SIGKILL, 1);/*enviamos la se±al de muerte
al hilo*/
...
proceso */
      	...
      	/* establecemos las se±ales que queremos responder con el hilo */
...
es un buen parche . El parche simplemente a±ade una nueva entrada a
