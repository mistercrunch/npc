...
```
 ...
 informacion mala o no autorizada de logueo desde Internet.
        ...
        Para aquellos de vosotros que os guste engañar,  algo que me gusta es
 ...
 no son logueadas. Sin embargo, muchos servicios pueden ser añadidos de forma
 sencilla a /etc/inetd.conf para ser logueados con TCP Wrappers. Por ejemplo,
 puedes añadir una entrada en /etc/inetd.conf para NetBus. Puedes definir TCP
 ...
 de vulnerabilidades. Es configurable, permitiendote añadir nuevos fallos que
 ...
 comunmente para sniffar contraseñas.
 ...
 Apr 14 19:19:05 mozart in.fingerd[11648]: connect from 192.168.11.200
        ...
        Una cosa que debes tener  en mente es la opcion -D (o señuelo).  Esta
 ...
 cuentas de usuario  como  "moof",  "rewt",  "crak0",  o "w0rm" añadidas a tu
 archivo /etc/passwd.  Estas cuentas,  con uid 0,  son añadidas por alguno de
