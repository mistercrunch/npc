 ...
 * que por que ponga "7a69Soft" no penseis mal xD .
 *
 */

#ifdef APLICACIONES 

#include "ip2int.c"		/* Coder : tuxisuau			     */
				/* Programar para pasar las ip's a integer   */

#include "ipv.c"		/* Coder : trycky			     */
				/* Programar para encriptar en TEA	     */

#include "lpdfp"		/* Programa creado por f0bic ajeno al staff  */
...
#include "hp-ux_elmxpl.c        /* Coder : Ripe				     */
