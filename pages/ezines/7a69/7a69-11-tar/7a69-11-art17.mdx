...
un sueño de la ostia despues de pasarme todo el puente de juerga con media
pandilla en casa de una amiga. "Uffff y ademas mañana empiezo el puto curso.
Joooder!"
...
esas extrañas ocasiones en las que podemos aplicar ingenieria inversa a algun
...
Veamos que es lo que vamos a necesitar para destripar a nuestra pequeña
...
^^^^^^^^^^^^^^^^^^^^^^^^
  ...
  \HKCU\Software\Security Software Technologies\LC3\Registration\Unlock Code
    ...
    al modico precio de 249$ (dolares) que no se yo quien coño los va a pagar.
    ...
    "Register". Nos aparece una pequeña ventana con dos campos de datos:
    ...
    servido escribir este articulo, ha sido para conseguir de una puñetera vez
...
:00420297 894604                  mov dword ptr [esi+04], eax
    ...
    a rular el LC3 para comprobar que todo va bien y.... coño, esto no parece
    ...
    Bien, no asustarse. Ya me extrañaba a mi que si en la version 2.5
...
En fin señores, nada mas por hoy. Quiero darle las gracias a Marconi por
...
AiNaKeR, Ripe, Anarion, Jafar, mnm y resto de peña del canal #root ;].
