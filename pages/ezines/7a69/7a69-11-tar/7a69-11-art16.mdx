...
2.- LA VICTIMA.
 ...
 museArc. En concreto este programa es un reproductor de mpeg diseñado para
...
Pues vamos a probar nuestro nuevo mp3 player y vemos ke ni de coña, no nos
...
programa... Asi pues, pasaremos a buscar alguna solucion a este pekeño
contratiempo...
 ...
 esa funcion. Para ello, primero se arranca el symbol loader, una pequeña
 ...
 MuseArc.exe. Le damos para continuar al pekeño boton con un dibujo de ruedas
...
Bueno, y ke koño pasa aki??? Pues la respuesta parece bastante clara. O
...
culo. Asi ke habra ke buscar soluciones para esto.
 ...
 Pues esta es la primera solucion ke se me ocurre. Un loader es un pekeño
 ...
 ke tenemos ke hacer es ejecutarlo.
  ...
  estan sacados de este archivo.
   ...
   extension, se le añade ".exe", pero sei el nombre del fichero termina en
   punto, sin extension, o el nombre del fichero contiene el path, el ".exe"
   no es añadido. Si el nombre del fichero no contiene el path, windows busca
   ...
   typedef struct _SECURITY_ATTRIBUTES {
    DWORD  nLength;              // Tamaño de la estructura
   ...
   A pesar de su tamaño, la mayoria de los campos son ignorados a no ser ke
   ...
   valores determinados. Estos son:
    cb: Con el tamaño total de la estructura.
  ...
  Por un lado hay k destacar ke añadi algo de codigo adicional ke se encarga
  ...
  nuestro pekeño enjendro, veremos ke el MuseArc arranca sin ningun problema
  :)))))
  ...
  *(esp+4)+2b apuntaria a "e" o "E". Por lo tanto *(*(esp+4)+2b) deberia ser 
  ...
  ke estamos direccionando en memoria es de tama±o byte, pues por defecto
  ...
  no aumentariamos el tamaño del ejecutable. Asi k abrimos el archivo
  ...
  RAW SICE: Es el tamaño de la seccion, valor ke el procdump calcula a partir
  ...
  Pues vamos a hablar de esta herramienta, creada por Iczelion. Este pekeño
  programa nos permite la posibilidad de escribir pekeños trozos de codigo
  ...
  original, al ke habiamos puesto el nombre MuseArc.exx.
   ...
   solo vamos aki a hacer una pekeña lista de lo ke habiams obtenido:
  ...
  cualkier sitio. Nos aparece una pekeña ventana indicando ke la operacion se
 ...
 * Referenced by a CALL at Addresses:
 ...
 estudio detallado de la rutina de proteccion, basikamente porke es un peñazo
 :).....
