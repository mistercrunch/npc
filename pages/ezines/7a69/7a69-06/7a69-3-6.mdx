...
║1.- Presentacion             ║                 ║             ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║           
║2.- Hackers en IRC           ║ Canales de IRC  ║             ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║          
║3.- Comandos basicos del FTP ║     Hacking     ║   Muy bajo  ║    Dan^^    ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
║4.- La historia de los virus ║     Viruses     ║   Muy Bajo  ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
║5.- Curso de UNIX II         ║     Hacking     ║    Bajo     ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
║6.- Introduccion al TCP/IP   ║      Redes      ║    Medio    ║   |CoDeX|   ║
║    III                      ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║7.- Criptografia II          ║      Datos      ║    Medio    ║   |CoDeX|   ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║8.- ¡No dejes huellas!       ║     Hacking     ║    Bajo     ║   IReick    ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║9.- Tecnicas de hacking      ║     Hacking     ║    Bajo     ║    Ripe     ║
║    (Sniffing y spoofing)    ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║10.- Proyectos               ║    El futuro    ║             ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║11.- Despedida               ║                 ║             ║    Ripe     ║
╚═════════════════════════════╩═════════════════╩═════════════╩═════════════╝
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║2.- Hackers en IRC            ║   Canales de IRC   ║                       ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
#hack: Aqui se reune la supuesta 31337 del hack español, si bien es cierto
       que puedes encontrar gente de autentico nivel, es un canal en el que
       es muy dificil integrarte.

#hack_novatos: Algunas personas se empeñan en decir que los canales
...
#seguridad_informática: (Con acebto en la "a") Este canal esta mas bien
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║3.- Comandos basicos del FTP  ║      Hacking       ║       Muy bajo        ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ Dan^^ ]
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║4.- La historis de los virus  ║       Virus        ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
informaticos" que mas daño causan, en muy pocas ocasiones son capturados, aun
que ultimamente el mismisimo F.B.I. esta poniendo mucho empeño en campturar
...
dañino de la historia (hasta ahora), el CIH, este fue Che Inh Hau, que puso
sus iniciales en el nombre del virus.

Pero dejemos la actualidad, y dirijamonos a la epoca pre-historica :P

Aun que fue hasta los años 80 cuando salieron a la luz los primeros virus, en
...
un año mas tarde aparecieron las denominadas Core Wars, un juego que
...
a conocer a la gran masa hasta que Ken Thomson (Uno de los diseñadores del
sistema operativo UNIX) lo menciono en un discurso que realizo tras la
recogida de un premio. Al año siguiente nacio el concepto de virus como un
...
deiseñadores de UNIX y muy aficionado a las Core Wars) en 1988 y que proboco
...
primer diseñado para PC fue el creado por Basit y Amjads (Dos dessarolladores
...
descubierto hasta un año mas tarde. Despues de Brain siguieron apareciendo
virus experimentales como Virden Burguer o Rush hour.

Un año mas tarde, en 1987, aparecieron los primeros virus que causaban
autentico daño, el primero en darse a conocer fue el Viena, el cual afectaba
...
autentco caos en internet ese año.

A caballo entre el 1988 y el 1989 aparecio el Virus-B, que estaba programado
apartir de otro virus y que no presentaba intenciones dañinas. Los primeros
...
virus Vienna). A finales de año Dark Avenger (que a lo largo de la historia
...
virus que aparecieron ese año cabe destacar V2px, virus90, Virus-101 y Fish
...
probocando un autentico panico). Ese mimso año se dio un paso muy importante
para los creadores de virus, nacio el MTE, un motor de mutacion diseñado por
Dark Avenger y que permitia a los virus mutarse, y ocultarse asi mejor. El
virus Grove aparecio un año mas tarde utilizando ese motode de mutacion.

El 1993 fue el año en que internet se lanzo a la fama, los usuarion de la red
habian crecido mucho en los 2 años anteriores y los creadores de virus vieron
...
junto el MS-DOS 6.0. Ese año salieron a la luz una imensa cantidad de virus;
...
realidad, ese año aparecio el primer virus macro, fue Concept, que luego
seria seguidi por otros como Wazzu, Nuclear o NOP entre otrso muchos. El 1996
tambien fue la epoca de los virus macro, durante ese año aparecieron mas de
...
Al año siguiente eparecio el conocido virus Spansaka, que atacaba a ficheros
...
de grupos de noticias (News). Ese año anacio tambien un completo virus
denominado Olivio.

En 1998, y con la aparicion al mercado con la version 98 de Microsoft
Windows, aparecio el virus Marburg, de la mano del creador de virus español
...
electronico de sus usuario para evitar la propagacion de ese virus. Ese año
...
aparecieron muchisimos mas. El año 1997 Microsoft saco la nueva version de su
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║5.- Curso de UNIX II          ║      Hacking       ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
orden, UNIX nos pide la actual contraseña (no en todos los sistemas), si esta
se introduce correctamente este procedera a preguntarnos en dos ocasiones la
nueva contraseña, si las dos contraseñas coinciden el password del usuario
habra cambiado.
...
Para que se produzca el cambio de contraseña deben darse algunas
coindiciones:
  --La nueva contraseña ha de diferir tres caracteres de la anterior.
  --La contraseña ha de ser de almenos 6 caracteres y contener numeros y
    letras.
  --La contraseña no puede ser igual al nombre de usuario.

NOTA: Cuando UNIX te pida que introduzcas las contraseñas estas no se
      imprimiran en pantalla por motivos de seguridad.

Despues de explicar como cambiar la contraseña de usuario en UNIX voy a
...
respondera con el dia de la semana, el mes, la hora y el año (Esto es
...
tras la orden "cal" el mes y el año que quieras.
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║6.- Introduccion al TCP/IP III║       Redes        ║         Medio         ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ CoDeX ]
...
El principal añadido de UDP respecto a IP es el de direccionar los segmentos
...
cifrado de claves privadas desarrollado por IBM en los años 70, que fue
...
norma se ha evaluado durante muchos años y habia sido considerada solida,
...
2.-Sistemas de certificacion
  ...
  --El proceso de certificacion se lleva a cabo de la siguiente forma:
    ...
    la clave p·blica del usuario. De esta forma se garantiza que la
...
transmision. Un MAC es un mecanismo que calcula un ·nico valor a partir del
...
cuando se emplea esquema de cifrado de claves p·blicas. Se utiliza un
...
receptor utiliza la clave p·blica del emisor para descifrar la firma.

Dado que para verificar la autenticidad del mensaje se utiliza la clave
p·blica, las firmas digitales son mas versatiles que los esquemas MAC, en los
...
PEM (Privacy Enhanced Mail) es una norma de Internet diseñada para incluir
...
privadas y p·blicas para asegurar la integridad de los mensajes y añadirles
firmas digitales.
...
una fotografia sin que esta sufra ning·n tipo de alteracion o de muestras de
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║8.- ¡No dejes huellas!        ║      Hacking       ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                   [ IReick ]
...
son las siguientes:
   ...
   --Para evitar que te detecten al hacer un who ejecuta login con el mismo
     ...
     modificada, es decir, es algo mosqueante si tu desde España te conectas
   ...
   --Si cuando entras en la maquina ajena te encuentras con algo como "Last
     ...
     maquina donde estas, utilizando el mismo nombre de usuario y contraseña,
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║9.- Tecnicas de hacking       ║       Virus        ║         Bajo          ║
║    (sniffing y spoofing)     ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
ataque segudo por un pequeño ejemplo:
...
universitario que se ha currado un trabajo que se lo borren unos niñatos) por
si los necesitamos en un futuro... :)

Ahora os estareis preguntando.... ¿Y de donde coño saco yo un sniffer?
...
normales de la red y añade cierta informacion a las tranferencias. El
...
empresa es pequeña y solo tiene presupuesto para tres ordenadores, pero creo
...
**********************UN ATACANTE PRACTICANDO SFOOFING***********************
 ...
 (IP cliente 1)                        ▲                │     (IP cliente 2)
                                       ...
                                       ▼                └────────> ║       ║
                                    INTERNET                       ╚═══════╝ 
                      (Los cuatro PC's con la IP servidor)         ┌──┴─┴──┐
                                                                   └───────┘
                                                                    ATACANTE
                                                               (IP atacante)
...
************************ESQUEMA GENERAL DEL SPOOFING*************************
 ...
 ╔═══════╗                         ╔═══════╗                       ╔═══════╗
 ║       ║  ip atacante/ip server  ║       ║ ip server/ip victima  ║       ║ 
 ║       ║ <────────────────────>  ║       ║ <───────────────────> ║       ║
 ╚═══════╝                         ╚═══════╝                       ╚═══════╝ 
 ┌──┴─┴──┐                         ┌──┴─┴──┐                       ┌──┴─┴──┐
 └───────┘                         └───────┘                       └───────┘
...
CHARLANDO CON...: Esta seccion hace ya un tiempo que tenia pensado
                  ...
                  carismaticos de Undergr0und español (¡¡Buuf!! Que bien
...
Como habreis podido comprobar este 6º numero del E-Zine ha venido cargadito
...
saludar a la peña:
        ...
        -A toda la peña de #hacker_novatos, que se lo merecen:

                       http://hello.to/hacker_novatos        


        -A todos los que se esfuerzan por hacer que el Undergr0und en España
        ...
        -Y por que no un utimo saludo a todos los QuAkErS que hay en españa y
         en especial a la gente del Twistedl33t. 


¡Ostia! Se me olvidava, saludos a toda la peña del #delta, y en especia a
IReick que me esta ayudando mucho para completar los numero de 7A69 (este y
los siguientes).

Se terminaron los saludos por hoy, Que la fuerza os acompañe...
...
#       colaboracion de la peña de #ASM (venga a ver quien se anima).       #
#############################################################################
