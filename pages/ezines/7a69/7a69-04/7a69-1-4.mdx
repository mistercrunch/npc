...
║1.- Presentacion             ║                 ║             ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║           
║2.- Delta                    ║  Grupo de Hack  ║             ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║          
║3.- Introduccion a la        ║     Hacking     ║   Muy bajo  ║    Ripe     ║
║    ingenieria social II     ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
║4.- Introduccion a los virus ║     Viruses     ║   Muy bajo  ║   |CoDeX|   ║
║    II                       ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
║5.- Introduccion al UNIX II  ║     Hacking     ║    Bajo     ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║            
...
peña de NoD-Media, ye en especial a CoDeX que me esta ayudando mucho con
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║3.- Introduccion a la         ║      Hacking       ║       Muy bajo        ║
║    ingenieria social II      ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════1/4
                                                                     [ Ripe ]
...
&lt;Julia18>Me dijiste que eras del barça ¿no?
...
(si cres que se puede añadir algo... ripe@mixmail.com xD).
...
Ya hemos conseguido el loguin y el password de su cuenta de conexión a
...
Bueno, seguiremos con nuestro articulo sobre los virus con una peque±a 
...
2.- VIRUS DE FICHERO: Los virus de esta clase, utilizan los ficheros
    ...
    residente o de accion directa.
      --Virus de ficheros residentes: Nada mas tomar el control, el virus
        ...
        pequeña porcion de la memoria para poder "residir". El numero de
        bytes de memoria que un virus residente necesita reservar esta en
        funcion de su tamaño, que el la mayoria de los casos esta en el rango
        ...
        casos el comienzo de una serie de comportamientos extraños del
...
3.- VIRUS DE SOBREESCRITURA: La caracteristica principal de este tipo de
    ...
    su tamaño a no ser que el codigo del virus ocupe mas bytes que el del
    fichero infectado.
    ...
    virus se encargara de sacar un mensaje de error extraño, por lo que no se
...
4.- VIRUS DE COMPAÑIA: Este tipo de virus, que pueden ser residentes o de
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║5.- Introduccion al UNIX II   ║      Hacking       ║         Bajo          ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════1/4
                                                                     [ Ripe ]
...
en blanco con ese nombre). Segudamente voy a exponer un pequeño cuadro que
...
con VI", pues es bien facil: Primero introduviremos VI PRUEBA tras el
...
Bueno, para terminar una pequeña explicaccion de dd, si nosotros introducimos
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║6.- Introduccion al TCP/IP    ║       Redes        ║         Medio         ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════1/4
                                                                    [ CoDeX ]
...
1.- MODELO DE CAPAS: El modelo de capas se refiere a las distintas capas que
   ...
   "interface" (1 en cada nivel). Una interface es un conjunto de peque±as
...
2.- MODELO OSI: Es el modelo de referencia para la intercomunicacion de
 ...
 --Nivel Fisico: Define las caracteristicas electricas, mecanicas, ... 
                      ...
                      Sus funciones son: 
                         ...
                         ╖ El voltaje de las se±ales 
                         ╖ Duracion de los pulsos electricos 
                         ╖ Modulacion de la se±al (si la hay) 
...
por el Departamento de Defensa de los Estados Unidos a mediados de los a±os
70.
...
fichero de datos, lo primero que hace es partirlo en trozos peque±os 
...
infinita inseguridad de la seguridad") ya que intentare poner una diferente
en cada numero del e-zine. Asi que ya sabeis a pensar frases durante el
verano.

Saludos a la peña de #hacker #hacker_novatos a {{ScsiX}} (para que luego no 
digas que no te saludo). Estoi pensando en saludar tambien al LsD otra 
vez....

Bueno; adios lector y que la fuerza te acompañe.... (¿Donde habre oido yo
eso?)  xD
