...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║4.- Curso de C y C++ III      ║    Programacion    ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ IReik ]
...
repetiran un n·mero controlado de veces) en nuestros programas. Vamos a ver 
su formato:
...
relacion y l≤gicos, ej:<,<, ==, ||... (recuerdo que todos estos se vieron en 
