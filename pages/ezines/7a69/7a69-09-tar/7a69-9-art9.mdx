...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║9.- Buscadores y troyanos; la ║   Internet......   ║       Muy Bajo        ║
║    moda de Internet          ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                           [ Tahum & pollo1 ]
...
q esta acompañado del nombre "cliente" NO EJECUTES NUNCA EL Q ESTA NOMBRADO
...
esto sirve para poder cambiar el icono del troyano, poner contraseña de
...
1.- Entra en un canal en el q se use mucho el dcc, como por ejemplo el canal
    #fotos_guarras q es un canal en el q se envian fotos a puñados.
...
añadido una pequeña lista de algunos troyanos.

          &lt;Ripe: Debido al tamaño de la lista hemos decidido
