...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║6.- Algoritmo DES             ║    Criptografia    ║       Medio/Alto      ║  
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ Doing ]
...
Bueno, ya estoy aqui otra vez para daros el coñazo (jeje). Pues en este
...
descifrar en vez de encriptar y desencriptar, porque en español, encriptar
...
NOTA: el bit Nº1 corresponde al MSD, asi que los bits eliminados
son el 8, 16, 24, ...
*/
...
Un pequeño apunte: la clave tiene que ser de 8 caracteres.
