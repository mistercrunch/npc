...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║12.- Firewalls bajo LinuX     ║      Security      ║         Medio         ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                   [ Trycky ]
...
"make [b]zImage".La [b] es por si sobrepasa el tamaño , Para nucleo muy
llenos.
...
casi no lo he llegado a usar .Este documento acompaña un programa que echo yo
...
En la primera añadimos a la maquina ANGEL y ARCANGEL como que les aceptamos
