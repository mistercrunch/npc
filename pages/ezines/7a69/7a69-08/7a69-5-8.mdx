...
║─────────────────────────────║─────────────────║─────────────║─────────────║
║2.- Indice RaReGaZz [1-7]    ║                 ║             ║   Editor    ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║3.- Diseño grafico por       ║    Concurso     ║             ║   Editor    ║
║    ordenador                ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║4.- Curso de C y C++ II      ║  Programacion   ║    Bajo     ║   IReick    ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║5.- Curso de UNIX IV         ║     Hacking     ║    Bajo     ║    Ripe     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║6.- Shells, ¿Que coño es eso?║     Hacking     ║    Bajo     ║    DAn_^^   ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║7.- Charlando con            ║    Entrevista   ║             ║    Ripe     ║
║    - J.J.F. / Hackers Team -║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║8.- Entrañas de Internet;    ║     Hacking     ║    Alto     ║    Ripe     ║
║    Protocolos y demas       ║                 ║             ║             ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║9.- Seguridad en Linux       ║    Seguridad    ║    Medio    ║    Trcyky   ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
║10.- Sockets                 ║  Programacion   ║Alto/Muy alto║   Doing     ║
║─────────────────────────────║─────────────────║─────────────║─────────────║
...
¿Que decir? Je je, que la semana que viene cumplimos nuestro primer año. Un
año de publicaciones, y la cosa no ha terminado, de echo va mejor que nunca
...
Bueno, antes de empezar con este numero quiza que celebremos el primer año
...
3.- Comandos extraños para UNIX - Phrack
...
3.- Robando a la telefonica española - ???
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║3.- Diseño grafico por        ║     Concurso       ║                       ║
║    ordenador                 ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                   [ Editor ]

Desde la aparicion de los navegadores graficos (como EI, Netscape, Mozilla,
etc), el diseño grafico en las paginas web ha ido cobrando cada vez mas
importancia, y aun que si bien es cierto que aqui en españa las redes de
...
En 7A69 hemos pensado que no estaria de mas crear un concurso de diseño
...
------------------------
1.- Deben tener un tamaño inferior a 350x300 y su formato debe ser JPG o GIF
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║4.- Curso de C y C++ II       ║    Programacion    ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ IReik ]

Bueno, pues segunda entrega del pequeño curso de C o turbo C, esta vez vamos
...
Para declara run array simplemente hemos de añadir, entre corchetes, el
...
En este caso en el programa, al ajecutarlo tendriamos que añadir los tres
...
NOTA: Bueno, asi acabamos el punto 3, antes de continuar os podeis
      entreteniendo hacer algun pequeño programa, que por ejemplo calcule la
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║5.- Curso de UNIX IV          ║      Hacking       ║         Bajo          ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
Como podeis ver, al usar cada una de las variables, añadimos el signo "$"
...
¿Y como coño lo hago para borrar un directorio con archivos? ¿Tengo que 
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║6.- Shells, ¿Que coño es eso? ║      Hacking       ║         Bajo          ║  
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [DAn_^^]
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║7.- Charlando con             ║     Entrevista     ║                       ║
║    - J.J.F. / Hackers Team - ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]

Bueno, volvemos a estar aqui una vez mas, esta vez nos acompaña el
...
scene española (scene a la que sin duda le queda aun mucho trabajo).
...
5.- ¿Podeis contar alguna azaña vuestra (antes o despues de de decidiros por
    el hack blanco)?

     Lo de antes, queda en el pasado :) Y para ver nuestras
     actuales hazañas basta con visitar el web y ver nuestro
...
8.- ¿Como veis la evolucion que el Under Hispano esta  teniendo en los
    ultimos años?¿Puede compararse con lo que se puede encontrar en USA?

     En el ultimo año han aparecido tantos grupos y tanta
     ...
     producidas por españoles! ;-)


9.- Hablando de USA: ¿Que tal os va por alli?¿Cuando teneis pensado volver a
    España?

     Por aqui, va genial :) Y lo de volver a españa, personalmente
     por el momento no me interesa. Quiero estar aqui unos
     cuantos años mas. Seguir estudiando, trabajar y bueno
     ya sabeis... ;-)
...
13.- ¿Que proyectos personales teneis cada uno?
     ...
     sus frutos a lo largo de este año. Que estoy
...
16.- ¿Ofrece o ofrecera Roses Labs servicios comerciales?
     ...
     seguridad. Ya tenemos diseñados modelos de seguridad
     para pequeñas y medianas empresas, que se ajustan a sus
     ...
     mediados de año, no lo estaran. Todo a su debido
     tiempo.
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║8.- Entrañas de Internet;     ║      Hacking       ║         Alto          ║
║    Protocolos y demas        ║                    ║                       ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                     [ Ripe ]
...
NOTA: Como se puede ver en la capa de transporte se añade una cabecera, que
...
***************[ Resaltando la cabecera IP en el datagrama ]*****************
    ...
    ┌────────┬────────┬────────────────┬────────────────────────────────┐                       
    │        │ Tamaño │  Procedencia   │                                │
    │ Version│ de la  │                │      Tamañp del datagrama      │
...
¿Que coño es todo esto? segudamente vamos  responder esta pregunta explicando
...
2.-TAMAÑO DE LA CABECERA: (5 bits) El tamaño de la cabecera se mide mediante
                          palabras de 32 bits, si no se tratan opciones
                          especiales, el tamaño de la cabecera es de 5
...
4.- TAMAÑO DEL DATAGRAMA: (16 bits) Al igual que en el tamano de la cabecera,
...
tiene un tamaño demasiado grande? (esto puede suceder por muchos motivos;
tamaño del buffer insuficiente, el tamaño del datagrama supra al tamaño
maximo que el medio ficico puede aceptar, etc) Es entonces cuando se realiza
la fragmentacion, que consiste en dividir el datagrama en otros mas pequeños.
¿Y como se realiza esto? El proceso es el siguiente:

1.- El router recibe el datagrama y comprueba que su tamaño es demasido
...
4.- A cada uno de los trozos se les coloca la cabecera IP del datagrama
    original, pro modificando los siguientes campos.
        ...
        -Tamaño del datagrama, este pasara a ser el tamaño del nuevo
         datagrama.
...
simple, cada vez que el datagrama pasa por un router, se añade la IP de
...
ese caso dejara de añadirse IP's. ¿Para que puede servir todo esto? Pues
...
debe apañarselas de alguna manera para avisar al host de origen y decirle que
...
Terminamos aqui, seguiremos con las entrañas de internet en el proximo
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║9.- Seguridad en linux I      ║     Seguridad      ║         Medio         ║
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                    [ Trycky ]
...
passwd son por ejemp X|í>dfE2 , contraseñas to raras con conbinaciones de
...
echo por un español savage este programa lo que haze es mandar paquetes a un
...
Tambien Una pequeña descripcion del archivo de passwords :
...
facil editamos el fichero " /etc/ientd.conf " y le añadimos una entrada
diciendole que cuando se le pida una peticion a ese puerto muestre
directamente la bash o
si no nos hazemos un pequño programa que pida un passwd y depues nos lanze a
...
responderte es el retardo que tienes o lag (si señor a sin se averigua el lag
...
Si queremos nostros añadir una opcion basta con poner primero que tipo de
...
los errores a la terminal 10 se puden añadir mas cosas poniendo ; y la accion
...
se dirigira directamente a la IP que le indiques , O si no añadimos la ip .
...
usando el Kvirc , exactamente la version 0.9.0 hay un pequeño bug que permite 
...
contraseña a la bios . pero quitandole la pila se resuelve el problema otra
solucion es poniendole una contraseña al lilo doy por echo de que sabeis lo
que es lilo de la siguiente forma poniendo password=contraseña dentro de cada
imagen que quisieramos proteger por ejemplo si queremos poner contraseña a
nuestras imagenes del linux pero dejando la del guindows sin contraseña para
...
linux por lo que si quiero proteger otra tendria que añadir otra linea de 
...
niñoooo que estas viendo y te suelten ostias , Fuera de bromas pero la mayor
...
es desde añadir los host permitidos con el comando xhost + nombre_de_la_makina
...
en una makina monousuaria que confiamos del dueño pos si vale pero si mas
...
comillas son para señalar el comando).
...
www.segurinet.org  ; Hay unos documentos mu majos y que me han ayudado en
                     algo.
www.hispasec.org  ; Pagina de seguridad Española .
...
www.linux.apostols.org ; Pagina de un Grupo de Gurus del Linux Españoles .
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║10.- Sockets                  ║    Programacion    ║     Alto/Muy alto     ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
                                                                      [Doing]
...
NOTA: Este articulo esta dirigido a todas aquellas personas que estan
      ...
      E-Zine, y en el articulo "Entrañas de internet; prootoclos y demas"
...
leyendo. ¿Que coño es un socket? Un socket sirve para conectarte al IRC, para
...
Si no sabes programar en C no se que coño haces leyendo esto, asi que ponte a
...
Cuando otro socket conecta con el socket del bouncer, Θste abre otra conexion
...
para el programador (o sea t·) esto es completamente transparente. Hay veces
...
2.-EL MALDITO PHREAK: Parece que en españa los pheakers escasean, aun que
...
5.- CONCURSOS: Como ya habreis podido leer hemos organizado un mini-concurso
               de diseño grafico, dependiendo de la partizipacion que haya
               en este primer concurso organizaremos algunos mas como:

                        -Imagenes ASCII
                        -Virus
                        -Relatos relacionados con el Undergr0und
                        -Miss España 2000 (Ups! esto ya existe :P)
...
de este tinglado, ademas de una pequeña apliacion, jejeje, aqui os dejo el
texto:
...
modelo mejorado de "chapa". Esto me lo comento un compañero de mi clase,
aunque luego lo vi en un e-zine de Paradigma. Mi compañero dice q funciona
...
desde el podemos marcar lo que deseemos, incluidos prefijos de compañias.
...
añadiendo un par de comentarios de los que se deduce que los hackers eran
...
El dia 23 de Enero, la segunda de television española (TV2) nos sorprendia en
...
En el repontaje pudimos ver a conocidos individuos de la scene española, como
NetSavage, Underface, GriYo, MindTwist (hehehehe), entre otros. El programa
empieza con una pequeña introduccion al hack mediante el diario virtual que
...
Mallorca el año pasado (la No Con Name) organizado por los miembros de
...
con una entrevista al hacker español mas conocido, GriYo (ver seccion
...
Hay que reconocerle a Television Española el valor por realizar un amplio
...
indicaciones de la compa±ia lo cierto es que puede recuperarse la moneda
...
(cosa muy rara en los productos de la compañia de Gates).
...
piratas que a lo largo de un año eleva las perdidas de las multinacionales
...
NOTA: Si en una año aprenden que es un sniffer ya estaran contentos, hehehe.


------------------------{ Detenido por chantaje }----------------------------
-----------------------------------------------------------------------------

En francia ha sido detenido un joven de 36 años por chantajear a un banco. El
joven habia disea±do una targete credito mediante la que podia sacar la 
...
chico que entr≤ el otro dφa en el chat de #hacker 
...
Te escribφa para decirte que 
aunque la revista estß muy bien hecha pues hay algunas 
cosas que no entiendo. Ej: te pones a hablar de el TCP/
IP y empiezas a hablar de 7 partes, y es que yo soy 
incapaz de visualizar esas 7 partes ┐donde estßn?┐partes 
...
no me entra ne la cabeza)
	...
	&lt;Ripe: Esto del |CoDeX| que lo escribio,
	       ...
	       "Entra±as de internte; protocolos
               y demas" de este mismo numero :P>

Otra cosa que te querφa 
comentar es un problemilla que tengo. Verßs, yo uso un 
Mac, (que dirßn lo que quieran, pero para mi es sagrado) 
y da la casualdad de que la tienda en que lo adquirφ 
vende uniocamente Mac's SCSI. Como comprenderßs a mi eso 
de SCSI o lo que sea me la resbalaba cuando lo adquirφ 
(para mi era un Mac como otro cualquiera), pero cuando 
en una de las revistas que suelo comprar de Macintosh 
(MacWorld) vφ que incluφan el MkLinux (es parecido al 
...
poder instalßrmelo. Ahora resulta que empiezo a saber 
algo y como s≤lo conozco un hacker que use Mac (ICEFIRE, 
que ha desaparecido)y ya nunca le veo pues no tengo 
ninguna utilidad de hackear.Lo siento si te he dado el 
co±azo, pero es que necesito una soluci≤n.
...
TambiΘn te querφa decir que 
estoy acabando de hacer mi pßgina web (http://
members.es.tripod.de/Attanar y que me gustarφa incluir 
tus revistas en ella, aunque no tenga mucha relaci≤n con 
ese tema)

	   &lt;Ripe: No proble. Tu mete mete>

Nada mßs, solo darte las 
gracias por tu atenci≤n, pedirte que me respondas (a ser 
posible contestando mis dudas) y hacerte entrega de unas 
de esas frases que tanto reclamas, no se si tienen 
alguna relaci≤n con lo que t· quieres, pero son poΘticas 
XD.

Nos las da el profesor de 
"transici≤n a la vida adulta y activa"

ò "No tengas miedo a ir 
despacio, tan solo tenlo de quedarte parado" - proverbio 
chino

ò "S≤lo las personas que han 
recibido esucaci≤n son verdaderamente libres" - Epφcteto

ò "Casi todo lo grande ha sido 
llevado a cabo por la juventud" - Disraelφ (un tφo 
listo)

ò "La vida es como un arca 
inmensa llena de posibilidades" - Amando Nervo

ò "Los mejores artistas son 
los que hacen una obra de arte con su propia vida"


- G. Mateu

ò "F≤rmate t· en vez de 
esperar a que te formen y te modelen" - H. Spencer

ò "Un matemßtico que no es 
tambiΘn un poco poeta no serß jamßs un matemßtico 
completo" <---- Atenci≤n a esta, parece tonta pero tiene 
...
Bueno, hemos cumplido un año (BIEEEEEEEEEEEEEEEEE), que decir..... Esperamos
...
yo me se), pero trataremos que {7A69} #9 salga dentro de 1 mes y medio (íeh!
que conste que no aseguramos nada :P).

Bueno, nada mas, nos vemos dentro de..... 1 mes y medio, ehehe.

ííOstia!! Que se me olvidan los saludos....
