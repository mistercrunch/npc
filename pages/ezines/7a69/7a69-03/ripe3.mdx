...
╚═════════════════════════════════════════════════════════════════╦═════════╣
Bajate cualquiern numero de R|p3HACK en:                          ║ By Ripe ║
...
║    ingenieria social         ║                    ║                       ║
║──────────────────────────────║────────────────────║───────────────────────║
║4.- Introduccion a los virus  ║      Viruses       ║       Muy bajo        ║
║──────────────────────────────║────────────────────║───────────────────────║
║5.- Introduccion al UNIX      ║      Hacking       ║         Bajo          ║
║──────────────────────────────║────────────────────║───────────────────────║
║6.- Despedida                 ║                    ║                       ║    
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
...
pequeño grupo de Hack (que por cierto es mas grande que antes, ¡Ya somos 9!)
...
Este texto, como el titulo bien indica va a ser unicamente una pequeña
...
Entre las posiblidades que abarca esta tecnica esta el engañar a una persona
...
trabajando en un bar, que tiene 21 años, que le gusta el futbo y que es del
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║4.- Introcuccion a los virus  ║      Hacking       ║         Bajo          ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
...
1.- QUE ES UN VIRUS? Con el termino "virus", se designa un programa de
    ...
    Es capaz de generar copias de sφ mismo de forma homogΘnea o en partes
    ...
    cualquier programa ejecutable. Esta caracterφstica supone que para que
    ...
    la que ha sido programado, completando asφ la segunda fase de
    funcionamiento.
    Por ultimo, cabe destacar que un virus se dise±a intentando disfrazar su
    ...
    derivado de su ejecucion que da la se±al de alarma.
    ...
    informacion almacenada en el soporte magnΘtico.
    ...
    de respuesta del ordenador, lo que significa una pΘrdida considerable de
...
2.- COMO Y PORQUE SE DESAROYAN LOS VIRUS? La tendencia de facilitar al maximo
    ...
    programas shareware, se obtienen pagando una pequeña cantidad de dinero.
...
3.- COMO SE CREA UN VIRUS? En principio cualquier herramienta de programacion
    ...
    pequeño tamaño y tratan de contener el maximo codigo en el minimo
    espacio.
...
║         * ARTICULO *         ║      * TEMA *      ║       * NIVEL *       ║
║──────────────────────────────║────────────────────║───────────────────────║
║5.- Introcuccion al UNIX      ║      Hacking       ║         Bajo          ║     
╚══════════════════════════════╩════════════════════╩═══════════════════════╝
...
¿Que coño es todo esto? Pues en la ultima columna se nos mustran los nombres
