...
podemos acceder, pero hacedme caso, no servirá para nada.
...
será una universidad. El unico problema que tiene esto es que no podemos
...
Este otro os hará root en los ssoo con el sendmail 4.x
<-------------------------------CORTAR AQUI---------------------------------->
#!/bin/sh
...
demasiadas veces, pondrá nombredeusuario Never Logged In , osea es como si
...
rara ) no está de mas ponerlo para futuros "trabajos".
