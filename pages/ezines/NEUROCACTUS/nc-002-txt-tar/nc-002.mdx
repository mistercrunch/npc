...
```
  ...
  └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘
                               ...
                               ╔══════[2]═══════════════════════╗
                            ┌──╢ APPEND TO YOUR MESSAGE.        ║
         Leaving a message  │  ╚════════════════════════════════╝
         ╔═══════════════╗  │  ╔══════[3]═══════════════════════╗
         ║ ENTER MESSAGE ║  ├──╢ DISCARD MESSAGE AND RE-RECORD. ║
         ╚═══════╤═══════╝  │  ╚════════════════════════════════╝
         ╔═══════╧═══════╗  │  ╔══════[7]═══════════════════════╗
         ║   MAIN MENU   ╟──┼──╢ REVIEW YOUR MESSAGE.           ║
         ╚═══════╤═══════╝  │  ╚════════════════════════════════╝
         ╔══════[*]══════╗  │  ╔══════[8]═══════════════════════╗
         ║ WELCOME xXxXx ║  ├──╢ MARK MESSAGE AS URGENT.        ║
         ║ PLEASE  ENTER ║  │  ╚════════════════════════════════╝
         ║ YOUR  MAILBOX ║  │  ╔══════[9]═══════════════════════╗
         ║ PASSWORD .... ║  ├──╢ DELIVER MESSAGE AND EXIT.      ║
         ╚═══════╤═══════╝  │  ╚════════════════════════════════╝
         ╔═══════╧═══════╗  │  ╔══════[0]═══════════════════════╗
         ║ SEE PART NO 1 ║  └──╢ DELIVER AND TALK TO OPERATOR.  ║
         ╚═══════════════╝     ╚════════════════════════════════╝
  ...
  └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘
   ...
   you would type 201* 1008*.  At any rate, it's not very hard to figure
                  ├─┘  └──┤  out and  the  benifits  are  numerous.  For
   >─State─Code─>─┘  ┌────┘  instance, one of the nice things you can do
   >─Box─number─>────┘  (if you know what you're doing)  is make a daisy
  ...
  └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘
   ...
   Trilogue Executive Fax box
         ...
         (1)             ╚══════════╤═════╝                      (2)
 ╔════════╧═══════════╗         ╔══(3)═══╗                    ╔═══╧══╗
 ║ Listen To Messages ║     ┌───╢ Modify ╟────────────────────╢ Send ╟──────┐
 ╚════════╤═══════════╝     │   ╚════════╝                    ╚══════╝      │
          │                 │                                               │
   ╔══════╧════════╗        │   ╔═══════════╗                               │
   ║ Play Messages ║        ├(1)╢Alternative║                               │
   ╚══════╤══════╤═╝        │   ╚═══════════╝                               │
          │     (*)         │                                               │
          │      │          │                                               │
┌─────────┘    ╔═╧═══════╗  │   ╔══════════╗   ╔════════╗                   │
│              ║ Receive ║  ├(2)╢Forwarding╟─┬─╢1 Urgent╟─┐                 │
│              ║   Fax   ║  │   ╚══════════╝ │ ╚════════╝ │                 │
│    ╔══════╗  ╚═════════╝  │                │ ╔════════╗ │                 │
├(2)─╢ Reply║               │                ├─╢2 All   ╟─┤ ╔═════════════╗ │
│    ╚══════╝               └──────┐         │ ╚════════╝ ├─╢1 Main Phone ║ │
│                                  │         │ ╔════════╗ │ ╚═════════════╝ │
│    ╔════════╗ ╔═══════╗ ╔════╗   │         └─╢3 None  ║ │ ╔═════════════╗ │
├(3)─╢Transfer╟─╢Comment╟─╢Send║   │           ╚════════╝ └─╢2 Alternative║ │
│    ╚════════╝ ╚══╤════╝ ╚════╝   │   ╔════╗               ╚═════════════╝ │
│             ╔════╧═════════╗     ├───╢List╟─┐                             │
│             ║Record Comment║     │   ╚════╝ │  ╔════════╗                 │
│             ╚══════════════╝     │          ├──╢1 Modify║                 │
...
└(6)─╢ Next ║                                │   ╔═════════╗ │└─╢3 Delete ║ │
     ╚══════╝                                ├(2)╢  Voice  ║ │  ╚═════════╝ │
  ╔══════╗                    ╔══════════╗   │   ║Signiture╟─┘ ╔═══════════╗│
  ║ Non  ║     ╔══════╗       ║   Auto   ║   │   ╚═════════╝   ║Destination╟┘
  ║ Conf.╟(1)┬─╢ Type ╟─(1)─┬─╢ Transfer ╟(3)┤                 ╚═════╤═════╝
  ╚══════╝   │ ╚══════╝     │ ╚══════════╝   │     ╔═════════╗    ╔══╧═══╗
  ╔══════╗   │              │ ╔══════════╗   │     ║ Add fax ╟(3)─╢Record║
  ║ All  ╟(2)┤              │ ║ Password ╟(4)┘     ╚═════════╝    ╚══╤═══╝
  ╚══════╝   │              │ ╚══════════╝                          (*)
...
╚═════╝    ╚══╤═══════╝                                 ║ Delivery  ║    │
              ...
              │                            ║ Urgent ╟─┐ ╚═══════════╝    │
          ╔═══╧═══╗  ╔════════╗            ╠════════╣(1)─┐  ╔═══════╗    │
          ║ Start ╟──╢ Finish ║            ║ Reply  ╟(2)─┼──╢ Class ╟─(2)┤
          ║ Time  ║  ║ Time   ║            ╠════════╣(3)─┘  ╚═══════╝    │
          ╚═══════╝  ╚════════╝            ║ Delete ╟─┘                  │
                                           ╚════════╝                    │
   Original By «The Pick» for TVMBT docs                     ╔══════╗    │
   Modified to exec fax by Minnow                            ║ Send ╟─(3)┘
                                                             ╚══════╝
  ...
  └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘
   ...
   ──══ ACT II: Rendezvous, Scout & Penetration ══──
   ...
   ──══ ACT III: Hopper Inspection Time ══──
  ...
  └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘ └┼┘
   ...
   █ ──── █ █ █ █▀▀  █  █ █▀▀▄ █  █ █  ▄ █▀▀█ █  ▄   █ █  █  ▀▀▄ ──── █│
   █▀▀▀▀▀ ▀  ▀  ▀▀▀▀  ▀▀  ▀  ▀  ▀▀   ▀▀  ▀  ▀  ▀▀    ▀  ▀▀  ▀▀▀  ▀▀▀▀▀█B
   █        ─ Minnow ─ Grudge ─ «The Pick» ─ Scourge ─ Blade ─        █b
   █             ─ Deicidal Maniac ─ FreeStyle ─ RíPMàX ─             █s
   █▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█┘
