...
```
              ...
              [ Mind Warp  -  Volume #5, Issue #08, File #079 ]
...
------------------------------------------------------------------------------
   ...
   Yeah, yeah..it's short.  You want more Mind Warp?  Give us articles.
Next issue will have MY music reviews...I didn't have time to finish them.
Got two new writers...check em out.  Raven is back...did you get my tee-shirt
buddy?  BTW- Mind Warp Tee-Shirts!  E-Mail Mustaine for info...REAL CHEAP.
Two new writers, Squid, and Ninja-Man Bob.  Welcome them with open arms.
...
Hell's Kitchen                  301-989-8510 28.8k          Hell Raiser
------------------------------------------------------------------------------
...
** New **     
     Distribution Info:  Because we started getting complaints, the 
distribution information has been updated, and most likely will NOT be
changed again.  Please, we emplore you to distribute these articles all
you want, but just keep the files in the format of MW!-XXX.TXT where XXX is
a file number that is *already* on there.  Most often these files will be
archived by volume, and we ask you to also keep it in the same format, which
as of now will be MW_XXXX.AAA, where XXXX is the volume number, and AAA is 
the default archive extension (ex. ZIP,ARC,ZOO,LZH,ARJ,UC2, etc...).  These
files are *copyrighted*, and we ask that you do *not* reproduce, whether in 
