...
APENDICE 1: Listado de los estßndares de Internet.
#########################################################################################
...
0009 File Transfer Protocol. J. Postel, J. Reynolds. October 1985.
     (Format: TXT=148316 bytes) (Updated by RFC2228, RFC2640) (Also
     RFC0959)
...
0012 [Reserved for Network Time Protocol (NTP). See RFC 1305.]. (Not
     online)
...
0015 Simple Network Management Protocol. J. Case, M. Fedor, M.
     Schoffstall, J. Davin. May 1990. (Format: TXT=72876 bytes) (Also
     RFC1157)
...
0039 [Was BBN Report 1822 (IMP/Host Interface). Now Historic.].
     December 1981. (Not online)

0040 Host Access Protocol specification. Bolt Beranek and Newman.
     August 1993. (Format: TXT=152740 bytes) (Also RFC0907)
...
0050 Definitions of Managed Objects for the Ethernet-like Interface
     Types. F. Kastenholz. July 1994. (Format: TXT=39008, bytes)
     (Obsoletes RFC1623, RFC1398) (Also RFC1643)
...
0058 Structure of Management Information Version 2 (SMIv2. K.
     ...
     TXT=89712 bytes) (Obsoletes RFC1902) (Also RFC2578, RFC2579)
