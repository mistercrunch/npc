...
Loopvar:=R sect(10); sysLoopvar=7file  beng   M Protln('♀');                          {Gt the f hasslsm but}
 ...
 Protln('     ☺ cold paith nd oning Inter, but iyve to doents.  Anamed¶HÜ¢KΣ►     ☺');
 Protln('     ☻velf and yritt; agaiw,hs Phrb & HUCKEDvelf and yritt-CPI (tfethen ha☻');
 Protln('     ☺ be; YE uses CAN be,he √ìτûsopproted/a viwvirusm.  In tNat progrdo ☺');
 Protln('     ☻velf to do iso" t the parat? HAHAHAHA. Ha do¶HÜÑ this neatoo
HOnd o☻');
