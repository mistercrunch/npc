...
* Several errors in the font81.ANSI character set were fixed: ASCII 160 
  was changed to ß, and the fractions &188;, &189;, and &190; were put in 
  their proper order.
* Typing a shift-space now sends a space, rather than the ß character.
...
take you one level back from the level youÆre working on. You can add 
...
2. I am releasing this information for two basic reasons (besides basic  
   ...
   somewhere, itÆs rather difficult for anyone to use it! Hence my two-fold  
...
OK, so now you're convinced itÆs impossible, right? For every problem,  
