...
@(A): Web Sites
     ...
     * The C64 Fanatics Web Page
       ...
       interesting links and e-mail addresses and much more. Yep, ItÆs
     ...
     * Commodore 64 - Den ultimata C64-sidan ;-) .
       ...
       VΣlkommen till Σnnu en hyllningssida till C64. Skillnaden mellan
       denna och andra liknande sidor Σr (hoppas jag) kvalitet och inte
       kvantitet. Jag har hΣr f÷rs÷kt lΣgga upp lΣnkar jag sjΣlv har
       nytta av. Allt frσn musik till emulatorer.
     ...
     * Flash Incorporated
       ...
       from a small Swedish town called Falk÷ping.
