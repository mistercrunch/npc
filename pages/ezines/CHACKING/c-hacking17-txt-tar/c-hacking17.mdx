...
6076   FDA3 85 C1       	STA STAL	;clear I/O start addressà
6077   FDA5 85 97       	STA REGSAV	;àregister save
6078   FDA7 8D 81 02    	STA OSSTAR	;àand start of OS memory ptr
...
6094   FDBE             
6095   FDBE A4 C2       	LDY STAL+1	;done testing,get RAM top MSBà
6096   FDC0 A6 C1       	LDX STAL	;àand LSB
...
6111   FDD4 8D 82 02    	STA OSSTAR+1	;at $1200à
6112   FDD7 A9 10       	LDA #$10	;àand screen starts at $1000
...
6278   FE96 91 C1       	STA (STAL),Y	;save ità
6279   FE98 D1 C1       	CMP (STAL),Y	;àand compare
6280   FE9A D0 08       	BNE MEMTS1	;not equal
6281   FE9C             			;pattern compares OK
6282   FE9C 6A          	ROR A		;%10101010 invert pattern
6283   FE9D 91 C1       	STA (STAL),Y	;save ità
6284   FE9F D1 C1       	CMP (STAL),Y	;àand compare
