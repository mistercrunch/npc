...
lasciatemi dire che sono molto contento dal momento che il traguardo di 10 uscite di una e-zine non Φ
...
detto fatto :-)))
                                         DISCLAIMER
I redattori e collaboratori di Netrunners non si assumono alcuna responsabilitα per le azioni od 
...
mpa non pu≥ essere soggetta a limitazioni o censure".

Direi che come disclaimer possa andare no?? :-)))
Ok...salto la tradizionale presentazione degli articoli, dal momento che sono tanti e cos∞ interessanti
...
nel tradizionale formato txt ed in HTML . Ci≥ Φ dovuto al fatto che i nostri collaboratori spesso
...
L'altra sera ho ricevuto da Vecna (che saluto affettuosamente) una critica per come Φ formattata la ns
e-zine. Notoriamente io sono molto aperto alle critiche, solo per≥ quando sanno essere costruttive. Mi
...
Inoltre, con nostro sommo piacere, sia RigoR che Nick1 sono ritornati a farsi vivi un p≥ pi∙ spesso.
Grazie ragazzi....sentivamo la nostra mancanza :-)))) (chissα quando si deciderα a ritornare Chrome
hihihihihi).
Annuncio anche, dopo diverse peripezie, la riapertura ufficiale del famoso FTP degli SPP, dove Φ 
contenuto ogni ben di Dio, compresa una rarissima immagine ISO del SignalOS....il tool indispensabile
per l'hacker di successo (detto cos∞ sembra un profumo....cmq...il concetto Φ quello :-))).
Ed infine, con nostra somma gioia, annunciamo che la famiglia SPP si Φ accresciuta, con ben tre
nuove entrate. Innanzitutto 2 Spippolatori grandi e grossi, che tutti giα conoscerete, ovvero ErGoline
e Nob0dy88, ai quali facciamo i migliori auguri e speriamo che si trovino bene con noi. E poi, evento
lietissimo, una piccola SpiPPolAtRiCe.....la piccola Giorgia che Φ venuta ad allietare la casa del
...
M:9:G"J3%%!GKOQQ:"04+N496B)HI^#/&lt;V=M`',9BL`&#9U7*_.PFK,PDM;A/
...
Forse questo sarebbe un valido argomento di discussione per una tavola rotonda, ma ci tengo a dire quattro parole rivolte soprattutto a chi non Φ un grande esperto e si sente ripetere da tutti "Installa Linux, winzoz non serve a niente". Cercher≥ d'essere imparziale verso entrambe le piattaforme, cercando di descriverne, a larghe linee, i principali svantaggi e vantaggi. Diciamo pure che il 90% (se non di pi∙) degli utenti utilizza Windows (NT, 95, 98 ecc...) quindi, per uno smanettone Φ indispensabile conoscere il sistema operativo maggiormente diffuso. Il fatto che un po' mi dα fastidio, Φ che la maggior parte delle persone che sostiene che "Windows fa schifo", Φ costituita da inesperti che si lasciano trascinare dalle idee degli altri. Prima di affermare una cosa del genere almeno bisognerebbe saper programmare e conoscerne abbastanza bene il funzionamento. Io di musica non ne capisco un cappero, perci≥ posso solo dire che preferisco un autore ad un altro perchΘ + motivo, ma non che l'altro sia meno o pi∙ bravo. Sono entrambi dei sistemi molto validi, ma completamente opposti. Ognuno ha i suoi vantaggi e svantaggi. La cosa migliore sarebbe quella di averli entrambi in due partizioni separate. A proposito di questo discorso, mi Φ venuta in mente un'altra questione che spesso m'irrita hehehe. La stragrande maggioranza degli utenti decide di installare Linux lo fa perchΘ si Φ stufato di Windows. L'altra parte invece desidera conoscere nuove cose, poichΘ conosce giα un altro sistema approfonditamente. Beh, ogni individuo appartenente alla prima categoria, subito dopo essere riuscito ad installare il nuovo amico, si ritrova nei guai perchΘ non pu≥ usare la shell grafica dato che Linux non gli supporta la scheda e vari altri componenti hardware (ora comunque la situazione sta rapidamente cambiando!). Il bello Φ che Unix non Φ nato per essere un ambiente grafico, ma uno simile (solo per aspetto) al vecchio disk operating disk (il dos insomma). Ma allora perchΘ installare un altro sistema? Per farlo assomigliare a quello che giα si ha, aggiungendo nuovi e pi∙ complessi problemi? Chi usa la shell grafica vuole evidentemente la comoditα e maggior semplicitα. Per leggere il contenuto di un floppy bisogna scrivere un libro, Φ pi∙ facile perci≥ farci click sopra. Ma questa non Φ una caratteristica (la pi∙ importante) del prodotto della Microsoft (a dire la veritα, a sua volta copiato dal mac)? Anche io ho usato per un p≥ Linux e mi sono subito imbattuto in una shell dove appariva addirittura anche il men∙ d'avvio (stesso discorso per kde). Quello che voglio dirvi insomma Φ di non fare le cose solo perchΘ sono gli altri a dirlo, spesso, infatti, si dice "Windows, ma che ci fai? Installa Linux!" solo per far vedere che si Φ bravi. Per usare questa piattaforma occorre un'ottima conoscenza dei prottocolli, di C e una voglia di imparare e di tempo libero infinitamente grandi. Ultima considerazione antinewbiecredulone: non Φ vero che Linux possa fare delle cose su Internet che Win non sia in grado di supportare. E' una menzogna. Infatti tutto dipende dai vari protocolli (TCP, UDP, IP, SMTP...) e non dal sistema. Ad esempio molti credono di dover usare per forza Red Hat o fratelli per usare lo spoofing. Errato: provate a dare un'occhiata alla dll winsock.dll C'Φ il raw tcp, ovvero l'arte del forgiare i pacchetti a mano. Tutto si pu≥ fare, basta saper programmare. Ora che ho finito questa specie di introduzione, possiamo passare avanti.
Linux vs Windows: la stabilitα. Qui c'Φ parecchia roba di cui parlare. C'Φ poco da commentare per quanto riguarda Linux, che Φ sicuramente pi∙ stabile sia di NT, che di 95/98. Unix non si blocca mai, neanche se lo pestate o se date una martellata all'hard disk :-) Window95/98 in questo campo hanno i loro problemi. Molte volte il sistema crasha o diventa instabile. PerchΘ? Beh, perchΘ la Ms ha deciso di sacrificare questo fattore a favore della semplicitα d'uso. Sappiamo benissimo che questo sistema riconosce una vastissima gamma di componenti e li rileva automaticamente e inoltre supporta anche direct x e varie altre funzioni. Linux non fa nessuna di queste cose. Inutile ripetere quanto spesso risulti difficile installare del nuovo hardware o aggiornare il sistema operativo stesso. Win costa una bella cifra, mentre l'altro Φ gratuito, fattore cruciale. WinNt Φ un po' pi∙ stabile e ha, anche se in minor parte, gli stessi problemi di Linux. Staremo a vedere cosa succederα con il nuovissimo Windows 2000. Qui il vincitore Φ Linux (che batte 5-0 Win95/98, 1-0 WinNT), ma gli altri aspetti non sono assolutamente da sottovalutare. Dipende insomma dai propri gusti e dalle proprie esigenze. Ad esempio per quello che io faccio col pc preferisco il prodotto della casa di Redmond.
Il supporto: Linux in questo campo Φ pessimo. WinNT non molto migliore, Win95/98 superiore ad entrambi. Il discorso per≥ Φ uguale a prima. Se non ci tenete a giocare con Half Life with Matrox G400 e non possedete un pc ultimo modello, anche Linux pu≥ andare, visto che non sarebbe un ambiente grafico. Stessa cosa: dipende dai propri gusti. (Win95/98- Linux = 5-0), (Linux-WinNt = 
0-1).
Richiesta di risorse: nulla da dire. Linux gira su un 386, a Win95/98 occorre il quadruplo d'ogni cosa. WinNT un po' meglio di Win95, ma sicuramente peggiore dello sfidante diretto. E' un fattore determinate se siete in possesso di un pc vecchiotto, Φ irrilevante se avete un processore superiore ad un Pentium 200 "liscio". 
La facilitα: terreno ostico per Linux, che Φ vinto da Win 10 a 0. Ma questo non significa niente, perchΘ noi desideriamo imparare un altro sistema (dato che l'altro, sto facendo un discorso teorico, lo conosciamo) e se Φ difficile meglio! Sarα pi∙ stimolante ;-) Altri aspetti non mi vengono in mente, ma il concetto base e che nΘ uno nΘ l'altro Φ migliore, perchΘ dipende dalle proprie esigenze. Io consiglio di iniziare con Windows e di imparare a conoscerlo abbastanza approfonditamente. E' inutile imparare due cose in malo modo. Meglio salire i gradini uno per volta. Ci vuole molto tempo per capire Windows. Quanto? Beh, quando saprete creare un'applicazione con pi∙ thread, usare file mappati in memoria, semafori, mutex e usare le API della dll gdi, allora potrete passare a Linux. E poi non abbiamo nemmeno accennato ad altri sistemi, che forse sono anche loro molto validi (anzi, lo saranno sicuramente), semplicemente perchΘ io non li ho mai usati. Sto parlando di Os2 (per gli anti-ms: lo sapevate che Os2 Φ frutto del lavoro di Microsoft ed IBM?), Mac (vabbΦ, questo Φ pi∙ di un sistema, ma siamo semplicistici), BeOs, Solaris... Insomma, Linux versus Windows Φ solo un capitolo, ci≥ che vi ho voluto dire Φ che dovete ragionare con la vostra testa (e perci≥ non fidarvi sempre degli altri) e di imparare le cose un po' per volta. Se conoscere vi piace, il tempo lo troverete.
Spero di non avervi fatto incavolare pi∙ del dovuto :-) Ciao e buona riflessione.
...
La crittografia come modifica volontaria del testo esisteva giα al tempo
...
parola correlata Φ steganografia che significa scrittura nascosta. Un
esempio legato all'antichitα Φ di scrivere messaggi segreti non
...
(che costituirα la chiave di decodifica). Una volta scritto il messaggio in
...
metodo Φ di trasposizione perchΦ il messagggio Φ in chiaro ma l'ordine
delle lettere Φ da scoprire.

Un altro metodo, questa volta di sostituzione, Φ stato inventato da Giulio
Cesare: la chiave Φ un numero n stabilito e si sostituisce ogni lettera del
messaggio con l'ennesima seguente.
Esempio: pippo con chiave 3 diventa snssr.
Questo metodo Φ facilmente attaccabile perchΦ basta confrontare la
...
scovare la chiave. Data la bassa complessitα [tanto bassa non Φ, numero di
combinazioni possibili: 26!=4*(10^26)] del metodo usato da Cesare Φ chiaro
che non fosse infallibile, ma dati i risultati militari Φ stato efficace!
Il metodo di Cesare ha ispirato un sistema usato ancora oggi, il ROT-13
dove la chiave Φ appunto 13, quindi A->N, B->O, etc.

Il metodo che usavano gli ebrei Φ detto ATBASH. La sostituzione avviene
...
Lo storico greco Polibio invent≥ una tecnica di codifica legando le lettere
...
alfabetico si capisce la difficoltα di trovare la chiave che in questo caso
Φ la tabella.
...
Se la somma (valore cifrato) eccede 21 si ricomincia dalla a; ci≥ equivale
a fare una somma modulo 21.
La decifrazione Φ una semplice sottrazione.
La criptoanalisi di questo metodo non beneficia della frequenza delle
lettere della lingua usata. Questo metodo pu≥ essere attaccato con un brute
force utilizzando un dizionario di parole. Ovviamente ci si pu≥ difendere
...
un metodo chiamato One-Time Pad, che Φ difficile da superare senza
conoscere la chiave e generando in maniera "davvero" casuale la chiave (e
non Φ facile perchΦ si pu≥ ottenere solo osservando fenomeni casuali
naturali). Occorre notare che non bisogna usare questo metodo per due
diversi messaggi con la stessa chiave perchΦ la differenza tra testo
cifrato e testo in chiaro Φ uguale e, in unione a un bruteforce, aiuta di
...
crittografia.
L'idea part∞ dall'osservazione che un criptoanalista pu≥ essere aiutato
dalle caratteristiche di una lingua come le frequenza delle lettere, le
sillabe impossibili o pi∙ frequenti, le sequenze di lettere caratteristiche
come le desinenze. Per rendere pi∙ difficile il lavoro del criptoanalista
altro non c'era da fare se non cambiare durante il procedimento l'alfabeto
da cui pescare la lettera cifrata: questo Φ il sistema polialfabetico.

Altro esempio di cifratura con il sistema del polialfabeto Φ quello
...
si usa cos∞: la prima lettera da cifrare rimane la stessa, la seconda si
cifra con il secondo alfabeto, la terza lettera userα il terzo alfabeto e
cos∞ via fino a ricominciare dal primo alfabeto dopo la ventiseiesima
lettera. Per rendere difficile il lavoro dei criptoanalisti si pu≥ usare un
alfabeto disordinato o, meglio ancora (Φ pi∙ facile da ricordare e
comunicare al destinatario del messaggio) una frase chiave.

L'uso della criptografia continua intensificandosi sempre di pi∙ e
...
Cos∞ non successe, perchΦ inglesi e polacchi unendo le loro forze furono in
...
teoricamente impossibile per l'epoca. Ma ci≥ non ferm≥ gli inglesi che
trassero grande beneficio dai messaggi decodificati.

Per anni la regola generale Φ stata di creare algoritmi semplici e di
impiegare chiave molto lunghe per rendere difficile la vita al
criptoanalista. Oggi l'orientamento Φ opposto data la potenza di calcolo di
cui si pu≥ disporre per fare un bruteforce, quindi si creano algoritmi
...
la riservatezza delle informazioni, etc. Uno dei presupposti fondamentali Φ
che si suppone che il criptoanalista di turno conosca in generale il nostro
metodo di crittografia, questo perchΦ Φ davvero un disastro cambiare ogni
...
Se la chiave Φ la stessa sia per la codifica che per la decodifica
...
Una delle due chiavi Φ pubblica e conosciuta da tutti e serve per cifrare i
messaggi, mentre l'altra Φ segreta e riservata al destinatario dei messaggi
che la utilizzerα per decifrarli. Le chiavi vanno a coppie e quindi solo
una chiave pu≥ decifrare il messaggio generato utilizzando la chiave a lei
...
nel famoso PGP) perchΦ il solo metodo asimmetrico non Φ efficiente (Φ
lento!) per grandi moli di dati e, se dovessimo inviare lo stesso messaggio
a pi∙ persone, dovremmo cifrarlo ogni volta con la giusta chiave.
PGP (Pretty Good Privacy) Φ un pacchetto freeware (http://www.pgpi.com) che
realizza la crittografia a chiave pubblica; permette l'interscambio di
documenti elettronici realizzando segretezza, autenticitα, integritα dei
dati su un canale insicuro. PGP Φ principalmente pensato per lo scambio di
documenti via Internet, ma pu≥ essere usato su un qualsiasi canale
insicuro; Φ indubbiamente un prodotto di qualitα, e non c'Φ da dubitare
dell'integritα morale del suo autore (che potrebbe come sempre aver
...
sistemi di crittografia; P. Zimmerman Φ stato sotto inchiesta per due anni
e mezzo, accusato di esportazione non autorizzata di materiale
crittografico, ed Φ recente la notizia che le autoritα federali
...
USA, Φ nato nel 1977 per implementazioni per lo pi∙ hardware come
...
militari.
Il DES brevettato nel 1976 da IBM Φ royalty-free dal 1993.
Il DES Φ un codice cifrato a blocchi (si dice che un codice Φ cifrato a
blocchi quando si applica un codice cifrato a un bit, byte, parola o gruppi
di parole alla volta). Il blocco che si usa per crittografare Φ di 64 bits
(8 sottoblocchi da 8 bits). Dato che l'ultimo bit di ogni sottoblocco Φ di
controllo, i bit utili sono 56.
Per cifrare il testo si divide in blocchi da 64 bits che sono cifrati in
successione. Se un messaggio non riempie i 64 bits si pu≥ completare in
...
Il DES Φ molto usato in ambito commerciale perchΦ nonostante consti di
...
economici immediati, ma appena verrα scoperto il modo per forzarlo (senza
bruteforce) occorrerα cambiare radicalmente tutto. Un altro difetto
fondamentale Φ lo spazio limitato delle chiavi pari a 2^56. Per ovviare al
problema si tenta di allungare le chiavi o di applicare pi∙ volte il DES
(triplo-DES o TDES).
Il progetto originale dell' IMB per il DES prevedeva una chiave pi∙ lunga
...
Nel gennaio 1998 la RSA Laboratories lanci≥ il "DES challenge II"
coordinato e risolto da distributed.net in 39 days.
Record presto battuto, nel 17 luglio 1998.
L'EFF, Electronic Frontier Foundation's, costru∞ una macchina (DES Cracker
machine) per distruggere il DES e ha scritto un libro (maggio 1998) dove Φ
spiegato nei minimi dettagli come si Φ proceduto
(http://www.eff.org/descracker).
La macchina del costo di 210.000 $ (80.000 per lo sviluppo e il rimanente
per i materiali impiegati, il software Φ stato scritto da volontari in 2
settimane) forza un DES-56 bits in meno di 3 giorni. Il progetto Φ stato
completato in 18 mesi.
Hanno cos∞ dimostrato ai loro "stolti" (cos∞ li definiscono nel libro)
governanti che il DES pu≥ essere forzato con una macchina dedicata. Qualche
...
Dal novembre 1998 il DES non Φ pi∙ l'algoritmo standard federale; Φ
sostituito dal triplo-DES finchΦ il nuovo AES non sarα pronto.


IDEA, International Data Encryption Algorithm

Creato nel 1991 da Xuejja Lai e James L. Massey, Φ, come il DES, codice
cifrato a blocchi di 64 bits con chiave, per≥, di 128 bits. Anche IDEA usa
...
Con questo tipo di crittogafia Φ stato risolto il problema della gestione
delle chiavi che non occorre pi∙ trasmettere al destinatario del messaggio
per la decodifica. Il concetto di crittografia simmetrica Φ stato
...
pubblica pu≥ essere decodificato SOLO dalla corrispondente chiave privata
che Φ unica ed associata strettamente a quella pubblica; ci≥ si basa anche
...
per cifrare la chiave di sessione con cui verrα codificato il messaggio
...
cifrario "asimmetrico", dimostravano la fattibilitα di sistemi
crittografici di nuovo tipo, adatti alla crittografia di massa mediante il
concetto delle "chiavi pubbliche".
Questo algoritmo Φ stato sotto brevetto fino al 29/4/97. Basa la sua
difficoltα di decodifica sui problemi logaritmici. E' considerato sicuro
con chiavi lunghe e generatori adatti.

RSA

Nato a due anni dal Diffie-Hellman (e brevettato il 29/9/1983 , scadenza
nel 2000 in USA, libero nel resto del mondo), questo algoritmo Φ ancora
...
difficoltα di ricreare la chiave segreta da quella pubblica basandosi su
...
esempio che dovrebbe chiarire e che Φ appunto l'idea su cui si basa l'RSA:
Φ facilissimo trovare il prodotto di due numeri molto grandi, ma dato il
prodotto sarα estremamente difficoltoso trovarne i 2 fattori primi.
Illustriamo i passaggi e l'esempio (che sarα fatto con numeri piccoli per
non complicare):
...
diviso (divisione intera) (p-1)(q-1) dα come risultato 1. Infatti
d*e=3*7=21/20=1.

4) Cifriamo il testo con c=(t^e) MODULO p*q.
t, intero positivo, Φ il testo in chiaro. il risultato c Φ il testo
cifrato.

La chiave pubblica conterrα n ed e(esponente pubblico), quella privata n e
d(esponente privato).
...
La chiave per l'RSA Φ il modulo n. Pi∙ Φ grande la chiave, pi∙ sarα sicura
(ma lenta) la cifratura. Con 1024 bits si Φ abbastanza (molto?) sicuri.
...
la crittografia a 512 bits pu≥ essere superata da agenzie statali. Solo
...
DES produciamo una chiave casuale (che cifreremo con l'RSA) che servirα per
...
la sua chiave segreta decritterα prima la chiave che impiegherα per
decodificare il messaggio.
Questo si fa perchΦ DES Φ da due (a livello software) a 4/5 ordini (a
livello hardware) di grandezza pi∙ veloce dell'RSA.
...
Curiositα: il numero di numeri primi minori o uguali a n Φ asintotico a
n/ln n. Quindi il numero di numeri primi di lunghezza minore o uguale a 512
bits Φ di circa 10^150, cioΦ pi∙ grande del numero degli atomi
dell'universo conosciuto. Questo la dice lunga sull'enorme disponibilitα di
chiavi diverse.

Fattorizzato RSA-140

Notizia del marzo 1999 apparsa sul mensile Crypto-Gram: Φ stato
fattorizzato un RSA-140. Un nuovo record Φ stato stabilito da Herman Riele
e il suo gruppo ad Amsterdam avendo fattorizzato un numero di 140 cifre
(456 bit). Questo numero Φ stato una delle sfide dell'RSA, era il prodotto
di due numeri primi molto grandi, proprio il tipo di numeri usati nel
criptosistema RSA.
La mole di lavoro Φ stata stimata in 2000 anni-mips (mips=milioni di
...
DEC 11/780 Φ una macchina mips. Un Pentium II di fascia alta Φ una macchina
da 200 mips. Il supercomputer per simulare esplosioni nucleari installato
al Sandia National Laboratory Φ una macchina da 1.8 milioni di mips).
Per l'impresa Φ stato usato un algoritmo detto "a setaccio di numeri", lo
...
ma le tecniche di fattorizzazione diventano sempre pi∙ efficienti e veloci
perchΦ i computer diventano sempre pi∙ veloci, le macchine possono lavorare
in rete, gli algoritmi migliorano continuamente di pari passo alle ricerche
di matematica.
E' stato giα avviato un progetto per fattorizzare un RSA-155 (512 bit) che
sarα pronto per fine 1999.

Fattorizzato RSA-155

Sono stati un p≥ pi∙ veloci della fine d'anno promessa e cos∞ Φ il 22
...
Lo sforzo Φ stato 50 volte pi∙ facile che craccare il DES. Fattorizzare le
chiavi usate per il commercio elettronico Φ sempre pi∙ facile e lo sarα
ancor di pi∙ in futuro. Questa impresa deve mettere in allarme perchΦ la
maggior parte dei protocolli sicuri usati in Internet usano RSA a 512 bits.
Grosse e medie societα come Compaq e Microsoft usano ancora per i loro
magazzini on-line l'RSA a 512 bit. Occorre inoltre riflettere sul fatto che
Φ probabile che qualche organizzazione in segreto giα forzi abitualmente
...
una macchina che potrebbe incrementare la velocitα di fattorizzazione
...
Appena un certo numero di relazioni Φ trovato, c'Φ una massiccia operazione
...
setaccio, idea peraltro non nuova perchΦ si rifα a quella di D.H. Lehmer
che pens≥ nel 1930 di usare tecniche meccanico-ottiche. La macchina sembra
...
operazioni sulla matrici. La complessitα del secondo passaggio esplode
...
semplicemente esegue operazioni giα conosciute pi∙ velocemente.


Servizi di email criptate web-based

L'idea Φ semplice: cos∞ come si entra in Hotmail e si spediscono e ricevono
messaggi, allo stesso modo lo si pu≥ fare, utilizzando per≥ email criptate
senza dover scaricare nessun software.
HushMail http://www.hushmail.com, basato su PGP e S/MIME-like, sfrutta
java. Il mittente entra in HushMail e, attraverso un'applet java, pu≥
...
1024 bit e Blowfish. La chiave privata personale Φ immagazzinata sul server
di HushMail e l'unica cosa che la protegge da accessi pi∙ o meno illegali
al server Φ una passphrase. L'altra debolezza Φ costituita dall'applet java
che non si pu≥ mai sapere se Φ quella corretta o un cavallo di Troia. Anche
certificando l'applet ci sarebbero dei problemi. L'ultimo problema Φ legato
alla collocazione fisica del server, che nonstante la compagnia che lo
gestisce sia di Antigua, Φ collocato in Canada, che notoriamente Φ molto
pi∙ suscettibile ad azioni legali.
...
Insomma, le email web-based criptate sono pi∙ sicure di una email non
...
Il sistema UMTS
· Servizi voce e dati per utenti mobili in qualunque tipo di ambiente (indoor outdoor, urbano/rurale); con
...
· Roaming nazionale, internazionale e globale.
...
DECT
· canali di segnalazione associati a velocita' fissa.
· capacita' del canale di traffico ridotta in modo prefissato.
· separazione tra controllo e dati d'utente.
· separazione tra chiamata e connessione.
· gestione delle risorse audio a livello 2.

UMTS
· canali di seganalazione associati a velocita' variabile.
· capacita' del canale di traffico non ridotta (o ridotta in modo controllato) a causa della segnalazione.
· separazione tra controllo e dati d'utente.
· separazione tra chiamata e connessione.
· gestione delle risorse radio a livello 2.
...
· Backward handover.
· Hard handover.
· Handover tra entita' di rete per mantenere la continuita' della conversazione.

DECT
· Mobile controlled.
· Forward handover.
· Seamless handover.
· Handover tra livelli di protocollo per mantenere la continuita' della conversazione.
...
· Seamless handover per mantenere la continuita' e migliorare la qualita' della conversazione.
...
· velocita' fino a 384 kb/s (oltre 730 kb/s unidirezionali teorici)
· connessioni multiple
· chiamate multiple con connessioni condivise
· variazione lenta della velocita'

UMTS
· servizi simmetrici e asimmetrici
· velocita' fino a 2Mb/s
· connessioni multiple con connessioni condivise
· variazione veloce della velocita'
Migrazione verso UMTS: Servizi dati a velocita' variabile

GSM
· variazione solo da parte dell'utente (o del terminale)
· variazione all'interno della singola connessione
· variazione lenta
· nessun impatto sulla disponibilita' delle risorse radio

DECT
· variazione da parte del sistema e dell'utente
...
In specifico , lo standard citato Φ il numero 7810 dei documenti creati dall' ISO (International Standard Group , www.iso.ch).Questo documento specifica la dimensione della tessera e tutti i valori di flessione,resistenza al calore ad agli urti per questo tipo di carta.Invece lo standard ISO 7811 spiega quali sono le aree che possono avere caratteri in rilievo e dove pu≥ essere messa la banda magnetica (se necessaria).Ma quello che ci interessa davvero Φ l'ISO7816 che ci spiega la dimensione dei contatti, la posizione dei contatti che altro non sono che i pin di un'integrato.
...
ABS :non pu≥ essere stampato ma Φ riciclabile
PVC :non pu≥ essere riciclato ma Φ stampabile
Inoltre la posizione del chip Φ determinata dalle applicazioni che si vogliono realizzare e viene identificata con ID-1 ID-2 ID-3 ed ID-000.Quelle pi∙ diffuse sono le ID-1 e le ID-0.Nella posizione ID-1 il chip Φ posizionato al centro mentre nell'ID-0 (detta anche ID-000) il chip Φ posizionato al centro , ma di una piccola tesserina plastica (detta anche SIM/SAM).Non Φ inconsueto trovare una tessera ID-1 che incorpora una ID-0 , vedete l'esempio delle schede GSM che a seconda del telefono possono essere usate in full-size oppure , staccandole, in formato ID-0.


Le differenze fra le varie card

Esistono come ho detto molti tipi di card, lcune basate su microprocessori che possono dialogare con l'esterno,ed Φ quello che interessa a noi!Infatti, se una persona disponesse di un programmatore di chipcard (dette anche smartcard) potrebbe farsi le proprie applicazioni basate su di essa ,ma non c'Φ bisogno che ve lo suggerisca io , vero?
...
-tutti
Questo tipo di card non ha password e po≥ essere letta da tutti, un esempio italiano Φ la card della quale sono dotati i malati di schemio in cura a Napoli che hanno una card con tutta la loro storia medica.
-solo dal possessore
...
-solo da terze parti
Esempio classico Φ quello delle carte di credito a scalare.Quando la tessere Φ esaurita solo chi la ha emessa Φ in grado di ricaricarla (in teoria:_] )
E adesso viene il bello ovvero come pu≥ essere configurata una card:
-in sola lettura (non permette l'aggiornamento)
-in solo aggiornamento  (non permette la lettura)
-in sola aggiunta (non permette la lettura nΦ l'aggiornamento , solo la riscrittura totale)
-inaccessibile (non ci si potrebbe fare nulla...)

Tutti questi diversi stati di lettura e scrittura sono ovviamente comandati dal micro che Φ integrato nella carta , che vedremo in specifico pi∙ avanti.

Le diverse metodologie di incapsulamento dei chip nelle card

Beh, non Φ che ci sia molto da scegliere, le metodologie sono solo due!
...
GLi asterischi sono la superficie adesiva alla quale aderiscono i contatti , il rettangolo al centro Φ il micro fissato anche lui con adesivo , le linee che partono dal micro e che si collegano ai contatti dorati sono i fili di connessione del micro con le piazzole.
...
Sostanzialmente le metodologie non sono molto differenti come funzionalitα ,ma si tende a preferire la tecnica del Wire Bonding per il semplice fatto che il chip Φ molto pi∙ protetto dagli urti rispetto al Tape Automatic Bonding, dato che resta dietro ad uno dei contatti e non protetto solo da un pochino di plastica protettiva.

La posizione dei contatti elettrici

Come giα detto i contatti elettrici sono 8 e sono in posizione standard.Qui di seguito vi riporto un paio di misure per le card che vengono usate per i telefoni GSM :
...
I contatti dal numero 1 al numero 4 rispetto al lato inserimento sono distanti 11 mm.Il contatto 1 rispetto al lato alto Φ alla distanza di 18.02 mm e tutte le piazzole sono di forma quadrata aventi 2 mm di lato.

La funzione dei contatti elettrici

Contatto 1:
VCC, consente di applicare tensione alla scheda, normalmente +5V con scostamento del 10% in + o in -.L'amperaggio massimo secondo lo standard Iso7816-2 Φ di 200mA ma le schede attuali consumano al massimo 15mA.
Contatto 2:
...
Contatto 6:
VPP, ormai inutile, ma viene conservato per la compatibilitα con il passato, il quanto le prime sim usavano una memoria EEProm che necessitava di una seconda tensione (+12,+21 o +25) per operare correttamente.
Contatto 7:
...
Come da regolamentazione ISO il metodo di trasmissione Φ sincrono in half-duplex a caratteri.Questo metodo Φ siglato dall'ISO come T0.Invece la metodologia asincrona in half duplex a blocchi prende il nome di T1.Tutte le card che usano metodi di trasferimento dati diverso hanno come sigla del metodo T14.Ci≥ vuol dire che le card T14 non sono compatibili con le direttive ISO7816, ovvero che sono card proprietarie (sviluppate da chi vende hardware particolare, in modo da dovervi sempre rivolgere ad un unico fornitore oppure per applicazioni specializzate tipo card ad uso medico).

Come si leggono?

Lo so che volevate solo questo!
Beh, di hardware in commercio ce n'Φ parecchio, ma il migliore Φ sempre quello autocostruito...
...
Tanto per iniziare...
Poi, se volete magari saperne di +, beh, di programmatori ne Φ piena la rete,ma per 'farsi le ossa' vanno bene anche quelli per il satellite...Magari su http://neworder.box.sk c'Φ qualcosa....
