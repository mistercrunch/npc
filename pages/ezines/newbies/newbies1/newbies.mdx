...
│BUGGATI CHE MI BUGGO ANCH'IO [ PHF]                             L0rD D3sTRuçTi0N│
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
               ...
               ╔═══════════════════════════════════════════════╗
               ║┌─────────────────────────────────────────────┐║
               ║│    GUIDA A INTERNET [ per veri newbies ]    │║
               ║└─────────────────────────────────────────────┘║
               ╚═══════════════════════════════════════════════╝

Ok ragazzi ci siamo, siamo al primo numero di questa e-zine dedicata ai Newbie
ed è per questo che ho pensato di realizzare una mini guida ad Internet per
tutti quelli che approdano alla Rete per la prima volta, che kazzo mi è
passato per il cervello, ce ne sono a miliardi, bhe una più una meno....
durante la lettura potreste avere l'impressione di averlo già letto da qualche
parte sappiate che probabilmente è così infatti, questa guida non è altro che
...
Ok, ok procediamo, mha da dove comincio, il primo DIO..., no non così dal
principio dunque vediamo ah già ecco...

Cos' è Internet ? 

Internet è in primo luogo un grande insieme di computer collegati tra loro,
su cui vigono determinate convenzioni che permettono la trasmissione dei dati
fra i vari PC, la Rete però non è fatta solo di cavi, chip e programmi.
Internet è fatta da milioni di persone che si scambiano messaggi, ricercano
informazioni, discutono ecc... in poche parole Internet è una società virtuale,
...
soluzione. Egli progettò una rete di comunicazione tra computer che non aveva
alcun nodo centrale e nessuna autorità governante.
La rete di Baran divenne la base tecnologica di Internet.

Le università diedero un grande impulso alla crescita e diffusione di
Internet. Dall'università la Rete si espanse alle aziende e alle famiglie.
...
di distribuzione dell'informazione e di condivisione di essa da parte di più
utenti. In pratica questo modello prevede che ciascun utente possa mettere a
disposizione di altri utenti le informazioni di cui è in possesso,
(facendo così da server), e quindi possa a sua volta riceverne da altri
(mettendosi nella condizione di client). É molto importante sottolineare che
...
Innanzitutto quello di cui avete bisogno per collegarvi ad Internet è un PC
dotato di modem, tengo a precisare che non esiste un computer studiato
appositamente per Internet, in pratica la connessione può essere effettuata
anche con un computer di vecchia generazione ma, lo svantaggio più evidente
sta nel dover subire estenuanti tempi di attesa per la visualizzazione di
qualsiasi pagina.

É di semplice intuizione quindi che, quanto maggiori sono le prestazioni del
vostro PC, tanto più veloce sarà la trasmissione dei dati; sottolineo però che
le buone prestazioni del computer non implicano una costante fluidità della
navigazione in quanto questa è determinata anche da altri fattori come per
...
3. Dominio
4. N° di telefono da chiamare per la connessione
...
password che dovrete fare in modo di non dimenticare!! É probabile che vi
venga fornito anche un programma (comunemente incluso nel browser ma, non
sempre), che vi seguirà passo per passo nella configurazione della
...
sulle potenzialità di Internet. La prima risorsa a cui un utente approda
quando è in rete è il WWW, ma esistono anche molti altri servizi di grande
utilità quali ad esempio:
...
sono così tante le curiosità e i dubbi che Internet è in grado di procurare
che si rischia spesso di non concludere niente, per questo, da qui in poi
cercherò di rispondere ai dubbi più comuni che sorgono appena ci si trova
connessi nella stessa sequenza in cui io li ho incontrati e superati.

Cos'è il WWW?

World Wide Web (ragnatela mondiale) è il nome (abbreviato in WWW) con il quale
si identifica comunemente l'insieme di ipertesti collegati tra loro che
attualmente costituiscono l'aspetto più userfriendly di Internet per chi non
sapesse cos'è un ipertesto niente paura il concetto è di estrema facilità
...
in seguito, a comprendere concetti più complessi, un indirizzo Internet si
...
Il protocollo più usato in Internet è Http che significa Hyper Text Transfer
Protocol. Indica che state cercando un documento di testo piuttosto che un
file o altro ancora.

Vi sono diversi tipi di protocolli ma per ora basti sapere che i 2 più usati
...
L'indirizzo dell'Host, se questa è messa a disposizione per il Web, è
...
Grazie a quanto sopra detto ora risulterà facile creare gli indirizzi che più
...
l'università di Verona mette a disposizione dei vari utenti (http:// può
essere omesso).

Esaminiamo ora sotto un aspetto più particolareggiato gli indirizzi Internet.

Quello che sopra ho sommariamente definito come indirizzo dell' Host è
scomponibile in sottoparti le quali, hanno tutte un loro nome tecnico che è
utile conoscere per evitare di trovarsi in difficoltà.

La via per imparare è lunga se si va per regole, breve ed efficace se si
...
3. /Pub/~Newbie/ (directory, ~Newbie è inventata per questo esempio)
4. Homepage.htm (nome pagina, inventato per questo esempio)

Il punto numero 2 si può suddividere ulteriormente nelle seguenti sotto parti
a partire da sinistra:

1. Members "nome proprio" (hostname) del computer
2. Tripod dominio di secondo livello o sottodominio (subdomains), a volte ve
   ne è più di uno e in quel caso sono sempre più grandi a partire da sinistra
   verso destra.
...
ma oggi questa distinizione è scomparsa.

Importante precisare che non vi è alcun vero e proprio vincolo geografico che
...
dove il metodo può essere Http, Ftp ecc... , il nomemacchina è il nome del
computer su cui si trova l'oggetto cercato, la porta (solitamente sottintesa)
è il numero della porta con cui si intende comunicare con l'altra macchina,
esso varia a seconda del metodo scelto. Il nomeoggetto è il percorso più il
nome del file cercato.

Lo schema di cui sopraèΦ detto URL (Uniform Resource Locator, ovvero
...
In realtà la gestione degli indirizzi Internet è molto più complessa di quanto
possa apparire infatti come è noto i computer non sanno gestire informazioni
diverse da numeri binari questo comporta ovviamente una serie di problemi
legati alla gestione della Rete in particolare è lecito chiedersi:
<< Come fa la Rete a sapere dove si trova il computer Prefisso.Hostname
.Dominio ? >>.

Per arrivare alla soluzione di questo problema è necessario introdurre le
nozioni di:

1. Ip address, ovvero combinazione di 32 bit che identifica univocamente un
   qualsiasi computer connesso ad Internet.
2. DNS (Domain Name System) è il sistema utilizzato dai computer che
   gestiscono Internet per tradurre gli indirizzi letterali nel corrispondente
   Ip address e viceversa.
 
Come si può facilmente intuire, non è possibile che in un solo computer siano
...
essere .HTM o .HTML. Inizialmente il Web è stato sviluppato su computer UNIX
e i file avevano estensione .HTML. In seguito con la diffusione di Windows 3.1
entrò in uso l'estensione .Htm per via della limitazione a soli 3 caratteri
nell'estensione dei file gestiti dal DOS-Windows 3.1. Oggi si incontrano
comunemente sia file .HTM che .HTML e anche se Windows 95/98 è in grado di
...
Come è costituito un indirizzo e-mail?
...
L'account è in genere il nome che ciascuno utilizza per connettersi al proprio
Provider. Dopo l'account c'è il simbolo @ che serve a separare l'account dal
nome del dominio. Il nome del dominio è generalmente l'indirizzo della ditta
che fornisce l'accesso ad Internet.

Quello che ho chiamato account può essere chiamato in modi molto diversi fra
i quali i più comuni sono:
...
interessa in particolare perchè, sarebbe troppo grande per poter essere
gestito.

Esistono però siti che danno la possibilità di effettuare ricerche, che
permettono di trovare pagine che riguardano l'argomento che ci interessa.

Essenzialmente, gli strumenti che un utente medio utilizza più di frequente
sono:
...
è quindi necessario scegliere la categoria a cui si è interessati per ricevere
un elenco di siti con i relativi rimandi

Si tratta di programmi che accettano in input una o più parole chiave e
forniscono in output i documenti che le contengono, ordinati in funzione della
probabilità che riguardino più o meno strettamente l'argomento al quale siamo
...
unificazione per cui oggi non è più possibile una netta distinzione.

Vi sono poi altri strumenti con i quali è possibile effettuare ricerche ma
...
quesiti per mezzo di una sintassi logica ed è quindi necessario saper utilizzare
in maniera corretta operatori logici quali ad esempio AND, OR, NOT e altri.

Innanzitutto è da dire che generalmente i motori di ricerca permettono due
tipi di ricerca quella semplice e quella complessa e o avanzata.
 
Uno dei più considerevoli vantaggi della ricerca semplice è che questa gradua
i risultati automaticamente in modo che i documenti di maggior rilievo, quelli
più probabilmente abinabili alla/e parola/e chiave, vengono ad essere
posizionati in cima alla lista dei risultati.
In più la Ricerca Semplice consente di ricercare parole e frasi in modo
...
1. Si è in grado di comporre quesiti usando la sintassi logica
2. Si è interessati a documenti modificati per l'ultima volta in uno specifico
   periodo di tempo
...
Per avere risultati più adeguati bisogna prima di tutto imparare ad usare il
più (+), il meno (-), le virgolette ("), il carattere jolly (*) e l'uso delle
maiuscole.

Più Quando è posto davanti a una parola si richiede che questa appaia nei
risultati.
Meno Quando è posto davanti a una parola la esclude dai risultati.
...
se il documento contiene tutte e 4 le parole, sarà posizionato in cima alla
...
Il carattere jolly indica che l'utente è interessato a documenti che
contengono le parole digitalizzazione, digitalizzare, digitalizzato ecc..

+vietnam+film-"good morning vietnam"
...
Come già detto sopra per utilizzare la ricerca complessa è necessario
...
NOT  Esclude i documenti contenenti la parola o la frase specificata.
     Questo operatore non può mai essere usato da solo.
...
É consigliato inoltre il costante utilizzo delle maiuscole per distinguere le
...
Nel caso in cui in un quesito vi siano più operatori buona abitudine usare le
parentesi () per riunirli con le parole da cercare.

Per circoscrivere una ricerca nel tempo è necessario specificare la data nel
formato gg/mm/aa dove mm è espresso con le prime tre lettere inglesi del nome
...
altrimenti essi appaiono in ordine casuale è anche possibile selezionare un
...
presenti al massimo con 10 parole di distanza tra loro, NEAR è un operatore
...
non mi veniva in mente altro :) Pietà .....

Per concludere, rimane da dire che i motori di ricerca funzionano in gran parte
grazie alla buona volontα degli utenti infatti, chiunque può inserire un nuovo
...
Questa era la panoramica più ampia che si potesse dare sui Net Motor, ora
manca solo la pratica, ecco di seguito un elenco dei motori più conosciuti:
...
Con la pratica si vedrà che molte altre sono le possibilità che offre il
mondo del WWW ma, quanto già detto basta per sapersi orientare.

Cos'è l'FTP?

Come già precedentemente accennato l'ftp è un protocollo che serve per
...
ftp è comunque la scelta migliore.
...
o ls (in Unix è l'equivalente del comando dir), vengono impartiti con il
...
Il vantaggio principale che l'utilizzo di questo protocollo comporta è, a mio
avviso, la possibilità di riesumare i download interrotti infatti, oggi la
maggior parte dei server ftp fornisce questa possibilità, molto utile, in
...
trasferimento di uno o più file dal computer remoto al proprio PC,
l'operazione contraria viene denominata upload.

I collegamenti a un sito ftp, possono essere realizzati in diversi modi
infatti, oltre ai già citati programmi a interfaccia grafica, oggi una
sessione ftp può essere eseguita con un qualsiasi browser, l'interfaccia è
...
eseguirne il download, esistono poi altre possibilità per utilizzare ftp che,
essendo più complicate sono oggi in disuso.

Personalmente, preferisco utilizzare un vero e proprio client ftp perchè, a
...
non crea nessuna difficoltà infatti, essi hanno il pregio di essere molto
intuitivi, è sufficiente uno sguardo per capire come si usano, ed è proprio
per questo motivo che ne consiglio l'utilizzo.
 
Ecco i nomi dei client ftp più diffusi:
...
Per poter accedere ai siti ftp privati, è necessario possedere una login e
...
e-mail generalmente il tutto è fornito in maniera automatica dal proprio
client.
...
directory (ormai è una convenzione), ne suggeriscono il contenuto.

Ogni volta che si esegue un download, è opportuno fare una scansione del file
per verificare che non sia infetto da qualche virus, a questo scopo è
...
Se l'antivirus vi dovesse segnalare che il file scaricato è infetto
NON FATEVI PRENDERE DAL PANICO, le leggende sui virus sono molte ma, in
realtà, esiste solo un modo con cui un virus proveniente dalla Rete può
entrare nel vostro computer e cioè, siete voi che dovete mandare in esecuzione
...
Internet, vorrei precisare che personalmente non le ho mai utilizzate perchè,
a mio avviso, sono obsolete in confronto ad altre, per quello che mi riguarda,
non mi è mai capitato di non riuscire a soddisfare le mie esigenze attraverso
gli altri strumenti disponibili, quindi pur conoscendo il funzionamento di
tali risorse non ho mai avuto la necessità di usarle.

Archie ovvero Archive

Archie è un sistema di database che contatta periodicamente i server FTP
...
più comuni sono: via Web o tramite client Archie, esistono poi altre tre
possibilità, ma sono quanto meno scomode e, per questo, mi limiterò a parlare
di quelle appena citate.

Con il proprio browser è possibile usare un server Archie via Web,
...
supplementari che per la maggior parte sono intuitive ma, è utile commentare
brevemente i tipi di ricerca che sono disponibili.

Una ricerca si può effettuare in modi diversi a seconda dell'opzione
selezionata, generalmente è passibile basare la ricerca:

1.esattamente sul testo digitato
2.su una espressione Unix
3.sulla base del testo digitato, con possibilità di trovare file che
  semplicemente lo contengono e, non consentendo la sensibilità alle maiuscole
  (Default)
4.sulla base del testo digitato, con possibilità di trovare file che
  semplicemente lo contengono ma, consentendo la sensibilità alle maiuscole,
  scegliete quella che più si adatta e buona fortuna.

Per quanto riguarda i client Archie, non resta che recuperarne uno e provare,
tutta la teoria necessaria è stata sopra esposta il resto è solo pratica.

A mio avviso, Archie è stato ampiamente rimpiazzato da siti quali ad esempio:
...
Gopher è l'immediato predecessore del WWW e rappresentava una grande risorsa
prima della fine del 1994 periodo in cui la comparsa del primo Browser
favorisce lo sviluppo del WWW che segnerà in seguito il declino di Gopher.

Gopher presenta una serie di menù testuali che una volta selezionati possono
portare ad altri menù, alla copia di un file o altro ed è l'evoluzione della
precedente interfaccia a riga di comando.

Oggi si usa tramite Web, ed esistono programmi per effettuare le ricerche su
server Gopher, ma ormai questo sistema è dimenticato da tutti e del resto è
più che comprensibile.

Cos'è Telnet?

Telnet è un programma che consente al nostro PC di diventare un terminale di
un elaboratore remoto, tutto ciò che noi faremo una volta aperta la sessione
Telnet, sarà elaborato dal computer remoto e non dal nostro PC e, proprio per
...
La comunicazione in Internet, analisi delle varie possibilità.

Internet, mette a disposizione dell'utente molte possibilità per conversare
in rete, e di questo tutti abbiamo sentito parlare ma, oltre agli esami di
laurea in diretta, quali sono le reali possibilità?
...
Possiamo distinguere in due diversi gruppi a seconda del protocollo su cui è
...
Si basa sul protocollo omonimo, per avviare una sessione irc è necessario:
...
messaggio, se selezionate un utente, si aprirè un'ulteriore finestra,
identica a quella appena descritta ma, il messaggio che invierete sarà
rivolto esclusivamente a quella persona.

Se invece scrivete un messaggio nella finestra principale, questo verrà
replicato dal server a tutti gli utenti presenti sul canale.

Tramite le Chat IRC c'è anche la possibilità di spedire file, usare macro.
...
Infine rimane da dire che nei canali IRC è presente un moderatore, che si
...
di comunicare in tempo reale tra di loro, negli ultimi tempi però ha trovato
applicazione in diversi client che permettono la discussione tra più persone
contemporaneamente, mantenendo però le sue caratteristiche principali.

Per poter dialogare con un qualsiasi client che basa il suo funzionamento sul
protocollo talk, è necessario seguire la procedura sotto riportata:
...
2. Se l'utente desiderato ha in esecuzione lo stesso client per Chat talk
   (condizione necessaria), gli verrà richiesto se vuole accettare o meno la
...
L'interfaccia di un client talk, è totalmente diversa da quella di un client
...
dell'utente la lista delle persone collegate e prevedono anche la possibilità
...
questo protocollo, ovviamente, è necessaria una telecamera come ad esempio la
famosa Quik Cam (nata per Mac).

I software più conosciuti per le comunicazioni in tempo reale sono:
...
É noto che l'e-mail (electronic mail) è molto più veloce rispetto alla
tradizionale snail-mail (posta lumaca), perchè inpiega pochi secondi per
arrivare a destinazione ma, nonostante ciò, è concettualmente considerata un
...
sapere quando il destinatario la leggerà.

Grazie ad un qualsiasi Browser, gli utenti di Internet sono in grado di
gestire tutte le possibilità che il protocollo SMTP offre.
...
La possibilità di specificare il livello di prioritα del messaggio
La possibilità di filtrare i messaggi
...
Un Web Chat è un sistema che permette il dialogo tra due o più utenti tramite
...
operazione a lungo termine è estenuante, per quanto semplice non ne vale
proprio la pena.

Java Chat

Java è un linguaggio di programmazione sviluppato dalla Sun, ed è orientato
alla rete, il suo pregio principale è quello di poter essere eseguito su
qualsiasi piattaforma.
Le Java Chat hanno un'interfaccia simile a quella dei client IRC, per poter
sfruttare questo tipo di chat è necessario avere un browser in grado di
eseguire gli applet java (programmi inseriti in pagine WWW).

Questo tipo di Chat è più veloce della precedente.

Le mailing list

Una mailing list è basata sul protocollo SMTP, in pratica è una lista di
indirizzi e-mail appartenenti a persone che hanno un interesse comune, e
vogliono scambiarsi mail sull'argomento.
Per partecipare ad una mailing list è necessario spedire una mail ad uno
specifico indirizzo.

Chiunque voglia dire o chiedere qualcosa sull'argomento non deve far altro che
inoltrare una mail all'indirizzo convenzionale, il listserver provvederà a
...
all'Euro, in alcune liste è presente un moderatore quindi, cercate di
...
il rischio di "forare" i Mb a vostra disposizione.

L'iscrizione è revocabile in qualsiasi momento.

I newsgroup (UseNet)

Basati sul protocollo News, i gruppi di discussione sono simili ad una mailing
list ma, presentano tre fondamentali differenze e cioè:

1. Non hanno l'obbligo di iscrizione (iscriversi serve solo per fare in modo
   che il programma visualizzi solo i newsgroup ai quali si è interessati)
2. Non è necessaria una casella di posta in quanto ci sono appositi server che
...
ne contiene uno), uno tra i più conosciuti è Free Agent.
...
invece non potete farlo, ovviamente in quest'ultima ipotesi la velocità delle
varie operazioni è maggiore.
...
misc (tutto ciò che non rientra nelle altre)

altri...

L'insieme dei newsgroup è detto Usenet per distinguerlo da Internet, in
effetti questa distinzione non è del tutto fuori luogo infatti, i messaggi
dei nowsgroup vengono trasmessi anche su altre reti di calcolatori diverse da
internet.

Altri servizi "interessanti"...

Nel descrivere questi servizi farò riferimento ad un famoso software per
...
Verifica la raggiungibilità di un sito e l'efficienza del collegamento che si
può stabilire con esso.
...
Per concludere, tengo a precisare che, CyberKit è solo uno dei tanti software
...
Siamo così giunti FINALMENTE alla fine di questa mini guida, cosa?, vi siete
rotti a leggerla? bhe pensate a quanto mi sono SKAZZATO a scriverla, con la
promessa che non scriverò mai più una guida per novizi vi saluto...
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔══════════════════════════════════════════════════════════╗
        ║┌────────────────────────────────────────────────────────┐║
        ║│LE NOVITA' PER QUANTO RIGUARDA MAMMA TELECOM E ALTRE ...│║
        ║└────────────────────────────────────────────────────────┘║
        ╚══════════════════════════════════════════════════════════╝
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
  ...
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !!!! QuEsTo aRtIcOlO Φ StAtO ScRiTtO Da CyRuS ThE ViRuS e Dr.ShAdE!!!!!!
...
In questo articolo non verrα citata la localita in cui noi della 
IHC abbiamo operato, si ricorda che fare tutto ciò alla vista di
occhi indiscreti, è una cazzata. Quindi okki in mano mentre provate a fare queste cose!
L' articolo e stato steso da Dr.ShAdE e Cyrus The Virus membri della IHC (ItALiAn HaCkEr CrEw). Special FRIEND "ChEm-BoY"
#########                                     #     #
    #                                         ##   ##
    #   ######  #      ###### ######  ######  # # # #
    #   #       #      #      #       #    #  #  #  #
...
centraline, naturalmente, però, durante l' hackeraggio, il consumo alimentare è
stato maggiore :-)


Bene.

Prima di tutto, vogliamo precisare che , non tutte le cittα 
...
3/4 metri, che  ci è servito per fare i fili di connessione.
E poi la valigetta del bravo PHREAKER 
con saldatore e altre stronzate.
Tutto il lavoro svolto, è stato suddiviso in due giorni:
...
giorno.
Il primo tipo è quello che si trova ai lati delle case,abbastanza piccole, che 
controllano non + di 13 linee...
Il secondo è quello che si trova vicino alle cabine telefoniche e, naturalmente,
regge solo quelle..
Il terzo tipo, quello che abbiamo hackato noi, è quello che si trova di solito nel 
centro delle piazze principali delle cittα... Si distingue dalle altre per la sua
grandezza e per le pareti esterne in metallo e non in plastica...

Per cominciare vi diciamo subito che la serratura non è molto semplice 
...
Oppure si può anche fare un innesto utilizzando la batteria 12 Volts
del motorino...
...
<--FIAMMA-->
Più semplice e più veloce: vi procurate una fiamma ossidrica
...
costanti.                                                 
La domanda che ci si pone ora,è questa: "che cosa si può fare con tale bellezza?"
Bhe vi assicuriamo che ci si può fare di tutto... noi abbiamo 
fatto solo alcuni esperimeti dei tanti realizzabili.
A noi  ci interssava principalmente verificare la possibilitα 
...
Per cominciare vi diciamo che non è difficle, ma bisogna agire con la
...
si entra , in mezzo alla linea, ciò vuol dire che è possibile 
...
lo possimao usare per fare ponte,possiamo cioè, deviare una chiamata e dirigerla verso un altro telfono.
...
Una cosa molto importante, è il fatto che si può ridirigere le chiamate.
...
rischi.  Altro consiglio Θ magari quello di svolgere 
un paio di prove, prima di  agire, per vedere se 
in caso di grane , è possibile scappare velocemente.
Inoltre. Quando cercate di aprire la centralina, mi raccomando
di non lasciare casino: meno si vede, più possibilita avrete
di ritornarci in un secondo momento.
Comunque ciò che abbiamo capito il primo giorno della missione
è questo: 
1 Le centraline si possono aprire senza troppi problemi.
2 La linea telefonica è presente... quindi basta attaccarci il modem..
3 E' possibile costruire dei ponticelli.  
4 Si possono deviare le chiamate.


Nel secondo giorno spiegheremo una delle cose
più interessati. Una volta acquistata sicurezza sulle tecniche
sopra citate e possibile fare altre cose più complicate.

2)!!!!!!!!!!!!!!!!!!!!!SECONDO GIORNO!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 

Siamo adesso giunti al secondo giorno dei nostri esperimenti.
Bhe questa parte e un po' piu' difficile da seguire. Anche perchè
...
Ma a cosa ci è servito il telefono collegato al computer 
e alla centralina?
...
Ma la cosa più divertente era quella di utilizzare direttamente 
una linea telekom {Linea di servizio}...
Si riconosceva facilmente perche li si collegavano tutte le altre
linee.
Si capisce bene che i vantaggi sono molti perchè è quindi possibile
...
giorno? bhe io penso che sarebbe stato veramete molto più seria la
cosa: perchè bastava far ponte sulla mia linea di casa, e
...
Bhe nulla di ciò che pensate,  ma e utile per non destare sopetti
...
Può sembrare paranoico, ma vi assicuriamo che funziona!!!
Attenti alle persone che vi guadano: non volgete mai la faccia
dalla loro parte. E cercate di essere naturali il più possibile
...
AMICO "ChEm-BoY"  che non è potuto venire al meeting
CAusE.... \/[OpS]\/
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
                ...
                ╔════════════════════════════════════════╗
                ║┌──────────────────────────────────────┐║
                ║│INTERESSANTI INFO SU TELEFONI E AFFINI│║
                ║└──────────────────────────────────────┘║
                ╚════════════════════════════════════════╝

╔═══╦════════════════════════╦═══╗
╠═══╣CABINE X NAVIGARE GRATIS╠═══╣
╚═══╩════════════════════════╩═══╝

Bè da dove cominciamo...Volete sapere un modo sicuro x inculare la telekoma?
...
sulle cabine il cavetto che arriva al modem.Dovete star attenti però a togliere
il filo ogni volta che vi disconnettete ed è consigliabile andarci di notte (così non vi vede nessuno).
Questo sistema però può essere attuato solo da chi abita vicino a quste cabine.
...
╔═══╦══════════════════════════════╦═══╗
╠═══╣CELLULARI E SCHEDE TELEFONICHE╠═══╣
╚═══╩══════════════════════════════╩═══╝

Come tutti saprete la TELECOM è difficile da truffare ,ma ecco quà un pò di cosette
che possono tornare utili.Partiamo con le cose più semplici,inviare SMS a qualunque
cellulare GSM gratuitamente e rimanendo del tutto anonimi. Ecco qui un sito che può
tornare utile:

WWW.GSMBOX.COM

Una seconda cosetta semplice è ricaricare le schede telefoniche, basta soltanto
spruzzare della lacca per capelli sulla striscia mangnetica e succesivamente
passarla su un televisore vecchio,la scheda si ricaricherà.
...
si spengnerà e voi comunicherete gratuitamente senza spendere una lira. L'unico
inconveniente è che la OMNITEL dopo qualche settimana ve lo disattiverà. Per ora
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔══════════════════════════════════╗
        ║┌────────────────────────────────┐║
        ║│GREEN: ma quanti cazz ce ne sono│║
        ║└────────────────────────────────┘║
        ╚══════════════════════════════════╝
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔══════════════════════════════════╗
        ║┌────────────────────────────────┐║
        ║│Guida all' Hacking di Windows NT│║
        ║└────────────────────────────────┘║
        ╚══════════════════════════════════╝
...
L'hacking di WinNT risulta spesso piuttosto semplice (non dimentichiamo che è
prodotto dalla Microsoft!) in quanto esistono centinaia di exploit che possono
essere utilizzati.
Scriverò qui quelli più comuni e che vanno bene quasi in qualsiasi situazione.
...
Esso verrà eseguito. Grazie a questo bug è stato fatto un exploit che riporto qui sotto
ma che trovate dappertutto in rete: è uno dei più efficaci.

Basta compilare questo programmino e rinominarlo come FPNWCLNT.DLL. Questo è
infatti uno dei file che winnt utilizza all'avvio. Riusciremo così ad ottenere
...
Andate su "Risorse di Rete" ed accedete al server.Quasi sicuramente esso avrà
...
Il gioco è fatto! Quando il sysadmin userà il suo programmino NetBus si installerà
sul WinNT Server e voi sarete padroni di quel computer come se foste seduti davanti.
Una volta dentro basterà usare il metodo N°1 per ottenere le pass oppure prelevare
i file .SAM come spiegherò nel punto 3.
...
esulta, ma l'hacker sa dell'esistenza di SAM.SAV che è il backup di SAM...
...
le keys.  Ovviamente se non sapete a cosa serve tutto questo sarà meglio non
...
dell'hd ed eseguire il file .exe. Quando questo avrà terminato il suo lavoro vi
basterà riavviare il computer e vedrete che siete stati aggiunti alla lista dei sysadmin!!
...
- abbiamo la possibilità di installare tutti i programmi che vogliamo senza che ci
  appaia la scritta "per installare il programma sono necessari i privilegi dell'amministratore
  di sisitema"! Quindi possiamo sbizzarrirci ad installare programmi utili a raggiungere
...
Per concludere vi darò qualche consiglio.
Prima di incominciare ad hackerare una rete di computer senza quasi sapere
cosa state facendo, raccogliete più informazioni possibili su di essa, sui
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔═════════════════════════════════════════╗
        ║┌───────────────────────────────────────┐║
        ║│CHI HA PAURA DI NET-BUS E BACK ORIFICE?│║
        ║└───────────────────────────────────────┘║
        ╚═════════════════════════════════════════╝
...
Uno degli argomenti che forse terrorizzano di più i novellini di Linux è
capire cosa sia il kernel e come fare a compilarsene uno, processo di per
sé abbastanza semplice una volta venuti in possesso di alcune conoscenze di
base... L'intento di questo articolo è quello di sfatare miti e/o leggende
...
è quello di favorire la chiarezza a discapito della complessità, qualità in ogni
...
alla completezza delle definizioni per aumentare la comprensibilità del tutto);
...
moderni sistemi operativi siamo abituati a vedere più processi in esecuzione
contemporanea (multitasking), ma, in realtà, un solo processo è attivo nella
CPU rispetto all'unità di tempo... Ed è proprio questo il punto: in un dato
momento il programma X è in esecuzione, ma subito dopo X potrebbe essere
...
kernel, ed è per questo che è così importante.
...
(un listato in linguaggio c non può infatti essere eseguito direttamente dal
...
più precisamente esistono in contemporanea due versioni differenti dei sorgenti del
kernel, una assolutamente stabile per gli utenti "normali" e una più "sperimentale"
...
Come discorso generale, per capire se una versione del kernel è stabile o meno
si osserva il secondo numero di versione (quello in mezzo): numeri pari = stabile,
numeri dispari = sperimentale (infatti 2.0.X è stabile, 2.1.X è sperimentale).
La versione stabile più recente è, nel momento in cui sto scrivendo questo
articolo, la 2.0.35 (comunque la 2.0.36 è già dietro l'angolo e potrebbe essere
stata già rilasciata mentre leggete questo articolo). Segue ora un metodo esaustivo
per conoscere quali siano le release più recenti del kernel, da digitare al prompt
dei comandi una volta collegati alla rete (da Linux, a meno che non disponiate del
programma finger anche in Windows); quello che dovrete digitare è semplicemente:
...
infectmachine:~>
(infectmachine è il nome della mia macchina).

come potete vedere, la versione stabile più recente è la 2.0.35 .
Ora che sappiamo cosa scaricare utilizziamo ftp su ftp.kernel.org per scaricare
i sorgenti di quello che ci interessa: il nome del file che dovete prendere è
...
Oltre al file appena scaricato vi servirà il compilatore gcc (dovreste averlo
già installato, in caso contrario fatelo!) e una conoscenza per lo meno
...
sicuramente non la più recente disponibile), mentre l'altra è un link a detta
directory (ovvero scrivendo "cd linux-2.0.X" o "cd linux" si entra in pratica
nella stessa directory). Visto che noi siamo in possesso di una versione più
recente facciamo innanzitutto in modo di sostituire i sorgenti obsoleti con
quelli nuovi. L'operazione in questione è eseguita dai seguenti comandi (da
eseguire ovviamente in /usr/src):

1) mkdir linux-2.0.35 (crea la directory che andrà a contenere la versione del
...
pronti ad eseguire la fase di messa a punto del kernel, che ci permetterà di
...
1) make config (modalità ascii: verrà visualizzato un elenco in cui selezionare
   i componenti con Y (yes), N (no) e M. Il significato di cosa sia un modulo
   verrà affrontato tra poco.
2) make menuconfig (sempre modalità testo, ma ci troviamo in questo caso di
   fronte a dei comodi menu in cui effettuare la selezione con il tasto spazio).
3) make xconfig (da utilizzare se avete avviato X Window. Vi permetterà di
...
se non aumentarne la dimensione e/o renderlo un po' più "pesante". proprio per
questo vi avevo suggerito di scrivervi su un foglietto  i vari componenti hardware presenti.
Poco sopra vi ho parlato di tre differenti "valori" da attribuire ai vari componenti: è
possibile includerne uno con yes (asterisco se avete usato menuconfig), escluderlo con
no (e in questo caso non verrà compilato nel vostro kernel), ma è anche possibile
renderlo un "modulo" con la lettera "M". Cosa significa renderlo un modulo? ╘
presto detto: sempre per alleggerire il kernel e non includere al suo interno
componenti che non si utilizzano spesso, è possibile rendere questi ultimi
modulari; in questo caso sarà possibile caricarli e scaricarli dalla memoria
a seconda della necessità (se utilizzate i moduli vi consiglio vivamente di
...
Code maturity level options: dire di lasciare questa voce così com'è, ovvero
...
perché è ad esempio in possesso di un processore 486SX) e si limita la memoria
...
direi di lasciare le cose così come stanno (a meno di non possedere un PPro: in
questo caso è possibile specificare questo tipo di CPU).
Floppy, IDE and other block devices: questa sezione è abbastanza lunga, ma per
fortuna c'è ben poco da cambiare... Innanzitutto, a meno di non essere in possesso
di una scheda madre che monta il chipset CMD640 o RZ1000, direi che è il caso di
eliminare queste due voci (il 90% delle schede madri montano in genere un chipset
Intel, per lo meno per ora). Per il resto lasciate tutto così com'è.
...
anche, sempre come modulo, la voce "plip": vi tornerà utile per creare connessioni
...
consiglio di deselezionare la voce  "ethernet". Lasciate tutto il resto così
come lo avete trovato.
ISDN subsystem: se non disponete di una connessione ISDN lasciate tutto così
...
Filesystems: seleziona i tipi di filesystem che il kernel supporterà una
...
il "second extended" (se lo deselezionate non riuscirete più a fare il boot della
macchina: è quello che utilizza Linux per le sue partizioni!!), e di selezionare
...
support" come modulo (non si stampa infatti tutto il giorno e così facendo lasciamo
il kernel più leggero, non includendolo direttamente al suo interno!). NB: se siete
in possesso di un mouse diverso da quello seriale (ad esempio PS/2) sarà necessario
...
dati della scheda sonora... Sarà infatti necessario specificarne i vari indirizzi
base, nonché IRQ e DMA. In genere le voci da selezionare (per lo meno per le Sound
...
La procedura di configurazione è conclusa... Salvate la configurazione corrente
...
486 potrebbe essere necessaria anche mezz'ora o più. Molto meglio quindi andarsi
a bere un bel caffè, dopo aver ovviamente digitato il seguente comando (in effetti
sono più comandi divisi da punto e virgola, ma è molto meglio scriverli così
perché poi ci si può dedicare ad altro... In caso contrario dovreste aspettare
...
anche saltare questi passaggi, ma in ogni caso è buona abitudine eseguirli
...
1) cd /; mv vmlinuz vmlinuz.old (Dal momento che abbiamo imparato a digitare
   ...
   altresì nota con il nome di "root"; il secondo rinomina il vecchio kernel, che
...
si è riavviato con successo... Complimenti, avete appena compilato il vostro
...
sprecare spazio per nulla è ora il caso di cancellare i vecchi moduli con un
...
ignorarli, ma se urtano la vostra sensibilità editate il file /etc/conf.modules
...
Al prossimo reboot non vi infastidiranno più...
...
crittografia della posta mi sempre affascinato ed ormai è da parecchio che la
sperimento sulla mia pelle , quindi ho deciso di condividere queste poche cose
che so con tutti.Intanto la mia ragazza ha perso ogni interesse e si è messa a
giocare a Croc ;-[
Vebbè, a parte tutto , volevo solo dirvi che io faccio parte del Club SPiPPoLaTorI
...
Si inizia!
Dando per scontato che voi sappiate cosa è e come funziona pgp , cosa sono gli
header delle mail e come leggerli , mi propongo di spiegarvi con parole facili
cos'è e come funziona la posta anonima , partendo dagli anonymous mail server
fini ai nym server concatenati passando per PGP e tutti remailer noti.
iniziamo proprio dai remailer di uso più facile , i cosiddetti anonymous remailer.
...
anonima-mail reale e ciò ha causato la chiusura di penet.fi ,sia perchè gli addetti
...
-è possibile usare la chiave pgp del remailer per instradare i propri messaggi
 E qui già il discorso si fa complicato!Insomma , se voltete spedire una mail
...
-permettono la concatenazione dei remailer
 Logicamente , più passaggi fanno le mail , più si perdono le vostre tracce
-possibilità di riordino dei messaggi
 Il server da un tempo di latenza a caso per ogni mail.
-possibilità di spedire la mail ad orari prestabiliti
 Manda le mail sopo un'intervallo di tempo specificato.
-inserire header in più
...
Già a questo punto potete facilmente capire che se si imposta una catena di
remailer per mandare un messaggo si può già pensare ad un discreto grado di
sicurezza.Ricordate che il numero minimo di remailer consigliato è 3 e che
la sicurezza totale la si ottiene solo usando la crittazione dei messaggi con pgp.
In pratica la catena dei remailer è così: se si vuole spedire un messaggio
da A verso B , usando N remailer il percorso schematico sarà questo:

A->N1->N2->N3->B

Se poi usate remailer di tipo 0 e vi avvalete della possibilità di crittazione
dei messaggi e del posting dei messaggi cifrati siete già abbastanza sicuri!
...
potrebbe sapere dove viene inviata la mail dato che è inserito in una chiave
pgp.Capite che cosettina interessante?
Comunque , se è vero che un buon anonimato si ottiene usando più remailer vi
...
Sono più sicuri dei remailer di tipo 1 in quanto , prevedendo anche l'invio
...
Beh , il più evidente per chi non usa UNIX è il fatto che non esiste un
programma che generi dei messaggi compatibili con il formato mixmaster,
esiste solo un sorgente da poter compilare sotto DOS , ma non è alla portata
di tutti.L'unico modo di ovviare a ciò è ricorrere a Private Idaho ed al
l'apposito plugin per dos.Mmm, Private Idaho l'ho citato ma forse non sapete
che cos'è.. Beh, è un'applicazione che è in grado di gestire catene di
remailer di tipo 1 e , con l'apposito plugin , anche di tipo 2 , ma si rivela
utilissimo usando i nym server , dei quali tratterò poco più avanti.
...
viceversa.Anche se a questo problema si può ovviare usando un cosiddetto
"reply-block" che altro non è che una serie di istruzioni di inoltro attravero
vari remailer crittata con pgp.Il vantaggio immediato di un reply block è che
il destinatario della nostra missiva anonima possa contattarci , senza conoscere
il nosrto vero indirizzo mail.Un'altro vantaggio non da sottovalutare è che si
possono (e sarebbe meglio farlo) usare più catene di remailer , una per l'inoltro
ed una per il reply block , aumentando così di N volte la sicurezza , dove N è il
...
mail veramente anonime e di avere la possibilità di avere delle risposte alle
...
qualcosa di molto simile ai remailer di tipo 0 , cioè hanno un database di
relazione indirizzoanonimo->indirizzo reale e viceversa ma sono molto più
sicuri dato che hanno la possibilità di specificare come indirizzo reale in un
nym.Quindi , prima di usare un server di questo tipo , bisogna avere un nym
da utilizzare.Per crearlo è sufficiente creare una chiave pgp ad uso esclusivo
...
gli si invia il nostro reply block appena creato.Da questo momneot in poi è
possibile inviare la posta e sapere che non sarà possibile risalire a voi in
nessun modo.
Infatti i passaggi che il messaggio farà per transitare da A verso B sono i seguenti :
...
essere differenti , e sarebbe meglio che così fossero.Tenete sempre bene a mente
...
perchè troppo grossi! Potete anche fare in modo che un messaggio che vi viene
inviato al nym server segua due o più catene di remailer , in modo che abbiate
...
farvi una piccola idea dove X è il nym server e Y siete voi, il vostro indirizzo
mail reale:
...
anche in triplice copia , che è meglio di nulla.In alternativa o in aggiunta
potete anche specificare catene di remailer scelte fra tutte quelle che avete
inviato nel vostro nym e delle quali avete impostato un indice di probabilità d'uso.
Per ora direi che l'argomanto remailer è stato aperto , adesso sta a voi decidere se
vi serve un remailer o un nym server!
Per informazioni più dettagliate ed in italiano sulla crittografia in ogni sua
...
Scusate se il contenuto è troppo tecnico , ma la crtittografia è studio, se
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔═══════════════════════════════════════════════════════╗
        ║┌─────────────────────────────────────────────────────┐║
        ║│Se io sono io e tu 6 tu ki è il + scemo tra noi 2 ???│║
        ║└─────────────────────────────────────────────────────┘║
        ╚═══════════════════════════════════════════════════════╝

Mi chiederete "ma non dovevi fare un articolo sul cracking??
Che è questa specie di indovinello stupido???" ed io vi rispondo prontamente
...
Faccio un rapido calcolo di fuso orario e penso a ciò che potrebbe fare in questo
...
come un maiale pakistano ma questa è un'altra storia....magari in un prossimo articolo....

Mi ricordo ancora la 1° volta che ho crackato un gioco....era Larry 7 Love for
Sail....copiai l'intero CD sull'H-D, aprii il file .bat di partenza con l'edit
di Dos e lessi la stringa "cd path E:\" sostituì "E:\" con "C:\Larry" (dove Larry
era la dir in cui avevo copiato il cd), e mi rantolai a terra sghignazzando come
una iena Texana.
Il gioco partiva senza cd ed io avevo crackato il mio 1° gioco!!!.

Tutto questo per farvi capire come alle volte può essere facile crackare.....ma
non è tutto oro ciò che luccica!!
Oggi vi spiegherò come fare se volete far saltare un Cd-check per un gioco
oppure registrare uno di quei bastardissimi shareware.....
E' un metodo facilissimo, semplicissimo ed efficacissimo!!!!!!!!
Come avrete notato ha un titolo un pò strano ma abbiate fede nello zio Dante...
...tutto verrà spiegato.

Occorrente:   1° Win 32/16 Dasm....reperibile in rete
              2° Hiew.....anche questo reperibile nella stessa locazione
              3° Buona dose di puro culo....reperibile solo alla nascita purtroppo!!!

Il metodo consiste in questo:
Il Cd-check o il programma shareware esegue un così detto Jump durante il controllo
del cd, nel caso del gioco, della veridicità dell'user e pass, nel caso dello shareware.
Cos'è un Jump??? semplicemente un salto (non vi preoccupate il comp. non cercherà
...
E pur mi converrà vincer la pugna!!
...
con un algaritmo o con delle pass precedentemente inserite in memoria e si è detto:
se la pass è giusta registra il programma, se la pass non è giusta fai apparire il messaggio
Ed è proprio quì la succulenta idea: perchè non invertire i jump in modo da avere....
se la pass non è giusta registra il programma, se è giusta fai apparire il messaggio
SEMPLICE & GENIALE!!!!!
Ecco spiegato il nome del metodo: inverto i nomi e te lo metto in culo!!!

Disassembling

A questo punto dato che la fortuna non è dalla mia parte e la pass "che culo!!!"
...
Vi apparirà una finestra con una serie di stringhe.....fate doppio click su
quella con la frase con cui vi aveva risposto il programma (Brutto bastardo
hai inserito........), adesso spostandovi un pò in sopra evideziate la linea
in cui compare il jump condizionale Es.  je 1034732 adesso segnatevi l'offset
che non è niente altro che quel numero che compare in basso sulla finestra
...
Vi accorgerete di essere capitati su di una stringa in cui nella terza colonna c'è lo stesso tipo di jump che avevate trovato prima e di cui vi eravate segnati l'Offset, attenzione però non è dello stesso tipo.....è proprio quello!!!
...
Adesso viene il momento decisivo....il verdetto....sarete stati così bravi o
fortunati da azzekare il giusto jump???C'è solo un modo per scoprirlo....
Aprite lo shareware che avete appena crackato andate su register ed inserite
la vostra pass scaramantica: la mia è "Che" per l'user e "Culo!!!" per la pass
con variante "Caxxo" "che" "culo!!!" nel caso di richiesta di un altro codice
e sperate con tutti voi stessi di esserci riusciti....
A questo punto se avrete modificato il jump giusto apparirà una roba del genere:
"Registered" ed ora non vi resta che rantolare a terra in preda alle convulsioni
per la felicità con la schiuma che vi esce dalla bocca.....
by Dante Alighieri
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔═════════════════════════════════════════════════╗
        ║┌───────────────────────────────────────────────┐║
        ║│COME SI DIVENTA HACKER IN POCHI SEMPLICI PASSI?│║
        ║└───────────────────────────────────────────────┘║
        ╚═════════════════════════════════════════════════╝
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔═════════════════════════════════════════════════╗
        ║┌───────────────────────────────────────────────┐║
        ║│COME NASCONDERE L'IP IN ICQ (MA SOLO IN QUELLO)│║
        ║└───────────────────────────────────────────────┘║
        ╚═════════════════════════════════════════════════╝
...
127.0.0.1 o qualsiasi ip voi vogliate:
  ...
  Step 5: Selezionate "I am behind a firewall".
  Step 6: Cliccate sul pulsante firewall settings.
  Step 7: Selezionate "I am using a socks4 proxy".
  Step 8: Cliccate sul pulsante next.
  Step 9: Inserite un IP falso nella casella di testo "SOCK4 Host:".
...
Se volete riavere il vostro ip normale bastera':
  ...
  Step 2: Cliccate Preferences.
  Step 3: Cliccate sulla scritta Connection.
  Step 4: Selezionate "I am using a modem".
...
Bhe, cominciamo...
Allora vi parlerò dei bug che mezzo mondo conosce ma che alcuni appena
...
Uno dei bug più conosciuti al mondo Φ quello del PHF...
...
...e premete invio.
A questo punto se non avete fatto errori e se il PHF Φ bacato otterrete un
cat del file passwd, altrimenti se non lo Φ...un messaggio di errore.

Ma con questa stringa possiamo fare tante altre cose, come ad esempio dare
il comando "id" e vedere con che permessi gira il PHF, e se siamo un po
...
P.S. : ricordatevi che sul web lo spazio si rappresenta con la stringa %20
   ...
   echo "hacker::0:0::/home/lor1:/bin/bash" >> /etc/passwd
...
entrati spostate il vostro account a metà del passwd in modo da
...
sono attivi etc etc...
 ...
 eccetera eccetera, mailate tutto a lord_dest@iname.com, vi risponderò e
 vi insulterò al più presto };P

╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧

 ╔════════════════════════════════════════════════════════════════════════╗
 ║┌──────────────────────────────────────────────────────────────────────┐║
 ║│------------Che---Bello----Emailizzarci---IN----CORO------------------│║
 ║└──────────────────────────────────────────────────────────────────────┘║
 ╚════════════════════════════════════════════════════════════════════════╝
...
Musica ascoltata:Sound Track di Quake 2, Bach, un programma su "6"
...
allora, chi di voi per Windoze non ha mia avuto "divine ascension" o "X-mail"
...
finche' non si "unsubscribe" continuera' a ricevere mail !!!

Allora, c'e' da dire che il programma "AVALANCHE" MI SEMBRA facesse anche
...
e poi dicono anche "for subscribe mail to Majordomo@cazzo.figa" no subject body:
...
risponde paziente: "STA' CALM ! CASU' !"
...
si usa il + fedelissimo motore di ricerca "http://astalavista.box.sk")
...
questo solo se il loglevel in sendmail.cf è maggiore di 3 (anche se di default è 9 :)
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
                ...
                ╔═══════════════════════╗
                ║┌─────────────────────┐║
                ║│COME SI METTE UN BOT?│║
                ║└─────────────────────┘║
                ╚═══════════════════════╝

Buon giorno a tutti!
Quando mi chiesero se volevo scrivere un articolo per questa rivista ero un po'
incerto, forse perchè credo di avere ancora molto da imparare visto che non mi
ritengo uno dei "maestri" nel campo.
Alla fine però, come vedete :) l'ho scritto. Il mio scopo è quello di aiutare
...
Per chi non lo sappia (veramente pochi visto che quasi su ogni canale c'è un
bot) un bot è un "robot", che oltre a tenere sempre attivo un canale, oppa solo
chi volete ed esegue un mucchio di altre operazioni, ma solo quando glielo dite
voi (o almeno dovrebbe fare così hihi).
La prima e fondamentale cosa che dovete fare è quella di procurarvi una shell
sulla quale sia possibile installare un eggy. Hackate o tradate... è uguale basta averla!
Fatto ciò siete a metà dell'opera. Quello che dovete fare ora è uploadare il
...
usare sono: "ftp ftp.sodre.net", (inserendo anonymous come name e l'indirizzo
e-mail come password); per prelevare il file scrivete "get nomefile". Concluso
l'upload scrivete "quit" per tornare alla vostra shell.
Ora avete tutto ciò che vi serve per iniziare lavorare. Per decomprimere il file
dovete scrivere "gzip -d nomefile.tar.gz" e subito dopo "tar xf nomefile.tar".
Decompresso il file rinnominate la directory del bot in qualcosa come "../   ";
questo è un piccolo trucco per far si che la directory del vostro bot sia un po'
più nascosta. Entrateci dentro e scrivete "./configure", finito ciò scrivete "make".
Se tutto è andato come dovrebbe non dovreste aver avuto nessun segnale di errore.
...
Questo è il file di configurazione del bot. In esso sono contenute tutte le
informazioni riguardanti nick,server,canali ecc. Modificate il file a vostro
piacimento e rimettetelo nella shell.
Quindi scrivete "eggdrop -m eggdrop.conf" ed il gioco è fatto. Vi dico già da
subito che non sempre è tutto così facile....anzi spesso si hanno problemi con
tcl o con altre librerie strane;P.
In questo caso potete provare ad installare un precompilato (ve li consiglio).
Ciò dovrebbe eliminare il problema delle tcl e molti altri. Inizialmente dovete
scrive "uname -a" per vedere su che sistema operativo state lavorando. Dopodichè
dovete trovare un eggdrop precompilato. Uno dei siti che li forniscono è

                        http://www.unseen.org/~simpson/

scaricate quello corrispondente al vostro OS.
Ora basta decomprimerlo (vedi sopra) nella directory del bot, e senza fare "./configure"
e "make", scrivete solamente "chmod 777 eggdrop ".
Se avete svolto ogni passo come vi ho detto ed avete una buona shell il vostro
bot sarà già nel vostro canale pronto ad aspettare un comando :D
...
parte del materiale è in inglese).
Vi do un consiglio: se avrete dei problemi, rompete le scatole a tutti quelli
che ne sanno un po' più di voi, così facendo otterrete quasi sicuramente un
buon risultato!!! ;)
                                                            Ja[3]Ck
...
╔═══╦════════════════════════════════════════════════════════╦═══╗
╠═══╣COME VELOCIZZARE IL TRASFERIMENTO DI FILE IN DCC SU mIRC╠═══╣
╚═══╩════════════════════════════════════════════════════════╩═══╝
...
e' un duro colpo alla ns dignita' \°_°/ ) e appena entrati si saluta e si parla
dicendo frasi tipo "che bello che e' questo irc" stando attenti a non scrivere
...
a questo punto poi farete la...ehm...il finto tonto dicendo "ma xche alcuni
hanno uno strano simbolo a fianco del nome?" a questo punto l'op maschio in
cerca di notorieta' dira' cose del tipo "ce l'hanno i capi del canale, chi lo
...
vento facendo finta di essere una ragazza..."se vuoi lo do anche a te quel
...
Consigliatomi da un IrcOp "tu e i tuoi amici cambiate canale, ignorateli e vedrete
...
pss: un consiglio molto valido e' di uscire da tutti i canali in cui siete xche sentirsi
     dire "Cara Beatrice ma come non sai cos'e' l'op???? ce l'hai su 4 canali...
...
╔═══╦═════════════════════════════════════════════════════════════╦═══╗
╠═══╣COME FARE AD AVERE LA PASSWORD DI QUALCUNO...CHIEDENDOGLIELA!╠═══╣
╚═══╩═════════════════════════════════════════════════════════════╩═══╝
...
soliti "ciao" "come va" ditegli che dato che pensate che lui sia una persona
...
Ricapitolando ditegli "Per essere riconosciuto ora e sempre dal mio bot roBOTtino
...
mandategli un msg dall'altra finestra di irc del tipo"indentificato" e dopo un
...
pss: metodo mai sperimentato e non so nemmeno se lo ha partorito la mia mente
     sovraffolata di doc in inglese indecifrabili o se e' "opera di ingegno"
     di qualcuno, se qualcuno sa qlcs basta che lo comunichi a me o a zero e
     nel prox numero metteremo una sezione "ERRATA CORRIGE" a mo' di Il Mio Computer.
ps: se l'utente a cui avete dato la finta "dritta" non fa cio' che gli avete
    ben bene spiegato xche' ha paura che sia un trucco (barlume di speranza
    x l'umanita'...) voi dite qualcosa del tipo "byez io devo andare che ho
    ...
    nella vostra trappola...
                                                        ...
                                                        {D4m4g3~M4N}
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
¼ÇÇÇÇÇÇÇÇÇÇÇÇ##########ÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇÇ##########ÇÇÇÇÇÇÇÇÇÇÇÇ¼
≤╓╓╓╓╓╓╓╓╓╓╓╓╓ÄÄÄÄÄÄÄÄÄÄÄ COME HACKKARE UN SITO PORNO ÄÄÄÄÄÄÄÄÄÄÄ╓╓╓╓╓╓╓╓╓╓╓╓╓≤

         ╔═══════════════════════════════════════════════════════╗
         ║┌─────────────────────────────────────────────────────┐║
         ║│             COME HACKKARE UN SITO PORNO             │║
         ║└─────────────────────────────────────────────────────┘║
         ╚═══════════════════════════════════════════════════════╝
...
iNTRO
Allora, ansioso di hacckare un sito porno? Bè, innanzitutto devo anticipare
che questo non è uno dei miei sport preferiti, anzi, lo considero parecchio
da lamah, comunque sia può essere divertente provare ;) Cercherò di spiegarvi
come fare nel modo più veloce e semplice possibile.

rEQUISITI
Tutto quello che ci sarà necessario saranno un browser web (meglio se explorer
4x o netscape 4x) e un buon generatore di carte di credito. Ma di questo
parleremo più avanti. Iniziamo con il browser.

sETTARE IL BROWSER IN MANIERA OPPORTUNA
La prima cosa che devi fare quando hai il browser è disabilitare l'utilizzo
dei cookies. Mi chiedi perchè? Eccotelo spiegato.
...
di accesso...pensate un po'... Capirete quindi per quale motivo è
conveniente e sicuro disabilitarne l'utilizzo.

Ok, dopo aver fatto questo, sarà necessario disabilitare anche l'uso
...
faremo sarà esclusivamente ottenere i dati d'accesso con una carta
di credito falsa ;) Loro accetteranno il numero di carta, attiveranno
il login, che però durerà solo pochi giorni, fino a che si accorgeranno
dell'inganno..eheh...!! Se non ne avete questi programmi, vi consiglio
di scaricarvene uno, cercando su www.altavista.com "carding" o "credit
card generator".

rESTARE ANONIMI
Eccoci, questa è la parte un po' più impegnativa e più importante
...
uno di questi è usare un account di anonymizer (www.anonymizer.com).
Questo servizio ti permette di navigare in completa anonimità...
...
che sia necessario proseguire per chi non è disposto a farlo.
Un buon metodo per restare anonimi è quello di usare un server
proxy. Tralascio la spiegazione di "proxy", anche perchè la
cosa andrebbe un po' per le lunghe, l'importante comunque è
capire che:
...
in questo modo il tuo IP può essere loggato da quelli del sito e
se fosse così sarebbero cazzi amari...
...
anonimo sia effettivamente anonimo, basterà che andiate su
...
xxx e qualche video volete un po' di "fama", non dovrete far altro che
mandare username e password al sito www.xxxpassword.org... l'account
che avete attivato verrà messo a disposizione di migliaia di utenti
che, se volete, vedranno il vostro nome accanto a "hacked by.."
...eheh...eh già...siamo proprio dei bastardi!!!...
...
più utili in situazioni diverse (alcune info le potete trovare leggendo
l'articolo "RFC" su questo numero, ndr).

oUTRO
Bene, tutto quello che vi rimarrà da fare sarà quindi trovare un
...
Immaginetevi a cosa possono essere utili! Per tovarli basterà che usiate un
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
         ...
         ╔═══════════════════════════════════════════════════╗
         ║┌─────────────────────────────────────────────────┐║
         ║│    IP SPOFFING ATTRAVERSO I WINGATE By Zinco    │║
         ║└─────────────────────────────────────────────────┘║
         ╚═══════════════════════════════════════════════════╝

Sogno di ogni client di IRC è quello di nascondere ad un occhio vigile il suo Host di
provenienza, tutto questo è molto semplice, basta avere degli ip di server che possiedono 
il programma WINGATE in esescuzione. (non è altro che un programma che permette
a + computer di collegarsi ad internet con più PC ad un solo modem)
Una peculiarità di questo programma è quella di non richiedere il settaggio di
...
appunto del wingate, avvertendoci quando uno dei PC remoti in cui si è tentato il 
collegamento ha risposto con la stringa: "WinGate>".
...
Il problema è inserire un intervallo di IP valido.. Inserendo degli IP è un opzione che io 
...
Detto così può sembrare molto difficile trovare wingate, ma non lo è, una volta che avete 
beccato una "zona" di IP , ricca di WINGATE , in genere è sempre li che riandrete a cercare.

Ottenuto l'ip del Wingate, ci sono vari metodi per utilizzarlo per spoffare, io vi 
descriverò il più semplice e veloce.

CLIENT MIRC

Dovete andare nel menù "mIRC Setup" e da li a "Firewall"
Inserite l'ip del wingate nella casella "Hostname", abilitatelo con "Use SOCKS firewall" e 
...
Dal menù "Client Setup" andate nella voce "VIRC Option", poi "Winsock" ed infine "SOCKS".
In quest'ultima inserite l'IP del wingate nella casella "Server" e abilitatelo con "SOCKS
 support enabled".
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
        ...
        ╔═══╦══════════════════════════════════════╦═══╗
        ╠═══╣CUIOSITA' SU... LA PRIVACY SU NETSCAPE╠═══╣
        ╚═══╩══════════════════════════════════════╩═══╝
...
Se volete potete provare a mettere altri "about:" seguiti da nomi come mozzilla,
...
╔═╦═╦═══════════════════════════════════════════════════════════════════╦═╦═╗
╠═╬═╣CURIOSITA' SU... COME CREARE UN COLLEGAMENTO A INTERNET CON NOTEPAD╠═╬═╣
╠═╬═╣         (X FAR VEDERE CHE SIETE VERI HACKERS....HI HI HI)         ╠═╬═╣
╚═╩═╩═══════════════════════════════════════════════════════════════════╩═╩═╝
...
Ehheh-, ultimamente va di moda usare gli ip spoffati.... mi accingerò quindi
a spiegarvi + o - come spoffare il vostro ip.... Allora, innanzi tutto,
perchè spoffarsi? c'è più di un motivo,per iniziare quando andate irc nessuno
vede il vostro vero ip facendo un dns o un whois,perciò anke volendo non può
...
non può scoprire il vostro nick però puo sempre nukkare l'ip che gli è
arrivato heheheh, un ultimo motivo per fakkarsi è il fare scherzi alla gente...
...vi rimando perciò all'apposita sezione:o)) Avviate Portscan.Ora va configurato,
...
Firewall (1080) poi sulla sinista dove sta scritto "port set" , c'è uno
spazio dove dovrebbe essere scrito firewall, se non c'è scritto scrivetecelo,
...
è che dal dns che avete fatto risulti sia l'ip che l'address, fatto ciò avrete
...
e apparirà la finestra della scansione... nella parte in basso avrete le porte
che state scansionando..... quando ne troverete una buona apparirà sotto l'ip
...
che avete trovato è buono, lo vedrete nella finestra dello status nel mirc, vi
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
 ...
 ╔═════════════════════════════════════════════════╗
 ║┌───────────────────────────────────────────────┐║
 ║│     CHE DIFFERENZA C'E' TRA TCP/IP E UDP?     │║
 ║└───────────────────────────────────────────────┘║
 ╚═════════════════════════════════════════════════╝

Il protocollo TCP/IP è un protocollo basato sulla connessione ed è analogo a
...
computer è analoga al passaggio di un messaggio che viene inviato da un computer
all'altro, senza che venga stabilita alcuna connessione esplicita tra i due computer.
La dimensione massima dei dati che è possibile inviare in ciascuna trasmissione
...
(papà voglio diventare un cacciatore di lupi.... per coloro con poca famigliarità
con un linguaggio chiamato Inglese ^_^  ), così il padre gli propose di andare a
parlare con quello che era ritenuto il + grande cacciatore di lupi ancora vivente,
che tra le altre cose abitava anche dalle sue parti, e così il giovane cowboy partì.
Arivvato alla casa del vecchio vi trovò ad attenderlo una signora messicana grassa e
brutta ma simpatica e così gli chiese di poter parlare con il vecchio ed ella lo fece
entrare, fatto accomodare in una stanza sporca e buia si accorse che il vecchio era
steso su di un lettino e farneticava, così Hacky ansioso e speranzoso chiese al
vecchio di parlargli dei lupi e dei suoi metodi di caccia, ma come tutti i vecchi
anche questo non rispondeva esattamente a ciò che gli chiedeva il giovane ma alle
volte dava risposte senza senso però a tratti dalla sua bocca uscivano delle frasi
che erano perle di saggezza tipo "il lupo è come un fiocco di neve, quando pensi
di averlo in pugno ti rendi conto, che riaprendo la mano è sparito".Comunque Hacky
sentì il vecchio che ad un certo punto farfugliava qualcosa sul fuoco ma ormai si
era fatto tardi e doveva tornare a casa, quindi lasciò la casa e intraprese la via
del ritorno.
Giunto ormai a + di metà strada vide un vecchio bivacco per cowboy messicani e
ricordandosi le parole del vecchio gli venne l'idea di mettere una trappola vicino
al bivacco col fuocherello, e così fece,  posizionò la trappola e scrisse un
cartello in messicano che diceva "Trappola per lupi Attenzione", quindi tornò a casa.
Giunto a casa il giovane entusiasta raccontò al padre tutto ciò che gli era
successo e gli spiegò la sua idea della trappola. Il padre gli rispose "Bravo
Coglione, tu pensi che dei cowboy messicani sappiano leggere? Domattina prima
dell'alba andrai a smontare la tua trappola".
Così Hacky il mattino successivo si svegliò presto ed intraprese il cammino,
se non che arrivato al bivacco, si accorse che una stupenda lupa dal pelo
argenteo era caduta nella sua trappola.
Hacky si avvicinò di soppiatto e riuscì a mettere un bastone tra le fauci
...
stato....kissà perchè?!?!?!?).
Hacky si ingegnò e trovò un sistema per poter fare in modo da legare la lupa
al cavallo in modo da non farlo sbranare.....così durante la strada Hacky
cercò di far amicizia con la lupa e molto pazientemente ogni giorno tentava
...
Il primo giorno la lupa non mangiò, il secondo giorno la lupa non mangiò, ma il
terzo aveva fame e dovette accettare il cibo, così pian piano i 2 divennero
amici.Un giorno ritornando da un' osteria in cui si era fermato trovò la lupa
senza museruola, e con calma si avvicinò alla lupa che si fece rimettere la
museruola.
...
Messico un posto di blocco, la polizia fu ferma e decisa e sequestrò la lupa
al giovane.Hacky però si ripropose, che a qualunque costo avrebbe raggiunto
il suo scopo e che sarebbe sempre rimasto accanto alla lupa. Così aspettò ed
aspettò finchè un giorno vide che la lupa fu caricata in una cassa e portata
ad una fiera e lì venne esposta. Al prezzo di pochi cents si poteva vedere
...
cowboy che era un tipo di poche parole si ritrovò in una situazione in cui
qualcosa la doveva dire per forza e così fece un breve ma intenso discorso
all' animale che sembrava capire tutto ciò che il c-boy le diceva.
2 giorni dopo la lupa fu trasferita in un altro tendone, come una specie di
arena, ma un pò + piccola, circolare con un palo al centro, dove la lupa era
legata per mezzo di una catena.
Si potevano contare tre passi e poi ancora tre passi per arrivare al palo, ma
la catena copriva solamente la metà di quella distanza (3 passi per chi non
avesse capito  :-P ) dei cani da combattimento venivano aizzati verso la lupa
e dei messicani sugli spalti scommettevano sulla sorte della lupa. Hacky entrò
nella tende, vide quello spettacolo,e rimase calmo si sedette e vide 2 cani che
attaccavano la lupa, la lupa ammzzò il primo con un sol colpo, col secondo
ingaggiò una piccola lotta ma lo uccise dopo pochi istanti. Hacky si voltò
verso il messicano che gli sedeva accanto e gli chiese quanti cani ancora ci
fossero, ed egli gli rispose "Bastante" (abbastanza).Hacky uscì dal tendone
per ritornarci solo qualche ora dopo, ritrovò la lupa, azzuffata, insanguinata,
ma ancora viva.Così entrò nell'arena tra le urla dei messicani (che non avevano
mai smesso di scommettere) fece il  primo passo, poi il secondo, ed ancora il terzo...
parecchi si erano spinti fino là, ma nessuno oltre.Fece un altro passo e tutti tacquero.
Il ragazzo si avvicinò al palo, sganciò la catena, si voltò verso il pubblico,
ma non trovò neanche uno sguardo benevolo nei suoi confronti, così prese la lupa
e disse "Es Mia" (è mia)e se ne andò

The end

    Dov'è la metafora???
Ora voi mi chiederete appunto "Dov'è la metafora???" io vi risponderei "kakkio
ci sono 30mila metafore in questo racconto e non ne avete scovata neanche una???" :-)
Il racconto è una metafora della vita di ogni Hacker ed in generale della vita di ognuno di noi :
1-Il ragazzo voleva raggiungere un obbiettivo ma ha dovuto sudare per raggiungerlo,
  ha cercato di reperire informazioni per diventare un wolf-hunter così ogni Hacker
...
2-Trovi sempre qualcuno, anche il tuo + fedele amico(padre) che è pronto a
...
5-Una volta diventato lupa (hacker) ricordati sempre che il tuo animo deve
  essere per metà quello del cowboy (paziente e di poche parole) e per metà
  quello della lupa (aggressivo spietato e cattivo)
6-Quando pensi di essere riuscito a fare ciò che volevi la maggior parte delle
  volte non è così (non dire gatto se non ce l'hai nel sacco!!)
7-Anche se non riesci nel tuo scopo, non demordere mai, se hai la testa dura
  come il piombo, ed una volontà di ferro,ce la farai!!!!
8-Non lasciare mai che tu sia esposto o paragonato ad un fenomeno da baraccone.
  (non dire in giro ciò che fai o ciò che sai fare).
9-Spesso ti troverai a combattere, solo quando sarai allo stremo delle tue
  forze e solo allora si vedrà veramente quanto vali.
...
12-Trova sempre il coraggio di assumerti le tue responsabilità  di prenderti i tuoi
...
interiormente e magari che questa storia rimanga eterna in internet per sempre...kissà?!?!?!

Vorrei dedicare questa storia un pò a tutti gli amici che la sera mi tengono
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
         ...
         ╔═══════════════════════════════════════╗
         ║┌─────────────────────────────────────┐║
         ║│     Manipolati SI Manipolati NO?!   │║
         ║└─────────────────────────────────────┘║
         ╚═══════════════════════════════════════╝
 
MATERIALE: Una penna di struzzo una boccietta di inchiostro di china ed una pergamena circa del 1700.
ORE: Preferibilmente ore pasti al numero in sovraimpressione, hum mi sà che non centra nulla, humm vabbè :) 
...
LORO INIZIATIVA CHE DOVREBBE ESSERE D'ESEMPIO :-), E POI PERCH╘ SONO DEI
...
DI ORE ED ORE SEDUTI SU UNA SEDIA BRUTTA E VECCHIA (╘ TUTTO VEROOOOOO) :)))))))))

ALLURA inizio rompendovi un pò le palle cercando di farvi capire, che non sono
...
diventare così un esiliato politico :-).
Adesso spero abbiate capito tutto, anche se c'è poco da capire, iniziamo con
spiegare semplicemente con qualche esempio, il perchè dobbiamo non credere a
tutto ciò che ci propinano, e che il nostro sistema (intendo tutto il sistema
non solo quello italiano) ci manipola:
{{{HALT!! quasi dimenticavo, non stò scivendo una BIBBIA quindi potete
anche ridere e pensare: ma questo è propio BIP BIP BIP BIP BIP BIP BIP BIP e
così via:-) leggete con poca o molta attenzione per poi elaborare e magari
demolire la mia idea, dò liberta di parola IO!! :-)  }}}
OK a posto adesso si può iniziare, il mio motto è semplice, conciso, ma EFFICACE.
Perchè è propio quello che non fanno i mass-media che con la mal informazione
...
cattive e cioè PILOTATE; voi vi chiederete: ma pilotata da chi??????????, ed
...
Adesso uno si chiede ma come fà a funzionare questo "sistema"???!, semplice,
...
semplicemente l'opposto, cioè DICENDO TUTTO PER NON DIRE NULLA!!!
...
A questo punto uno legge tutto ciò e dice: OK OK siamo manipolati ed allora???
...
BHE prima di tutto, pensate con la vostra testa che è già difficile, poi
bisogna lavorare nascosti per non venir "corrotti", e dato che avete prelevato
tutto ciò dalla RETE iniziate con il battervi per tenere la rete libera da
...
RABBIA SU QUELLO CHE HO SCRITTO, O VOLETE PRESENTARMI VOSTRA MOGLIE PERCH╘
...
confondo sempre, quello è il mio secondo lavoro :)
...
che hai tra le altre due che ci sto!" e cosi' eccomi qua. Siccome non ho molte
...
spropositata di lettere per di piu' in inglese?" e io risponderei:
...
ULTERIORI INFO = questa e' una lista per particolareggiate discussioni sui
                 ...
                 l'uso dei buchi e i relativi rischi". Sono accettate dal
...
COME REGISTRARSI = mandare una email mettendo nel corpo "SUBSCRIBE firewalls"
...
COME REGISTRARSI = mandare la email mettendo nel corpo"SUB infsec.l your-name"
                   (y-n=vs nome) :P
...
COME REGISTRARSI = mandare una email mettendo nel corpo "subscribe ids"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "subscribe ntbugtraq"
COME TOGLIERSI DALLA ML = mandare una mail mettendo nel corpo "unsubscribe ntbugtraq"
...
NOME = NT Security
INDIRIZZO X REGISTRARSI = majordomo@iss.net
COME REGISTRARSI = mandare una email mettendo nel corpo "subscribe ntsecurity"
COME TOGLIERSI DALLA ML =  mandare un mail mettendo nel corpo "unsubscribe ntsecurity"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "SUBSCRIBE Phrack"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "SUBSCRIBE"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "SUBSCRIBE virus-l your-name"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "I want to be on your mailing list"
...
COME REGISTRARSI = mandare una email mettendo nel corpo "subscribe cryptography"
...
almeno uno solo di voi si "sottoscrivera' " qualcuna di queste ml allora il
...
L'autore non ha responsabilità alcuna sulle azioni che potrebbero essere 
...
Come tutti saprete FrontPage (che chiamerò FP d'ora in avanti)
serve a creare siti web, però in più rispetto a un semplice
editor Html ha la possibilità di utilizzare dei programmini che 
vengono forniti insieme.
Per il corretto funzionamento di questi programmini è necessario
però che nel server in qui andranno messi siti fatti con FP
...
sia sempre più una politica aziendale 8oD).
...
Bene a sua insaputa FP creerà l'everyone group per avere accesso
al server tramite il FP Explorer.
Il punto è che il sysadmin non lo sa e quindi l'accesso rimane
senza password permettendo così a chiunque di modificare le sue
pagine Web!
...
belle ed ambite password :-). Spiegherò poi come sfruttare questi
file, nel frattempo salvateli :-).

Ora zio Bill dice: "Ma cazzo lo sanno tutti che NT fa schifo e
così sanno anche che se non entro da questa porta entro dalle
finestre (Windows), facciamo qualcosa per incasinare anche Unix"
Voi direte: "Ma chi è così imbecille da installarsi le estensioni
...
nuovi account).
Ma se non avete una shell non abbiate paura è giusto dare a
tutti una possibilità. Apriamo il nostro browser e scriviamo:
...
Non vi preoccupate la prima parte è il login la seconda è la
...
bhe non è mica colpa vostra 8oD.
...
Forse si può usare anche con la 8.9 ma non ne sono sicuro.
...
SMTP: recepient ok!
io: DATA
SMTP: Enter mail, end with "." on a line by itself
io: - messaggio -
.
io: Quit.
...
Inserendo "anonymous", per esempio, sugli header apparirà questo:

Return-Path: &lt;anonymous@0202.iol.it>

Non è necessario che il nome del mittente esista davvero ma deve essere scritto
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
         ...
         ╔═══════════════════════════════════════════════╗
         ║┌─────────────────────────────────────────────┐║
         ║│     VISUAL BASIC TUTORIAL [ prima parte ]   │║
         ║└─────────────────────────────────────────────┘║
         ╚═══════════════════════════════════════════════╝
        
Ok ragazzi, benvenuti nel mondo del Visual Basic.
Questa "guida" sarà un semplice strumento per introdurvi all'uso di questo
ambiente di sviluppo.
Prima di tutto cosa è il Visual Basic? si tratta essenzialmente di un linguaggio
orientato agli oggetti. Semma sul significato di "linugaggio orientato agli
oggetti" ci torneremo... non è importatissimo per cominciare.
Per il momento ci limiteremo a dire che, generalmente, un OOL su basa sulla
gestione di eventi. Un evento altro non è che un avvenimetno che si verifica
durante l'esecuzione del programma (è un evento la pressione di un bottone,
la digitazione di qualcosa su una casella di testo e cos∞ via).
Noi (programmatori) dobbiamo creare una gestione degli eventi (ad es. decidiamo
cosa succede alla pressione di un bottone, ...).
Ma ora basta con le nozioncine, dedichiamoci a qualcosa di più pratico (se ho
lasciato qualcosa lo aggiungerò nei prossimi numeri).
Oggi parleremo della creazione di semplici form e faremo qualche esperimento
creando un semplice programma.
Un form è una finestra; inizieremo inserrendo nel nostro form 2 CommandButton
(pulsante), 1 TextBox (casella di testo) e 1 Label (etichetta).
Ogni oggetto (form, pulsanti, etichette....... sono tutti oggetti) ha delle
proprietà (alcune delle quali possono essere modificate) e dei metodi.
Un metodo è una funzione supportata dall'oggetto (ad es. possiamo, tramite
l'apposito metodo nei controlli directory, fare un refresh della directory
corrente).... questi li useremo successivamente.
Parliamo ora delle proprietà. Premendo con il tasto destro del mouse sul
CommandButton, l'ultima voce del  menù di popup indicherà la voce "proprietà"; cliccateci.
Nella finestra comparsa potrete modificare le proprietà dell'oggetto. Prima
di tutto il nome: button1 non è molto esplicativo, e se all'inizio potrebbe
andare bene, con la creazine di programmi più complessi potrebbe non essere
abbastanza chiaro.
Quindi è sempre opportuno dare un nome preciso ad ogni oggetto. Ad es., al
pulsante di uscita, gli daremo il nome "cmdEsci".
Il prefisso "cmd" lo usiamo per "ricordarci" che si tratta di un pulsante.
Ecco i prefissi più importanti:
cmd	CommandButton
lbl	Label
txt	TextBox
frm	Form
...
Ogni oggetto ha alcune proprietà caratteristiche ed altre comuni agli altri.
Le più comuni (quelle che userete di più) sono:
Name            Indica il nome del controllo (il form è composto da controlli).
                Useremo questo nome per far riferimento al controllo.
Caption         Indica quello che sarà visualizzato sul controllo (per es.
                il testo del CommandButton)
Enable          Indica se il controllo può essere attivato o meno
Height          Indica la distanza del lato in alto del controllo dal lato
                ...
                più avanti, per il momento sappiate che quello che usiamo più
                spesso come Recipient è il form)
Width           Indica la distanza del lato sinistro del controllo dal lato
                sinistro del Recipient
Visible         Indica se il controllo è visibile
...
Magari in uno dei prossimi numeri farò una tabella con tutte le proprietà e
...
TextBox io di solito gli dò lo stesso nome... è solo una questione di comodità).
Lo scopo del programma è visualizzare un testo (contenuto in txtTesto) 3 volte.
Assegnamo le caption ai vari oggetti (compreso il form.... inventate un titolo)
e passiamo al codice.
Quella che abbiamo creato ora è l'interfaccia, quello cioè che l'utente vede,
...
La prima istruzione, Unload xxx, scarica dalla memoria il parametro indicato che può
...
Questa istruzione è facoltativa... ma sempre comoda!!!

La prima routine è un pò più "complessa"... e necessita di qualche spiegazione in più.
L'istruzione Dim serve per dichiarare le variabili. In VB non è obbligatorio
dichiarare le variabili (a meno che voi, con un'apposita istruzione, non lo
facciate diventare tale). Nonostante questo, è sempre buona abitudine farlo,
anche perchè altrimenti il compilatore le considererà tutte di tipo Variant (vedi sotto).
Vi sono diversi tipi di variabili.

Questa è una parte della guida che riepiloga i tipi di dati:
***********************************************************************
...
Decimal                                        14 byte                       +/-79.228.162.514.264.337.593.543.950.335 senza virgola;
                                                                             ...
                                                                             il numero minore diverso da zero è +/-0,0000000000000000000000000001
...
Definito dall'utente (utilizzando Type)        Num. richiesto dagli elementi L'intervallo di ciascun elemento è identico a quello del relativo tipo di dati sopraelencato.

***********************************************************************

Per cercare di utilizzare il minor numero di risorse possibili, è inutile
utilizzare un variant quando potrebbe bastare un integer.
Quindi è sempre necessario controllare quali valori dovranno finire nella
variabile e dichiararla di consenguenza cercando di ottimizzare le risorse.
Nel nostro esempio le variabili I e N sono di tipo Integer, mentre Testo è di tipo String.
E' possibile dichiarare più variabili su una riga, ad es.
Dim I as Integer, Testo as String
è uguale rispetto alla sintassi dell'esempio.
Ritorneremo sul discorso delle variabili quando sarà il momento di definirne
...
dove x è il contatore (la variabile che sarà incrementata), y è il valore
iniziale, z è il valore finale e w è il margine di incremento (di quanto cioè
l'indice aumenta ad ogni esecuzione del ciclo).
L'opzione Step non è obbligatoria e, nel caso non fosse presente, viene preso
come riferimento il valore 1. Lo Step può anche essere negativo (ad es. -1).
ATTENZIONE AI CICLI INFINITI!!!!!!
Infatti scrivendo per esempio:

For x = 1 to 5 Step -1

Si avrà un ciclo infinito........
...
Il comando in questione è Exit For.
...
cicli, ce n'è un altro ad indice M che si ripete 50 volte.
...
printf("Sotto forma di carattere è %c, sotto forma di numero è %d",carattere,carattere);
...
main(){
 ...
 int numero;
        ...
        scanf("%d",&numero);
        printf("\n\rIl doppio di %d è %d",numero,doppio(numero));
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
         ...
         ╔═════════════════════════════════════════════════╗
         ║┌───────────────────────────────────────────────┐║
         ║│GREEN UPDATE [ che sfiga ne han beccati altri ]│║
         ║└───────────────────────────────────────────────┘║
         ╚═════════════════════════════════════════════════╝
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
         ...
         ╔══════════════════════════════════════════════╗
         ║┌────────────────────────────────────────────┐║
         ║│COSA DI SOLITO CONTIENE IL FILE TEST-CGI.CGI│║
         ║└────────────────────────────────────────────┘║
         ╚══════════════════════════════════════════════╝
...
poche volte :(( Se vi ho dimenticato be....mi rifaro' la prox volta. °|^__^|°
...
Byez a tutti questo 1° num della e-zine e' finito, se volete commentare la e-zine,
