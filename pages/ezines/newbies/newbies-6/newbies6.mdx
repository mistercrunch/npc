...
[ also from Dante Alighieri to: chi gli Φ lontanto ma vicino e chi gli Φ vicino
[ ma lontano....]
...
lettura di questo 6° numero e vi mando un saluto
...
qu∞ sotto..beh sorry :/ provveder≥ dal prox numero a darvi una risposta
certa dopo un paio di gg max dalla consegna affinchΦ le vostre aspettative
non vadano deluse :)
...
Ancora, non pensate che aver giα scritto un articolo per la zine sia un
...
hack phreak di un paio di palle" italiana solo perchΦ ci avete mandato
un articolo....
Poiiiiii........vorrei parlα del Nobo..caxxo il nobo ci lascia ragα!!
non scrive e non fa + il redattore per NB !! :░░░(
GRRRrrrrrrrrr.......fratΦ...t'ammazzer≥!!! ti verr≥ a dare le fustigate
sulle chiappette! ma come cazpio faccio a mannα avanti la baracca senza di
te? uffff....... ci sarα MAX che mi aiuterα...ma il nobo Φ il nobooo !!!!
Novitα delle novitα by MAXXOLINO
...
Questa idea mi Φ venuta in mente mentre leggebo bfi7 e pensavo che nessuna zine ha questi
tipi di sezione ... quindi newbie sarebbe la prima! Io penso che potrebbe essere una buona 
iniziativa,ma a voi spetta la sentenza...l'ultima parola Φ data a voi lettori di newbie,quindi
pensateci bene!
...
1░Impressione: ammazza...ma che Φ sta maera di figa??? ahhaha..
molto mejo cos∞ ragα..na roba da paura... "nnna cifra" in giro per quei
loculi maledetti... hihihi :)
Per quei pochi di voi che non lo sanno ankora..l'hack meeting 2k s'Φ
svolto al Forte Prenestino a Roma..in pratica un vero Castello con tanto
di mura, fossato e catacombe!! hihihi...ed indovinate un p≥ dove ci hanno
sistemato?? NELLE CELLEEEEEE!!! Segno premonitorio o soltanto
uccellaci del malaugurio?? boh..non si saprα mai.. cmq..una cosa Φ certa:
...
sotto la rete stessa......grrrr.....e vabb∙ la moda "Share the fun"...
e vabb∙ l'anarkia...e vabb∙ che le cose mie son le tue..ed il contrario..
...
noti come "Raul Chiesa" (spero si scriva cos∞ il suo nome) e Gomma sistematisi
...
informatica l'etica Φ una cosa...i soldi un'altra..sorry penso di avere un
...
genere: "fuck fuck fuck" o "posso provare a rootarti io la shell??", Φ proprio
quando si pensa di essere i migliori che si prendono le inculate + grosse.
(hijacking rulez)
VabbΦ...una delle cose che penso avranno notato tutti all'hackit Φ la comparsa
...
sotto forma diversa..a noi poveri dell'hackit c'Φ tokkata la SMAV !!!
...
Ma..t'ho visto andare in giro mano nella mano con la smavva...Φ la tua tipa????
...
Non scorder≥ mai i giri nei cunicoli abbracciato a MaYhEm (ubriaco frascico)
che parlando con un Australiano (?) gli ha augurato un "have a nice trip"
molto ambiguo :P.
Solo un'ultima precisazione...non m'Φ piaciuto sentirmi dire l'ultimo gg
da mia madre: Che beeellooo t'ho visto sul TG1 stamattina!!!
......che nervi....mi si Φ inacidito il sangue per un gg intero...
cazzo...avevamo detto niente telecamere :(((((
VabbΦ...la pula non Φ ankora venuta a casa mai..per adesso sono ok :))) hhiihih
Rigα...vi auguro un'ottima lettura sperando sta zine ve gusti e che non
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
   ...
   ╔══════════════════════════════════════════════════════════════════════╗
   ║┌────────────────────────────────────────────────────────────────────┐║
   ║│ INVIO DI PACCHETTI ICMP CON L'UTILIZZO DELLE RAW SOCKET by |CyRaX| │║
   ║└────────────────────────────────────────────────────────────────────┘║
   ╚══════════════════════════════════════════════════════════════════════╝
...
32-bits  daddr▐stination address.
...
una funzione interessante e' la setf() :
	...
	cout.setf(ios::X, ios::basefield);
		//produce interi in base X ( X▐c, oct, hex )
...
cmq ora cominciamo su come operare su sti stream e sicuramente avrete tutto + chiaro.
...
ß:38 39 32 46 42 37 44 43 41 36 41 38 36 30 44 41 42 42 34 44 38 36 33 39 00
─:38 43 32 41 42 32 44 39 41 33 41 44 36 35 44 46 42 45 34 38 38 33 33 43 00
▄:39 34 33 32 41 41 43 31 42 42 42 35 37 44 43 37 41 36 35 30 39 42 32 34 00
²:39 35 33 33 41 42 43 30 42 41 42 34 37 43 43 36 41 37 35 31 39 41 32 35 00
╓:39 45 33 38 41 30 43 42 42 31 42 46 37 37 43 44 41 43 35 41 39 31 32 45 00
º:45 46 34 39 44 31 42 41 43 30 43 45 30 36 42 43 44 44 32 42 45 30 35 46 00
...
╡:46 44 35 42 43 33 41 38 44 32 44 43 31 34 41 45 43 46 33 39 46 32 34 44 00
...
anche chiamate "ip spoofing, raw socket ect ect " avrete bisogno di "knoware"
...
Un "Model of Operation" risiede su ogni host e su ogni gateway. Esso ha la
funzione di interpretare gli "Addresses", frammentare e riassemblare i
pacchetti.
...
viene distrutto. Il "TTL" puo' essere pensato come un tempo limite di
...
il caso in cui i dati potrebbero contenere errori. SE l'"HC" fallisce, il
...
Gli errori vengono riportati via "Internet Control Message Protocol"(ICMP)
che e' implementato nell'"Internet Protocol Module".
...
network number, seguito dal local address(chiamato campo "rest"). Esistono tre
...
Un Internet Datagram puo' essere marcato come "Don't Fragment".
Ogni datagramma cosi' marcato non viene frammentato in nessuna circostanza.
Se il datagramma marcato "Don't Fragment" non puo' raggiungere la destinazione
...
successivamente. Il Ricevente dei pacchetti usa l'"Identification Field" per
assicurarsi che i frammenti di differenti datagrammi non vengano mischiati.Il
Campo "Fragment offset" informa il ricevente circa la posizione del frammento
nel datagramma originale.I vari "Fragment Flag" indicano l'ultimo
frammento.
Questi campi provvedono informazioni sufficienti a riassemblare i
datagrammi.

L' "identification field" e' usato per distinguere il frammento di un datagrammma
...
2.4 Gateways
    ...
    i vari networks.Implementano anche il protocollo "gateway to gateway" (GGP)
...
Il valore dei protocolli e' specificato in "Assigned Numbers".
...
la fine delle opzioni non coincide necessariamente con la fine dell'header.
    ...
    I valori sono definiti nello "Standard Security Markings".
...
vostre ingiurie verso il sommo Bill "potato" Gates
 __________
...
tratta da "Guida ad IPv6" di Silvano Gai e dagli rfc 1881, 1883, 1884; gli
...
infatti chiunque puo' presentare una proposta perche' " diventi " RFC
...
- Required -> sono le RFC " Obbligatorie " , cioe' devono essere 
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
               ...
               ╔════════════════════════════════════════════╗
               ║┌──────────────────────────────────────────┐║
               ║│  ROUTER SIMULATOR LA FIGATA DEL 2000 :D  │║
               ║└──────────────────────────────────────────┘║
               ╚════════════════════════════════════════════╝
...
replacement" caricheranno nella cache solo le info con una maggior prob. di
...
DISCLAIMER:
  Quanto state per leggere è stato scritto a puro scopo didattico, l'autore
  condanna quanti vogliano utilizzare le informazioni qui scritte per scopo
  illegale. L'autore non si assume nessuna responsabilità per eventuali danni
...
Introduzione:
Chi, come me, ha una passione per l'informatica da un pò di tempo ricorderà
...
NIENTE! Si trattava di un normalissimo gioco di corse di automobili, che però
...
videogioco furono ritirate dagli scaffali dei negozi... solo perchè degli
stupidi consideravano violento questo gioco... perchè poteva influenzare i
giovani adolescenti convincendoli che era moralmente corretto investire le
persone! Un paio di mesi più tardi venne introdotta la versione censurata,
...
mi è mai piaciuta questa versione del gioco.

Nonostante questo, la violenza nei video giochi è continuata ad aumentare...
oggi vendono per lo più i titoli dove si entra in campo con un arsenale che
farebbe invidia perfino ad un'intera truppa militare, dove si spara a più non
posso e dove non esistono alleati o nemici... se vi sono alleati è meglio per
loro stare il più lontano possibile (almeno da me in Unreal tournement.. ne
ho ammazzati un bel pò della mia squadra.. prima si spara e poi si pensa!).

Nel 1998 finalmente è stato pubblicato il seguito di CARMAGEDDON
                         CARMAGEDDON II - CARPOCALYPSE NOW

Finalmente non è stato censurato nemmeno nel nostro paese!! E finalmente
...
già visto in altri cd. Per dare maggiore conferma al mio dubbio cerco nel CD
eventuali file con estensione .ICD. Ok sono stati trovato e come al solito
oltre a CARM2_HW.ICD e CARM2_SW.ICD ci trovo due eseguibili. IL CD Rom è
stato protetto con SafeDISC e il mio bel masterizzatore non supporta la RAW
Write... maledetta YAMAHA! Allora non resta altro che crackarlo! Io crackerò
CARM2_SW.ICD dato che non ho schede 3D sul pc, ma il metodo usato è identico!
...
lo decripta solo quando si è realmente accertato che il disco utilizzato è
...
Ok.... questa è la struttura del file, per nostra fortuna SafeDISC non cripta
questa tabella.. altrimenti sarebbero guai :P

Di tutte queste sezioni, CODICE e DATI sono criptate... Non si capisce un
mazzo di quello che c'è memorizzato sul disco!
...
software e così mi carica sempre CARM2_SW.EXE. Mi compare una msg box che
dice gentilmente di rimuovere il debugger. Avvio FrogsICE e tolgo la schermata
BLUE SCREEN OF DEATH .. così SoftICE funzionerà come se nessun check anti-debug
fosse attivo sul pc. Ricarico il gioco e lo faccio girare fino a che il monitor
non diventa scuro xchè sta caricando il gioco. Carico SoftICE premendo CTRL+D
ed è ora di incominciare :P
Settiamo un bel break point sull'entry point del gioco... Assicuratevi
che sia il punto giusto di memoria ok ?? :P Per questo gioco l'entry point è
00173730 ... ma è quello sul file, sommiamo l'image base ed otteniamo 00573730
...
PAGEIN D 401000 181A9C c:\text.bin    ; Così ci copiamo tutto la sezione 
.text
                                       ; dalla memoria sul disco fisso.
PAGEIN D 589000 E7000 c:\data.bin      ; Idem x data.. però qui vi faccio notare
                                       ; che copiamo solo quanto risulta essere
                                       ; la dimensione fisica e non la lunghezza
                                       ; virtuale... altrimenti ci troverremo con
                                       ; un eseguibile quasi 2 volte più grande
                                       ; dell'originale!

La sezione .rdata la lasciamo dove è ... è la IAT e se la importiamo ci
mettiamo nei guai... il loader non ci darebbe il programma!

Tracciamo un attimino il programma, finchè non incontriamo la prima
CALL DWORD PTR [xxxxxxxx]. Tracciamo questa CALL, entriamo dritti in una
tabella di JMP DWORD PTR [xxxxxxxx] però il sice quel xxxxxxx l'ha tradotto
in nomi. Dove ci troviamo noi è JMP DWORD PTR KERNEL32!GetVersion. Avviamo
ok ... continuamo con l'esecuzione del programma... non ce ne può sbatter di
meno! Chiudiamo il gioco e facciamo una copia del CARMA2_SW.ICD e lo chiamiamo
CRACKED.EXE (La vittoria è del più forte... se usa un minimo di cervello :P)
...
La sezione .text è stata sostituita con quella copiata dalla memoria :P
Notiamo i vari parametri... C:\TEXT.BIN è il file di origine, CRACKED.EXE
il file di destinazione, 0x0 è il valore esadecimale da dove si incomincia
a leggere dall'origine, 0x400 è il valore invece esadecimale da dove si
incomincia a scrivere, 0x181A9C è il valore esadecimale di quanto si deve
scrivere.

SUPWRITE C:\DATA.BIN CRACKED.EXE 0x0 0x187C00 0xE7000. Problema risolto :P

Ok .. potremmo dire che il programma è crackato. ma qualcosa non va. Avviate
il file e vi darà errore di protezione. Tracciamolo col SoftICE. Vi ricordate
...
Dovremmo lavorare un pò con la vecchia carta e l'editor. Innanzi tutto
...
ordine progressivo, così come vengono e riportiamo anche l'offset in cui
...
tabella ed idem ho fatto anche con la tabella di USER32. Così mi ritrovavo
...
Addr:xxxxxxxx Ci indica l'indirizzo dove è memorizzata la funzione.
...
è tutta ordinata... riscrivo tutte le voci come ho fatto la prima volta
...
Ringraziamenti:
  ...
  xOANON - Per avermi gentilmente (miracolo!! Ha risposto alla richiesta!)
           indicato come fixare il tutto... solo che è molto palloso questo
...
misteriose Quequero... forse è stato rapito dagli alieni o magari ha deciso
di darsi alla latitanza come +ORC (e magari un giorno ci arriverà qualche
...
ricerca sulla rete ?? Ho dovuto crackare l'intero gioco x necessità altro
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
               ...
               ╔════════════════════════════════════════════╗
               ║┌──────────────────────────────────────────┐║
               ║│ UN TRUCCO AL GIORNO GRAZIE A WWW.UGU.COM │║
               ║└──────────────────────────────────────────┘║
               ╚════════════════════════════════════════════╝
...
&lt;Boba-Fett> si', la sfiora delicatamente
...
SOTTOSOTTOSOTTOTITOLO: COME SUPERARE TUTTO CIò SENZA AVERE NESSUN SEGNO
...
1°GIORNO (SABATO 15\04\2K): Io (N0bodY88-ooo) arrivo a casa della famiglia HDE
                            ...
                            2° V56 dormiva su due sedie e gli altri sonnecchia
                            vano (ma non la fida adry!) ci siamo fatti una
                            collazione alla grande come direbbe qualcuno ;)

2°GIORNO (DOMENICA 16\04\2K): dopo la collazione smav si desta dal divano
...
(MARTEDI' 18/04/2K): dopo 12 ore di sonno che dovevano bastare x l'intera
                     ...
                     xche' non 6 venuto b.i.!!!! :°(( ). Una volta a casa di
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
   ...
   ╔════════════════════════════════════════════════════════════════════╗
   ║┌──────────────────────────────────────────────────────────────────┐║
   ║│       SE I VOSTRI BOT SI SENTONO SOLI....FATE LA BOTNETTA        │║
   ║└──────────────────────────────────────────────────────────────────┘║
   ╚════════════════════════════════════════════════════════════════════╝
...
OCCORRENTE:  Una radio, non si sa mai....
             ...
             le pinze "apposta" ( costo approssimativo delle pinze 50.000£ ).
             ...
             Una bottiglia di Sprite ( Cosa bevono li smanettoni più estremi?
             la stessa cosa di queli più impediti. Ascolta la tua fame, fatti
             una biondona :) ).
...
6 10 o 14 porte con le stesse cartatteristiche di velocità: se gli HUB erano
da 100 Mbit/s, anche il risultante rimane da 100 Mbit/s.
Detto questo vediamo un po' ciò che ci interessa realmente per connettere  sti
due benedetti pc.
...
Nel caso ci siano piu schede è ovvio che ci vuole un qualcosa che reindirizzi
...
Quando però ci interessa collegare solo due pc l'HUB diviene praticamente
inutile, o meglio sprecato. (ricordo che costa sempre attorno alle 200 000 £)
...
Ora se vi dico che il TX+ è il pin 1, il TX- è il pin 2, l'RX+ è il pin 3 e
l'RX- è il pin 6 vi viene in mente nulla... ?
...
di rete Ethernet e cavo con connettori RJ45 è finalmente svelato...
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
   ...
   ╔════════════════════════════════════════════════════════════════════╗
   ║┌──────────────────────────────────────────────────────────────────┐║
   ║│ QUALCHE CONSIGLIO UTILE SU COME FOTTERE LE MACCHINETTE DEL POKER │║
   ║└──────────────────────────────────────────────────────────────────┘║
   ╚════════════════════════════════════════════════════════════════════╝
...
107 caratteri (std BCD) nei campi :
        SS,FC,PAN,Use security data,Additional Data,ES,LRC (vedi standard in
                  internet)
Il campo "clue" e' "Use security ecc. ecc." che contiene :
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
          ...
          ╔════════════════════════════════════════════════════╗
          ║┌──────────────────────────────────────────────────┐║
          ║│       OPEN SOURCE segnalatoci da MAXPIRATA       │║
          ║└──────────────────────────────────────────────────┘║
          ╚════════════════════════════════════════════════════╝
...
Un gruppo di volontari sta lavorando alla progettazione delle componenti 
...
Presenta :
        ...
        Come bloccare e sbloccare la possibilità di modificare un dbase in
        Acess97....
...
Occorrente :
        ...
        immediate vicinanze ... :)
        Uno stereo... la musica è indispensabile per ipnotizarre il PC ....
        Vedi tu una Coca Cola o tè alla pesca, come ti gira ...
        Buoni riflessi con il mouse ... questo non è uno scherzo ...

Iniziamo creando un Dbase con Acess come cacchio ci gira quindi divertitevi :)
L'unica cosa che vi consiglio è di creare una maschera in modo da rendere il
tutto un po' più divertente he he he he.

(1) Come bloccare un database

Una volta creato bisogna settare i parametri di avvio per il nostro dbase. Per
fare ciò andate sulla barra dei menù quindi: "Strumenti" ==> "Avvio ..."; vi
...
"Titolo aplicazione" => è il titolo che appare sulla finestra principale di
...
"Barra menù" => nel caso creiate più barre dei menu potete associare quella
che volete a questo dbase altrimenti potete lasciare "(predefinita)".
"Menù completi" => Eccoci arrivati alla prima voce interessante...
deselezionandola spariscono i menù: "Visualizza", "Formato", "Strumenti"
he he he proprio "Strumenti", quindi una volta modificate le impostazioni
di avvio deselezionando questa voce non è più possibile tornare indietro
(teoricamente... vi spiego poi come si fa a ritornarci)
"Menù di scelta rapida predefiniti" => Deselezionandolo si disabilitano i
menù di scelta rapida, incredibile vero? :)
...
"Barra menù di scelta rapida" => stessa cosa dalla "Barra menù" solo che sta
volta è per quelli di scelta rapida Stupefacente ......... :)
...
Ciò che volevo dire è l'abbinata di praticamente tutte le check eccetto quella
...
la barre dei menù predefinita. Una volta lanciato vi chiederà se aprire un
dbase esistente o crearne uno nuovo: voi selezionate quello esistente
bloccato ma NON APRITELO ASSOLUTAMNETNE ORA. Spostatevi con il mouse sul menù
"Strumenti"e appena premete il tasto IVIO per aprire il database clickateci
sopra in modo tale che il menù si apra durante il caricamento del dbase e ...
magia ... il submenù "Avvio" è ancora lì disponibile he he he.
Entrateci e riabilitate tutto quindi uscite oops non è cambiato nulla ...
chiaro il menù non si chiama Avvio per nulla... Dovete uscire da Acess
...
introdotto un po' il mondo di Acess e sinceramente non ricordo più se mi ha
...
semichiuse, e non mi passa un cazzo. PerchΘ? Sono stufo. Mi sono rotto. Ho
...
autolesiono con il fumo. PerchΘ? Sono un masochista. Siamo tutti masochisti.
...
cicca. La stanza e' satura di fumo. Pensiamo solo al guadagno. PerchΘ abbiamo
amici? PerchΘ ci sono nel momento del bisogno. Cioe'? Ci danno qualcosa. Li
...
ma non l'ha fatto. PerchΘ? Forse non e' cattivo. Hitler e' cattivo? Ha ucciso
...
Emozioni forti, potenti, implacabili. Forse non sono inutili. Quelle. PerchΘ?
Bisogna sempre chiedersi il perchΘ. Sempre. Cicca spenta. Mai provato ad amare
...
PerchΘ ora mi alzo? Cosa devo fare di cosi' importante? PerchΘ non posso
continuare a dormire? Devo cambiare il mondo? Devo crearmi una vita? Devo
andare a scuola? Devo lavorare? PerchΘ non posso dormire? Dormire per sempre.
...
server ftp per fare questo?". Semplice, e' sufficiente andare nei motori
...
considerato il diretto autore di questo breve articolo, perchΘ in verita' ho
...
l' ho letto, perchΘ si trova tanto altro materiale in giro, ma chi e' curioso
e conosce l'inglese puo' benissimo farlo. Devo dare per scontato che gia'
sappiate cos'e' un client telnet, a cosa serve ecc... perchΘ la loro
...
lunghe. PerchΘ? Beh, c'e' anche gente che spedisce news in html e percio'
bisogna inserire dell'altra roba, ma a noi non interessa, anche perchΘ ci
...
percio' abbiate pazienza e non scrivete finchΘ non ricevete la relativa
...
perchΘ, come ben si capisce, potreste mettere tutto in subbuglio. In ogni
caso non demordete, perchΘ su news.interbusiness.it e' possibile cancellare
...
dei casi, per smanettare un po' non dobbiamo fare granchΘ, ma bastera'
...
c'e' ancora, perchΘ? PerchΘ lo avevi gia' scaricato in precedenza e anche se
...
puo' essere molto comodo se usato insieme ad altri perchΘ, per vedere chi
...
alt.qualcosa descrizione". Comunque lo sconsiglio, il nostro obiettivo e'
...
Io consiglio caldamente di non usare gli ultimi due, perchΘ passano
...
qualsiasi newsgroup. Qui la cosa si fa leggermente piu' complicata, perchΘ
...
non sono l'autore dell'articolo, poichΘ avreste potuto trovare tutte queste
informazioni semplicemente leggendo le RFC e usando solo un po' di fantasia.
Mi raccomando, usate le cose che vi ho insegnato con moderazione, perchΘ
...
tranquillamente ed e' anche una buona tecnica. PerchΘ? Per prima cosa il
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
          ...
          ╔═══════════════════════════════════════════════════════╗
          ║┌─────────────────────────────────────────────────────┐║
          ║│ MITICA MAIL DI TEX IN RISPOSTA AL LAMERINO DI TURNO │║
          ║└─────────────────────────────────────────────────────┘║
          ╚═══════════════════════════════════════════════════════╝
...
>1)mi servivi solo per fare numero
...
1 siga ke mi accender≥ al + presto... &lt;DarK-Elf>
...
10x1 to...  {del DarK0}
N0B0 xkΦ ho usato il pakketto di N0bocikke kome posacenere 
Adry ke mi ospita a casa 
Devvo ke ha messo su sta Slack 7 su uno dei pc ke regnano in sto salotto
Tutti i raghi dell HackIt perkΦ sono simpaticissimi
Smilzo perkΦ je presento le Bio-Shell e lui me le fa arrossire
Spirit perkΦ ogni tanto skompare
Letale Malattia perkΦ lo konfondo sempre kon spiritello
Sharra Tia xkΦ mi coccolano ad oltranza
Vini e NoneX xkΦ hanno avuto il coraggio di provare il kokakoffee
Un'anonima barista di un bar vicino al forte prenestino XkΦ mi ha fatto 10
kokakoffee in 3 day
Mellax Melina Gotcha Anairda e Dai-Uffa {nonostante alkuni screzi} perkΦ
esistono
Anairda perkΦ mi ha fatto *dormire* sul suo parquet
Pomicio perkΦ andava in giro per kasa di Anairda in mutande
Pulcino perkΦ Φ il pulce :)
Manula e Valy perkΦ... non so perkΦ :) 
Mitika perkΦ magari domani ci si vede...
...
KOME SI PREPARA?
Fin troppo semplice...
Piji na kaffettiera... ne svuoti metα in uno shacker kon 5 o 6 kubetti di
ghiaccio... shakeri bene... metti in un bikkierozzo da un quarto di litro
aggiungi coca finkΦ non raggiungi l'orlo del bikkiere...
...
SALUTANO: (li ordino x gruppi se no faccio doppioni come nel 1° num...)
...
╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧╧
            ...
            ╔══════════════════════════════════════════════════╗
            ║┌────────────────────────────────────────────────┐║
            ║│  THIS NUMBA IS DEDICATED BY N0bodY88-ooo TO:   │║
            ║└────────────────────────────────────────────────┘║
            ╚══════════════════════════════════════════════════╝
...
[TheDuke...xchΦ mi stα a fα quasi da paparino :P                             ]
...
da troppo tempo in un loop infinito
...
