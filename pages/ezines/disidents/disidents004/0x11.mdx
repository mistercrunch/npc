...
|===========================================================================
  ...
  ** Curiosidad: OSI en espa±ol se dice MARISA (Modelo arquitectonico de 
...
**************
  ...
  una fibra optica, el aire... El nivel fisico se  ocupa de formar la se±al 
  ...
  tad del tiempo de bit la se±al cambia a cero  otra vez. El cero son 0V y 
...
---      ---        ------
  ...
  bits haya  una transicion y el  receptor pueda  engancharse  a la  se±al. 
  ...
  fallos. Este es uno de los motivos, el otro es que  la se±al que te llega 
...
*************
  ...
  a±ades un codigo CRC que sirve para detectar e incluso a veces en aplica-
...
************
  ...
  Imaginaros dos ordenadores, uno en Espa±a y otro en Japon,y que queremos 
...
*************
   ...
   Definicion: El objetivo  del nivel s esi≤n es  organizar y sincronizar 
               el dißlogo, asφ como controlar la  transferencia  de datos 
               entre entidades del nivel presentaci≤n. 
               Para  ello  ofrece s ervicios  de gesti≤n de  conexi≤n  de 
               sesi≤n, apoyßndose a su vez en las prestaciones  del nivel 
               transporte. 
...
****************
   ...
   Definicion: En este nivel se maneja  la sintaxis o  representaci≤n de 
               la informaci≤n.
               Sus funciones incluyen el formateo de datos, la codifica-
               ci≤n, la traducci≤n entre conjuntos de caracteres y c≤di-
               gos, asφ como la selecci≤n de los mecanismos de desplie-
               gue de la informaci≤n en pantalla. 
...
de peque±os detalles que veremos mas adelante.
...
6 (RecvData -) -----------2 (Txdata -) 
 ...
 Ahora toca explicar como son  las se±ales que viajan  por los cables. Como
 ...
 cables que cada  se±al  tiene un par asociado, uno  para transmitir y otro
 para recibir. Esto es asi  porque en vez de trasmitir  las se±ales tomando 
 ...
 se±al se dice que es flotante  porque  no tiene la tierra como referencia.
 ...
 diferencia de tensi≤n entre los dos, si existen  interferencias como van a 
...
---------------
 ...
 nar en el hub. Por lo tanto nuestra  transmisi≤n es half-duplex  ya que no
...
- Tipo o longitud: En  Ethernet II  los datos  IP o Arp o Novell  o.... van 
                  ...
                  ┐Porque no se pone el tipo?
                      ...
                      los datos, va una peque±a  cabecera  de un  protocolo 
 ...
 - Datos: Aqui  vienen los  datos  a  trasmistir, normalmente  IP, pero  ya 
          ...
          tante es que os habreis fijado que tiene un tama±o minimo de cua-
...
Si se ha producido una colisi≤n se  espera  un tiempo  aleatorio  antes  de 
volver a intentarlo.
...
cuando  transmitan. La se±al  tarda un  tiempo  en propagarse  por el cable
por lo tanto uno puede estar   transmitiendo y e l  otro escuchar  el medio 
y verlo vacio porque la se±al todavia no le ha llegado, en ese caso tenemos
...
hay otro PC adue±andose de nuestro espacio. Entonces lo que hacemos  es pa-
