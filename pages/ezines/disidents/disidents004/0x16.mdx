...
car como programar en Visual Basic (version 6.0) un peque±o motor de cifrado, 
...
Las respuestas mßs comunes a esta pregunta son: 
1) el p·blico no estß concienciado de la (in)seguridad de Internet.
2) el p·blico no estß dispuesto a ceder en comodidad para ganar en seguridad.

Ambas respuestas eran vßlidas en el pasado, pero ya no es asφ. 

La prensa, con su campa±a de histeria colectiva, presenta  Internet  como  un
lugar inseguro, plagado de crackers, en el que la intimidad no  existe  y  la
seguridad es una broma. El segundo problema es de φndole tΘcnica, pero con la
maduraci≤n de estas tecnologφas, penPGP puede integrarse  (y  de  hecho  estß
integrado) en muchos clientes de correo -como Microsoft Outlook, Eudora y si-
milares- mediante el uso de m≤dulos extra (plug-ins).
...
El motor  va  a tener varios motores peque±os, la union de todos los motores 
...
Este peque±o encriptador es base de este otro algo mas complejo
...
evitar que sea de pi±on fijo vamos a crear un sistema de key,  este  sistema
...
El objetivo de este texto es ense±ar como crear motores de cifrado con visu-
