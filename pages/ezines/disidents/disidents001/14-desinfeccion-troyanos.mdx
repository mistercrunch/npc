---
title: "14-desinfeccion-troyanos"
ezine: "disidents"
---

# 14-desinfeccion-troyanos
...
desacernos de ellos (desinfectarnos)... tambien os dare unas peke±as 
...
el troyan esperando a su due±o (veras listening  en caso de usar el protocolo 
...
como stablished,  es que ahy una conexion  y es que el due±o esta dentro 
"urgando" tu makina).
...
utilizada en  Msdos desde hace varios a±os que estaban basadas en el segmento 
...
Lo 1║ ke tienes ke hacer es pillarte un buen antivirus (q hay muchos por la
...
cuenta, te preguntaras ┐ que puedo hacer ?,  pues lo 1║ instalarte un firewall 
...
1║ tienes ke localizar el archivo con ke se ejecuta en troyanoal 
...
*Inicio-ejecutar
pones: msconfig 
vas a la pesta±a de inicio y ahi tienes todos los programas q se cargan al
...
Tray, su web es  http://lopesoft.cjb.net, es frreware y en espa±ol,  el cual  
una de sus opciones es  Tray System que  bueno puedes ver los recursos libres
apacidad total, libre y usada  de la memoria fφsica y de la memoria virtual, 
capacidad total,  libre y usada de los discos duros; e informaci≤n sobre los 
...
-No aceptar ni aun menos ejecutar ning·n archivo que provenga del IRC o de
...
-Eliminar manualmente las librerφas windll.dll con al que trabaja el BO y 
