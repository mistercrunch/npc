---
title: "5-TCP-IP_afondo_por_w3ndig0"
ezine: "disidents"
---

# 5-TCP-IP_afondo_por_w3ndig0
...
Pero kien asigna las direcciones a la pe±a?...eh?.. bien de esto se encargan los
NICs (Network Information Centers) que hay por todo el mundo, por ejemplo en el
caso espa±ol..nuestra terminacion .Es es asignada por el centro de comunicaciones
CSIC RedIRIS (ES-NIC) <<  es el registro de dominios delegado en Espa±a
...
continuemos con el pi±azo asincrono....
...
antes 32
 ...
 Operacion: de ri±on..digooo.. indica a si esta trama es una trma de pregunta
