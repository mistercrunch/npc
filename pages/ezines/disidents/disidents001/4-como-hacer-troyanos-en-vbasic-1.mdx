---
title: "4-como_hacer_troyanos_en_vbasic_(1"
ezine: "disidents"
---

# 4-como_hacer_troyanos_en_vbasic_(1
...
advertencias:
	...
	la informaci≤n recogida en este articulo, es meramente informativa, el autor,
usea iop, manifiesta su intenci≤n expresa de k cualquier uso de la misma,
mediante la aplicaci≤n de codigo, instrucciones, o cualquier otro tipo de uso,
sea con fines educativos y en ningun caso con el fin de causar da±o a terceros
...
a una makina y decirle ">ni±oo...apagate" simplemente no me va a entender,
...
k este tipo de troyanos se hacen con la gorra :), por mucho k las compa±ias 
antivirus se empe±en en protegernos, hacer un troyano es cosa de ni±os y con 
...
creo k es justo k si te has tragado este co±azo,..jode..lo minimo es k te lo 
esplique un poco.
...
hasta k no se complete alguna operacion, por ejemplo, recivir datos.
         ...
         los sockets pueden ser binarios o no binarios, esto implika un peke±o 
...
Select Case comando
            ...
            Case "[±isk]" _>lo de [±isk] e una pirualada de ejemplo
...
comando sea
[±isk], necesites volver a leer algo del socket...pero otias..sabiendo k las 
