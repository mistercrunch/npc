...
<< con dialup ni de co±a,  no es bueno excederse en esto casi regula las
...
una determinada lista de palabras a±adiendo mayusculas minusculas
...
ademas tenemos la opcion de seed word q lo q hace es q nosotros a±adimos
...
vamos a ver ahora.
NOTA: He visto el diccionario de users.txt es peque±ito aqui os lo planto
Admin
administrator
test
guest
...
Este archivo puede modificarse, simplemente con a±adir + usuarios a quien
...
Bueno pasemos al ftp aunke como vereis la rutina es parecida en todos
 los tipos rekieren peke±as variaciones en cada uno de ellos. En este
...
la direcci≤n de correo del RCPT que le indiquemos, aunque sea antiguo todavia 
