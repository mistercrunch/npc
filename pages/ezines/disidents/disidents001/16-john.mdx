...
linux aparecian las contrase±as cifradas por DES en /etc/passwd, con acceso
...
2 La contrase±a cifrada en este caso o  rese±a de la contrase±a(e±a e±a)
...
* Nota: Pongo la parte  de instalaci≤n teniendo en cuenta para los que acaban
de empezar en linux:
...
ahi esta el programa  escribe ./john para ver las p≥sibilidades
...
Lo primero que probaremos es el modo single, es el modo mßs rßpido
...
guesses: 0  time: 0:00:00:00 100%  c/s: 215  trying: SULLEiRO - atjjqywu
(Lo he a±adido yo al diccionario claro)

John admite abreviaciones puedes poner ./john -w:list.txt  passwd

Tambien puedes a±adirle rules para que a±ada cambios a las palabras de la lista
tales como  mayusculas, n·meros, letras, caracteres especiales tipo  Pepe   -   PePe^99
...
Si quieres usrar rules a tu gusto y que a±ada los caracteres y el tipo de
...
combinaciones de caracteres, hasta las seleccionadas por  ti solo n·meros o
letras
por ejemplo

COMANDOS:

:all: Todas las letras, n·meros y caracteres especiales (Fuerza Bruta)
:digits: Solo  numeros
:alpha: Solo letras
...
Claro que muchas veces si crackeas un pass   puede que te lleve mßs tiempo
...
-------- Donde co±o estan las pass en otros sistemas
...
-Crack hecho en c y perl,  descifra contrase±as  encriptadas mediante DES, e
