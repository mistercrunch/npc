...
Θxito con los pasos anteriores el asunto es mßs tardado, lo que tendrßn que
hacer es editar el archivo lin_hsf.inf , creando unas lφneas donde
...
Ahφ buscamos el pßrrafo  donde se  encuentren  los datos que corresponden a
nuestro modem, 14F1 (Conexant) o 127A ( Rockwell ) y checamos el Device ID,
buscarφamos algo asφ:

PCI\VEN_127A&DEV_2015&SUBSYS_2015127A.

Ya con estos datos procedemos a editar el archivo lin_hsf.inf con cualquier
editor de texto,  lo que tenemos  que hacer  es crear  una lφnea %HSFModem%
dentro  de  la  secci≤n marcada  como  [generic] ahφ  encontraremos  lφneas
similares a la que nosotros agregaremos.

Nuestra linea quedarφa de esta forma:

%HSFModem% = ModemX, PCI\VEN_XXXX&DEV_YYYY&SUBSYS_********

DespuΘs se remplazan las XXXX por el Vendor ID y las YYYY  por el Device ID
se pone el Subsys******** completo, con lo cual tendrφamos.
