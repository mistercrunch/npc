...
```
 ...
 |                                                                        |
 | -- Titulo_____: Guia de comandos basicos de linux                      |
 | -- Autor______: Quade2K                                                |
...
-v: Da informaci≤n en pantalla sobre los archivos que se van copiando.
...
No voy a dar todas la explicacion de cada comando del ftp.Consiguela tu ;)
...
-l tama±o: Tama±o de bufer de envios.
...
Ejemplo: ping -s 32000 &lt;direccion IP>
...
Espero que les haya sido util, y que conoscan el fabuloso mundo de linux y
dejen de porrearse con la mierda del gⁿindous.

Tambien les pido disculpas si me equiboque en algo.
       PERDONENME, HERRAR ES UMANO. xD

       SALUDOS A:
                   DDiego, w3ndig0, damicita, ADAROTH, S-P-A-R-K, rootzero,
                   RandomLoG, leon01, Taseh, charchi, bad^boy, {FEAR}, hdi4
                   Vanmore, remains, wendell, N0RTH, y a toda la pe±a de
                   #disidents.

Posdata: Has probado el nuevo torneo de hack IzHal. www.izhal.com
