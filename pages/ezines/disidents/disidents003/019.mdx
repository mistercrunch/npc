...
existentes  en nuestra maquina. . ademas  de hacer un peque±a herramienta que
...
puertos asi como una correcta politica de permisos y actualizaci≤n de nuestro
...
extra±a  por  ser  una estupendisima manera de hacer nuestro sistema linux un
poquitin mas seguro.
...
filtrados e incluso a±adidos  al log del sistema...como sabeis  linux  guarda
...
l≤gicamente  los  que tu no quieras,  no es un metodo que yo recomendaria (el
...
como cofigurarlo..es muy facil! :)
        ...
        2.- O±o..pos no w3n..no lo tengo instalado. .como lo  instalo ? donde
            lo consigo...
...
┐por quΘ  usamos  LOG_DAEMON? . facil . . si queremos que nuestro sistema sea
...
|===========================================================================
         ...
         Portsentry  en  su  configuraci≤n  original  nos  provee  3 posibles
...
desactivarlas, no tendremos mas que  descomentar la linea ..veamos como va,..
 ...
 ----------------------------------------------------------------------------
  ...
  esta configuracion solo nos hara estar prevenidos, aun  asi  podemos a±adir
  ...
  ->#UDP_PORTS="1,7,9,69,161,162,513,635,640,641,700,37444,34555,31335,32770,32771,32772,32773,32774,31337,54321"
   ...
   -> TCP_PORTS="1,7,9,11,15,70,79,80,109,110,111,119,138,139,143,512,513,514,515,540,635,1080,1524,2000,2001,4000,4001,5742,600
	...
	->UDP_PORTS="1,7,9,66,67,68,69,111,137,138,161,162,474,513,517,518,635,640,641,666,700,2049,31335,27444,34555,32770,32771,32
      ...
      y listo, si quereis quitar o a±adir puertos veis el apartado anterior.
...
dependiendo  de  la  extensi≤n  de esta  claro, si mi red tiene 2 pcs pues no
vamos a rompernos la cabeza..pero..y si alguien ganase control sobre un pc de nuestra  red? no olerφamos  k  a nivel  de puerto algo raro sucede..y tampoco podriamos  blockear  spoofs  de ip con ips de nuestro  dominio...PARANOIA! yo personalmente no ig noraria a ninguna  maquina nada mas que a la mia. que  es 
...
KILL_RUN_CMD="echo Atencion el se±or jaiker X te llama por el puerto $PORT$ desde
 $TARGET$" lo cual deberia mostrar una salida por consola diciendonos algo como esto:
            El se±or jaiker X te llama por el puerto 313 desde 194.34.56.12
...
de puertos,voy a optar a tratar de ense±aros como hacerlo vosotros mismos.
...
cuestiones  que  os  indicaran  que el dise±o de las apis que vamos a usar es 
...
irc hispano, NO LO ENVIO A CORREOS).
   ...
   c) Y  si  pudiΘramos  ver claramente  TODO lo que pasa en nuestro sistema?
...
'# La curiosidad y el empe±o es el atributo del hombre. w3ndig0                 #
...
nombres a las variables "extra±os" me he limitado a copiar
...
' declaraciones de extructuras ...±aaarererrooo raro roo...jeje
            ...
            " we recommend to you close all aplications and if this alert continues go to www.moosoft.com and dowload THE CLEANER and scan your host", vbYesNo, "Warning S0lid had detected a suspicious CONEXION on your system!!! ")
                     ...
                     Else
                            ...
                            Next
                             ...
                             ignored_ports.portignored(ignored_ports.Num_Entryes).port_number = Val(puerto) 'a±adimos puerto a la lista
...
A la pe±a de empresariales y al tio este k da informatica..como se llama..ehmm
...
tan de resolver con todo el cari±o del mundo. A vosotros, a los  que  empezais
