...
|===========================================================================
  ...
  contrase±a  para el cliente, su configuracion  es realmente  sencilla:
  ./vncpasswd

  Password: contrase±a para el cliente (igual o mayor que seis caracteres)
  Verify: reinsertamos la contrase±a.
  ...
  (maquina 1):  Esta maquina tendria que estar corriendo el  vncserver y haber
   puesto una contrase±a previamente con vncpasswd.

  ./vncpasswd

  Password: servidorvnc (por ejemplo)
  Verify: servidorvnc (aqui tendriamos que poner otra vez la contrase±a, pero
  ...
  Seguidamente nos  preguntaria la contrase±a, la contrase±a que pusimos antes
  ...
  caracteristica  muy importante que tiene  vnc, ípodemos acceder al servidor
  mediante el navegador!, si no os lo creeis iros a otro  odenador que no sea
  el server y poned en el navegador: 
  http://servidor:58**/ ,
  sustituyendo ** por el display que tenga el servidor , meted  la contrase±a
  ...
  se encuentran en:  /inicio/programas/vnc , aqui tenemos una  peque±a lista
...
|===========================================================================
  ...
  saldra una peque±a ventana para introducir el nombre que le queramos poner
  ...
  - Set password:  debemos de insertar una contrase±a para el servidor, como
