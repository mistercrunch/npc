...
∩╗┐[024]_Perl_a_dolor_2_edicion-Creando_nuestra_propia_utilleria_by_DDiego_DisidentS_Hack_Journal_-_5                         
 ...
 |                                                                            |
 |  -+- Titulo_____: PERL A DOLOR 2┬║ EDICCION - CREANDO NUESTRA PROPIA        |
 |                   UTILLERIA [024.txt]                                      |  
 |  -+- Autor______: DDiego                                                   |
...
|===========================================================================
   ...
   Hola  amigos perleros,  siento no poder  hacer la 2┬║  parte del  tremendo 
manual de Perl a dolor de seguido, asi que la hare por  trozos, tipo a├▒adidos
...
caera ;).  Esta no era la 2┬¬ parte que esperaba pero bueno,  esperaba  hacer 
algo mas amplio tipo a  la 1┬¬ parte de la guia,  pero no tengo otra forma de 
...
ximo articulo sobre perl espero sacarlo para la 7┬¬ ezine como mucho, o igual 
