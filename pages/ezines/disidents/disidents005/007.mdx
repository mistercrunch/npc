...
Dim retval As Long
    ...
    Else
        MsgBox "Encontrado en la posici≤n: " & retval + 1
    End If
End Sub
...
la informaci≤n que nos importa.... como ?, otra vez abriendo archivos
...
Haremos un peque±o punto y coma y explicare que es lo que hice hasta ahora...
