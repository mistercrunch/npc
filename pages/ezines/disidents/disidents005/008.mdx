...
```
[008]_Creando_un_Interprete_en_Tiempo_de_Ejecuci≤n_by_RandomLoG_-_Disidents_Journal_5
  ...
  |                                                                                          |
  | -+- Titulo_____: Creando un interprete de VB/VB.NET en tiempo de ejecuci≤n by RandomLoG  |
...
|===========~ INDICE ~=======================================================
|============================================================================
|=~ 1- Creando un interprete de Visual Basic / VB.NET en tiempo de ejecuci≤n|
|=~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~=.
======================================================~ INDICE ~=============
=============================================================================
.============================================================================.
...
Ahora les voy a dar una muy peque±a idea de como realizar un interprete en VB, con un par de instrucciones nomas
...
es solo cuestion de ponerse y darle manteca al vb o vb.net, imaginaci≤n y no tener una novia q te rompa las pelotas
mientras tas programando XDDDDD.

Bueno amigos, no amigos, cachorras xD, nos veremos en el proximo EZINE :)
Feliz Navidad y un muy prospero A±o Nuevo para todos!!!!
