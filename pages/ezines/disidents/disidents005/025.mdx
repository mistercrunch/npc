...
Hecha esta peque±a introduccion, entremos en materia.
...
encima este peque±o codigo. Basicamente, vamos a las partes importantes:
...
inofensivo (solo es una peque±a muestra de como funcionaria el fallo ;) y
en el he prescindido de la funcion run();, aunque se podria a±adir despues
de la linea "file.writeline("Hola mundo")". 

Ahora imaginate que en vez de "Hola mundo" puse un codigo en VBS (e imagina
todas las posibilidades que puede darme el VBS) y que a±adi "Run();". 
...
admiten en su mayoria la a±adicion de codigos html en los post. Incluyendo
...
o webs afectadas por fallos de inyeccion HTML, se podria inyectar (a±adir)
...
nuevo enfoque y una peque±a a±adicion a lo que seria el "reporte original"
