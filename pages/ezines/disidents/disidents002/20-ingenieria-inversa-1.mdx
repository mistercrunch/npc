---
title: "20 - Ingenieria_inversa_1"
ezine: "disidents"
---

# 20 - Ingenieria_inversa_1
...
acto indebido del lector, asi como el uso indebido de este texto, estaá prohibida 
la modificacion del mismo sin autorización del autor.-
...
blador medio raro, creando peque±os programas, que eran compilados y carga
...
programas y ganar, pero con el riesgo de destruirse a sí mismo, un juego
realmente ingenioso, que corria a principios del año 69 y sigue hoy usandose
...
máquina entendible por la PC.

Desensamblado: antes mencion desarmar, pues es así, convertir el programa
...
Lenguaje de maquina: lenguaje entendible por la PC, conjunto de símbolos, hoy
en día son usados los simbolos ASCII.
...
programación, entonces de-bug es sacar errores, pero siempre con la ayuda del
programador, la máquina sin programas es un electrodomestico que gasta energia
nada más. ;)

Desensambladores: herramienta que ayuda a desarmar un programa en lenguaje
entendible para el usuario, en la mayoría de los casos asm.
...
serán ustedes sus propios maestros, y podrán decidir que hacer y cuando.
...
teniendo este dispositivo, el programa esteá completo)

Así, se pueden mezclar estas protecciones, y generar un programa robusto.
Una protección usada comunmente para proteger las protecciones(paradojico no?)
es la encriptación, esta se usa para hacer ilegible el código de maquina,
anti-crackers o anti-lamers. ;-)
La encriptación se lleva a cabo a traves de un algoritmo que toma el codigo
...
Bueno, creo que esto es todo por hoy, proximamente escribir otra lección,
...
------------------------[0x04 Recursos]----------------------------------------------------------
-------------------------------------------------------------------------------------------------
A continuación les pongo direcciones para los interesados en el tema:
