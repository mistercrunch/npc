---
title: "28 - Phreak para newbies"
ezine: "disidents"
---

# 28 - Phreak para newbies
...
-------------------------------------------------------------------------------------------------
----[1.0  INTRODUCCION                                                                          -                 
----[2.0  INICIACION A LA BLUEBOX (no esta de mal saberlo aunke no funcione en espa±a)          -                                                                                 -
----[3.0  Explikacion beige box(es la unika ke funciona en espa±a?┐)                            -
----[4.0  Construccion de la beige box                                                          -                                 
----[5.0  COMO LLAMAR GRATIS DESDE LAS CABINAS VERDES PEQUE╤AS                                  -                                                          
...
Espero que este documento  os  sirva de ayuda a los que usais una y no sabΘis  realmente como 
...
3.Luego la compa±ia Telefonica envia una subida de voltaje a la linea
...
Espa±ola manda 2500Hz que es la se±al que le indica que has colgado la linea.
Entonces si  tu coges el ordenador y mandas 2500Hz por la linea mientras estas hablando con un 
amigo,en teoria se cortaria el telefono,pero no es asφ debido a que han puesto filtros (pero 
...
llamados MF,bueno, (Ed:creo que esto se estß  complicando  demasiado), veamos si  me entendeis,
los 2600Hz no son exactamente los de la se±al de colgar el telefono, son la se±al de
supervisor de la linea,┐entonces la cuenta de telefono te sigue corriendo?,efectiviwonder, 
pero... la cosa cambia si llamas a un numero 800 (en Espa╤a 900,ojo no 903 je,je,je), por 
que los pasos no corren ya que es un n·mero gratuito, bueno, y  que  pasa entonces despues de
...
La Beige box es la ·nica box que funciona en Espa±a (por lo menos que yo conozca) aparte de ke 
es muy fßcil de construir (construir?┐?┐ xDD) 



se trata de una box que emula el telΘfono que utilizan los tΘcnicos de telef≤nica para hacer 
llamadas.

- MATERIAL NECESARIO -

Necesitarßs un telΘfono sin el jack (el enchufe que va a la lφnea telef≤nica),unos cocodrilos y
cualquier elemento que te permita abrir el cajetφn, por ejemplo unas pinzas, un destornillador
etc...

Bueno, una vez hayas conseguido todo eso, te coges la mochila y te vas en busca del cajetφn, 
que son bastante fßciles de encontrar (son grises con el sφmbolo de telef≤nica enmedio), 
normalmente suelen estar por los postes de tlf, en las fachadas de los edificios, portales... 
el caso es que encontrΘis uno en el que no se os vea mucho (mejor si vais por la noche :) ), 
una vez lo hayßis encontrado tendrΘis que abrirlo, hay dos tipos de cerradura (aunque yo solo 
he visto 1) la triangular y la circular, si es la triangular cogΘis unas pinzas y lo abrφs 
(podΘis probar con la llave de los ascensores, a mi me funcion≤ :) ) si es redonda pues cogΘis
el destornillador y punto, tambiΘn lo podΘis hacer con las manos, que no cuesta mucho. Una vez
abierto el cajetφn, cogemos el telΘfono sin el jack y con los dos cables de enmedio los 
enganchamos a los cocodrilos que van enganchados a los tornillos del cajetφn, daros cuenta que 
hay 4 columnas de tornillos y los tendrΘis que enganchar de forma par, por ejemplo enganchßis 
uno al primer tornillo de la primera columna y otro con el primero de la segunda columna o el 
segundo de la tercera columna y el tercero de la cuarta columna y asφ, ya hemos acabado el 
trabajo, ahora solo nos queda descolgar y llamar. Es recomendable usar el par 26 ya que no lo 
utiliza nadie y da linia, asφ os evitareis sorpresas desagradables 
...
evita la elevada tensi≤n del tono de llamada (mßs de 100 voltios); R1, D1 y D2 recortan la 
se±al alterna a algo menos de 1 voltio; por ·ltimo, el divisor R2, R3 reduce la se±al para 
evitar que el grabador se dispare cuando haya ruφdo en la lφnea.

Pinchar la lφnea y escucharla por un telΘfono:
Este es un mΘtodo muy sencillo pero tiene el problema de que tenemos que colgar y descolgar continuamente el telΘfono para saber si estß hablando la vecina. No vale dejarlo descolgado porque al poco rato, comienza a comunicar y la cagamos. Es un mΘtodo ·til, cuando, de alg·n modo nos enteramos de cußndo habla la tφa que queremos controlar (A lo mejor escuchas el timbre de su telΘfono, o sabes a quΘ hora suele llamar). TambiΘn es ·til, si queremos controlar desde alg·n sitio las llamadas en nuestra casa sin que nadie se entere.
El procedimiento es muy simple. Ahora c≤gete un telΘfono de estos viejos que tengas tirado por casa (si eres rico, usa uno nuevo, allß t·). Cßrgate el micr≤fono del telΘfono para que no te escuchen los suspiros. Luego, cortas el cable que tiene el telΘfono un poco antes del chirimbolo que sirve de enchufe.
Podemos pinchar la lφnea del vecino en el cable que va de la casa a la caja donde se juntan las lφneas o bien en dicha caja. Pela un poco el cable que recubre la lφnea y conecta ahφ el telΘfono que acabamos de preparar. Si eres de los que son un poco bestias, puedes llevarte un cable desde ahφ hasta donde te de la gana (A tu habitaci≤n si lo deseas).
Para grabar la conversaci≤n, puedes comprarte un aparatito de estos que venden en tiendas especializadas por menos de 4000 pelas, lo conectas a una grabadora que tenga entrada de lφnea y ya estß.
MΘtodo del Phreaker. Pinchar la lφnea con Grabadora y despreocuparte.
La lφnea se puede pinchar en dos lugares diferentes, en el cable que va de la casa a la caja donde se juntan las lineas o bien en dicha caja. Si lo conectamos en el cable no habra problemas de identificacion pero darß mucho en cante ver un aparato pegado al hilo. Si lo conectas dentro de la caja no se verß (a menos claro que los de T revisen la caja) pero puede haber problemas para identificar el n·mero es asi, llevate un movil GSM y un telefono normal conecta este a cada linea y llama al m≤vil, el Caller-ID te permitira saber cual el la correcta.
...
Podrias despertar a la gente. Pero que coño estoy diciendo?! Aqui se trata de hacer las
...
Joder, entonces pa que coño quiero dejarla fuera de servicio?
...
lo esta, no seria logico, sabiendo lo paranoica que es la compañia que lo fabrico.
...
1-> Una ultilidad muy interesente es conseguir, mediante el mensaje de
    ...
    -Si?-,...Una peque±a pausa...,-Si, acepto la llamada-.
...
Los contestadores se crearon para no perder las llamadas que otras personas hacφan mientras el 
usuario no estaba disponible (por eso telef≤nica nos pone el contestador gratis, asφ se 
aseguran que no se pierdan llamadas aunque el usuario no este). Lo que alomejor algunos no 
sabΘis es que a la mayorφa de los contestadores se puede acceder de forma remota, por ejemplo, 
...
mueve por las opciones de su contestador como si estuviese ahφ. De eso podemos sacar varias 
conclusiones, por ejemplo... y si llamo a casa de Pedro, y empiezo a meter c≤digos a su 
contestador, hasta que encuentre el correcto, podrφa escuchar sus mensajes, cambiarle su 
configuraci≤n, etc... pero llamar a casa de Pedro, tantas veces hasta que encuentre su clave 
puede resultar algo caro, pero eso ya depende del dinero que disponga cada uno, ya que tambiΘn 
...
contestador de un peri≤dico, mientras nos sale el mensaje grabado, le damos al * , entonces el
mensaje dejara de escucharse, y aparecerß un pitido, en ese momento tenemos que meter la clave 
...
prueba cosas fßciles como 00 123 y cosas asi, ahora, si has hecho eso y no has conseguido 
entrar es hora de poner a prueba las claves de ese contestador mediante una tabla de b·squeda 
de claves de 2 cifras.
En que consiste esa tabla?┐ los contestadores de 2 dφgitos de clave, te dejan marcar 6 n·meros antes de cortar la llamada y de ahφ podemos sacar provecho nosotros. Por ejemplo, podrφamos marcar 135790 y el contestador reconocerφa los n·meros 13-57-90 pero tambiΘn los n·meros 35 y 79 y aquφ esta la utilidad de la tabla, ya que te permite escanear todas las claves posibles en muy poco tiempo.
