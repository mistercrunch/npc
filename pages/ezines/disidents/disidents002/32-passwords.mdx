...
```
                            ...
                            - D I S I D E N T S - H A C K  J O U R N A L -
                                         ...
                                         TITLE: Pass en Routers y Bios -> "Como crackear el pass de la BIOS"
                                         Author:DDiego
...
-----[ 1.0     ROUTERS - que son?                                                                           -
-----[ 1.1     ROUTERS - ESQUEMA                                                                            -
-----[ 1.2     CLASIFICACION DE REDES SEGUN SU ESPACIO FISICO                                               -
-----[ 1.3     HUBS Y SWITCHES                                                                              -
-----[ 1.4     TOPOLOGIA DE RED - TOPOLOGIA EN ESTRELLA                                                     -
-----[ 1.5     ALGORITMOS DE RUTEO                                                                          -
-----[ 1.6     PASS POR DEFECTO DE ROUTERS                                                                  -
-----[ 1.7     QUE ES LA BIOS?                                                                              -
-----[ 1.8     ACCESO FISICO                                                                                -
-----[ 1.9     MAS PROBLEMAS                                                                                -
-----[ 2.0     MODO PRACTICO DE SALTARSE EL PASS DE LA BIOS (A CRACKEAR EL PASS DE LA BIOS)                 -
-----[ 3.0     3COM Routers                                                                                 -
-----[ 3.0.1   ROUTERS Y BIOS SUELTOS                                                                       -
-----[ 3.0.2   ALTEON                                                                                       -
-----[ 3.0.3   AMI                                                                                          -
-----[ 3.0.4   APC                                                                                          -
-----[ 3.0.5   AWARD                                                                                        -
...
Los routers son en realidad  un dispositivo con sistema operativo propio que actua como un firewall a nivel
de red basados en direccionadores (NOTA: un pc puede actuar  de  proxy con el sofware adecuado en  Linux y
Windows, la opcion mas eficiente seria linux por su estabilidad, y no apoyo esta afirmacion yo solo sino
en el libro Computer Networks de de Andrew S. Tanenbaum, habla de que el autor ha visto  pcs con linux
con 4 megas de RAM  routeando 6 equipos en red), es decir que son capaces de encaminar o direccionar  datos
de una red a otra, los ruteadores o routers suelen tener una red detras a la que protegen filtrando paquetes,
denegando acceso a ips o puertos, permiten al igual que un proxy canalizar todas las salidas de datos de una
red, a de una conexion < la del router con una red externa, su finalidad es proporcionar seguridad y
control  limitando el trafico que llegan de redes externas, el router lo encuadramos en la  capa 3  del modelo
OSI (Open System Interconnection), es una arquitectura de red que  se basa en descomponer  en siete  niveles o capas
 de abstraccion de red, cada capa o nivel tiene una funcion, en este caso explicaremos, la capa 3:
 ...
 ------------------------------------
 - Nivel 5: Nivel de Sesion         -
 ------------------------------------
 - Nivel 6: Nivel de Presentacion   -
 ------------------------------------
 - Nivel 7: Nivel de Aplicacion     -
 ------------------------------------

Nivel 3: Nivel de red >> se encarga de  encontrar, encaminar, direccionar la informacion y encontrar
una ruta para la comunicacion (esto suena a routeador no??), pues si
...
AHORA VEAMOS EL ESQUEMA DE UN ROUTER QUE TIENE DETRAS UNA LAN (Local Area Networks) >> Red de Area local,
aunque este es el ejemplo mas tipico que suelen establecer manuales etc, detras de un router puede
haber redes mas grandes como MANS o WANS, despues del dibujo explicaremos cada una
...
(red externa              Hubs       |
y peligrosa
     jeje)          o switches    Una Red Local, tambien puede ser una
                                  MAN y a su vez tener una LAN detras
...
- LAN: Bueno este termino si que es conocido por todos, quien no ha visto una red local montada en
los cibers, las universidades, una empresa etc, estas debido a su dimension puede alcanzar grandes
velocidades desde 10 Mb/s hasta 100 Mb/s este ultimo se puede enmarcar dentro de  la Tecnologφa
Fast Ethernet

- MAN (Metropolitan Area Network)o lo que  es lo mimos  Redes de Area Metropolitana, son como las
LAN solo que algo mas grande, pueden abarcar una ciudad, este tipo de redes son mas recientes que
las LANs, las MANs estan dise±adas ademas de transportar datos, permiten transportar video, audio etc,
las MANs estan dise±adas para   trabajar a mas distancia que las LANs, aunque pueden  vinvcular a varias
LANs, y formar un conjungo de redes de alta velocidad

- WAN   Redes de Area Amplia  ,estas llegan a tomar una dimension algo mas grande que las de arriba
llegando a cubrir un pais entero o todo el mundo, tambien soportan conexiones con LANs y MANs.
usan el protocolo de encapsulacion punto por punto "PPTP", entre las WANs que existe esta ARPANET creada por
la Secretarφa de Defensa de los Estados Unidos, que luego se combirtio en Internet

Existen otro tipo de routers, que ademas cumplen la funcion de Bridges o puentes(  , un brouter es capaz
de actuar de router para un protocolo  y como bridge para el resto, en fin combinar las propiedades de
cada uno.
...
En una red aparte de routers podemos encontrarnos hubs y switches

- El router: este es el "cerebro de la red tiene unas tablas de enrutamiento o encamienamiento segun las
cual concoce el estado de la red, la finalidad de  estas tablas es seleccionar la mejor ruta segun los
caminos disponibles estas tablas de encaminamiento incluyen:

Todas las direcciones de red conocidas
Posibles caminos entre los routers
Instrucciones para la conexion con otras redes
El tiempo  de envio de los datos

Un router trabaja a nivel de red conociendo la ip de origen y la de destino y es el encargado de
enviar los datagramas por el camino que considere mas oportuno, comunicandose con otros routers y
direcciones NIC locales (Network Interface Cards) < direcciones de las tarjetas de red


- hub: tambien se les llama concentradores,un hub se suele usar para implementar una red en estrella (veremos
como funciona) y su funcion es recibir el datagrama de uno de los ordenadores  este trabaja a nivel de enlace
de datos es decir realiza las conexiones con el siguiente  elemento de la red(usease un router otro ordenador
o lo que estemos conectado) por ello lo que hace es lanzarlo por todos las conexiones y regenera la se±al


- Switch tiene las mismas funciones que un hub de hecho se les llama hubs inteligentes lo que sucede es que
conocen el destinatario del paquete  llegan a la capa de red y por ello generan menos trafico inecesario
(un hub se lo envia al ordenador destino pero tambien a los otros 400000 ) un switch solo se lo envia al
destinatario  esta es la principal diferencia en fin,  el switch tiene  es capaz de resolver problemas de
rendimiento de una red, procurar un mayor ancho de banda, evitar cuellos de botella,otra caracteristica es
que no estan dise±ados como el router a ningun tipo de control de seguridad, los switch esta encuadrados en
el nivel o capa 2 del modelo OSI "Nivel de Enlace de Datos"
...
Ahora vamos a aclarar algunos conceptos de forma muy simple para entender como se forma una red en
estrella :

TOPOLOGIA DE RED: Es la forma en que se conectan entre si los equipos de una red, esto puede
determinar la seguridad, velocidad, costes jeje en fin problemas que pueden pasar, existen multiples
formas de hacerlo, las mas conocidas, son topologia (de bus, de anillo, de estrella, en malla, en arbol,
de interconexion total), todas pueden llegar a complicarse bastante dependiendo de la dimension de la
red que quieras montar, no  es lo mismo una LAN de 10 ordenadores que una MAN "no hablo de la revista jeje"

TOPOLOGIA EN ESTRELLA: pues esta topologia como su nombre indica coloca los equipos en forma de estrella,
una cosa que le distinge es su caracter centralizado, ya que cada  equipo se conecta al hub, en este caso
el hub es un punto clave de la seguridad si falla el hub falla la red por completo, la ventaja es que
ninguno de sus equipos determina el rendimiento del otro, ya que son estaciones de trabajo independientes
osea si falla un equipo no pasa nada, un problema que tiene es respecto al cableado en la estacion
del concentrador o hub ya que ahi llega el cableado de todas las estaciones, hablando de seguridad
fisica, el cableado es un punto clave en la seguridad por eso es bueno meter un cableado de calidad
, y en el sitio mas inascesible posible para posibles problemas, esto es un problema a la hora de
posibles cambios pero no todo es perfecto, otro problema es el acceso fisico a los equipos etc



veamos un dibujo de la tipologia de estrella:



                                    #####
                                    #   # <== Un Pc aunque no lo paredca, como vemos
                                    #   #     son independientes todas las estaciones
                                    #####     de trabajo
                                      |
                                      |
                                      |
...
Quizas crees que me he separado un poco del tema de los routers pero en realidad, es al contrario
nos estamos acercando mas a ver que son, cual es su funcion y que suele haber detras de ellos, eso
es lo que nos diferencia de los lamers.


Bueno volvamos mas al tema de  los routers, sabemos que el proposito de ellos es dirigir los paquetes
desde el origen al destino, ahora tenemos que saber que protocolos usan, distingen varios protocolos
de red IP, IPX, ApplTalk o DECnet, IBM/SNA, bueno ya  sabemos bastantes cosas de los routers, pero nos
podemos preguntar como encaminan y seleccionan el camino, pues mediante "algoritmos de ruteo"
...
Podemos llamarlo metodos o mecanismos que hace que el router busque o seleccione la eleccion mas
eficiente, mas rapida y en mejores condiciones para seleccionar la ruta de destino.
Existen 2 grupos de algoritmos de ruteo estaticos y dinamicos:
Estaticos: Se basan en   informacion recogida de  forma previa sobre la red, trafico y tipo de linea
, el problema es que la red es muy dinamica, esta constantemente cambiando y es imprevisible el trafico
que pueda pasar por ella.
Dinamicos: Se basan en la informacion recogida en tiempo real sobre la red, esta  se actualiza en
todo momento mediante el intercambio de datos entre los routers

Podriamos adentarnos mucho mas en este tema, ya  que es un tema muy amplio, bueno pero prefiero
meterme mas respecto a temas de seguridad, y hablemos un poco de el filtrado de paquetes y de sus
restricciones, para programar este filtrado todo depende de el router por ello habra que mirar la
documentacion que encontraras en la  pagina del fabricante. Vemos que los routers a parte de
beneficiarse de el filtrado, tambien ocultan las  ips internas  de las redes externas, he estado
mirando varios routers y claro como no pasar por cisco, cuando se habla de routers siempre sale
cisco que tiene una amplia cuota de mercado en lo referente a routers (ahi sale mi vena economista),
en www.cisco.com hay verdaderas joyas para tu red, algunos de estos dispositivos integran e sofware
Cisco IOS Firewall que se compone de control de acceso, firewall, deteccion y prevencion de denegacion
de servicio (preparados para resistir 500.000 conexiones simultaneas al tiempo que bloquea un ataque
dos), bloqueo java y alertas en tiempo real, soporte para cifrado a alta velocidad con sofware que
soporta distintos tipos de encriptado (DES y Triple DES , etc), bueno todas estas son las maravillas
  que nos cuenta cisco en su pagina http://www.cisco.com/es/ << version espa±ola, pero cuando llegas
al mundo real empiezas a ver routers que no se pueden comprar routers a diario, empiezas a ver que
no todos los que montan redes estan capacitados para ello,y que en la red  podemos encontrarnos algun
router como recien salido de la  caja sin cifrado, vulnerable a cualquier tipo de ataque y con el
gran fallo de no haber definido las contrase±as esto puede salirle caro al administrador ya que te da
un gran poder de control respecto no solo a la red interna que esta detras del router, si no a la
posible utilizacion de identidad de la propia red con las consecuencias que puede tener (ataques a
otros servidores, trusted host, etc), lo que antes era un portero de seguridad, ahora es un piltrafilla
que no tiene ni media hostia, de aqui la lista que os pongo a continuacion recopilada de varios sitio
esta informacion puede comprometer a muchos administradores
...
Mas adelante veremos varias marcas de routers con los passwords que bienen por defecto, se clasifican tambien
los privilegios que otorgan estos pass
...
Cuando hablamos de la BIOS hablamos de un programa que viene instalado en la placa base con el objetivo de
simplemente detectar y verificar el funcionamiento del hadware conectado a la placa," memoria, disco duro
teclado, disquetera, cdrom  etc...",  de ahi  su nombre  Basic Input Ouput System, Sistema Basico de Entrada
y Salida, este programa se  carga en un chip de memoria PROM "Programmable ROM", integrada en la placa,
cuando nos referimos a programmable ROM "Read Only Memory", Memoria solo de lectura, es donde se guarda este
programa llamado BIOS, las modificaciones que haces en la BIOS se guardan en  CMOS que es Complimentary Metal
Oxide Semiconductor "Semiconductor complementario de ≤xido metßlico"<-- esta hecho de ese material,   la CMOS
tambien denominada RAM CMOS en ella se guardan los cambios que hayas hecho al  configurar la BIOS, estos
datos no se borran al apagar  gracias a que cuando apagas el ordenador  este chip se ve alimentado gracias a
la pila si esta se gasta, habra que cambiarla  y configurar de nuevo la BIOS
...
Tener acceso fisico a la maquina/s puede causar problemas de forma evidente, a pesar de la gran seguridad con
la que administres tus sistemas, el problema es que cualquiera puede arracan desde una unidad de disco y desde
ahi tener acceso a las particiones de tu pc, las formas de evitarlo es 1║ ir a la BIOS y que el sistema
no acceda a la unidades de disco a la hora de arrancar, y vaya directamente al disco duro, y luego establecer
una contrase±a para que esta configuracion  no sea modificada por nadie, "no uses la misma que uses para
adquirir privilegios en tus sistema <-- no les demos todo hecho", recordad no apuntar los pass en un papelito
y pegarlos a la pantalla.
...
Bueno ahora el problema es que esta seguridad puede ser vulnerada, de varias maneras, borrando la
configuracion de la BIOS, existen varios metodos para hacerlo todos de riesgo porque estas de forma fisica
ante la maquina objetivo eso es diferente a estar en tu casa con tu pc y tomando un cohete aqui si te pillan
no hay vuelta atras,

METODOS PARA EVADIR LA PASS DE LA BIOS

1¬ Quitando la pila a la placa con la que alimenta la CMOS
2¬ Algunas placas tienen un jumper, que poniendo los pins de forma adecuada borra la CMOS (consultar manual
de la placa
3¬ Usar utilidades que sirven para sacar los pass de la BIOS
4¬ Usar utilidades que directamente sirven para borrar la CMOS
5¬ Pass por defecto


Veremos las 2 ultimas, para  la 3¬ tendreis la posibilidad de usar herramientas para hacerlo, no hay problema
ni limitaciones de ningun tipo




-------------------------------------------------------------------------------------------------------------
-----[ 2.0 MODO PRACTICO DE SALTARSE EL PASS DE LA BIOS]-----------------------------------------------------
-------------------------------------------------------------------------------------------------------------


Me ha entrado la locura una vez metido en el tema de passwords por defecto busca alternaticas
para evadir esta medida de seguridad, y he decidido ir a probar una conocida herramienta de dos
llamada !BIOS la  puedes encontrar en http://www.11a.nu/toc.html , esta utilidad tiene desde
herramientas bios wiper (blaster crackers) , es decir una herramienta que sirve para borrar la CMOS (la
configuracion de la BIOS), hasta un bios password cracker, que es que voy a utilizar en este
articulo, no tengo ganas de volver a configurar mi CMOS, no obstante lo 1║ que se debe hacer
es entrar en la BIOS y apuntar la configuracion que  tenias por si metemos la pata.
!BIOS esta escrito en pascal y asm, el codigo fuente de los programas viene incluido en el programa
de manera libre y con buena documentacion aunque en ingles - siempre estamos igual, estra
documentacion viene incluida en el programa en el directorio docs, luego en   el directorio Code
viene el codigo fuente de los programas, preparados para compilarlos, dentro de Code\Units en
Units.txt se explica que mas herramientas hay, me voy a centrar en los crackeadores de pass.

Arrancamos el programa desde  el directorio principal del programa unpacked, con ibios, te saldra
un menu



  +-----------------------------+
--ª !BIOS 3.20 (build 20000804) +----------------------------------------------
  +-----------------------------+

+------------------++---------------++-------------++-------------------------+
ªSystem:  PPro     ªª     Docs      ªª    Info     ªª!BIOS 3.20               ª
ªDataBus: ISA/PCI  ªª   Crackers    ªª   How To    ªª(c) Eleventh Alliance,   ª
ªMS-DOS:  7.10     ªª BackUp & Dump ªª    Faq!     ªª    Bluefish & ibiosdev  ª
ªWindows: 4.10     ªª   Blasters    ªª  Eleventh   ªª                         ª
+------------------+ª   Advanced    ªª   Ripped    ªª                        ª
                    ª    Source     ªª   Paying    ªª  Keyboard contols!    ª
                    ª     Quit      ªª    Tips     ªª   Don't forget Enter!  ª
                    ª Screen Saver  ªª             ªª                         ª
                    ª   Junkinfo    ªª             ªª                         ª
                    ª               ªª             ªª                         ª
                    +---------------++-------------++-------------------------+
  ...
  +---------------------------------------------+
--ª http://www.11a.nu/ -{}- bluefish@swipnet.se +------------------------------
  +---------------------------------------------+



Bueno ahi vemos desde la documentacion, utilidades para restear la CMOS "Blasters", bueno
ya sabes lo que pasa si los usas, tienes herramientas para editar la CMOS en binario, hexadecimal,
y decimal tambien otro buen riesgo como dice en la web only adviced for very experienced hackers) ,
y tambien hay herramientas de backup y para restaurar la configuracion del CMOS, se encuentra en
BackUp & Dump - Backup o restore Bueno ahi vamos a los crackers opcion menos arriesgada pero
interesante lo 1║ que hay que tener en cuenta  es que tipo de BIOS tienes "AMI, Award, DTK, IBM,
Phoenix 1, Phoenix 2, Strings"

La mia es AWARD BIOS v.600PG, veamos como funciona, vamos a crackers Award en mi caso, te
salen estas 6 opciones


Press  1  in order to crack Supervisor/System passwords
Press  2  in order to crack User passwords
Press  3  in order to crack User passwords (other versions)
Press  4  in order to crack 4.50 masterpasswords
Press  5  in order to crack 4.51/4.60 masterpasswords
Press  6  in order to enter checksum manually
Press Esc in order to quit

Yo solo he puesto contrase±a de supervisor, calco el 1


Press  1  use Jan Stohner's PWDigit (very fast!)
Press  2  (not very) intelligent bruteforce
Press  3  all passwords bruteforce
Press  4  simply print checksum (uncracked)
Press Esc in order to quit


Eso de very fast, vamos a comprobarlo, calco el 1 y sale

The password is: 20122123

En principio pense, joder esto no tira, ya que habia puesto de pass diego, pero decidi
reiniciar y puse 20122123  y entro sin problema yujuuuuu


Voy a darle al 2║ y sale

Eleventh Alliance's Award BIOS 4.5X Bruteforcer

Detecting best startup value...
Bruteforcing 4000 passwords per screen update!

Valid password -> avaew

Please note that since Award uses a hash routine,
a very simple form of none reversable encryptions,
we can only find valid password(s), not guess what
actually has been typed in.
(c) 1997-98 Bluefish [11A]

Otro igual donde esta  diego, pues no avaew, fui a probarlo y lo
mismo entro como un cohete

La 3¬ Opcion es sacar el pass por fuerza bruta.

Press  1  bruteforce with a-z
Press  2  bruteforce with 0-9
Press  3  bruteforce with a-z, 0-9
Press Esc in order to quit

Tarda demasiado, si te salen con los otros de forma instantanea para que co±o
usar este



Bueno ahora vamos a ver desde linux que podemos hacer, hay intentar saber hacer todo desde
cualquier sistema, es una utopia, intentemos paso a paso convertirlo en realidad, tenemos
que intentar adaptarnos. Para ello volvemos a la pagina de !BIOS http://www.11a.nu/toc.html
y tenemos hay unos programas escritos en ansi c, bajaros  el programa segun la BIOS que tengais:

bios_award.c - para BIOS Award          - http://www.11a.nu/FILES/!BIOS/SRC/UNIX/bios_award.c
bios_sc.c    - para BIOS IBM y Phoenix  - http://www.11a.nu/FILES/!BIOS/SRC/UNIX/bios_sc.c


Bueno voy a probar bios_award.c desde linux, tienes correr como root para poder usarlo:

[root@localhost c]# ./bios_award
Bios Password Crackers (Open Source)
By the members of the ibiosdev mailinglists.
Check out our homepage at http://www.11a.nu/

Bios access usually requires root permission.

This program decrypts passwords used by various
versions of Award BIOS.
Cracker is based on pwdigit by Jan Stohner

CMOS Checksum at [28] is [34459] and is decoded to: 20122123
CMOS Checksum at [77] is [0] and is decoded to: 40000000
CMOS Checksum at [96] is [7240] and is decoded to: 01301020

20122123 <-- este pass tira podeis ver que coincide con el de  Jan Stohner's PWDigit, es porque esta
basado en el, lo podeis comprobar mirando el codigo fuente "bios_awardy.c -- based on pwdigit.c by
Jan Stohner"


Bueno ahora voy a poner una peque±a lista sobre pass por defecto de routers y bios, espero que os sea de
interes y utilidad.
...
En http://www.3com.com, y  en http://www.3com.com para espa±a,  para ponerse en contacto con ellos.y conseguir
mas informacion sobre el tema.



MARCA TIPO                 CLASE     PROTOCOLO LOGIN     PASS   PRIVILEGIOS COMENTARIOS

3COM  CellPlex             7000      Telnet    tech      tech
3COM  CoreBuilder                    Telnet    debug     synnet
3COM  CoreBuilder                    Telnet    tech      tech
3COM  HiPerARC             v4.1.x    Telnet    adm       (ninguno)
3COM  LANplex              2500      Telnet    debug     synnet
3COM  LANplex              2500      Telnet    tech      tech
3COM  LinkSwitch 2000/2700           Telnet    tech      tech
3COM  Office Connect ISDN  5x0       Telnet    n/a       Admin
         Routers
...
3COM  SuperStack II Switch 1100/3300  Telnet   admin     n/a        Admin
...
3COM Cable Managment System SQL                          DOCSIS_APP 3com
...
Debian LinuxLILO  Default 2.2                               Console   n/a      tatercounter2000 Admin
...
Ericsson          Ericsson                                            netman   netman
...
InterbaseDatabase Server                              All   Multi     SYSDBA   masterkey        Admin
IRC               IRC Daemon                                IRC       n/a      FOOBAR           Acess
Iwill             PC BIOS                                   Console   n/a      iwill            Admin
JD Edwards        WorldVision/OneWorldAll(?)TCP 1964                  JDE      JDE              Admin/SE
...
http://www.alteon.com, para ver las caracteristicas de los routers en  http://www.nortelnetworks.com/
solutions/ipservices/security/ , para ir directamete a  por la documentacion en
http://www.nortelnetworks.com/products/01/alt180/doclib.html
...
Alteon  Web Systems     HTTP        none      admin
Alteon  Web Systems     HTTP        none      14admin
...
American Megatrens en http://www.ami.com, en http://www.ami.com/support/download.cfm esta la documentacion
software etc, que necesitas para tu bios



MARCA   TIPO      CLASE PROTOCOLO         LOGIN       PASS        PRIVILEGIOS
...
En http://www.apcc.com/es/support/  se puede encontrar informacion sobre esta marca
...
APCC  all-UPS        AP9608 Console   n/a               Admin       (Access menu Control+P)
APC   Share-UPS      AP9207 Console   n/a               Admin
APC   Web/SNMPAP9606        Multi     apc          apc  Admin
      Management Card

APC   Powerchute Plus       Console   POWERCHUTE   APC  Admin
...
AWARD tiene esta direccion http://www.award.com/ y en http://www.phoenix.com/PlatSS/pcplatforms/desktop/
awardbios.html   documentancion



MARCA TIPO    PROTOCOLO      LOGIN PASS        PRIVILEGIOS COMENTARIOS
...
AWARD PC BIOS Console         n/a  CONCAT      Admin       7409 hash
...
AWARD PC BIOS Console         n/a  j322        Admin       16aa hash
...
AWARD PC BIOS Console         n/a  TTPTHA      Admin       bea2 hash
...
http://www.axis.com/ para obtener mas informacion
...
Axis  Printserver540/540+  Multi     root  pass  Admin
AXIS   NPS 530:                      root  pass
...
Mas info en http://www130.nortelnetworks.com/cgi-bin/eserv/ess/essHomeFrameSet.jsp
...
Vayamos a http://www.biostar-usa.com/latinamerica/Homex.html si lo quieres en espa±ol, en USA
http://www.biostar-usa.com/ y een europa http://www.stats4all.com/asp/overview.asp , en este  ultimo
jeje salen las ips de las ultimas entradas (ya veo a muchos invitando a sus mejores amigos a entrar
en la web), y en http://www.biostar-usa.com/UserManual/usermanuals.htm directamente los manuales.
...
En http://www.alvarion.com/HomePage.asp encontraras documentacion



MARCA      TIPO                CLASE          LOGIN PASS     PRIVILEGIOS COMENTARIOS
...
http://www.cabletron.com/, ahi esta la web de esta marca



MARCA               TIPO                   LOGIN  PASS   PRVILEGIOS
...
http://www.cisco.com/warp/public/44/jump/routers.shtml de ahi podreis sacar documetacion y software
...
Cisco IOS                 SNMP public ReadOnly secret       Read
Cisco IOS                 SNMP      private    secret       Read/Write
...
Bonita marca http://www.compaq.com/products/servers/management/
...
En http://www.compulynx.com/support.htm podras encontrar informacion



MARCA      TIPO          CLASE PROTOCOLO LOGIN         PASS    PRIVILEGIOS COMENTARIOS

Compulynx Cproxy Server All   Multi     administrator asecret Admin
Compulynx Cmail Server  All   Multi     administrator asecret Admin
Compulynx SCM           All   Multi     administrator asecret Admin
...
La web de data general es http://www.dg.com/   y aqui la documentacion http://www-csc.dg.com/csc/default.asp





 MARCA       TIPO   PROTOCOLO LOGIN    PASS       PRIVILEGIOS
...
Hay que pasarse por aqui http://www.alliancedatacom.com/
...
La web de develcon es http://www.develcon.com/ , en ftp://ftp.eda.com/manuals/ puedes encontrar manuales
de referencia
...
En http://www.dictaphone.com, aqui hay algo mas de informacion http://www.wellscommunications.com/logging.htm
...
En http://www.dec.com encontraras documentacion
...
Digital Equipment      VMS     Mult       FIELD         TEST
...
Pasemonos por http://www.elsa.com/, la version espa±ola en http://www.elsa.com/international/espana/index.htm
...
En http://www.flowpoint.com/ encontraras informacion
...
Veamos la web de hp es http://www.hp.com, y puedes encontrar los manuales en
...
MARCA              TIPO      CLASE   PROTOCOL LOGIN    PASS           PRIVILEGIOS
...
En http://www.ibm.com/ la pagina de  ibm, en espa±a http://www.pc.ibm.com/es/ y documentacion en
...
Intel espa±a http://www.intel.com/es/ en y el soporte en
http://isearch.intel.com/scripts/search/app/en/support/search.asp
...
Intel LanRover VNP      < 6.0                  n/a      isolation   Admin
        Gateway

Intel LanRover VPN   6.0 > Multi               n/a      shiva       Admin
        Gateway
...
Pasemos por http://www.josstech.com
...
Acceso a faqs y tutoriales desde la principal http://www.lantronix.com/
...
Vamos a por slackware en http://www.slackware.com/
...
Vamos a http://www.livingston.com/
...
La pagina principal en http://www.lucent.com, soportee en http://www.lucent.com/support/ y en espa±ol
en http://www.lucent.com.mx/new/Lucent_Nhome.htm
...
Soporte en http://support.micronpc.com/apps/srvrhub.asp?Hub=TREK2
...
Ahi no me meto, ellos y yo hemos sido buenos amigos jajajaja
...
Microsoft Windows NT              Multi   Administrator Administrator Admin  *á Not by system default but
Microsoft Windows NT              Multi   Administrator (none)        Admin  *á has been identified as a
Microsoft Windows NT              Multi        Guest     Guest        User   *á common consultant mistake
Microsoft Windows NT              Multi        Guest    (none)        User   *á These may be removed
...
Aqui hay algo de informacion http://dsl.orbisnet.com/netopia_routers.htm
...
Pagina principal  en http://www.nortelnetworks.com, en espa±ol en  http://www.nortelnetworks.com/corporate/
global/emea/spain/index.html, y en http://www.nortelnetworks.com/products/index_sp.html directamente para
seleccionar la documentacion sobre sus productos
...
Vamos por http://www.novell.com/ y soporte en http://support.novell.com/ , en espa±a
http://www.novell.com/offices/emea/spain/ y soporte en castellano
http://www.novell.com/offices/emea/spain/services_support/index.html
...
En http://www.oracle.com/   y en espa±ol http://www.oracle.com/es/
...
Oracle Oracle RDBMS 7,8  Multi    AURORA@ORB INVALID
...
Oracle Oracle RDBMS 7,8  Multi    SYS     CHANGE_ON_INSDBA +
...
-------------------------------------------------------------------------------------------------------------
 ...
 Ahi esta  lo que buscaas en http://www.osicom.com/osicom/
...
Osicom Osicom Plus          Telnet   write     private
       T1/PLUS 56k
...
En http://www.primecomputer.net mas informacion
...
Sun   Sun E10000     Processor Multi     ssp     ssp      Admin
      System Service
...
Pasaros por http://www.telus.com
...
Vamos a http://www.toshiba.com, en espa±a http://www.toshiba.es, soporte en http://support.toshiba-tro.de
y soporte de la  bios en http://support.toshiba-tro.de/internet/bios/biospage.asp
...
Nos tenemos que ir a http://www.att.com/
...
Gracias a estas webs he podido reunir estos pass por defecto:

http://www.astalavista.com/hacking/password/defaultpasswords.shtml
http://security.nerdnet.com/index.php
http://www.phenoelit.de/dpl/dpl.html
http://www.securiteam.com/securitynews/Default_passwords_sometimes_stay_for_good.html
http://blacksun.box.sk/defaultpasswds.html
http://www.parallaxresearch.com/dataclips/pub/infosec/cracking/passwords/Default%20Passwords%203.0.6.html


Tambien he pasado por cisco www.cisco.com  www.cisco.com/es <- cisco espa±a y el pdf que he puesto en la web
de disidents (seccion de libros y documentos) no me ha venido mal
