/*
   ...
   Testado em Linux 2.0.30, 2.0.27, 2.0.32
   Existe a remota:)) possibilidade de ocorrerem erros a correr
   o programa em alguns sistemas...isso esta relacionado, com as
   funcoes de input de leitura de ficheiros! Se isso ocorrer no seu
   sistema faca gdb para detectar o erro!!
...
printf("o ficheiro '%s/.bash_history' nao existe\n", dir);
